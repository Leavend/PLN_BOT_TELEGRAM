...
final class OkHttpCall<T> implements Call<T> {
    ...
    Response<T> parseResponse(okhttp3.Response response) throws IOException {
        ...
        okhttp3.Response responseBuild = response.newBuilder().body(new NoContentResponseBody(responseBodyBody.getMediaType(), responseBodyBody.getContentLength())).build();
