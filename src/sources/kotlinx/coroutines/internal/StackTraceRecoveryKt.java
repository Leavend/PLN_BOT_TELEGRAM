...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM6852constructorimpl2;
        ...
        try {
            ...
            objM6852constructorimpl = Result.m6852constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM6852constructorimpl = Result.m6852constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m6855exceptionOrNullimpl(objM6852constructorimpl) == null) {
            obj2 = objM6852constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM6852constructorimpl2 = Result.m6852constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM6852constructorimpl2 = Result.m6852constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m6855exceptionOrNullimpl(objM6852constructorimpl2) == null) {
            obj = objM6852constructorimpl2;
        }
