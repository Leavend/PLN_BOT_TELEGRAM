...
final /* synthetic */ class FlowKt__MergeKt {
    ...
    static final class C10311<R, T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C10311(Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super C10311> continuation) {
            super(3, continuation);
            this.$transform = function2;
        }
        ...
        public final Object invoke(FlowCollector<? super R> flowCollector, T t, Continuation<? super Unit> continuation) {
            C10311 c10311 = new C10311(this.$transform, continuation);
            c10311.L$0 = flowCollector;
            c10311.L$1 = t;
            return c10311.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T, R> Flow<R> mapLatest(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2) {
        return FlowKt.transformLatest(flow, new C10311(function2, null));
    }
