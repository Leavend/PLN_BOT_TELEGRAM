...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    static final class C10291 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C10291(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C10291) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    */
    ...
    public static final <T> Flow<T> m8396catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
