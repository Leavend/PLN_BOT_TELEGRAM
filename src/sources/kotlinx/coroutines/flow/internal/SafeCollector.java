...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T>, CoroutineStackFrame {
    ...
    public Object invokeSuspend(Object result) {
        Throwable thM6855exceptionOrNullimpl = Result.m6855exceptionOrNullimpl(result);
        if (thM6855exceptionOrNullimpl != null) {
            this.lastEmissionContext = new DownstreamExceptionContext(thM6855exceptionOrNullimpl, getContext());
        }
        Continuation<? super Unit> continuation = this.completion;
