...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM6852constructorimpl = Result.m6852constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM6852constructorimpl = Result.m6852constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m6858isFailureimpl(objM6852constructorimpl) ? null : objM6852constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo8411dispatch(cancellableContinuationImpl2.getContext(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
