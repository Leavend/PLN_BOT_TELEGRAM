    ...
    public static final <T> void startCoroutineUnintercepted(Function1<? super Continuation<? super T>, ? extends Object> function1, Continuation<? super T> continuation) {
        ...
        try {
            ...
            if (objInvoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                ...
                continuationProbeCoroutineCreated.resumeWith(Result.m6852constructorimpl(objInvoke));
            }
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            continuationProbeCoroutineCreated.resumeWith(Result.m6852constructorimpl(ResultKt.createFailure(th)));
        }
    }
