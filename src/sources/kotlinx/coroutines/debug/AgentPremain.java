...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM6852constructorimpl = Result.m6852constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM6852constructorimpl = Result.m6852constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m6858isFailureimpl(objM6852constructorimpl) ? null : objM6852constructorimpl);
