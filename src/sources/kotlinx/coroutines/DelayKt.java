...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo8412scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m8342delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m8343toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m8343toDelayMillisLRDsOJo(long j) {
        if (Duration.m8178compareToLRDsOJo(j, Duration.INSTANCE.m8281getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m8197getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
