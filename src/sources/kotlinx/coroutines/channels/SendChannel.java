...
public interface SendChannel<E> {
    ...
    Object mo8356trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m8376isSuccessimpl(objMo8356trySendJP2dKIU)) {
                return true;
            }
            Throwable thM8370exceptionOrNullimpl = ChannelResult.m8370exceptionOrNullimpl(objMo8356trySendJP2dKIU);
