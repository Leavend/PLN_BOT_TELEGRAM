...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM8384trySendImplMj0NB7M = conflatedBufferedChannel.m8384trySendImplMj0NB7M(e, true);
        if (objM8384trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m8370exceptionOrNullimpl(objM8384trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM8384trySendImplMj0NB7M = conflatedBufferedChannel.m8384trySendImplMj0NB7M(e, true);
        if (!(objM8384trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo8356trySendJP2dKIU(E element) {
        return m8384trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m8384trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m8382trySendDropLatestMj0NB7M(element, isSendOp) : m8383trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m8382trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo8356trySendJP2dKIU = super.mo8356trySendJP2dKIU(element);
        if (ChannelResult.m8376isSuccessimpl(objMo8356trySendJP2dKIU) || ChannelResult.m8374isClosedimpl(objMo8356trySendJP2dKIU)) {
            return objMo8356trySendJP2dKIU;
        }
        ...
        return ChannelResult.INSTANCE.m8381successJP2dKIU(Unit.INSTANCE);
    }

    /* renamed from: trySendDropOldest-JP2dKIU, reason: not valid java name */
    private final Object m8383trySendDropOldestJP2dKIU(E element) {
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (channelSegmentFindSegmentSend != null) {
                    ...
                    return ChannelResult.INSTANCE.m8379closedJP2dKIU(getSendException());
                }
            } else {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo8356trySendJP2dKIU = mo8356trySendJP2dKIU(element);
        if (!(objMo8356trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo8356trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m8370exceptionOrNullimpl(objMo8356trySendJP2dKIU);
