...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo8360receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo8360receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo8361tryReceivePtdJZtk() {
        return this._channel.mo8361tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo8356trySendJP2dKIU(E element) {
        return this._channel.mo8356trySendJP2dKIU(element);
    }
