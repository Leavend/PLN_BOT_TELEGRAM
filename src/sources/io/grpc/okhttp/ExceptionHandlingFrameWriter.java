...
final class ExceptionHandlingFrameWriter implements FrameWriter {
    ...
    public void ping(boolean z, int i, int i2) {
        if (z) {
            this.frameLogger.logPingAck(OkHttpFrameLogger.Direction.OUTBOUND, (InternalZipConstants.ZIP_64_SIZE_LIMIT & i2) | (i << 32));
        } else {
            this.frameLogger.logPing(OkHttpFrameLogger.Direction.OUTBOUND, (InternalZipConstants.ZIP_64_SIZE_LIMIT & i2) | (i << 32));
        }
        try {
