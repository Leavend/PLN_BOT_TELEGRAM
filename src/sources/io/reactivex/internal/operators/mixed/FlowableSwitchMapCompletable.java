    ...
    static final class SwitchMapCompletableObserver<T> implements FlowableSubscriber<T>, Disposable {
        ...
        public void onNext(T t) {
            ...
            try {
                ...
                } while (!TaskExecutorWithFakeMainThread$1$$ExternalSyntheticBackportWithForwarding0.m(this.inner, switchMapInnerObserver, switchMapInnerObserver2));
        ...
        void innerError(SwitchMapInnerObserver switchMapInnerObserver, Throwable th) {
            if (TaskExecutorWithFakeMainThread$1$$ExternalSyntheticBackportWithForwarding0.m(this.inner, switchMapInnerObserver, null) && this.errors.addThrowable(th)) {
                if (this.delayErrors) {
                    if (this.done) {
        ...
        void innerComplete(SwitchMapInnerObserver switchMapInnerObserver) {
            if (TaskExecutorWithFakeMainThread$1$$ExternalSyntheticBackportWithForwarding0.m(this.inner, switchMapInnerObserver, null) && this.done) {
                Throwable thTerminate = this.errors.terminate();
                if (thTerminate == null) {
                    this.downstream.onComplete();
                } else {
