...
public final class ParallelReduceFull<T> extends Flowable<T> {
    ...
    static final class ParallelReduceFullMainSubscriber<T> extends DeferredScalarSubscription<T> {
        ...
        SlotPair<T> addValue(T t) {
            ...
            while (true) {
                ...
                if (slotPair == null) {
                    ...
                    if (!TaskExecutorWithFakeMainThread$1$$ExternalSyntheticBackportWithForwarding0.m(this.current, null, slotPair)) {
                        continue;
                    }
                }
                ...
                TaskExecutorWithFakeMainThread$1$$ExternalSyntheticBackportWithForwarding0.m(this.current, slotPair, null);
            }
            if (iTryAcquireSlot == 0) {
                slotPair.first = t;
            } else {
        ...
        void innerError(Throwable th) {
            if (TaskExecutorWithFakeMainThread$1$$ExternalSyntheticBackportWithForwarding0.m(this.error, null, th)) {
                cancel();
