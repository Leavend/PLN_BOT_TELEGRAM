...
public enum DisposableHelper implements Disposable {
    ...
    public static boolean set(AtomicReference<Disposable> atomicReference, Disposable disposable) {
        ...
        } while (!TaskExecutorWithFakeMainThread$1$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, disposable2, disposable));
        if (disposable2 == null) {
            return true;
        }
        disposable2.dispose();
    ...
    public static boolean setOnce(AtomicReference<Disposable> atomicReference, Disposable disposable) {
        ...
        if (TaskExecutorWithFakeMainThread$1$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, null, disposable)) {
            return true;
        }
        disposable.dispose();
