...
public final class FutureSubscriber<T> extends CountDownLatch implements FlowableSubscriber<T>, Future<T>, Subscription {
    ...
    public boolean cancel(boolean z) {
        ...
        } while (!TaskExecutorWithFakeMainThread$1$$ExternalSyntheticBackportWithForwarding0.m(this.upstream, subscription, SubscriptionHelper.CANCELLED));
    ...
    public void onError(Throwable th) {
        ...
        do {
            ...
            this.error = th;
        } while (!TaskExecutorWithFakeMainThread$1$$ExternalSyntheticBackportWithForwarding0.m(this.upstream, subscription, this));
        countDown();
    }
