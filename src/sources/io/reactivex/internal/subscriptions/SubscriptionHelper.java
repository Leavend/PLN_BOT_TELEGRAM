...
public enum SubscriptionHelper implements Subscription {
    ...
    public static boolean set(AtomicReference<Subscription> atomicReference, Subscription subscription) {
        ...
        } while (!TaskExecutorWithFakeMainThread$1$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, subscription2, subscription));
        if (subscription2 == null) {
            return true;
        }
        subscription2.cancel();
    ...
    public static boolean setOnce(AtomicReference<Subscription> atomicReference, Subscription subscription) {
        ...
        if (TaskExecutorWithFakeMainThread$1$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, null, subscription)) {
            return true;
        }
        subscription.cancel();
