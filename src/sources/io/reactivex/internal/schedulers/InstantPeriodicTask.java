...
final class InstantPeriodicTask implements Callable<Void>, Disposable {
    ...
    void setFirst(Future<?> future) {
        ...
        } while (!TaskExecutorWithFakeMainThread$1$$ExternalSyntheticBackportWithForwarding0.m(this.first, future2, future));
    }
    ...
    void setRest(Future<?> future) {
        ...
        } while (!TaskExecutorWithFakeMainThread$1$$ExternalSyntheticBackportWithForwarding0.m(this.rest, future2, future));
    }
}
