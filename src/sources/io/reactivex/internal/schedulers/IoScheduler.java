...
public final class IoScheduler extends Scheduler {
    ...
    public void start() {
        ...
        if (TaskExecutorWithFakeMainThread$1$$ExternalSyntheticBackportWithForwarding0.m(this.pool, NONE, cachedWorkerPool)) {
            return;
        }
        cachedWorkerPool.shutdown();
    }
    ...
    public void shutdown() {
        ...
        } while (!TaskExecutorWithFakeMainThread$1$$ExternalSyntheticBackportWithForwarding0.m(this.pool, cachedWorkerPool, cachedWorkerPool2));
        cachedWorkerPool.shutdown();
    }
