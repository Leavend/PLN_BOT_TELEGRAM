...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
    ...
    private static long hashLength0to16(byte[] bArr, int i, int i2) {
        ...
        if (i2 >= 4) {
            return hashLength16(i2 + ((LittleEndianByteArray.load32(bArr, i) & InternalZipConstants.ZIP_64_SIZE_LIMIT) << 3), LittleEndianByteArray.load32(bArr, (i + i2) - 4) & InternalZipConstants.ZIP_64_SIZE_LIMIT, (i2 * 2) + K2);
        }
        if (i2 <= 0) {
            return K2;
        }
