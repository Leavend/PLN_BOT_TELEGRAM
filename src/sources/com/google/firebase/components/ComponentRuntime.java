...
public class ComponentRuntime extends AbstractComponentContainer implements ComponentLoader {
        ...
        synchronized (this) {
            ...
            for (final Component<?> component : list) {
                this.components.put(component, new Lazy(new Provider() { // from class: com.google.firebase.components.ComponentRuntime$$ExternalSyntheticLambda1
                    @Override // com.google.firebase.inject.Provider
                    public final Object get() {
                        return this.f$0.m6361xc080f8d8(component);
                    }
                }));
            }
    ...
    /* synthetic */ Object m6361xc080f8d8(Component component) {
    ...
    public void initializeEagerComponents(boolean z) {
        HashMap map;
        if (TaskExecutorWithFakeMainThread$1$$ExternalSyntheticBackportWithForwarding0.m(this.eagerComponentsInitializedWith, null, Boolean.valueOf(z))) {
            synchronized (this) {
