...
public class BundleSerializer {
    ...
    public BundleMetadata decodeBundleMetadata(JSONObject jSONObject) throws JSONException {
        return new BundleMetadata(jSONObject.getString(DownloadModel.ID), jSONObject.getInt(ClientCookie.VERSION_ATTR), decodeSnapshotVersion(jSONObject.get("createTime")), jSONObject.getInt("totalDocuments"), jSONObject.getLong("totalBytes"));
    }
