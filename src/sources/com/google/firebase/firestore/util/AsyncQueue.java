...
public class AsyncQueue {
    ...
    class SynchronizedShutdownAwareExecutor implements Executor {
        ...
        SynchronizedShutdownAwareExecutor() {
            ...
            threadNewThread.setUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() { // from class: com.google.firebase.firestore.util.AsyncQueue$SynchronizedShutdownAwareExecutor$$ExternalSyntheticLambda0
                ...
                public final void uncaughtException(Thread thread, Throwable th) {
                    this.f$0.m6520x23fada6e(thread, th);
                }
            });
        ...
        /* synthetic */ void m6520x23fada6e(Thread thread, Throwable th) {
            AsyncQueue.this.panic(th);
        }
