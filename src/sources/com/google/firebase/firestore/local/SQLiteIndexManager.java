...
final class SQLiteIndexManager implements IndexManager {
    ...
    public void start() {
        ...
        this.db.query("SELECT index_id, collection_group, index_proto FROM index_configuration").forEach(new Consumer() { // from class: com.google.firebase.firestore.local.SQLiteIndexManager$$ExternalSyntheticLambda7
            @Override // com.google.firebase.firestore.util.Consumer
            public final void accept(Object obj) {
                this.f$0.m6462x30c0807a(map, (Cursor) obj);
            }
        });
        this.started = true;
    }
    ...
    /* synthetic */ void m6462x30c0807a(Map map, Cursor cursor) {
        try {
    ...
    public void m6463x55deb5b3(Document document, IndexEntry indexEntry) throws SQLException {
    ...
    public void m6464x57150892(Document document, IndexEntry indexEntry) throws SQLException {
