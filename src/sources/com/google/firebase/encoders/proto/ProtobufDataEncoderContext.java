...
final class ProtobufDataEncoderContext implements ObjectEncoderContext {
    ...
    private static final FieldDescriptor MAP_KEY_DESC = FieldDescriptor.builder(DatabaseFileArchive.COLUMN_KEY).withProperty(AtProtobuf.builder().tag(1).build()).build();
