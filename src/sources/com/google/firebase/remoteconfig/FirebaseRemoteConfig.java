...
public class FirebaseRemoteConfig {
    ...
    public Task<FirebaseRemoteConfigInfo> ensureInitialized() {
        ...
        final Task taskCall = Tasks.call(this.executor, new Callable() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda4
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f$0.getInfo();
            }
        });
        return Tasks.whenAllComplete((Task<?>[]) new Task[]{task, task2, task3, taskCall, this.firebaseInstallations.getId(), this.firebaseInstallations.getToken(false)}).continueWith(this.executor, new Continuation() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda5
    ...
    public Task<Boolean> activate() {
        ...
        return Tasks.whenAllComplete((Task<?>[]) new Task[]{task, task2}).continueWithTask(this.executor, new Continuation() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda9
            ...
            public final Object then(Task task3) {
                return this.f$0.m6546x98ca96b0(task, task2, task3);
            }
        });
    }

    /* renamed from: lambda$activate$2$com-google-firebase-remoteconfig-FirebaseRemoteConfig, reason: not valid java name */
    /* synthetic */ Task m6546x98ca96b0(Task task, Task task2, Task task3) throws Exception {
    ...
    public Task<Void> setConfigSettingsAsync(final FirebaseRemoteConfigSettings firebaseRemoteConfigSettings) {
        return Tasks.call(this.executor, new Callable() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda6
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f$0.m6549xd6203cf5(firebaseRemoteConfigSettings);
            }
        });
    }
    ...
    /* synthetic */ Void m6549xd6203cf5(FirebaseRemoteConfigSettings firebaseRemoteConfigSettings) throws Exception {
