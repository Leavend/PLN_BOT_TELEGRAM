...
public class Query {
    ...
    public Query startAfter(String str, String str2) throws DatabaseException {
        if (str != null && this.params.getIndex().equals(KeyIndex.getInstance())) {
    ...
    public Query endBefore(String str, String str2) throws DatabaseException {
        if (str != null && this.params.getIndex().equals(KeyIndex.getInstance())) {
    ...
    public Query orderByChild(String str) throws DatabaseException {
        if (str == null) {
