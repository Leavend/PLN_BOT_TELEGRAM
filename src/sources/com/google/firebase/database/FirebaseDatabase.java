...
public class FirebaseDatabase {
    ...
    public static FirebaseDatabase getInstance(FirebaseApp firebaseApp) {
        ...
        if (databaseUrl == null) {
            ...
            databaseUrl = Config.HTTPS + firebaseApp.getOptions().getProjectId() + "-default-rtdb.firebaseio.com";
        }
    ...
    public DatabaseReference getReference(String str) throws DatabaseException {
        ensureRepo();
        if (str == null) {
    ...
    public DatabaseReference getReferenceFromUrl(String str) throws DatabaseException {
        ensureRepo();
        if (str == null) {
