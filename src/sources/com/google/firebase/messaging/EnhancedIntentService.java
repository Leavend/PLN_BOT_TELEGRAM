...
public abstract class EnhancedIntentService extends Service {
    ...
    public Task<Void> processIntent(final Intent intent) {
        ...
        this.executor.execute(new Runnable() { // from class: com.google.firebase.messaging.EnhancedIntentService$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m6530x624ce8b2(intent, taskCompletionSource);
            }
        });
    ...
    /* synthetic */ void m6530x624ce8b2(Intent intent, TaskCompletionSource taskCompletionSource) {
        try {
            handleIntent(intent);
        } finally {
    ...
    public final int onStartCommand(final Intent intent, int i, int i2) {
        ...
        taskProcessIntent.addOnCompleteListener(new ProfileInstallReceiver$$ExternalSyntheticLambda0(), new OnCompleteListener() { // from class: com.google.firebase.messaging.EnhancedIntentService$$ExternalSyntheticLambda1
            ...
            public final void onComplete(Task task) {
                this.f$0.m6529x83fa35aa(intent, task);
            }
        });
        return 3;
    }
    ...
    /* synthetic */ void m6529x83fa35aa(Intent intent, Task task) {
        finishTask(intent);
    }
