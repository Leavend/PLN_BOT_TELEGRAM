...
public class ImageDownload implements Closeable {
    ...
    public void start(ExecutorService executorService) {
        ...
        this.future = executorService.submit(new Runnable() { // from class: com.google.firebase.messaging.ImageDownload$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m6543lambda$start$0$comgooglefirebasemessagingImageDownload(taskCompletionSource);
            }
        });
    ...
    /* synthetic */ void m6543lambda$start$0$comgooglefirebasemessagingImageDownload(TaskCompletionSource taskCompletionSource) {
        try {
