...
final class AutoValue_PersistedEvent extends PersistedEvent {
    ...
    public String toString() {
        return "PersistedEvent{id=" + this.f82id + ", transportContext=" + this.transportContext + ", event=" + this.event + "}";
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f82id == persistedEvent.getId() && this.transportContext.equals(persistedEvent.getTransportContext()) && this.event.equals(persistedEvent.getEvent());
    }
