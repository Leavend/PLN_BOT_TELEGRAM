...
public class GoogleSignInAccount extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public static GoogleSignInAccount zab(String str) throws JSONException, NumberFormatException {
        ...
        GoogleSignInAccount googleSignInAccountZaa = zaa(jSONObject.optString(DownloadModel.ID), jSONObject.has("tokenId") ? jSONObject.optString("tokenId") : null, jSONObject.has("email") ? jSONObject.optString("email") : null, jSONObject.has("displayName") ? jSONObject.optString("displayName") : null, jSONObject.has("givenName") ? jSONObject.optString("givenName") : null, jSONObject.has("familyName") ? jSONObject.optString("familyName") : null, uri, Long.valueOf(j), jSONObject.getString("obfuscatedIdentifier"), hashSet);
    ...
    public final String zad() throws JSONException {
        ...
        try {
            if (getId() != null) {
                jSONObject.put(DownloadModel.ID, getId());
            }
            if (getIdToken() != null) {
