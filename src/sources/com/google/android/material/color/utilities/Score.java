...
public final class Score {
    ...
    public static List<Integer> score(Map<Integer, Integer> map) {
        ...
        for (Map.Entry entry2 : map2.entrySet()) {
            ...
            map4.put(Integer.valueOf(iIntValue3), Double.valueOf((((Double) map3.get(Integer.valueOf(iIntValue3))).doubleValue() * 100.0d * 0.7d) + ((cam16.getChroma() - TARGET_CHROMA) * (cam16.getChroma() < TARGET_CHROMA ? WEIGHT_CHROMA_BELOW : WEIGHT_CHROMA_ABOVE))));
        }
