...
public class HctSolver {
    ...
    static double[][] bisectToSegment(double d, double d2) {
        ...
        for (int i = 0; i < 12; i++) {
            ...
            if (dArrNthVertex[0] >= FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
    ...
    static double inverseChromaticAdaptation(double d) {
        ...
        return MathUtils.signum(d) * Math.pow(Math.max(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, (27.13d * dAbs) / (400.0d - dAbs)), 2.380952380952381d);
    }
