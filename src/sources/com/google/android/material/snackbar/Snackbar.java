...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
        ...
        if (TextUtils.isEmpty(charSequence) || onClickListener == null) {
            ...
            actionView.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.snackbar.Snackbar$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view) {
                    this.f$0.m6332lambda$setAction$0$comgoogleandroidmaterialsnackbarSnackbar(onClickListener, view);
                }
            });
        }
        return this;
    ...
    /* synthetic */ void m6332lambda$setAction$0$comgoogleandroidmaterialsnackbarSnackbar(View.OnClickListener onClickListener, View view) {
