...
public class JCERSACipher extends WrapCipherSpi {
    ...
    /* JADX WARN: Type inference failed for: r7v25, types: [org.bouncycastle.crypto.params.ParametersWithRandom] */
    /* JADX WARN: Type inference failed for: r7v9, types: [org.bouncycastle.crypto.params.ParametersWithRandom] */
    @Override // org.bouncycastle.jce.provider.WrapCipherSpi, javax.crypto.CipherSpi
    protected void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        asymmetricBlockCipher.init(z, rSAKeyParametersGeneratePrivateKeyParameter);
    }
        ...
        if (upperCase.equals("NOPADDING")) {
            ...
            if (!upperCase.equals("ISO9796-1PADDING")) {
                if (upperCase.equals("OAEPWITHMD5ANDMGF1PADDING")) {
                    ...
                    oAEPParameterSpec = new OAEPParameterSpec(MessageDigestAlgorithms.SHA_224, "MGF1", new MGF1ParameterSpec(MessageDigestAlgorithms.SHA_224), PSource.PSpecified.DEFAULT);
