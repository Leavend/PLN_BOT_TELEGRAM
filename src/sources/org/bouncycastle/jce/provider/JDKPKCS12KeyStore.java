...
public class JDKPKCS12KeyStore extends KeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore {
    ...
    private class CertId {
        ...
        CertId(PublicKey publicKey) {
            this.f182id = JDKPKCS12KeyStore.this.createSubjectKeyId(publicKey).getKeyIdentifier();
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof CertId) {
                return Arrays.areEqual(this.f182id, ((CertId) obj).f182id);
            }
            return false;
        }

        public int hashCode() {
            return Arrays.hashCode(this.f182id);
        }
    }
    ...
    private static byte[] calculatePbeMac(DERObjectIdentifier dERObjectIdentifier, byte[] bArr, int i, char[] cArr, boolean z, byte[] bArr2) throws Exception {
        String id2 = dERObjectIdentifier.getId();
        Provider provider = bcProvider;
        SecretKeyFactory secretKeyFactory = SecretKeyFactory.getInstance(id2, provider);
    ...
    protected byte[] cryptData(boolean z, AlgorithmIdentifier algorithmIdentifier, char[] cArr, boolean z2, byte[] bArr) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, IOException, InvalidAlgorithmParameterException {
        String id2 = algorithmIdentifier.getObjectId().getId();
    ...
    public Enumeration engineAliases() {
        ...
        while (enumerationKeys2.hasMoreElements()) {
            ...
            if (hashtable.get(str) == null) {
                hashtable.put(str, DatabaseFileArchive.COLUMN_KEY);
            }
        }
    ...
    */
    ...
    /* JADX WARN: Type inference failed for: r1v44, types: [org.bouncycastle.jce.interfaces.PKCS12BagAttributeCarrier] */
