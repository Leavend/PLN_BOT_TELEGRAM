...
public class RFC3280CertPathUtilities {
    ...
    */
    ...
    protected static void processCertA(CertPath certPath, ExtendedPKIXParameters extendedPKIXParameters, int i, PublicKey publicKey, boolean z, X500Principal x500Principal, X509Certificate x509Certificate) throws CertificateNotYetValidException, ExtCertPathValidatorException, CertificateExpiredException {
                        ...
                        for (int i5 = 0; i5 < list.size(); i5++) {
                            ...
                            for (Object obj2 : pKIXPolicyNode2.getExpectedPolicies()) {
                                if (obj2 instanceof String) {
                                    ...
                                    id2 = ((DERObjectIdentifier) obj2).getId();
                                }
                                String str = id2;
