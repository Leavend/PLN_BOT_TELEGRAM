...
public class AttrCertExample {
    ...
    public static X509Certificate createAcIssuerCert(PublicKey publicKey, PrivateKey privateKey) throws Exception {
        ...
        v1CertGen.setNotBefore(new Date(System.currentTimeMillis() - OpenStreetMapTileProviderConstants.TILE_EXPIRY_TIME_MILLISECONDS));
        v1CertGen.setNotAfter(new Date(System.currentTimeMillis() + OpenStreetMapTileProviderConstants.TILE_EXPIRY_TIME_MILLISECONDS));
    ...
    public static X509Certificate createClientCert(PublicKey publicKey, PrivateKey privateKey, PublicKey publicKey2) throws Exception {
        ...
        v3CertGen.setNotBefore(new Date(System.currentTimeMillis() - OpenStreetMapTileProviderConstants.TILE_EXPIRY_TIME_MILLISECONDS));
        v3CertGen.setNotAfter(new Date(System.currentTimeMillis() + OpenStreetMapTileProviderConstants.TILE_EXPIRY_TIME_MILLISECONDS));
