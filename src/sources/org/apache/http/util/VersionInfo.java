...
public class VersionInfo {
    ...
    public static String getUserAgent(String str, String str2, Class<?> cls) throws IOException {
        ...
        return str + InternalZipConstants.ZIP_FILE_SEPARATOR + (versionInfoLoadVersionInfo != null ? versionInfoLoadVersionInfo.getRelease() : UNAVAILABLE) + " (Java 1.5 minimum; Java/" + System.getProperty("java.version") + ")";
    }
}
