        ...
        if (httpClientConnectionManager2 == null) {
            ...
            if (sSLConnectionSocketFactory == null) {
                if (this.sslcontext != null) {
                    ...
                    sSLConnectionSocketFactory = new SSLConnectionSocketFactory((SSLSocketFactory) SSLSocketFactory.getDefault(), split(System.getProperty("https.protocols")), split(System.getProperty("https.cipherSuites")), this.hostnameVerifier);
                } else {
