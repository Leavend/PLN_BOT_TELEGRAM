...
final class NTLMEngineImpl implements NTLMEngine {
    ...
    protected static class CipherGen {
        ...
        public byte[] getLanManagerSessionKey() throws BadPaddingException, NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, NTLMEngineException, InvalidKeyException {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static byte[] lmHash(String str) throws BadPaddingException, NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, InvalidKeyException, NTLMEngineException, UnsupportedEncodingException {
        try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static byte[] ntlmHash(String str) throws NTLMEngineException, UnsupportedEncodingException {
        try {
    ...
    static class Type3Message extends NTLMMessage {
        ...
        Type3Message(String str, String str2, String str3, String str4, byte[] bArr, int i, String str5, byte[] bArr2) throws BadPaddingException, NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, InvalidKeyException, NTLMEngineException, UnsupportedEncodingException {
