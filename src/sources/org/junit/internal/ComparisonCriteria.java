...
public abstract class ComparisonCriteria {
    ...
    private void arrayEquals(String str, Object obj, Object obj2, boolean z) throws ArrayComparisonFailure, ArrayIndexOutOfBoundsException, IllegalArgumentException {
    ...
    private Object getToStringableArrayElement(Object obj, int i, int i2) throws ArrayIndexOutOfBoundsException, IllegalArgumentException {
        if (i2 < i) {
            ...
            return isArray(obj2) ? objectWithToString(componentTypeName(obj2.getClass()) + "[" + Array.getLength(obj2) + "]") : obj2;
        }
