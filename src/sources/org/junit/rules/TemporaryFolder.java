...
public class TemporaryFolder extends ExternalResource {
    ...
    private static File createTemporaryFolderWithNioApi(File file) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException, IllegalArgumentException, NegativeArraySizeException, InvocationTargetException {
        Object objInvoke;
        ...
        if (file != null) {
            objInvoke = cls.getDeclaredMethod("createTempDirectory", cls2, String.class, objNewInstance.getClass()).invoke(null, File.class.getDeclaredMethod("toPath", new Class[0]).invoke(file, new Object[0]), TMP_PREFIX, objNewInstance);
        } else {
        ...
        return (File) cls2.getDeclaredMethod("toFile", new Class[0]).invoke(objInvoke, new Object[0]);
    }
