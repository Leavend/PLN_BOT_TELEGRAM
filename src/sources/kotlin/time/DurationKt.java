...
public final class DurationKt {
    ...
    private static final long m8305timesmvk6XK0(int i, long j) {
        return Duration.m8217timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m8304timeskIfJnKk(double d, long j) {
        return Duration.m8216timesUwyO8pc(j, d);
    }
    ...
    */
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m8179constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m8179constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m8179constructorimpl((j << 1) + i);
    }
