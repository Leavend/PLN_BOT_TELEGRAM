...
public interface TimeMark {
    ...
    TimeMark mo8169minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo8171plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m8316plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m8315minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo8171plusLRDsOJo(Duration.m8231unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m8212isNegativeimpl(timeMark.mo8168elapsedNowUwyO8pc());
        }
