...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo8169minusLRDsOJo(long duration);

    /* renamed from: minus-UwyO8pc */
    long mo8170minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo8171plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m8174minusLRDsOJo(ComparableTimeMark comparableTimeMark, long j) {
            return comparableTimeMark.mo8171plusLRDsOJo(Duration.m8231unaryMinusUwyO8pc(j));
        }

        public static int compareTo(ComparableTimeMark comparableTimeMark, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m8178compareToLRDsOJo(comparableTimeMark.mo8170minusUwyO8pc(other), Duration.INSTANCE.m8281getZEROUwyO8pc());
        }
    }
}
