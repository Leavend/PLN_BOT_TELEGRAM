...
public final class ResultKt {
    ...
    private static final <R> Object runCatching(Function0<? extends R> block) {
        ...
        try {
            ...
            return Result.m6852constructorimpl(block.invoke());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m6852constructorimpl(createFailure(th));
        }
    }
    ...
    private static final <T, R> Object runCatching(T t, Function1<? super T, ? extends R> block) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.m6852constructorimpl(block.invoke(t));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m6852constructorimpl(createFailure(th));
        }
    ...
    private static final <R, T extends R> R getOrElse(Object obj, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        Throwable thM6855exceptionOrNullimpl = Result.m6855exceptionOrNullimpl(obj);
        return thM6855exceptionOrNullimpl == null ? obj : onFailure.invoke(thM6855exceptionOrNullimpl);
    }

    /* JADX WARN: Multi-variable type inference failed */
    private static final <R, T extends R> R getOrDefault(Object obj, R r) {
        return Result.m6858isFailureimpl(obj) ? r : obj;
    }
    ...
    private static final <R, T> R fold(Object obj, Function1<? super T, ? extends R> onSuccess, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        return onFailure.invoke(thM6855exceptionOrNullimpl);
    }

    private static final <R, T> Object map(Object obj, Function1<? super T, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        if (!Result.m6859isSuccessimpl(obj)) {
            return Result.m6852constructorimpl(obj);
        }
        Result.Companion companion = Result.INSTANCE;
        return Result.m6852constructorimpl(transform.invoke(obj));
    }
    ...
    private static final <R, T extends R> Object recover(Object obj, Function1<? super Throwable, ? extends R> transform) {
        ...
        Result.Companion companion = Result.INSTANCE;
        return Result.m6852constructorimpl(transform.invoke(thM6855exceptionOrNullimpl));
    }
    ...
    private static final <T> Object onFailure(Object obj, Function1<? super Throwable, Unit> action) {
        ...
        Throwable thM6855exceptionOrNullimpl = Result.m6855exceptionOrNullimpl(obj);
        if (thM6855exceptionOrNullimpl != null) {
            action.invoke(thM6855exceptionOrNullimpl);
        }
        return obj;
    }
