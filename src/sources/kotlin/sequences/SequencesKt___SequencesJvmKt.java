...
class SequencesKt___SequencesJvmKt extends SequencesKt__SequencesKt {
    ...
    public static final /* synthetic */ Double m8136max(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
    ...
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* renamed from: max, reason: collision with other method in class */
    public static final /* synthetic */ Float m8137max(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt.maxOrNull(sequence);
    }
    ...
    public static final /* synthetic */ Double m8138min(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
    ...
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* renamed from: min, reason: collision with other method in class */
    public static final /* synthetic */ Float m8139min(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt.minOrNull(sequence);
    }
