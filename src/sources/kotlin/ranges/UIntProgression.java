...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int i, int i2, int i3) {
        ...
        this.first = i;
        this.last = UProgressionUtilKt.m8074getProgressionLastElementNkh28Cs(i, i2, i3);
        this.step = i3;
    }
    ...
    public String toString() {
        ...
        int i;
        if (this.step > 0) {
            sbAppend = new StringBuilder().append((Object) UInt.m6994toStringimpl(this.first)).append("..").append((Object) UInt.m6994toStringimpl(this.last)).append(" step ");
            i = this.step;
        } else {
            sbAppend = new StringBuilder().append((Object) UInt.m6994toStringimpl(this.first)).append(" downTo ").append((Object) UInt.m6994toStringimpl(this.last)).append(" step ");
            i = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final UIntProgression m8090fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
