...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m8073getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM7027constructorimpl = ((int) ULong.m7027constructorimpl(j ^ ULong.m7027constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM7027constructorimpl2 = (iM7027constructorimpl + ((int) ULong.m7027constructorimpl(j2 ^ ULong.m7027constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return iM7027constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            sbAppend = new StringBuilder().append((Object) ULong.m7073toStringimpl(this.first)).append("..").append((Object) ULong.m7073toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sbAppend = new StringBuilder().append((Object) ULong.m7073toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m7073toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m8099fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
