...
@DebugMetadata(c = "id.go.bpsfasih.utils.sync.reqDownload.RDAnswerPartial$extractAnswer$1$assignmentPojo$1", f = "RDAnswerPartial.kt", i = {}, l = {158}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes2.dex */
final class RDAnswerPartial$extractAnswer$1$assignmentPojo$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Sync>, Object> {
    final /* synthetic */ Ref.ObjectRef<File> $file;
    int label;
    final /* synthetic */ RDAnswerPartial this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    RDAnswerPartial$extractAnswer$1$assignmentPojo$1(RDAnswerPartial rDAnswerPartial, Ref.ObjectRef<File> objectRef, Continuation<? super RDAnswerPartial$extractAnswer$1$assignmentPojo$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new RDAnswerPartial$extractAnswer$1$assignmentPojo$1(this.this$0, this.$file, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Sync> continuation) {
        return ((RDAnswerPartial$extractAnswer$1$assignmentPojo$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
