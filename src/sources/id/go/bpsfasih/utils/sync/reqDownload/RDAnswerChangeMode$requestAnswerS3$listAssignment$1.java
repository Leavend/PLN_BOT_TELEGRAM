...
@DebugMetadata(c = "id.go.bpsfasih.utils.sync.reqDownload.RDAnswerChangeMode$requestAnswerS3$listAssignment$1", f = "RDAnswerChangeMode.kt", i = {}, l = {153}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes2.dex */
final class RDAnswerChangeMode$requestAnswerS3$listAssignment$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends AssignmentEntity>>, Object> {
    int label;
    final /* synthetic */ RDAnswerChangeMode this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    RDAnswerChangeMode$requestAnswerS3$listAssignment$1(RDAnswerChangeMode rDAnswerChangeMode, Continuation<? super RDAnswerChangeMode$requestAnswerS3$listAssignment$1> continuation) {
        super(2, continuation);
        this.this$0 = rDAnswerChangeMode;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new RDAnswerChangeMode$requestAnswerS3$listAssignment$1(this.this$0, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super List<AssignmentEntity>> continuation) {
        return ((RDAnswerChangeMode$requestAnswerS3$listAssignment$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
