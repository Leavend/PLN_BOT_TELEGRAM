...
@DebugMetadata(c = "id.go.bpsfasih.utils.sync.reqDownload.RDAnswerPartialDraft$requestAnswerS3$listAssignment$1", f = "RDAnswerPartialDraft.kt", i = {}, l = {185}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes2.dex */
final class RDAnswerPartialDraft$requestAnswerS3$listAssignment$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends AssignmentEntity>>, Object> {
    int label;
    final /* synthetic */ RDAnswerPartialDraft this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    RDAnswerPartialDraft$requestAnswerS3$listAssignment$1(RDAnswerPartialDraft rDAnswerPartialDraft, Continuation<? super RDAnswerPartialDraft$requestAnswerS3$listAssignment$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new RDAnswerPartialDraft$requestAnswerS3$listAssignment$1(this.this$0, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super List<AssignmentEntity>> continuation) {
        return ((RDAnswerPartialDraft$requestAnswerS3$listAssignment$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
