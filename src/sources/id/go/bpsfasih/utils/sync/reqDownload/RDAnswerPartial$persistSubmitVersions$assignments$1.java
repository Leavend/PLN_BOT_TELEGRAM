...
@DebugMetadata(c = "id.go.bpsfasih.utils.sync.reqDownload.RDAnswerPartial$persistSubmitVersions$assignments$1", f = "RDAnswerPartial.kt", i = {}, l = {276}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes2.dex */
final class RDAnswerPartial$persistSubmitVersions$assignments$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends AssignmentEntity>>, Object> {
    final /* synthetic */ List<String> $assignmentIds;
    int label;
    final /* synthetic */ RDAnswerPartial this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    RDAnswerPartial$persistSubmitVersions$assignments$1(RDAnswerPartial rDAnswerPartial, List<String> list, Continuation<? super RDAnswerPartial$persistSubmitVersions$assignments$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new RDAnswerPartial$persistSubmitVersions$assignments$1(this.this$0, this.$assignmentIds, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super List<AssignmentEntity>> continuation) {
        return ((RDAnswerPartial$persistSubmitVersions$assignments$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
