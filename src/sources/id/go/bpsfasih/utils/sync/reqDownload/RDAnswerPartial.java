...
public final class RDAnswerPartial {
    ...
    public RDAnswerPartial(SyncAnswerPartial unit, Function3<? super String, ? super Boolean, ? super Double, Unit> callback) {
    ...
    private final void requestAnswerNfs() {
        ...
        Downloader.INSTANCE.requestAnswer(str2, strPathTempAnswer, str3, new Function2<String, Boolean, Unit>() { // from class: id.go.bpsfasih.utils.sync.reqDownload.RDAnswerPartial.requestAnswerNfs.1
            ...
            public final void invoke(String str4, boolean z) {
                if (!z) {
                    RDAnswerPartial rDAnswerPartial = RDAnswerPartial.this;
                    AnswerBeforeSaveModel answerBeforeSaveModel = new AnswerBeforeSaveModel(strPathTempAnswer, str3, idPeriode, idSurvey, userId);
                    final RDAnswerPartial rDAnswerPartial2 = RDAnswerPartial.this;
                    rDAnswerPartial.extract(answerBeforeSaveModel, new Function3<String, Boolean, Double, Unit>() { // from class: id.go.bpsfasih.utils.sync.reqDownload.RDAnswerPartial.requestAnswerNfs.1.1
                        {
                            super(3);
                        }
                        ...
                        public final void invoke(String str5, boolean z2, double d) {
                            rDAnswerPartial2.getCallback().invoke(str5, Boolean.valueOf(z2), Double.valueOf(d));
                        }
                    });
                    return;
                }
                RDAnswerPartial.this.getCallback().invoke(str4, true, Double.valueOf(-100.0d));
            }
        });
    }
    ...
    public final void extract(AnswerBeforeSaveModel periodAnswer, final Function3<? super String, ? super Boolean, ? super Double, Unit> callback) {
        ...
        if (new File(companion2.pathTempAnswerZip(surveyId2, periodeId2 != null ? periodeId2 : "", periodAnswer.getFilename())).exists()) {
            ...
            if (zUnZip$default) {
                processExtract(strPathTempAnswer, new Function0<Unit>() { // from class: id.go.bpsfasih.utils.sync.reqDownload.RDAnswerPartial$extract$1$1$1$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(0);
                    ...
                    public final void invoke2() throws InterruptedException {
                        ...
                        if (listAssignmentIdNfs != null) {
                            RDAnswerPartial rDAnswerPartial = this.this$0;
                            rDAnswerPartial.assignmentaRepo.updateDataDownloadedAtByIds(listAssignmentIdNfs);
                            rDAnswerPartial.persistSubmitVersions(listAssignmentIdNfs);
                        }
    ...
    private final void processExtract(String tempDirAnswer, final Function0<Unit> callback) {
        ...
        extractAnswer(arrayList, tempDirAnswer, new Function0<Unit>() { // from class: id.go.bpsfasih.utils.sync.reqDownload.RDAnswerPartial.processExtract.3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        if (filesZip.size() > 0 && (size = filesZip.size() - 1) >= 0) {
            while (true) {
                ...
                if (((File) objectRef.element) != null) {
                    ...
                    Sync sync = (Sync) BuildersKt__BuildersKt.runBlocking$default(null, new RDAnswerPartial$extractAnswer$1$assignmentPojo$1(this, objectRef, null), 1, null);
                    if (sync != null) {
                        ...
                        if (assignmentStatusId != null && assignmentStatusId.intValue() == assignment_status_open && !assignment.getPendingStatus()) {
                            ...
                            companion.extractZip(path, out, new Function1<Boolean, Unit>() { // from class: id.go.bpsfasih.utils.sync.reqDownload.RDAnswerPartial$extractAnswer$1$1
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(1);
                                }
    ...
    private final void requestAnswerS3() {
        new AssignmentRepositoryImpl().getPresignS3AnswerAssignment(this.unit.getIdPeriode(), (List) BuildersKt__BuildersKt.runBlocking$default(null, new RDAnswerPartial$requestAnswerS3$listAssignment$1(this, null), 1, null), new Function1<S3Response, Unit>() { // from class: id.go.bpsfasih.utils.sync.reqDownload.RDAnswerPartial.requestAnswerS3.1
            {
                super(1);
            }
            ...
            public final void invoke2(S3Response s3Response) {
                ...
                if (s3Response != null) {
                    ArrayList arrayList = RDAnswerPartial.this.listS3;
                    List<S3Entity> data = s3Response.getData();
                    Intrinsics.checkNotNull(data);
                    arrayList.addAll(data);
                    RDAnswerPartial.this.sumSuccess = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE;
                    RDAnswerPartial rDAnswerPartial = RDAnswerPartial.this;
                    rDAnswerPartial.countS3 = rDAnswerPartial.listS3.size();
                    RDAnswerPartial.this.unduhAnswer();
                    return;
                }
                RDAnswerPartial.this.getCallback().invoke("Gagal mengunduh presign url", true, Double.valueOf(-100.0d));
            }
        });
    }
    ...
    public final void unduhAnswer() {
        ...
        Downloader.INSTANCE.requestAnswer(presignedUrl, strPathTempAnswer, fileName, new Function2<String, Boolean, Unit>() { // from class: id.go.bpsfasih.utils.sync.reqDownload.RDAnswerPartial.unduhAnswer.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            }
            ...
            public final void invoke(String str, boolean z) throws InterruptedException {
                if (!z) {
                    ...
                    RDAnswerPartial.extractAnswer$default(rDAnswerPartial, assignmentId, strPathTempAnswer + InternalZipConstants.ZIP_FILE_SEPARATOR + fileName, false, 4, null);
                    return;
                }
                RDAnswerPartial.this.getCallback().invoke(str, true, Double.valueOf(-100.0d));
            }
        });
    }

    static /* synthetic */ void extractAnswer$default(RDAnswerPartial rDAnswerPartial, String str, String str2, boolean z, int i, Object obj) throws InterruptedException {
        if ((i & 4) != 0) {
            z = false;
        }
        rDAnswerPartial.extractAnswer(str, str2, z);
    }
    ...
    private final void extractAnswer(final String assignmentId, final String pathInput, boolean isSingleDownload) throws InterruptedException {
        final AssignmentEntity assignmentEntity = (AssignmentEntity) BuildersKt__BuildersKt.runBlocking$default(null, new RDAnswerPartial$extractAnswer$assignment$1(this, assignmentId, null), 1, null);
        Intrinsics.checkNotNull(assignmentEntity);
        Integer assignmentStatusId = assignmentEntity.getAssignmentStatusId();
        int assignment_status_open = CommonCons.INSTANCE.getASSIGNMENT_STATUS_OPEN();
        if (assignmentStatusId != null && assignmentStatusId.intValue() == assignment_status_open && !assignmentEntity.getPendingStatus()) {
        ...
        if (StringsKt.endsWith$default(pathInput, ".7z", false, 2, (Object) null)) {
            ZipHelper.INSTANCE.extractZip(pathInput, FileHelper.INSTANCE.pathAnswer(this.unit.getIdSurvey(), this.unit.getIdPeriode()), new Function1<Boolean, Unit>() { // from class: id.go.bpsfasih.utils.sync.reqDownload.RDAnswerPartial.extractAnswer.2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke(boolean z) throws InterruptedException {
                    ...
                    this.persistSubmitVersion(assignmentId, assignmentEntity.getSubmitVersionCode());
                    Function3<String, Boolean, Double, Unit> callback = this.getCallback();
                    RDAnswerPartial rDAnswerPartial = this;
                    rDAnswerPartial.sumSuccess += 1.0d;
                    callback.invoke("Sukses", false, Double.valueOf((rDAnswerPartial.sumSuccess / this.countS3) * 100));
                    if (this.listS3.size() != 0) {
                        this.unduhAnswer();
                    }
                }
        ...
        if (StringsKt.endsWith$default(pathInput, ".zip", false, 2, (Object) null)) {
            ...
            this.assignmentaRepo.updateDataDownloadedAt(assignmentId);
            persistSubmitVersion(assignmentId, assignmentEntity.getSubmitVersionCode());
            Function3<String, Boolean, Double, Unit> function32 = this.callback;
            double d2 = this.sumSuccess + 1.0d;
            this.sumSuccess = d2;
            function32.invoke("Sukses", false, Double.valueOf((d2 / this.countS3) * 100));
            if (this.listS3.size() != 0) {
                unduhAnswer();
            }
        }
    ...
    public final void persistSubmitVersions(List<String> assignmentIds) throws InterruptedException {
        for (AssignmentEntity assignmentEntity : (List) BuildersKt__BuildersKt.runBlocking$default(null, new RDAnswerPartial$persistSubmitVersions$assignments$1(this, assignmentIds, null), 1, null)) {
    ...
    @DebugMetadata(c = "id.go.bpsfasih.utils.sync.reqDownload.RDAnswerPartial$persistSubmitVersion$1", f = "RDAnswerPartial.kt", i = {}, l = {285}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: id.go.bpsfasih.utils.sync.reqDownload.RDAnswerPartial$persistSubmitVersion$1, reason: invalid class name */
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return RDAnswerPartial.this.new AnonymousClass1(this.$assignmentId, this.$submitVersionCode, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (RDAnswerPartial.this.assignmentSubmitVersionRepo.upsert(this.$assignmentId, this.$submitVersionCode, this) == coroutine_suspended) {
