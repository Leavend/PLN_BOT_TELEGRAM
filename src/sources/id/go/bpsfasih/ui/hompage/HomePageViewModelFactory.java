...
public final class HomePageViewModelFactory implements ViewModelProvider.Factory {
    ...
    public <T extends ViewModel> T create(Class<T> modelClass) {
        ...
        return new HomePageViewModel(this.mApplication, this.activity, this.fragmentManager);
    }
}
