...
@DebugMetadata(c = "id.go.bpsfasih.ui.unduhChangeMode.UnduhChangeModeViewModel$mapData$customData$1", f = "UnduhChangeModeViewModel.kt", i = {}, l = {126}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes2.dex */
final class UnduhChangeModeViewModel$mapData$customData$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super CustomDataTemplateEntity>, Object> {
    final /* synthetic */ String $templateId;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    UnduhChangeModeViewModel$mapData$customData$1(String str, Continuation<? super UnduhChangeModeViewModel$mapData$customData$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new UnduhChangeModeViewModel$mapData$customData$1(this.$templateId, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super CustomDataTemplateEntity> continuation) {
        return ((UnduhChangeModeViewModel$mapData$customData$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
