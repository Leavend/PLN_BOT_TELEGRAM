...
@DebugMetadata(c = "id.go.bpsfasih.ui.formGear.FormGearActivity$loadContentSafely$assignment$1", f = "FormGearActivity.kt", i = {}, l = {898}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes2.dex */
final class FormGearActivity$loadContentSafely$assignment$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super AssignmentEntity>, Object> {
    int label;
    final /* synthetic */ FormGearActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    FormGearActivity$loadContentSafely$assignment$1(FormGearActivity formGearActivity, Continuation<? super FormGearActivity$loadContentSafely$assignment$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new FormGearActivity$loadContentSafely$assignment$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super AssignmentEntity> continuation) {
        return ((FormGearActivity$loadContentSafely$assignment$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
