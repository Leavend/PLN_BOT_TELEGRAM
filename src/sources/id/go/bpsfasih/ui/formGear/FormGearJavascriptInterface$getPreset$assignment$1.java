...
@DebugMetadata(c = "id.go.bpsfasih.ui.formGear.FormGearJavascriptInterface$getPreset$assignment$1", f = "FormGearJavascriptInterface.kt", i = {}, l = {262}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes2.dex */
final class FormGearJavascriptInterface$getPreset$assignment$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Sync>, Object> {
    int label;
    final /* synthetic */ FormGearJavascriptInterface this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    FormGearJavascriptInterface$getPreset$assignment$1(FormGearJavascriptInterface formGearJavascriptInterface, Continuation<? super FormGearJavascriptInterface$getPreset$assignment$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new FormGearJavascriptInterface$getPreset$assignment$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Sync> continuation) {
        return ((FormGearJavascriptInterface$getPreset$assignment$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
