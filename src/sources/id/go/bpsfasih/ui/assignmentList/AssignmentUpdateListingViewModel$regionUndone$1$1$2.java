...
import id.go.bpsfasih.ui.assignmentList.AssignmentUpdateListingViewModel$regionUndone$1$1$2;
...
final class AssignmentUpdateListingViewModel$regionUndone$1$1$2 extends Lambda implements Function1<AssignmentRegionResponse, Unit> {
    ...
    AssignmentUpdateListingViewModel$regionUndone$1$1$2(AssignmentUpdateListingViewModel assignmentUpdateListingViewModel, Ref.ObjectRef<AssignmentRegionRepository> objectRef) {
        super(1);
    ...
    public final void invoke2(AssignmentRegionResponse assignmentRegionResponse) {
        ...
        activity.runOnUiThread(new Runnable() { // from class: id.go.bpsfasih.ui.assignmentList.AssignmentUpdateListingViewModel$regionUndone$1$1$2$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                AssignmentUpdateListingViewModel$regionUndone$1$1$2.invoke$lambda$0(assignmentUpdateListingViewModel);
            }
        });
    ...
    @DebugMetadata(c = "id.go.bpsfasih.ui.assignmentList.AssignmentUpdateListingViewModel$regionUndone$1$1$2$2", f = "AssignmentUpdateListingViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: id.go.bpsfasih.ui.assignmentList.AssignmentUpdateListingViewModel$regionUndone$1$1$2$2, reason: invalid class name */
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (assignmentRegionResponse != null) {
                ...
                if (Intrinsics.areEqual(assignmentRegionResponse.getSuccess(), Boxing.boxBoolean(true))) {
                    objectRef.element.insertAll(assignmentRegionResponse.getData(), new AssignmentUpdateListingViewModel$regionUndone$1$1$2$2$1$1(assignmentUpdateListingViewModel));
                } else {
                    assignmentUpdateListingViewModel.getActivity().runOnUiThread(new Runnable() { // from class: id.go.bpsfasih.ui.assignmentList.AssignmentUpdateListingViewModel$regionUndone$1$1$2$2$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            AssignmentUpdateListingViewModel$regionUndone$1$1$2.AnonymousClass2.invokeSuspend$lambda$1$lambda$0(assignmentUpdateListingViewModel, assignmentRegionResponse);
                        }
                    });
                }
                unit = Unit.INSTANCE;
            ...
            if (unit == null) {
                ...
                assignmentUpdateListingViewModel2.getActivity().runOnUiThread(new Runnable() { // from class: id.go.bpsfasih.ui.assignmentList.AssignmentUpdateListingViewModel$regionUndone$1$1$2$2$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        AssignmentUpdateListingViewModel$regionUndone$1$1$2.AnonymousClass2.invokeSuspend$lambda$3$lambda$2(assignmentUpdateListingViewModel2);
                    }
                });
            }
            return Unit.INSTANCE;
