...
@DebugMetadata(c = "id.go.bpsfasih.ui.assignmentList.AssignmentListActivity$showDialogAksi$periode$1", f = "AssignmentListActivity.kt", i = {}, l = {580}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes2.dex */
final class AssignmentListActivity$showDialogAksi$periode$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super PeriodeEntityNew>, Object> {
    int label;
    final /* synthetic */ AssignmentListActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    AssignmentListActivity$showDialogAksi$periode$1(AssignmentListActivity assignmentListActivity, Continuation<? super AssignmentListActivity$showDialogAksi$periode$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AssignmentListActivity$showDialogAksi$periode$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super PeriodeEntityNew> continuation) {
        return ((AssignmentListActivity$showDialogAksi$periode$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
