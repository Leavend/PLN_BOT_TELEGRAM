...
@DebugMetadata(c = "id.go.bpsfasih.ui.assignmentList.AssignmentUpdateListingViewModel$assignAssignment$periode$1", f = "AssignmentUpdateListingViewModel.kt", i = {}, l = {1225}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes2.dex */
final class AssignmentUpdateListingViewModel$assignAssignment$periode$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super PeriodeEntityNew>, Object> {
    int label;
    final /* synthetic */ AssignmentUpdateListingViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    AssignmentUpdateListingViewModel$assignAssignment$periode$1(AssignmentUpdateListingViewModel assignmentUpdateListingViewModel, Continuation<? super AssignmentUpdateListingViewModel$assignAssignment$periode$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AssignmentUpdateListingViewModel$assignAssignment$periode$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super PeriodeEntityNew> continuation) {
        return ((AssignmentUpdateListingViewModel$assignAssignment$periode$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
