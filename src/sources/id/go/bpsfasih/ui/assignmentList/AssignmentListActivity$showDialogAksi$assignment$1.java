...
@DebugMetadata(c = "id.go.bpsfasih.ui.assignmentList.AssignmentListActivity$showDialogAksi$assignment$1", f = "AssignmentListActivity.kt", i = {}, l = {572}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes2.dex */
final class AssignmentListActivity$showDialogAksi$assignment$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super AssignmentEntity>, Object> {
    final /* synthetic */ String $assignmentId;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    AssignmentListActivity$showDialogAksi$assignment$1(String str, Continuation<? super AssignmentListActivity$showDialogAksi$assignment$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AssignmentListActivity$showDialogAksi$assignment$1(this.$assignmentId, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super AssignmentEntity> continuation) {
        return ((AssignmentListActivity$showDialogAksi$assignment$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
