...
@DebugMetadata(c = "id.go.bpsfasih.ui.tariksampel.TarikSampelActivity$initListener$1$1$1$sampling$1", f = "TarikSampelActivity.kt", i = {}, l = {79}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes2.dex */
final class TarikSampelActivity$initListener$1$1$1$sampling$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super TarikSampleEntity>, Object> {
    int label;
    final /* synthetic */ TarikSampelActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    TarikSampelActivity$initListener$1$1$1$sampling$1(TarikSampelActivity tarikSampelActivity, Continuation<? super TarikSampelActivity$initListener$1$1$1$sampling$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new TarikSampelActivity$initListener$1$1$1$sampling$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super TarikSampleEntity> continuation) {
        return ((TarikSampelActivity$initListener$1$1$1$sampling$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
