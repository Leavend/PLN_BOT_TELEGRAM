    ...
    public static final <T> Request.Builder commonTag(Request.Builder builder, KClass<T> type, T t) {
        ...
        if (t == 0) {
            ...
            if (builder.getTags$okhttp().isEmpty()) {
                ...
                linkedHashMapAsMutableMap = TypeIntrinsics.asMutableMap(builder.getTags$okhttp());
            }
