...
public final class _CacheControlCommonKt {
    ...
    public static final CacheControl.Builder commonMaxAge(CacheControl.Builder builder, int i, DurationUnit timeUnit) {
        ...
        builder.setMaxAgeSeconds$okhttp(commonClampToInt(Duration.m8200getInWholeSecondsimpl(DurationKt.toDuration(i, timeUnit))));
        return builder;
    }
    ...
    public static final CacheControl.Builder commonMaxStale(CacheControl.Builder builder, int i, DurationUnit timeUnit) {
        ...
        builder.setMaxStaleSeconds$okhttp(commonClampToInt(Duration.m8200getInWholeSecondsimpl(DurationKt.toDuration(i, timeUnit))));
        return builder;
    }
    ...
    public static final CacheControl.Builder commonMinFresh(CacheControl.Builder builder, int i, DurationUnit timeUnit) {
        ...
        builder.setMinFreshSeconds$okhttp(commonClampToInt(Duration.m8200getInWholeSecondsimpl(DurationKt.toDuration(i, timeUnit))));
        return builder;
    }
    ...
    */
    public static final okhttp3.CacheControl commonParse(okhttp3.CacheControl.Companion r29, okhttp3.Headers r30) throws java.lang.NumberFormatException {
        /*
