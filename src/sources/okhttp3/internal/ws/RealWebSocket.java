    ...
    public final void initReaderAndWriter(String name, Streams streams) throws IOException {
        ...
        synchronized (this) {
            ...
            if (this.pingIntervalMillis != 0) {
                ...
                this.taskQueue.schedule(name + " ping", nanos, new Function0<Long>() { // from class: okhttp3.internal.ws.RealWebSocket$initReaderAndWriter$1$1
            ...
            if (byteStringPoll == null) {
                ...
                if (objPoll instanceof Close) {
                    ...
                    if (i != -1) {
                        ...
                        TaskQueue.execute$default(this.taskQueue, this.name + " cancel", TimeUnit.MILLISECONDS.toNanos(((Close) objPoll).getCancelAfterCloseMillis()), false, new Function0<Unit>() { // from class: okhttp3.internal.ws.RealWebSocket$writeOneFrame$1$1
                            {
                                super(0);
                            }
