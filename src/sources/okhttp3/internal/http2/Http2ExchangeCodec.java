    ...
    public static final class Companion {
        ...
        public final List<Header> http2HeadersList(Request request) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                String strLowercase = _UtilJvmKt.lowercase(strName, US);
                if (!Http2ExchangeCodec.HTTP_2_SKIPPED_REQUEST_HEADERS.contains(strLowercase) || (Intrinsics.areEqual(strLowercase, Http2ExchangeCodec.TE) && Intrinsics.areEqual(headers.value(i), GrpcUtil.TE_TRAILERS))) {
                    arrayList.add(new Header(strLowercase, headers.value(i)));
                }
            }
            return arrayList;
        }
        ...
        public final Response.Builder readHttp2HeadersList(Headers headerBlock, Protocol protocol) throws IOException {
            ...
            return new Response.Builder().protocol(protocol).code(statusLine.code).message(statusLine.message).headers(builder.build()).trailers(new Function0<Headers>() { // from class: okhttp3.internal.http2.Http2ExchangeCodec$Companion$readHttp2HeadersList$1
