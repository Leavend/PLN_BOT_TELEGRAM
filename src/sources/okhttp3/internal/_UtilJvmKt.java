...
public final class _UtilJvmKt {
    ...
    public static final EventListener m8561asFactory$lambda7(EventListener this_asFactory, Call it) {
    ...
    public static final ThreadFactory threadFactory(final String name, final boolean z) {
        ...
        return new ThreadFactory() { // from class: okhttp3.internal._UtilJvmKt$$ExternalSyntheticLambda0
            ...
            public final Thread newThread(Runnable runnable) {
                return _UtilJvmKt.m8562threadFactory$lambda1(name, z, runnable);
            }
        };
    }
    ...
    public static final Thread m8562threadFactory$lambda1(String name, boolean z, Runnable runnable) {
        Intrinsics.checkNotNullParameter(name, "$name");
    ...
    public static final EventListener.Factory asFactory(final EventListener eventListener) {
        ...
        return new EventListener.Factory() { // from class: okhttp3.internal._UtilJvmKt$$ExternalSyntheticLambda1
            ...
            public final EventListener create(Call call) {
                return _UtilJvmKt.m8561asFactory$lambda7(eventListener, call);
            }
        };
    }
