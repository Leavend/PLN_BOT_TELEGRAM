...
public final class Http1ExchangeCodec implements ExchangeCodec {
    ...
    public Response.Builder readResponseHeaders(boolean expectContinue) throws IOException {
        ...
        try {
            ...
            Response.Builder builderTrailers = new Response.Builder().protocol(statusLine.protocol).code(statusLine.code).message(statusLine.message).headers(this.headersReader.readHeaders()).trailers(new Function0<Headers>() { // from class: okhttp3.internal.http1.Http1ExchangeCodec$readResponseHeaders$responseBuilder$1
