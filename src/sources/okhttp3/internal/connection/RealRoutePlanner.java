...
public final class RealRoutePlanner implements RoutePlanner {
    ...
    public RealRoutePlanner(OkHttpClient client, Address address, RealCall call, RealInterceptorChain chain) {
        ...
        this.call = call;
        this.doExtensiveHealthChecks = !Intrinsics.areEqual(chain.getRequest().method(), HttpGet.METHOD_NAME);
    ...
    public final ReusePlan planReusePooledConnection$okhttp(ConnectPlan planToReplace, List<Route> routes) throws IOException {
