...
public final class ConnectPlan implements RoutePlanner.Plan, ExchangeCodec.Carrier {
    ...
    */
    public okhttp3.internal.connection.RoutePlanner.ConnectResult mo8568connectTlsEtc() throws java.lang.Throwable {
        /*
            Method dump skipped, instructions count: 548
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.connection.ConnectPlan.mo8568connectTlsEtc():okhttp3.internal.connection.RoutePlanner$ConnectResult");
    }
    ...
    public RealConnection mo8564handleSuccess() throws IOException {
    ...
    /* renamed from: cancel */
    public void mo8563cancel() throws IOException {
        this.canceled = true;
        Socket socket = this.rawSocket;
        if (socket != null) {
            _UtilJvmKt.closeQuietly(socket);
    ...
    @Override // okhttp3.internal.connection.RoutePlanner.Plan
    /* renamed from: retry */
    public RoutePlanner.Plan mo8565retry() {
