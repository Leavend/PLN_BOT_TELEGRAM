...
@Metadata(d1 = {"\u0000\b\n\u0000\n\u0002\u0010\u000e\n\u0000\u001a\f\u0010\u0000\u001a\u0004\u0018\u00010\u0001*\u00020\u0001¨\u0006\u0002"}, d2 = {"toCanonicalHost", "", "okhttp"}, k = 2, mv = {1, 6, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class _HostnamesJvmKt {
    public static final String toCanonicalHost(String str) {
        ...
        try {
            ...
            strLowercase = _UtilJvmKt.lowercase(ascii, US);
        } catch (IllegalArgumentException unused) {
        }
        if (strLowercase.length() == 0) {
            return null;
        }
        if (_HostnamesCommonKt.containsInvalidHostnameAsciiCodes(strLowercase) || _HostnamesCommonKt.containsInvalidLabelLengths(strLowercase)) {
        } else {
            str2 = strLowercase;
        }
        return str2;
