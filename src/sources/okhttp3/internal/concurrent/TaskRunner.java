...
public final class TaskRunner {
    ...
    public TaskRunner(Backend backend, Logger logger2) {
        ...
        this.logger = logger2;
        this.nextQueueName = Operator.PRECEDENCE_POWER;
