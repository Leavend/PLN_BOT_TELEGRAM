...
public final class HttpUrl {
    ...
    public final URL m8494deprecated_url() {
        return url();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to toUri()", replaceWith = @ReplaceWith(expression = "toUri()", imports = {}))
    /* renamed from: -deprecated_uri, reason: not valid java name */
    public final URI m8493deprecated_uri() {
        return uri();
    }
    ...
    public final String m8482deprecated_encodedUsername() {
    ...
    public final String m8478deprecated_encodedPassword() {
    ...
    public final int m8487deprecated_pathSize() {
        return pathSize();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "encodedPath", imports = {}))
    /* renamed from: -deprecated_encodedPath, reason: not valid java name */
    public final String m8479deprecated_encodedPath() {
        return encodedPath();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "encodedPathSegments", imports = {}))
    /* renamed from: -deprecated_encodedPathSegments, reason: not valid java name */
    public final List<String> m8480deprecated_encodedPathSegments() {
        return encodedPathSegments();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "pathSegments", imports = {}))
    /* renamed from: -deprecated_pathSegments, reason: not valid java name */
    public final List<String> m8486deprecated_pathSegments() {
        return this.pathSegments;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "encodedQuery", imports = {}))
    /* renamed from: -deprecated_encodedQuery, reason: not valid java name */
    public final String m8481deprecated_encodedQuery() {
        return encodedQuery();
    }
    ...
    public final String m8489deprecated_query() {
        return query();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "querySize", imports = {}))
    /* renamed from: -deprecated_querySize, reason: not valid java name */
    public final int m8491deprecated_querySize() {
        return querySize();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "queryParameterNames", imports = {}))
    /* renamed from: -deprecated_queryParameterNames, reason: not valid java name */
    public final Set<String> m8490deprecated_queryParameterNames() {
        return queryParameterNames();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "encodedFragment", imports = {}))
    /* renamed from: -deprecated_encodedFragment, reason: not valid java name */
    public final String m8477deprecated_encodedFragment() {
        ...
        */
        ...
        public final Builder parse$okhttp(HttpUrl base, String input) throws NumberFormatException {
            ...
            if (iSlashCount >= 2 || base == null || !Intrinsics.areEqual(base.scheme(), this.scheme)) {
                ...
                boolean z8 = false;
                while (true) {
                    iDelimiterOffset = _UtilCommonKt.delimiterOffset(input2, "@/\\?#", i5, iIndexOfLastNonAsciiWhitespace$default);
                    char cCharAt = iDelimiterOffset != iIndexOfLastNonAsciiWhitespace$default ? input2.charAt(iDelimiterOffset) : c4;
                    if (cCharAt == '@') {
                        if (!z7) {
                            int iDelimiterOffset2 = _UtilCommonKt.delimiterOffset(input2, ':', i5, iDelimiterOffset);
                            z4 = z6;
                        ...
                        if ((((cCharAt != c && cCharAt != '/') ? false : z) || cCharAt == '\\') ? z : false) {
                            z2 = z;
                            c5 = '?';
                        } else {
                            c5 = '?';
                        ...
                        c4 = c;
                        z6 = z;
                        iIndexOfLastNonAsciiWhitespace$default = i;
                        str4 = str;
                    }
                }
                ...
                if (i6 < iDelimiterOffset) {
                    c3 = '\"';
                    i2 = i5;
                    this.host = _HostnamesJvmKt.toCanonicalHost(Companion.percentDecode$okhttp$default(HttpUrl.INSTANCE, input, i5, iPortColonOffset, false, 4, null));
                    ...
                    i2 = i5;
                    str2 = str;
                    this.host = _HostnamesJvmKt.toCanonicalHost(Companion.percentDecode$okhttp$default(HttpUrl.INSTANCE, input, i2, iPortColonOffset, false, 4, null));
            ...
            int i7 = i;
            int iDelimiterOffset3 = _UtilCommonKt.delimiterOffset(input2, "?#", iIndexOfFirstNonAsciiWhitespace$default, i7);
            resolvePath(input2, iIndexOfFirstNonAsciiWhitespace$default, iDelimiterOffset3);
            if (iDelimiterOffset3 < i7 && input2.charAt(iDelimiterOffset3) == c5) {
                int iDelimiterOffset4 = _UtilCommonKt.delimiterOffset(input2, '#', iDelimiterOffset3, i7);
    ...
    public static final class Companion {
        ...
        public final HttpUrl m8496deprecated_get(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        public final HttpUrl m8499deprecated_parse(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return parse(url);
        }
        ...
        @Deprecated(level = DeprecationLevel.ERROR, message = "moved to extension function", replaceWith = @ReplaceWith(expression = "url.toHttpUrlOrNull()", imports = {"okhttp3.HttpUrl.Companion.toHttpUrlOrNull"}))
        /* renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m8498deprecated_get(URL url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        /* renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m8497deprecated_get(URI uri) {
