...
public final class Request {
    ...
    public Request(HttpUrl url, Headers headers, String method, RequestBody requestBody) {
        this(new Builder().url(url).headers(headers).method(Intrinsics.areEqual(method, "\u0000") ? requestBody != null ? "POST" : HttpGet.METHOD_NAME : method, requestBody));
    ...
    public final CacheControl m8539deprecated_cacheControl() {
        return cacheControl();
    }
