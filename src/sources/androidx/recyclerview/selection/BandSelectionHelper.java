...
class BandSelectionHelper<K> implements RecyclerView.OnItemTouchListener, Resettable {
    ...
    BandSelectionHelper(BandHost<K> bandHost, AutoScroller autoScroller, ItemKeyProvider<K> itemKeyProvider, SelectionTracker<K> selectionTracker, BandPredicate bandPredicate, FocusDelegate<K> focusDelegate, OperationMonitor operationMonitor) {
    ...
    static <K> BandSelectionHelper<K> create(RecyclerView recyclerView, AutoScroller autoScroller, int i, ItemKeyProvider<K> itemKeyProvider, SelectionTracker<K> selectionTracker, SelectionTracker.SelectionPredicate<K> selectionPredicate, BandPredicate bandPredicate, FocusDelegate<K> focusDelegate, OperationMonitor operationMonitor) {
    ...
    private void startBandSelect(MotionEvent motionEvent) {
        ...
        Point origin = MotionEvents.getOrigin(motionEvent);
        GridModel<K> gridModelCreateGridModel = this.mHost.createGridModel();
        this.mModel = gridModelCreateGridModel;
        gridModelCreateGridModel.addOnSelectionChangedListener(this.mGridObserver);
        this.mLock.start();
