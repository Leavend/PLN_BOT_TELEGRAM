...
public final class FlowExtKt {
    ...
    static final class AnonymousClass1<T> extends SuspendLambda implements Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        static final class C01301 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            C01301(Flow<? extends T> flow, ProducerScope<? super T> producerScope, Continuation<? super C01301> continuation) {
                super(2, continuation);
                this.$this_flowWithLifecycle = flow;
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C01301(this.$this_flowWithLifecycle, this.$$this$callbackFlow, continuation);
            }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (RepeatOnLifecycleKt.repeatOnLifecycle(this.$lifecycle, this.$minActiveState, new C01301(this.$this_flowWithLifecycle, producerScope2, null), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
