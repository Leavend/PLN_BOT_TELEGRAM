...
public final class ViewMatchers {
    ...
    static final class HasDescendantMatcher extends TypeSafeDiagnosingMatcher<View> {
        ...
        /* synthetic */ boolean m6182xe0b846ea(View view, View view2) {
        ...
        public boolean matchesSafely(final View view, Description description) {
            ...
            if (Iterables.filter(TreeIterables.breadthFirstViewTraversal(view), new Predicate() { // from class: androidx.test.espresso.matcher.ViewMatchers$HasDescendantMatcher$$ExternalSyntheticLambda0
                ...
                public final boolean apply(Object obj) {
                    return this.f$0.m6182xe0b846ea(view, (View) obj);
                }
            }).iterator().hasNext()) {
                return true;
            }
    ...
    static final class WithCheckBoxStateMatcher<E extends View & Checkable> extends BoundedDiagnosingMatcher<View, E> {
        ...
        public boolean matchesSafely(E e, Description description) {
            boolean zIsChecked = e.isChecked();
    ...
    static final class WithIdMatcher extends TypeSafeDiagnosingMatcher<View> {
            ...
            while (matcher.find()) {
                if (this.resources != null) {
                    ...
                    if (strSafeGetResourceName != null) {
                        matcher.appendReplacement(stringBuffer, strGroup + InternalZipConstants.ZIP_FILE_SEPARATOR + strSafeGetResourceName);
                    } else {
        ...
        public boolean matchesSafely(View view, Description description) {
            ...
            if (!zMatches && !(description instanceof Description.NullDescription)) {
                description.appendText("view.getId() was ").appendText(getViewIdString("<" + view.getId() + ">"));
            }
            return zMatches;
        }
    }
    ...
    static final class WithTagKeyMatcher extends TypeSafeDiagnosingMatcher<View> {
        ...
        public boolean matchesSafely(View view, Description description) {
            ...
            description.appendText("view.getTag(" + this.key + ") ");
    ...
    private static <T> String getMismatchDescriptionString(T t, Matcher<T> matcher) {
        ...
        return strTrim.isEmpty() ? t.toString() : strTrim;
    }
        ...
        return new BoundedDiagnosingMatcher<View, TextView>(TextView.class) { // from class: androidx.test.espresso.matcher.ViewMatchers.1
            ...
            protected void describeMoreTo(Description description) {
                ...
                if (this.context == null) {
                    ...
                    description.appendText("value " + getColorHex(this.context.getColor(i)));
                }
            }
