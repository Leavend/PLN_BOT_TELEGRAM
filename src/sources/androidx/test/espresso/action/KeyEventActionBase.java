...
class KeyEventActionBase implements ViewAction {
    ...
    public void perform(UiController uiController, View view) {
        try {
            ...
            Log.e(TAG, "Failed to inject espressoKey event: " + String.valueOf(this.espressoKey));
            throw new PerformException.Builder().withActionDescription(getDescription()).withViewDescription(HumanReadables.describe(view)).withCause(new RuntimeException("Failed to inject espressoKey event " + String.valueOf(this.espressoKey))).build();
