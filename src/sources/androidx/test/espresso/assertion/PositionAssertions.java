        ...
        return new ViewAssertion() { // from class: androidx.test.espresso.assertion.PositionAssertions.1
            ...
            public void check(View view, NoMatchingViewException noMatchingViewException) {
                ...
                if (noMatchingViewException == null) {
                    ...
                    ViewMatchers.assertThat(stringDescription.toString(), Boolean.valueOf(PositionAssertions.isRelativePosition(view, PositionAssertions.findView(matcher, PositionAssertions.getTopViewGroup(view)), position)), Matchers.is(true));
                } else {
