...
public final class CacheBuilder {
    ...
    static final Supplier CACHE_STATS_COUNTER = new Supplier() { // from class: androidx.test.espresso.core.internal.deps.guava.cache.CacheBuilder$$ExternalSyntheticLambda0
        @Override // androidx.test.espresso.core.internal.deps.guava.base.Supplier
        public final Object get() {
            return CacheBuilder.lambda$static$0();
        }
    };
    static final Ticker NULL_TICKER = new Ticker() { // from class: androidx.test.espresso.core.internal.deps.guava.cache.CacheBuilder.2
