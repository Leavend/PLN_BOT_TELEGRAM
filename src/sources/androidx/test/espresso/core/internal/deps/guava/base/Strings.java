...
public final class Strings {
    ...
    private static String lenientToString(Object obj) {
        ...
        try {
            ...
            Logger.getLogger("androidx.test.espresso.core.internal.deps.guava.base.Strings").logp(Level.WARNING, "androidx.test.espresso.core.internal.deps.guava.base.Strings", "lenientToString", "Exception during lenientFormat for " + str, (Throwable) e);
