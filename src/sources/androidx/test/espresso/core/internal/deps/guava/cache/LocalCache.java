...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    static final ValueReference UNSET = new ValueReference() { // from class: androidx.test.espresso.core.internal.deps.guava.cache.LocalCache.1
    ...
    static final Queue DISCARDING_QUEUE = new AbstractQueue() { // from class: androidx.test.espresso.core.internal.deps.guava.cache.LocalCache.2
    ...
    static final class AccessQueue<K, V> extends AbstractQueue<ReferenceEntry<K, V>> {
        final ReferenceEntry head = new AbstractReferenceEntry(this) { // from class: androidx.test.espresso.core.internal.deps.guava.cache.LocalCache.AccessQueue.1
    ...
    static class LoadingValueReference implements ValueReference {
        ...
        /* synthetic */ Object m6174x59597480(Object obj) {
            set(obj);
            return obj;
        }
        ...
        public ListenableFuture loadFuture(Object obj, CacheLoader cacheLoader) {
            try {
                ...
                return listenableFutureReload == null ? Futures.immediateFuture(null) : Futures.transform(listenableFutureReload, new Function() { // from class: androidx.test.espresso.core.internal.deps.guava.cache.LocalCache$LoadingValueReference$$ExternalSyntheticLambda0
                    @Override // androidx.test.espresso.core.internal.deps.guava.base.Function
                    public final Object apply(Object obj3) {
                        return this.f$0.m6174x59597480(obj3);
                    }
    ...
    static class Segment extends ReentrantLock {
        ...
        ReferenceEntry getFirst(int i) {
            return (ReferenceEntry) this.table.get(i & (r0.length() - 1));
        }
        ...
        /* synthetic */ void m6175lambda$loadAsync$0$comgooglecommoncacheLocalCache$Segment(Object obj, int i, LoadingValueReference loadingValueReference, ListenableFuture listenableFuture) {
            try {
                getAndRecordStats(obj, i, loadingValueReference, listenableFuture);
            } catch (Throwable th) {
                LocalCache.logger.logp(Level.WARNING, "androidx.test.espresso.core.internal.deps.guava.cache.LocalCache$Segment", "lambda$loadAsync$0", "Exception thrown during refresh", th);
        ...
        ListenableFuture loadAsync(final Object obj, final int i, final LoadingValueReference loadingValueReference, CacheLoader cacheLoader) {
            ...
            listenableFutureLoadFuture.addListener(new Runnable() { // from class: androidx.test.espresso.core.internal.deps.guava.cache.LocalCache$Segment$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m6175lambda$loadAsync$0$comgooglecommoncacheLocalCache$Segment(obj, i, loadingValueReference, listenableFutureLoadFuture);
                }
            }, MoreExecutors.directExecutor());
        ...
        */
        java.lang.Object remove(java.lang.Object r12, int r13) {
            /*
                r11 = this;
                r11.lock()
                androidx.test.espresso.core.internal.deps.guava.cache.LocalCache r0 = r11.map     // Catch: java.lang.Throwable -> L78
                androidx.test.espresso.core.internal.deps.guava.base.Ticker r0 = r0.ticker     // Catch: java.lang.Throwable -> L78
            ...
            L1f:
                ...
                if (r3 != r13) goto L73
                if (r6 == 0) goto L73
                androidx.test.espresso.core.internal.deps.guava.cache.LocalCache r3 = r11.map     // Catch: java.lang.Throwable -> L78
                androidx.test.espresso.core.internal.deps.guava.base.Equivalence r3 = r3.keyEquivalence     // Catch: java.lang.Throwable -> L78
                boolean r3 = r3.equivalent(r12, r6)     // Catch: java.lang.Throwable -> L78
                if (r3 == 0) goto L73
                androidx.test.espresso.core.internal.deps.guava.cache.LocalCache$ValueReference r9 = r5.getValueReference()     // Catch: java.lang.Throwable -> L78
            ...
            L4f:
                ...
                r7 = r13
                r8 = r12
                androidx.test.espresso.core.internal.deps.guava.cache.ReferenceEntry r13 = r3.removeValueFromChain(r4, r5, r6, r7, r8, r9, r10)     // Catch: java.lang.Throwable -> L78
            ...
            L6c:
                ...
                return r2
            L73:
                androidx.test.espresso.core.internal.deps.guava.cache.ReferenceEntry r5 = r5.getNext()     // Catch: java.lang.Throwable -> L78
                goto L1f
            L78:
                r12 = move-exception
                r11.unlock()
        ...
        */
        java.lang.Object replace(java.lang.Object r18, int r19, java.lang.Object r20) {
            /*
                ...
                r0 = r19
                r17.lock()
                androidx.test.espresso.core.internal.deps.guava.cache.LocalCache r1 = r9.map     // Catch: java.lang.Throwable -> La7
                androidx.test.espresso.core.internal.deps.guava.base.Ticker r1 = r1.ticker     // Catch: java.lang.Throwable -> La7
            ...
            L24:
                ...
                if (r4 == 0) goto L9f
                androidx.test.espresso.core.internal.deps.guava.cache.LocalCache r1 = r9.map     // Catch: java.lang.Throwable -> La7
                androidx.test.espresso.core.internal.deps.guava.base.Equivalence r1 = r1.keyEquivalence     // Catch: java.lang.Throwable -> La7
                r14 = r18
                boolean r1 = r1.equivalent(r14, r4)     // Catch: java.lang.Throwable -> La7
                if (r1 == 0) goto La1
                androidx.test.espresso.core.internal.deps.guava.cache.LocalCache$ValueReference r15 = r12.getValueReference()     // Catch: java.lang.Throwable -> La7
                ...
                r6 = r16
                r7 = r15
                androidx.test.espresso.core.internal.deps.guava.cache.ReferenceEntry r0 = r1.removeValueFromChain(r2, r3, r4, r5, r6, r7, r8)     // Catch: java.lang.Throwable -> La7
            ...
            L9f:
                r14 = r18
            La1:
                androidx.test.espresso.core.internal.deps.guava.cache.ReferenceEntry r12 = r12.getNext()     // Catch: java.lang.Throwable -> La7
                goto L24
            La7:
                r0 = move-exception
                r17.unlock()
        ...
        /* JADX WARN: Code restructure failed: missing block: B:12:0x0048, code lost:
            ...
            if (r12.map.valueEquivalence.equivalent(r15, r8) == false) goto L14;
         */
        ...
        */
        boolean remove(java.lang.Object r13, int r14, java.lang.Object r15) {
            /*
                r12 = this;
                r12.lock()
                androidx.test.espresso.core.internal.deps.guava.cache.LocalCache r0 = r12.map     // Catch: java.lang.Throwable -> L7e
                androidx.test.espresso.core.internal.deps.guava.base.Ticker r0 = r0.ticker     // Catch: java.lang.Throwable -> L7e
                long r0 = r0.read()     // Catch: java.lang.Throwable -> L7e
            ...
            L1f:
                ...
                if (r3 != r14) goto L79
                if (r6 == 0) goto L79
                androidx.test.espresso.core.internal.deps.guava.cache.LocalCache r3 = r12.map     // Catch: java.lang.Throwable -> L7e
                androidx.test.espresso.core.internal.deps.guava.base.Equivalence r3 = r3.keyEquivalence     // Catch: java.lang.Throwable -> L7e
                boolean r3 = r3.equivalent(r13, r6)     // Catch: java.lang.Throwable -> L7e
                if (r3 == 0) goto L79
                androidx.test.espresso.core.internal.deps.guava.cache.LocalCache$ValueReference r9 = r5.getValueReference()     // Catch: java.lang.Throwable -> L7e
                java.lang.Object r8 = r9.get()     // Catch: java.lang.Throwable -> L7e
                androidx.test.espresso.core.internal.deps.guava.cache.LocalCache r13 = r12.map     // Catch: java.lang.Throwable -> L7e
                androidx.test.espresso.core.internal.deps.guava.base.Equivalence r13 = r13.valueEquivalence     // Catch: java.lang.Throwable -> L7e
            ...
            L57:
                ...
                r7 = r14
                r10 = r13
                androidx.test.espresso.core.internal.deps.guava.cache.ReferenceEntry r14 = r3.removeValueFromChain(r4, r5, r6, r7, r8, r9, r10)     // Catch: java.lang.Throwable -> L7e
            ...
            L72:
                ...
                return r2
            L79:
                androidx.test.espresso.core.internal.deps.guava.cache.ReferenceEntry r5 = r5.getNext()     // Catch: java.lang.Throwable -> L7e
                goto L1f
            L7e:
                r13 = move-exception
                r12.unlock()
        ...
        */
        boolean replace(java.lang.Object r18, int r19, java.lang.Object r20, java.lang.Object r21) {
            /*
                ...
                r0 = r19
                r17.lock()
                androidx.test.espresso.core.internal.deps.guava.cache.LocalCache r1 = r9.map     // Catch: java.lang.Throwable -> Lb9
                androidx.test.espresso.core.internal.deps.guava.base.Ticker r1 = r1.ticker     // Catch: java.lang.Throwable -> Lb9
                long r7 = r1.read()     // Catch: java.lang.Throwable -> Lb9
            ...
            L24:
                ...
                if (r4 == 0) goto Laf
                androidx.test.espresso.core.internal.deps.guava.cache.LocalCache r1 = r9.map     // Catch: java.lang.Throwable -> Lb9
                androidx.test.espresso.core.internal.deps.guava.base.Equivalence r1 = r1.keyEquivalence     // Catch: java.lang.Throwable -> Lb9
                r14 = r18
                boolean r1 = r1.equivalent(r14, r4)     // Catch: java.lang.Throwable -> Lb9
                if (r1 == 0) goto Lb1
                androidx.test.espresso.core.internal.deps.guava.cache.LocalCache$ValueReference r15 = r12.getValueReference()     // Catch: java.lang.Throwable -> Lb9
                ...
                r5 = r19
                r7 = r15
                androidx.test.espresso.core.internal.deps.guava.cache.ReferenceEntry r0 = r1.removeValueFromChain(r2, r3, r4, r5, r6, r7, r8)     // Catch: java.lang.Throwable -> Lb9
            ...
            L73:
                androidx.test.espresso.core.internal.deps.guava.cache.LocalCache r1 = r9.map     // Catch: java.lang.Throwable -> Lb9
                androidx.test.espresso.core.internal.deps.guava.base.Equivalence r1 = r1.valueEquivalence     // Catch: java.lang.Throwable -> Lb9
                r3 = r20
                ...
                int r1 = r1 + 1
                r9.modCount = r1     // Catch: java.lang.Throwable -> Lb9
                int r5 = r15.getWeight()     // Catch: java.lang.Throwable -> Lb9
            ...
            Lb1:
                r3 = r20
                androidx.test.espresso.core.internal.deps.guava.cache.ReferenceEntry r12 = r12.getNext()     // Catch: java.lang.Throwable -> Lb9
                goto L24
            Lb9:
                r0 = move-exception
                r17.unlock()
    ...
    static final class WriteQueue<K, V> extends AbstractQueue<ReferenceEntry<K, V>> {
        final ReferenceEntry head = new AbstractReferenceEntry(this) { // from class: androidx.test.espresso.core.internal.deps.guava.cache.LocalCache.WriteQueue.1
    ...
    public V put(K k, V v) {
        ...
        int iHash = hash(k);
        return (V) segmentFor(iHash).put(k, iHash, v, false);
    }
    ...
    public V get(Object obj) {
        ...
        int iHash = hash(obj);
        return (V) segmentFor(iHash).get(obj, iHash);
    }
    ...
    public V remove(Object obj) {
        ...
        int iHash = hash(obj);
        return (V) segmentFor(iHash).remove(obj, iHash);
    }
    ...
    static class ManualSerializationProxy<K, V> extends ForwardingCache<K, V> implements Serializable {
        ...
        CacheBuilder recreateCacheBuilder() {
            ...
            if (this.weigher != CacheBuilder.OneWeigher.INSTANCE) {
                cacheBuilderRemovalListener.weigher(this.weigher);
