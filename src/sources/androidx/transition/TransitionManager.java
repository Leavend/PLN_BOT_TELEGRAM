...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo6274clone = transition.mo6274clone();
        transitionMo6274clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo6274clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo6274clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo6274clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo6274clone = transition.mo6274clone();
        sceneChangeSetup(viewGroup, transitionMo6274clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo6274clone);
    }
