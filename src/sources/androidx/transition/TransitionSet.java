...
public class TransitionSet extends Transition {
    ...
    @Override // androidx.transition.Transition
    /* renamed from: clone */
    public Transition mo6274clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo6274clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo6274clone());
        }
