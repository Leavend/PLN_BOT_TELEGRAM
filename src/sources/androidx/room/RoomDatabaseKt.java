...
public final class RoomDatabaseKt {
    ...
    /* compiled from: RoomDatabase.kt */
    @Metadata(k = 3, mv = {1, 7, 1}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    @DebugMetadata(c = "androidx.room.RoomDatabaseKt", f = "RoomDatabase.kt", i = {0, 0}, l = {50, ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_TAG}, m = "withTransaction", n = {"$this$withTransaction", "block"}, s = {"L$0", "L$1"})
    /* renamed from: androidx.room.RoomDatabaseKt$withTransaction$1, reason: invalid class name and case insensitive filesystem */
    static final class C06991<R> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;
    ...
    /* JADX WARN: Removed duplicated region for block: B:28:0x0082 A[PHI: r7
    ...
    */
    public static final <R> java.lang.Object withTransaction(androidx.room.RoomDatabase r5, kotlin.jvm.functions.Function1<? super kotlin.coroutines.Continuation<? super R>, ? extends java.lang.Object> r6, kotlin.coroutines.Continuation<? super R> r7) throws java.lang.Throwable {
        /*
            boolean r0 = r7 instanceof androidx.room.RoomDatabaseKt.C06991
            if (r0 == 0) goto L14
            r0 = r7
            androidx.room.RoomDatabaseKt$withTransaction$1 r0 = (androidx.room.RoomDatabaseKt.C06991) r0
            int r1 = r0.label
    ...
    static final class C07002<R> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super R>, Object> {
        ...
        C07002(RoomDatabase roomDatabase, Function1<? super Continuation<? super R>, ? extends Object> function1, Continuation<? super C07002> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C07002 c07002 = new C07002(this.$this_withTransaction, this.$block, continuation);
            c07002.L$0 = obj;
            return c07002;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super R> continuation) {
            return ((C07002) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
                ...
                static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 0) {
                            ...
                            Intrinsics.checkNotNull(element);
                            cancellableContinuation.resumeWith(Result.m6852constructorimpl(element));
                            this.label = 1;
