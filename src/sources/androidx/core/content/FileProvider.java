    ...
    static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) throws IOException {
            ...
            try {
                ...
                return new Uri.Builder().scheme(FirebaseAnalytics.Param.CONTENT).authority(this.mAuthority).encodedPath(Uri.encode(entry.getKey()) + '/' + Uri.encode(strSubstring, InternalZipConstants.ZIP_FILE_SEPARATOR)).build();
