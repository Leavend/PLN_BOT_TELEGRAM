...
public final class SparseArrayKt {
    ...
    public static final class C06871<T> implements Iterator<T>, KMappedMarker {
        ...
        C06871(SparseArray<T> sparseArray) {
