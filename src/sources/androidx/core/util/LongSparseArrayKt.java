...
public final class LongSparseArrayKt {
    ...
    public static final class C06861<T> implements Iterator<T>, KMappedMarker {
        ...
        C06861(LongSparseArray<T> longSparseArray) {
    ...
    public static final <T> Iterator<T> valueIterator(LongSparseArray<T> longSparseArray) {
        return new C06861(longSparseArray);
    }
