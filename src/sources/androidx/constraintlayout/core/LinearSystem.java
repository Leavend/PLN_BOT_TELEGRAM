...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object obj) {
        ...
        if (obj instanceof ConstraintAnchor) {
            ...
            if (solverVariable.f76id == -1 || solverVariable.f76id > this.mVariablesID || this.mCache.mIndexedVariables[solverVariable.f76id] == null) {
                if (solverVariable.f76id != -1) {
                    solverVariable.reset();
                }
                int i = this.mVariablesID + 1;
                this.mVariablesID = i;
                this.mNumColumns++;
                solverVariable.f76id = i;
    ...
    public SolverVariable createSlackVariable() {
        ...
        this.mVariablesID = i;
        this.mNumColumns++;
        solverVariableAcquireSolverVariable.f76id = i;
    ...
    public SolverVariable createErrorVariable(int i, String str) {
        ...
        this.mNumColumns++;
        solverVariableAcquireSolverVariable.f76id = i2;
    ...
    */
    ...
    private final int optimize(Row row, boolean z) {
        ...
        while (!z2) {
            ...
            if (row.getKey() != null) {
                this.mAlreadyTestedCandidates[row.getKey().f76id] = true;
            }
            SolverVariable pivotCandidate = row.getPivotCandidate(this, this.mAlreadyTestedCandidates);
            if (pivotCandidate != null) {
                if (this.mAlreadyTestedCandidates[pivotCandidate.f76id]) {
                    return i2;
                }
                this.mAlreadyTestedCandidates[pivotCandidate.f76id] = true;
            }
            if (pivotCandidate != null) {
    ...
    public void addEquality(SolverVariable solverVariable, int i) {
        if (USE_BASIC_SYNONYMS && solverVariable.definitionId == -1) {
            ...
            for (int i2 = 0; i2 < this.mVariablesID + 1; i2++) {
                SolverVariable solverVariable2 = this.mCache.mIndexedVariables[i2];
                if (solverVariable2 != null && solverVariable2.isSynonym && solverVariable2.synonym == solverVariable.f76id) {
