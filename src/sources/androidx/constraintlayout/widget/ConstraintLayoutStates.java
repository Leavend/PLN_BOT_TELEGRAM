    ...
    */
    ...
    private void parseConstraintSet(Context context, XmlPullParser parser) throws NumberFormatException {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (attributeName != null && attributeValue != null && DownloadModel.ID.equals(attributeName)) {
                int identifier = attributeValue.contains(InternalZipConstants.ZIP_FILE_SEPARATOR) ? context.getResources().getIdentifier(attributeValue.substring(attributeValue.indexOf(47) + 1), DownloadModel.ID, context.getPackageName()) : -1;
                if (identifier == -1) {
