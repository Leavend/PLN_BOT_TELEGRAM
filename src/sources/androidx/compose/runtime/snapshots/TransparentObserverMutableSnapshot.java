...
public final class TransparentObserverMutableSnapshot extends MutableSnapshot {
    ...
    public void mo3034recordModified$runtime_release(StateObject state) {
        getCurrentSnapshot().mo3034recordModified$runtime_release(state);
    }
    ...
    public Void mo3032nestedActivated$runtime_release(Snapshot snapshot) {
        SnapshotStateMapKt.unsupported();
        throw new KotlinNothingValueException();
    }
    ...
    public Void mo3033nestedDeactivated$runtime_release(Snapshot snapshot) {
        SnapshotStateMapKt.unsupported();
        throw new KotlinNothingValueException();
    }
}
