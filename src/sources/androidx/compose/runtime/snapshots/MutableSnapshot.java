...
public class MutableSnapshot extends Snapshot {
    ...
    public void dispose() {
        ...
        super.dispose();
        mo3033nestedDeactivated$runtime_release(this);
    }
    ...
    public Snapshot takeNestedSnapshot(Function1<Object, Unit> readObserver) {
        ...
        synchronized (SnapshotKt.getLock()) {
            ...
            SnapshotKt.nextSnapshotId = i + 1;
            SnapshotKt.openSnapshots = SnapshotKt.openSnapshots.set(i);
            nestedReadonlySnapshot = new NestedReadonlySnapshot(i, SnapshotKt.addRange(getInvalid(), id2 + 1, i), readObserver, this);
        }
        if (!getApplied() && !getDisposed()) {
            int id3 = getId();
            synchronized (SnapshotKt.getLock()) {
