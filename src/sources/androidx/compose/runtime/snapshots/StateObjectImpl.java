...
public abstract class StateObjectImpl implements StateObject {
    ...
    public final void m3049recordReadInh_f27i8$runtime_release(int reader) {
        int iM3036constructorimpl;
        do {
            iM3036constructorimpl = ReaderKind.m3036constructorimpl(this.readerKind.get());
            if ((iM3036constructorimpl & reader) != 0) {
                return;
            }
        } while (!this.readerKind.compareAndSet(iM3036constructorimpl, ReaderKind.m3036constructorimpl(iM3036constructorimpl | reader)));
    }

    /* renamed from: isReadIn-h_f27i8$runtime_release, reason: not valid java name */
    public final boolean m3048isReadInh_f27i8$runtime_release(int reader) {
        return (reader & ReaderKind.m3036constructorimpl(this.readerKind.get())) != 0;
    }
}
