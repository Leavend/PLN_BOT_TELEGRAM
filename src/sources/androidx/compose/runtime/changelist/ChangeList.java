...
public final class ChangeList implements OperationsDebugStringFormattable {
    ...
    public final void pushRemember(RememberObserver value) {
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(remember.mo2956intParamNamew8GmfQM(Operation.IntParameter.m2982constructorimpl(i2)));
                i++;
            }
        }
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(remember.mo2957objectParamName31yXWZQ(Operation.ObjectParameter.m2993constructorimpl(i4)));
                i3++;
            }
        }
    ...
    public final void pushUpdateValue(Object value, int groupSlotIndex) {
        ...
        Operations.WriteScope.m3026setIntA6tL2VI(operationsM3021constructorimpl, Operation.IntParameter.m2982constructorimpl(0), groupSlotIndex);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(updateValue.mo2956intParamNamew8GmfQM(Operation.IntParameter.m2982constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(updateValue.mo2957objectParamName31yXWZQ(Operation.ObjectParameter.m2993constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushUpdateAuxData(Object data) {
        ...
        Operations.WriteScope.m3027setObjectDKhxnng(operationsM3021constructorimpl, Operation.ObjectParameter.m2993constructorimpl(0), data);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(updateAuxData.mo2956intParamNamew8GmfQM(Operation.IntParameter.m2982constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(updateAuxData.mo2957objectParamName31yXWZQ(Operation.ObjectParameter.m2993constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushEnsureGroupStarted(Anchor anchor) {
        ...
        Operations.WriteScope.m3027setObjectDKhxnng(operationsM3021constructorimpl, Operation.ObjectParameter.m2993constructorimpl(0), anchor);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(ensureGroupStarted.mo2956intParamNamew8GmfQM(Operation.IntParameter.m2982constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(ensureGroupStarted.mo2957objectParamName31yXWZQ(Operation.ObjectParameter.m2993constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushInsertSlots(Anchor anchor, SlotTable from) {
        ...
        Operations.WriteScope.m3027setObjectDKhxnng(operationsM3021constructorimpl, Operation.ObjectParameter.m2993constructorimpl(1), from);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(insertSlots.mo2956intParamNamew8GmfQM(Operation.IntParameter.m2982constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(insertSlots.mo2957objectParamName31yXWZQ(Operation.ObjectParameter.m2993constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushInsertSlots(Anchor anchor, SlotTable from, FixupList fixups) {
        ...
        Operations.WriteScope.m3027setObjectDKhxnng(operationsM3021constructorimpl, Operation.ObjectParameter.m2993constructorimpl(2), fixups);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(insertSlotsWithFixups.mo2956intParamNamew8GmfQM(Operation.IntParameter.m2982constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(insertSlotsWithFixups.mo2957objectParamName31yXWZQ(Operation.ObjectParameter.m2993constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushMoveCurrentGroup(int offset) {
        ...
        Operations.WriteScope.m3026setIntA6tL2VI(operationsM3021constructorimpl, Operation.IntParameter.m2982constructorimpl(0), offset);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(moveCurrentGroup.mo2956intParamNamew8GmfQM(Operation.IntParameter.m2982constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(moveCurrentGroup.mo2957objectParamName31yXWZQ(Operation.ObjectParameter.m2993constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushEndCompositionScope(Function1<? super Composition, Unit> action, Composition composition) {
        ...
        Operations.WriteScope.m3027setObjectDKhxnng(operationsM3021constructorimpl, Operation.ObjectParameter.m2993constructorimpl(0), action);
        Operation.EndCompositionScope endCompositionScope3 = Operation.EndCompositionScope.INSTANCE;
        Operations.WriteScope.m3027setObjectDKhxnng(operationsM3021constructorimpl, Operation.ObjectParameter.m2993constructorimpl(1), composition);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(endCompositionScope.mo2956intParamNamew8GmfQM(Operation.IntParameter.m2982constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(endCompositionScope.mo2957objectParamName31yXWZQ(Operation.ObjectParameter.m2993constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushRemoveNode(int removeFrom, int moveCount) {
        ...
        Operations.WriteScope.m3026setIntA6tL2VI(operationsM3021constructorimpl, Operation.IntParameter.m2982constructorimpl(0), removeFrom);
        Operation.RemoveNode removeNode3 = Operation.RemoveNode.INSTANCE;
        Operations.WriteScope.m3026setIntA6tL2VI(operationsM3021constructorimpl, Operation.IntParameter.m2982constructorimpl(1), moveCount);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(removeNode.mo2956intParamNamew8GmfQM(Operation.IntParameter.m2982constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(removeNode.mo2957objectParamName31yXWZQ(Operation.ObjectParameter.m2993constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushMoveNode(int to, int from, int count) {
        ...
        Operations.WriteScope.m3026setIntA6tL2VI(operationsM3021constructorimpl, Operation.IntParameter.m2982constructorimpl(1), to);
        Operation.MoveNode moveNode3 = Operation.MoveNode.INSTANCE;
        Operations.WriteScope.m3026setIntA6tL2VI(operationsM3021constructorimpl, Operation.IntParameter.m2982constructorimpl(0), from);
        Operation.MoveNode moveNode4 = Operation.MoveNode.INSTANCE;
        Operations.WriteScope.m3026setIntA6tL2VI(operationsM3021constructorimpl, Operation.IntParameter.m2982constructorimpl(2), count);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(moveNode.mo2956intParamNamew8GmfQM(Operation.IntParameter.m2982constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(moveNode.mo2957objectParamName31yXWZQ(Operation.ObjectParameter.m2993constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushAdvanceSlotsBy(int distance) {
        ...
        Operations.WriteScope.m3026setIntA6tL2VI(operationsM3021constructorimpl, Operation.IntParameter.m2982constructorimpl(0), distance);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(advanceSlotsBy.mo2956intParamNamew8GmfQM(Operation.IntParameter.m2982constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(advanceSlotsBy.mo2957objectParamName31yXWZQ(Operation.ObjectParameter.m2993constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushUps(int count) {
        ...
        Operations.WriteScope.m3026setIntA6tL2VI(operationsM3021constructorimpl, Operation.IntParameter.m2982constructorimpl(0), count);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(ups.mo2956intParamNamew8GmfQM(Operation.IntParameter.m2982constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(ups.mo2957objectParamName31yXWZQ(Operation.ObjectParameter.m2993constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushDowns(Object[] nodes) {
        if (!(nodes.length == 0)) {
            ...
            Operations.WriteScope.m3027setObjectDKhxnng(operationsM3021constructorimpl, Operation.ObjectParameter.m2993constructorimpl(0), nodes);
            ...
            for (int i2 = 0; i2 < ints; i2++) {
                if (((1 << i2) & operations.pushedIntMask) != 0) {
                    ...
                    sb.append(downs.mo2956intParamNamew8GmfQM(Operation.IntParameter.m2982constructorimpl(i2)));
                    i++;
                }
            }
            String string = sb.toString();
            ...
            for (int i4 = 0; i4 < objects; i4++) {
                if (((1 << i4) & operations.pushedObjectMask) != 0) {
                    ...
                    sb2.append(downs.mo2957objectParamName31yXWZQ(Operation.ObjectParameter.m2993constructorimpl(i4)));
                    i3++;
                }
            }
            String string2 = sb2.toString();
    ...
    public final void pushSideEffect(Function0<Unit> effect) {
        ...
        Operations.WriteScope.m3027setObjectDKhxnng(operationsM3021constructorimpl, Operation.ObjectParameter.m2993constructorimpl(0), effect);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(sideEffect.mo2956intParamNamew8GmfQM(Operation.IntParameter.m2982constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(sideEffect.mo2957objectParamName31yXWZQ(Operation.ObjectParameter.m2993constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushDetermineMovableContentNodeIndex(IntRef effectiveNodeIndexOut, Anchor anchor) {
        ...
        Operations.WriteScope.m3027setObjectDKhxnng(operationsM3021constructorimpl, Operation.ObjectParameter.m2993constructorimpl(0), effectiveNodeIndexOut);
        ...
        Operations.WriteScope.m3027setObjectDKhxnng(operationsM3021constructorimpl, Operation.ObjectParameter.m2993constructorimpl(1), anchor);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(determineMovableContentNodeIndex.mo2956intParamNamew8GmfQM(Operation.IntParameter.m2982constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(determineMovableContentNodeIndex.mo2957objectParamName31yXWZQ(Operation.ObjectParameter.m2993constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushCopyNodesToNewAnchorLocation(List<? extends Object> nodes, IntRef effectiveNodeIndex) {
        if (!nodes.isEmpty()) {
            ...
            Operations.WriteScope.m3027setObjectDKhxnng(operationsM3021constructorimpl, Operation.ObjectParameter.m2993constructorimpl(1), nodes);
            Operation.CopyNodesToNewAnchorLocation copyNodesToNewAnchorLocation3 = Operation.CopyNodesToNewAnchorLocation.INSTANCE;
            Operations.WriteScope.m3027setObjectDKhxnng(operationsM3021constructorimpl, Operation.ObjectParameter.m2993constructorimpl(0), effectiveNodeIndex);
            ...
            for (int i2 = 0; i2 < ints; i2++) {
                if (((1 << i2) & operations.pushedIntMask) != 0) {
                    ...
                    sb.append(copyNodesToNewAnchorLocation.mo2956intParamNamew8GmfQM(Operation.IntParameter.m2982constructorimpl(i2)));
                    i++;
                }
            }
            String string = sb.toString();
            ...
            for (int i4 = 0; i4 < objects; i4++) {
                if (((1 << i4) & operations.pushedObjectMask) != 0) {
                    ...
                    sb2.append(copyNodesToNewAnchorLocation.mo2957objectParamName31yXWZQ(Operation.ObjectParameter.m2993constructorimpl(i4)));
                    i3++;
                }
            }
            String string2 = sb2.toString();
    ...
    public final void pushCopySlotTableToAnchorLocation(MovableContentState resolvedState, CompositionContext parentContext, MovableContentStateReference from, MovableContentStateReference to) {
        ...
        Operations.WriteScope.m3027setObjectDKhxnng(operationsM3021constructorimpl, Operation.ObjectParameter.m2993constructorimpl(0), resolvedState);
        Operation.CopySlotTableToAnchorLocation copySlotTableToAnchorLocation3 = Operation.CopySlotTableToAnchorLocation.INSTANCE;
        Operations.WriteScope.m3027setObjectDKhxnng(operationsM3021constructorimpl, Operation.ObjectParameter.m2993constructorimpl(1), parentContext);
        Operation.CopySlotTableToAnchorLocation copySlotTableToAnchorLocation4 = Operation.CopySlotTableToAnchorLocation.INSTANCE;
        Operations.WriteScope.m3027setObjectDKhxnng(operationsM3021constructorimpl, Operation.ObjectParameter.m2993constructorimpl(3), to);
        Operation.CopySlotTableToAnchorLocation copySlotTableToAnchorLocation5 = Operation.CopySlotTableToAnchorLocation.INSTANCE;
        Operations.WriteScope.m3027setObjectDKhxnng(operationsM3021constructorimpl, Operation.ObjectParameter.m2993constructorimpl(2), from);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(copySlotTableToAnchorLocation.mo2956intParamNamew8GmfQM(Operation.IntParameter.m2982constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(copySlotTableToAnchorLocation.mo2957objectParamName31yXWZQ(Operation.ObjectParameter.m2993constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushReleaseMovableGroupAtCurrent(ControlledComposition composition, CompositionContext parentContext, MovableContentStateReference reference) {
        ...
        Operations.WriteScope.m3027setObjectDKhxnng(operationsM3021constructorimpl, Operation.ObjectParameter.m2993constructorimpl(0), composition);
        ...
        Operations.WriteScope.m3027setObjectDKhxnng(operationsM3021constructorimpl, Operation.ObjectParameter.m2993constructorimpl(2), reference);
        ...
        for (int i2 = 0; i2 < ints; i2++) {
            if (((1 << i2) & operations.pushedIntMask) != 0) {
                ...
                sb.append(releaseMovableGroupAtCurrent.mo2956intParamNamew8GmfQM(Operation.IntParameter.m2982constructorimpl(i2)));
                i++;
            }
        }
        String string = sb.toString();
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & operations.pushedObjectMask) != 0) {
                ...
                sb2.append(releaseMovableGroupAtCurrent.mo2957objectParamName31yXWZQ(Operation.ObjectParameter.m2993constructorimpl(i4)));
                i3++;
            }
        }
        String string2 = sb2.toString();
    ...
    public final void pushExecuteOperationsIn(ChangeList changeList, IntRef effectiveNodeIndex) {
        if (changeList.isNotEmpty()) {
            ...
            Operations.WriteScope.m3027setObjectDKhxnng(operationsM3021constructorimpl, Operation.ObjectParameter.m2993constructorimpl(0), changeList);
            Operation.ApplyChangeList applyChangeList3 = Operation.ApplyChangeList.INSTANCE;
            Operations.WriteScope.m3027setObjectDKhxnng(operationsM3021constructorimpl, Operation.ObjectParameter.m2993constructorimpl(1), effectiveNodeIndex);
            ...
            for (int i2 = 0; i2 < ints; i2++) {
                if (((1 << i2) & operations.pushedIntMask) != 0) {
                    ...
                    sb.append(applyChangeList.mo2956intParamNamew8GmfQM(Operation.IntParameter.m2982constructorimpl(i2)));
                    i++;
                }
            }
            String string = sb.toString();
            ...
            for (int i4 = 0; i4 < objects; i4++) {
                if (((1 << i4) & operations.pushedObjectMask) != 0) {
                    ...
                    sb2.append(applyChangeList.mo2957objectParamName31yXWZQ(Operation.ObjectParameter.m2993constructorimpl(i4)));
                    i3++;
                }
            }
            String string2 = sb2.toString();
