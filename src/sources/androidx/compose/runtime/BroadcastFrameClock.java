...
public final class BroadcastFrameClock implements MonotonicFrameClock {
    ...
    static final class FrameAwaiter<R> {
        ...
        public final void resume(long timeNanos) {
            ...
            try {
                ...
                objM6852constructorimpl = Result.m6852constructorimpl(this.onFrame.invoke(Long.valueOf(timeNanos)));
            } catch (Throwable th) {
    ...
    public final void fail(Throwable cause) {
        synchronized (this.lock) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                Result.Companion companion = Result.INSTANCE;
                continuation.resumeWith(Result.m6852constructorimpl(ResultKt.createFailure(cause)));
            }
            this.awaiters.clear();
            Unit unit = Unit.INSTANCE;
        }
    ...
    public <R> Object withFrameNanos(Function1<? super Long, ? extends R> function1, Continuation<? super R> continuation) {
        ...
        synchronized (this.lock) {
            ...
            if (th != null) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl2.resumeWith(Result.m6852constructorimpl(ResultKt.createFailure(th)));
            } else {
