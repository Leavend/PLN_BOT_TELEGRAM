...
public final class Updater<T> {
    ...
    public static final /* synthetic */ Updater m2943boximpl(Composer composer) {
        return new Updater(composer);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m2944constructorimpl(Composer composer) {
        return composer;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2945equalsimpl(Composer composer, Object obj) {
        return (obj instanceof Updater) && Intrinsics.areEqual(composer, ((Updater) obj).getComposer());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2946equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m2947hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2952toStringimpl(Composer composer) {
        return "Updater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m2945equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m2947hashCodeimpl(this.composer);
    }

    public String toString() {
        return m2952toStringimpl(this.composer);
    }
    ...
    public static final void m2950setimpl(Composer composer, int i, Function2<? super T, ? super Integer, Unit> function2) {
    ...
    /* renamed from: set-impl, reason: not valid java name */
    public static final <V> void m2951setimpl(Composer composer, V v, Function2<? super T, ? super V, Unit> function2) {
    ...
    public static final void m2953updateimpl(Composer composer, int i, Function2<? super T, ? super Integer, Unit> function2) {
    ...
    /* renamed from: update-impl, reason: not valid java name */
    public static final <V> void m2954updateimpl(Composer composer, V v, Function2<? super T, ? super V, Unit> function2) {
        boolean inserting = composer.getInserting();
    ...
    public static final void m2948initimpl(Composer composer, final Function1<? super T, Unit> function1) {
    ...
    public static final void m2949reconcileimpl(Composer composer, final Function1<? super T, Unit> function1) {
