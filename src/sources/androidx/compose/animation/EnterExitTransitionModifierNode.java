...
final class EnterExitTransitionModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    public final long m91sizeByStateUzc_VyU(EnterExitState targetState, long fullSize) {
        ...
        if (i == 2) {
            ChangeSize changeSize = this.enter.getData().getChangeSize();
            return (changeSize == null || (size = changeSize.getSize()) == null) ? fullSize : size.invoke(IntSize.m5897boximpl(fullSize)).getPackedValue();
        }
        if (i != 3) {
            throw new NoWhenBranchMatchedException();
        }
        ChangeSize changeSize2 = this.exit.getData().getChangeSize();
        return (changeSize2 == null || (size2 = changeSize2.getSize()) == null) ? fullSize : size2.invoke(IntSize.m5897boximpl(fullSize)).getPackedValue();
    }
    ...
    public final long m93targetOffsetByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        if (this.currentAlignment != null && getAlignment() != null && !Intrinsics.areEqual(this.currentAlignment, getAlignment())) {
            int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
            if (i == 1) {
                return IntOffset.INSTANCE.m5873getZeronOccac();
            }
            if (i == 2) {
                return IntOffset.INSTANCE.m5873getZeronOccac();
            }
            ...
            if (changeSize != null) {
                long packedValue = changeSize.getSize().invoke(IntSize.m5897boximpl(fullSize)).getPackedValue();
                Alignment alignment = getAlignment();
                Intrinsics.checkNotNull(alignment);
                long jMo3050alignKFBX0sM = alignment.mo3050alignKFBX0sM(fullSize, packedValue, LayoutDirection.Ltr);
                Alignment alignment2 = this.currentAlignment;
                Intrinsics.checkNotNull(alignment2);
                long jMo3050alignKFBX0sM2 = alignment2.mo3050alignKFBX0sM(fullSize, packedValue, LayoutDirection.Ltr);
                return IntOffsetKt.IntOffset(IntOffset.m5863getXimpl(jMo3050alignKFBX0sM) - IntOffset.m5863getXimpl(jMo3050alignKFBX0sM2), IntOffset.m5864getYimpl(jMo3050alignKFBX0sM) - IntOffset.m5864getYimpl(jMo3050alignKFBX0sM2));
            }
            return IntOffset.INSTANCE.m5873getZeronOccac();
        }
        return IntOffset.INSTANCE.m5873getZeronOccac();
    ...
    public MeasureResult mo90measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (measureScope.isLookingAhead()) {
            ...
            return MeasureScope.layout$default(measureScope, IntSize.m5905getWidthimpl(jIntSize), IntSize.m5904getHeightimpl(jIntSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$1
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable.PlacementScope placementScope) {
                    Placeable.PlacementScope.place$default(placementScope, placeableMo4684measureBRTryo0, 0, 0, 0.0f, 4, null);
                }
            }, 4, null);
        }
        final Function1<GraphicsLayerScope, Unit> function1Init = this.graphicsLayerBlock.init();
        final Placeable placeableMo4684measureBRTryo02 = measurable.mo4684measureBRTryo0(j);
        long jIntSize2 = IntSizeKt.IntSize(placeableMo4684measureBRTryo02.getWidth(), placeableMo4684measureBRTryo02.getHeight());
        final long j2 = AnimationModifierKt.m67isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : jIntSize2;
        ...
        State<IntSize> stateAnimate3 = deferredAnimation != null ? deferredAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$animSize$1
            ...
            public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                return IntSize.m5897boximpl(m94invokeYEO4UFw(enterExitState));
            }

            /* renamed from: invoke-YEO4UFw, reason: not valid java name */
            public final long m94invokeYEO4UFw(EnterExitState enterExitState) {
                return this.this$0.m91sizeByStateUzc_VyU(enterExitState, j2);
            }
        }) : null;
        if (stateAnimate3 != null) {
            jIntSize2 = stateAnimate3.getValue().getPackedValue();
        }
        long jM5702constrain4WqzIAM = ConstraintsKt.m5702constrain4WqzIAM(j, jIntSize2);
        Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation2 = this.offsetAnimation;
        final long jM5873getZeronOccac = (deferredAnimation2 == null || (stateAnimate2 = deferredAnimation2.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$offsetDelta$1
            @Override // kotlin.jvm.functions.Function1
            public final FiniteAnimationSpec<IntOffset> invoke(Transition.Segment<EnterExitState> segment) {
                return EnterExitTransitionKt.DefaultOffsetAnimationSpec;
            }
            ...
            public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                return IntOffset.m5854boximpl(m95invokeBjo55l4(enterExitState));
            }

            /* renamed from: invoke-Bjo55l4, reason: not valid java name */
            public final long m95invokeBjo55l4(EnterExitState enterExitState) {
                return this.this$0.m93targetOffsetByStateoFUgxo0(enterExitState, j2);
            }
        })) == null) ? IntOffset.INSTANCE.m5873getZeronOccac() : stateAnimate2.getValue().getPackedValue();
        Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation3 = this.slideAnimation;
        long jM5873getZeronOccac2 = (deferredAnimation3 == null || (stateAnimate = deferredAnimation3.animate(this.slideSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$slideOffset$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                return IntOffset.m5854boximpl(m96invokeBjo55l4(enterExitState));
            }

            /* renamed from: invoke-Bjo55l4, reason: not valid java name */
            public final long m96invokeBjo55l4(EnterExitState enterExitState) {
                return this.this$0.m92slideTargetValueByStateoFUgxo0(enterExitState, j2);
            }
        })) == null) ? IntOffset.INSTANCE.m5873getZeronOccac() : stateAnimate.getValue().getPackedValue();
        Alignment alignment2 = this.currentAlignment;
        long jMo3050alignKFBX0sM = alignment2 != null ? alignment2.mo3050alignKFBX0sM(j2, jM5702constrain4WqzIAM, LayoutDirection.Ltr) : IntOffset.INSTANCE.m5873getZeronOccac();
        final long jIntOffset = IntOffsetKt.IntOffset(IntOffset.m5863getXimpl(jMo3050alignKFBX0sM) + IntOffset.m5863getXimpl(jM5873getZeronOccac2), IntOffset.m5864getYimpl(jMo3050alignKFBX0sM) + IntOffset.m5864getYimpl(jM5873getZeronOccac2));
        return MeasureScope.layout$default(measureScope, IntSize.m5905getWidthimpl(jM5702constrain4WqzIAM), IntSize.m5904getHeightimpl(jM5702constrain4WqzIAM), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Placeable.PlacementScope placementScope) {
                placementScope.placeWithLayer(placeableMo4684measureBRTryo02, IntOffset.m5863getXimpl(jM5873getZeronOccac) + IntOffset.m5863getXimpl(jIntOffset), IntOffset.m5864getYimpl(jM5873getZeronOccac) + IntOffset.m5864getYimpl(jIntOffset), 0.0f, function1Init);
            }
        }, 4, null);
    }
    ...
    public final long m92slideTargetValueByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        ...
        long jM5873getZeronOccac = (slide == null || (slideOffset2 = slide.getSlideOffset()) == null) ? IntOffset.INSTANCE.m5873getZeronOccac() : slideOffset2.invoke(IntSize.m5897boximpl(fullSize)).getPackedValue();
        Slide slide2 = this.exit.getData().getSlide();
        long jM5873getZeronOccac2 = (slide2 == null || (slideOffset = slide2.getSlideOffset()) == null) ? IntOffset.INSTANCE.m5873getZeronOccac() : slideOffset.invoke(IntSize.m5897boximpl(fullSize)).getPackedValue();
        int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
        if (i == 1) {
            return IntOffset.INSTANCE.m5873getZeronOccac();
        }
        if (i == 2) {
            return jM5873getZeronOccac;
        }
        if (i == 3) {
            return jM5873getZeronOccac2;
        }
        throw new NoWhenBranchMatchedException();
    }
}
