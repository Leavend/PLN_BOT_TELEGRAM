...
final class SizeAnimationModifierNode$animateTo$data$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = Animatable.animateTo$default(this.$this_apply.getAnim(), IntSize.m5897boximpl(this.$targetSize), this.this$0.getAnimationSpec(), null, null, this, 12, null);
        ...
        if (animationResult.getEndReason() == AnimationEndReason.Finished && (listener = this.this$0.getListener()) != 0) {
            listener.invoke(IntSize.m5897boximpl(this.$this_apply.m111getStartSizeYbymL2g()), animationResult.getEndState().getValue());
        }
