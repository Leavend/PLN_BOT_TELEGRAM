...
public interface AnimatedContentTransitionScope<S> extends Transition.Segment<S> {
    ...
    EnterTransition mo40slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, Function1<? super Integer, Integer> initialOffset);

    /* renamed from: slideOutOfContainer-mOhB8PU, reason: not valid java name */
    ExitTransition mo41slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, Function1<? super Integer, Integer> targetOffset);
    ...
    public static final class SlideDirection {
        ...
        private static final int Left = m43constructorimpl(0);
        private static final int Right = m43constructorimpl(1);
        private static final int Up = m43constructorimpl(2);
        private static final int Down = m43constructorimpl(3);
        private static final int Start = m43constructorimpl(4);
        private static final int End = m43constructorimpl(5);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ SlideDirection m42boximpl(int i) {
        ...
        public static String m47toStringimpl(int i) {
            return m45equalsimpl0(i, Left) ? "Left" : m45equalsimpl0(i, Right) ? "Right" : m45equalsimpl0(i, Up) ? "Up" : m45equalsimpl0(i, Down) ? "Down" : m45equalsimpl0(i, Start) ? "Start" : m45equalsimpl0(i, End) ? "End" : "Invalid";
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: slideIntoContainer-mOhB8PU$default, reason: not valid java name */
    static /* synthetic */ EnterTransition m38slideIntoContainermOhB8PU$default(AnimatedContentTransitionScope animatedContentTransitionScope, int i, FiniteAnimationSpec finiteAnimationSpec, Function1 function1, int i2, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: slideIntoContainer-mOhB8PU");
        }
        if ((i2 & 2) != 0) {
            finiteAnimationSpec = AnimationSpecKt.spring$default(0.0f, 0.0f, IntOffset.m5854boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntOffset.INSTANCE)), 3, null);
        }
        if ((i2 & 4) != 0) {
    ...
    static /* synthetic */ ExitTransition m39slideOutOfContainermOhB8PU$default(AnimatedContentTransitionScope animatedContentTransitionScope, int i, FiniteAnimationSpec finiteAnimationSpec, Function1 function1, int i2, Object obj) {
        if (obj != null) {
