                ...
                objRememberedValue = (Function3) new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.animation.AnimatedVisibilityKt$AnimatedVisibilityImpl$1$1
                    ...
                    public final MeasureResult m66invoke3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
                        ...
                        if (measureScope.isLookingAhead() && !function1.invoke(transition.getTargetState()).booleanValue()) {
                            jIntSize = IntSize.INSTANCE.m5910getZeroYbymL2g();
                        } else {
                            jIntSize = IntSizeKt.IntSize(placeableMo4684measureBRTryo0.getWidth(), placeableMo4684measureBRTryo0.getHeight());
                        }
                        return MeasureScope.layout$default(measureScope, IntSize.m5905getWidthimpl(jIntSize), IntSize.m5904getHeightimpl(jIntSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedVisibilityKt$AnimatedVisibilityImpl$1$1.1
                            {
                                super(1);
                            }
