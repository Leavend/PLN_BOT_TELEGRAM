    ...
    public MeasureResult mo37measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        while (true) {
            ...
            if (childData != null && childData.isTarget()) {
                placeableArr[i] = measurable.mo4684measureBRTryo0(j);
            }
            i++;
        }
        int size3 = list.size();
        for (int i2 = 0; i2 < size3; i2++) {
            ...
            if (placeableArr[i2] == null) {
                placeableArr[i2] = measurable2.mo4684measureBRTryo0(j);
            }
        }
        if ((size == 0) == true) {
            placeable2 = null;
        ...
        this.rootScope.m62setMeasuredSizeozmzZPI$animation_release(IntSizeKt.IntSize(width3, height3));
        return MeasureScope.layout$default(measureScope, width3, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentMeasurePolicy$measure$3
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                for (Placeable placeable5 : placeableArr2) {
                    if (placeable5 != null) {
                        long jMo3050alignKFBX0sM = animatedContentMeasurePolicy.getRootScope().getContentAlignment().mo3050alignKFBX0sM(IntSizeKt.IntSize(placeable5.getWidth(), placeable5.getHeight()), IntSizeKt.IntSize(i3, i4), LayoutDirection.Ltr);
                        Placeable.PlacementScope.place$default(placementScope, placeable5, IntOffset.m5863getXimpl(jMo3050alignKFBX0sM), IntOffset.m5864getYimpl(jMo3050alignKFBX0sM), 0.0f, 4, null);
                    }
                }
            }
        }, 4, null);
