...
public final class AnimatedContentTransitionScopeImpl<S> implements AnimatedContentTransitionScope<S> {
    ...
    private final MutableState measuredSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m5897boximpl(IntSize.INSTANCE.m5910getZeroYbymL2g()), null, 2, null);
    ...
    public EnterTransition mo40slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> initialOffset) {
        return m59isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$1
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf(IntSize.m5905getWidthimpl(this.m58getCurrentSizeYbymL2g()) - IntOffset.m5863getXimpl(this.m57calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m58getCurrentSizeYbymL2g()))));
            }
        }) : m60isRightgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf((-IntOffset.m5863getXimpl(this.m57calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m58getCurrentSizeYbymL2g()))) - i));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m45equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m54getUpDKzdypw()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf(IntSize.m5904getHeightimpl(this.m58getCurrentSizeYbymL2g()) - IntOffset.m5864getYimpl(this.m57calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m58getCurrentSizeYbymL2g()))));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m45equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m49getDownDKzdypw()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$4
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int i) {
                return initialOffset.invoke(Integer.valueOf((-IntOffset.m5864getYimpl(this.m57calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.m58getCurrentSizeYbymL2g()))) - i));
            }
        }) : EnterTransition.INSTANCE.getNone();
    }

    /* renamed from: isLeft-gWo6LJ4, reason: not valid java name */
    private final boolean m59isLeftgWo6LJ4(int i) {
        return AnimatedContentTransitionScope.SlideDirection.m45equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m51getLeftDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m45equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m53getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr) || (AnimatedContentTransitionScope.SlideDirection.m45equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m50getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl);
    }

    /* renamed from: isRight-gWo6LJ4, reason: not valid java name */
    private final boolean m60isRightgWo6LJ4(int i) {
        return AnimatedContentTransitionScope.SlideDirection.m45equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m52getRightDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m45equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m53getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl) || (AnimatedContentTransitionScope.SlideDirection.m45equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m50getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: calculateOffset-emnUabE, reason: not valid java name */
    public final long m57calculateOffsetemnUabE(long fullSize, long currentSize) {
        return getContentAlignment().mo3050alignKFBX0sM(fullSize, currentSize, LayoutDirection.Ltr);
    }

    @Override // androidx.compose.animation.AnimatedContentTransitionScope
    /* renamed from: slideOutOfContainer-mOhB8PU */
    public ExitTransition mo41slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> targetOffset) {
        return m59isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$1
            ...
            public final Integer invoke(int i) {
                ...
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m5863getXimpl(this.this$0.m57calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m5910getZeroYbymL2g()))) - i));
            }
        }) : m60isRightgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$2
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
            ...
            public final Integer invoke(int i) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                long packedValue = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m5910getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m5863getXimpl(this.this$0.m57calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue))) + IntSize.m5905getWidthimpl(packedValue)));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m45equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m54getUpDKzdypw()) ? EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$3
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
            ...
            public final Integer invoke(int i) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m5864getYimpl(this.this$0.m57calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m5910getZeroYbymL2g()))) - i));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m45equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m49getDownDKzdypw()) ? EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$4
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
            ...
            public final Integer invoke(int i) {
                State state = (State) this.this$0.getTargetSizeMap$animation_release().get(this.this$0.getTransition$animation_release().getTargetState());
                long packedValue = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m5910getZeroYbymL2g();
                return targetOffset.invoke(Integer.valueOf((-IntOffset.m5864getYimpl(this.this$0.m57calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue))) + IntSize.m5904getHeightimpl(packedValue)));
            }
    ...
    public final long m61getMeasuredSizeYbymL2g$animation_release() {
        return ((IntSize) this.measuredSize.getValue()).getPackedValue();
    }

    /* renamed from: setMeasuredSize-ozmzZPI$animation_release, reason: not valid java name */
    public final void m62setMeasuredSizeozmzZPI$animation_release(long j) {
        this.measuredSize.setValue(IntSize.m5897boximpl(j));
    }
    ...
    public final long m58getCurrentSizeYbymL2g() {
        State<IntSize> state = this.animatedSize;
        return state != null ? state.getValue().getPackedValue() : m61getMeasuredSizeYbymL2g$animation_release();
    }
    ...
    public final Modifier createSizeAnimationModifier$animation_release(ContentTransform contentTransform, Composer composer, int i) {
        ...
        if (createSizeAnimationModifier$lambda$2(mutableState)) {
            ...
            if (zChanged2 || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                ...
                Modifier.Companion companionClipToBounds = Modifier.INSTANCE;
                if (!z) {
                    companionClipToBounds = ClipKt.clipToBounds(companionClipToBounds);
                }
                objRememberedValue2 = companionClipToBounds.then(new SizeModifier(deferredAnimationCreateDeferredAnimation, stateRememberUpdatedState));
        ...
        public MeasureResult mo63measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
            ...
            Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>> function1 = new Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$1
                ...
                public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> segment) {
                    FiniteAnimationSpec<IntSize> finiteAnimationSpecMo113createAnimationSpecTemP2vQ;
                    State<IntSize> state = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(segment.getInitialState());
                    long packedValue = state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m5910getZeroYbymL2g();
                    State<IntSize> state2 = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(segment.getTargetState());
                    long packedValue2 = state2 != null ? state2.getValue().getPackedValue() : IntSize.INSTANCE.m5910getZeroYbymL2g();
                    SizeTransform value = this.getSizeTransform().getValue();
                    return (value == null || (finiteAnimationSpecMo113createAnimationSpecTemP2vQ = value.mo113createAnimationSpecTemP2vQ(packedValue, packedValue2)) == null) ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : finiteAnimationSpecMo113createAnimationSpecTemP2vQ;
                }
            };
            ...
            State<IntSize> stateAnimate = deferredAnimation.animate(function1, new Function1<S, IntSize>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$2
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(Object obj) {
                    return IntSize.m5897boximpl(m64invokeYEO4UFw(obj));
                }

                /* renamed from: invoke-YEO4UFw, reason: not valid java name */
                public final long m64invokeYEO4UFw(S s) {
                    State<IntSize> state = animatedContentTransitionScopeImpl2.getTargetSizeMap$animation_release().get(s);
                    return state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m5910getZeroYbymL2g();
                }
            });
            AnimatedContentTransitionScopeImpl.this.setAnimatedSize$animation_release(stateAnimate);
            final long jMo3050alignKFBX0sM = AnimatedContentTransitionScopeImpl.this.getContentAlignment().mo3050alignKFBX0sM(IntSizeKt.IntSize(placeableMo4684measureBRTryo0.getWidth(), placeableMo4684measureBRTryo0.getHeight()), stateAnimate.getValue().getPackedValue(), LayoutDirection.Ltr);
            return MeasureScope.layout$default(measureScope, IntSize.m5905getWidthimpl(stateAnimate.getValue().getPackedValue()), IntSize.m5904getHeightimpl(stateAnimate.getValue().getPackedValue()), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable.PlacementScope placementScope) {
                    Placeable.PlacementScope.m4735place70tqf50$default(placementScope, placeableMo4684measureBRTryo0, jMo3050alignKFBX0sM, 0.0f, 2, null);
                }
            }, 4, null);
        }
    }
