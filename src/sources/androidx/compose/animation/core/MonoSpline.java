...
public final class MonoSpline {
    ...
    public MonoSpline(float[] fArr, List<float[]> list) {
        ...
        while (i7 < i3) {
            int i8 = i2;
            while (i8 < length2) {
                if ((arrayListMakeFloatArray.get(i7)[i8] == 0.0f ? 1 : i2) != 0) {
    ...
    public final float getPos(float t, int j) {
        ...
        if (this.isExtrapolate) {
            if (t <= fArr[0]) {
                ...
                int i = length - 1;
                if (t >= fArr[i]) {
                    f = this.values.get(i)[j];
                    float f4 = this.timePoints[i];
                    f2 = t - f4;
                    slope = getSlope(f4, j);
                }
            }
        ...
        while (i4 < i3) {
            ...
            float f5 = fArr2[i4];
            if (t == f5) {
                return this.values.get(i4)[j];
            }
            int i5 = i4 + 1;
            float f6 = fArr2[i5];
            if (t < f6) {
                float f7 = f6 - f5;
                return interpolate(f7, (t - f5) / f7, this.values.get(i4)[j], this.values.get(i5)[j], this.tangents.get(i4)[j], this.tangents.get(i5)[j]);
            }
            i4 = i5;
        }
        return 0.0f;
