...
public final class InfiniteAnimationPolicyKt {
    public static final <R> Object withInfiniteAnimationFrameNanos(Function1<? super Long, ? extends R> function1, Continuation<? super R> continuation) {
        ...
        return infiniteAnimationPolicy.onInfiniteOperation(new C03162(function1, null), continuation);
    }
    ...
    static final class C03162<R> extends SuspendLambda implements Function1<Continuation<? super R>, Object> {
        final /* synthetic */ Function1<Long, R> $onFrame;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C03162(Function1<? super Long, ? extends R> function1, Continuation<? super C03162> continuation) {
        ...
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C03162(this.$onFrame, continuation);
        }
