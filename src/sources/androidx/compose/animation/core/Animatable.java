...
public final class Animatable<T, V extends AnimationVector> {
    ...
    static final class C03142 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        final /* synthetic */ T $targetValue;
        int label;
        final /* synthetic */ Animatable<T, V> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03142(Animatable<T, V> animatable, T t, Continuation<? super C03142> continuation) {
            super(1, continuation);
            this.this$0 = animatable;
            this.$targetValue = t;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C03142(this.this$0, this.$targetValue, continuation);
        }
    ...
    public final Object snapTo(T t, Continuation<? super Unit> continuation) {
        Object objMutate$default = MutatorMutex.mutate$default(this.mutatorMutex, null, new C03142(this, t, null), continuation, 1, null);
    ...
    static final class C03152 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03152(Animatable<T, V> animatable, Continuation<? super C03152> continuation) {
            super(1, continuation);
            this.this$0 = animatable;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C03152(this.this$0, continuation);
        }
    ...
    public final Object stop(Continuation<? super Unit> continuation) {
        Object objMutate$default = MutatorMutex.mutate$default(this.mutatorMutex, null, new C03152(this, null), continuation, 1, null);
        return objMutate$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objMutate$default : Unit.INSTANCE;
    }
