...
public final class Constraints {
    ...
    public static final /* synthetic */ Constraints m5679boximpl(long j) {
    ...
    public static boolean m5683equalsimpl(long j, Object obj) {
        return (obj instanceof Constraints) && j == ((Constraints) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m5684equalsimpl0(long j, long j2) {
        return j == j2;
    }

    /* renamed from: getFocusIndex-impl, reason: not valid java name */
    private static final int m5685getFocusIndeximpl(long j) {
        return (int) (j & 3);
    }
    ...
    public static int m5694hashCodeimpl(long j) {
    ...
    public boolean equals(Object obj) {
        return m5683equalsimpl(this.value, obj);
    }
    ...
    public static final int m5693getMinWidthimpl(long j) {
        return ((int) (j >> 2)) & WidthMask[m5685getFocusIndeximpl(j)];
    }

    /* renamed from: getMaxWidth-impl, reason: not valid java name */
    public static final int m5691getMaxWidthimpl(long j) {
        int i = ((int) (j >> 33)) & WidthMask[m5685getFocusIndeximpl(j)];
        if (i == 0) {
    ...
    public static final int m5692getMinHeightimpl(long j) {
        int iM5685getFocusIndeximpl = m5685getFocusIndeximpl(j);
        return ((int) (j >> MinHeightOffsets[iM5685getFocusIndeximpl])) & HeightMask[iM5685getFocusIndeximpl];
    }

    /* renamed from: getMaxHeight-impl, reason: not valid java name */
    public static final int m5690getMaxHeightimpl(long j) {
        int iM5685getFocusIndeximpl = m5685getFocusIndeximpl(j);
        int i = ((int) (j >> (MinHeightOffsets[iM5685getFocusIndeximpl] + 31))) & HeightMask[iM5685getFocusIndeximpl];
        if (i == 0) {
            return Integer.MAX_VALUE;
        }
        return i - 1;
    ...
    public static final boolean m5687getHasBoundedWidthimpl(long j) {
        return (((int) (j >> 33)) & WidthMask[m5685getFocusIndeximpl(j)]) != 0;
    }

    /* renamed from: getHasBoundedHeight-impl, reason: not valid java name */
    public static final boolean m5686getHasBoundedHeightimpl(long j) {
        int iM5685getFocusIndeximpl = m5685getFocusIndeximpl(j);
        return (((int) (j >> (MinHeightOffsets[iM5685getFocusIndeximpl] + 31))) & HeightMask[iM5685getFocusIndeximpl]) != 0;
    }

    /* renamed from: getHasFixedWidth-impl, reason: not valid java name */
    public static final boolean m5689getHasFixedWidthimpl(long j) {
        return m5691getMaxWidthimpl(j) == m5693getMinWidthimpl(j);
    }

    /* renamed from: getHasFixedHeight-impl, reason: not valid java name */
    public static final boolean m5688getHasFixedHeightimpl(long j) {
        return m5690getMaxHeightimpl(j) == m5692getMinHeightimpl(j);
    }

    /* renamed from: isZero-impl, reason: not valid java name */
    public static final boolean m5695isZeroimpl(long j) {
        return m5691getMaxWidthimpl(j) == 0 || m5690getMaxHeightimpl(j) == 0;
    }

    /* renamed from: copy-Zbe2FdA$default, reason: not valid java name */
    public static /* synthetic */ long m5682copyZbe2FdA$default(long j, int i, int i2, int i3, int i4, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = m5693getMinWidthimpl(j);
        }
        int i6 = i;
        if ((i5 & 2) != 0) {
            i2 = m5691getMaxWidthimpl(j);
        }
        int i7 = i2;
        if ((i5 & 4) != 0) {
            i3 = m5692getMinHeightimpl(j);
        }
        int i8 = i3;
        if ((i5 & 8) != 0) {
            i4 = m5690getMaxHeightimpl(j);
        }
        return m5681copyZbe2FdA(j, i6, i7, i8, i4);
    }

    /* renamed from: copy-Zbe2FdA, reason: not valid java name */
    public static final long m5681copyZbe2FdA(long j, int i, int i2, int i3, int i4) {
        boolean z = true;
        if (!(i3 >= 0 && i >= 0)) {
        ...
        return INSTANCE.m5698createConstraintsZbe2FdA$ui_unit_release(i, i2, i3, i4);
    }
    ...
    public static String m5696toStringimpl(long j) {
        int iM5691getMaxWidthimpl = m5691getMaxWidthimpl(j);
        String strValueOf = iM5691getMaxWidthimpl == Integer.MAX_VALUE ? "Infinity" : String.valueOf(iM5691getMaxWidthimpl);
        int iM5690getMaxHeightimpl = m5690getMaxHeightimpl(j);
        return "Constraints(minWidth = " + m5693getMinWidthimpl(j) + ", maxWidth = " + strValueOf + ", minHeight = " + m5692getMinHeightimpl(j) + ", maxHeight = " + (iM5690getMaxHeightimpl != Integer.MAX_VALUE ? String.valueOf(iM5690getMaxHeightimpl) : "Infinity") + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m5699fixedJhjzzOo(int width, int height) {
            if (!(width >= 0 && height >= 0)) {
                throw new IllegalArgumentException(("width(" + width + ") and height(" + height + ") must be >= 0").toString());
            }
            return m5698createConstraintsZbe2FdA$ui_unit_release(width, width, height, height);
        }

        /* renamed from: fixedWidth-OenEA2s, reason: not valid java name */
        public final long m5701fixedWidthOenEA2s(int width) {
            if (!(width >= 0)) {
                throw new IllegalArgumentException(("width(" + width + ") must be >= 0").toString());
            }
            return m5698createConstraintsZbe2FdA$ui_unit_release(width, width, 0, Integer.MAX_VALUE);
        }

        /* renamed from: fixedHeight-OenEA2s, reason: not valid java name */
        public final long m5700fixedHeightOenEA2s(int height) {
            if (!(height >= 0)) {
                throw new IllegalArgumentException(("height(" + height + ") must be >= 0").toString());
            }
            return m5698createConstraintsZbe2FdA$ui_unit_release(0, Integer.MAX_VALUE, height, height);
        }

        /* renamed from: createConstraints-Zbe2FdA$ui_unit_release, reason: not valid java name */
        public final long m5698createConstraintsZbe2FdA$ui_unit_release(int minWidth, int maxWidth, int minHeight, int maxHeight) {
            long j;
            ...
            if (iBitsNeedForSize + iBitsNeedForSize2 <= 31) {
                ...
                return Constraints.m5680constructorimpl((i3 << 33) | j | (minWidth << 2) | (minHeight << i5) | (i4 << (i5 + 31)));
            }
