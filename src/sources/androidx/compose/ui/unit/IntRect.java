...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m5881getSizeYbymL2g$annotations() {
    }
    ...
    public final long m5889getSizeYbymL2g() {
    ...
    public final IntRect m5893translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m5863getXimpl(offset), this.top + IntOffset.m5864getYimpl(offset), this.right + IntOffset.m5863getXimpl(offset), this.bottom + IntOffset.m5864getYimpl(offset));
    }
