...
public final class IntRectKt {
    ...
    public static final IntRect m5895IntRectVbeCjmY(long j, long j2) {
        return new IntRect(IntOffset.m5863getXimpl(j), IntOffset.m5864getYimpl(j), IntOffset.m5863getXimpl(j) + IntSize.m5905getWidthimpl(j2), IntOffset.m5864getYimpl(j) + IntSize.m5904getHeightimpl(j2));
    }

    /* renamed from: IntRect-E1MhUcY, reason: not valid java name */
    public static final IntRect m5894IntRectE1MhUcY(long j, long j2) {
        return new IntRect(IntOffset.m5863getXimpl(j), IntOffset.m5864getYimpl(j), IntOffset.m5863getXimpl(j2), IntOffset.m5864getYimpl(j2));
    }

    /* renamed from: IntRect-ar5cAso, reason: not valid java name */
    public static final IntRect m5896IntRectar5cAso(long j, int i) {
        return new IntRect(IntOffset.m5863getXimpl(j) - i, IntOffset.m5864getYimpl(j) - i, IntOffset.m5863getXimpl(j) + i, IntOffset.m5864getYimpl(j) + i);
    }
