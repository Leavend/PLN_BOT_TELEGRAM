...
final class DialogLayout extends AbstractComposeView implements DialogWindowProvider {
    ...
    public DialogLayout(Context context, Window window) {
        ...
        this.window = window;
        this.content = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$AndroidDialog_androidKt.INSTANCE.m5987getLambda1$ui_release(), null, 2, null);
    }
