    ...
    */
    ...
    public static final void DialogLayout(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 91) != 18 || !composerStartRestartGroup.getSkipping()) {
            ...
            C06791 c06791 = new MeasurePolicy() { // from class: androidx.compose.ui.window.AndroidDialog_androidKt.DialogLayout.1
                ...
                public final MeasureResult mo37measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
                    ...
                    int width3 = placeable2 != null ? placeable2.getWidth() : Constraints.m5693getMinWidthimpl(j);
                    if (!arrayList2.isEmpty()) {
                    ...
                    return MeasureScope.layout$default(measureScope, width3, placeable3 != null ? placeable3.getHeight() : Constraints.m5692getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.window.AndroidDialog_androidKt.DialogLayout.1.1
            ...
            Updater.m2951setimpl(composerM2944constructorimpl, c06791, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
