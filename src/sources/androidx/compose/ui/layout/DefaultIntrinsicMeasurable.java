...
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public Placeable mo4684measureBRTryo0(long constraints) {
        ...
        if (intrinsicWidthHeight == intrinsicWidthHeight2) {
            ...
            return new FixedSizeIntrinsicsPlaceable(iMinIntrinsicWidth, iM5691getMaxWidthimpl);
        }
        if (this.minMax == IntrinsicMinMax.Max) {
        ...
        return new FixedSizeIntrinsicsPlaceable(iM5691getMaxWidthimpl, iMinIntrinsicHeight);
    }
