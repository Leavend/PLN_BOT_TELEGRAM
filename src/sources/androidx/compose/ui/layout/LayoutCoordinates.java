...
public interface LayoutCoordinates {
    ...
    long mo4692localPositionOfR5De75A(LayoutCoordinates sourceCoordinates, long relativeToSource);

    /* renamed from: localToRoot-MK-Hz9U, reason: not valid java name */
    long mo4693localToRootMKHz9U(long relativeToLocal);

    /* renamed from: localToWindow-MK-Hz9U, reason: not valid java name */
    long mo4694localToWindowMKHz9U(long relativeToLocal);

    /* renamed from: windowToLocal-MK-Hz9U, reason: not valid java name */
    long mo4696windowToLocalMKHz9U(long relativeToWindow);
    ...
    public static final class DefaultImpls {
        ...
        public static void m4697transformFromEL8BTi8(LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2, float[] fArr) {
            LayoutCoordinates.super.mo4695transformFromEL8BTi8(layoutCoordinates2, fArr);
        }
    }
    ...
    /* renamed from: transformFrom-EL8BTi8, reason: not valid java name */
    default void mo4695transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
