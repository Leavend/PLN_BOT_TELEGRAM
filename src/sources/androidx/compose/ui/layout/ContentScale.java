...
public interface ContentScale {
    ...
    long mo4675computeScaleFactorH7hwNQA(long srcSize, long dstSize);
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo4675computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM4681computeFillMaxDimensioniLBOSCw = ContentScaleKt.m4681computeFillMaxDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM4681computeFillMaxDimensioniLBOSCw, fM4681computeFillMaxDimensioniLBOSCw);
            }
        };
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo4675computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM4682computeFillMinDimensioniLBOSCw = ContentScaleKt.m4682computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM4682computeFillMinDimensioniLBOSCw, fM4682computeFillMinDimensioniLBOSCw);
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo4675computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM4680computeFillHeightiLBOSCw = ContentScaleKt.m4680computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM4680computeFillHeightiLBOSCw, fM4680computeFillHeightiLBOSCw);
            }
        };
        private static final ContentScale FillWidth = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillWidth$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo4675computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM4683computeFillWidthiLBOSCw = ContentScaleKt.m4683computeFillWidthiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM4683computeFillWidthiLBOSCw, fM4683computeFillWidthiLBOSCw);
            }
        };
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo4675computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                if (Size.m3242getWidthimpl(srcSize) > Size.m3242getWidthimpl(dstSize) || Size.m3239getHeightimpl(srcSize) > Size.m3239getHeightimpl(dstSize)) {
                    float fM4682computeFillMinDimensioniLBOSCw = ContentScaleKt.m4682computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                    return ScaleFactorKt.ScaleFactor(fM4682computeFillMinDimensioniLBOSCw, fM4682computeFillMinDimensioniLBOSCw);
                }
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo4675computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                return ScaleFactorKt.ScaleFactor(ContentScaleKt.m4683computeFillWidthiLBOSCw(srcSize, dstSize), ContentScaleKt.m4680computeFillHeightiLBOSCw(srcSize, dstSize));
            }
        };
