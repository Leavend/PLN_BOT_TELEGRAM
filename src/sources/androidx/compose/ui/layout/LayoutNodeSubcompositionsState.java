...
public final class LayoutNodeSubcompositionsState implements ComposeNodeLifecycleCallback {
    ...
    private final void subcompose(LayoutNode node, Object slotId, Function2<? super Composer, ? super Integer, Unit> content) {
        ...
        if (nodeState == null) {
            nodeState = new NodeState(slotId, ComposableSingletons$SubcomposeLayoutKt.INSTANCE.m4674getLambda1$ui_release(), null, 4, null);
        ...
        return new LayoutNode.NoIntrinsicsMeasurePolicy(this.NoIntrinsicsMessage) { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState.createMeasurePolicy.1
            ...
            public MeasureResult mo37measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
                ...
                if (measureScope.isLookingAhead() || LayoutNodeSubcompositionsState.this.root.getLookaheadRoot() == null) {
                    ...
                    final MeasureResult measureResultInvoke = block.invoke(LayoutNodeSubcompositionsState.this.scope, Constraints.m5679boximpl(j));
                ...
                final MeasureResult measureResultInvoke2 = block.invoke(LayoutNodeSubcompositionsState.this.postLookaheadMeasureScope, Constraints.m5679boximpl(j));
    ...
    public final SubcomposeLayoutState.PrecomposedSlotHandle precompose(final Object slotId, Function2<? super Composer, ? super Integer, Unit> content) {
        ...
        return new SubcomposeLayoutState.PrecomposedSlotHandle() { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState.precompose.2
            ...
            public void mo4700premeasure0kLqBqw(int index, long constraints) {
                LayoutNode layoutNode = (LayoutNode) LayoutNodeSubcompositionsState.this.precomposeMap.get(slotId);
                ...
                if (!layoutNode.isPlaced()) {
                    ...
                    layoutNode2.ignoreRemeasureRequests = true;
                    LayoutNodeKt.requireOwner(layoutNode).mo4947measureAndLayout0kLqBqw(layoutNode.getChildren$ui_release().get(index), constraints);
                    layoutNode2.ignoreRemeasureRequests = false;
                    return;
                }
    ...
    private final class PostLookaheadMeasureScopeImpl implements SubcomposeMeasureScope, MeasureScope {
        ...
        public int mo309roundToPxR2X_6o(long j) {
            return this.$$delegate_0.mo309roundToPxR2X_6o(j);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: roundToPx-0680j_4 */
        public int mo310roundToPx0680j_4(float f) {
            return this.$$delegate_0.mo310roundToPx0680j_4(f);
        }

        @Override // androidx.compose.ui.unit.FontScaling
        /* renamed from: toDp-GaN1DYA */
        public float mo311toDpGaN1DYA(long j) {
            return this.$$delegate_0.mo311toDpGaN1DYA(j);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toDp-u2uoSUM */
        public float mo312toDpu2uoSUM(float f) {
            return this.$$delegate_0.mo312toDpu2uoSUM(f);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toDp-u2uoSUM */
        public float mo313toDpu2uoSUM(int i) {
            return this.$$delegate_0.mo313toDpu2uoSUM(i);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toDpSize-k-rfVVM */
        public long mo314toDpSizekrfVVM(long j) {
            return this.$$delegate_0.mo314toDpSizekrfVVM(j);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toPx--R2X_6o */
        public float mo315toPxR2X_6o(long j) {
            return this.$$delegate_0.mo315toPxR2X_6o(j);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toPx-0680j_4 */
        public float mo316toPx0680j_4(float f) {
            return this.$$delegate_0.mo316toPx0680j_4(f);
        }
        ...
        public long mo317toSizeXkaWNTQ(long j) {
            return this.$$delegate_0.mo317toSizeXkaWNTQ(j);
        }

        @Override // androidx.compose.ui.unit.FontScaling
        /* renamed from: toSp-0xMU5do */
        public long mo318toSp0xMU5do(float f) {
            return this.$$delegate_0.mo318toSp0xMU5do(f);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toSp-kPz2Gy4 */
        public long mo319toSpkPz2Gy4(float f) {
            return this.$$delegate_0.mo319toSpkPz2Gy4(f);
        }

        @Override // androidx.compose.ui.unit.Density
        /* renamed from: toSp-kPz2Gy4 */
        public long mo320toSpkPz2Gy4(int i) {
            return this.$$delegate_0.mo320toSpkPz2Gy4(i);
        }
