...
public final class IntermediateLayoutModifierNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public void onAttach() {
        ...
        if (lookaheadRoot != null && lookaheadRoot.getIsVirtualLookaheadRoot()) {
            ...
            int iM4891constructorimpl = NodeKind.m4891constructorimpl(512);
    ...
    public MeasureResult mo90measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, placeableMo4684measureBRTryo0.getWidth(), placeableMo4684measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$measure$1$1
            {
                super(1);
            }
    ...
    public final MeasureResult m4686intermediateMeasureTeuZzU(MeasureScope measureScope, Measurable measurable, long j, long j2, long j3) {
        this.intermediateMeasureScope.m4688setLookaheadSizeozmzZPI(j2);
        this.lookaheadConstraints = Constraints.m5679boximpl(j3);
        ...
        return this.measureBlock.invoke(this.intermediateMeasureScope, intermediateMeasurablePlaceable, Constraints.m5679boximpl(j));
    }
    ...
    public final int minIntermediateIntrinsicWidth$ui_release(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i) {
        return NodeMeasuringIntrinsics.INSTANCE.minWidth$ui_release(new NodeMeasuringIntrinsics.MeasureBlock() { // from class: androidx.compose.ui.layout.IntermediateLayoutModifierNode$minIntermediateIntrinsicWidth$1
            ...
            /* renamed from: measure-3p2s80s */
            public final MeasureResult mo4689measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
                return this.this$0.getMeasureBlock$ui_release().invoke(this.this$0.intermediateMeasureScope, measurable, Constraints.m5679boximpl(j));
            }
    ...
    private final class IntermediateMeasurablePlaceable extends Placeable implements Measurable {
        ...
        public Placeable mo4684measureBRTryo0(long constraints) {
            ...
            if (IntermediateLayoutModifierNode.this.getIsIntermediateChangeActive()) {
                placeableMo4684measureBRTryo0 = this.wrappedMeasurable.mo4684measureBRTryo0(constraints);
                m4734setMeasurementConstraintsBRTryo0(constraints);
                m4733setMeasuredSizeozmzZPI(IntSizeKt.IntSize(placeableMo4684measureBRTryo0.getWidth(), placeableMo4684measureBRTryo0.getHeight()));
            } else {
                ...
                placeableMo4684measureBRTryo0 = measurable.mo4684measureBRTryo0(constraints2.getValue());
                ...
                m4734setMeasurementConstraintsBRTryo0(constraints3.getValue());
                if (!intermediateLayoutModifierNode.getIsIntermediateChangeActive()) {
                    ...
                    lookaheadSize = IntSizeKt.IntSize(placeableMo4684measureBRTryo0.getWidth(), placeableMo4684measureBRTryo0.getHeight());
                }
                m4733setMeasuredSizeozmzZPI(lookaheadSize);
            }
            this.wrappedPlaceable = placeableMo4684measureBRTryo0;
            return this;
        }
        ...
        public void mo4685placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            Unit unit;
            if (!IntermediateLayoutModifierNode.this.getIsIntermediateChangeActive()) {
                position = IntOffset.INSTANCE.m5873getZeronOccac();
            }
            ...
            if (layerBlock != null) {
                ...
                if (placeable != null) {
                    placementScope.m4744placeWithLayeraW9wM(placeable, position, zIndex, layerBlock);
                    unit = Unit.INSTANCE;
                } else {
                    unit = null;
                }
            ...
            if (placeable2 != null) {
                placementScope.m4739place70tqf50(placeable2, position, zIndex);
    ...
    final class IntermediateMeasureScopeImpl implements IntermediateMeasureScope, CoroutineScope {
        ...
        public void m4688setLookaheadSizeozmzZPI(long j) {
