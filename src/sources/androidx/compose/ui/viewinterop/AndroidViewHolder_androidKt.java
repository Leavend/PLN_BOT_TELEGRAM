...
public final class AndroidViewHolder_androidKt {
    ...
    public static final void layoutAccordingTo(View view, LayoutNode layoutNode) {
        ...
        int iRoundToInt = MathKt.roundToInt(Offset.m3173getXimpl(jPositionInRoot));
        int iRoundToInt2 = MathKt.roundToInt(Offset.m3174getYimpl(jPositionInRoot));
    ...
    public static final int toNestedScrollSource(int i) {
        if (i == 0) {
            return NestedScrollSource.INSTANCE.m4452getDragWNlRxjI();
        }
        return NestedScrollSource.INSTANCE.m4453getFlingWNlRxjI();
    }
}
