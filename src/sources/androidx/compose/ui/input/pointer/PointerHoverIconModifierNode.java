...
public final class PointerHoverIconModifierNode extends Modifier.Node implements TraversableNode, PointerInputModifierNode, CompositionLocalConsumerModifierNode {
    ...
    public void mo181onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        if (pass == PointerEventPass.Main) {
            if (PointerEventType.m4507equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m4511getEnter7fucELk())) {
                this.cursorInBoundsOfNode = true;
                displayIconIfDescendantsDoNotHavePriority();
            } else if (PointerEventType.m4507equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m4512getExit7fucELk())) {
