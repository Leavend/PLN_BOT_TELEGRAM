...
public final class PointerIdArray {
    ...
    public final long m4653get_I2yYro(int index) {
        return PointerId.m4538constructorimpl(this.internalArray[index]);
    }

    /* renamed from: remove-0FcD4WY, reason: not valid java name */
    public final boolean m4654remove0FcD4WY(long pointerId) {
    ...
    public final boolean remove(long pointerIdValue) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            if (pointerIdValue == m4653get_I2yYro(i2)) {
                removeAt(i2);
                return true;
            }
        }
    ...
    public final boolean m4651add0FcD4WY(long pointerId) {
    ...
    public final void m4655setDmW0f2w(int index, long pointerId) {
        set(index, pointerId);
    }
    ...
    public final boolean m4652contains0FcD4WY(long pointerId) {
