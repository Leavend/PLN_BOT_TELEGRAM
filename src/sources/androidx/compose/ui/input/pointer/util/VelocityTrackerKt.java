...
public final class VelocityTrackerKt {
    ...
    private static final void addPointerInputChangeLegacy(VelocityTracker velocityTracker, PointerInputChange pointerInputChange) {
        if (PointerEventKt.changedToDownIgnoreConsumed(pointerInputChange)) {
            velocityTracker.m4660setCurrentPointerPositionAccumulatork4lQ0M$ui_release(pointerInputChange.getPosition());
        ...
        while (i < size) {
            ...
            long jM3177minusMKHz9U = Offset.m3177minusMKHz9U(historicalChange.getPosition(), previousPosition);
            long position = historicalChange.getPosition();
            velocityTracker.m4660setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m3178plusMKHz9U(velocityTracker.getCurrentPointerPositionAccumulator(), jM3177minusMKHz9U));
            velocityTracker.m4656addPositionUv8p0NA(historicalChange.getUptimeMillis(), velocityTracker.getCurrentPointerPositionAccumulator());
            i++;
            previousPosition = position;
        }
        velocityTracker.m4660setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m3178plusMKHz9U(velocityTracker.getCurrentPointerPositionAccumulator(), Offset.m3177minusMKHz9U(pointerInputChange.getPosition(), previousPosition)));
        velocityTracker.m4656addPositionUv8p0NA(pointerInputChange.getUptimeMillis(), velocityTracker.getCurrentPointerPositionAccumulator());
    }
    ...
    private static final void addPointerInputChangeWithFix(VelocityTracker velocityTracker, PointerInputChange pointerInputChange) {
        ...
        if (!PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange)) {
            ...
            for (int i = 0; i < size; i++) {
                HistoricalChange historicalChange = historical.get(i);
                velocityTracker.m4656addPositionUv8p0NA(historicalChange.getUptimeMillis(), historicalChange.getOriginalEventPosition());
            }
            velocityTracker.m4656addPositionUv8p0NA(pointerInputChange.getUptimeMillis(), pointerInputChange.getOriginalEventPosition());
        }
