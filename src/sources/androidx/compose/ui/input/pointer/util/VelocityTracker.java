...
public final class VelocityTracker {
    ...
    private long currentPointerPositionAccumulator = Offset.INSTANCE.m3189getZeroF1C5BW0();
    ...
    public final void m4660setCurrentPointerPositionAccumulatork4lQ0M$ui_release(long j) {
    ...
    public final void m4656addPositionUv8p0NA(long timeMillis, long position) {
        this.xVelocityTracker.addDataPoint(timeMillis, Offset.m3173getXimpl(position));
        this.yVelocityTracker.addDataPoint(timeMillis, Offset.m3174getYimpl(position));
    }

    /* renamed from: calculateVelocity-9UxMQ8M, reason: not valid java name */
    public final long m4657calculateVelocity9UxMQ8M() {
        return m4658calculateVelocityAH228Gc(VelocityKt.Velocity(Float.MAX_VALUE, Float.MAX_VALUE));
    }

    /* renamed from: calculateVelocity-AH228Gc, reason: not valid java name */
    public final long m4658calculateVelocityAH228Gc(long maximumVelocity) {
        if (!(Velocity.m5970getXimpl(maximumVelocity) > 0.0f && Velocity.m5971getYimpl(maximumVelocity) > 0.0f)) {
            throw new IllegalStateException(("maximumVelocity should be a positive value. You specified=" + ((Object) Velocity.m5977toStringimpl(maximumVelocity))).toString());
        }
        return VelocityKt.Velocity(this.xVelocityTracker.calculateVelocity(Velocity.m5970getXimpl(maximumVelocity)), this.yVelocityTracker.calculateVelocity(Velocity.m5971getYimpl(maximumVelocity)));
    }
