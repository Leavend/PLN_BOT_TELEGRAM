...
public final class PointerEvent {
    ...
    public PointerEvent(List<PointerInputChange> list, InternalPointerEvent internalPointerEvent) {
        ...
        this.buttons = PointerButtons.m4491constructorimpl(motionEvent$ui_release != null ? motionEvent$ui_release.getButtonState() : 0);
        MotionEvent motionEvent$ui_release2 = getMotionEvent$ui_release();
        this.keyboardModifiers = PointerKeyboardModifiers.m4621constructorimpl(motionEvent$ui_release2 != null ? motionEvent$ui_release2.getMetaState() : 0);
        this.type = m4497calculatePointerEventType7fucELk();
    }
    ...
    public final void m4501setTypeEhbLWgg$ui_release(int i) {
        this.type = i;
    }

    /* renamed from: calculatePointerEventType-7fucELk, reason: not valid java name */
    private final int m4497calculatePointerEventType7fucELk() {
        MotionEvent motionEvent$ui_release = getMotionEvent$ui_release();
            ...
            if (actionMasked != 0) {
                if (actionMasked != 1) {
                    if (actionMasked != 2) {
                        ...
                        return PointerEventType.INSTANCE.m4514getPress7fucELk();
                    }
                    return PointerEventType.INSTANCE.m4513getMove7fucELk();
                }
                return PointerEventType.INSTANCE.m4515getRelease7fucELk();
            }
            return PointerEventType.INSTANCE.m4514getPress7fucELk();
        }
    ...
    */
    public final androidx.compose.ui.input.pointer.PointerEvent copy(java.util.List<androidx.compose.ui.input.pointer.PointerInputChange> r32, android.view.MotionEvent r33) {
        ...
        L3a:
            ...
            if (r10 == 0) goto L7c
            long r6 = r8.getId()
            boolean r6 = r10.m4487issuesEnterExitEvent0FcD4WY(r6)
            r7 = 1
            if (r6 != r7) goto L7c
            goto L7d
        L7c:
