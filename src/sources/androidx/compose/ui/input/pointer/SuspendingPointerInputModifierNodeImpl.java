...
public final class SuspendingPointerInputModifierNodeImpl extends Modifier.Node implements SuspendingPointerInputModifierNode, PointerInputScope, Density {
    ...
    private long boundsSize = IntSize.INSTANCE.m5910getZeroYbymL2g();
    ...
    public long mo307getExtendedTouchPaddingNHjbRc() {
        long j = mo317toSizeXkaWNTQ(getViewConfiguration().mo4818getMinimumTouchTargetSizeMYxV2XQ());
        long boundsSize = getBoundsSize();
        return SizeKt.Size(Math.max(0.0f, Size.m3242getWidthimpl(j) - IntSize.m5905getWidthimpl(boundsSize)) / 2.0f, Math.max(0.0f, Size.m3239getHeightimpl(j) - IntSize.m5904getHeightimpl(boundsSize)) / 2.0f);
    }
    ...
    final class PointerEventHandlerCoroutine<R> implements AwaitPointerEventScope, Density, Continuation<R> {
        ...
        public long mo4470getSizeYbymL2g() {
        ...
        @Override // androidx.compose.ui.input.pointer.AwaitPointerEventScope
        /* renamed from: getExtendedTouchPadding-NH-jbRc */
        public long mo4469getExtendedTouchPaddingNHjbRc() {
            return SuspendingPointerInputModifierNodeImpl.this.mo307getExtendedTouchPaddingNHjbRc();
        }
        ...
        public final void offerPointerEvent(PointerEvent event, PointerEventPass pass) {
            ...
            cancellableContinuation.resumeWith(Result.m6852constructorimpl(event));
        }
        ...
        */
        public <T> java.lang.Object withTimeout(long r11, kotlin.jvm.functions.Function2<? super androidx.compose.ui.input.pointer.AwaitPointerEventScope, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r13, kotlin.coroutines.Continuation<? super T> r14) {
            ...
            L38:
                ...
                java.lang.Object r2 = kotlin.Result.m6852constructorimpl(r2)
                r14.resumeWith(r2)
            L5b:
    ...
    public <R> Object awaitPointerEventScope(Function2<? super AwaitPointerEventScope, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        ...
        synchronized (this.pointerHandlers) {
            ...
            Result.Companion companion = Result.INSTANCE;
            continuationCreateCoroutine.resumeWith(Result.m6852constructorimpl(Unit.INSTANCE));
            Unit unit = Unit.INSTANCE;
        }
