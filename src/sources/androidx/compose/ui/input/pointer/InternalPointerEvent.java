...
public final class InternalPointerEvent {
    ...
    public final boolean m4487issuesEnterExitEvent0FcD4WY(long pointerId) {
        ...
        while (true) {
            ...
            if (PointerId.m4540equalsimpl0(pointerInputEventData.m4573getIdJ3iCeTQ(), pointerId)) {
                break;
            }
            i++;
        }
