...
public final class PointerInputChange {
    ...
    private PointerInputChange(long j, long j2, long j3, boolean z, float f, long j4, long j5, boolean z2, boolean z3, int i, long j6) {
        ...
        this.type = i;
        this.scrollDelta = j6;
        this.originalEventPosition = Offset.INSTANCE.m3189getZeroF1C5BW0();
    ...
    public /* synthetic */ PointerInputChange(long j, long j2, long j3, boolean z, float f, long j4, long j5, boolean z2, boolean z3, int i, long j6, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, j2, j3, z, f, j4, j5, z2, z3, (i2 & 512) != 0 ? PointerType.INSTANCE.m4637getTouchT8wyACA() : i, (i2 & 1024) != 0 ? Offset.INSTANCE.m3189getZeroF1C5BW0() : j6, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ PointerInputChange(long j, long j2, long j3, boolean z, long j4, long j5, boolean z2, boolean z3, int i, long j6, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, j2, j3, z, j4, j5, z2, z3, (i2 & 256) != 0 ? PointerType.INSTANCE.m4637getTouchT8wyACA() : i, (i2 & 512) != 0 ? Offset.INSTANCE.m3189getZeroF1C5BW0() : j6, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ PointerInputChange(long j, long j2, long j3, boolean z, long j4, long j5, boolean z2, ConsumedData consumedData, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, j2, j3, z, j4, j5, z2, consumedData, (i2 & 256) != 0 ? PointerType.INSTANCE.m4637getTouchT8wyACA() : i, (DefaultConstructorMarker) null);
    }

    private PointerInputChange(long j, long j2, long j3, boolean z, long j4, long j5, boolean z2, ConsumedData consumedData, int i) {
        this(j, j2, j3, z, 1.0f, j4, j5, z2, consumedData.getDownChange() || consumedData.getPositionChange(), i, Offset.INSTANCE.m3189getZeroF1C5BW0(), (DefaultConstructorMarker) null);
    }
    ...
    public final void m4562setOriginalEventPositionk4lQ0M$ui_release(long j) {
    ...
    public final /* synthetic */ PointerInputChange m4552copyEzrO64(long id2, long currentTime, long currentPosition, boolean currentPressed, long previousTime, long previousPosition, boolean previousPressed, ConsumedData consumed, int type) {
    ...
    public final PointerInputChange m4553copyJKmWfYY(long id2, long currentTime, long currentPosition, boolean currentPressed, long previousTime, long previousPosition, boolean previousPressed, int type, long scrollDelta) {
        return m4545copy8H9lfAM$default(this, id2, currentTime, currentPosition, 0L, currentPressed, this.pressure, previousTime, previousPosition, previousPressed, type, getHistorical(), scrollDelta, 8, null);
    }
    ...
    public final PointerInputChange m4550copy0GkPj7c(long id2, long currentTime, long currentPosition, boolean currentPressed, long previousTime, long previousPosition, boolean previousPressed, ConsumedData consumed, int type, long scrollDelta) {
    ...
    public final PointerInputChange m4555copyTn9QgHE(long id2, long currentTime, long currentPosition, boolean currentPressed, float pressure, long previousTime, long previousPosition, boolean previousPressed, int type, long scrollDelta) {
    ...
    public final PointerInputChange m4554copyOHpmEuE(long id2, long currentTime, long currentPosition, boolean currentPressed, long previousTime, long previousPosition, boolean previousPressed, int type, List<HistoricalChange> historical, long scrollDelta) {
        return m4545copy8H9lfAM$default(this, id2, currentTime, currentPosition, 0L, currentPressed, this.pressure, previousTime, previousPosition, previousPressed, type, historical, scrollDelta, 8, null);
    }

    /* renamed from: copy-8H9lfAM$default, reason: not valid java name */
    public static /* synthetic */ PointerInputChange m4545copy8H9lfAM$default(PointerInputChange pointerInputChange, long j, long j2, long j3, long j4, boolean z, float f, long j5, long j6, boolean z2, int i, List list, long j7, int i2, Object obj) {
        return pointerInputChange.m4551copy8H9lfAM((i2 & 1) != 0 ? pointerInputChange.id : j, (i2 & 2) != 0 ? pointerInputChange.uptimeMillis : j2, (i2 & 4) != 0 ? pointerInputChange.position : j3, (i2 & 8) != 0 ? pointerInputChange.originalEventPosition : j4, (i2 & 16) != 0 ? pointerInputChange.pressed : z, (i2 & 32) != 0 ? pointerInputChange.pressure : f, (i2 & 64) != 0 ? pointerInputChange.previousUptimeMillis : j5, (i2 & 128) != 0 ? pointerInputChange.previousPosition : j6, (i2 & 256) != 0 ? pointerInputChange.previousPressed : z2, (i2 & 512) != 0 ? pointerInputChange.type : i, (i2 & 1024) != 0 ? pointerInputChange.getHistorical() : list, (i2 & 2048) != 0 ? pointerInputChange.scrollDelta : j7);
    }

    /* renamed from: copy-8H9lfAM, reason: not valid java name */
    public final PointerInputChange m4551copy8H9lfAM(long id2, long currentTime, long currentPosition, long originalEventPosition, boolean currentPressed, float pressure, long previousTime, long previousPosition, boolean previousPressed, int type, List<HistoricalChange> historical, long scrollDelta) {
        PointerInputChange pointerInputChange = new PointerInputChange(id2, currentTime, currentPosition, currentPressed, pressure, previousTime, previousPosition, previousPressed, false, type, historical, scrollDelta, originalEventPosition, null);
        pointerInputChange.consumed = this.consumed;
        return pointerInputChange;
    }
    ...
    public String toString() {
        ...
        sb.append((Object) PointerId.m4542toStringimpl(this.id)).append(", uptimeMillis=").append(this.uptimeMillis).append(", position=").append((Object) Offset.m3181toStringimpl(this.position)).append(", pressed=").append(this.pressed).append(", pressure=").append(this.pressure).append(", previousUptimeMillis=").append(this.previousUptimeMillis).append(", previousPosition=").append((Object) Offset.m3181toStringimpl(this.previousPosition)).append(", previousPressed=").append(this.previousPressed).append(", isConsumed=").append(isConsumed()).append(", type=").append((Object) PointerType.m4632toStringimpl(this.type)).append(", historical=").append(getHistorical()).append(",scrollDelta=");
        sb.append((Object) Offset.m3181toStringimpl(this.scrollDelta)).append(')');
        return sb.toString();
    }
}
