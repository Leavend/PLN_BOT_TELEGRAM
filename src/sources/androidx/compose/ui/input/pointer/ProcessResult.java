...
public final class ProcessResult {
    ...
    public static final /* synthetic */ ProcessResult m4642boximpl(int i) {
    ...
    public static final boolean m4646getAnyMovementConsumedimpl(int i) {
        return (i & 2) != 0;
    }

    /* renamed from: getDispatchedToAPointerInputModifier-impl, reason: not valid java name */
    public static final boolean m4647getDispatchedToAPointerInputModifierimpl(int i) {
        return (i & 1) != 0;
    }
