...
final class PointerInputChangeEventProducer {
    ...
    public final InternalPointerEvent produce(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator) {
        long uptime;
        boolean down;
        long jMo4641screenToLocalMKHz9U;
        ...
        for (int i = 0; i < size; i++) {
            ...
            PointerInputData pointerInputData = this.previousPointerInputData.get(pointerInputEventData.m4573getIdJ3iCeTQ());
            if (pointerInputData == null) {
                uptime = pointerInputEventData.getUptime();
                jMo4641screenToLocalMKHz9U = pointerInputEventData.m4575getPositionF1C5BW0();
                down = false;
            } else {
                long uptime2 = pointerInputData.getUptime();
                uptime = uptime2;
                down = pointerInputData.getDown();
                jMo4641screenToLocalMKHz9U = positionCalculator.mo4641screenToLocalMKHz9U(pointerInputData.getPositionOnScreen());
            }
            longSparseArray.put(pointerInputEventData.m4573getIdJ3iCeTQ(), new PointerInputChange(pointerInputEventData.m4573getIdJ3iCeTQ(), pointerInputEventData.getUptime(), pointerInputEventData.m4575getPositionF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.getPressure(), uptime, jMo4641screenToLocalMKHz9U, down, false, pointerInputEventData.m4578getTypeT8wyACA(), pointerInputEventData.getHistorical(), pointerInputEventData.m4577getScrollDeltaF1C5BW0(), pointerInputEventData.m4574getOriginalEventPositionF1C5BW0(), null));
            if (pointerInputEventData.getDown()) {
                this.previousPointerInputData.put(pointerInputEventData.m4573getIdJ3iCeTQ(), new PointerInputData(pointerInputEventData.getUptime(), pointerInputEventData.m4576getPositionOnScreenF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.m4578getTypeT8wyACA(), null));
            } else {
                this.previousPointerInputData.remove(pointerInputEventData.m4573getIdJ3iCeTQ());
            }
        }
