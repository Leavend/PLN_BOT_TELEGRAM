...
public final class KeyEventType {
    ...
    private static final int Unknown = m4413constructorimpl(0);
    private static final int KeyUp = m4413constructorimpl(1);
    private static final int KeyDown = m4413constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ KeyEventType m4412boximpl(int i) {
        return new KeyEventType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m4413constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4414equalsimpl(int i, Object obj) {
        return (obj instanceof KeyEventType) && i == ((KeyEventType) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4415equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4416hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m4414equalsimpl(this.value, obj);
    }
    ...
    public String toString() {
        return m4417toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m4417toStringimpl(int i) {
        return m4415equalsimpl0(i, KeyUp) ? "KeyUp" : m4415equalsimpl0(i, KeyDown) ? "KeyDown" : m4415equalsimpl0(i, Unknown) ? "Unknown" : "Invalid";
    }
