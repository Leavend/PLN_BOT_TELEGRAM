...
public final class NestedScrollInteropConnection implements NestedScrollConnection {
    ...
    public long mo404onPreScrollOzD1aCk(long available, int source) {
        if (this.nestedScrollChildHelper.startNestedScroll(NestedScrollInteropConnectionKt.m5031getScrollAxesk4lQ0M(available), NestedScrollInteropConnectionKt.m5033toViewTypeGyEprt8(source))) {
            ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
            this.nestedScrollChildHelper.dispatchNestedPreScroll(NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3173getXimpl(available)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3174getYimpl(available)), this.consumedScrollCache, null, NestedScrollInteropConnectionKt.m5033toViewTypeGyEprt8(source));
            return NestedScrollInteropConnectionKt.m5032toOffsetUv8p0NA(this.consumedScrollCache, available);
        }
    ...
    public long mo403onPostScrollDzOQY0M(long consumed, long available, int source) {
        if (this.nestedScrollChildHelper.startNestedScroll(NestedScrollInteropConnectionKt.m5031getScrollAxesk4lQ0M(available), NestedScrollInteropConnectionKt.m5033toViewTypeGyEprt8(source))) {
            ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
            this.nestedScrollChildHelper.dispatchNestedScroll(NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3173getXimpl(consumed)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3174getYimpl(consumed)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3173getXimpl(available)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m3174getYimpl(available)), null, NestedScrollInteropConnectionKt.m5033toViewTypeGyEprt8(source), this.consumedScrollCache);
            return NestedScrollInteropConnectionKt.m5032toOffsetUv8p0NA(this.consumedScrollCache, available);
        }
        return Offset.INSTANCE.m3189getZeroF1C5BW0();
    }
    ...
    public Object mo644onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        if (!this.nestedScrollChildHelper.dispatchNestedPreFling(NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m5970getXimpl(j)), NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m5971getYimpl(j)))) {
            j = Velocity.INSTANCE.m5981getZero9UxMQ8M();
        }
        interruptOngoingScrolls();
        return Velocity.m5961boximpl(j);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostFling-RZ2iAVY */
    public Object mo402onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        if (!this.nestedScrollChildHelper.dispatchNestedFling(NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m5970getXimpl(j2)), NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m5971getYimpl(j2)), true)) {
            j2 = Velocity.INSTANCE.m5981getZero9UxMQ8M();
        }
        interruptOngoingScrolls();
        return Velocity.m5961boximpl(j2);
    }
