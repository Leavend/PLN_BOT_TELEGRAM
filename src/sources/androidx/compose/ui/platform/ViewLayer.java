...
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    public ViewLayer(AndroidComposeView androidComposeView, DrawChildContainer drawChildContainer, Function1<? super Canvas, Unit> function1, Function0<Unit> function0) {
        ...
        this.mTransformOrigin = TransformOrigin.INSTANCE.m3804getCenterSzJe1aQ();
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope scope, LayoutDirection layoutDirection, Density density) {
        ...
        if ((mutatedFields$ui_release & 4096) != 0) {
            long jMo3603getTransformOriginSzJe1aQ = scope.getTransformOrigin();
            this.mTransformOrigin = jMo3603getTransformOriginSzJe1aQ;
            setPivotX(TransformOrigin.m3799getPivotFractionXimpl(jMo3603getTransformOriginSzJe1aQ) * getWidth());
            setPivotY(TransformOrigin.m3800getPivotFractionYimpl(this.mTransformOrigin) * getHeight());
        }
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            if ((mutatedFields$ui_release & 64) != 0) {
                ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this, ColorKt.m3468toArgb8_81llA(scope.getAmbientShadowColor()));
            }
            if ((mutatedFields$ui_release & 128) != 0) {
                ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this, ColorKt.m3468toArgb8_81llA(scope.getSpotShadowColor()));
            }
        }
        ...
        if ((mutatedFields$ui_release & 32768) != 0) {
            int iMo3600getCompositingStrategyNrFUSI = scope.getCompositingStrategy();
            if (CompositingStrategy.m3499equalsimpl0(iMo3600getCompositingStrategyNrFUSI, CompositingStrategy.INSTANCE.m3505getOffscreenNrFUSI())) {
                setLayerType(2, null);
            } else if (CompositingStrategy.m3499equalsimpl0(iMo3600getCompositingStrategyNrFUSI, CompositingStrategy.INSTANCE.m3504getModulateAlphaNrFUSI())) {
                setLayerType(0, null);
    ...
    public boolean mo4939isInLayerk4lQ0M(long position) {
        ...
        if (this.clipToBounds) {
            return 0.0f <= fM3173getXimpl && fM3173getXimpl < ((float) getWidth()) && 0.0f <= fM3174getYimpl && fM3174getYimpl < ((float) getHeight());
        }
        if (getClipToOutline()) {
    ...
    public void mo4942resizeozmzZPI(long size) {
        ...
        if (iM5905getWidthimpl == getWidth() && iM5904getHeightimpl == getHeight()) {
            return;
        }
        float f = iM5905getWidthimpl;
        setPivotX(TransformOrigin.m3799getPivotFractionXimpl(this.mTransformOrigin) * f);
        float f2 = iM5904getHeightimpl;
        setPivotY(TransformOrigin.m3800getPivotFractionYimpl(this.mTransformOrigin) * f2);
        this.outlineResolver.m5036updateuvyYCjk(SizeKt.Size(f, f2));
        updateOutlineResolver();
        layout(getLeft(), getTop(), getLeft() + iM5905getWidthimpl, getTop() + iM5904getHeightimpl);
        resetClipBounds();
        this.matrixCache.invalidate();
    }
    ...
    public void mo4941movegyyYBs(long position) {
        ...
        if (iM5863getXimpl != getLeft()) {
            offsetLeftAndRight(iM5863getXimpl - getLeft());
            this.matrixCache.invalidate();
        }
        int iM5864getYimpl = IntOffset.m5864getYimpl(position);
        if (iM5864getYimpl != getTop()) {
            offsetTopAndBottom(iM5864getYimpl - getTop());
            this.matrixCache.invalidate();
        }
    }
    ...
    public long mo4940mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            float[] fArrM5012calculateInverseMatrixbWbORWo = this.matrixCache.m5012calculateInverseMatrixbWbORWo(this);
        ...
        return androidx.compose.ui.graphics.Matrix.m3651mapMKHz9U(this.matrixCache.m5013calculateMatrixGrdbGEg(this), point);
    }
    ...
    public void mapBounds(MutableRect rect, boolean inverse) {
        ...
        androidx.compose.ui.graphics.Matrix.m3653mapimpl(this.matrixCache.m5013calculateMatrixGrdbGEg(this), rect);
    }
    ...
    public void mo4943transform58bKbWc(float[] matrix) {
        androidx.compose.ui.graphics.Matrix.m3662timesAssign58bKbWc(matrix, this.matrixCache.m5013calculateMatrixGrdbGEg(this));
    }
