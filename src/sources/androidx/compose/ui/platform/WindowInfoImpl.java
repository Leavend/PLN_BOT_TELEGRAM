...
public final class WindowInfoImpl implements WindowInfo {
    ...
    private static final MutableState<PointerKeyboardModifiers> GlobalKeyboardModifiers = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(PointerKeyboardModifiers.m4620boximpl(PointerEvent_androidKt.EmptyPointerKeyboardModifiers()), null, 2, null);
    ...
    public static /* synthetic */ void m5043getKeyboardModifiersk7X9c1A$annotations() {
    }
    ...
    public int mo5042getKeyboardModifiersk7X9c1A() {
        return GlobalKeyboardModifiers.getValue().getPackedValue();
    }

    /* renamed from: setKeyboardModifiers-5xRPYO0, reason: not valid java name */
    public void m5044setKeyboardModifiers5xRPYO0(int i) {
        GlobalKeyboardModifiers.setValue(PointerKeyboardModifiers.m4620boximpl(i));
    }
