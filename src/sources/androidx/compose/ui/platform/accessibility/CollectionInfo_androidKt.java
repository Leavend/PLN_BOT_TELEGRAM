    ...
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (list.size() == 0 || list.size() == 1) {
            ...
            while (i < lastIndex) {
                ...
                arrayListEmptyList.add(Offset.m3162boximpl(OffsetKt.Offset(Math.abs(Offset.m3173getXimpl(semanticsNode4.getBoundsInRoot().m3203getCenterF1C5BW0()) - Offset.m3173getXimpl(semanticsNode3.getBoundsInRoot().m3203getCenterF1C5BW0())), Math.abs(Offset.m3174getYimpl(semanticsNode4.getBoundsInRoot().m3203getCenterF1C5BW0()) - Offset.m3174getYimpl(semanticsNode3.getBoundsInRoot().m3203getCenterF1C5BW0())))));
        ...
        if (arrayListEmptyList.size() == 1) {
            ...
            if (1 <= lastIndex2) {
                int i2 = 1;
                while (true) {
                    objFirst = Offset.m3162boximpl(Offset.m3178plusMKHz9U(((Offset) objFirst).getPackedValue(), ((Offset) arrayListEmptyList.get(i2)).getPackedValue()));
                    if (i2 == lastIndex2) {
                        break;
                    }
                    i2++;
        ...
        return Offset.m3164component2impl(packedValue) < Offset.m3163component1impl(packedValue);
    }
