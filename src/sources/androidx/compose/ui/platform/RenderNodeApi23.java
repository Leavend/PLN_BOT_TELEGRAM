...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public RenderNodeApi23(AndroidComposeView androidComposeView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.INSTANCE.m3503getAutoNrFUSI();
    ...
    public void mo4998setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m3499equalsimpl0(i, CompositingStrategy.INSTANCE.m3505getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m3499equalsimpl0(i, CompositingStrategy.INSTANCE.m3504getModulateAlphaNrFUSI())) {
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m3499equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.INSTANCE.m3505getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            androidCanvas.save();
            Canvas.m3385clipPathmtrdDE$default(androidCanvas, clipPath, 0, 2, null);
        }
