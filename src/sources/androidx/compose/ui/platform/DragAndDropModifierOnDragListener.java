...
final class DragAndDropModifierOnDragListener implements View.OnDragListener, DragAndDropManager {
    ...
    public boolean mo3062drag12SF9DM(DragAndDropTransferData transferData, long decorationSize, Function1<? super DrawScope, Unit> drawDragDecoration) {
        return this.startDrag.invoke(transferData, Size.m3230boximpl(decorationSize), drawDragDecoration).booleanValue();
    }
