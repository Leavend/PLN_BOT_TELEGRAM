...
public final class CornerRadiusKt {
    ...
    public static final long m3159lerp3Ry4LBc(long j, long j2, float f) {
        return CornerRadius(MathHelpersKt.lerp(CornerRadius.m3148getXimpl(j), CornerRadius.m3148getXimpl(j2), f), MathHelpersKt.lerp(CornerRadius.m3149getYimpl(j), CornerRadius.m3149getYimpl(j2), f));
    }

    public static final long CornerRadius(float f, float f2) {
        return CornerRadius.m3142constructorimpl((Float.floatToRawIntBits(f2) & InternalZipConstants.ZIP_64_SIZE_LIMIT) | (Float.floatToRawIntBits(f) << 32));
    }
}
