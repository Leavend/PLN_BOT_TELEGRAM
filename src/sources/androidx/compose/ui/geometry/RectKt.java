...
public final class RectKt {
    ...
    public static final Rect m3213Recttz77jQw(long j, long j2) {
        return new Rect(Offset.m3173getXimpl(j), Offset.m3174getYimpl(j), Offset.m3173getXimpl(j) + Size.m3242getWidthimpl(j2), Offset.m3174getYimpl(j) + Size.m3239getHeightimpl(j2));
    }

    /* renamed from: Rect-0a9Yr6o, reason: not valid java name */
    public static final Rect m3211Rect0a9Yr6o(long j, long j2) {
        return new Rect(Offset.m3173getXimpl(j), Offset.m3174getYimpl(j), Offset.m3173getXimpl(j2), Offset.m3174getYimpl(j2));
    }

    /* renamed from: Rect-3MmeM6k, reason: not valid java name */
    public static final Rect m3212Rect3MmeM6k(long j, float f) {
        return new Rect(Offset.m3173getXimpl(j) - f, Offset.m3174getYimpl(j) - f, Offset.m3173getXimpl(j) + f, Offset.m3174getYimpl(j) + f);
    }
