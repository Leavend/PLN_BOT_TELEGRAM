...
public final class OneDimensionalFocusSearchKt {
    ...
    public static final boolean m3129oneDimensionalFocusSearchOMvw8(FocusTargetNode focusTargetNode, int i, Function1<? super FocusTargetNode, Boolean> function1) {
    ...
    private static final boolean forwardFocusSearch(FocusTargetNode focusTargetNode, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (i == 1) {
            ...
            if (activeChild != null) {
                return forwardFocusSearch(activeChild, function1) || m3128generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.INSTANCE.m3103getNextdhqQ8s(), function1);
            }
    ...
    private static final boolean backwardFocusSearch(FocusTargetNode focusTargetNode, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (i == 1) {
            ...
            if (i2 != 1) {
                if (i2 == 2 || i2 == 3) {
                    return m3128generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.INSTANCE.m3104getPreviousdhqQ8s(), function1);
                }
                if (i2 == 4) {
                    throw new IllegalStateException(NoActiveChild.toString());
                }
            ...
            if (!backwardFocusSearch(activeChild, function1) && !m3128generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.INSTANCE.m3104getPreviousdhqQ8s(), function1) && (!activeChild.fetchFocusProperties$ui_release().getCanFocus() || !function1.invoke(activeChild).booleanValue())) {
                return false;
            }
        } else {
            if (i == 2 || i == 3) {
    ...
    private static final boolean m3128generateAndSearchChildren4C6V_qg(final FocusTargetNode focusTargetNode, final FocusTargetNode focusTargetNode2, final int i, final Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m3089searchBeyondBoundsOMvw8(focusTargetNode, i, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.OneDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope beyondBoundsScope) {
                Boolean boolValueOf = Boolean.valueOf(OneDimensionalFocusSearchKt.m3130searchChildren4C6V_qg(focusTargetNode, focusTargetNode2, i, function1));
    ...
    public static final boolean m3130searchChildren4C6V_qg(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (FocusDirection.m3093equalsimpl0(i, FocusDirection.INSTANCE.m3103getNextdhqQ8s()) || !focusTargetNode.fetchFocusProperties$ui_release().getCanFocus() || isRoot(focusTargetNode)) {
            return false;
        }
        return function1.invoke(focusTargetNode).booleanValue();
    }
