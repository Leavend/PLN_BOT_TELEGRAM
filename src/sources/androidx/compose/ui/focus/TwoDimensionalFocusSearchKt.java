...
public final class TwoDimensionalFocusSearchKt {
    ...
    public static final Boolean m3138twoDimensionalFocusSearchOMvw8(FocusTargetNode focusTargetNode, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        int i2 = WhenMappings.$EnumSwitchMapping$0[focusTargetNode.getFocusState().ordinal()];
        if (i2 != 1) {
            if (i2 == 2 || i2 == 3) {
                return Boolean.valueOf(m3134findChildCorrespondingToFocusEnterOMvw8(focusTargetNode, i, function1));
            }
            if (i2 == 4) {
        ...
        if (i3 == 1) {
            Boolean boolM3138twoDimensionalFocusSearchOMvw8 = m3138twoDimensionalFocusSearchOMvw8(activeChild, i, function1);
            return !Intrinsics.areEqual((Object) boolM3138twoDimensionalFocusSearchOMvw8, (Object) false) ? boolM3138twoDimensionalFocusSearchOMvw8 : Boolean.valueOf(m3135generateAndSearchChildren4C6V_qg(focusTargetNode, activeNode(activeChild), i, function1));
        }
        if (i3 == 2 || i3 == 3) {
            return Boolean.valueOf(m3135generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, i, function1));
        }
        if (i3 == 4) {
            throw new IllegalStateException(NoActiveChild.toString());
        }
    ...
    private static final boolean m3135generateAndSearchChildren4C6V_qg(final FocusTargetNode focusTargetNode, final FocusTargetNode focusTargetNode2, final int i, final Function1<? super FocusTargetNode, Boolean> function1) {
        if (m3137searchChildren4C6V_qg(focusTargetNode, focusTargetNode2, i, function1)) {
            return true;
        }
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m3089searchBeyondBoundsOMvw8(focusTargetNode, i, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.TwoDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope beyondBoundsScope) {
                Boolean boolValueOf = Boolean.valueOf(TwoDimensionalFocusSearchKt.m3137searchChildren4C6V_qg(focusTargetNode, focusTargetNode2, i, function1));
    ...
    private static final FocusTargetNode m3133findBestCandidate4WY_MpI(MutableVector<FocusTargetNode> mutableVector, Rect rect, int i) {
        Rect rectTranslate;
        if (FocusDirection.m3093equalsimpl0(i, FocusDirection.INSTANCE.m3102getLeftdhqQ8s())) {
            ...
            rectTranslate = rect.translate(-(rect.getWidth() + 1), 0.0f);
        } else if (FocusDirection.m3093equalsimpl0(i, FocusDirection.INSTANCE.m3106getUpdhqQ8s())) {
        ...
        if (size > 0) {
            ...
            do {
                ...
                if (FocusTraversalKt.isEligibleForFocusSearch(focusTargetNode2)) {
                    ...
                    if (m3136isBetterCandidateI7lrPNg(rectFocusRect, rectTranslate, rect, i)) {
    ...
    private static final float isBetterCandidate_I7lrPNg$majorAxisDistance(Rect rect, int i, Rect rect2) {
        ...
        float f;
        if (!FocusDirection.m3093equalsimpl0(i, FocusDirection.INSTANCE.m3102getLeftdhqQ8s())) {
            if (FocusDirection.m3093equalsimpl0(i, FocusDirection.INSTANCE.m3105getRightdhqQ8s())) {
                top = rect.getLeft();
    ...
    private static final float isBetterCandidate_I7lrPNg$minorAxisDistance(Rect rect, int i, Rect rect2) {
        ...
        float left2;
        float width;
        if (FocusDirection.m3093equalsimpl0(i, FocusDirection.INSTANCE.m3102getLeftdhqQ8s()) ? true : FocusDirection.m3093equalsimpl0(i, FocusDirection.INSTANCE.m3105getRightdhqQ8s())) {
            f = 2;
            left = rect2.getTop() + (rect2.getHeight() / f);
            left2 = rect.getTop();
            width = rect.getHeight();
        } else {
            if (!(FocusDirection.m3093equalsimpl0(i, FocusDirection.INSTANCE.m3106getUpdhqQ8s()) ? true : FocusDirection.m3093equalsimpl0(i, FocusDirection.INSTANCE.m3099getDowndhqQ8s()))) {
                throw new IllegalStateException(InvalidFocusDirection.toString());
            }
            f = 2;
    ...
    private static final boolean m3136isBetterCandidateI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (isBetterCandidate_I7lrPNg$isCandidate(rect, i, rect3)) {
            return !isBetterCandidate_I7lrPNg$isCandidate(rect2, i, rect3) || m3132beamBeatsI7lrPNg(rect3, rect, rect2, i) || (!m3132beamBeatsI7lrPNg(rect3, rect2, rect, i) && isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect) < isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect2));
        }
        return false;
    }
    ...
    public static final boolean m3134findChildCorrespondingToFocusEnterOMvw8(FocusTargetNode focusTargetNode, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (FocusDirection.m3093equalsimpl0(i, FocusDirection.INSTANCE.m3100getEnterdhqQ8s())) {
            i = FocusDirection.INSTANCE.m3105getRightdhqQ8s();
        }
        if (FocusDirection.m3093equalsimpl0(i, FocusDirection.INSTANCE.m3105getRightdhqQ8s()) ? true : FocusDirection.m3093equalsimpl0(i, FocusDirection.INSTANCE.m3099getDowndhqQ8s())) {
            rectBottomRight = topLeft(FocusTraversalKt.focusRect(focusTargetNode));
        } else {
            if (!(FocusDirection.m3093equalsimpl0(i, FocusDirection.INSTANCE.m3102getLeftdhqQ8s()) ? true : FocusDirection.m3093equalsimpl0(i, FocusDirection.INSTANCE.m3106getUpdhqQ8s()))) {
                throw new IllegalStateException(InvalidFocusDirection.toString());
            }
            rectBottomRight = bottomRight(FocusTraversalKt.focusRect(focusTargetNode));
        }
        FocusTargetNode focusTargetNodeM3133findBestCandidate4WY_MpI = m3133findBestCandidate4WY_MpI(mutableVector, rectBottomRight, i);
        if (focusTargetNodeM3133findBestCandidate4WY_MpI != null) {
            return function1.invoke(focusTargetNodeM3133findBestCandidate4WY_MpI).booleanValue();
        }
        return false;
    }
    ...
    public static final boolean m3137searchChildren4C6V_qg(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        FocusTargetNode focusTargetNodeM3133findBestCandidate4WY_MpI;
        MutableVector mutableVector = new MutableVector(new FocusTargetNode[16], 0);
        ...
        while (mutableVector.isNotEmpty() && (focusTargetNodeM3133findBestCandidate4WY_MpI = m3133findBestCandidate4WY_MpI(mutableVector, FocusTraversalKt.focusRect(focusTargetNode2), i)) != null) {
            if (focusTargetNodeM3133findBestCandidate4WY_MpI.fetchFocusProperties$ui_release().getCanFocus()) {
                return function1.invoke(focusTargetNodeM3133findBestCandidate4WY_MpI).booleanValue();
            }
            if (m3135generateAndSearchChildren4C6V_qg(focusTargetNodeM3133findBestCandidate4WY_MpI, focusTargetNode2, i, function1)) {
                return true;
            }
            mutableVector.remove(focusTargetNodeM3133findBestCandidate4WY_MpI);
        }
        return false;
    }
