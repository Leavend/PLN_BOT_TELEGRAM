...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    private final MutableState size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m3230boximpl(Size.INSTANCE.m3250getUnspecifiedNHjbRc()), null, 2, null);
    private final State<Shader> shaderState = SnapshotStateKt.derivedStateOf(new Function0<Shader>() { // from class: androidx.compose.ui.text.platform.style.ShaderBrushSpan$shaderState$1
        ...
        public final Shader invoke() {
            if ((this.this$0.m5509getSizeNHjbRc() == Size.INSTANCE.m3250getUnspecifiedNHjbRc()) || Size.m3244isEmptyimpl(this.this$0.m5509getSizeNHjbRc())) {
                return null;
            }
            return this.this$0.getShaderBrush().mo3383createShaderuvyYCjk(this.this$0.m5509getSizeNHjbRc());
        }
    });
    ...
    public final long m5509getSizeNHjbRc() {
        return ((Size) this.size.getValue()).getPackedValue();
    }

    /* renamed from: setSize-uvyYCjk, reason: not valid java name */
    public final void m5510setSizeuvyYCjk(long j) {
