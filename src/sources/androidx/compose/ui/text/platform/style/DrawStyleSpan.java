...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public void updateDrawState(TextPaint textPaint) {
        if (textPaint != null) {
            ...
            if (drawStyle instanceof Stroke) {
                ...
                textPaint.setStrokeJoin(m5508toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).getJoin()));
                textPaint.setStrokeCap(m5507toAndroidCapBeK7IIE(((Stroke) this.drawStyle).getCap()));
    ...
    private final Paint.Join m5508toAndroidJoinWw9F2mQ(int i) {
        return StrokeJoin.m3772equalsimpl0(i, StrokeJoin.INSTANCE.m3777getMiterLxFBmk8()) ? Paint.Join.MITER : StrokeJoin.m3772equalsimpl0(i, StrokeJoin.INSTANCE.m3778getRoundLxFBmk8()) ? Paint.Join.ROUND : StrokeJoin.m3772equalsimpl0(i, StrokeJoin.INSTANCE.m3776getBevelLxFBmk8()) ? Paint.Join.BEVEL : Paint.Join.MITER;
    }

    /* renamed from: toAndroidCap-BeK7IIE, reason: not valid java name */
    private final Paint.Cap m5507toAndroidCapBeK7IIE(int i) {
        return StrokeCap.m3762equalsimpl0(i, StrokeCap.INSTANCE.m3766getButtKaPHkGw()) ? Paint.Cap.BUTT : StrokeCap.m3762equalsimpl0(i, StrokeCap.INSTANCE.m3767getRoundKaPHkGw()) ? Paint.Cap.ROUND : StrokeCap.m3762equalsimpl0(i, StrokeCap.INSTANCE.m3768getSquareKaPHkGw()) ? Paint.Cap.SQUARE : Paint.Cap.BUTT;
    }
}
