...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(Spannable spannable, TextIndent textIndent, float f, Density density) {
        float fM5926getValueimpl;
        if (textIndent != null) {
            if ((TextUnit.m5923equalsimpl0(textIndent.getFirstLine(), TextUnitKt.getSp(0)) && TextUnit.m5923equalsimpl0(textIndent.getRestLine(), TextUnitKt.getSp(0))) || TextUnitKt.m5944isUnspecifiedR2X_6o(textIndent.getFirstLine()) || TextUnitKt.m5944isUnspecifiedR2X_6o(textIndent.getRestLine())) {
                return;
            }
            long jM5925getTypeUIouoOA = TextUnit.m5925getTypeUIouoOA(textIndent.getFirstLine());
            float fM5926getValueimpl2 = 0.0f;
            if (TextUnitType.m5954equalsimpl0(jM5925getTypeUIouoOA, TextUnitType.INSTANCE.m5959getSpUIouoOA())) {
                fM5926getValueimpl = density.mo315toPxR2X_6o(textIndent.getFirstLine());
            } else {
                fM5926getValueimpl = TextUnitType.m5954equalsimpl0(jM5925getTypeUIouoOA, TextUnitType.INSTANCE.m5958getEmUIouoOA()) ? TextUnit.m5926getValueimpl(textIndent.getFirstLine()) * f : 0.0f;
            }
            long jM5925getTypeUIouoOA2 = TextUnit.m5925getTypeUIouoOA(textIndent.getRestLine());
            if (TextUnitType.m5954equalsimpl0(jM5925getTypeUIouoOA2, TextUnitType.INSTANCE.m5959getSpUIouoOA())) {
                fM5926getValueimpl2 = density.mo315toPxR2X_6o(textIndent.getRestLine());
            } else if (TextUnitType.m5954equalsimpl0(jM5925getTypeUIouoOA2, TextUnitType.INSTANCE.m5958getEmUIouoOA())) {
                fM5926getValueimpl2 = TextUnit.m5926getValueimpl(textIndent.getRestLine()) * f;
            }
            setSpan(spannable, new LeadingMarginSpan.Standard((int) Math.ceil(fM5926getValueimpl), (int) Math.ceil(fM5926getValueimpl2)), 0, spannable.length());
        }
    }

    /* renamed from: setLineHeight-KmRG4DE, reason: not valid java name */
    public static final void m5504setLineHeightKmRG4DE(Spannable spannable, long j, float f, Density density, LineHeightStyle lineHeightStyle) {
        float fM5499resolveLineHeightInPxo2QH7mI = m5499resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(fM5499resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        Spannable spannable2 = spannable;
        setSpan(spannable, new LineHeightStyleSpan(fM5499resolveLineHeightInPxo2QH7mI, 0, ((spannable2.length() == 0) || StringsKt.last(spannable2) == '\n') ? spannable.length() + 1 : spannable.length(), LineHeightStyle.Trim.m5612isTrimFirstLineTopimpl$ui_text_release(lineHeightStyle.getTrim()), LineHeightStyle.Trim.m5613isTrimLastLineBottomimpl$ui_text_release(lineHeightStyle.getTrim()), lineHeightStyle.getAlignment()), 0, spannable.length());
    }

    /* renamed from: setLineHeight-r9BaKPg, reason: not valid java name */
    public static final void m5505setLineHeightr9BaKPg(Spannable spannable, long j, float f, Density density) {
        float fM5499resolveLineHeightInPxo2QH7mI = m5499resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(fM5499resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        setSpan(spannable, new LineHeightSpan(fM5499resolveLineHeightInPxo2QH7mI), 0, spannable.length());
    }

    /* renamed from: resolveLineHeightInPx-o2QH7mI, reason: not valid java name */
    private static final float m5499resolveLineHeightInPxo2QH7mI(long j, float f, Density density) {
        float fM5926getValueimpl;
        long jM5925getTypeUIouoOA = TextUnit.m5925getTypeUIouoOA(j);
        if (TextUnitType.m5954equalsimpl0(jM5925getTypeUIouoOA, TextUnitType.INSTANCE.m5959getSpUIouoOA())) {
            if (!isNonLinearFontScalingActive(density)) {
                return density.mo315toPxR2X_6o(j);
            }
            fM5926getValueimpl = TextUnit.m5926getValueimpl(j) / TextUnit.m5926getValueimpl(density.mo319toSpkPz2Gy4(f));
        } else {
            if (!TextUnitType.m5954equalsimpl0(jM5925getTypeUIouoOA, TextUnitType.INSTANCE.m5958getEmUIouoOA())) {
                return Float.NaN;
            }
            fM5926getValueimpl = TextUnit.m5926getValueimpl(j);
        }
        return fM5926getValueimpl * f;
    }
    ...
    public static final void setSpanStyles(Spannable spannable, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        MetricAffectingSpan metricAffectingSpanM5498createLetterSpacingSpaneAf_CNQ;
        ...
        if (z) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (start2 >= 0 && start2 < spannable.length() && end2 > start2 && end2 <= spannable.length() && (metricAffectingSpanM5498createLetterSpacingSpaneAf_CNQ = m5498createLetterSpacingSpaneAf_CNQ(item.getLetterSpacing(), density)) != null) {
                    setSpan(spannable, metricAffectingSpanM5498createLetterSpacingSpaneAf_CNQ, start2, end2);
                }
            }
        }
    }
    ...
    private static final void setSpanStyle(Spannable spannable, AnnotatedString.Range<SpanStyle> range, Density density) {
        ...
        m5501setBaselineShift0ocSgnM(spannable, item.getBaselineShift(), start, end);
        m5502setColorRPmYEkk(spannable, item.m5194getColor0d7_KjU(), start, end);
        setBrush(spannable, item.getBrush(), item.getAlpha(), start, end);
        setTextDecoration(spannable, item.getTextDecoration(), start, end);
        m5503setFontSizeKmRG4DE(spannable, item.getFontSize(), density, start, end);
        ...
        m5500setBackgroundRPmYEkk(spannable, item.getBackground(), start, end);
    ...
    private static final MetricAffectingSpan m5498createLetterSpacingSpaneAf_CNQ(long j, Density density) {
        long jM5925getTypeUIouoOA = TextUnit.m5925getTypeUIouoOA(j);
        if (TextUnitType.m5954equalsimpl0(jM5925getTypeUIouoOA, TextUnitType.INSTANCE.m5959getSpUIouoOA())) {
            return new LetterSpacingSpanPx(density.mo315toPxR2X_6o(j));
        }
        if (TextUnitType.m5954equalsimpl0(jM5925getTypeUIouoOA, TextUnitType.INSTANCE.m5958getEmUIouoOA())) {
            return new LetterSpacingSpanEm(TextUnit.m5926getValueimpl(j));
        }
        return null;
    }

    private static final boolean getNeedsLetterSpacingSpan(SpanStyle spanStyle) {
        return TextUnitType.m5954equalsimpl0(TextUnit.m5925getTypeUIouoOA(spanStyle.getLetterSpacing()), TextUnitType.INSTANCE.m5959getSpUIouoOA()) || TextUnitType.m5954equalsimpl0(TextUnit.m5925getTypeUIouoOA(spanStyle.getLetterSpacing()), TextUnitType.INSTANCE.m5958getEmUIouoOA());
    }

    private static final void setShadow(Spannable spannable, Shadow shadow, int i, int i2) {
        if (shadow != null) {
            setSpan(spannable, new ShadowSpan(ColorKt.m3468toArgb8_81llA(shadow.getColor()), Offset.m3173getXimpl(shadow.getOffset()), Offset.m3174getYimpl(shadow.getOffset()), TextPaintExtensions_androidKt.correctBlurRadius(shadow.getBlurRadius())), i, i2);
        }
    }
    ...
    public static final void m5503setFontSizeKmRG4DE(Spannable spannable, long j, Density density, int i, int i2) {
        long jM5925getTypeUIouoOA = TextUnit.m5925getTypeUIouoOA(j);
        if (TextUnitType.m5954equalsimpl0(jM5925getTypeUIouoOA, TextUnitType.INSTANCE.m5959getSpUIouoOA())) {
            setSpan(spannable, new AbsoluteSizeSpan(MathKt.roundToInt(density.mo315toPxR2X_6o(j)), false), i, i2);
        } else if (TextUnitType.m5954equalsimpl0(jM5925getTypeUIouoOA, TextUnitType.INSTANCE.m5958getEmUIouoOA())) {
            setSpan(spannable, new RelativeSizeSpan(TextUnit.m5926getValueimpl(j)), i, i2);
        }
    }
    ...
    private static final void m5501setBaselineShift0ocSgnM(Spannable spannable, BaselineShift baselineShift, int i, int i2) {
        if (baselineShift != null) {
            setSpan(spannable, new BaselineShiftSpan(baselineShift.m5517unboximpl()), i, i2);
        }
    }
    ...
    private static final void setBrush(Spannable spannable, Brush brush, float f, int i, int i2) {
        if (brush != null) {
            if (brush instanceof SolidColor) {
                m5502setColorRPmYEkk(spannable, ((SolidColor) brush).getValue(), i, i2);
    ...
    private static final boolean hasFontAttributes(TextStyle textStyle) {
        return TextPaintExtensions_androidKt.hasFontAttributes(textStyle.toSpanStyle()) || textStyle.m5268getFontSynthesisZQGJjVo() != null;
    }
    ...
    private static final void setFontAttributes(final Spannable spannable, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, final Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        ...
        flattenFontStylesAndApply(hasFontAttributes(textStyle) ? new SpanStyle(0L, 0L, textStyle.getFontWeight(), textStyle.m5267getFontStyle4Lr2A7w(), textStyle.m5268getFontSynthesisZQGJjVo(), textStyle.getFontFamily(), (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65475, (DefaultConstructorMarker) null) : null, arrayList, new Function3<SpanStyle, Integer, Integer, Unit>() { // from class: androidx.compose.ui.text.platform.extensions.SpannableExtensions_androidKt.setFontAttributes.1
            ...
            public final void invoke(SpanStyle spanStyle, int i2, int i3) {
                ...
                FontStyle fontStyleM5342boximpl = FontStyle.m5342boximpl(fontStyle != null ? fontStyle.m5348unboximpl() : FontStyle.INSTANCE.m5352getNormal_LCdwA());
                FontSynthesis fontSynthesis = spanStyle.getFontSynthesis();
                spannable2.setSpan(new TypefaceSpan(function42.invoke(fontFamily, fontWeight, fontStyleM5342boximpl, FontSynthesis.m5353boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m5362getAllGVVA2EU()))), i2, i3, 33);
            }
        });
    }

    /* renamed from: setBackground-RPmYEkk, reason: not valid java name */
    public static final void m5500setBackgroundRPmYEkk(Spannable spannable, long j, int i, int i2) {
        if (j != Color.INSTANCE.m3450getUnspecified0d7_KjU()) {
            setSpan(spannable, new BackgroundColorSpan(ColorKt.m3468toArgb8_81llA(j)), i, i2);
        }
    }

    /* renamed from: setColor-RPmYEkk, reason: not valid java name */
    public static final void m5502setColorRPmYEkk(Spannable spannable, long j, int i, int i2) {
        if (j != Color.INSTANCE.m3450getUnspecified0d7_KjU()) {
            setSpan(spannable, new ForegroundColorSpan(ColorKt.m3468toArgb8_81llA(j)), i, i2);
        }
    }
}
