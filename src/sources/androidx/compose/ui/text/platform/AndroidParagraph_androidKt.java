...
public final class AndroidParagraph_androidKt {
    ...
    public static final Paragraph m5486ActualParagraphO3s9Psw(String str, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, int i, boolean z, long j, Density density, FontFamily.Resolver resolver) {
    ...
    public static final Paragraph m5485ActualParagraphhBUhpc(ParagraphIntrinsics paragraphIntrinsics, int i, boolean z, long j) {
