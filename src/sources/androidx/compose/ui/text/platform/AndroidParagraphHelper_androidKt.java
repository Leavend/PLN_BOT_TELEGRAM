...
public final class AndroidParagraphHelper_androidKt {
    ...
    public static final CharSequence createCharSequence(String str, float f, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4, boolean z) {
        ...
        if (list.isEmpty() && list2.isEmpty() && Intrinsics.areEqual(textStyle.getTextIndent(), TextIndent.INSTANCE.getNone()) && TextUnitKt.m5944isUnspecifiedR2X_6o(textStyle.m5274getLineHeightXSAIIZE())) {
            return strProcess;
        }
        ...
        if (isIncludeFontPaddingEnabled(textStyle) && textStyle.getLineHeightStyle() == null) {
            SpannableExtensions_androidKt.m5505setLineHeightr9BaKPg(spannableString, textStyle.m5274getLineHeightXSAIIZE(), f, density);
        } else {
            ...
            SpannableExtensions_androidKt.m5504setLineHeightKmRG4DE(spannable, textStyle.m5274getLineHeightXSAIIZE(), f, density, lineHeightStyle);
        }
