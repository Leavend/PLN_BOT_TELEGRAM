...
public final /* data */ class ParagraphInfo {
    ...
    public final long m5125toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m3173getXimpl(j), Offset.m3174getYimpl(j) - this.top);
    }

    public final Rect toGlobal(Rect rect) {
        return rect.m3210translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    public final Path toGlobal(Path path) {
        path.mo3309translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }

    /* renamed from: toGlobal-GEjPoXI, reason: not valid java name */
    public final long m5124toGlobalGEjPoXI(long j) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m5235getStartimpl(j)), toGlobalIndex(TextRange.m5230getEndimpl(j)));
    }
}
