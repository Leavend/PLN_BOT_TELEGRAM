...
public final class SpanStyleKt {
    ...
    public static final long m5200lerpTextUnitInheritableC3pnCVY(long j, long j2, float f) {
        if (TextUnitKt.m5944isUnspecifiedR2X_6o(j) || TextUnitKt.m5944isUnspecifiedR2X_6o(j2)) {
            return ((TextUnit) lerpDiscrete(TextUnit.m5916boximpl(j), TextUnit.m5916boximpl(j2), f)).getPackedValue();
        }
        return TextUnitKt.m5946lerpC3pnCVY(j, j2, f);
    }
    ...
    public static final SpanStyle lerp(SpanStyle spanStyle, SpanStyle spanStyle2, float f) {
        ...
        long jM5200lerpTextUnitInheritableC3pnCVY = m5200lerpTextUnitInheritableC3pnCVY(spanStyle.getFontSize(), spanStyle2.getFontSize(), f);
        ...
        long jM5200lerpTextUnitInheritableC3pnCVY2 = m5200lerpTextUnitInheritableC3pnCVY(spanStyle.getLetterSpacing(), spanStyle2.getLetterSpacing(), f);
        BaselineShift baselineShift = spanStyle.getBaselineShift();
        float fM5517unboximpl = baselineShift != null ? baselineShift.m5517unboximpl() : BaselineShift.m5512constructorimpl(0.0f);
        BaselineShift baselineShift2 = spanStyle2.getBaselineShift();
        float fM5524lerpjWV1Mfo = BaselineShiftKt.m5524lerpjWV1Mfo(fM5517unboximpl, baselineShift2 != null ? baselineShift2.m5517unboximpl() : BaselineShift.m5512constructorimpl(0.0f), f);
        ...
        long jM3465lerpjxsXWHM = ColorKt.m3465lerpjxsXWHM(spanStyle.getBackground(), spanStyle2.getBackground(), f);
        ...
        return new SpanStyle(textForegroundStyleLerp, jM5200lerpTextUnitInheritableC3pnCVY, fontWeightLerp, fontStyle, fontSynthesis, fontFamily, str, jM5200lerpTextUnitInheritableC3pnCVY2, BaselineShift.m5511boximpl(fM5524lerpjWV1Mfo), textGeometricTransformLerp, localeList, jM3465lerpjxsXWHM, textDecoration, ShadowKt.lerp(shadow, shadow2, f), lerpPlatformStyle(spanStyle.getPlatformStyle(), spanStyle2.getPlatformStyle(), f), (DrawStyle) lerpDiscrete(spanStyle.getDrawStyle(), spanStyle2.getDrawStyle(), f), (DefaultConstructorMarker) null);
    }
    ...
    public static final SpanStyle resolveSpanStyleDefaults(SpanStyle spanStyle) {
        ...
        TextForegroundStyle textForegroundStyleTakeOrElse = spanStyle.getTextForegroundStyle().takeOrElse(new Function0<TextForegroundStyle>() { // from class: androidx.compose.ui.text.SpanStyleKt.resolveSpanStyleDefaults.1
            ...
            public final TextForegroundStyle invoke() {
                return TextForegroundStyle.INSTANCE.m5648from8_81llA(SpanStyleKt.DefaultColor);
            }
        });
        long fontSize = TextUnitKt.m5944isUnspecifiedR2X_6o(spanStyle.getFontSize()) ? DefaultFontSize : spanStyle.getFontSize();
        FontWeight fontWeight = spanStyle.getFontWeight();
        if (fontWeight == null) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        ...
        FontSynthesis fontSynthesisM5353boximpl = FontSynthesis.m5353boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m5362getAllGVVA2EU());
        ...
        if (TextUnitKt.m5944isUnspecifiedR2X_6o(spanStyle.getLetterSpacing())) {
        ...
        BaselineShift baselineShift = spanStyle.getBaselineShift();
        BaselineShift baselineShiftM5511boximpl = BaselineShift.m5511boximpl(baselineShift != null ? baselineShift.m5517unboximpl() : BaselineShift.INSTANCE.m5521getNoney9eOQZs());
        TextGeometricTransform textGeometricTransform = spanStyle.getTextGeometricTransform();
        if (textGeometricTransform == null) {
            textGeometricTransform = TextGeometricTransform.INSTANCE.getNone$ui_text_release();
        }
        ...
        if (!(background != Color.INSTANCE.m3450getUnspecified0d7_KjU())) {
        ...
        return new SpanStyle(textForegroundStyleTakeOrElse, fontSize, fontWeight2, fontStyleM5342boximpl, fontSynthesisM5353boximpl, fontFamily2, str, j, baselineShiftM5511boximpl, textGeometricTransform2, localeList2, j2, textDecoration2, shadow2, platformStyle, drawStyle, (DefaultConstructorMarker) null);
    }
    ...
    */
    public static final androidx.compose.ui.text.SpanStyle m5199fastMergedSHsh3o(androidx.compose.ui.text.SpanStyle r21, long r22, androidx.compose.ui.graphics.Brush r24, float r25, long r26, androidx.compose.ui.text.font.FontWeight r28, androidx.compose.ui.text.font.FontStyle r29, androidx.compose.ui.text.font.FontSynthesis r30, androidx.compose.ui.text.font.FontFamily r31, java.lang.String r32, long r33, androidx.compose.ui.text.style.BaselineShift r35, androidx.compose.ui.text.style.TextGeometricTransform r36, androidx.compose.ui.text.intl.LocaleList r37, long r38, androidx.compose.ui.text.style.TextDecoration r40, androidx.compose.ui.graphics.Shadow r41, androidx.compose.ui.text.PlatformSpanStyle r42, androidx.compose.ui.graphics.drawscope.DrawStyle r43) {
        /*
            Method dump skipped, instructions count: 548
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.SpanStyleKt.m5199fastMergedSHsh3o(androidx.compose.ui.text.SpanStyle, long, androidx.compose.ui.graphics.Brush, float, long, androidx.compose.ui.text.font.FontWeight, androidx.compose.ui.text.font.FontStyle, androidx.compose.ui.text.font.FontSynthesis, androidx.compose.ui.text.font.FontFamily, java.lang.String, long, androidx.compose.ui.text.style.BaselineShift, androidx.compose.ui.text.style.TextGeometricTransform, androidx.compose.ui.text.intl.LocaleList, long, androidx.compose.ui.text.style.TextDecoration, androidx.compose.ui.graphics.Shadow, androidx.compose.ui.text.PlatformSpanStyle, androidx.compose.ui.graphics.drawscope.DrawStyle):androidx.compose.ui.text.SpanStyle");
    }
}
