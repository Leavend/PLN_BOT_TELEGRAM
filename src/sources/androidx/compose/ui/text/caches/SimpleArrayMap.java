        ...
        if (i2 <= 1) {
            ...
            if (iArr.length > 8 && i2 < iArr.length / 3) {
                ...
                if (index < i3) {
                    ...
                    ArraysKt.copyInto(objArr, this.keyValues, i, i5 << 1, i6 << 1);
                }
            } else {
                if (index < i3) {
                    int i7 = index + 1;
