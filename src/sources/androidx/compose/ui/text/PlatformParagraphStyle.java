...
public final class PlatformParagraphStyle {
    ...
    public PlatformParagraphStyle(boolean z) {
        ...
        this.emojiSupportMatch = EmojiSupportMatch.INSTANCE.m5106getDefault_3YsG6Y();
    }
    ...
    public /* synthetic */ PlatformParagraphStyle(int i, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? EmojiSupportMatch.INSTANCE.m5106getDefault_3YsG6Y() : i, (i2 & 2) != 0 ? false : z, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ PlatformParagraphStyle(int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? EmojiSupportMatch.INSTANCE.m5106getDefault_3YsG6Y() : i, (DefaultConstructorMarker) null);
    }

    public PlatformParagraphStyle() {
        this(EmojiSupportMatch.INSTANCE.m5106getDefault_3YsG6Y(), false, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return this.includeFontPadding == platformParagraphStyle.includeFontPadding && EmojiSupportMatch.m5102equalsimpl0(this.emojiSupportMatch, platformParagraphStyle.emojiSupportMatch);
    }

    public int hashCode() {
        return (Boolean.hashCode(this.includeFontPadding) * 31) + EmojiSupportMatch.m5103hashCodeimpl(this.emojiSupportMatch);
    }

    public String toString() {
        return "PlatformParagraphStyle(includeFontPadding=" + this.includeFontPadding + ", emojiSupportMatch=" + ((Object) EmojiSupportMatch.m5104toStringimpl(this.emojiSupportMatch)) + ')';
    }
}
