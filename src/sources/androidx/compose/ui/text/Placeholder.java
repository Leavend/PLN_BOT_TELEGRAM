...
public final class Placeholder {
    ...
    private Placeholder(long j, long j2, int i) {
        ...
        if (!(!TextUnitKt.m5944isUnspecifiedR2X_6o(j2))) {
    ...
    public static /* synthetic */ Placeholder m5154copyK8Q__8$default(Placeholder placeholder, long j, long j2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            j = placeholder.width;
        }
        long j3 = j;
        ...
        return placeholder.m5155copyK8Q__8(j3, j4, i);
    }

    /* renamed from: copy-K8Q-__8, reason: not valid java name */
    public final Placeholder m5155copyK8Q__8(long width, long height, int placeholderVerticalAlign) {
    ...
    public boolean equals(Object other) {
        ...
        return TextUnit.m5923equalsimpl0(this.width, placeholder.width) && TextUnit.m5923equalsimpl0(this.height, placeholder.height) && PlaceholderVerticalAlign.m5162equalsimpl0(this.placeholderVerticalAlign, placeholder.placeholderVerticalAlign);
    }

    public int hashCode() {
        return (((TextUnit.m5927hashCodeimpl(this.width) * 31) + TextUnit.m5927hashCodeimpl(this.height)) * 31) + PlaceholderVerticalAlign.m5163hashCodeimpl(this.placeholderVerticalAlign);
    }

    public String toString() {
        return "Placeholder(width=" + ((Object) TextUnit.m5933toStringimpl(this.width)) + ", height=" + ((Object) TextUnit.m5933toStringimpl(this.height)) + ", placeholderVerticalAlign=" + ((Object) PlaceholderVerticalAlign.m5164toStringimpl(this.placeholderVerticalAlign)) + ')';
    }
}
