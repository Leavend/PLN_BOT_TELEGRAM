...
public final class TextLayout {
    ...
    public TextLayout(CharSequence charSequence, float f, TextPaint textPaint, int i, TextUtils.TruncateAt truncateAt, int i2, float f2, float f3, boolean z, boolean z2, int i3, int i4, int i5, int i6, int i7, int i8, int[] iArr, int[] iArr2, LayoutIntrinsics layoutIntrinsics) {
        ...
        try {
            ...
            this.topPadding = Math.max(VerticalPaddings.m5288getTopPaddingimpl(verticalPaddings), VerticalPaddings.m5288getTopPaddingimpl(lineHeightPaddings));
            this.bottomPadding = Math.max(VerticalPaddings.m5287getBottomPaddingimpl(verticalPaddings), VerticalPaddings.m5287getBottomPaddingimpl(lineHeightPaddings));
