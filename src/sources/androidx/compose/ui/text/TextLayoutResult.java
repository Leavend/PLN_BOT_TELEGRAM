...
public final class TextLayoutResult {
    ...
    public final boolean getDidOverflowHeight() {
        return this.multiParagraph.getDidExceedMaxLines() || ((float) IntSize.m5904getHeightimpl(this.size)) < this.multiParagraph.getHeight();
    }

    public final boolean getDidOverflowWidth() {
        return ((float) IntSize.m5905getWidthimpl(this.size)) < this.multiParagraph.getWidth();
    }
    ...
    public final int m5207getOffsetForPositionk4lQ0M(long position) {
        return this.multiParagraph.m5112getOffsetForPositionk4lQ0M(position);
    }
    ...
    public final long m5209getWordBoundaryjx7JFs(int offset) {
        return this.multiParagraph.m5113getWordBoundaryjx7JFs(offset);
    }
    ...
    public static /* synthetic */ TextLayoutResult m5205copyO0kMr_c$default(TextLayoutResult textLayoutResult, TextLayoutInput textLayoutInput, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textLayoutResult.m5206copyO0kMr_c(textLayoutInput, j);
    }

    /* renamed from: copy-O0kMr_c, reason: not valid java name */
    public final TextLayoutResult m5206copyO0kMr_c(TextLayoutInput layoutInput, long size) {
    ...
    public boolean equals(Object other) {
        ...
        if (!Intrinsics.areEqual(this.layoutInput, textLayoutResult.layoutInput) || !Intrinsics.areEqual(this.multiParagraph, textLayoutResult.multiParagraph) || !IntSize.m5903equalsimpl0(this.size, textLayoutResult.size)) {
            return false;
        }
    ...
    public int hashCode() {
        return (((((((((this.layoutInput.hashCode() * 31) + this.multiParagraph.hashCode()) * 31) + IntSize.m5906hashCodeimpl(this.size)) * 31) + Float.hashCode(this.firstBaseline)) * 31) + Float.hashCode(this.lastBaseline)) * 31) + this.placeholderRects.hashCode();
    }

    public String toString() {
        return "TextLayoutResult(layoutInput=" + this.layoutInput + ", multiParagraph=" + this.multiParagraph + ", size=" + ((Object) IntSize.m5908toStringimpl(this.size)) + ", firstBaseline=" + this.firstBaseline + ", lastBaseline=" + this.lastBaseline + ", placeholderRects=" + this.placeholderRects + ')';
    }
}
