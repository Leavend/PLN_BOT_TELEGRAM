...
public final class AndroidParagraph implements Paragraph {
    ...
    private AndroidParagraph(AndroidParagraphIntrinsics androidParagraphIntrinsics, int i, boolean z, long j) {
        ...
        this.ellipsis = z;
        this.constraints = j;
        if ((Constraints.m5692getMinHeightimpl(j) == 0 && Constraints.m5693getMinWidthimpl(j) == 0) != true) {
        ...
        int iM5093toLayoutAlignaXe7zB0 = AndroidParagraph_androidKt.m5093toLayoutAlignaXe7zB0(style.m5276getTextAligne0LSkKk());
        boolean zM5623equalsimpl0 = TextAlign.m5623equalsimpl0(style.m5276getTextAligne0LSkKk(), TextAlign.INSTANCE.m5629getJustifye0LSkKk());
        int iM5095toLayoutHyphenationFrequency3fSNIE = AndroidParagraph_androidKt.m5095toLayoutHyphenationFrequency3fSNIE(style.getParagraphStyle().getHyphens());
        int iM5094toLayoutBreakStrategyxImikfE = AndroidParagraph_androidKt.m5094toLayoutBreakStrategyxImikfE(LineBreak.m5547getStrategyfcGXIks(style.m5273getLineBreakrAG3T2k()));
        int iM5096toLayoutLineBreakStylehpcqdu8 = AndroidParagraph_androidKt.m5096toLayoutLineBreakStylehpcqdu8(LineBreak.m5548getStrictnessusljTpc(style.m5273getLineBreakrAG3T2k()));
        int iM5097toLayoutLineBreakWordStylewPN0Rpw = AndroidParagraph_androidKt.m5097toLayoutLineBreakWordStylewPN0Rpw(LineBreak.m5549getWordBreakjp8hJ3c(style.m5273getLineBreakrAG3T2k()));
        TextUtils.TruncateAt truncateAt = z ? TextUtils.TruncateAt.END : null;
        TextLayout textLayoutConstructTextLayout = constructTextLayout(iM5093toLayoutAlignaXe7zB0, zM5623equalsimpl0 ? 1 : 0, truncateAt, i, iM5095toLayoutHyphenationFrequency3fSNIE, iM5094toLayoutBreakStrategyxImikfE, iM5096toLayoutLineBreakStylehpcqdu8, iM5097toLayoutLineBreakWordStylewPN0Rpw);
        if (z && textLayoutConstructTextLayout.getHeight() > Constraints.m5690getMaxHeightimpl(j) && i > 1) {
            int iNumberOfLinesThatFitMaxHeight = AndroidParagraph_androidKt.numberOfLinesThatFitMaxHeight(textLayoutConstructTextLayout, Constraints.m5690getMaxHeightimpl(j));
            if (iNumberOfLinesThatFitMaxHeight >= 0 && iNumberOfLinesThatFitMaxHeight != i) {
                textLayoutConstructTextLayout = constructTextLayout(iM5093toLayoutAlignaXe7zB0, zM5623equalsimpl0 ? 1 : 0, truncateAt, RangesKt.coerceAtLeast(iNumberOfLinesThatFitMaxHeight, 1), iM5095toLayoutHyphenationFrequency3fSNIE, iM5094toLayoutBreakStrategyxImikfE, iM5096toLayoutLineBreakStylehpcqdu8, iM5097toLayoutLineBreakWordStylewPN0Rpw);
            }
            this.layout = textLayoutConstructTextLayout;
        } else {
            this.layout = textLayoutConstructTextLayout;
        }
        getTextPaint$ui_text_release().m5491setBrush12SF9DM(style.getBrush(), SizeKt.Size(getWidth(), getHeight()), style.getAlpha());
        for (ShaderBrushSpan shaderBrushSpan : getShaderBrushSpans(this.layout)) {
            shaderBrushSpan.m5510setSizeuvyYCjk(SizeKt.Size(getWidth(), getHeight()));
        }
        CharSequence charSequence2 = this.charSequence;
        if (charSequence2 instanceof Spanned) {
            ?? r1 = (Spanned) charSequence2;
            Object[] spans = r1.getSpans(0, charSequence2.length(), PlaceholderSpan.class);
    ...
    public float getWidth() {
        return Constraints.m5691getMaxWidthimpl(this.constraints);
    }
    ...
    public int mo5083getOffsetForPositionk4lQ0M(long position) {
        return this.layout.getOffsetForHorizontal(this.layout.getLineForVertical((int) Offset.m3174getYimpl(position)), Offset.m3173getXimpl(position));
    }
    ...
    public void mo5081fillBoundingBoxes8ffj60Q(long range, float[] array, int arrayStart) {
        this.layout.fillBoundingBoxes(TextRange.m5233getMinimpl(range), TextRange.m5232getMaximpl(range), array, arrayStart);
    }
    ...
    public long mo5084getWordBoundaryjx7JFs(int offset) {
    ...
    public void mo5086paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration) {
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m5492setColor8_81llA(color);
    ...
    public void mo5085paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        int iM5489getBlendMode0nO6VwU = getTextPaint$ui_text_release().m5489getBlendMode0nO6VwU();
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m5492setColor8_81llA(color);
        textPaint$ui_text_release.setShadow(shadow);
        textPaint$ui_text_release.setTextDecoration(textDecoration);
        textPaint$ui_text_release.setDrawStyle(drawStyle);
        textPaint$ui_text_release.m5490setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m5490setBlendModes9anfk8(iM5489getBlendMode0nO6VwU);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: paint-hn5TExg, reason: not valid java name */
    public void mo5087painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        int iM5489getBlendMode0nO6VwU = getTextPaint$ui_text_release().m5489getBlendMode0nO6VwU();
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m5491setBrush12SF9DM(brush, SizeKt.Size(getWidth(), getHeight()), alpha);
        textPaint$ui_text_release.setShadow(shadow);
        textPaint$ui_text_release.setTextDecoration(textDecoration);
        textPaint$ui_text_release.setDrawStyle(drawStyle);
        textPaint$ui_text_release.m5490setBlendModes9anfk8(blendMode);
