...
public final class TextIndent {
    ...
    public static /* synthetic */ TextIndent m5649copyNB67dxo$default(TextIndent textIndent, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textIndent.m5650copyNB67dxo(j, j2);
    }

    /* renamed from: copy-NB67dxo, reason: not valid java name */
    public final TextIndent m5650copyNB67dxo(long firstLine, long restLine) {
    ...
    public boolean equals(Object other) {
        ...
        return TextUnit.m5923equalsimpl0(this.firstLine, textIndent.firstLine) && TextUnit.m5923equalsimpl0(this.restLine, textIndent.restLine);
    }

    public int hashCode() {
        return (TextUnit.m5927hashCodeimpl(this.firstLine) * 31) + TextUnit.m5927hashCodeimpl(this.restLine);
    }

    public String toString() {
        return "TextIndent(firstLine=" + ((Object) TextUnit.m5933toStringimpl(this.firstLine)) + ", restLine=" + ((Object) TextUnit.m5933toStringimpl(this.restLine)) + ')';
    }
}
