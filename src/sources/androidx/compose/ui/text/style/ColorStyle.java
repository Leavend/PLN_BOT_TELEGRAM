...
final /* data */ class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m5526copy8_81llA$default(ColorStyle colorStyle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = colorStyle.value;
        }
        return colorStyle.m5528copy8_81llA(j);
    }
    ...
    public final ColorStyle m5528copy8_81llA(long value) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorStyle) && Color.m3415equalsimpl0(this.value, ((ColorStyle) other).value);
    }
    ...
    public int hashCode() {
        return Color.m3421hashCodeimpl(this.value);
    }

    public String toString() {
        return "ColorStyle(value=" + ((Object) Color.m3422toStringimpl(this.value)) + ')';
    }
    ...
    public final long m5529getValue0d7_KjU() {
        return this.value;
    }
    ...
    public float getAlpha() {
        return Color.m3416getAlphaimpl(mo5525getColor0d7_KjU());
    }
}
