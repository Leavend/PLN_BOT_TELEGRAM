...
public final class LineHeightStyle {
    ...
    static {
        ...
        Default = new LineHeightStyle(Alignment.INSTANCE.m5605getProportionalPIaL0Z0(), Trim.INSTANCE.m5616getBothEVpEnUU(), defaultConstructorMarker);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Alignment.m5599equalsimpl0(this.alignment, lineHeightStyle.alignment) && Trim.m5610equalsimpl0(this.trim, lineHeightStyle.trim);
    }

    public int hashCode() {
        return (Alignment.m5600hashCodeimpl(this.alignment) * 31) + Trim.m5611hashCodeimpl(this.trim);
    }

    public String toString() {
        return "LineHeightStyle(alignment=" + ((Object) Alignment.m5601toStringimpl(this.alignment)) + ", trim=" + ((Object) Trim.m5614toStringimpl(this.trim)) + ')';
    }
    ...
    public static final class Trim {
        ...
        private static final int FirstLineTop = m5608constructorimpl(1);
        private static final int LastLineBottom = m5608constructorimpl(16);
        private static final int Both = m5608constructorimpl(17);
        private static final int None = m5608constructorimpl(0);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Trim m5607boximpl(int i) {
            return new Trim(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        private static int m5608constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m5609equalsimpl(int i, Object obj) {
            return (obj instanceof Trim) && i == ((Trim) obj).getValue();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m5610equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m5611hashCodeimpl(int i) {
            return Integer.hashCode(i);
        }

        /* renamed from: isTrimFirstLineTop-impl$ui_text_release, reason: not valid java name */
        public static final boolean m5612isTrimFirstLineTopimpl$ui_text_release(int i) {
            return (i & 1) > 0;
        }

        /* renamed from: isTrimLastLineBottom-impl$ui_text_release, reason: not valid java name */
        public static final boolean m5613isTrimLastLineBottomimpl$ui_text_release(int i) {
            return (i & 16) > 0;
        }

        public boolean equals(Object obj) {
            return m5609equalsimpl(this.value, obj);
        }

        public int hashCode() {
            return m5611hashCodeimpl(this.value);
        }
        ...
        public String toString() {
            return m5614toStringimpl(this.value);
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m5614toStringimpl(int i) {
        ...
        public static final class Companion {
            ...
            public final int m5617getFirstLineTopEVpEnUU() {
                return Trim.FirstLineTop;
            }

            /* renamed from: getLastLineBottom-EVpEnUU, reason: not valid java name */
            public final int m5618getLastLineBottomEVpEnUU() {
                return Trim.LastLineBottom;
            }

            /* renamed from: getBoth-EVpEnUU, reason: not valid java name */
            public final int m5616getBothEVpEnUU() {
                return Trim.Both;
            }

            /* renamed from: getNone-EVpEnUU, reason: not valid java name */
            public final int m5619getNoneEVpEnUU() {
                return Trim.None;
            }
        }
    }
    ...
    public static final class Alignment {
        ...
        /* renamed from: Companion, reason: from kotlin metadata */
        public static final Companion INSTANCE = new Companion(null);
        private static final float Top = m5597constructorimpl(0.0f);
        private static final float Center = m5597constructorimpl(0.5f);
        private static final float Proportional = m5597constructorimpl(-1.0f);
        private static final float Bottom = m5597constructorimpl(1.0f);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Alignment m5596boximpl(float f) {
            return new Alignment(f);
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m5598equalsimpl(float f, Object obj) {
            return (obj instanceof Alignment) && Float.compare(f, ((Alignment) obj).getTopRatio()) == 0;
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m5599equalsimpl0(float f, float f2) {
            return Float.compare(f, f2) == 0;
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m5600hashCodeimpl(float f) {
            return Float.hashCode(f);
        }

        public boolean equals(Object obj) {
            return m5598equalsimpl(this.topRatio, obj);
        }

        public int hashCode() {
            return m5600hashCodeimpl(this.topRatio);
        }
        ...
        /* renamed from: constructor-impl, reason: not valid java name */
        public static float m5597constructorimpl(float f) {
            boolean z = true;
            if (!(0.0f <= f && f <= 1.0f)) {
                if (!(f == -1.0f)) {
                    z = false;
        ...
        public String toString() {
            return m5601toStringimpl(this.topRatio);
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m5601toStringimpl(float f) {
            if (f == Top) {
        ...
        public static final class Companion {
            ...
            public final float m5606getTopPIaL0Z0() {
                return Alignment.Top;
            }

            /* renamed from: getCenter-PIaL0Z0, reason: not valid java name */
            public final float m5604getCenterPIaL0Z0() {
                return Alignment.Center;
            }

            /* renamed from: getProportional-PIaL0Z0, reason: not valid java name */
            public final float m5605getProportionalPIaL0Z0() {
                return Alignment.Proportional;
            }

            /* renamed from: getBottom-PIaL0Z0, reason: not valid java name */
            public final float m5603getBottomPIaL0Z0() {
