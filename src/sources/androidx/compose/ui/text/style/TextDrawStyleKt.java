...
public final class TextDrawStyleKt {
    public static final TextForegroundStyle lerp(TextForegroundStyle textForegroundStyle, TextForegroundStyle textForegroundStyle2, float f) {
        ...
        if (!z && !(textForegroundStyle2 instanceof BrushStyle)) {
            return TextForegroundStyle.INSTANCE.m5648from8_81llA(ColorKt.m3465lerpjxsXWHM(textForegroundStyle.mo5525getColor0d7_KjU(), textForegroundStyle2.mo5525getColor0d7_KjU(), f));
        }
        if (z && (textForegroundStyle2 instanceof BrushStyle)) {
    ...
    public static final long m5647modulateDxMtmZc(long j, float f) {
        return (Float.isNaN(f) || f >= 1.0f) ? j : Color.m3413copywmQWz5c$default(j, Color.m3416getAlphaimpl(j) * f, 0.0f, 0.0f, 0.0f, 14, null);
    }
