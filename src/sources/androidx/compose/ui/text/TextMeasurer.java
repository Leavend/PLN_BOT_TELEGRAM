...
public final class TextMeasurer {
    ...
    public static /* synthetic */ TextLayoutResult m5211measurexDpz5zY$default(TextMeasurer textMeasurer, AnnotatedString annotatedString, TextStyle textStyle, int i, boolean z, int i2, List list, long j, LayoutDirection layoutDirection, Density density, FontFamily.Resolver resolver, boolean z2, int i3, Object obj) {
        return textMeasurer.m5213measurexDpz5zY(annotatedString, (i3 & 2) != 0 ? TextStyle.INSTANCE.getDefault() : textStyle, (i3 & 4) != 0 ? TextOverflow.INSTANCE.m5676getClipgIe3tQ8() : i, (i3 & 8) != 0 ? true : z, (i3 & 16) != 0 ? Integer.MAX_VALUE : i2, (i3 & 32) != 0 ? CollectionsKt.emptyList() : list, (i3 & 64) != 0 ? ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null) : j, (i3 & 128) != 0 ? textMeasurer.defaultLayoutDirection : layoutDirection, (i3 & 256) != 0 ? textMeasurer.defaultDensity : density, (i3 & 512) != 0 ? textMeasurer.defaultFontFamilyResolver : resolver, (i3 & 1024) != 0 ? false : z2);
    }

    /* renamed from: measure-xDpz5zY, reason: not valid java name */
    public final TextLayoutResult m5213measurexDpz5zY(AnnotatedString text, TextStyle style, int overflow, boolean softWrap, int maxLines, List<AnnotatedString.Range<Placeholder>> placeholders, long constraints, LayoutDirection layoutDirection, Density density, FontFamily.Resolver fontFamilyResolver, boolean skipCache) {
        ...
        if (textLayoutResult != null) {
            return textLayoutResult.m5206copyO0kMr_c(textLayoutInput, ConstraintsKt.m5702constrain4WqzIAM(constraints, IntSizeKt.IntSize(ParagraphKt.ceilToInt(textLayoutResult.getMultiParagraph().getWidth()), ParagraphKt.ceilToInt(textLayoutResult.getMultiParagraph().getHeight()))));
        }
    ...
    public final TextLayoutResult m5212measurewNUYSr0(String text, TextStyle style, int overflow, boolean softWrap, int maxLines, long constraints, LayoutDirection layoutDirection, Density density, FontFamily.Resolver fontFamilyResolver, boolean skipCache) {
        return m5211measurexDpz5zY$default(this, new AnnotatedString(text, null, null, 6, null), style, overflow, softWrap, maxLines, null, constraints, layoutDirection, density, fontFamilyResolver, skipCache, 32, null);
    }
    ...
    public static final class Companion {
        ...
        public final TextLayoutResult layout(TextLayoutInput textLayoutInput) {
            ...
            int iM5693getMinWidthimpl = Constraints.m5693getMinWidthimpl(textLayoutInput.getConstraints());
            boolean z = false;
            int iM5691getMaxWidthimpl = ((textLayoutInput.getSoftWrap() || TextOverflow.m5669equalsimpl0(textLayoutInput.getOverflow(), TextOverflow.INSTANCE.m5677getEllipsisgIe3tQ8())) && Constraints.m5687getHasBoundedWidthimpl(textLayoutInput.getConstraints())) ? Constraints.m5691getMaxWidthimpl(textLayoutInput.getConstraints()) : Integer.MAX_VALUE;
            if (!textLayoutInput.getSoftWrap() && TextOverflow.m5669equalsimpl0(textLayoutInput.getOverflow(), TextOverflow.INSTANCE.m5677getEllipsisgIe3tQ8())) {
                z = true;
            }
            int maxLines = z ? 1 : textLayoutInput.getMaxLines();
            if (iM5693getMinWidthimpl != iM5691getMaxWidthimpl) {
                iM5691getMaxWidthimpl = RangesKt.coerceIn(ParagraphKt.ceilToInt(multiParagraphIntrinsics.getMaxIntrinsicWidth()), iM5693getMinWidthimpl, iM5691getMaxWidthimpl);
            }
            return new TextLayoutResult(textLayoutInput, new MultiParagraph(multiParagraphIntrinsics, ConstraintsKt.Constraints$default(0, iM5691getMaxWidthimpl, 0, Constraints.m5690getMaxHeightimpl(textLayoutInput.getConstraints()), 5, null), maxLines, TextOverflow.m5669equalsimpl0(textLayoutInput.getOverflow(), TextOverflow.INSTANCE.m5677getEllipsisgIe3tQ8()), null), ConstraintsKt.m5702constrain4WqzIAM(textLayoutInput.getConstraints(), IntSizeKt.IntSize((int) Math.ceil(r2.getWidth()), (int) Math.ceil(r2.getHeight()))), null);
        }
    }
}
