...
public final class EditProcessor {
    ...
    private TextFieldValue mBufferState = new TextFieldValue(AnnotatedStringKt.emptyAnnotatedString(), TextRange.INSTANCE.m5240getZerod9O1mEE(), (TextRange) null, (DefaultConstructorMarker) null);
    ...
    public final void reset(TextFieldValue value, TextInputSession textInputSession) {
        boolean z = true;
        boolean z2 = !Intrinsics.areEqual(value.getComposition(), this.mBuffer.m5394getCompositionMzsxiRA$ui_text_release());
        boolean z3 = false;
        ...
        } else if (TextRange.m5228equalsimpl0(this.mBufferState.getSelection(), value.getSelection())) {
            z = false;
        } else {
            this.mBuffer.setSelection$ui_text_release(TextRange.m5233getMinimpl(value.getSelection()), TextRange.m5232getMaximpl(value.getSelection()));
            z3 = true;
            z = false;
        }
        if (value.getComposition() == null) {
            this.mBuffer.commitComposition$ui_text_release();
        } else if (!TextRange.m5229getCollapsedimpl(value.getComposition().getPackedValue())) {
            this.mBuffer.setComposition$ui_text_release(TextRange.m5233getMinimpl(value.getComposition().getPackedValue()), TextRange.m5232getMaximpl(value.getComposition().getPackedValue()));
        }
        if (z || (!z3 && z2)) {
            this.mBuffer.commitComposition$ui_text_release();
            value = TextFieldValue.m5469copy3r_uNRQ$default(value, (AnnotatedString) null, 0L, (TextRange) null, 3, (Object) null);
        }
    ...
    private final String generateBatchErrorMessage(List<? extends EditCommand> editCommands, final EditCommand failedCommand) {
        ...
        StringBuilder sbAppend = sb.append("Error while applying EditCommand batch to buffer (length=" + this.mBuffer.getLength$ui_text_release() + ", composition=" + this.mBuffer.m5394getCompositionMzsxiRA$ui_text_release() + ", selection=" + ((Object) TextRange.m5238toStringimpl(this.mBuffer.m5395getSelectiond9O1mEE$ui_text_release())) + "):");
    ...
    public final TextFieldValue apply(List<? extends EditCommand> editCommands) {
        ...
        try {
            ...
            long jM5395getSelectiond9O1mEE$ui_text_release = this.mBuffer.m5395getSelectiond9O1mEE$ui_text_release();
            TextRange textRangeM5223boximpl = TextRange.m5223boximpl(jM5395getSelectiond9O1mEE$ui_text_release);
            textRangeM5223boximpl.getPackedValue();
            TextRange textRange = TextRange.m5234getReversedimpl(this.mBufferState.getSelection()) ? null : textRangeM5223boximpl;
            TextFieldValue textFieldValue = new TextFieldValue(annotatedString$ui_text_release, textRange != null ? textRange.getPackedValue() : TextRangeKt.TextRange(TextRange.m5232getMaximpl(jM5395getSelectiond9O1mEE$ui_text_release), TextRange.m5233getMinimpl(jM5395getSelectiond9O1mEE$ui_text_release)), this.mBuffer.m5394getCompositionMzsxiRA$ui_text_release(), (DefaultConstructorMarker) null);
