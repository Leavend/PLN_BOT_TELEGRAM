...
public final class CursorAnchorInfoBuilder_androidKt {
    public static final CursorAnchorInfo build(CursorAnchorInfo.Builder builder, TextFieldValue textFieldValue, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Matrix matrix, Rect rect, Rect rect2, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        int iM5233getMinimpl = TextRange.m5233getMinimpl(textFieldValue.getSelection());
        builder.setSelectionRange(iM5233getMinimpl, TextRange.m5232getMaximpl(textFieldValue.getSelection()));
        if (z) {
            setInsertionMarker(builder, iM5233getMinimpl, offsetMapping, textLayoutResult, rect);
        }
        if (z2) {
            ...
            int iM5232getMaximpl = composition2 != null ? TextRange.m5232getMaximpl(composition2.getPackedValue()) : -1;
            boolean z5 = false;
            if (iM5233getMinimpl2 >= 0 && iM5233getMinimpl2 < iM5232getMaximpl) {
                z5 = true;
            }
            if (z5) {
                builder.setComposingText(iM5233getMinimpl2, textFieldValue.getText().subSequence(iM5233getMinimpl2, iM5232getMaximpl));
                addCharacterBounds(builder, iM5233getMinimpl2, iM5232getMaximpl, offsetMapping, textLayoutResult, rect);
            }
        }
    ...
    private static final CursorAnchorInfo.Builder setInsertionMarker(CursorAnchorInfo.Builder builder, int i, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Rect rect) {
        ...
        float fCoerceIn = RangesKt.coerceIn(cursorRect.getLeft(), 0.0f, IntSize.m5905getWidthimpl(textLayoutResult.getSize()));
    ...
    */
    private static final android.view.inputmethod.CursorAnchorInfo.Builder addCharacterBounds(android.view.inputmethod.CursorAnchorInfo.Builder r17, int r18, int r19, androidx.compose.ui.text.input.OffsetMapping r20, androidx.compose.ui.text.TextLayoutResult r21, androidx.compose.ui.geometry.Rect r22) {
        /*
            ...
            r5 = 0
            r7.m5111fillBoundingBoxes8ffj60Q(r8, r6, r5)
        L22:
            if (r2 >= r0) goto L8b
