...
public final class KeyboardCapitalization {
    ...
    private static final int Characters = m5430constructorimpl(1);
    private static final int Words = m5430constructorimpl(2);
    private static final int Sentences = m5430constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ KeyboardCapitalization m5429boximpl(int i) {
        return new KeyboardCapitalization(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m5430constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m5431equalsimpl(int i, Object obj) {
        return (obj instanceof KeyboardCapitalization) && i == ((KeyboardCapitalization) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m5432equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public static String m5434toStringimpl(int i) {
        return m5432equalsimpl0(i, None) ? "None" : m5432equalsimpl0(i, Characters) ? "Characters" : m5432equalsimpl0(i, Words) ? "Words" : m5432equalsimpl0(i, Sentences) ? "Sentences" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m5436getCharactersIUNYP9k$annotations() {
        }

        /* renamed from: getNone-IUNYP9k$annotations, reason: not valid java name */
        public static /* synthetic */ void m5437getNoneIUNYP9k$annotations() {
        }

        /* renamed from: getSentences-IUNYP9k$annotations, reason: not valid java name */
        public static /* synthetic */ void m5438getSentencesIUNYP9k$annotations() {
        }

        /* renamed from: getWords-IUNYP9k$annotations, reason: not valid java name */
        public static /* synthetic */ void m5439getWordsIUNYP9k$annotations() {
        }
        ...
        public final int m5441getNoneIUNYP9k() {
            return KeyboardCapitalization.None;
        }

        /* renamed from: getCharacters-IUNYP9k, reason: not valid java name */
        public final int m5440getCharactersIUNYP9k() {
            return KeyboardCapitalization.Characters;
        }

        /* renamed from: getWords-IUNYP9k, reason: not valid java name */
        public final int m5443getWordsIUNYP9k() {
            return KeyboardCapitalization.Words;
        }

        /* renamed from: getSentences-IUNYP9k, reason: not valid java name */
        public final int m5442getSentencesIUNYP9k() {
