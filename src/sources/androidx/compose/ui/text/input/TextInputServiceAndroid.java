...
public final class TextInputServiceAndroid implements PlatformTextInputService {
    ...
    public TextInputServiceAndroid(View view, PositionCalculator positionCalculator, InputMethodManager inputMethodManager, Executor executor) {
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid$onImeActionPerformed$1
            ...
            public final void m5475invokeKlQnJC8(int i) {
            }

            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                m5475invokeKlQnJC8(imeAction.getValue());
                return Unit.INSTANCE;
            }
        };
        this.state = new TextFieldValue("", TextRange.INSTANCE.m5240getZerod9O1mEE(), (TextRange) null, 4, (DefaultConstructorMarker) null);
    ...
    public final InputConnection createInputConnection(EditorInfo outAttrs) {
        ...
        RecordingInputConnection recordingInputConnection = new RecordingInputConnection(this.state, new InputEventCallback2() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid.createInputConnection.1
            ...
            public void mo5428onImeActionKlQnJC8(int imeAction) {
                TextInputServiceAndroid.this.onImeActionPerformed.invoke(ImeAction.m5397boximpl(imeAction));
            }
    ...
    public void stopInput() {
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid.stopInput.2
            /* renamed from: invoke-KlQnJC8, reason: not valid java name */
            public final void m5476invokeKlQnJC8(int i) {
            }

            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                m5476invokeKlQnJC8(imeAction.getValue());
                return Unit.INSTANCE;
            }
        };
    ...
    public void updateState(TextFieldValue oldValue, TextFieldValue newValue) {
        boolean z = true;
        boolean z2 = (TextRange.m5228equalsimpl0(this.state.getSelection(), newValue.getSelection()) && Intrinsics.areEqual(this.state.getComposition(), newValue.getComposition())) ? false : true;
        this.state = newValue;
        ...
        if (Intrinsics.areEqual(oldValue, newValue)) {
            if (z2) {
                ...
                int iM5233getMinimpl = TextRange.m5233getMinimpl(newValue.getSelection());
                int iM5232getMaximpl = TextRange.m5232getMaximpl(newValue.getSelection());
                TextRange composition = this.state.getComposition();
                int iM5233getMinimpl2 = composition != null ? TextRange.m5233getMinimpl(composition.getPackedValue()) : -1;
                TextRange composition2 = this.state.getComposition();
                inputMethodManager.updateSelection(iM5233getMinimpl, iM5232getMaximpl, iM5233getMinimpl2, composition2 != null ? TextRange.m5232getMaximpl(composition2.getPackedValue()) : -1);
                return;
            }
            return;
        }
        if (oldValue == null || (Intrinsics.areEqual(oldValue.getText(), newValue.getText()) && (!TextRange.m5228equalsimpl0(oldValue.getSelection(), newValue.getSelection()) || Intrinsics.areEqual(oldValue.getComposition(), newValue.getComposition())))) {
            z = false;
        }
        if (z) {
            restartInputImmediately();
