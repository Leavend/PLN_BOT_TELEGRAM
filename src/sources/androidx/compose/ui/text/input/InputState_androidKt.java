...
public final class InputState_androidKt {
    public static final ExtractedText toExtractedText(TextFieldValue textFieldValue) {
        ...
        extractedText.selectionStart = TextRange.m5233getMinimpl(textFieldValue.getSelection());
        extractedText.selectionEnd = TextRange.m5232getMaximpl(textFieldValue.getSelection());
