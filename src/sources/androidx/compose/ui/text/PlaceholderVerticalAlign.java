...
public final class PlaceholderVerticalAlign {
    ...
    private static final int AboveBaseline = m5160constructorimpl(1);
    private static final int Top = m5160constructorimpl(2);
    private static final int Bottom = m5160constructorimpl(3);
    private static final int Center = m5160constructorimpl(4);
    private static final int TextTop = m5160constructorimpl(5);
    private static final int TextBottom = m5160constructorimpl(6);
    private static final int TextCenter = m5160constructorimpl(7);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PlaceholderVerticalAlign m5159boximpl(int i) {
    ...
    public static String m5164toStringimpl(int i) {
        return m5162equalsimpl0(i, AboveBaseline) ? "AboveBaseline" : m5162equalsimpl0(i, Top) ? "Top" : m5162equalsimpl0(i, Bottom) ? "Bottom" : m5162equalsimpl0(i, Center) ? "Center" : m5162equalsimpl0(i, TextTop) ? "TextTop" : m5162equalsimpl0(i, TextBottom) ? "TextBottom" : m5162equalsimpl0(i, TextCenter) ? "TextCenter" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public final int m5166getAboveBaselineJ6kI3mc() {
            return PlaceholderVerticalAlign.AboveBaseline;
        }

        /* renamed from: getTop-J6kI3mc, reason: not valid java name */
        public final int m5172getTopJ6kI3mc() {
            return PlaceholderVerticalAlign.Top;
        }

        /* renamed from: getBottom-J6kI3mc, reason: not valid java name */
        public final int m5167getBottomJ6kI3mc() {
            return PlaceholderVerticalAlign.Bottom;
        }

        /* renamed from: getCenter-J6kI3mc, reason: not valid java name */
        public final int m5168getCenterJ6kI3mc() {
            return PlaceholderVerticalAlign.Center;
        }

        /* renamed from: getTextTop-J6kI3mc, reason: not valid java name */
        public final int m5171getTextTopJ6kI3mc() {
            return PlaceholderVerticalAlign.TextTop;
        }

        /* renamed from: getTextBottom-J6kI3mc, reason: not valid java name */
        public final int m5169getTextBottomJ6kI3mc() {
            return PlaceholderVerticalAlign.TextBottom;
        }

        /* renamed from: getTextCenter-J6kI3mc, reason: not valid java name */
        public final int m5170getTextCenterJ6kI3mc() {
