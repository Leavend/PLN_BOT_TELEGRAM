...
public final class AsyncTypefaceCache {
    ...
    private final Object PermanentFailure = AsyncTypefaceResult.m5303constructorimpl(null);
    ...
    public static final class AsyncTypefaceResult {
        ...
        public static final /* synthetic */ AsyncTypefaceResult m5302boximpl(Object obj) {
            return new AsyncTypefaceResult(obj);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static Object m5303constructorimpl(Object obj) {
            return obj;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m5304equalsimpl(Object obj, Object obj2) {
            return (obj2 instanceof AsyncTypefaceResult) && Intrinsics.areEqual(obj, ((AsyncTypefaceResult) obj2).m5309unboximpl());
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m5305equalsimpl0(Object obj, Object obj2) {
            return Intrinsics.areEqual(obj, obj2);
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m5306hashCodeimpl(Object obj) {
            if (obj == null) {
                return 0;
            }
            return obj.hashCode();
        ...
        public static final boolean m5307isPermanentFailureimpl(Object obj) {
            return obj == null;
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m5308toStringimpl(Object obj) {
            return "AsyncTypefaceResult(result=" + obj + ')';
        }

        public boolean equals(Object obj) {
            return m5304equalsimpl(this.result, obj);
        }

        public int hashCode() {
            return m5306hashCodeimpl(this.result);
        }

        public String toString() {
            return m5308toStringimpl(this.result);
        }

        /* renamed from: unbox-impl, reason: not valid java name */
        public final /* synthetic */ Object m5309unboximpl() {
            return this.result;
        }
    ...
    public final void put(Font font, PlatformFontLoader platformFontLoader, Object result, boolean forever) {
        ...
        synchronized (this.cacheLock) {
            try {
                if (result == null) {
                    this.permanentCache.put(key, AsyncTypefaceResult.m5302boximpl(this.PermanentFailure));
                } else if (forever) {
                    this.permanentCache.put(key, AsyncTypefaceResult.m5302boximpl(AsyncTypefaceResult.m5303constructorimpl(result)));
                } else {
                    this.resultCache.put(key, AsyncTypefaceResult.m5302boximpl(AsyncTypefaceResult.m5303constructorimpl(result)));
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public final AsyncTypefaceResult m5301get1ASDuI8(Font font, PlatformFontLoader platformFontLoader) {
    ...
    */
    public final java.lang.Object runCached(androidx.compose.ui.text.font.Font r6, androidx.compose.ui.text.font.PlatformFontLoader r7, boolean r8, kotlin.jvm.functions.Function1<? super kotlin.coroutines.Continuation<java.lang.Object>, ? extends java.lang.Object> r9, kotlin.coroutines.Continuation<java.lang.Object> r10) {
        ...
        L5d:
            if (r7 == 0) goto L65
            java.lang.Object r7 = r7.m5309unboximpl()     // Catch: java.lang.Throwable -> Lb1
            monitor-exit(r6)
            return r7
        L65:
        ...
        L7b:
            ...
            androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult r7 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m5302boximpl(r7)     // Catch: java.lang.Throwable -> L8c
        ...
        L8e:
            ...
            java.lang.Object r8 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m5303constructorimpl(r10)     // Catch: java.lang.Throwable -> L8c
            androidx.compose.ui.text.font.AsyncTypefaceCache$AsyncTypefaceResult r8 = androidx.compose.ui.text.font.AsyncTypefaceCache.AsyncTypefaceResult.m5302boximpl(r8)     // Catch: java.lang.Throwable -> L8c
    ...
    public final Object runCachedBlocking(Font font, PlatformFontLoader platformFontLoader, Function0<? extends Object> block) {
        synchronized (this.cacheLock) {
            try {
                ...
                if (asyncTypefaceResult != null) {
                    Object objM5309unboximpl = asyncTypefaceResult.m5309unboximpl();
                    InlineMarker.finallyStart(2);
                    InlineMarker.finallyEnd(2);
                    return objM5309unboximpl;
                }
