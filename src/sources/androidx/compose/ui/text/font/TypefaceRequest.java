...
public final /* data */ class TypefaceRequest {
    ...
    public static /* synthetic */ TypefaceRequest m5386copye1PVR60$default(TypefaceRequest typefaceRequest, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, Object obj, int i3, Object obj2) {
        if ((i3 & 1) != 0) {
        ...
        return typefaceRequest.m5389copye1PVR60(fontFamily, fontWeight2, i4, i5, obj);
    }
    ...
    public final TypefaceRequest m5389copye1PVR60(FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis, Object resourceLoaderCacheKey) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.fontFamily, typefaceRequest.fontFamily) && Intrinsics.areEqual(this.fontWeight, typefaceRequest.fontWeight) && FontStyle.m5345equalsimpl0(this.fontStyle, typefaceRequest.fontStyle) && FontSynthesis.m5356equalsimpl0(this.fontSynthesis, typefaceRequest.fontSynthesis) && Intrinsics.areEqual(this.resourceLoaderCacheKey, typefaceRequest.resourceLoaderCacheKey);
    }

    public int hashCode() {
        FontFamily fontFamily = this.fontFamily;
        int iHashCode = (((((((fontFamily == null ? 0 : fontFamily.hashCode()) * 31) + this.fontWeight.hashCode()) * 31) + FontStyle.m5346hashCodeimpl(this.fontStyle)) * 31) + FontSynthesis.m5357hashCodeimpl(this.fontSynthesis)) * 31;
        Object obj = this.resourceLoaderCacheKey;
        return iHashCode + (obj != null ? obj.hashCode() : 0);
    }

    public String toString() {
        return "TypefaceRequest(fontFamily=" + this.fontFamily + ", fontWeight=" + this.fontWeight + ", fontStyle=" + ((Object) FontStyle.m5347toStringimpl(this.fontStyle)) + ", fontSynthesis=" + ((Object) FontSynthesis.m5360toStringimpl(this.fontSynthesis)) + ", resourceLoaderCacheKey=" + this.resourceLoaderCacheKey + ')';
    }
    ...
    public final int m5390getFontStyle_LCdwA() {
        return this.fontStyle;
    }

    /* renamed from: getFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m5391getFontSynthesisGVVA2EU() {
        return this.fontSynthesis;
    }
