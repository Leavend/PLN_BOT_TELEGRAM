...
public final class AndroidFontLoader implements PlatformFontLoader {
    ...
    public android.graphics.Typeface loadBlocking(Font font) throws Resources.NotFoundException {
        ...
        } else if (FontLoadingStrategy.m5332equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m5338getOptionalLocalPKNRLFQ())) {
            try {
                Result.Companion companion = Result.INSTANCE;
                AndroidFontLoader androidFontLoader = this;
                objM6852constructorimpl = Result.m6852constructorimpl(AndroidFontLoader_androidKt.load((ResourceFont) font, this.context));
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM6852constructorimpl = Result.m6852constructorimpl(ResultKt.createFailure(th));
            }
            typefaceLoad = (android.graphics.Typeface) (Result.m6858isFailureimpl(objM6852constructorimpl) ? null : objM6852constructorimpl);
        } else {
            if (FontLoadingStrategy.m5332equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m5336getAsyncPKNRLFQ())) {
                throw new UnsupportedOperationException("Unsupported Async font load path");
            }
            throw new IllegalArgumentException("Unknown loading type " + ((Object) FontLoadingStrategy.m5334toStringimpl(font.getLoadingStrategy())));
        }
