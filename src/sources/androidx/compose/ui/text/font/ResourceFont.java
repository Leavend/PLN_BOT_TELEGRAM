...
public final class ResourceFont implements Font {
    ...
    public static /* synthetic */ void m5383getLoadingStrategyPKNRLFQ$annotations() {
    }
    ...
    public /* synthetic */ ResourceFont(int i, FontWeight fontWeight, int i2, FontVariation.Settings settings, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        int iM5352getNormal_LCdwA = (i4 & 4) != 0 ? FontStyle.INSTANCE.m5352getNormal_LCdwA() : i2;
        this(i, normal, iM5352getNormal_LCdwA, (i4 & 8) != 0 ? FontVariation.INSTANCE.m5367Settings6EWAqTQ(normal, iM5352getNormal_LCdwA, new FontVariation.Setting[0]) : settings, (i4 & 16) != 0 ? FontLoadingStrategy.INSTANCE.m5336getAsyncPKNRLFQ() : i3, null);
    }
    ...
    public static /* synthetic */ ResourceFont m5382copyRetOiIg$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        return resourceFont.m5385copyRetOiIg(i, fontWeight, i2);
    }

    /* renamed from: copy-RetOiIg, reason: not valid java name */
    public final ResourceFont m5385copyRetOiIg(int resId, FontWeight weight, int style) {
        return m5381copyF3nL8kk$default(this, resId, weight, style, getLoadingStrategy(), null, 16, null);
    }

    /* renamed from: copy-F3nL8kk$default, reason: not valid java name */
    public static /* synthetic */ ResourceFont m5381copyF3nL8kk$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = resourceFont.resId;
        }
        if ((i4 & 2) != 0) {
        ...
        return resourceFont.m5384copyF3nL8kk(i, fontWeight2, i5, i6, settings);
    }

    /* renamed from: copy-F3nL8kk, reason: not valid java name */
    public final ResourceFont m5384copyF3nL8kk(int resId, FontWeight weight, int style, int loadingStrategy, FontVariation.Settings variationSettings) {
    ...
    public boolean equals(Object other) {
        ...
        return this.resId == resourceFont.resId && Intrinsics.areEqual(getWeight(), resourceFont.getWeight()) && FontStyle.m5345equalsimpl0(getStyle(), resourceFont.getStyle()) && Intrinsics.areEqual(this.variationSettings, resourceFont.variationSettings) && FontLoadingStrategy.m5332equalsimpl0(getLoadingStrategy(), resourceFont.getLoadingStrategy());
    }

    public int hashCode() {
        return (((((((this.resId * 31) + getWeight().hashCode()) * 31) + FontStyle.m5346hashCodeimpl(getStyle())) * 31) + FontLoadingStrategy.m5333hashCodeimpl(getLoadingStrategy())) * 31) + this.variationSettings.hashCode();
    }

    public String toString() {
        return "ResourceFont(resId=" + this.resId + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m5347toStringimpl(getStyle())) + ", loadingStrategy=" + ((Object) FontLoadingStrategy.m5334toStringimpl(getLoadingStrategy())) + ')';
    }
}
