...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m5299getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0, FontStyle.m5345equalsimpl0(i, FontStyle.INSTANCE.m5351getItalic_LCdwA()));
    }
}
