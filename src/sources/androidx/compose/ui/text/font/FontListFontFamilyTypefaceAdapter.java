...
public final class FontListFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public final Object preload(FontFamily fontFamily, PlatformFontLoader platformFontLoader, Continuation<? super Unit> continuation) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (FontLoadingStrategy.m5332equalsimpl0(font.getLoadingStrategy(), FontLoadingStrategy.INSTANCE.m5336getAsyncPKNRLFQ())) {
                arrayList.add(font);
            }
        }
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            arrayList3.add(TuplesKt.to(font2.getWeight(), FontStyle.m5342boximpl(font2.getStyle())));
        }
        ...
        for (int i4 = 0; i4 < size4; i4++) {
            ...
            int iM5348unboximpl = ((FontStyle) pair.component2()).m5348unboximpl();
            List list = (List) FontListFontFamilyTypefaceAdapterKt.firstImmediatelyAvailable(fontMatcher.m5341matchFontRetOiIg(fonts, fontWeight, iM5348unboximpl), new TypefaceRequest(fontFamily, fontWeight, iM5348unboximpl, FontSynthesis.INSTANCE.m5362getAllGVVA2EU(), platformFontLoader.getCacheKey(), null), this.asyncTypefaceCache, platformFontLoader, new Function1<TypefaceRequest, Unit>() { // from class: androidx.compose.ui.text.font.FontListFontFamilyTypefaceAdapter$preload$2$1
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        Pair pairFirstImmediatelyAvailable = FontListFontFamilyTypefaceAdapterKt.firstImmediatelyAvailable(fontMatcher.m5341matchFontRetOiIg(((FontListFontFamily) typefaceRequest.getFontFamily()).getFonts(), typefaceRequest.getFontWeight(), typefaceRequest.m5390getFontStyle_LCdwA()), typefaceRequest, this.asyncTypefaceCache, platformFontLoader, createDefaultTypeface);
