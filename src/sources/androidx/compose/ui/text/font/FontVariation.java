...
public final class FontVariation {
    ...
    private static final class SettingTextUnit implements Setting {
        ...
        public float toVariationValue(Density density) {
            ...
            return TextUnit.m5926getValueimpl(this.value) * density.getFontScale();
        }
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(getAxisName(), settingTextUnit.getAxisName()) && TextUnit.m5923equalsimpl0(this.value, settingTextUnit.value);
        }

        public int hashCode() {
            return (getAxisName().hashCode() * 31) + TextUnit.m5927hashCodeimpl(this.value);
        }

        public String toString() {
            return "FontVariation.Setting(axisName='" + getAxisName() + "', value=" + ((Object) TextUnit.m5933toStringimpl(this.value)) + ')';
        }
    }
    ...
    public final Setting m5368opticalSizingR2X_6o(long textSize) {
        if (!TextUnit.m5929isSpimpl(textSize)) {
    ...
    public final Settings m5367Settings6EWAqTQ(FontWeight weight, int style, Setting... settings) {
