...
public final class TextStyleKt {
    ...
    public static final int m5281resolveTextDirectionIhaHGbI(LayoutDirection layoutDirection, int i) {
        if (TextDirection.m5637equalsimpl0(i, TextDirection.INSTANCE.m5641getContents_7Xco())) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 == 1) {
                return TextDirection.INSTANCE.m5642getContentOrLtrs_7Xco();
            }
            if (i2 == 2) {
                return TextDirection.INSTANCE.m5643getContentOrRtls_7Xco();
            }
            throw new NoWhenBranchMatchedException();
        }
        if (!TextDirection.m5637equalsimpl0(i, TextDirection.INSTANCE.m5646getUnspecifieds_7Xco())) {
            return i;
        }
        int i3 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
        if (i3 == 1) {
            return TextDirection.INSTANCE.m5644getLtrs_7Xco();
        }
        if (i3 == 2) {
            return TextDirection.INSTANCE.m5645getRtls_7Xco();
        }
        throw new NoWhenBranchMatchedException();
    }
