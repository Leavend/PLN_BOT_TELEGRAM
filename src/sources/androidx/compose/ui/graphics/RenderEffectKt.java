...
public final class RenderEffectKt {
    ...
    public static /* synthetic */ BlurEffect m3722BlurEffect3YTHUZs$default(float f, float f2, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = TileMode.INSTANCE.m3786getClamp3opZhB0();
        }
        return m3721BlurEffect3YTHUZs(f, f2, i);
    }

    /* renamed from: BlurEffect-3YTHUZs, reason: not valid java name */
    public static final BlurEffect m3721BlurEffect3YTHUZs(float f, float f2, int i) {
