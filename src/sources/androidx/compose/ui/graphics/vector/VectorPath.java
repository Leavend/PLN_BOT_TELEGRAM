...
public final class VectorPath extends VectorNode {
    ...
    public boolean equals(Object other) {
        ...
        if (!(this.strokeLineWidth == vectorPath.strokeLineWidth) || !StrokeCap.m3762equalsimpl0(this.strokeLineCap, vectorPath.strokeLineCap) || !StrokeJoin.m3772equalsimpl0(this.strokeLineJoin, vectorPath.strokeLineJoin)) {
            return false;
        }
        ...
        if (this.trimPathEnd == vectorPath.trimPathEnd) {
            return ((this.trimPathOffset > vectorPath.trimPathOffset ? 1 : (this.trimPathOffset == vectorPath.trimPathOffset ? 0 : -1)) == 0) && PathFillType.m3692equalsimpl0(this.pathFillType, vectorPath.pathFillType) && Intrinsics.areEqual(this.pathData, vectorPath.pathData);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((((((((((((((((iHashCode2 + (brush2 != null ? brush2.hashCode() : 0)) * 31) + Float.hashCode(this.strokeAlpha)) * 31) + Float.hashCode(this.strokeLineWidth)) * 31) + StrokeCap.m3763hashCodeimpl(this.strokeLineCap)) * 31) + StrokeJoin.m3773hashCodeimpl(this.strokeLineJoin)) * 31) + Float.hashCode(this.strokeLineMiter)) * 31) + Float.hashCode(this.trimPathStart)) * 31) + Float.hashCode(this.trimPathEnd)) * 31) + Float.hashCode(this.trimPathOffset)) * 31) + PathFillType.m3693hashCodeimpl(this.pathFillType);
    }
}
