...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m4082getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.INSTANCE.m3766getButtKaPHkGw();
        }
        return m4081getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m4081getStrokeLineCapCSYIeUk(int i, int i2) {
        if (i == 0) {
            return StrokeCap.INSTANCE.m3766getButtKaPHkGw();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeCap.INSTANCE.m3768getSquareKaPHkGw();
        }
        return StrokeCap.INSTANCE.m3767getRoundKaPHkGw();
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA$default, reason: not valid java name */
    static /* synthetic */ int m4084getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.INSTANCE.m3777getMiterLxFBmk8();
        }
        return m4083getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m4083getStrokeLineJoinkLtJ_vA(int i, int i2) {
        if (i == 0) {
            return StrokeJoin.INSTANCE.m3777getMiterLxFBmk8();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeJoin.INSTANCE.m3776getBevelLxFBmk8();
        }
        return StrokeJoin.INSTANCE.m3778getRoundLxFBmk8();
    }
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet) throws XmlPullParserException {
        long jM3450getUnspecified0d7_KjU;
        int iM3354getSrcIn0nO6VwU;
        ...
        if (typedArrayObtainAttributes.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            if (typedValue.type != 2 && (namedColorStateList = androidVectorParser.getNamedColorStateList(typedArrayObtainAttributes, theme, "tint", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) != null) {
                jM3450getUnspecified0d7_KjU = ColorKt.Color(namedColorStateList.getDefaultColor());
            } else {
                jM3450getUnspecified0d7_KjU = Color.INSTANCE.m3450getUnspecified0d7_KjU();
            }
        } else {
            jM3450getUnspecified0d7_KjU = Color.INSTANCE.m3450getUnspecified0d7_KjU();
        }
        long j = jM3450getUnspecified0d7_KjU;
        ...
        if (i == -1) {
            iM3354getSrcIn0nO6VwU = BlendMode.INSTANCE.m3354getSrcIn0nO6VwU();
        } else if (i == 3) {
            iM3354getSrcIn0nO6VwU = BlendMode.INSTANCE.m3356getSrcOver0nO6VwU();
        } else if (i == 5) {
            iM3354getSrcIn0nO6VwU = BlendMode.INSTANCE.m3354getSrcIn0nO6VwU();
        } else if (i == 9) {
            iM3354getSrcIn0nO6VwU = BlendMode.INSTANCE.m3353getSrcAtop0nO6VwU();
        } else {
            switch (i) {
                case 14:
                    iM3354getSrcIn0nO6VwU = BlendMode.INSTANCE.m3345getModulate0nO6VwU();
                    break;
                case 15:
                    iM3354getSrcIn0nO6VwU = BlendMode.INSTANCE.m3350getScreen0nO6VwU();
                    break;
                case 16:
                    iM3354getSrcIn0nO6VwU = BlendMode.INSTANCE.m3348getPlus0nO6VwU();
                    break;
                default:
                    iM3354getSrcIn0nO6VwU = BlendMode.INSTANCE.m3354getSrcIn0nO6VwU();
                    break;
        ...
        int i2 = iM3354getSrcIn0nO6VwU;
        float fM5735constructorimpl = Dp.m5735constructorimpl(dimension / resources.getDisplayMetrics().density);
        float fM5735constructorimpl2 = Dp.m5735constructorimpl(dimension2 / resources.getDisplayMetrics().density);
        typedArrayObtainAttributes.recycle();
        return new ImageVector.Builder(null, fM5735constructorimpl, fM5735constructorimpl2, namedFloat, namedFloat2, j, i2, namedBoolean, 1, null);
    }
    ...
    public static final void parsePath(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int iM4081getStrokeLineCapCSYIeUk = m4081getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(typedArrayObtainAttributes, "strokeLineCap", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.INSTANCE.m3766getButtKaPHkGw());
        int iM4083getStrokeLineJoinkLtJ_vA = m4083getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(typedArrayObtainAttributes, "strokeLineJoin", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.INSTANCE.m3776getBevelLxFBmk8());
        ...
        builder.m4048addPathoIyEayM(listAddPathNodes, namedInt == 0 ? companion.m3697getNonZeroRgk1Os() : companion.m3696getEvenOddRgk1Os(), str, brushObtainBrushFromComplexColor, namedFloat, brushObtainBrushFromComplexColor2, namedFloat3, namedFloat4, iM4081getStrokeLineCapCSYIeUk, iM4083getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
