...
public final class GroupComponent extends VNode {
    ...
    public GroupComponent() {
        ...
        this.tintColor = Color.INSTANCE.m3450getUnspecified0d7_KjU();
    ...
    private final void markTintForBrush(Brush brush) {
        if (this.isTintable && brush != null) {
            if (brush instanceof SolidColor) {
                m4041markTintForColor8_81llA(((SolidColor) brush).getValue());
            } else {
                markNotTintable();
            }
        }
    ...
    private final void m4041markTintForColor8_81llA(long color) {
        if (this.isTintable) {
            if (color != Color.INSTANCE.m3450getUnspecified0d7_KjU()) {
                if (this.tintColor == Color.INSTANCE.m3450getUnspecified0d7_KjU()) {
                    this.tintColor = color;
                } else {
                    if (VectorKt.m4064rgbEqualOWjLjI(this.tintColor, color)) {
                        return;
                    }
                    markNotTintable();
                }
    ...
    public final void markTintForVNode(VNode node) {
        if (node instanceof PathComponent) {
            ...
            if (groupComponent.isTintable && this.isTintable) {
                m4041markTintForColor8_81llA(groupComponent.tintColor);
            } else {
                markNotTintable();
            }
        }
    ...
    private final void updateMatrix() {
        float[] fArrM3645constructorimpl$default = this.groupMatrix;
        if (fArrM3645constructorimpl$default == null) {
            fArrM3645constructorimpl$default = Matrix.m3645constructorimpl$default(null, 1, null);
            this.groupMatrix = fArrM3645constructorimpl$default;
        } else {
            Matrix.m3654resetimpl(fArrM3645constructorimpl$default);
        }
        Matrix.m3665translateimpl$default(fArrM3645constructorimpl$default, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m3657rotateZimpl(fArrM3645constructorimpl$default, this.rotation);
        Matrix.m3658scaleimpl(fArrM3645constructorimpl$default, this.scaleX, this.scaleY, 1.0f);
        Matrix.m3665translateimpl$default(fArrM3645constructorimpl$default, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void draw(DrawScope drawScope) {
        ...
        if (fArr != null) {
            transform.mo3896transform58bKbWc((fArr != null ? Matrix.m3643boximpl(fArr) : null).m3666unboximpl());
        }
        Path path = this.clipPath;
        if (getWillClipPath() && path != null) {
            DrawTransform.m4014clipPathmtrdDE$default(transform, path, 0, 2, null);
        }
