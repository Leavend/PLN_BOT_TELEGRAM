...
public final class VectorKt {
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.INSTANCE.m3766getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.INSTANCE.m3777getMiterLxFBmk8();
    private static final int DefaultTintBlendMode = BlendMode.INSTANCE.m3354getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.INSTANCE.m3449getTransparent0d7_KjU();
    private static final int DefaultFillType = PathFillType.INSTANCE.m3697getNonZeroRgk1Os();
    ...
    public static final boolean m4064rgbEqualOWjLjI(long j, long j2) {
        if (Color.m3420getRedimpl(j) == Color.m3420getRedimpl(j2)) {
            if (Color.m3419getGreenimpl(j) == Color.m3419getGreenimpl(j2)) {
                if (Color.m3417getBlueimpl(j) == Color.m3417getBlueimpl(j2)) {
                    return true;
                }
            }
        }
    ...
    public static final boolean tintableWithAlphaMask(ColorFilter colorFilter) {
        if (colorFilter instanceof BlendModeColorFilter) {
            ...
            if (BlendMode.m3325equalsimpl0(blendModeColorFilter.getBlendMode(), BlendMode.INSTANCE.m3354getSrcIn0nO6VwU()) || BlendMode.m3325equalsimpl0(blendModeColorFilter.getBlendMode(), BlendMode.INSTANCE.m3356getSrcOver0nO6VwU())) {
                return true;
            }
