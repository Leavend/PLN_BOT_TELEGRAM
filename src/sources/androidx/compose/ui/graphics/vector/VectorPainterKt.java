...
public final class VectorPainterKt {
    ...
    public static final VectorPainter m4076rememberVectorPaintermlNsNFs(float f, float f2, float f3, float f4, String str, long j, int i, Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> function4, Composer composer, int i2, int i3) {
        ...
        long jM3450getUnspecified0d7_KjU = (i3 & 32) != 0 ? Color.INSTANCE.m3450getUnspecified0d7_KjU() : j;
        int iM3354getSrcIn0nO6VwU = (i3 & 64) != 0 ? BlendMode.INSTANCE.m3354getSrcIn0nO6VwU() : i;
        ...
        VectorPainter vectorPainterM4077rememberVectorPaintervIP8VLU = m4077rememberVectorPaintervIP8VLU(f, f2, f5, f6, str2, jM3450getUnspecified0d7_KjU, iM3354getSrcIn0nO6VwU, false, function4, composer, (i2 & 14) | 12582912 | (i2 & 112) | (i2 & 896) | (i2 & 7168) | (57344 & i2) | (458752 & i2) | (3670016 & i2) | ((i2 << 3) & 234881024), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return vectorPainterM4077rememberVectorPaintervIP8VLU;
    }
    ...
    */
    public static final androidx.compose.ui.graphics.vector.VectorPainter m4077rememberVectorPaintervIP8VLU(float r16, float r17, float r18, float r19, java.lang.String r20, long r21, int r23, boolean r24, final kotlin.jvm.functions.Function4<? super java.lang.Float, ? super java.lang.Float, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r25, androidx.compose.runtime.Composer r26, int r27, int r28) {
        /*
            Method dump skipped, instructions count: 364
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.graphics.vector.VectorPainterKt.m4077rememberVectorPaintervIP8VLU(float, float, float, float, java.lang.String, long, int, boolean, kotlin.jvm.functions.Function4, androidx.compose.runtime.Composer, int, int):androidx.compose.ui.graphics.vector.VectorPainter");
    }
    ...
    private static final long m4074obtainSizePxVpY3zN4(Density density, float f, float f2) {
        return SizeKt.Size(density.mo316toPx0680j_4(f), density.mo316toPx0680j_4(f2));
    }

    /* renamed from: obtainViewportSize-Pq9zytI, reason: not valid java name */
    private static final long m4075obtainViewportSizePq9zytI(long j, float f, float f2) {
        if (Float.isNaN(f)) {
            f = Size.m3242getWidthimpl(j);
        }
        if (Float.isNaN(f2)) {
            f2 = Size.m3239getHeightimpl(j);
        }
        return SizeKt.Size(f, f2);
    }

    /* renamed from: configureVectorPainter-T4PVSW8, reason: not valid java name */
    public static final VectorPainter m4071configureVectorPainterT4PVSW8(VectorPainter vectorPainter, long j, long j2, String str, ColorFilter colorFilter, boolean z) {
        vectorPainter.m4068setSizeuvyYCjk$ui_release(j);
        vectorPainter.setAutoMirror$ui_release(z);
        vectorPainter.setIntrinsicColorFilter$ui_release(colorFilter);
        vectorPainter.m4069setViewportSizeuvyYCjk$ui_release(j2);
    ...
    public static final VectorPainter createVectorPainterFromImageVector(Density density, ImageVector imageVector, GroupComponent groupComponent) {
        long jM4074obtainSizePxVpY3zN4 = m4074obtainSizePxVpY3zN4(density, imageVector.getDefaultWidth(), imageVector.getDefaultHeight());
        return m4071configureVectorPainterT4PVSW8(new VectorPainter(groupComponent), jM4074obtainSizePxVpY3zN4, m4075obtainViewportSizePq9zytI(jM4074obtainSizePxVpY3zN4, imageVector.getViewportWidth(), imageVector.getViewportHeight()), imageVector.getName(), m4073createColorFilterxETnrds(imageVector.getTintColor(), imageVector.getTintBlendMode()), imageVector.getAutoMirror());
    }
    ...
    public static final GroupComponent createGroupComponent(GroupComponent groupComponent, VectorGroup vectorGroup) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (vectorNode instanceof VectorPath) {
                ...
                pathComponent.m4054setPathFillTypeoQ8Xj4U(vectorPath.getPathFillType());
                ...
                pathComponent.m4055setStrokeLineCapBeK7IIE(vectorPath.getStrokeLineCap());
                pathComponent.m4056setStrokeLineJoinWw9F2mQ(vectorPath.getStrokeLineJoin());
    ...
    public static final ColorFilter m4073createColorFilterxETnrds(long j, int i) {
        if (j != Color.INSTANCE.m3450getUnspecified0d7_KjU()) {
            return ColorFilter.INSTANCE.m3458tintxETnrds(j, i);
        }
        return null;
    }
}
