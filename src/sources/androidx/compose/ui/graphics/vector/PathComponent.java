...
public final class PathComponent extends VNode {
    ...
    public final void m4054setPathFillTypeoQ8Xj4U(int i) {
        this.pathFillType = i;
        this.renderPath.mo3307setFillTypeoQ8Xj4U(i);
        invalidate();
    }
    ...
    public final void m4055setStrokeLineCapBeK7IIE(int i) {
    ...
    public final void m4056setStrokeLineJoinWw9F2mQ(int i) {
    ...
    private final void updateRenderPath() {
        ...
        if (Intrinsics.areEqual(this.renderPath, this.path)) {
            ...
            int iMo3305getFillTypeRgk1Os = this.renderPath.mo3305getFillTypeRgk1Os();
            this.renderPath.rewind();
            this.renderPath.mo3307setFillTypeoQ8Xj4U(iMo3305getFillTypeRgk1Os);
        }
    ...
    public void draw(DrawScope drawScope) {
        ...
        if (brush != null) {
            DrawScope.m3953drawPathGBMwjPU$default(drawScope, this.renderPath, brush, this.fillAlpha, null, null, 0, 56, null);
        }
        ...
        if (brush2 != null) {
            ...
            DrawScope.m3953drawPathGBMwjPU$default(drawScope, this.renderPath, brush2, this.strokeAlpha, stroke, null, 0, 48, null);
        }
    }
