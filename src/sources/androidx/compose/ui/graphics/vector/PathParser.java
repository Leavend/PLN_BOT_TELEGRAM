                ...
                if ((cCharAt | ' ') != 122) {
                    ...
                    while (true) {
                        if (i >= length || Intrinsics.compare((int) pathData.charAt(i), 32) > 0) {
                            ...
                            float fIntBitsToFloat = Float.intBitsToFloat((int) (jNextFloat & InternalZipConstants.ZIP_64_SIZE_LIMIT));
