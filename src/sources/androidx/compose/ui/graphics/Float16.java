...
public final class Float16 implements Comparable<Float16> {
    ...
    private static final short Epsilon = m3523constructorimpl((short) 5120);
    private static final short LowestValue = m3523constructorimpl((short) -1025);
    private static final short MaxValue = m3523constructorimpl((short) 31743);
    private static final short MinNormal = m3523constructorimpl((short) 1024);
    private static final short MinValue = m3523constructorimpl((short) 1);
    private static final short NaN = m3523constructorimpl((short) 32256);
    private static final short NegativeInfinity = m3523constructorimpl((short) -1024);
    private static final short NegativeZero = m3523constructorimpl(ShortCompanionObject.MIN_VALUE);
    private static final short PositiveInfinity = m3523constructorimpl((short) 31744);
    private static final short PositiveZero = m3523constructorimpl((short) 0);
    private static final short One = m3522constructorimpl(1.0f);
    private static final short NegativeOne = m3522constructorimpl(-1.0f);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ Float16 m3518boximpl(short s) {
        return new Float16(s);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static short m3523constructorimpl(short s) {
        return s;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3524equalsimpl(short s, Object obj) {
        return (obj instanceof Float16) && s == ((Float16) obj).m3549unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3525equalsimpl0(short s, short s2) {
        return s == s2;
    }

    /* renamed from: getExponent-impl, reason: not valid java name */
    public static final int m3527getExponentimpl(short s) {
        return ((s >>> 10) & 31) - 15;
    }

    /* renamed from: getSignificand-impl, reason: not valid java name */
    public static final int m3529getSignificandimpl(short s) {
        return s & 1023;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3530hashCodeimpl(short s) {
        return Short.hashCode(s);
    }

    /* renamed from: isFinite-impl, reason: not valid java name */
    public static final boolean m3531isFiniteimpl(short s) {
        return (s & ShortCompanionObject.MAX_VALUE) != FP16_EXPONENT_MAX;
    }

    /* renamed from: isInfinite-impl, reason: not valid java name */
    public static final boolean m3532isInfiniteimpl(short s) {
        return (s & ShortCompanionObject.MAX_VALUE) == FP16_EXPONENT_MAX;
    }

    /* renamed from: isNaN-impl, reason: not valid java name */
    public static final boolean m3533isNaNimpl(short s) {
        return (s & ShortCompanionObject.MAX_VALUE) > FP16_EXPONENT_MAX;
    }

    /* renamed from: isNormalized-impl, reason: not valid java name */
    public static final boolean m3534isNormalizedimpl(short s) {
        int i = s & FP16_EXPONENT_MAX;
        return (i == 0 || i == FP16_EXPONENT_MAX) ? false : true;
    }

    /* renamed from: toRawBits-impl, reason: not valid java name */
    public static final int m3543toRawBitsimpl(short s) {
        return s & UShort.MAX_VALUE;
    }

    public boolean equals(Object obj) {
        return m3524equalsimpl(this.halfValue, obj);
    }

    public int hashCode() {
        return m3530hashCodeimpl(this.halfValue);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ short m3549unboximpl() {
        return this.halfValue;
    }

    @Override // java.lang.Comparable
    public /* bridge */ /* synthetic */ int compareTo(Float16 float16) {
        return m3548compareTo41bOqos(float16.m3549unboximpl());
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static short m3522constructorimpl(float f) {
        return m3523constructorimpl(INSTANCE.floatToHalf(f));
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static short m3521constructorimpl(double d) {
        return m3522constructorimpl((float) d);
    }

    /* renamed from: toByte-impl, reason: not valid java name */
    public static final byte m3537toByteimpl(short s) {
        return (byte) m3539toFloatimpl(s);
    }

    /* renamed from: toShort-impl, reason: not valid java name */
    public static final short m3544toShortimpl(short s) {
        return (short) m3539toFloatimpl(s);
    }

    /* renamed from: toInt-impl, reason: not valid java name */
    public static final int m3541toIntimpl(short s) {
        return (int) m3539toFloatimpl(s);
    }

    /* renamed from: toLong-impl, reason: not valid java name */
    public static final long m3542toLongimpl(short s) {
        return (long) m3539toFloatimpl(s);
    }

    /* renamed from: toFloat-impl, reason: not valid java name */
    public static final float m3539toFloatimpl(short s) {
        int i;
        int i2;
        int i3;
        ...
        if (i6 != 0) {
            ...
            if (i7 != 0) {
                ...
                float fIntBitsToFloat = Float.intBitsToFloat(i7 + FP32_DENORMAL_MAGIC) - FP32_DENORMAL_FLOAT;
    ...
    public static final double m3538toDoubleimpl(short s) {
        return m3539toFloatimpl(s);
    }

    /* renamed from: toBits-impl, reason: not valid java name */
    public static final int m3536toBitsimpl(short s) {
        return m3533isNaNimpl(s) ? NaN : s & UShort.MAX_VALUE;
    }

    public String toString() {
        return m3545toStringimpl(this.halfValue);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3545toStringimpl(short s) {
        return String.valueOf(m3539toFloatimpl(s));
    }

    /* renamed from: compareTo-41bOqos, reason: not valid java name */
    public int m3548compareTo41bOqos(short s) {
        return m3520compareTo41bOqos(this.halfValue, s);
    }

    /* renamed from: compareTo-41bOqos, reason: not valid java name */
    public static int m3520compareTo41bOqos(short s, short s2) {
        if (m3533isNaNimpl(s)) {
            return !m3533isNaNimpl(s2) ? 1 : 0;
        }
        if (m3533isNaNimpl(s2)) {
            return -1;
        }
    ...
    public static final short m3528getSignslo4al4(short s) {
        if (m3533isNaNimpl(s)) {
            return NaN;
        }
        return m3520compareTo41bOqos(s, NegativeZero) < 0 ? NegativeOne : m3520compareTo41bOqos(s, PositiveZero) > 0 ? One : s;
    }

    /* renamed from: withSign-qCeQghg, reason: not valid java name */
    public static final short m3547withSignqCeQghg(short s, short s2) {
        return m3523constructorimpl((short) ((s & ShortCompanionObject.MAX_VALUE) | (s2 & ShortCompanionObject.MIN_VALUE)));
    }

    /* renamed from: absoluteValue-slo4al4, reason: not valid java name */
    public static final short m3517absoluteValueslo4al4(short s) {
        return m3523constructorimpl((short) (s & ShortCompanionObject.MAX_VALUE));
    }

    /* renamed from: round-slo4al4, reason: not valid java name */
    public static final short m3535roundslo4al4(short s) {
        ...
        return m3523constructorimpl((short) i);
    }

    /* renamed from: ceil-slo4al4, reason: not valid java name */
    public static final short m3519ceilslo4al4(short s) {
        int i = s & UShort.MAX_VALUE;
        int i2 = i & 32767;
        if (i2 < 15360) {
    ...
    public static final short m3526floorslo4al4(short s) {
        int i = s & UShort.MAX_VALUE;
        int i2 = i & 32767;
        if (i2 < 15360) {
    ...
    public static final short m3546truncslo4al4(short s) {
        int i;
        int i2 = s & UShort.MAX_VALUE;
        int i3 = i2 & 32767;
        if (i3 >= 15360) {
            i = i3 < 25600 ? ~((1 << (25 - (i3 >> 10))) - 1) : 32768;
            return m3523constructorimpl((short) i2);
        }
        i2 &= i;
        return m3523constructorimpl((short) i2);
    }
    ...
    public static final String m3540toHexStringimpl(short s) {
    ...
    public static final class Companion {
        ...
        public final short floatToHalf(float f) {
            ...
            int i5 = iFloatToRawIntBits & Float16.FP32_SIGNIFICAND_MASK;
            int i6 = 31;
            int i7 = 0;
            if (i4 == 255) {
                if (i5 != 0) {
