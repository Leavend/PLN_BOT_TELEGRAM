...
public final class Stroke extends DrawStyle {
    ...
    private static final int DefaultCap = StrokeCap.INSTANCE.m3766getButtKaPHkGw();
    private static final int DefaultJoin = StrokeJoin.INSTANCE.m3777getMiterLxFBmk8();
    ...
    public static final class Companion {
        ...
        public final int m4029getDefaultCapKaPHkGw() {
            return Stroke.DefaultCap;
        }

        /* renamed from: getDefaultJoin-LxFBmk8, reason: not valid java name */
        public final int m4030getDefaultJoinLxFBmk8() {
    ...
    public boolean equals(Object other) {
        ...
        if (this.width == stroke.width) {
            return ((this.miter > stroke.miter ? 1 : (this.miter == stroke.miter ? 0 : -1)) == 0) && StrokeCap.m3762equalsimpl0(this.cap, stroke.cap) && StrokeJoin.m3772equalsimpl0(this.join, stroke.join) && Intrinsics.areEqual(this.pathEffect, stroke.pathEffect);
        }
        return false;
    }

    public int hashCode() {
        int iHashCode = ((((((Float.hashCode(this.width) * 31) + Float.hashCode(this.miter)) * 31) + StrokeCap.m3763hashCodeimpl(this.cap)) * 31) + StrokeJoin.m3773hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect = this.pathEffect;
        return iHashCode + (pathEffect != null ? pathEffect.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m3764toStringimpl(this.cap)) + ", join=" + ((Object) StrokeJoin.m3774toStringimpl(this.join)) + ", pathEffect=" + this.pathEffect + ')';
    }
}
