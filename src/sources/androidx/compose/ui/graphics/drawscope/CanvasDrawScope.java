...
public final class CanvasDrawScope implements DrawScope {
    ...
    private final DrawContext drawContext = new DrawContext() { // from class: androidx.compose.ui.graphics.drawscope.CanvasDrawScope$drawContext$1
        ...
        public long mo3888getSizeNHjbRc() {
            return this.this$0.getDrawParams().m3886getSizeNHjbRc();
        }

        @Override // androidx.compose.ui.graphics.drawscope.DrawContext
        /* renamed from: setSize-uvyYCjk, reason: not valid java name */
        public void mo3889setSizeuvyYCjk(long j) {
            this.this$0.getDrawParams().m3887setSizeuvyYCjk(j);
        }
    ...
    public void mo3871drawLine1RTmtNc(Brush brush, long start, long end, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().mo3273drawLineWko1d7g(start, end, m3861configureStrokePaintho4zsrM$default(this, brush, strokeWidth, 4.0f, cap, StrokeJoin.INSTANCE.m3777getMiterLxFBmk8(), pathEffect, alpha, colorFilter, blendMode, 0, 512, null));
    }
    ...
    public void mo3872drawLineNGM6Ib0(long color, long start, long end, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().mo3273drawLineWko1d7g(start, end, m3859configureStrokePaintQ_0CZUI$default(this, color, strokeWidth, 4.0f, cap, StrokeJoin.INSTANCE.m3777getMiterLxFBmk8(), pathEffect, alpha, colorFilter, blendMode, 0, 512, null));
    }
    ...
    public void mo3879drawRectAsUm42w(Brush brush, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().drawRect(Offset.m3173getXimpl(topLeft), Offset.m3174getYimpl(topLeft), Offset.m3173getXimpl(topLeft) + Size.m3242getWidthimpl(size), Offset.m3174getYimpl(topLeft) + Size.m3239getHeightimpl(size), m3857configurePaintswdJneE$default(this, brush, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3880drawRectnJ9OG0(long color, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().drawRect(Offset.m3173getXimpl(topLeft), Offset.m3174getYimpl(topLeft), Offset.m3173getXimpl(topLeft) + Size.m3242getWidthimpl(size), Offset.m3174getYimpl(topLeft) + Size.m3239getHeightimpl(size), m3855configurePaint2qPWKa0$default(this, color, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3870drawImagegbVJVH8(ImageBitmap image, long topLeft, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().mo3271drawImaged4ec7I(image, topLeft, m3857configurePaintswdJneE$default(this, null, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public /* synthetic */ void mo3868drawImage9jGpkUE(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().mo3272drawImageRectHPBpro0(image, srcOffset, srcSize, dstOffset, dstSize, m3857configurePaintswdJneE$default(this, null, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3869drawImageAZ2fEMs(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode, int filterQuality) {
        this.drawParams.getCanvas().mo3272drawImageRectHPBpro0(image, srcOffset, srcSize, dstOffset, dstSize, m3856configurePaintswdJneE(null, style, alpha, colorFilter, blendMode, filterQuality));
    }
    ...
    public void mo3881drawRoundRectZuiqVtQ(Brush brush, long topLeft, long size, long cornerRadius, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().drawRoundRect(Offset.m3173getXimpl(topLeft), Offset.m3174getYimpl(topLeft), Offset.m3173getXimpl(topLeft) + Size.m3242getWidthimpl(size), Offset.m3174getYimpl(topLeft) + Size.m3239getHeightimpl(size), CornerRadius.m3148getXimpl(cornerRadius), CornerRadius.m3149getYimpl(cornerRadius), m3857configurePaintswdJneE$default(this, brush, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3882drawRoundRectuAw5IA(long color, long topLeft, long size, long cornerRadius, DrawStyle style, float alpha, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().drawRoundRect(Offset.m3173getXimpl(topLeft), Offset.m3174getYimpl(topLeft), Offset.m3173getXimpl(topLeft) + Size.m3242getWidthimpl(size), Offset.m3174getYimpl(topLeft) + Size.m3239getHeightimpl(size), CornerRadius.m3148getXimpl(cornerRadius), CornerRadius.m3149getYimpl(cornerRadius), m3855configurePaint2qPWKa0$default(this, color, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3866drawCircleV9BoPsw(Brush brush, float radius, long center, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().mo3270drawCircle9KIMszo(center, radius, m3857configurePaintswdJneE$default(this, brush, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3867drawCircleVaOC9Bg(long color, float radius, long center, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().mo3270drawCircle9KIMszo(center, radius, m3855configurePaint2qPWKa0$default(this, color, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3873drawOvalAsUm42w(Brush brush, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().drawOval(Offset.m3173getXimpl(topLeft), Offset.m3174getYimpl(topLeft), Offset.m3173getXimpl(topLeft) + Size.m3242getWidthimpl(size), Offset.m3174getYimpl(topLeft) + Size.m3239getHeightimpl(size), m3857configurePaintswdJneE$default(this, brush, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3874drawOvalnJ9OG0(long color, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().drawOval(Offset.m3173getXimpl(topLeft), Offset.m3174getYimpl(topLeft), Offset.m3173getXimpl(topLeft) + Size.m3242getWidthimpl(size), Offset.m3174getYimpl(topLeft) + Size.m3239getHeightimpl(size), m3855configurePaint2qPWKa0$default(this, color, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3864drawArcillE91I(Brush brush, float startAngle, float sweepAngle, boolean useCenter, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().drawArc(Offset.m3173getXimpl(topLeft), Offset.m3174getYimpl(topLeft), Offset.m3173getXimpl(topLeft) + Size.m3242getWidthimpl(size), Offset.m3174getYimpl(topLeft) + Size.m3239getHeightimpl(size), startAngle, sweepAngle, useCenter, m3857configurePaintswdJneE$default(this, brush, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3865drawArcyD3GUKo(long color, float startAngle, float sweepAngle, boolean useCenter, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().drawArc(Offset.m3173getXimpl(topLeft), Offset.m3174getYimpl(topLeft), Offset.m3173getXimpl(topLeft) + Size.m3242getWidthimpl(size), Offset.m3174getYimpl(topLeft) + Size.m3239getHeightimpl(size), startAngle, sweepAngle, useCenter, m3855configurePaint2qPWKa0$default(this, color, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3876drawPathLG529CI(Path path, long color, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().drawPath(path, m3855configurePaint2qPWKa0$default(this, color, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3875drawPathGBMwjPU(Path path, Brush brush, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().drawPath(path, m3857configurePaintswdJneE$default(this, brush, style, alpha, colorFilter, blendMode, 0, 32, null));
    }
    ...
    public void mo3877drawPointsF8ZwMP8(List<Offset> points, int pointMode, long color, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().mo3274drawPointsO7TthRY(pointMode, points, m3859configureStrokePaintQ_0CZUI$default(this, color, strokeWidth, 4.0f, cap, StrokeJoin.INSTANCE.m3777getMiterLxFBmk8(), pathEffect, alpha, colorFilter, blendMode, 0, 512, null));
    }
    ...
    public void mo3878drawPointsGsft0Ws(List<Offset> points, int pointMode, Brush brush, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.drawParams.getCanvas().mo3274drawPointsO7TthRY(pointMode, points, m3861configureStrokePaintho4zsrM$default(this, brush, strokeWidth, 4.0f, cap, StrokeJoin.INSTANCE.m3777getMiterLxFBmk8(), pathEffect, alpha, colorFilter, blendMode, 0, 512, null));
    }

    /* renamed from: draw-yzxVdVo, reason: not valid java name */
    public final void m3863drawyzxVdVo(Density density, LayoutDirection layoutDirection, Canvas canvas, long size, Function1<? super DrawScope, Unit> block) {
    ...
    private final Paint obtainFillPaint() {
        ...
        Paint.mo3297setStylek9PVt8s(PaintingStyle.INSTANCE.m3681getFillTiuSbCo());
    ...
    private final Paint obtainStrokePaint() {
        ...
        Paint Paint = AndroidPaint_androidKt.Paint();
        Paint.mo3297setStylek9PVt8s(PaintingStyle.INSTANCE.m3682getStrokeTiuSbCo());
    ...
    private final Paint selectPaint(DrawStyle drawStyle) {
        ...
        if (drawStyle instanceof Stroke) {
            ...
            if (!StrokeCap.m3762equalsimpl0(paintObtainStrokePaint.mo3289getStrokeCapKaPHkGw(), stroke.getCap())) {
                paintObtainStrokePaint.mo3295setStrokeCapBeK7IIE(stroke.getCap());
            }
            if (!(paintObtainStrokePaint.getStrokeMiterLimit() == stroke.getMiter())) {
                paintObtainStrokePaint.setStrokeMiterLimit(stroke.getMiter());
            }
            if (!StrokeJoin.m3772equalsimpl0(paintObtainStrokePaint.mo3290getStrokeJoinLxFBmk8(), stroke.getJoin())) {
                paintObtainStrokePaint.mo3296setStrokeJoinWw9F2mQ(stroke.getJoin());
            }
    ...
    static /* synthetic */ Paint m3857configurePaintswdJneE$default(CanvasDrawScope canvasDrawScope, Brush brush, DrawStyle drawStyle, float f, ColorFilter colorFilter, int i, int i2, int i3, Object obj) {
        if ((i3 & 32) != 0) {
            i2 = DrawScope.INSTANCE.m3965getDefaultFilterQualityfv9h1I();
        }
        return canvasDrawScope.m3856configurePaintswdJneE(brush, drawStyle, f, colorFilter, i, i2);
    }

    /* renamed from: configurePaint-swdJneE, reason: not valid java name */
    private final Paint m3856configurePaintswdJneE(Brush brush, DrawStyle style, float alpha, ColorFilter colorFilter, int blendMode, int filterQuality) {
        Paint paintSelectPaint = selectPaint(style);
        if (brush != null) {
            brush.mo3361applyToPq9zytI(mo3963getSizeNHjbRc(), paintSelectPaint, alpha);
        } else {
            if (paintSelectPaint.getInternalShader() != null) {
                paintSelectPaint.setShader(null);
            }
            if (!Color.m3415equalsimpl0(paintSelectPaint.mo3287getColor0d7_KjU(), Color.INSTANCE.m3440getBlack0d7_KjU())) {
                paintSelectPaint.mo3293setColor8_81llA(Color.INSTANCE.m3440getBlack0d7_KjU());
            }
        ...
        if (!BlendMode.m3325equalsimpl0(paintSelectPaint.get_blendMode(), blendMode)) {
            paintSelectPaint.mo3292setBlendModes9anfk8(blendMode);
        }
        if (!FilterQuality.m3509equalsimpl0(paintSelectPaint.mo3288getFilterQualityfv9h1I(), filterQuality)) {
            paintSelectPaint.mo3294setFilterQualityvDHp3xo(filterQuality);
        }
        return paintSelectPaint;
    }

    /* renamed from: configurePaint-2qPWKa0$default, reason: not valid java name */
    static /* synthetic */ Paint m3855configurePaint2qPWKa0$default(CanvasDrawScope canvasDrawScope, long j, DrawStyle drawStyle, float f, ColorFilter colorFilter, int i, int i2, int i3, Object obj) {
        return canvasDrawScope.m3854configurePaint2qPWKa0(j, drawStyle, f, colorFilter, i, (i3 & 32) != 0 ? DrawScope.INSTANCE.m3965getDefaultFilterQualityfv9h1I() : i2);
    }

    /* renamed from: configurePaint-2qPWKa0, reason: not valid java name */
    private final Paint m3854configurePaint2qPWKa0(long color, DrawStyle style, float alpha, ColorFilter colorFilter, int blendMode, int filterQuality) {
        Paint paintSelectPaint = selectPaint(style);
        long jM3862modulate5vOe2sY = m3862modulate5vOe2sY(color, alpha);
        if (!Color.m3415equalsimpl0(paintSelectPaint.mo3287getColor0d7_KjU(), jM3862modulate5vOe2sY)) {
            paintSelectPaint.mo3293setColor8_81llA(jM3862modulate5vOe2sY);
        }
        if (paintSelectPaint.getInternalShader() != null) {
            paintSelectPaint.setShader(null);
        }
    ...
    static /* synthetic */ Paint m3859configureStrokePaintQ_0CZUI$default(CanvasDrawScope canvasDrawScope, long j, float f, float f2, int i, int i2, PathEffect pathEffect, float f3, ColorFilter colorFilter, int i3, int i4, int i5, Object obj) {
        return canvasDrawScope.m3858configureStrokePaintQ_0CZUI(j, f, f2, i, i2, pathEffect, f3, colorFilter, i3, (i5 & 512) != 0 ? DrawScope.INSTANCE.m3965getDefaultFilterQualityfv9h1I() : i4);
    }

    /* renamed from: configureStrokePaint-Q_0CZUI, reason: not valid java name */
    private final Paint m3858configureStrokePaintQ_0CZUI(long color, float strokeWidth, float miter, int cap, int join, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode, int filterQuality) {
        Paint paintObtainStrokePaint = obtainStrokePaint();
        long jM3862modulate5vOe2sY = m3862modulate5vOe2sY(color, alpha);
        if (!Color.m3415equalsimpl0(paintObtainStrokePaint.mo3287getColor0d7_KjU(), jM3862modulate5vOe2sY)) {
            paintObtainStrokePaint.mo3293setColor8_81llA(jM3862modulate5vOe2sY);
        }
        ...
        if (!BlendMode.m3325equalsimpl0(paintObtainStrokePaint.get_blendMode(), blendMode)) {
            paintObtainStrokePaint.mo3292setBlendModes9anfk8(blendMode);
        }
        ...
        if (!StrokeCap.m3762equalsimpl0(paintObtainStrokePaint.mo3289getStrokeCapKaPHkGw(), cap)) {
            paintObtainStrokePaint.mo3295setStrokeCapBeK7IIE(cap);
        }
        if (!StrokeJoin.m3772equalsimpl0(paintObtainStrokePaint.mo3290getStrokeJoinLxFBmk8(), join)) {
            paintObtainStrokePaint.mo3296setStrokeJoinWw9F2mQ(join);
        }
        if (!Intrinsics.areEqual(paintObtainStrokePaint.getPathEffect(), pathEffect)) {
            paintObtainStrokePaint.setPathEffect(pathEffect);
        }
        if (!FilterQuality.m3509equalsimpl0(paintObtainStrokePaint.mo3288getFilterQualityfv9h1I(), filterQuality)) {
            paintObtainStrokePaint.mo3294setFilterQualityvDHp3xo(filterQuality);
        }
        return paintObtainStrokePaint;
    }

    /* renamed from: configureStrokePaint-ho4zsrM$default, reason: not valid java name */
    static /* synthetic */ Paint m3861configureStrokePaintho4zsrM$default(CanvasDrawScope canvasDrawScope, Brush brush, float f, float f2, int i, int i2, PathEffect pathEffect, float f3, ColorFilter colorFilter, int i3, int i4, int i5, Object obj) {
        return canvasDrawScope.m3860configureStrokePaintho4zsrM(brush, f, f2, i, i2, pathEffect, f3, colorFilter, i3, (i5 & 512) != 0 ? DrawScope.INSTANCE.m3965getDefaultFilterQualityfv9h1I() : i4);
    }

    /* renamed from: configureStrokePaint-ho4zsrM, reason: not valid java name */
    private final Paint m3860configureStrokePaintho4zsrM(Brush brush, float strokeWidth, float miter, int cap, int join, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode, int filterQuality) {
        Paint paintObtainStrokePaint = obtainStrokePaint();
        if (brush != null) {
            brush.mo3361applyToPq9zytI(mo3963getSizeNHjbRc(), paintObtainStrokePaint, alpha);
        } else {
    ...
    private final long m3862modulate5vOe2sY(long j, float f) {
        return !((f > 1.0f ? 1 : (f == 1.0f ? 0 : -1)) == 0) ? Color.m3413copywmQWz5c$default(j, Color.m3416getAlphaimpl(j) * f, 0.0f, 0.0f, 0.0f, 14, null) : j;
    }
    ...
    public static final /* data */ class DrawParams {
        ...
        public static /* synthetic */ DrawParams m3883copyUg5Nnss$default(DrawParams drawParams, Density density, LayoutDirection layoutDirection, Canvas canvas, long j, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return drawParams.m3885copyUg5Nnss(density, layoutDirection2, canvas2, j);
        }
        ...
        public final DrawParams m3885copyUg5Nnss(Density density, LayoutDirection layoutDirection, Canvas canvas, long size) {
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(this.density, drawParams.density) && this.layoutDirection == drawParams.layoutDirection && Intrinsics.areEqual(this.canvas, drawParams.canvas) && Size.m3238equalsimpl0(this.size, drawParams.size);
        }

        public int hashCode() {
            return (((((this.density.hashCode() * 31) + this.layoutDirection.hashCode()) * 31) + this.canvas.hashCode()) * 31) + Size.m3243hashCodeimpl(this.size);
        }

        public String toString() {
            return "DrawParams(density=" + this.density + ", layoutDirection=" + this.layoutDirection + ", canvas=" + this.canvas + ", size=" + ((Object) Size.m3246toStringimpl(this.size)) + ')';
        }
        ...
        public /* synthetic */ DrawParams(Density density, LayoutDirection layoutDirection, EmptyCanvas emptyCanvas, long j, int i, DefaultConstructorMarker defaultConstructorMarker) {
            this((i & 1) != 0 ? DrawContextKt.getDefaultDensity() : density, (i & 2) != 0 ? LayoutDirection.Ltr : layoutDirection, (i & 4) != 0 ? new EmptyCanvas() : emptyCanvas, (i & 8) != 0 ? Size.INSTANCE.m3251getZeroNHjbRc() : j, null);
        }
        ...
        /* renamed from: getSize-NH-jbRc, reason: not valid java name */
        public final long m3886getSizeNHjbRc() {
            return this.size;
        }

        /* renamed from: setSize-uvyYCjk, reason: not valid java name */
        public final void m3887setSizeuvyYCjk(long j) {
            this.size = j;
        }
    }
}
