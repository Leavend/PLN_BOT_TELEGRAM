...
public interface Canvas {
    ...
    void mo3267clipPathmtrdDE(Path path, int clipOp);

    /* renamed from: clipRect-N_I0leg */
    void mo3268clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp);

    /* renamed from: concat-58bKbWc */
    void mo3269concat58bKbWc(float[] matrix);
    ...
    void mo3270drawCircle9KIMszo(long center, float radius, Paint paint);

    /* renamed from: drawImage-d-4ec7I */
    void mo3271drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint);

    /* renamed from: drawImageRect-HPBpro0 */
    void mo3272drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint);

    /* renamed from: drawLine-Wko1d7g */
    void mo3273drawLineWko1d7g(long p1, long p2, Paint paint);
    ...
    void mo3274drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint);

    /* renamed from: drawRawPoints-O7TthRY */
    void mo3275drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint);
    ...
    void mo3276drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint);
    ...
    public static final class DefaultImpls {
        ...
        public static void m3392clipRectmtrdDE(Canvas canvas, Rect rect, int i) {
            Canvas.super.m3389clipRectmtrdDE(rect, i);
        }
    ...
    static /* synthetic */ void m3387clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.m3389clipRectmtrdDE(rect, i);
    }

    /* renamed from: clipRect-mtrdD-E, reason: not valid java name */
    default void m3389clipRectmtrdDE(Rect rect, int clipOp) {
        mo3268clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), clipOp);
    }

    /* renamed from: clipRect-N_I0leg$default, reason: not valid java name */
    static /* synthetic */ void m3386clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.mo3268clipRectN_I0leg(f, f2, f3, f4, i);
    }

    /* renamed from: clipPath-mtrdD-E$default, reason: not valid java name */
    static /* synthetic */ void m3385clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.mo3267clipPathmtrdDE(path, i);
    }
    ...
    static /* synthetic */ void m3388drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: drawImageRect-HPBpro0");
        }
        long jM5873getZeronOccac = (i & 2) != 0 ? IntOffset.INSTANCE.m5873getZeronOccac() : j;
        long jIntSize = (i & 4) != 0 ? IntSizeKt.IntSize(imageBitmap.getWidth(), imageBitmap.getHeight()) : j2;
        canvas.mo3272drawImageRectHPBpro0(imageBitmap, jM5873getZeronOccac, jIntSize, (i & 8) != 0 ? IntOffset.INSTANCE.m5873getZeronOccac() : j3, (i & 16) != 0 ? jIntSize : j4, paint);
    }
}
