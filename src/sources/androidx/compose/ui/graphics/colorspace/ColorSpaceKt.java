...
public final class ColorSpaceKt {
    ...
    public static /* synthetic */ Connector m3832connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.INSTANCE.m3846getPerceptualuksYyKA();
        }
        return m3831connectYBCOT_4(colorSpace, colorSpace2, i);
    }

    /* renamed from: connect-YBCOT_4, reason: not valid java name */
    public static final Connector m3831connectYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        if (colorSpace == ColorSpaces.INSTANCE.getSrgb()) {
            ...
            if (colorSpace2 == ColorSpaces.INSTANCE.getOklab() && RenderIntent.m3841equalsimpl0(i, RenderIntent.INSTANCE.m3846getPerceptualuksYyKA())) {
                return Connector.INSTANCE.getSrgbToOklabPerceptual$ui_graphics_release();
            }
        } else if (colorSpace == ColorSpaces.INSTANCE.getOklab() && colorSpace2 == ColorSpaces.INSTANCE.getSrgb() && RenderIntent.m3841equalsimpl0(i, RenderIntent.INSTANCE.m3846getPerceptualuksYyKA())) {
        ...
        if (ColorModel.m3820equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m3827getRgbxdoWZVw()) && ColorModel.m3820equalsimpl0(colorSpace2.getModel(), ColorModel.INSTANCE.m3827getRgbxdoWZVw())) {
    ...
    public static final ColorSpace adapt(ColorSpace colorSpace, WhitePoint whitePoint, Adaptation adaptation) {
        if (!ColorModel.m3820equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m3827getRgbxdoWZVw())) {
            return colorSpace;
        }
        Intrinsics.checkNotNull(colorSpace, "null cannot be cast to non-null type androidx.compose.ui.graphics.colorspace.Rgb");
