...
public final class ColorModel {
    ...
    public static final /* synthetic */ ColorModel m3817boximpl(long j) {
        return new ColorModel(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m3818constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3819equalsimpl(long j, Object obj) {
        return (obj instanceof ColorModel) && j == ((ColorModel) obj).getPackedValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3820equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public static final int m3821getComponentCountimpl(long j) {
        return (int) (j >> 32);
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3822hashCodeimpl(long j) {
    ...
    public int hashCode() {
        return m3822hashCodeimpl(this.packedValue);
    }
    ...
    public static final class Companion {
        ...
        public final long m3827getRgbxdoWZVw() {
            return ColorModel.Rgb;
        }

        /* renamed from: getXyz-xdoWZVw, reason: not valid java name */
        public final long m3828getXyzxdoWZVw() {
            return ColorModel.Xyz;
        }

        /* renamed from: getLab-xdoWZVw, reason: not valid java name */
        public final long m3826getLabxdoWZVw() {
            return ColorModel.Lab;
        }

        /* renamed from: getCmyk-xdoWZVw, reason: not valid java name */
        public final long m3825getCmykxdoWZVw() {
    ...
    static {
        long j = 3;
        long j2 = j << 32;
        Rgb = m3818constructorimpl((0 & InternalZipConstants.ZIP_64_SIZE_LIMIT) | j2);
        Xyz = m3818constructorimpl((1 & InternalZipConstants.ZIP_64_SIZE_LIMIT) | j2);
        Lab = m3818constructorimpl(j2 | (2 & InternalZipConstants.ZIP_64_SIZE_LIMIT));
        Cmyk = m3818constructorimpl((j & InternalZipConstants.ZIP_64_SIZE_LIMIT) | (4 << 32));
    }
    ...
    public static String m3823toStringimpl(long j) {
        return m3820equalsimpl0(j, Rgb) ? "Rgb" : m3820equalsimpl0(j, Xyz) ? "Xyz" : m3820equalsimpl0(j, Lab) ? "Lab" : m3820equalsimpl0(j, Cmyk) ? "Cmyk" : "Unknown";
    }
}
