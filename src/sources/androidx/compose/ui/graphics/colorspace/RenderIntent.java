...
public final class RenderIntent {
    ...
    private static final int Perceptual = m3839constructorimpl(0);
    private static final int Relative = m3839constructorimpl(1);
    private static final int Saturation = m3839constructorimpl(2);
    private static final int Absolute = m3839constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ RenderIntent m3838boximpl(int i) {
    ...
    public static String m3843toStringimpl(int i) {
        return m3841equalsimpl0(i, Perceptual) ? "Perceptual" : m3841equalsimpl0(i, Relative) ? "Relative" : m3841equalsimpl0(i, Saturation) ? ExifInterface.TAG_SATURATION : m3841equalsimpl0(i, Absolute) ? "Absolute" : "Unknown";
    }
}
