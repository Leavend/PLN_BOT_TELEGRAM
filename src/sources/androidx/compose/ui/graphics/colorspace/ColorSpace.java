...
public abstract class ColorSpace {
    ...
    public final int getComponentCount() {
        return ColorModel.m3821getComponentCountimpl(this.model);
    }
    ...
    public long toXy$ui_graphics_release(float v0, float v1, float v2) {
        ...
        float f = xyz[0];
        float f2 = xyz[1];
        return (Float.floatToRawIntBits(f) << 32) | (Float.floatToRawIntBits(f2) & InternalZipConstants.ZIP_64_SIZE_LIMIT);
    }
    ...
    public final float[] fromXyz(float x, float y, float z) {
        float[] fArr = new float[ColorModel.m3821getComponentCountimpl(this.model)];
        fArr[0] = x;
        fArr[1] = y;
        fArr[2] = z;
        return fromXyz(fArr);
    ...
    public String toString() {
        return this.name + " (id=" + this.id + ", model=" + ((Object) ColorModel.m3823toStringimpl(this.model)) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        if (this.id == colorSpace.id && Intrinsics.areEqual(this.name, colorSpace.name)) {
            return ColorModel.m3820equalsimpl0(this.model, colorSpace.model);
        }
        return false;
    }

    public int hashCode() {
        return (((this.name.hashCode() * 31) + ColorModel.m3822hashCodeimpl(this.model)) * 31) + this.id;
    }
}
