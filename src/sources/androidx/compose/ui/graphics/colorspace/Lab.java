...
public final class Lab extends ColorSpace {
    ...
    public Lab(String str, int i) {
        super(str, ColorModel.INSTANCE.m3826getLabxdoWZVw(), i, null);
    }
    ...
    public long toXy$ui_graphics_release(float v0, float v1, float v2) {
        ...
        return (Float.floatToRawIntBits(f2 * Illuminant.INSTANCE.getD50Xyz$ui_graphics_release()[1]) & InternalZipConstants.ZIP_64_SIZE_LIMIT) | (Float.floatToRawIntBits(f3) << 32);
    }
