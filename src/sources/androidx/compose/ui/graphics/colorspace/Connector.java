...
public class Connector {
    ...
    private Connector(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        this(colorSpace, colorSpace2, ColorModel.m3820equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m3827getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(colorSpace, Illuminant.INSTANCE.getD50(), null, 2, null) : colorSpace, ColorModel.m3820equalsimpl0(colorSpace2.getModel(), ColorModel.INSTANCE.m3827getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(colorSpace2, Illuminant.INSTANCE.getD50(), null, 2, null) : colorSpace2, i, INSTANCE.m3836computeTransformYBCOT_4(colorSpace, colorSpace2, i), null);
    }
    ...
    public long mo3834transformToColorwmQWz5c$ui_graphics_release(float r, float g, float b, float a) {
        ...
        float fIntBitsToFloat2 = Float.intBitsToFloat((int) (xy$ui_graphics_release & InternalZipConstants.ZIP_64_SIZE_LIMIT));
        ...
        return this.transformDestination.mo3830xyzaToColorJlNiLsg$ui_graphics_release(f2, f, z$ui_graphics_release, a, this.destination);
    }
    ...
    public static final class RgbConnector extends Connector {
        ...
        private RgbConnector(Rgb rgb, Rgb rgb2, int i) {
            ...
            this.mTransform = m3837computeTransformYBCOT_4(rgb, rgb2, i);
        }
        ...
        private final float[] m3837computeTransformYBCOT_4(Rgb source, Rgb destination, int intent) {
            ...
            if (RenderIntent.m3841equalsimpl0(intent, RenderIntent.INSTANCE.m3845getAbsoluteuksYyKA())) {
    ...
    public static final class Companion {
        ...
        /* renamed from: computeTransform-YBCOT_4, reason: not valid java name */
        public final float[] m3836computeTransformYBCOT_4(ColorSpace source, ColorSpace destination, int intent) {
            if (!RenderIntent.m3841equalsimpl0(intent, RenderIntent.INSTANCE.m3845getAbsoluteuksYyKA())) {
                return null;
            }
            boolean zM3820equalsimpl0 = ColorModel.m3820equalsimpl0(source.getModel(), ColorModel.INSTANCE.m3827getRgbxdoWZVw());
            boolean zM3820equalsimpl02 = ColorModel.m3820equalsimpl0(destination.getModel(), ColorModel.INSTANCE.m3827getRgbxdoWZVw());
            if (zM3820equalsimpl0 && zM3820equalsimpl02) {
                return null;
            }
            if (!zM3820equalsimpl0 && !zM3820equalsimpl02) {
                return null;
            }
            if (!zM3820equalsimpl0) {
                source = destination;
            }
            Intrinsics.checkNotNull(source, "null cannot be cast to non-null type androidx.compose.ui.graphics.colorspace.Rgb");
            Rgb rgb = (Rgb) source;
            float[] xyz$ui_graphics_release = zM3820equalsimpl0 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
            float[] xyz$ui_graphics_release2 = zM3820equalsimpl02 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
        ...
        public final Connector identity$ui_graphics_release(final ColorSpace source) {
            final int iM3847getRelativeuksYyKA = RenderIntent.INSTANCE.m3847getRelativeuksYyKA();
            return new Connector(source, iM3847getRelativeuksYyKA) { // from class: androidx.compose.ui.graphics.colorspace.Connector$Companion$identity$1
                @Override // androidx.compose.ui.graphics.colorspace.Connector
                public float[] transform(float[] v) {
                    return v;
                }
                ...
                {
                    super(source, source, iM3847getRelativeuksYyKA, null);
                }
    ...
    static {
        ...
        SrgbToOklabPerceptual = new Connector(ColorSpaces.INSTANCE.getSrgb(), ColorSpaces.INSTANCE.getOklab(), RenderIntent.INSTANCE.m3846getPerceptualuksYyKA(), defaultConstructorMarker);
        OklabToSrgbPerceptual = new Connector(ColorSpaces.INSTANCE.getOklab(), ColorSpaces.INSTANCE.getSrgb(), RenderIntent.INSTANCE.m3846getPerceptualuksYyKA(), defaultConstructorMarker);
    }
}
