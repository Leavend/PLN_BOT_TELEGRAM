...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private int compositingStrategy = CompositingStrategy.INSTANCE.m3503getAutoNrFUSI();
    private long size = Size.INSTANCE.m3250getUnspecifiedNHjbRc();
    ...
    public void mo3604setAmbientShadowColor8_81llA(long j) {
        if (Color.m3415equalsimpl0(this.ambientShadowColor, j)) {
            return;
        }
    ...
    public void mo3606setSpotShadowColor8_81llA(long j) {
        if (Color.m3415equalsimpl0(this.spotShadowColor, j)) {
            return;
        }
    ...
    public void mo3607setTransformOrigin__ExYCQ(long j) {
        if (TransformOrigin.m3798equalsimpl0(this.transformOrigin, j)) {
            return;
        }
    ...
    public void mo3605setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m3499equalsimpl0(this.compositingStrategy, i)) {
            return;
        }
    ...
    public void m3725setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public final void reset() {
        ...
        mo3604setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo3606setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo3607setTransformOrigin__ExYCQ(TransformOrigin.INSTANCE.m3804getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        mo3605setCompositingStrategyaDBOjCE(CompositingStrategy.INSTANCE.m3503getAutoNrFUSI());
        m3725setSizeuvyYCjk(Size.INSTANCE.m3250getUnspecifiedNHjbRc());
