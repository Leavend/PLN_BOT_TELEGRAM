...
public final class BitmapPainterKt {
    ...
    public static /* synthetic */ BitmapPainter m4036BitmapPainterQZhYCtY$default(ImageBitmap imageBitmap, long j, long j2, int i, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            j = IntOffset.INSTANCE.m5873getZeronOccac();
        }
        long j3 = j;
        if ((i2 & 4) != 0) {
        ...
        long j4 = j2;
        if ((i2 & 8) != 0) {
            i = FilterQuality.INSTANCE.m3514getLowfv9h1I();
        }
        return m4035BitmapPainterQZhYCtY(imageBitmap, j3, j4, i);
    }

    /* renamed from: BitmapPainter-QZhYCtY, reason: not valid java name */
    public static final BitmapPainter m4035BitmapPainterQZhYCtY(ImageBitmap imageBitmap, long j, long j2, int i) {
        BitmapPainter bitmapPainter = new BitmapPainter(imageBitmap, j, j2, null);
        bitmapPainter.m4034setFilterQualityvDHp3xo$ui_graphics_release(i);
