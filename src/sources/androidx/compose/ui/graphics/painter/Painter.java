...
public abstract class Painter {
    ...
    public abstract long mo4033getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m4038drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter, int i, Object obj) {
        if (obj != null) {
        ...
        painter.m4039drawx_KDEd0(drawScope, j, f2, colorFilter);
    }

    /* renamed from: draw-x_KDEd0, reason: not valid java name */
    public final void m4039drawx_KDEd0(DrawScope drawScope, long j, float f, ColorFilter colorFilter) {
        configureAlpha(f);
        configureColorFilter(colorFilter);
        configureLayoutDirection(drawScope.getLayoutDirection());
        float fM3242getWidthimpl = Size.m3242getWidthimpl(drawScope.mo3963getSizeNHjbRc()) - Size.m3242getWidthimpl(j);
        float fM3239getHeightimpl = Size.m3239getHeightimpl(drawScope.mo3963getSizeNHjbRc()) - Size.m3239getHeightimpl(j);
        drawScope.getDrawContext().getTransform().inset(0.0f, 0.0f, fM3242getWidthimpl, fM3239getHeightimpl);
        if (f > 0.0f && Size.m3242getWidthimpl(j) > 0.0f && Size.m3239getHeightimpl(j) > 0.0f) {
            if (this.useLayer) {
                Rect rectM3213Recttz77jQw = RectKt.m3213Recttz77jQw(Offset.INSTANCE.m3189getZeroF1C5BW0(), SizeKt.Size(Size.m3242getWidthimpl(j), Size.m3239getHeightimpl(j)));
                Canvas canvas = drawScope.getDrawContext().getCanvas();
                try {
                    canvas.saveLayer(rectM3213Recttz77jQw, obtainPaint());
                    onDraw(drawScope);
                } finally {
                    canvas.restore();
                }
