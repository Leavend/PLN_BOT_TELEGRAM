...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint paint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m3356getSrcOver0nO6VwU();
    }
    ...
    public long mo3287getColor0d7_KjU() {
        return AndroidPaint_androidKt.getNativeColor(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo3293setColor8_81llA(long j) {
        AndroidPaint_androidKt.m3299setNativeColor4WTKRHQ(this.internalPaint, j);
    }
    ...
    public void mo3292setBlendModes9anfk8(int i) {
        if (BlendMode.m3325equalsimpl0(this._blendMode, i)) {
            return;
        }
        this._blendMode = i;
        AndroidPaint_androidKt.m3298setNativeBlendModeGB0RdKg(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo3291getStyleTiuSbCo() {
        return AndroidPaint_androidKt.getNativeStyle(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStyle-k9PVt8s, reason: not valid java name */
    public void mo3297setStylek9PVt8s(int i) {
        AndroidPaint_androidKt.m3303setNativeStyle5YerkU(this.internalPaint, i);
    }
    ...
    public int mo3289getStrokeCapKaPHkGw() {
        return AndroidPaint_androidKt.getNativeStrokeCap(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeCap-BeK7IIE, reason: not valid java name */
    public void mo3295setStrokeCapBeK7IIE(int i) {
        AndroidPaint_androidKt.m3301setNativeStrokeCapCSYIeUk(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo3290getStrokeJoinLxFBmk8() {
        return AndroidPaint_androidKt.getNativeStrokeJoin(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo3296setStrokeJoinWw9F2mQ(int i) {
        AndroidPaint_androidKt.m3302setNativeStrokeJoinkLtJ_vA(this.internalPaint, i);
    }
    ...
    public int mo3288getFilterQualityfv9h1I() {
        return AndroidPaint_androidKt.getNativeFilterQuality(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setFilterQuality-vDHp3xo, reason: not valid java name */
    public void mo3294setFilterQualityvDHp3xo(int i) {
        AndroidPaint_androidKt.m3300setNativeFilterQuality50PEsBU(this.internalPaint, i);
    }
