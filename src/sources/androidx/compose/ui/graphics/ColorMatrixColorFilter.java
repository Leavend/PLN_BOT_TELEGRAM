...
public final class ColorMatrixColorFilter extends ColorFilter {
    ...
    private ColorMatrixColorFilter(float[] fArr) {
        this(fArr, AndroidColorFilter_androidKt.m3278actualColorMatrixColorFilterjHGOpc(fArr), null);
    }

    /* renamed from: copyColorMatrix-gBh15pI$default, reason: not valid java name */
    public static /* synthetic */ float[] m3491copyColorMatrixgBh15pI$default(ColorMatrixColorFilter colorMatrixColorFilter, float[] fArr, int i, Object obj) {
        if ((i & 1) != 0) {
            fArr = ColorMatrix.m3471constructorimpl$default(null, 1, null);
        }
        return colorMatrixColorFilter.m3493copyColorMatrixgBh15pI(fArr);
    }

    /* renamed from: copyColorMatrix-gBh15pI, reason: not valid java name */
    public final float[] m3493copyColorMatrixgBh15pI(float[] targetColorMatrix) {
        ArraysKt.copyInto$default(m3492obtainColorMatrixp10uLo(), targetColorMatrix, 0, 0, 0, 14, (Object) null);
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorMatrixColorFilter) && Arrays.equals(m3492obtainColorMatrixp10uLo(), ((ColorMatrixColorFilter) other).m3492obtainColorMatrixp10uLo());
    }

    /* renamed from: obtainColorMatrix-p10-uLo, reason: not valid java name */
    private final float[] m3492obtainColorMatrixp10uLo() {
    ...
    public int hashCode() {
        float[] fArr = this.colorMatrix;
        if (fArr != null) {
            return ColorMatrix.m3478hashCodeimpl(fArr);
        }
        return 0;
    }
    ...
    public String toString() {
        ...
        float[] fArr = this.colorMatrix;
        return sb.append((Object) (fArr == null ? "null" : ColorMatrix.m3489toStringimpl(fArr))).append(')').toString();
    }
}
