...
final class BlendModeColorFilterHelper {
    ...
    public final android.graphics.BlendModeColorFilter m3360BlendModeColorFilterxETnrds(long color, int blendMode) {
        return new android.graphics.BlendModeColorFilter(ColorKt.m3468toArgb8_81llA(color), AndroidBlendMode_androidKt.m3265toAndroidBlendModes9anfk8(blendMode));
    }
