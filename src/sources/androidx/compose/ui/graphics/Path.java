...
public interface Path {
    ...
    void mo3304addPathUv8p0NA(Path path, long offset);
    ...
    boolean mo3306opN5in7k0(Path path1, Path path2, int operation);
    ...
    void mo3307setFillTypeoQ8Xj4U(int i);

    /* renamed from: transform-58bKbWc */
    default void mo3308transform58bKbWc(float[] matrix) {
    }

    /* renamed from: translate-k-4lQ0M */
    void mo3309translatek4lQ0M(long offset);
    ...
    public static final class DefaultImpls {
        ...
        public static void m3687transform58bKbWc(Path path, float[] fArr) {
            Path.super.mo3308transform58bKbWc(fArr);
        }
    }
    ...
    static /* synthetic */ void m3684addPathUv8p0NA$default(Path path, Path path2, long j, int i, Object obj) {
        if (obj != null) {
        ...
        path.mo3304addPathUv8p0NA(path2, j);
    }
    ...
    public static final class Companion {
        ...
        public final Path m3685combinexh6zSI8(int operation, Path path1, Path path2) {
            Path Path = AndroidPath_androidKt.Path();
            if (Path.mo3306opN5in7k0(path1, path2, operation)) {
                return Path;
            }
