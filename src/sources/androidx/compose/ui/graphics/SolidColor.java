...
public final class SolidColor extends Brush {
    ...
    public void mo3361applyToPq9zytI(long size, Paint p, float alpha) {
        long jM3413copywmQWz5c$default;
        p.setAlpha(1.0f);
        if (!(alpha == 1.0f)) {
            long j = this.value;
            jM3413copywmQWz5c$default = Color.m3413copywmQWz5c$default(j, Color.m3416getAlphaimpl(j) * alpha, 0.0f, 0.0f, 0.0f, 14, null);
        } else {
            jM3413copywmQWz5c$default = this.value;
        }
        p.mo3293setColor8_81llA(jM3413copywmQWz5c$default);
        if (p.getShader() != null) {
            p.setShader(null);
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SolidColor) && Color.m3415equalsimpl0(this.value, ((SolidColor) other).value);
    }
    ...
    public String toString() {
        return "SolidColor(value=" + ((Object) Color.m3422toStringimpl(this.value)) + ')';
    }
}
