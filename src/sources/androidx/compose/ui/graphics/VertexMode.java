...
public final class VertexMode {
    ...
    private static final int Triangles = m3806constructorimpl(0);
    private static final int TriangleStrip = m3806constructorimpl(1);
    private static final int TriangleFan = m3806constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ VertexMode m3805boximpl(int i) {
        return new VertexMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m3806constructorimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object obj) {
        return m3807equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m3809hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m3814getTrianglesc2xauaI() {
            return VertexMode.Triangles;
        }

        /* renamed from: getTriangleStrip-c2xauaI, reason: not valid java name */
        public final int m3813getTriangleStripc2xauaI() {
            return VertexMode.TriangleStrip;
        }

        /* renamed from: getTriangleFan-c2xauaI, reason: not valid java name */
        public final int m3812getTriangleFanc2xauaI() {
            return VertexMode.TriangleFan;
        }
    }

    public String toString() {
        return m3810toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3810toStringimpl(int i) {
        return m3808equalsimpl0(i, Triangles) ? "Triangles" : m3808equalsimpl0(i, TriangleStrip) ? "TriangleStrip" : m3808equalsimpl0(i, TriangleFan) ? "TriangleFan" : "Unknown";
    }
}
