...
public interface PathEffect {
    ...
    public static final class Companion {
        ...
        public final PathEffect m3688stampedPathEffect7aD1DOk(Path shape, float advance, float phase, int style) {
            return AndroidPathEffect_androidKt.m3310actualStampedPathEffect7aD1DOk(shape, advance, phase, style);
        }
    }
}
