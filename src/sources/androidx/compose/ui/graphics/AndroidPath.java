...
public final class AndroidPath implements Path {
    ...
    public int mo3305getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.INSTANCE.m3696getEvenOddRgk1Os();
        }
        return PathFillType.INSTANCE.m3697getNonZeroRgk1Os();
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: setFillType-oQ8Xj4U, reason: not valid java name */
    public void mo3307setFillTypeoQ8Xj4U(int i) {
        Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m3692equalsimpl0(i, PathFillType.INSTANCE.m3696getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect) {
        ...
        fArr[0] = CornerRadius.m3148getXimpl(roundRect.m3223getTopLeftCornerRadiuskKHJgLs());
        fArr[1] = CornerRadius.m3149getYimpl(roundRect.m3223getTopLeftCornerRadiuskKHJgLs());
        fArr[2] = CornerRadius.m3148getXimpl(roundRect.m3224getTopRightCornerRadiuskKHJgLs());
        fArr[3] = CornerRadius.m3149getYimpl(roundRect.m3224getTopRightCornerRadiuskKHJgLs());
        fArr[4] = CornerRadius.m3148getXimpl(roundRect.m3222getBottomRightCornerRadiuskKHJgLs());
        fArr[5] = CornerRadius.m3149getYimpl(roundRect.m3222getBottomRightCornerRadiuskKHJgLs());
        fArr[6] = CornerRadius.m3148getXimpl(roundRect.m3221getBottomLeftCornerRadiuskKHJgLs());
        fArr[7] = CornerRadius.m3149getYimpl(roundRect.m3221getBottomLeftCornerRadiuskKHJgLs());
        android.graphics.Path path = this.internalPath;
        RectF rectF2 = this.rectF;
        Intrinsics.checkNotNull(rectF2);
    ...
    public void mo3304addPathUv8p0NA(Path path, long offset) {
        android.graphics.Path path2 = this.internalPath;
        if (path instanceof AndroidPath) {
            path2.addPath(((AndroidPath) path).getInternalPath(), Offset.m3173getXimpl(offset), Offset.m3174getYimpl(offset));
            return;
        }
    ...
    public void mo3309translatek4lQ0M(long offset) {
        ...
        matrix2.setTranslate(Offset.m3173getXimpl(offset), Offset.m3174getYimpl(offset));
        android.graphics.Path path = this.internalPath;
    ...
    public void mo3308transform58bKbWc(float[] matrix) {
    ...
    public boolean mo3306opN5in7k0(Path path1, Path path2, int operation) {
        Path.Op op;
        if (PathOperation.m3701equalsimpl0(operation, PathOperation.INSTANCE.m3705getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m3701equalsimpl0(operation, PathOperation.INSTANCE.m3706getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m3701equalsimpl0(operation, PathOperation.INSTANCE.m3707getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m3701equalsimpl0(operation, PathOperation.INSTANCE.m3708getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
