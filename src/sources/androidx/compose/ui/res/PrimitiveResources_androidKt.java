...
public final class PrimitiveResources_androidKt {
    ...
    public static final float dimensionResource(int i, Composer composer, int i2) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        float fM5735constructorimpl = Dp.m5735constructorimpl(((Context) objConsume).getResources().getDimension(i) / ((Density) objConsume2).getDensity());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return fM5735constructorimpl;
    }
}
