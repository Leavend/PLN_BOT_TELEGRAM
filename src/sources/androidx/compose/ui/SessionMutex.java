...
public final class SessionMutex<T> {
    ...
    public static final /* synthetic */ SessionMutex m3052boximpl(AtomicReference atomicReference) {
        return new SessionMutex(atomicReference);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static <T> AtomicReference<Session<T>> m3054constructorimpl(AtomicReference<Session<T>> atomicReference) {
        return atomicReference;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3055equalsimpl(AtomicReference<Session<T>> atomicReference, Object obj) {
    ...
    public static final boolean m3056equalsimpl0(AtomicReference<Session<T>> atomicReference, AtomicReference<Session<T>> atomicReference2) {
        return Intrinsics.areEqual(atomicReference, atomicReference2);
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3058hashCodeimpl(AtomicReference<Session<T>> atomicReference) {
        return atomicReference.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3059toStringimpl(AtomicReference<Session<T>> atomicReference) {
        return "SessionMutex(currentSessionHolder=" + atomicReference + ')';
    }

    public boolean equals(Object obj) {
        return m3055equalsimpl(this.currentSessionHolder, obj);
    }

    public int hashCode() {
        return m3058hashCodeimpl(this.currentSessionHolder);
    }

    public String toString() {
        return m3059toStringimpl(this.currentSessionHolder);
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> AtomicReference<Session<T>> m3053constructorimpl() {
        return m3054constructorimpl(new AtomicReference(null));
    }

    /* renamed from: getCurrentSession-impl, reason: not valid java name */
    public static final T m3057getCurrentSessionimpl(AtomicReference<Session<T>> atomicReference) {
    ...
    public static final <R> Object m3060withSessionCancellingPreviousimpl(AtomicReference<Session<T>> atomicReference, Function1<? super CoroutineScope, ? extends T> function1, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
