...
public final class BackwardsCompatNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode, PointerInputModifierNode, ModifierLocalModifierNode, ModifierLocalReadScope, ParentDataModifierNode, LayoutAwareModifierNode, GlobalPositionAwareModifierNode, FocusEventModifierNode, FocusPropertiesModifierNode, FocusRequesterModifierNode, OwnerScope, BuildDrawCacheParams {
    ...
    private final void unInitializeModifier() {
        ...
        if ((NodeKind.m4891constructorimpl(32) & backwardsCompatNode.getKindSet()) != 0) {
        ...
        if ((backwardsCompatNode.getKindSet() & NodeKind.m4891constructorimpl(8)) != 0) {
    ...
    private final void initializeModifier(boolean duringAttach) {
        ...
        if ((NodeKind.m4891constructorimpl(4) & backwardsCompatNode.getKindSet()) != 0) {
        ...
        if ((NodeKind.m4891constructorimpl(2) & backwardsCompatNode.getKindSet()) != 0) {
        ...
        if ((NodeKind.m4891constructorimpl(128) & backwardsCompatNode.getKindSet()) != 0) {
                    ...
                    DelegatableNodeKt.requireOwner(this).registerOnLayoutCompletedListener(new Owner.OnLayoutCompletedListener() { // from class: androidx.compose.ui.node.BackwardsCompatNode.initializeModifier.3
                        ...
                        public void onLayoutComplete() {
                            if (BackwardsCompatNode.this.lastOnPlacedCoordinates == null) {
                                ...
                                backwardsCompatNode2.onPlaced(DelegatableNodeKt.m4787requireCoordinator64DMado(backwardsCompatNode2, NodeKind.m4891constructorimpl(128)));
                            }
                        }
                    });
                }
        ...
        if (((NodeKind.m4891constructorimpl(256) & backwardsCompatNode.getKindSet()) != 0) && (element instanceof OnGloballyPositionedModifier) && BackwardsCompatNodeKt.isChainUpdate(this)) {
            DelegatableNodeKt.requireLayoutNode(this).invalidateMeasurements$ui_release();
        }
        if (element instanceof FocusRequesterModifier) {
            ((FocusRequesterModifier) element).getFocusRequester().getFocusRequesterNodes$ui_release().add(this);
        }
        if (((NodeKind.m4891constructorimpl(16) & backwardsCompatNode.getKindSet()) != 0) && (element instanceof PointerInputModifier)) {
            ((PointerInputModifier) element).getPointerInputFilter().setLayoutCoordinates$ui_release(getCoordinator());
        }
        if ((NodeKind.m4891constructorimpl(8) & backwardsCompatNode.getKindSet()) != 0) {
            DelegatableNodeKt.requireOwner(this).onSemanticsChange();
        }
    }
    ...
    public long mo3079getSizeNHjbRc() {
        return IntSizeKt.m5915toSizeozmzZPI(DelegatableNodeKt.m4787requireCoordinator64DMado(this, NodeKind.m4891constructorimpl(128)).mo4691getSizeYbymL2g());
    }
    ...
    public <T> T getCurrent(ModifierLocal<T> modifierLocal) {
        ...
        BackwardsCompatNode backwardsCompatNode = this;
        int iM4891constructorimpl = NodeKind.m4891constructorimpl(32);
    ...
    public MeasureResult mo90measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return ((LayoutModifier) element).mo63measure3p2s80s(measureScope, measurable, j);
    }
    ...
    public void mo181onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        ((PointerInputModifier) element).getPointerInputFilter().mo4582onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public void mo306onRemeasuredozmzZPI(long size) {
        ...
        if (element instanceof OnRemeasuredModifier) {
            ((OnRemeasuredModifier) element).mo4727onRemeasuredozmzZPI(size);
        }
    }
