...
public abstract class AlignmentLines {
    ...
    protected abstract long mo4772calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        while (true) {
            jOffset = mo4772calculatePositionInParentR5De75A(initialCoordinator, jOffset);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            iRoundToInt = MathKt.roundToInt(Offset.m3174getYimpl(jOffset));
        } else {
            iRoundToInt = MathKt.roundToInt(Offset.m3173getXimpl(jOffset));
        }
