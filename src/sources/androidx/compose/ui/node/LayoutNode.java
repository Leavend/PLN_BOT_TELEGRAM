...
public final class LayoutNode implements ComposeNodeLifecycleCallback, Remeasurement, OwnerScope, LayoutInfo, ComposeUiNode, InteroperableComposeUiNode, Owner.OnLayoutCompletedListener {
    ...
    private static final NoIntrinsicsMeasurePolicy ErrorMeasurePolicy = new NoIntrinsicsMeasurePolicy() { // from class: androidx.compose.ui.node.LayoutNode$Companion$ErrorMeasurePolicy$1
        ...
        public /* bridge */ /* synthetic */ MeasureResult mo37measure3p2s80s(MeasureScope measureScope, List list, long j) {
            return (MeasureResult) m4819measure3p2s80s(measureScope, (List<? extends Measurable>) list, j);
        }

        /* renamed from: measure-3p2s80s, reason: not valid java name */
        public Void m4819measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
    ...
    private static final ViewConfiguration DummyViewConfiguration = new ViewConfiguration() { // from class: androidx.compose.ui.node.LayoutNode$Companion$DummyViewConfiguration$1
        ...
        public long mo4818getMinimumTouchTargetSizeMYxV2XQ() {
            return DpSize.INSTANCE.m5843getZeroMYxV2XQ();
        }
    };
    ...
    public final SemanticsConfiguration getCollapsedSemantics$ui_release() {
        if (!this.nodes.m4854hasH91voCI$ui_release(NodeKind.m4891constructorimpl(8)) || this._collapsedSemantics != null) {
        ...
        LayoutNodeKt.requireOwner(this).getSnapshotObserver().observeSemanticsReads$ui_release(this, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNode$collapsedSemantics$1
            ...
            public final void invoke2() {
                ...
                int iM4891constructorimpl = NodeKind.m4891constructorimpl(8);
                Ref.ObjectRef<SemanticsConfiguration> objectRef2 = objectRef;
                if ((nodes.getAggregateChildKindSet() & iM4891constructorimpl) != 0) {
                    for (Modifier.Node tail = nodes.getTail(); tail != null; tail = tail.getParent()) {
                        if ((tail.getKindSet() & iM4891constructorimpl) != 0) {
    ...
    */
    ...
    public final void detach$ui_release() {
        ...
        if (this.nodes.m4854hasH91voCI$ui_release(NodeKind.m4891constructorimpl(8))) {
    ...
    public final boolean getHasFixedInnerContentConstraints$ui_release() {
        long jM4875getLastMeasurementConstraintsmsEJaDk$ui_release = getInnerCoordinator$ui_release().m4875getLastMeasurementConstraintsmsEJaDk$ui_release();
        return Constraints.m5689getHasFixedWidthimpl(jM4875getLastMeasurementConstraintsmsEJaDk$ui_release) && Constraints.m5688getHasFixedHeightimpl(jM4875getLastMeasurementConstraintsmsEJaDk$ui_release);
    }
    ...
    public static abstract class NoIntrinsicsMeasurePolicy implements MeasurePolicy {
        ...
        public /* bridge */ /* synthetic */ int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m4820maxIntrinsicHeight(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m4821maxIntrinsicWidth(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m4822minIntrinsicHeight(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m4823minIntrinsicWidth(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        /* renamed from: minIntrinsicWidth, reason: collision with other method in class */
        public Void m4823minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
            throw new IllegalStateException(this.error.toString());
        }

        /* renamed from: minIntrinsicHeight, reason: collision with other method in class */
        public Void m4822minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
            throw new IllegalStateException(this.error.toString());
        }

        /* renamed from: maxIntrinsicWidth, reason: collision with other method in class */
        public Void m4821maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
            throw new IllegalStateException(this.error.toString());
        }

        /* renamed from: maxIntrinsicHeight, reason: collision with other method in class */
        public Void m4820maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
            throw new IllegalStateException(this.error.toString());
        }
    }
    ...
    public void setDensity(Density density) {
        ...
        if ((nodeChain.getAggregateChildKindSet() & iM4891constructorimpl) != 0) {
            for (Modifier.Node head = nodeChain.getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & iM4891constructorimpl) != 0) {
                ...
                if ((head.getAggregateChildKindSet() & iM4891constructorimpl) == 0) {
                    return;
                }
            }
        }
    ...
    public void setCompositionLocalMap(CompositionLocalMap compositionLocalMap) {
        ...
        NodeChain nodeChain = this.nodes;
        int iM4891constructorimpl = NodeKind.m4891constructorimpl(32768);
        if ((nodeChain.getAggregateChildKindSet() & iM4891constructorimpl) != 0) {
            for (Modifier.Node head = nodeChain.getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & iM4891constructorimpl) != 0) {
                    DelegatingNode delegatingNodePop = head;
    ...
    public void setModifier(Modifier modifier) {
        ...
        if (this.nodes.m4854hasH91voCI$ui_release(NodeKind.m4891constructorimpl(512)) && this.lookaheadRoot == null) {
    ...
    public static /* synthetic */ void m4810hitTestM_7yMNQ$ui_release$default(LayoutNode layoutNode, long j, HitTestResult hitTestResult, boolean z, boolean z2, int i, Object obj) {
        if ((i & 4) != 0) {
            z = false;
        }
        boolean z3 = z;
        ...
        layoutNode.m4814hitTestM_7yMNQ$ui_release(j, hitTestResult, z3, z2);
    }

    /* renamed from: hitTest-M_7yMNQ$ui_release, reason: not valid java name */
    public final void m4814hitTestM_7yMNQ$ui_release(long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        getOuterCoordinator$ui_release().m4878hitTestYqVAtuI(NodeCoordinator.INSTANCE.getPointerInputSource(), getOuterCoordinator$ui_release().m4874fromParentPositionMKHz9U(pointerPosition), hitTestResult, isTouchEvent, isInLayer);
    }

    /* renamed from: hitTestSemantics-M_7yMNQ$ui_release, reason: not valid java name */
    public final void m4815hitTestSemanticsM_7yMNQ$ui_release(long pointerPosition, HitTestResult hitSemanticsEntities, boolean isTouchEvent, boolean isInLayer) {
        getOuterCoordinator$ui_release().m4878hitTestYqVAtuI(NodeCoordinator.INSTANCE.getSemanticsSource(), getOuterCoordinator$ui_release().m4874fromParentPositionMKHz9U(pointerPosition), hitSemanticsEntities, true, isInLayer);
    }
    ...
    private final void invalidateFocusOnAttach() {
        if (this.nodes.has$ui_release(NodeKind.m4891constructorimpl(1024) | NodeKind.m4891constructorimpl(2048) | NodeKind.m4891constructorimpl(4096))) {
            for (Modifier.Node head = this.nodes.getHead(); head != null; head = head.getChild()) {
                if (((NodeKind.m4891constructorimpl(1024) & head.getKindSet()) != 0) | ((NodeKind.m4891constructorimpl(2048) & head.getKindSet()) != 0) | ((NodeKind.m4891constructorimpl(4096) & head.getKindSet()) != 0)) {
    ...
    public final void dispatchOnPositionedCallbacks$ui_release() {
        ...
        NodeChain nodeChain = this.nodes;
        int iM4891constructorimpl = NodeKind.m4891constructorimpl(256);
        if ((nodeChain.getAggregateChildKindSet() & iM4891constructorimpl) != 0) {
            for (Modifier.Node head = nodeChain.getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & iM4891constructorimpl) != 0) {
                    DelegatingNode delegatingNodePop = head;
                    ...
                    while (delegatingNodePop != 0) {
                        if (delegatingNodePop instanceof GlobalPositionAwareModifierNode) {
                            ...
                            globalPositionAwareModifierNode.onGloballyPositioned(DelegatableNodeKt.m4787requireCoordinator64DMado(globalPositionAwareModifierNode, NodeKind.m4891constructorimpl(256)));
                        } else if (((delegatingNodePop.getKindSet() & iM4891constructorimpl) != 0) && (delegatingNodePop instanceof DelegatingNode)) {
                            Modifier.Node delegate$ui_release = delegatingNodePop.getDelegate();
                            int i = 0;
                            delegatingNodePop = delegatingNodePop;
    ...
    public static /* synthetic */ boolean m4812lookaheadRemeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m4831getLastLookaheadConstraintsDWUhwKw();
        }
        return layoutNode.m4816lookaheadRemeasure_Sx5XlM$ui_release(constraints);
    }

    /* renamed from: lookaheadRemeasure-_Sx5XlM$ui_release, reason: not valid java name */
    public final boolean m4816lookaheadRemeasure_Sx5XlM$ui_release(Constraints constraints) {
        if (constraints == null || this.lookaheadRoot == null) {
            return false;
        }
        LayoutNodeLayoutDelegate.LookaheadPassDelegate lookaheadPassDelegate$ui_release = getLookaheadPassDelegate$ui_release();
        Intrinsics.checkNotNull(lookaheadPassDelegate$ui_release);
        return lookaheadPassDelegate$ui_release.m4834remeasureBRTryo0(constraints.getValue());
    }

    /* renamed from: remeasure-_Sx5XlM$ui_release$default, reason: not valid java name */
    public static /* synthetic */ boolean m4813remeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m4830getLastConstraintsDWUhwKw();
        }
        return layoutNode.m4817remeasure_Sx5XlM$ui_release(constraints);
    }

    /* renamed from: remeasure-_Sx5XlM$ui_release, reason: not valid java name */
    public final boolean m4817remeasure_Sx5XlM$ui_release(Constraints constraints) {
        if (constraints == null) {
            return false;
        }
        if (this.intrinsicsUsageByParent == UsageByParent.NotUsed) {
        ...
        return getMeasurePassDelegate$ui_release().m4837remeasureBRTryo0(constraints.getValue());
    }
                ...
                if ((head.getKindSet() & iM4891constructorimpl) != 0) {
                    ...
                    while (delegatingNodePop != 0) {
                        if (delegatingNodePop instanceof LayoutModifierNode) {
                            OwnedLayer layer = DelegatableNodeKt.m4787requireCoordinator64DMado((LayoutModifierNode) delegatingNodePop, NodeKind.m4891constructorimpl(2)).getLayer();
                            if (layer != null) {
                                layer.invalidate();
                            }
                        } else if (((delegatingNodePop.getKindSet() & iM4891constructorimpl) != 0) && (delegatingNodePop instanceof DelegatingNode)) {
    ...
    public void forceRemeasure() {
        ...
        Constraints constraintsM4830getLastConstraintsDWUhwKw = this.layoutDelegate.m4830getLastConstraintsDWUhwKw();
        if (constraintsM4830getLastConstraintsDWUhwKw != null) {
            Owner owner = this.owner;
            if (owner != null) {
                owner.mo4947measureAndLayout0kLqBqw(this, constraintsM4830getLastConstraintsDWUhwKw.getValue());
                return;
            }
            return;
        }
    ...
    public void onLayoutComplete() {
        ...
        for (Modifier.Node nodeHeadNode = innerCoordinator$ui_release.headNode(zM4900getIncludeSelfInTraversalH91voCI); nodeHeadNode != null && (nodeHeadNode.getAggregateChildKindSet() & iM4891constructorimpl) != 0; nodeHeadNode = nodeHeadNode.getChild()) {
    ...
    private final boolean shouldInvalidateParentLayer() {
        if (this.nodes.m4854hasH91voCI$ui_release(NodeKind.m4891constructorimpl(4)) && !this.nodes.m4854hasH91voCI$ui_release(NodeKind.m4891constructorimpl(2))) {
            return true;
        }
        for (Modifier.Node head = this.nodes.getHead(); head != null; head = head.getChild()) {
            if (((NodeKind.m4891constructorimpl(2) & head.getKindSet()) != 0) && DelegatableNodeKt.m4787requireCoordinator64DMado(head, NodeKind.m4891constructorimpl(2)).getLayer() != null) {
                return false;
            }
            if ((NodeKind.m4891constructorimpl(4) & head.getKindSet()) != 0) {
                return true;
            }
        }
        return true;
