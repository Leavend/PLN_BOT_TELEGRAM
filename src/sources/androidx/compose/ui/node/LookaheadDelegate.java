...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public void m4844setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public final void set_measureResult(MeasureResult measureResult) {
        Unit unit;
        if (measureResult != null) {
            m4733setMeasuredSizeozmzZPI(IntSizeKt.IntSize(measureResult.getWidth(), measureResult.getHeight()));
            unit = Unit.INSTANCE;
        } else {
            unit = null;
        }
        if (unit == null) {
            m4733setMeasuredSizeozmzZPI(IntSize.INSTANCE.m5910getZeroYbymL2g());
        }
    ...
    public void replace$ui_release() {
        mo4685placeAtf8xVGno(getPosition(), 0.0f, null);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // androidx.compose.ui.layout.Placeable
    /* renamed from: placeAt-f8xVGno */
    public final void mo4685placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        m4840placeSelfgyyYBs(position);
    ...
    private final void m4840placeSelfgyyYBs(long position) {
        if (IntOffset.m5862equalsimpl0(getPosition(), position)) {
            return;
        }
        m4844setPositiongyyYBs(position);
    ...
    public final void m4842placeSelfApparentToRealOffsetgyyYBs$ui_release(long position) {
        long j = getApparentToRealOffset();
        m4840placeSelfgyyYBs(IntOffsetKt.IntOffset(IntOffset.m5863getXimpl(position) + IntOffset.m5863getXimpl(j), IntOffset.m5864getYimpl(position) + IntOffset.m5864getYimpl(j)));
    }
    ...
    public final Placeable m4841performingMeasureK40F9xA(long constraints, Function0<? extends MeasureResult> block) {
    ...
    public final long m4843positionInBjo55l4$ui_release(LookaheadDelegate ancestor) {
        long jM5873getZeronOccac = IntOffset.INSTANCE.m5873getZeronOccac();
        ...
        while (!Intrinsics.areEqual(lookaheadDelegate, ancestor)) {
            ...
            jM5873getZeronOccac = IntOffsetKt.IntOffset(IntOffset.m5863getXimpl(jM5873getZeronOccac) + IntOffset.m5863getXimpl(position), IntOffset.m5864getYimpl(jM5873getZeronOccac) + IntOffset.m5864getYimpl(position));
