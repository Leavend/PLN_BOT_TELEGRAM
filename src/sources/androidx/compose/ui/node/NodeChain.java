...
public final class NodeChain {
    ...
    public final void propagateCoordinator(Modifier.Node start, NodeCoordinator coordinator) {
        for (Modifier.Node parent = start.getParent(); parent != null; parent = parent.getParent()) {
            if (parent == NodeChainKt.SentinelHead) {
                ...
                if ((NodeKind.m4891constructorimpl(2) & parent.getKindSet()) != 0) {
                    return;
                }
    ...
    private final class Differ implements DiffCallback {
        ...
        public void remove(int atIndex, int oldIndex) {
            ...
            Logger logger = NodeChain.this.logger;
            if (logger != null) {
                logger.nodeRemoved(oldIndex, this.before.getContent()[this.offset + oldIndex], child);
            }
            if ((NodeKind.m4891constructorimpl(2) & child.getKindSet()) != 0) {
                NodeCoordinator coordinator = child.getCoordinator();
                Intrinsics.checkNotNull(coordinator);
    ...
    public final boolean m4854hasH91voCI$ui_release(int type) {
    ...
    public final /* synthetic */ <T> T m4853firstFromHeadaLcG6gQ$ui_release(int type, Function1<? super T, Boolean> block) {
    ...
    public final /* synthetic */ <T> void m4856headToTailaLcG6gQ$ui_release(int type, Function1<? super T, Unit> block) {
        if ((getAggregateChildKindSet() & type) != 0) {
            for (Modifier.Node head = getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & type) != 0) {
                    Modifier.Node nodePop = head;
    ...
    public final /* synthetic */ <T> void m4858tailToHeadaLcG6gQ$ui_release(int type, Function1<? super T, Unit> block) {
        if ((getAggregateChildKindSet() & type) != 0) {
            for (Modifier.Node tail = getTail(); tail != null; tail = tail.getParent()) {
    ...
    public final /* synthetic */ <T> T m4857tailH91voCI$ui_release(int type) {
        if ((getAggregateChildKindSet() & type) != 0) {
            for (Modifier.Node tail = getTail(); tail != null; tail = tail.getParent()) {
                if ((tail.getKindSet() & type) != 0) {
                    Object obj = (T) tail;
    ...
    public final /* synthetic */ <T> T m4855headH91voCI$ui_release(int type) {
        if ((getAggregateChildKindSet() & type) != 0) {
            for (Modifier.Node head = getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & type) != 0) {
                    Object obj = (T) head;
