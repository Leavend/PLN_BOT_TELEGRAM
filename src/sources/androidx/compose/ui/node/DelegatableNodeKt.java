...
public final class DelegatableNodeKt {
    ...
    public static final /* synthetic */ <T> void m4793visitSelfAndAncestors5BbP62I(DelegatableNode delegatableNode, int i, int i2, Function1<? super T, Unit> function1) {
        NodeChain nodes;
        Modifier.Node node = delegatableNode.getNode();
        int i3 = i | i2;
        if (!delegatableNode.getNode().getIsAttached()) {
    ...
    public static final /* synthetic */ <T> void m4794visitSelfAndChildren6rFNWt0(DelegatableNode delegatableNode, int i, Function1<? super T, Unit> function1) {
        Modifier.Node node = delegatableNode.getNode();
        MutableVector mutableVector = null;
        while (node != null) {
            Intrinsics.reifiedOperationMarker(3, ExifInterface.GPS_DIRECTION_TRUE);
    ...
    public static final NodeCoordinator m4787requireCoordinator64DMado(DelegatableNode delegatableNode, int i) {
        ...
        if (coordinator.getTail() != delegatableNode || !NodeKindKt.m4900getIncludeSelfInTraversalH91voCI(i)) {
            return coordinator;
        }
    ...
    public static final /* synthetic */ <T> void m4784dispatchForKind6rFNWt0(Modifier.Node node, int i, Function1<? super T, Unit> function1) {
        MutableVector mutableVector = null;
        while (node != null) {
            Intrinsics.reifiedOperationMarker(3, ExifInterface.GPS_DIRECTION_TRUE);
            if (node instanceof Object) {
    ...
    public static final /* synthetic */ <T> void m4792visitLocalDescendants6rFNWt0(DelegatableNode delegatableNode, int i, Function1<? super T, Unit> function1) {
        if (!delegatableNode.getNode().getIsAttached()) {
            throw new IllegalStateException("visitLocalDescendants called on an unattached node".toString());
        }
        Modifier.Node node = delegatableNode.getNode();
    ...
    public static final /* synthetic */ <T> void m4791visitLocalAncestors6rFNWt0(DelegatableNode delegatableNode, int i, Function1<? super T, Unit> function1) {
        if (!delegatableNode.getNode().getIsAttached()) {
            throw new IllegalStateException("visitLocalAncestors called on an unattached node".toString());
        }
        for (Modifier.Node parent = delegatableNode.getNode().getParent(); parent != null; parent = parent.getParent()) {
    ...
    public static final /* synthetic */ <T> void m4788visitAncestorsYYKmho(DelegatableNode delegatableNode, int i, boolean z, Function1<? super T, Unit> function1) {
        NodeChain nodes;
        if (!delegatableNode.getNode().getIsAttached()) {
            throw new IllegalStateException("visitAncestors called on an unattached node".toString());
        }
    ...
    public static /* synthetic */ void m4789visitAncestorsYYKmho$default(DelegatableNode delegatableNode, int i, boolean z, Function1 function1, int i2, Object obj) {
        NodeChain nodes;
        if ((i2 & 2) != 0) {
            z = false;
        }
    ...
    public static final /* synthetic */ <T> List<T> m4783ancestors64DMado(DelegatableNode delegatableNode, int i) {
        NodeChain nodes;
        if (!delegatableNode.getNode().getIsAttached()) {
            throw new IllegalStateException("visitAncestors called on an unattached node".toString());
        }
    ...
    public static final /* synthetic */ <T> void m4795visitSubtree6rFNWt0(DelegatableNode delegatableNode, int i, Function1<? super T, Unit> function1) {
        if (!delegatableNode.getNode().getIsAttached()) {
            throw new IllegalStateException("visitSubtree called on an unattached node".toString());
        }
        Modifier.Node child = delegatableNode.getNode().getChild();
    ...
    public static final /* synthetic */ <T> void m4790visitChildren6rFNWt0(DelegatableNode delegatableNode, int i, Function1<? super T, Unit> function1) {
        if (!delegatableNode.getNode().getIsAttached()) {
            throw new IllegalStateException("visitChildren called on an unattached node".toString());
        }
        MutableVector mutableVector = new MutableVector(new Modifier.Node[16], 0);
    ...
    public static final /* synthetic */ <T> void m4796visitSubtreeIf6rFNWt0(DelegatableNode delegatableNode, int i, Function1<? super T, Boolean> function1) {
        boolean z;
        if (!delegatableNode.getNode().getIsAttached()) {
            throw new IllegalStateException("visitSubtreeIf called on an unattached node".toString());
        }
    ...
    public static final LayoutModifierNode asLayoutModifierNode(Modifier.Node node) {
        if (!((NodeKind.m4891constructorimpl(2) & node.getKindSet()) != 0)) {
            return null;
        }
        ...
        if (node instanceof DelegatingNode) {
            ...
            while (delegate$ui_release != 0) {
                ...
                if (delegate$ui_release instanceof DelegatingNode) {
                    if ((NodeKind.m4891constructorimpl(2) & delegate$ui_release.getKindSet()) != 0) {
