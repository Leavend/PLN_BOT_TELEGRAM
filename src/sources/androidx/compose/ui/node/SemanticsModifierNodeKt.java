...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(Modifier.Node node, boolean z) {
        ...
        if (!z) {
            return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m4787requireCoordinator64DMado(node, NodeKind.m4891constructorimpl(8)));
        }
        return DelegatableNodeKt.m4787requireCoordinator64DMado(node, NodeKind.m4891constructorimpl(8)).touchBoundsInRoot();
    }
}
