...
public final class InnerNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateImpl extends LookaheadDelegate {
        ...
        public Placeable mo4684measureBRTryo0(long constraints) {
            ...
            lookaheadDelegateImpl.m4734setMeasurementConstraintsBRTryo0(constraints);
            ...
            lookaheadDelegateImpl.set_measureResult(getLayoutNode().getMeasurePolicy().mo37measure3p2s80s(this, getLayoutNode().getChildLookaheadMeasurables$ui_release(), constraints));
    ...
    public Placeable mo4684measureBRTryo0(long constraints) {
        ...
        setMeasureResult$ui_release(getLayoutNode().getMeasurePolicy().mo37measure3p2s80s(this, getLayoutNode().getChildMeasurables$ui_release(), constraints));
        onMeasured();
        return this;
    }
    ...
    protected void mo4685placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        super.mo4685placeAtf8xVGno(position, zIndex, layerBlock);
    ...
    /* JADX WARN: Removed duplicated region for block: B:38:0x0094 A[EDGE_INSN: B:38:0x0094->B:36:0x0094 BREAK  A[LOOP:0: B:21:0x0058->B:40:?], SYNTHETIC] */
    @Override // androidx.compose.ui.node.NodeCoordinator
    ...
    */
    public void mo4808hitTestChildYqVAtuI(androidx.compose.ui.node.NodeCoordinator.HitTestSource r19, long r20, androidx.compose.ui.node.HitTestResult r22, boolean r23, boolean r24) {
        /*
            r18 = this;
            r0 = r18
            r8 = r20
            ...
            r12 = 0
            if (r1 == 0) goto L3a
            boolean r1 = r0.m4885withinLayerBoundsk4lQ0M(r8)
            if (r1 == 0) goto L1c
            r13 = r24
            r1 = r11
            goto L3d
        L1c:
            if (r23 == 0) goto L3a
            long r1 = r18.m4876getMinimumTouchTargetSizeNHjbRc()
            float r1 = r0.m4873distanceInMinimumTouchTargettz77jQw(r8, r1)
        ...
        L58:
            ...
            r6 = r23
            r7 = r13
            r1.mo4886childHitTestYqVAtuI(r2, r3, r5, r6, r7)
        ...
        L99:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.node.InnerNodeCoordinator.mo4808hitTestChildYqVAtuI(androidx.compose.ui.node.NodeCoordinator$HitTestSource, long, androidx.compose.ui.node.HitTestResult, boolean, boolean):void");
    }
    ...
    static {
        ...
        Paint.mo3293setColor8_81llA(Color.INSTANCE.m3448getRed0d7_KjU());
