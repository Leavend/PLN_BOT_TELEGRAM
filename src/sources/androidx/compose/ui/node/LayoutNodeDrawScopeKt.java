...
public final class LayoutNodeDrawScopeKt {
    ...
    public static final Modifier.Node nextDrawNode(DelegatableNode delegatableNode) {
        ...
        int iM4891constructorimpl2 = NodeKind.m4891constructorimpl(2);
        Modifier.Node child = delegatableNode.getNode().getChild();
        if (child == null || (child.getAggregateChildKindSet() & iM4891constructorimpl) == 0) {
            return null;
        }
        while (child != null && (child.getKindSet() & iM4891constructorimpl2) == 0) {
