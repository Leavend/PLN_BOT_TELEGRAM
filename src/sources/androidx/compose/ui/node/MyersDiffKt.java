...
public final class MyersDiffKt {
    private static final IntStack calculateDiff(int i, int i2, DiffCallback diffCallback) {
        ...
        int i4 = (i3 * 2) + 1;
        int[] iArrM4774constructorimpl = CenteredArray.m4774constructorimpl(new int[i4]);
        int[] iArrM4774constructorimpl2 = CenteredArray.m4774constructorimpl(new int[i4]);
        int[] iArrM4951constructorimpl = Snake.m4951constructorimpl(new int[5]);
        while (intStack2.isNotEmpty()) {
            int iPop = intStack2.pop();
            int iPop2 = intStack2.pop();
            int iPop3 = intStack2.pop();
            int iPop4 = intStack2.pop();
            int[] iArr = iArrM4774constructorimpl;
            int[] iArr2 = iArrM4774constructorimpl2;
            if (m4852midPointq5eDKzI(iPop4, iPop3, iPop2, iPop, diffCallback, iArrM4774constructorimpl, iArrM4774constructorimpl2, iArrM4951constructorimpl)) {
                if (Snake.m4954getDiagonalSizeimpl(iArrM4951constructorimpl) > 0) {
                    Snake.m4949addDiagonalToStackimpl(iArrM4951constructorimpl, intStack);
                }
                intStack2.pushRange(iPop4, Snake.m4959getStartXimpl(iArrM4951constructorimpl), iPop2, Snake.m4960getStartYimpl(iArrM4951constructorimpl));
                intStack2.pushRange(Snake.m4955getEndXimpl(iArrM4951constructorimpl), iPop3, Snake.m4956getEndYimpl(iArrM4951constructorimpl), iPop);
            }
            iArrM4774constructorimpl = iArr;
            iArrM4774constructorimpl2 = iArr2;
        }
    ...
    private static final boolean m4852midPointq5eDKzI(int i, int i2, int i3, int i4, DiffCallback diffCallback, int[] iArr, int[] iArr2, int[] iArr3) {
        int i5 = i2 - i;
        int i6 = i4 - i3;
        if (i5 >= 1 && i6 >= 1) {
            int i7 = ((i5 + i6) + 1) / 2;
            CenteredArray.m4780setimpl(iArr, 1, i);
            CenteredArray.m4780setimpl(iArr2, 1, i2);
            int i8 = 0;
            while (i8 < i7) {
                int i9 = i8;
                if (m4851forward4l5_RBY(i, i2, i3, i4, diffCallback, iArr, iArr2, i8, iArr3) || m4850backward4l5_RBY(i, i2, i3, i4, diffCallback, iArr, iArr2, i9, iArr3)) {
                    return true;
                }
                i8 = i9 + 1;
            }
    ...
    private static final boolean m4851forward4l5_RBY(int i, int i2, int i3, int i4, DiffCallback diffCallback, int[] iArr, int[] iArr2, int i5, int[] iArr3) {
        int iM4777getimpl;
        int i6;
        int i7;
        int i8 = (i2 - i) - (i4 - i3);
        ...
        for (int i10 = i9; i10 <= i5; i10 += 2) {
            if (i10 == i9 || (i10 != i5 && CenteredArray.m4777getimpl(iArr, i10 + 1) > CenteredArray.m4777getimpl(iArr, i10 - 1))) {
                iM4777getimpl = CenteredArray.m4777getimpl(iArr, i10 + 1);
                i6 = iM4777getimpl;
            } else {
                iM4777getimpl = CenteredArray.m4777getimpl(iArr, i10 - 1);
                i6 = iM4777getimpl + 1;
            ...
            int i11 = (i3 + (i6 - i)) - i10;
            int i12 = (i5 == 0 || i6 != iM4777getimpl) ? i11 : i11 - 1;
            while (i6 < i2 && i11 < i4) {
            ...
            CenteredArray.m4780setimpl(iArr, i10, i6);
            if (z && (i7 = i8 - i10) >= i9 + 1 && i7 <= i5 - 1) {
                if (CenteredArray.m4777getimpl(iArr2, i7) <= i6) {
                    fillSnake(iM4777getimpl, i12, i6, i11, false, iArr3);
                    return true;
                }
            }
        }
    ...
    private static final boolean m4850backward4l5_RBY(int i, int i2, int i3, int i4, DiffCallback diffCallback, int[] iArr, int[] iArr2, int i5, int[] iArr3) {
        int iM4777getimpl;
        int i6;
        int i7;
        int i8 = (i2 - i) - (i4 - i3);
        ...
        int i9 = -i5;
        for (int i10 = i9; i10 <= i5; i10 += 2) {
            if (i10 == i9 || (i10 != i5 && CenteredArray.m4777getimpl(iArr2, i10 + 1) < CenteredArray.m4777getimpl(iArr2, i10 - 1))) {
                iM4777getimpl = CenteredArray.m4777getimpl(iArr2, i10 + 1);
                i6 = iM4777getimpl;
            } else {
                iM4777getimpl = CenteredArray.m4777getimpl(iArr2, i10 - 1);
                i6 = iM4777getimpl - 1;
            ...
            CenteredArray.m4780setimpl(iArr2, i10, i6);
            if (z && (i7 = i8 - i10) >= i9 && i7 <= i5) {
                if (CenteredArray.m4777getimpl(iArr, i7) >= i6) {
                    fillSnake(i6, i11, iM4777getimpl, i12, true, iArr3);
                    return true;
                }
            }
        }
