...
public final class LayoutModifierNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateForLayoutModifierNode extends LookaheadDelegate {
        ...
        public Placeable mo4684measureBRTryo0(long constraints) {
            ...
            lookaheadDelegateForLayoutModifierNode.m4734setMeasurementConstraintsBRTryo0(constraints);
            layoutModifierNodeCoordinator.lookaheadConstraints = Constraints.m5679boximpl(constraints);
    ...
    public Placeable mo4684measureBRTryo0(long constraints) {
        ...
        if (layoutModifierNode instanceof IntermediateLayoutModifierNode) {
            ...
            measureResultMo90measure3p2s80s = ((IntermediateLayoutModifierNode) layoutModifierNode).m4686intermediateMeasureTeuZzU(this, wrappedNonNull, constraints, jIntSize, constraints2.getValue());
        } else {
            measureResultMo90measure3p2s80s = layoutModifierNode.mo90measure3p2s80s(this, getWrappedNonNull(), constraints);
        }
    ...
    static {
        ...
        Paint.mo3293setColor8_81llA(Color.INSTANCE.m3441getBlue0d7_KjU());
