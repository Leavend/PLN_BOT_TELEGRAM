...
public final /* data */ class BiasAlignment implements Alignment {
    ...
    public long mo3050alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        float f;
        float fM5905getWidthimpl = (IntSize.m5905getWidthimpl(space) - IntSize.m5905getWidthimpl(size)) / 2.0f;
        float fM5904getHeightimpl = (IntSize.m5904getHeightimpl(space) - IntSize.m5904getHeightimpl(size)) / 2.0f;
        ...
        float f2 = 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt(fM5905getWidthimpl * (f + f2)), MathKt.roundToInt(fM5904getHeightimpl * (f2 + this.verticalBias)));
    }
