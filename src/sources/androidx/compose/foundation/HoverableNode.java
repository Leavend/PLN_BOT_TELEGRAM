...
final class HoverableNode extends Modifier.Node implements PointerInputModifierNode {
    ...
    public void mo181onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        if (pass == PointerEventPass.Main) {
            ...
            if (PointerEventType.m4507equalsimpl0(type, PointerEventType.INSTANCE.m4511getEnter7fucELk())) {
            ...
            } else if (PointerEventType.m4507equalsimpl0(type, PointerEventType.INSTANCE.m4512getExit7fucELk())) {
