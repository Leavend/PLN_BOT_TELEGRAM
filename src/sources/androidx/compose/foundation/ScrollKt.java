...
public final class ScrollKt {
    public static final ScrollState rememberScrollState(final int i, Composer composer, int i2, int i3) {
        ...
        ScrollState scrollState = (ScrollState) RememberSaveableKt.m3031rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) objRememberedValue, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
                        ...
                        if (z6) {
                            ...
                            SemanticsPropertiesKt.scrollBy$default(semanticsPropertyReceiver, null, new Function2<Float, Float, Boolean>() { // from class: androidx.compose.foundation.ScrollKt$scroll$2$semantics$1.1
                                ...
                                public final Boolean invoke(float f, float f2) {
                                    BuildersKt__Builders_commonKt.launch$default(coroutineScope2, null, null, new C00141(z7, scrollState5, f2, f, null), 3, null);
                                    return true;
                                }
                            }, 1, null);
                        }
