...
final class OffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m529setX0680j_4(float f) {
        this.x = f;
    }
    ...
    public final void m530setY0680j_4(float f) {
        this.y = f;
    }
    ...
    public MeasureResult mo90measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, placeableMo4684measureBRTryo0.getWidth(), placeableMo4684measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                if (this.this$0.getRtlAware()) {
                    Placeable.PlacementScope.placeRelative$default(placementScope, placeableMo4684measureBRTryo0, measureScope.mo310roundToPx0680j_4(this.this$0.getX()), measureScope.mo310roundToPx0680j_4(this.this$0.getY()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default(placementScope, placeableMo4684measureBRTryo0, measureScope.mo310roundToPx0680j_4(this.this$0.getX()), measureScope.mo310roundToPx0680j_4(this.this$0.getY()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }
