...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public void update(UnspecifiedConstraintsNode node) {
        node.m636setMinWidth0680j_4(this.minWidth);
        node.m635setMinHeight0680j_4(this.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        inspectorInfo.setName("defaultMinSize");
        inspectorInfo.getProperties().set("minWidth", Dp.m5733boximpl(this.minWidth));
        inspectorInfo.getProperties().set("minHeight", Dp.m5733boximpl(this.minHeight));
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5740equalsimpl0(this.minWidth, unspecifiedConstraintsElement.minWidth) && Dp.m5740equalsimpl0(this.minHeight, unspecifiedConstraintsElement.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (Dp.m5741hashCodeimpl(this.minWidth) * 31) + Dp.m5741hashCodeimpl(this.minHeight);
    }
}
