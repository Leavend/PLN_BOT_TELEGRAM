...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo37measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default(measureScope, Constraints.m5689getHasFixedWidthimpl(j) ? Constraints.m5691getMaxWidthimpl(j) : 0, Constraints.m5688getHasFixedHeightimpl(j) ? Constraints.m5690getMaxHeightimpl(j) : 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$measure$1$1
