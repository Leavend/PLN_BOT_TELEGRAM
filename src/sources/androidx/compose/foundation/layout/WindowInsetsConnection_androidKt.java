...
public final class WindowInsetsConnection_androidKt {
    ...
    public static final Modifier imeNestedScroll(Modifier modifier) {
        ...
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.WindowInsetsConnection_androidKt$imeNestedScroll$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier modifier2, Composer composer, int i) {
                ...
                Modifier modifierNestedScroll$default = NestedScrollModifierKt.nestedScroll$default(modifier2, WindowInsetsConnection_androidKt.m637rememberWindowInsetsConnectionVRgvIgI(WindowInsetsHolder.INSTANCE.current(composer, 8).getIme(), WindowInsetsSides.INSTANCE.m659getBottomJoeWqyM(), composer, 48), null, 2, null);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public static final NestedScrollConnection m637rememberWindowInsetsConnectionVRgvIgI(AndroidWindowInsets androidWindowInsets, int i, Composer composer, int i2) {
        ...
        SideCalculator sideCalculatorM597chooseCalculatorni1skBw = SideCalculator.INSTANCE.m597chooseCalculatorni1skBw(i, (LayoutDirection) objConsume);
        ...
        Object[] objArr = {androidWindowInsets, view, sideCalculatorM597chooseCalculatorni1skBw, density};
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new WindowInsetsNestedScrollConnection(androidWindowInsets, view, sideCalculatorM597chooseCalculatorni1skBw, density);
