...
abstract class IntrinsicSizeModifier extends Modifier.Node implements LayoutModifierNode {
    ...
    public abstract long mo519calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j);
    ...
    public final MeasureResult mo90measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        long jMo519calculateContentConstraintsl58MMJ0 = mo519calculateContentConstraintsl58MMJ0(measureScope, measurable, j);
        if (getEnforceIncoming()) {
            jMo519calculateContentConstraintsl58MMJ0 = ConstraintsKt.m5703constrainN9IONVI(j, jMo519calculateContentConstraintsl58MMJ0);
        }
        final Placeable placeableMo4684measureBRTryo0 = measurable.mo4684measureBRTryo0(jMo519calculateContentConstraintsl58MMJ0);
        return MeasureScope.layout$default(measureScope, placeableMo4684measureBRTryo0.getWidth(), placeableMo4684measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.IntrinsicSizeModifier$measure$1
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m4736placeRelative70tqf50$default(placementScope, placeableMo4684measureBRTryo0, IntOffset.INSTANCE.m5873getZeronOccac(), 0.0f, 2, null);
            }
        }, 4, null);
    }
