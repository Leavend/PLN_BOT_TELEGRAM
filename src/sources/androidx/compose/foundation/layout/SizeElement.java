...
final class SizeElement extends ModifierNodeElement<SizeNode> {
    ...
    public /* synthetic */ SizeElement(float f, float f2, float f3, float f4, boolean z, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.INSTANCE.m5755getUnspecifiedD9Ej5fM() : f, (i & 2) != 0 ? Dp.INSTANCE.m5755getUnspecifiedD9Ej5fM() : f2, (i & 4) != 0 ? Dp.INSTANCE.m5755getUnspecifiedD9Ej5fM() : f3, (i & 8) != 0 ? Dp.INSTANCE.m5755getUnspecifiedD9Ej5fM() : f4, z, function1, null);
    }
    ...
    public void update(SizeNode node) {
        node.m630setMinWidth0680j_4(this.minWidth);
        node.m629setMinHeight0680j_4(this.minHeight);
        node.m628setMaxWidth0680j_4(this.maxWidth);
        node.m627setMaxHeight0680j_4(this.maxHeight);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5740equalsimpl0(this.minWidth, sizeElement.minWidth) && Dp.m5740equalsimpl0(this.minHeight, sizeElement.minHeight) && Dp.m5740equalsimpl0(this.maxWidth, sizeElement.maxWidth) && Dp.m5740equalsimpl0(this.maxHeight, sizeElement.maxHeight) && this.enforceIncoming == sizeElement.enforceIncoming;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((Dp.m5741hashCodeimpl(this.minWidth) * 31) + Dp.m5741hashCodeimpl(this.minHeight)) * 31) + Dp.m5741hashCodeimpl(this.maxWidth)) * 31) + Dp.m5741hashCodeimpl(this.maxHeight)) * 31) + Boolean.hashCode(this.enforceIncoming);
    }
}
