...
final class AlignmentLineOffsetDpElement extends ModifierNodeElement<AlignmentLineOffsetDpNode> {
    ...
    private AlignmentLineOffsetDpElement(AlignmentLine alignmentLine, float f, float f2, Function1<? super InspectorInfo, Unit> function1) {
        ...
        if (!((f >= 0.0f || Dp.m5740equalsimpl0(f, Dp.INSTANCE.m5755getUnspecifiedD9Ej5fM())) && (f2 >= 0.0f || Dp.m5740equalsimpl0(f2, Dp.INSTANCE.m5755getUnspecifiedD9Ej5fM())))) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetDpElement.alignmentLine) && Dp.m5740equalsimpl0(this.before, alignmentLineOffsetDpElement.before) && Dp.m5740equalsimpl0(this.after, alignmentLineOffsetDpElement.after);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + Dp.m5741hashCodeimpl(this.before)) * 31) + Dp.m5741hashCodeimpl(this.after);
    }
}
