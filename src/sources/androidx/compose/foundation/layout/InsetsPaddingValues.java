...
final class InsetsPaddingValues implements PaddingValues {
    ...
    public float mo516calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
        ...
        return density.mo313toDpu2uoSUM(this.insets.getLeft(density, layoutDirection));
    }
    ...
    public float getTop() {
        Density density = this.density;
        return density.mo313toDpu2uoSUM(this.insets.getTop(density));
    }
    ...
    public float mo517calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Density density = this.density;
        return density.mo313toDpu2uoSUM(this.insets.getRight(density, layoutDirection));
    }
    ...
    public float getBottom() {
        Density density = this.density;
        return density.mo313toDpu2uoSUM(this.insets.getBottom(density));
    }
