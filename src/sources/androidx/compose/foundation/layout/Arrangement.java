...
public final class Arrangement {
    ...
    private static final HorizontalOrVertical Center = new HorizontalOrVertical() { // from class: androidx.compose.foundation.layout.Arrangement$Center$1
        private final float spacing = Dp.m5735constructorimpl(0);
    ...
    public interface Horizontal {
        ...
        public static final class DefaultImpls {
            ...
            public static float m482getSpacingD9Ej5fM(Horizontal horizontal) {
    ...
    public interface Vertical {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m490getSpacingD9Ej5fM(Vertical vertical) {
    ...
    public interface HorizontalOrVertical extends Horizontal, Vertical {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m484getSpacingD9Ej5fM(HorizontalOrVertical horizontalOrVertical) {
    ...
    public final Horizontal aligned(final Alignment.Horizontal alignment) {
        return new SpacedAligned(Dp.m5735constructorimpl(0), true, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement.aligned.1
            {
                super(2);
            }
    ...
    public final Vertical aligned(final Alignment.Vertical alignment) {
        return new SpacedAligned(Dp.m5735constructorimpl(0), false, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement.aligned.2
            {
                super(2);
            }
    ...
    public static final class Absolute {
        ...
        /* renamed from: spacedBy-0680j_4, reason: not valid java name */
        public final HorizontalOrVertical m477spacedBy0680j_4(float space) {
            return new SpacedAligned(space, false, null, 0 == true ? 1 : 0);
        }

        /* renamed from: spacedBy-D5KLDUw, reason: not valid java name */
        public final Horizontal m478spacedByD5KLDUw(float space, final Alignment.Horizontal alignment) {
        ...
        /* renamed from: spacedBy-D5KLDUw, reason: not valid java name */
        public final Vertical m479spacedByD5KLDUw(float space, final Alignment.Vertical alignment) {
        ...
        public final Horizontal aligned(final Alignment.Horizontal alignment) {
            return new SpacedAligned(Dp.m5735constructorimpl(0), false, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$Absolute$aligned$1
                {
                    super(2);
                }
    ...
    public static final /* data */ class SpacedAligned implements HorizontalOrVertical {
        ...
        public static /* synthetic */ SpacedAligned m485copy8Feqmps$default(SpacedAligned spacedAligned, float f, boolean z, Function2 function2, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return spacedAligned.m487copy8Feqmps(f, z, function2);
        }
        ...
        public final SpacedAligned m487copy8Feqmps(float space, boolean rtlMirror, Function2<? super Integer, ? super LayoutDirection, Integer> alignment) {
        ...
        public boolean equals(Object other) {
            ...
            return Dp.m5740equalsimpl0(this.space, spacedAligned.space) && this.rtlMirror == spacedAligned.rtlMirror && Intrinsics.areEqual(this.alignment, spacedAligned.alignment);
        }

        public int hashCode() {
            int iM5741hashCodeimpl = ((Dp.m5741hashCodeimpl(this.space) * 31) + Boolean.hashCode(this.rtlMirror)) * 31;
            Function2<Integer, LayoutDirection, Integer> function2 = this.alignment;
            return iM5741hashCodeimpl + (function2 == null ? 0 : function2.hashCode());
        }
        ...
        public final float m488getSpaceD9Ej5fM() {
            return this.space;
        }
        ...
        public void arrange(Density density, int i, int[] iArr, LayoutDirection layoutDirection, int[] iArr2) {
            ...
            int iMo310roundToPx0680j_4 = density.mo310roundToPx0680j_4(this.space);
            ...
            if (!z) {
                ...
                while (i3 < length) {
                    ...
                    iArr2[i4] = iMin2;
                    int iMin3 = Math.min(iMo310roundToPx0680j_4, (i - iMin2) - i5);
                ...
                for (int length2 = iArr.length - 1; -1 < length2; length2--) {
                    ...
                    iArr2[length2] = iMin4;
                    iMin = Math.min(iMo310roundToPx0680j_4, (i - iMin4) - i7);
        ...
        public String toString() {
            return (this.rtlMirror ? "" : "Absolute") + "Arrangement#spacedAligned(" + ((Object) Dp.m5746toStringimpl(this.space)) + ", " + this.alignment + ')';
        }
    }
