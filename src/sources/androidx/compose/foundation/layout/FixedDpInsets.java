...
final class FixedDpInsets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        return density.mo310roundToPx0680j_4(this.leftDp);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getTop(Density density) {
        return density.mo310roundToPx0680j_4(this.topDp);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getRight(Density density, LayoutDirection layoutDirection) {
        return density.mo310roundToPx0680j_4(this.rightDp);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getBottom(Density density) {
        return density.mo310roundToPx0680j_4(this.bottomDp);
    }

    public String toString() {
        return "Insets(left=" + ((Object) Dp.m5746toStringimpl(this.leftDp)) + ", top=" + ((Object) Dp.m5746toStringimpl(this.topDp)) + ", right=" + ((Object) Dp.m5746toStringimpl(this.rightDp)) + ", bottom=" + ((Object) Dp.m5746toStringimpl(this.bottomDp)) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5740equalsimpl0(this.leftDp, fixedDpInsets.leftDp) && Dp.m5740equalsimpl0(this.topDp, fixedDpInsets.topDp) && Dp.m5740equalsimpl0(this.rightDp, fixedDpInsets.rightDp) && Dp.m5740equalsimpl0(this.bottomDp, fixedDpInsets.bottomDp);
    }

    public int hashCode() {
        return (((((Dp.m5741hashCodeimpl(this.leftDp) * 31) + Dp.m5741hashCodeimpl(this.topDp)) * 31) + Dp.m5741hashCodeimpl(this.rightDp)) * 31) + Dp.m5741hashCodeimpl(this.bottomDp);
    }
}
