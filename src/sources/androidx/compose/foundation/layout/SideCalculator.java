...
interface SideCalculator {
    ...
    long mo595consumedOffsetsMKHz9U(long available);

    /* renamed from: consumedVelocity-QWom1Mo, reason: not valid java name */
    long mo596consumedVelocityQWom1Mo(long available, float remaining);
    ...
    public static final class Companion {
        ...
        private static final SideCalculator$Companion$LeftSideCalculator$1 LeftSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$LeftSideCalculator$1
            ...
            public long mo595consumedOffsetsMKHz9U(long available) {
                return androidx.compose.ui.geometry.OffsetKt.Offset(Offset.m3173getXimpl(available), 0.0f);
            }

            @Override // androidx.compose.foundation.layout.SideCalculator
            /* renamed from: consumedVelocity-QWom1Mo */
            public long mo596consumedVelocityQWom1Mo(long available, float remaining) {
                return VelocityKt.Velocity(Velocity.m5970getXimpl(available) - remaining, 0.0f);
            }
        };
        private static final SideCalculator$Companion$TopSideCalculator$1 TopSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$TopSideCalculator$1
            ...
            /* renamed from: consumedOffsets-MK-Hz9U */
            public long mo595consumedOffsetsMKHz9U(long available) {
                return androidx.compose.ui.geometry.OffsetKt.Offset(0.0f, Offset.m3174getYimpl(available));
            }

            @Override // androidx.compose.foundation.layout.SideCalculator
            /* renamed from: consumedVelocity-QWom1Mo */
            public long mo596consumedVelocityQWom1Mo(long available, float remaining) {
                return VelocityKt.Velocity(0.0f, Velocity.m5971getYimpl(available) - remaining);
            }
        };
        ...
        public final SideCalculator m597chooseCalculatorni1skBw(int side, LayoutDirection layoutDirection) {
            if (WindowInsetsSides.m648equalsimpl0(side, WindowInsetsSides.INSTANCE.m662getLeftJoeWqyM())) {
                return LeftSideCalculator;
            }
            if (WindowInsetsSides.m648equalsimpl0(side, WindowInsetsSides.INSTANCE.m665getTopJoeWqyM())) {
                return TopSideCalculator;
            }
            if (WindowInsetsSides.m648equalsimpl0(side, WindowInsetsSides.INSTANCE.m663getRightJoeWqyM())) {
                return RightSideCalculator;
            }
            if (WindowInsetsSides.m648equalsimpl0(side, WindowInsetsSides.INSTANCE.m659getBottomJoeWqyM())) {
                return BottomSideCalculator;
            }
            if (WindowInsetsSides.m648equalsimpl0(side, WindowInsetsSides.INSTANCE.m664getStartJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return LeftSideCalculator;
                }
                return RightSideCalculator;
            }
            if (!WindowInsetsSides.m648equalsimpl0(side, WindowInsetsSides.INSTANCE.m660getEndJoeWqyM())) {
