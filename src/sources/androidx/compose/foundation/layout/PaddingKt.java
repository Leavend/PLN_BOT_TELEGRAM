...
public final class PaddingKt {
    ...
    public static final Modifier m568paddingqDBjuR0(Modifier modifier, final float f, final float f2, final float f3, final float f4) {
        return modifier.then(new PaddingElement(f, f2, f3, f4, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.PaddingKt.padding.1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("start", Dp.m5733boximpl(f));
                inspectorInfo.getProperties().set("top", Dp.m5733boximpl(f2));
                inspectorInfo.getProperties().set("end", Dp.m5733boximpl(f3));
                inspectorInfo.getProperties().set("bottom", Dp.m5733boximpl(f4));
            }
        }, null));
    }

    /* renamed from: padding-VpY3zN4, reason: not valid java name */
    public static final Modifier m566paddingVpY3zN4(Modifier modifier, final float f, final float f2) {
        return modifier.then(new PaddingElement(f, f2, f, f2, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.PaddingKt.padding.2
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                inspectorInfo.setName("padding");
                inspectorInfo.getProperties().set("horizontal", Dp.m5733boximpl(f));
                inspectorInfo.getProperties().set("vertical", Dp.m5733boximpl(f2));
            }
        }, null));
    }

    /* renamed from: padding-3ABfNKs, reason: not valid java name */
    public static final Modifier m565padding3ABfNKs(Modifier modifier, final float f) {
    ...
    public static final Modifier m563absolutePaddingqDBjuR0(Modifier modifier, final float f, final float f2, final float f3, final float f4) {
        return modifier.then(new PaddingElement(f, f2, f3, f4, false, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.PaddingKt$absolutePadding$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("left", Dp.m5733boximpl(f));
                inspectorInfo.getProperties().set("top", Dp.m5733boximpl(f2));
                inspectorInfo.getProperties().set("right", Dp.m5733boximpl(f3));
                inspectorInfo.getProperties().set("bottom", Dp.m5733boximpl(f4));
            }
        }, null));
    }
    ...
    public static final float calculateStartPadding(PaddingValues paddingValues, LayoutDirection layoutDirection) {
        if (layoutDirection == LayoutDirection.Ltr) {
            return paddingValues.mo516calculateLeftPaddingu2uoSUM(layoutDirection);
        }
        return paddingValues.mo517calculateRightPaddingu2uoSUM(layoutDirection);
    }
    ...
    public static final PaddingValues m558PaddingValues0680j_4(float f) {
        return new PaddingValuesImpl(f, f, f, f, null);
    }

    /* renamed from: PaddingValues-YgX7TsA, reason: not valid java name */
    public static final PaddingValues m559PaddingValuesYgX7TsA(float f, float f2) {
        return new PaddingValuesImpl(f, f2, f, f2, null);
    }

    /* renamed from: PaddingValues-a9UjIt4, reason: not valid java name */
    public static final PaddingValues m561PaddingValuesa9UjIt4(float f, float f2, float f3, float f4) {
        return new PaddingValuesImpl(f, f2, f3, f4, null);
    }

    /* renamed from: padding-qDBjuR0$default, reason: not valid java name */
    public static /* synthetic */ Modifier m569paddingqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m5735constructorimpl(0);
        }
        if ((i & 2) != 0) {
            f2 = Dp.m5735constructorimpl(0);
        }
        if ((i & 4) != 0) {
            f3 = Dp.m5735constructorimpl(0);
        }
        if ((i & 8) != 0) {
            f4 = Dp.m5735constructorimpl(0);
        }
        return m568paddingqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: padding-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m567paddingVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m5735constructorimpl(0);
        }
        if ((i & 2) != 0) {
        ...
        return m566paddingVpY3zN4(modifier, f, f2);
    }

    /* renamed from: absolutePadding-qDBjuR0$default, reason: not valid java name */
    public static /* synthetic */ Modifier m564absolutePaddingqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m5735constructorimpl(0);
        }
        if ((i & 2) != 0) {
        ...
        return m563absolutePaddingqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: PaddingValues-YgX7TsA$default, reason: not valid java name */
    public static /* synthetic */ PaddingValues m560PaddingValuesYgX7TsA$default(float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m5735constructorimpl(0);
        }
        if ((i & 2) != 0) {
        ...
        return m559PaddingValuesYgX7TsA(f, f2);
    }

    /* renamed from: PaddingValues-a9UjIt4$default, reason: not valid java name */
    public static /* synthetic */ PaddingValues m562PaddingValuesa9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m5735constructorimpl(0);
        }
        if ((i & 2) != 0) {
        ...
        return m561PaddingValuesa9UjIt4(f, f2, f3, f4);
    }
}
