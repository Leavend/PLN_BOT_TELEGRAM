...
public final class SizeKt {
    ...
    public static final Modifier m619width3ABfNKs(Modifier modifier, final float f) {
        return modifier.then(new SizeElement(f, 0.0f, f, 0.0f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$width-3ABfNKs$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.setValue(Dp.m5733boximpl(f));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 10, null));
    }

    /* renamed from: height-3ABfNKs, reason: not valid java name */
    public static final Modifier m600height3ABfNKs(Modifier modifier, final float f) {
    ...
    public static final Modifier m615size6HolHcs(Modifier modifier, long j) {
        return m616sizeVpY3zN4(modifier, DpSize.m5833getWidthD9Ej5fM(j), DpSize.m5831getHeightD9Ej5fM(j));
    }

    /* renamed from: widthIn-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m621widthInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m620widthInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: widthIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m620widthInVpY3zN4(Modifier modifier, final float f, final float f2) {
        return modifier.then(new SizeElement(f, 0.0f, f2, 0.0f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$widthIn-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("min", Dp.m5733boximpl(f));
                inspectorInfo.getProperties().set("max", Dp.m5733boximpl(f2));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 10, null));
    }

    /* renamed from: heightIn-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m602heightInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m5755getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m601heightInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: heightIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m601heightInVpY3zN4(Modifier modifier, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m618sizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m5755getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        if ((i & 4) != 0) {
            f3 = Dp.INSTANCE.m5755getUnspecifiedD9Ej5fM();
        }
        if ((i & 8) != 0) {
            f4 = Dp.INSTANCE.m5755getUnspecifiedD9Ej5fM();
        }
        return m617sizeInqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: sizeIn-qDBjuR0, reason: not valid java name */
    public static final Modifier m617sizeInqDBjuR0(Modifier modifier, final float f, final float f2, final float f3, final float f4) {
        return modifier.then(new SizeElement(f, f2, f3, f4, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$sizeIn-qDBjuR0$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("minWidth", Dp.m5733boximpl(f));
                inspectorInfo.getProperties().set("minHeight", Dp.m5733boximpl(f2));
                inspectorInfo.getProperties().set("maxWidth", Dp.m5733boximpl(f3));
                inspectorInfo.getProperties().set("maxHeight", Dp.m5733boximpl(f4));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* renamed from: requiredWidth-3ABfNKs, reason: not valid java name */
    public static final Modifier m611requiredWidth3ABfNKs(Modifier modifier, final float f) {
    ...
    public static final Modifier m603requiredHeight3ABfNKs(Modifier modifier, final float f) {
    ...
    public static final Modifier m607requiredSize6HolHcs(Modifier modifier, long j) {
        return m608requiredSizeVpY3zN4(modifier, DpSize.m5833getWidthD9Ej5fM(j), DpSize.m5831getHeightD9Ej5fM(j));
    }

    /* renamed from: requiredWidthIn-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m613requiredWidthInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m5755getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m612requiredWidthInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: requiredWidthIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m612requiredWidthInVpY3zN4(Modifier modifier, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m605requiredHeightInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m5755getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m604requiredHeightInVpY3zN4(modifier, f, f2);
    }

    /* renamed from: requiredHeightIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m604requiredHeightInVpY3zN4(Modifier modifier, final float f, final float f2) {
    ...
    public static /* synthetic */ Modifier m610requiredSizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m5755getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m609requiredSizeInqDBjuR0(modifier, f, f2, f3, f4);
    }

    /* renamed from: requiredSizeIn-qDBjuR0, reason: not valid java name */
    public static final Modifier m609requiredSizeInqDBjuR0(Modifier modifier, final float f, final float f2, final float f3, final float f4) {
    ...
    public static /* synthetic */ Modifier m599defaultMinSizeVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m5755getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m598defaultMinSizeVpY3zN4(modifier, f, f2);
    }

    /* renamed from: defaultMinSize-VpY3zN4, reason: not valid java name */
    public static final Modifier m598defaultMinSizeVpY3zN4(Modifier modifier, float f, float f2) {
        return modifier.then(new UnspecifiedConstraintsElement(f, f2, null));
    }

    /* renamed from: size-3ABfNKs, reason: not valid java name */
    public static final Modifier m614size3ABfNKs(Modifier modifier, final float f) {
    ...
    public static final Modifier m616sizeVpY3zN4(Modifier modifier, final float f, final float f2) {
        return modifier.then(new SizeElement(f, f2, f, f2, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$size-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                inspectorInfo.setName("size");
                inspectorInfo.getProperties().set("width", Dp.m5733boximpl(f));
                inspectorInfo.getProperties().set("height", Dp.m5733boximpl(f2));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* renamed from: requiredSize-3ABfNKs, reason: not valid java name */
    public static final Modifier m606requiredSize3ABfNKs(Modifier modifier, final float f) {
    ...
    public static final Modifier m608requiredSizeVpY3zN4(Modifier modifier, final float f, final float f2) {
