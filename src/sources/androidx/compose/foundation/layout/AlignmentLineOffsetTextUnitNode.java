...
final class AlignmentLineOffsetTextUnitNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo90measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        return AlignmentLineKt.m443alignmentLineOffsetMeasuretjqqzMA(measureScope, this.alignmentLine, !TextUnitKt.m5944isUnspecifiedR2X_6o(this.before) ? measureScope.mo311toDpGaN1DYA(this.before) : Dp.INSTANCE.m5755getUnspecifiedD9Ej5fM(), !TextUnitKt.m5944isUnspecifiedR2X_6o(this.after) ? measureScope.mo311toDpGaN1DYA(this.after) : Dp.INSTANCE.m5755getUnspecifiedD9Ej5fM(), measurable, j);
    }
}
