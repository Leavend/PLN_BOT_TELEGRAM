...
final class OffsetElement extends ModifierNodeElement<OffsetNode> {
    ...
    public void update(OffsetNode node) {
        node.m529setX0680j_4(this.x);
        node.m530setY0680j_4(this.y);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5740equalsimpl0(this.x, offsetElement.x) && Dp.m5740equalsimpl0(this.y, offsetElement.y) && this.rtlAware == offsetElement.rtlAware;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((Dp.m5741hashCodeimpl(this.x) * 31) + Dp.m5741hashCodeimpl(this.y)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifierElement(x=" + ((Object) Dp.m5746toStringimpl(this.x)) + ", y=" + ((Object) Dp.m5746toStringimpl(this.y)) + ", rtlAware=" + this.rtlAware + ')';
    }
