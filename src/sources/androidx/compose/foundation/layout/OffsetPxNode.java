...
final class OffsetPxNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo90measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, placeableMo4684measureBRTryo0.getWidth(), placeableMo4684measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetPxNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (this.this$0.getRtlAware()) {
                    Placeable.PlacementScope.placeRelativeWithLayer$default(placementScope, placeableMo4684measureBRTryo0, IntOffset.m5863getXimpl(packedValue), IntOffset.m5864getYimpl(packedValue), 0.0f, null, 12, null);
                } else {
                    Placeable.PlacementScope.placeWithLayer$default(placementScope, placeableMo4684measureBRTryo0, IntOffset.m5863getXimpl(packedValue), IntOffset.m5864getYimpl(packedValue), 0.0f, null, 12, null);
                }
            }
        }, 4, null);
    }
