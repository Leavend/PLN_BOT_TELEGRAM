...
public final class PaddingValuesImpl implements PaddingValues {
    ...
    public static /* synthetic */ void m582getBottomD9Ej5fM$annotations() {
    }

    /* renamed from: getEnd-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m583getEndD9Ej5fM$annotations() {
    }

    /* renamed from: getStart-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m584getStartD9Ej5fM$annotations() {
    }

    /* renamed from: getTop-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m585getTopD9Ej5fM$annotations() {
    }
    ...
    public final float m589getTopD9Ej5fM() {
        return this.top;
    }
    ...
    public final float m586getBottomD9Ej5fM() {
        return this.bottom;
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5740equalsimpl0(this.start, paddingValuesImpl.start) && Dp.m5740equalsimpl0(this.top, paddingValuesImpl.top) && Dp.m5740equalsimpl0(this.end, paddingValuesImpl.end) && Dp.m5740equalsimpl0(this.bottom, paddingValuesImpl.bottom);
    }

    public int hashCode() {
        return (((((Dp.m5741hashCodeimpl(this.start) * 31) + Dp.m5741hashCodeimpl(this.top)) * 31) + Dp.m5741hashCodeimpl(this.end)) * 31) + Dp.m5741hashCodeimpl(this.bottom);
    }

    public String toString() {
        return "PaddingValues(start=" + ((Object) Dp.m5746toStringimpl(this.start)) + ", top=" + ((Object) Dp.m5746toStringimpl(this.top)) + ", end=" + ((Object) Dp.m5746toStringimpl(this.end)) + ", bottom=" + ((Object) Dp.m5746toStringimpl(this.bottom)) + ')';
    }
