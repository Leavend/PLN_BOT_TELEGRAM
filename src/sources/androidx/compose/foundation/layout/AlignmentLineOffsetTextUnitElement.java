...
final class AlignmentLineOffsetTextUnitElement extends ModifierNodeElement<AlignmentLineOffsetTextUnitNode> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + TextUnit.m5927hashCodeimpl(this.before)) * 31) + TextUnit.m5927hashCodeimpl(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetTextUnitElement.alignmentLine) && TextUnit.m5923equalsimpl0(this.before, alignmentLineOffsetTextUnitElement.before) && TextUnit.m5923equalsimpl0(this.after, alignmentLineOffsetTextUnitElement.after);
    }
