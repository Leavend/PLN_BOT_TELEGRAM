...
final class WrapContentNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo90measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable placeableMo4684measureBRTryo0 = measurable.mo4684measureBRTryo0(ConstraintsKt.Constraints(this.direction != Direction.Vertical ? 0 : Constraints.m5693getMinWidthimpl(j), (this.direction == Direction.Vertical || !this.unbounded) ? Constraints.m5691getMaxWidthimpl(j) : Integer.MAX_VALUE, this.direction == Direction.Horizontal ? Constraints.m5692getMinHeightimpl(j) : 0, (this.direction == Direction.Horizontal || !this.unbounded) ? Constraints.m5690getMaxHeightimpl(j) : Integer.MAX_VALUE));
        final int iCoerceIn = RangesKt.coerceIn(placeableMo4684measureBRTryo0.getWidth(), Constraints.m5693getMinWidthimpl(j), Constraints.m5691getMaxWidthimpl(j));
        final int iCoerceIn2 = RangesKt.coerceIn(placeableMo4684measureBRTryo0.getHeight(), Constraints.m5692getMinHeightimpl(j), Constraints.m5690getMaxHeightimpl(j));
        return MeasureScope.layout$default(measureScope, iCoerceIn, iCoerceIn2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.WrapContentNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m4735place70tqf50$default(placementScope, placeableMo4684measureBRTryo0, this.this$0.getAlignmentCallback().invoke(IntSize.m5897boximpl(IntSizeKt.IntSize(iCoerceIn - placeableMo4684measureBRTryo0.getWidth(), iCoerceIn2 - placeableMo4684measureBRTryo0.getHeight())), measureScope.getLayoutDirection()).getPackedValue(), 0.0f, 2, null);
            }
        }, 4, null);
    }
}
