...
final class DerivedWidthModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public MeasureResult mo63measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final Placeable placeableMo4684measureBRTryo0 = measurable.mo4684measureBRTryo0(Constraints.m5682copyZbe2FdA$default(j, iIntValue, iIntValue, 0, 0, 12, null));
        return MeasureScope.layout$default(measureScope, iIntValue, placeableMo4684measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.DerivedWidthModifier$measure$2
            {
                super(1);
            }
