...
final class ClickableElement extends ModifierNodeElement<ClickableNode> {
    ...
    public void update(ClickableNode node) {
        node.m256updateXHw0xAI(this.interactionSource, this.enabled, this.onClickLabel, this.role, this.onClick);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return ((iHashCode2 + (role != null ? Role.m5060hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode();
    }
}
