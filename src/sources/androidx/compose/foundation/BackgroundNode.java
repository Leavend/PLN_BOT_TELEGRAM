...
final class BackgroundNode extends Modifier.Node implements DrawModifierNode {
    ...
    private final void drawRect(ContentDrawScope contentDrawScope) {
        if (!Color.m3415equalsimpl0(this.color, Color.INSTANCE.m3450getUnspecified0d7_KjU())) {
            DrawScope.m3958drawRectnJ9OG0$default(contentDrawScope, this.color, 0L, 0L, 0.0f, null, null, 0, 126, null);
        }
        Brush brush = this.brush;
        if (brush != null) {
            DrawScope.m3957drawRectAsUm42w$default(contentDrawScope, brush, 0L, 0L, this.alpha, null, null, 0, 118, null);
        }
    }

    private final void drawOutline(ContentDrawScope contentDrawScope) {
        Outline outlineMo263createOutlinePq9zytI;
        if (Size.m3237equalsimpl(contentDrawScope.mo3963getSizeNHjbRc(), this.lastSize) && contentDrawScope.getLayoutDirection() == this.lastLayoutDirection && Intrinsics.areEqual(this.lastShape, this.shape)) {
            outlineMo263createOutlinePq9zytI = this.lastOutline;
            Intrinsics.checkNotNull(outlineMo263createOutlinePq9zytI);
        } else {
            outlineMo263createOutlinePq9zytI = this.shape.mo263createOutlinePq9zytI(contentDrawScope.mo3963getSizeNHjbRc(), contentDrawScope.getLayoutDirection(), contentDrawScope);
        }
        if (!Color.m3415equalsimpl0(this.color, Color.INSTANCE.m3450getUnspecified0d7_KjU())) {
            OutlineKt.m3672drawOutlinewDX37Ww(contentDrawScope, outlineMo263createOutlinePq9zytI, this.color, (60 & 4) != 0 ? 1.0f : 0.0f, (60 & 8) != 0 ? Fill.INSTANCE : null, (60 & 16) != 0 ? null : null, (60 & 32) != 0 ? DrawScope.INSTANCE.m3964getDefaultBlendMode0nO6VwU() : 0);
        }
        Brush brush = this.brush;
        if (brush != null) {
            OutlineKt.m3671drawOutlinehn5TExg$default(contentDrawScope, outlineMo263createOutlinePq9zytI, brush, this.alpha, null, null, 0, 56, null);
        }
        this.lastOutline = outlineMo263createOutlinePq9zytI;
        this.lastSize = Size.m3230boximpl(contentDrawScope.mo3963getSizeNHjbRc());
