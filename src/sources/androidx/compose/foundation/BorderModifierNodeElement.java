...
public final /* data */ class BorderModifierNodeElement extends ModifierNodeElement<BorderModifierNode> {
    ...
    public static /* synthetic */ BorderModifierNodeElement m233copy8Feqmps$default(BorderModifierNodeElement borderModifierNodeElement, float f, Brush brush, Shape shape, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return borderModifierNodeElement.m235copy8Feqmps(f, brush, shape);
    }
    ...
    public final BorderModifierNodeElement m235copy8Feqmps(float width, Brush brush, Shape shape) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5740equalsimpl0(this.width, borderModifierNodeElement.width) && Intrinsics.areEqual(this.brush, borderModifierNodeElement.brush) && Intrinsics.areEqual(this.shape, borderModifierNodeElement.shape);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((Dp.m5741hashCodeimpl(this.width) * 31) + this.brush.hashCode()) * 31) + this.shape.hashCode();
    }

    public String toString() {
        return "BorderModifierNodeElement(width=" + ((Object) Dp.m5746toStringimpl(this.width)) + ", brush=" + this.brush + ", shape=" + this.shape + ')';
    }

    /* renamed from: getWidth-D9Ej5fM, reason: not valid java name */
    public final float m236getWidthD9Ej5fM() {
        return this.width;
    }
    ...
    public void update(BorderModifierNode node) {
        node.m232setWidth0680j_4(this.width);
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("width", Dp.m5733boximpl(this.width));
        if (this.brush instanceof SolidColor) {
            inspectorInfo.getProperties().set(TypedValues.Custom.S_COLOR, Color.m3404boximpl(((SolidColor) this.brush).getValue()));
            inspectorInfo.setValue(Color.m3404boximpl(((SolidColor) this.brush).getValue()));
        } else {
