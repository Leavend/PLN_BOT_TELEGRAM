...
public abstract class LazyListMeasuredItemProvider {
    ...
    private LazyListMeasuredItemProvider(long j, boolean z, LazyListItemProvider lazyListItemProvider, LazyLayoutMeasureScope lazyLayoutMeasureScope) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, z ? Constraints.m5691getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, !z ? Constraints.m5690getMaxHeightimpl(j) : Integer.MAX_VALUE, 5, null);
    }
    ...
    public final LazyListMeasuredItem getAndMeasure(int index) {
        return createItem(index, this.itemProvider.getKey(index), this.itemProvider.getContentType(index), this.measureScope.mo729measure0kLqBqw(index, this.childConstraints));
    }
