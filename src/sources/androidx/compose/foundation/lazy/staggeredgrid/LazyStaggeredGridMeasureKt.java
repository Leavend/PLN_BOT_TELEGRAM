...
public final class LazyStaggeredGridMeasureKt {
        ...
        try {
            ...
            try {
                ...
                if (iArrUpdateScrollPositionIfTheFirstItemWasMoved$foundation_release.length == lazyStaggeredGridMeasureContext.getLaneCount()) {
                    ...
                    int i6 = 0;
                    while (i6 < laneCount) {
                        if (i6 >= iArrUpdateScrollPositionIfTheFirstItemWasMoved$foundation_release.length || (iM765maxInRangejy6DScQ = iArrUpdateScrollPositionIfTheFirstItemWasMoved$foundation_release[i6]) == -1) {
                            iM765maxInRangejy6DScQ = i6 == 0 ? 0 : m765maxInRangejy6DScQ(iArr, SpanRange.m775constructorimpl(0, i6)) + 1;
                        }
                        iArr[i6] = iM765maxInRangejy6DScQ;
    ...
    */
    ...
    private static final List<LazyStaggeredGridMeasuredItem> calculateVisibleItems(LazyStaggeredGridMeasureContext lazyStaggeredGridMeasureContext, ArrayDeque<LazyStaggeredGridMeasuredItem>[] arrayDequeArr, int[] iArr, int i) {
        ...
        while (true) {
            ...
            if (lazyStaggeredGridMeasuredItemRemoveFirst.getLane() == i3) {
                long jM775constructorimpl = SpanRange.m775constructorimpl(lazyStaggeredGridMeasuredItemRemoveFirst.getLane(), lazyStaggeredGridMeasuredItemRemoveFirst.getSpan());
                int iM765maxInRangejy6DScQ = m765maxInRangejy6DScQ(iArr, jM775constructorimpl);
                ...
                if (lazyStaggeredGridMeasuredItemRemoveFirst.getPlaceablesCount() != 0) {
                    lazyStaggeredGridMeasuredItemRemoveFirst.position(iM765maxInRangejy6DScQ, i6, i);
                    arrayList.add(lazyStaggeredGridMeasuredItemRemoveFirst);
                    int i7 = (int) (jM775constructorimpl & InternalZipConstants.ZIP_64_SIZE_LIMIT);
                    for (int i8 = (int) (jM775constructorimpl >> 32); i8 < i7; i8++) {
                        iArr[i8] = lazyStaggeredGridMeasuredItemRemoveFirst.getSizeWithSpacings() + iM765maxInRangejy6DScQ;
                    }
                }
            }
        }
        ...
        if (z) {
            ...
            if (size >= 0) {
                while (true) {
                    ...
                    if (function12.invoke(Integer.valueOf(iIntValue)).booleanValue()) {
                        long jM762getSpanRangelOCCd4c = lazyStaggeredGridMeasureContext.m762getSpanRangelOCCd4c(lazyStaggeredGridMeasureContext.getItemProvider(), iIntValue, 0);
                        if (arrayList == null) {
                            arrayList = new ArrayList();
                        }
                        LazyStaggeredGridMeasuredItem lazyStaggeredGridMeasuredItemM770getAndMeasurejy6DScQ = lazyStaggeredGridMeasureContext.getMeasuredItemProvider().m770getAndMeasurejy6DScQ(iIntValue, jM762getSpanRangelOCCd4c);
                        function1.invoke(lazyStaggeredGridMeasuredItemM770getAndMeasurejy6DScQ);
                        arrayList.add(lazyStaggeredGridMeasuredItemM770getAndMeasurejy6DScQ);
                    }
                    if (i < 0) {
                        break;
                    }
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (function12.invoke(Integer.valueOf(iIntValue2)).booleanValue()) {
                    long jM762getSpanRangelOCCd4c2 = lazyStaggeredGridMeasureContext.m762getSpanRangelOCCd4c(lazyStaggeredGridMeasureContext.getItemProvider(), iIntValue2, 0);
                    if (arrayList == null) {
                        arrayList = new ArrayList();
                    }
                    LazyStaggeredGridMeasuredItem lazyStaggeredGridMeasuredItemM770getAndMeasurejy6DScQ2 = lazyStaggeredGridMeasureContext.getMeasuredItemProvider().m770getAndMeasurejy6DScQ(iIntValue2, jM762getSpanRangelOCCd4c2);
                    function1.invoke(lazyStaggeredGridMeasuredItemM770getAndMeasurejy6DScQ2);
                    arrayList.add(lazyStaggeredGridMeasuredItemM770getAndMeasurejy6DScQ2);
                }
            }
        }
    ...
    private static final void m764forEachnIS5qE8(long j, Function1<? super Integer, Unit> function1) {
        int i = (int) (j & InternalZipConstants.ZIP_64_SIZE_LIMIT);
    ...
    private static final int m765maxInRangejy6DScQ(int[] iArr, long j) {
        int i = (int) (j & InternalZipConstants.ZIP_64_SIZE_LIMIT);
