...
public final class LazyStaggeredGridAnimateScrollScope implements LazyLayoutAnimateScrollScope {
    ...
    public int getVisibleItemScrollOffset(final int index) {
        ...
        return this.state.getIsVertical() ? IntOffset.m5864getYimpl(offset) : IntOffset.m5863getXimpl(offset);
    }
    ...
    public int getVisibleItemsAverageSize() {
        ...
        int iM5904getHeightimpl = 0;
        for (int i = 0; i < size; i++) {
            LazyStaggeredGridItemInfo lazyStaggeredGridItemInfo = visibleItemsInfo.get(i);
            iM5904getHeightimpl += this.state.getIsVertical() ? IntSize.m5904getHeightimpl(lazyStaggeredGridItemInfo.getSize()) : IntSize.m5905getWidthimpl(lazyStaggeredGridItemInfo.getSize());
        }
        return (iM5904getHeightimpl / visibleItemsInfo.size()) + layoutInfo.getMainAxisItemSpacing();
    }
}
