...
public final class LazyStaggeredGridMeasureContext {
    ...
    public final int m761getLaneInfoSZVOQXA(long j) {
        int i = (int) (InternalZipConstants.ZIP_64_SIZE_LIMIT & j);
        int i2 = (int) (j >> 32);
        if (i - i2 != 1) {
            return -2;
        }
    ...
    public final boolean m763isFullSpanSZVOQXA(long j) {
        return ((int) (InternalZipConstants.ZIP_64_SIZE_LIMIT & j)) - ((int) (j >> 32)) != 1;
    }
    ...
    public final long m762getSpanRangelOCCd4c(LazyStaggeredGridItemProvider lazyStaggeredGridItemProvider, int i, int i2) {
        boolean zIsFullSpan = lazyStaggeredGridItemProvider.getSpanProvider().isFullSpan(i);
        int i3 = zIsFullSpan ? this.laneCount : 1;
        if (zIsFullSpan) {
            i2 = 0;
        }
        return SpanRange.m775constructorimpl(i2, i3);
    }
}
