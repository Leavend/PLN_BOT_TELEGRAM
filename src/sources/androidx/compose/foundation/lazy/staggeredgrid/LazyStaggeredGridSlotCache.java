...
final class LazyStaggeredGridSlotCache implements LazyGridStaggeredGridSlotsProvider {
    ...
    public LazyStaggeredGridSlots mo750invoke0kLqBqw(Density density, long constraints) {
        if (this.cachedSizes != null && Constraints.m5684equalsimpl0(this.cachedConstraints, constraints)) {
        ...
        LazyStaggeredGridSlots lazyStaggeredGridSlotsInvoke = this.calculation.invoke(density, Constraints.m5679boximpl(constraints));
