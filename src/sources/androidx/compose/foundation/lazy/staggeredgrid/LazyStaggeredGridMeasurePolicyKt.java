...
public final class LazyStaggeredGridMeasurePolicyKt {
    ...
    public static final Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult> m767rememberStaggeredGridMeasurePolicy1tP8Re8(final LazyStaggeredGridState lazyStaggeredGridState, final Function0<? extends LazyStaggeredGridItemProvider> function0, final PaddingValues paddingValues, final boolean z, final Orientation orientation, final float f, float f2, final CoroutineScope coroutineScope, final LazyGridStaggeredGridSlotsProvider lazyGridStaggeredGridSlotsProvider, Composer composer, int i) {
        ...
        Object[] objArr = {lazyStaggeredGridState, function0, paddingValues, Boolean.valueOf(z), orientation, Dp.m5733boximpl(f), Dp.m5733boximpl(f2), lazyGridStaggeredGridSlotsProvider};
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasurePolicyKt$rememberStaggeredGridMeasurePolicy$1$1
                ...
                public /* bridge */ /* synthetic */ LazyStaggeredGridMeasureResult invoke(LazyLayoutMeasureScope lazyLayoutMeasureScope, Constraints constraints) {
                    return m768invoke0kLqBqw(lazyLayoutMeasureScope, constraints.getValue());
                }

                /* renamed from: invoke-0kLqBqw, reason: not valid java name */
                public final LazyStaggeredGridMeasureResult m768invoke0kLqBqw(LazyLayoutMeasureScope lazyLayoutMeasureScope, long j) {
                    long jIntOffset;
                    CheckScrollableContainerConstraintsKt.m241checkScrollableContainerConstraintsK40F9xA(j, orientation);
                    LazyStaggeredGridSlots lazyStaggeredGridSlotsMo750invoke0kLqBqw = lazyGridStaggeredGridSlotsProvider.mo750invoke0kLqBqw(lazyLayoutMeasureScope, j);
                    ...
                    lazyStaggeredGridState.setSlots$foundation_release(lazyStaggeredGridSlotsMo750invoke0kLqBqw);
                    ...
                    int i3 = lazyLayoutMeasureScope.mo310roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.beforePadding(paddingValues, orientation, z, lazyLayoutMeasureScope.getLayoutDirection()));
                    int i4 = lazyLayoutMeasureScope.mo310roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.afterPadding(paddingValues, orientation, z, lazyLayoutMeasureScope.getLayoutDirection()));
                    int i5 = lazyLayoutMeasureScope.mo310roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.startPadding(paddingValues, orientation, lazyLayoutMeasureScope.getLayoutDirection()));
                    int iM5690getMaxHeightimpl = ((z2 ? Constraints.m5690getMaxHeightimpl(j) : Constraints.m5691getMaxWidthimpl(j)) - i3) - i4;
                    if (z2) {
                    ...
                    int i6 = lazyLayoutMeasureScope.mo310roundToPx0680j_4(Dp.m5735constructorimpl(PaddingKt.calculateStartPadding(paddingValues2, lazyLayoutMeasureScope.getLayoutDirection()) + PaddingKt.calculateEndPadding(paddingValues2, lazyLayoutMeasureScope.getLayoutDirection())));
                    PaddingValues paddingValues3 = paddingValues;
                    boolean z3 = z2;
                    LazyStaggeredGridMeasureResult lazyStaggeredGridMeasureResultM766measureStaggeredGridsdzDtKU = LazyStaggeredGridMeasureKt.m766measureStaggeredGridsdzDtKU(lazyLayoutMeasureScope, lazyStaggeredGridState, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(lazyStaggeredGridItemProviderInvoke, lazyStaggeredGridState.getPinnedItems(), lazyStaggeredGridState.getBeyondBoundsInfo()), lazyStaggeredGridItemProviderInvoke, lazyStaggeredGridSlotsMo750invoke0kLqBqw, Constraints.m5682copyZbe2FdA$default(j, ConstraintsKt.m5705constrainWidthK40F9xA(j, i6), 0, ConstraintsKt.m5704constrainHeightK40F9xA(j, lazyLayoutMeasureScope.mo310roundToPx0680j_4(Dp.m5735constructorimpl(paddingValues3.getTop() + paddingValues3.getBottom()))), 0, 10, null), z3, z, j2, iM5690getMaxHeightimpl, lazyLayoutMeasureScope.mo310roundToPx0680j_4(f), i3, i4, coroutineScope);
                    LazyStaggeredGridState.applyMeasureResult$foundation_release$default(lazyStaggeredGridState, lazyStaggeredGridMeasureResultM766measureStaggeredGridsdzDtKU, false, 2, null);
                    return lazyStaggeredGridMeasureResultM766measureStaggeredGridsdzDtKU;
                }
            };
