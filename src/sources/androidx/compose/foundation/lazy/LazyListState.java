...
public final class LazyListState implements ScrollableState {
    ...
    public final void m681setPremeasureConstraintsBRTryo0$foundation_release(long j) {
    ...
    */
    ...
    public final MutableState<Unit> m679getPlacementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    private final void updateScrollDeltaForPostLookahead(float delta) {
        if (delta <= this.density.mo316toPx0680j_4(LazyListStateKt.DeltaThresholdForScrollAnimation)) {
            return;
        }
