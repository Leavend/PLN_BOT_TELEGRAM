...
final class ParentSizeNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo90measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        int iM5693getMinWidthimpl = iRoundToInt != Integer.MAX_VALUE ? iRoundToInt : Constraints.m5693getMinWidthimpl(j);
        int iM5692getMinHeightimpl = iRoundToInt2 != Integer.MAX_VALUE ? iRoundToInt2 : Constraints.m5692getMinHeightimpl(j);
        if (iRoundToInt == Integer.MAX_VALUE) {
            iRoundToInt = Constraints.m5691getMaxWidthimpl(j);
        }
        if (iRoundToInt2 == Integer.MAX_VALUE) {
            iRoundToInt2 = Constraints.m5690getMaxHeightimpl(j);
        }
        final Placeable placeableMo4684measureBRTryo0 = measurable.mo4684measureBRTryo0(ConstraintsKt.Constraints(iM5693getMinWidthimpl, iRoundToInt, iM5692getMinHeightimpl, iRoundToInt2));
        return MeasureScope.layout$default(measureScope, placeableMo4684measureBRTryo0.getWidth(), placeableMo4684measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.ParentSizeNode$measure$1
            {
                super(1);
            }
