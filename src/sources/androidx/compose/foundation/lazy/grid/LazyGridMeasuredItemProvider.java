...
public abstract class LazyGridMeasuredItemProvider {
    ...
    public static /* synthetic */ LazyGridMeasuredItem m706getAndMeasure3p2s80s$default(LazyGridMeasuredItemProvider lazyGridMeasuredItemProvider, int i, int i2, long j, int i3, Object obj) {
        if (obj != null) {
        ...
        return lazyGridMeasuredItemProvider.m707getAndMeasure3p2s80s(i, i2, j);
    }

    /* renamed from: getAndMeasure-3p2s80s, reason: not valid java name */
    public final LazyGridMeasuredItem m707getAndMeasure3p2s80s(int index, int mainAxisSpacing, long constraints) {
        ...
        List<Placeable> listMo729measure0kLqBqw = this.measureScope.mo729measure0kLqBqw(index, constraints);
        if (Constraints.m5689getHasFixedWidthimpl(constraints)) {
            iM5692getMinHeightimpl = Constraints.m5693getMinWidthimpl(constraints);
        } else {
            if (!Constraints.m5688getHasFixedHeightimpl(constraints)) {
                throw new IllegalArgumentException("does not have fixed height".toString());
            }
            iM5692getMinHeightimpl = Constraints.m5692getMinHeightimpl(constraints);
        }
        return createItem(index, key, contentType, iM5692getMinHeightimpl, mainAxisSpacing, listMo729measure0kLqBqw);
    }
