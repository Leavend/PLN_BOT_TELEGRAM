...
final class GridSlotCache implements LazyGridSlotsProvider {
    ...
    public LazyGridSlots mo690invoke0kLqBqw(Density density, long constraints) {
        ...
        LazyGridSlots lazyGridSlotsInvoke = this.calculation.invoke(density, Constraints.m5679boximpl(constraints));
