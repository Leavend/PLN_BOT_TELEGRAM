...
public final class BasicMarqueeKt {
    ...
    private static final float DefaultMarqueeVelocity = Dp.m5735constructorimpl(30);
    ...
    public static /* synthetic */ Modifier m219basicMarquee1Mj1MLw$default(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = DefaultMarqueeIterations;
        }
        if ((i5 & 2) != 0) {
            i2 = MarqueeAnimationMode.INSTANCE.m293getImmediatelyZbEOnfQ();
        }
        int i6 = i2;
        if ((i5 & 4) != 0) {
        ...
        int i7 = i3;
        if ((i5 & 8) != 0) {
            i4 = MarqueeAnimationMode.m287equalsimpl0(i6, MarqueeAnimationMode.INSTANCE.m293getImmediatelyZbEOnfQ()) ? i7 : 0;
        }
        int i8 = i4;
        if ((i5 & 16) != 0) {
        ...
        return m218basicMarquee1Mj1MLw(modifier, i, i6, i7, i8, marqueeSpacing2, f);
    }

    /* renamed from: basicMarquee-1Mj1MLw, reason: not valid java name */
    public static final Modifier m218basicMarquee1Mj1MLw(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f) {
    ...
    public static final AnimationSpec<Float> m220createMarqueeAnimationSpecZ4HSEVQ(int i, float f, int i2, int i3, float f2, Density density) {
        TweenSpec<Float> tweenSpecVelocityBasedTween = velocityBasedTween(Math.abs(density.mo316toPx0680j_4(f2)), f, i3);
        long jM150constructorimpl$default = StartOffset.m150constructorimpl$default((-i3) + i2, 0, 2, null);
        if (i == Integer.MAX_VALUE) {
            return AnimationSpecKt.m127infiniteRepeatable9IiC70o$default(tweenSpecVelocityBasedTween, null, jM150constructorimpl$default, 2, null);
        }
        return AnimationSpecKt.m129repeatable91I0pcU$default(i, tweenSpecVelocityBasedTween, null, jM150constructorimpl$default, 4, null);
    }
    ...
    public static final MarqueeSpacing m216MarqueeSpacing0680j_4(final float f) {
    ...
    public static final int MarqueeSpacing_0680j_4$lambda$1(float f, Density density, int i, int i2) {
        return density.mo310roundToPx0680j_4(f);
    }
}
