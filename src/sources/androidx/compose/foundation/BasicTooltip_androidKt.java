    ...
    */
    ...
    public static final void TooltipPopup(final PopupPositionProvider popupPositionProvider, final BasicTooltipState basicTooltipState, final CoroutineScope coroutineScope, final boolean z, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) throws Resources.NotFoundException {
        ...
        AndroidPopup_androidKt.Popup(popupPositionProvider, new Function0<Unit>() { // from class: androidx.compose.foundation.BasicTooltip_androidKt.TooltipPopup.1
            ...
            /* renamed from: androidx.compose.foundation.BasicTooltip_androidKt$TooltipPopup$1$1, reason: invalid class name and collision with other inner class name */
    ...
    static final class C03361 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03361(BasicTooltipState basicTooltipState, Continuation<? super C03361> continuation) {
            super(2, continuation);
            this.$state = basicTooltipState;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03361 c03361 = new C03361(this.$state, continuation);
            c03361.L$0 = obj;
            return c03361;
        }
        ...
        static final class C00061 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                */
                public final java.lang.Object invokeSuspend(java.lang.Object r17) {
                    /*
                        ...
                        To view this dump add '--comments-level debug' option
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.BasicTooltip_androidKt.C03361.C00061.C00071.invokeSuspend(java.lang.Object):java.lang.Object");
                }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    this.label = 1;
                    if (ForEachGestureKt.awaitEachGesture(this.$$this$pointerInput, new C00071(coroutineScope, this.$state, null), this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i != 1) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                this.label = 1;
                if (CoroutineScopeKt.coroutineScope(new C00061((PointerInputScope) this.L$0, this.$state, null), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
    ...
    private static final Modifier handleGestures(Modifier modifier, boolean z, BasicTooltipState basicTooltipState) {
        return z ? SuspendingPointerInputFilterKt.pointerInput(SuspendingPointerInputFilterKt.pointerInput(modifier, basicTooltipState, new C03361(basicTooltipState, null)), basicTooltipState, new C03372(basicTooltipState, null)) : modifier;
    }
    ...
    static final class C03372 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ BasicTooltipState $state;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03372(BasicTooltipState basicTooltipState, Continuation<? super C03372> continuation) {
            super(2, continuation);
            this.$state = basicTooltipState;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03372 c03372 = new C03372(this.$state, continuation);
            c03372.L$0 = obj;
            return c03372;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
            return ((C03372) create(pointerInputScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                */
                public final java.lang.Object invokeSuspend(java.lang.Object r14) {
                    ...
                    L45:
                        ...
                        androidx.compose.foundation.BasicTooltipState r5 = r0.$state
                        r9 = 0
                        r14.<init>(r5, r9)
                        r9 = r14
                    ...
                    L87:
                        ...
                        if (r14 == 0) goto L98
                        androidx.compose.foundation.BasicTooltipState r14 = r0.$state
                        r14.dismiss()
                    L98:
                        r14 = r0
                        r0 = r1
                        ...
                        goto L2f
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.BasicTooltip_androidKt.C03372.AnonymousClass1.C00091.invokeSuspend(java.lang.Object):java.lang.Object");
                }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    CoroutineScope coroutineScope = (CoroutineScope) this.L$0;
                    this.label = 1;
                    if (this.$$this$pointerInput.awaitPointerEventScope(new C00091(coroutineScope, this.$state, null), this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i != 1) {
            ...
            public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                ...
                SemanticsPropertiesKt.onLongClick(semanticsPropertyReceiver, str2, new Function0<Boolean>() { // from class: androidx.compose.foundation.BasicTooltip_androidKt.anchorSemantics.1.1
                    ...
                    public final Boolean invoke() {
                        BuildersKt__Builders_commonKt.launch$default(coroutineScope2, null, null, new C00051(basicTooltipState2, null), 3, null);
                        return true;
                    }
                });
            }
