...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline mo819createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m3242getWidthimpl(size) - topStart, 0.0f);
        Path.lineTo(Size.m3242getWidthimpl(size), topStart);
        float f2 = layoutDirection == LayoutDirection.Ltr ? bottomEnd : bottomStart;
        Path.lineTo(Size.m3242getWidthimpl(size), Size.m3239getHeightimpl(size) - f2);
        Path.lineTo(Size.m3242getWidthimpl(size) - f2, Size.m3239getHeightimpl(size));
        if (layoutDirection == LayoutDirection.Ltr) {
            bottomEnd = bottomStart;
        }
        Path.lineTo(bottomEnd, Size.m3239getHeightimpl(size));
        Path.lineTo(0.0f, Size.m3239getHeightimpl(size) - bottomEnd);
        Path.close();
