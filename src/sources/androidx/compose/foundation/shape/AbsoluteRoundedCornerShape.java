...
public final class AbsoluteRoundedCornerShape extends CornerBasedShape {
    ...
    public Outline mo819createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        return new Outline.Rounded(RoundRectKt.m3225RoundRectZAM2FJo(SizeKt.m3263toRectuvyYCjk(size), CornerRadiusKt.CornerRadius$default(topStart, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(topEnd, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(bottomEnd, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(bottomStart, 0.0f, 2, null)));
    }
    ...
    private final long m823toRadiusBz7bX_o(float f) {
