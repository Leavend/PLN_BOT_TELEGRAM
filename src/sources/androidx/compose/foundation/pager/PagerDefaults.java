...
public final class PagerDefaults {
    ...
    public final SnapFlingBehavior flingBehavior(PagerState pagerState, PagerSnapDistance pagerSnapDistance, AnimationSpec<Float> animationSpec, DecayAnimationSpec<Float> decayAnimationSpec, AnimationSpec<Float> animationSpec2, float f, Composer composer, int i, int i2) {
        ...
        Object[] objArr = {pagerState, animationSpec3, decayAnimationSpecRememberSplineBasedDecay, animationSpecSpring$default, pagerSnapDistanceAtMost, (Density) objConsume};
    ...
    public final SnapFlingBehavior m792flingBehaviorPfoAEA0(PagerState pagerState, PagerSnapDistance pagerSnapDistance, AnimationSpec<Float> animationSpec, DecayAnimationSpec<Float> decayAnimationSpec, AnimationSpec<Float> animationSpec2, float f, float f2, Composer composer, int i, int i2) {
