...
public final class PagerMeasureKt {
    ...
    public static final PagerMeasureResult m798measurePager_JDW0YA(final LazyLayoutMeasureScope lazyLayoutMeasureScope, int i, final PagerLazyLayoutItemProvider pagerLazyLayoutItemProvider, int i2, int i3, int i4, int i5, int i6, int i7, long j, final Orientation orientation, final Alignment.Vertical vertical, final Alignment.Horizontal horizontal, final boolean z, final long j2, final int i8, int i9, List<Integer> list, SnapPositionInLayout snapPositionInLayout, final MutableState<Unit> mutableState, Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> function3) {
        ...
        if (i <= 0) {
            return new PagerMeasureResult(CollectionsKt.emptyList(), i8, i5, i4, orientation, -i3, i2 + i4, false, i9, null, null, 0.0f, 0, false, function3.invoke(Integer.valueOf(Constraints.m5693getMinWidthimpl(j)), Integer.valueOf(Constraints.m5692getMinHeightimpl(j)), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$4
        ...
        final long jConstraints$default = ConstraintsKt.Constraints$default(0, orientation == Orientation.Vertical ? Constraints.m5691getMaxWidthimpl(j) : i8, 0, orientation != Orientation.Vertical ? Constraints.m5690getMaxHeightimpl(j) : i8, 5, null);
        int i19 = i6;
        int i20 = i7;
        while (i19 > 0 && i20 > 0) {
            i19--;
        ...
        while (i24 < 0 && i25 > 0) {
            int i26 = i25 - 1;
            MeasuredPage measuredPageM797getAndMeasureSGf7dI0 = m797getAndMeasureSGf7dI0(lazyLayoutMeasureScope, i26, jConstraints$default, pagerLazyLayoutItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope.getLayoutDirection(), z, i8);
            arrayDeque.add(0, measuredPageM797getAndMeasureSGf7dI0);
            iMax = Math.max(iMax, measuredPageM797getAndMeasureSGf7dI0.getCrossAxisSize());
            i24 += iCoerceAtLeast;
            i25 = i26;
        }
        if (i24 < i23) {
        ...
        while (i33 < i && (i31 < iCoerceAtLeast2 || i31 <= 0 || arrayDeque.isEmpty())) {
            ...
            MeasuredPage measuredPageM797getAndMeasureSGf7dI02 = m797getAndMeasureSGf7dI0(lazyLayoutMeasureScope, i33, jConstraints$default, pagerLazyLayoutItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope.getLayoutDirection(), z, i8);
            int i36 = i - 1;
            i31 += i33 == i36 ? i8 : iCoerceAtLeast;
            if (i31 > i23 || i33 == i36) {
                iMax = Math.max(iMax, measuredPageM797getAndMeasureSGf7dI02.getCrossAxisSize());
                arrayDeque.add(measuredPageM797getAndMeasureSGf7dI02);
                i18 = i29;
            } else {
                i18 = i33 + 1;
                i34 -= iCoerceAtLeast;
        ...
        if (i31 < i2) {
            ...
            while (i34 < i3 && i12 > 0) {
                i12--;
                MeasuredPage measuredPageM797getAndMeasureSGf7dI03 = m797getAndMeasureSGf7dI0(lazyLayoutMeasureScope, i12, jConstraints$default, pagerLazyLayoutItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope.getLayoutDirection(), z, i8);
                arrayDeque.add(0, measuredPageM797getAndMeasureSGf7dI03);
                iMax = Math.max(iMax, measuredPageM797getAndMeasureSGf7dI03.getCrossAxisSize());
                i34 += iCoerceAtLeast;
            }
            z2 = false;
            if (i34 < 0) {
        ...
        if (i3 > 0 || i5 < 0) {
            ...
            while (i42 < size && i41 != 0 && iCoerceAtLeast <= i41) {
                i14 = i40;
                if (i42 == CollectionsKt.getLastIndex(arrayDeque)) {
                    break;
                }
                i41 -= iCoerceAtLeast;
                i42++;
        ...
        List<MeasuredPage> listCreatePagesBeforeList = createPagesBeforeList(i12, i9, list, new Function1<Integer, MeasuredPage>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$extraPagesBefore$1
            ...
            public final MeasuredPage invoke(int i43) {
                ...
                return PagerMeasureKt.m797getAndMeasureSGf7dI0(lazyLayoutMeasureScope2, i43, jConstraints$default, pagerLazyLayoutItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope2.getLayoutDirection(), z, i8);
            }
        });
        int iMax2 = i13;
        int i43 = 0;
        ...
        List<MeasuredPage> listCreatePagesAfterList = createPagesAfterList(((MeasuredPage) arrayDeque.last()).getIndex(), i, i9, list, new Function1<Integer, MeasuredPage>() { // from class: androidx.compose.foundation.pager.PagerMeasureKt$measurePager$extraPagesAfter$1
            ...
            public final MeasuredPage invoke(int i44) {
                LazyLayoutMeasureScope lazyLayoutMeasureScope2 = lazyLayoutMeasureScope;
                return PagerMeasureKt.m797getAndMeasureSGf7dI0(lazyLayoutMeasureScope2, i44, jConstraints$default, pagerLazyLayoutItemProvider, j2, orientation, horizontal, vertical, lazyLayoutMeasureScope2.getLayoutDirection(), z, i8);
            }
        });
        ...
        boolean z5 = Intrinsics.areEqual(measuredPage2, arrayDeque.first()) && listCreatePagesBeforeList.isEmpty() && listCreatePagesAfterList.isEmpty();
        ...
        int iM5705constrainWidthK40F9xA = ConstraintsKt.m5705constrainWidthK40F9xA(j3, i16);
        if (orientation == Orientation.Vertical) {
            iMax2 = i39;
        }
        int iM5704constrainHeightK40F9xA = ConstraintsKt.m5704constrainHeightK40F9xA(j3, iMax2);
        int i45 = i33;
        final List<MeasuredPage> listCalculatePagesOffsets = calculatePagesOffsets(lazyLayoutMeasureScope, arrayDeque, listCreatePagesBeforeList, listCreatePagesAfterList, iM5705constrainWidthK40F9xA, iM5704constrainHeightK40F9xA, i39, i2, i14, orientation, z, lazyLayoutMeasureScope, i5, i8);
        if (z5) {
        ...
        MeasuredPage measuredPageCalculateNewCurrentPage = calculateNewCurrentPage(orientation == Orientation.Vertical ? iM5704constrainHeightK40F9xA : iM5705constrainWidthK40F9xA, list2, i3, i4, iCoerceAtLeast, snapPositionInLayout);
    ...
    public static final MeasuredPage m797getAndMeasureSGf7dI0(LazyLayoutMeasureScope lazyLayoutMeasureScope, int i, long j, PagerLazyLayoutItemProvider pagerLazyLayoutItemProvider, long j2, Orientation orientation, Alignment.Horizontal horizontal, Alignment.Vertical vertical, LayoutDirection layoutDirection, boolean z, int i2) {
        return new MeasuredPage(i, i2, lazyLayoutMeasureScope.mo729measure0kLqBqw(i, j), j2, pagerLazyLayoutItemProvider.getKey(i), orientation, horizontal, vertical, layoutDirection, z, null);
    }
    ...
    private static final List<MeasuredPage> calculatePagesOffsets(LazyLayoutMeasureScope lazyLayoutMeasureScope, List<MeasuredPage> list, List<MeasuredPage> list2, List<MeasuredPage> list3, int i, int i2, int i3, int i4, int i5, Orientation orientation, boolean z, Density density, int i6, int i7) {
        ...
        if (z2) {
            ...
            Arrangement.HorizontalOrVertical horizontalOrVerticalM477spacedBy0680j_4 = Arrangement.Absolute.INSTANCE.m477spacedBy0680j_4(lazyLayoutMeasureScope.mo313toDpu2uoSUM(i6));
            if (orientation == Orientation.Vertical) {
                horizontalOrVerticalM477spacedBy0680j_4.arrange(density, i9, iArr, iArr2);
            } else {
                horizontalOrVerticalM477spacedBy0680j_4.arrange(density, i9, iArr, LayoutDirection.Ltr, iArr2);
            }
