...
public final class MeasuredPage implements PageInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            long jM790getOffsetBjo55l4 = m790getOffsetBjo55l4(i);
            if (this.reverseLayout) {
                int iM5863getXimpl = this.isVertical ? IntOffset.m5863getXimpl(jM790getOffsetBjo55l4) : (this.mainAxisLayoutSize - IntOffset.m5863getXimpl(jM790getOffsetBjo55l4)) - getMainAxisSize(placeable);
                if (this.isVertical) {
                    iM5864getYimpl = (this.mainAxisLayoutSize - IntOffset.m5864getYimpl(jM790getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    iM5864getYimpl = IntOffset.m5864getYimpl(jM790getOffsetBjo55l4);
                }
                jM790getOffsetBjo55l4 = IntOffsetKt.IntOffset(iM5863getXimpl, iM5864getYimpl);
            }
            long j = this.visualOffset;
            long jIntOffset = IntOffsetKt.IntOffset(IntOffset.m5863getXimpl(jM790getOffsetBjo55l4) + IntOffset.m5863getXimpl(j), IntOffset.m5864getYimpl(jM790getOffsetBjo55l4) + IntOffset.m5864getYimpl(j));
            if (this.isVertical) {
                Placeable.PlacementScope.m4738placeWithLayeraW9wM$default(scope, placeable, jIntOffset, 0.0f, null, 6, null);
            } else {
                Placeable.PlacementScope.m4737placeRelativeWithLayeraW9wM$default(scope, placeable, jIntOffset, 0.0f, null, 6, null);
            }
        }
    }
    ...
    private final long m790getOffsetBjo55l4(int index) {
        int[] iArr = this.placeableOffsets;
        int i = index * 2;
    ...
    private final long m789copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
