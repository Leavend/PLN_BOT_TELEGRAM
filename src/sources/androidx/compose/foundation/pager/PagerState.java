...
public abstract class PagerState implements ScrollableState {
    ...
    public PagerState(int i, float f) {
        ...
        if (z) {
            this.upDownDifference = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3162boximpl(Offset.INSTANCE.m3189getZeroF1C5BW0()), null, 2, null);
    ...
    public final long m803getUpDownDifferenceF1C5BW0$foundation_release() {
    ...
    public final void m805setUpDownDifferencek4lQ0M$foundation_release(long j) {
        this.upDownDifference.setValue(Offset.m3162boximpl(j));
    }
    ...
    public final float getPositionThresholdFraction$foundation_release() {
        return Math.min(this.density.mo316toPx0680j_4(PagerStateKt.getDefaultPositionThreshold()), getPageSize$foundation_release() / 2.0f) / getPageSize$foundation_release();
    }
    ...
    public final void m804setPremeasureConstraintsBRTryo0$foundation_release(long j) {
    ...
    public final MutableState<Unit> m801getPlacementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    */
    public final java.lang.Object animateScrollToPage(int r20, float r21, androidx.compose.animation.core.AnimationSpec<java.lang.Float> r22, kotlin.coroutines.Continuation<? super kotlin.Unit> r23) throws java.lang.Throwable {
        /*
    ...
    */
    static /* synthetic */ java.lang.Object scroll$suspendImpl(androidx.compose.foundation.pager.PagerState r5, androidx.compose.foundation.MutatePriority r6, kotlin.jvm.functions.Function2<? super androidx.compose.foundation.gestures.ScrollScope, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        /*
            boolean r0 = r8 instanceof androidx.compose.foundation.pager.PagerState.C04241
            if (r0 == 0) goto L14
            r0 = r8
            androidx.compose.foundation.pager.PagerState$scroll$1 r0 = (androidx.compose.foundation.pager.PagerState.C04241) r0
            int r1 = r0.label
    ...
    private final boolean isGestureActionMatchesScroll(float scrollDelta) {
        return (getLayoutInfo().getOrientation() != Orientation.Vertical ? (Math.signum(scrollDelta) > Math.signum(-Offset.m3173getXimpl(m803getUpDownDifferenceF1C5BW0$foundation_release())) ? 1 : (Math.signum(scrollDelta) == Math.signum(-Offset.m3173getXimpl(m803getUpDownDifferenceF1C5BW0$foundation_release())) ? 0 : -1)) == 0 : (Math.signum(scrollDelta) > Math.signum(-Offset.m3174getYimpl(m803getUpDownDifferenceF1C5BW0$foundation_release())) ? 1 : (Math.signum(scrollDelta) == Math.signum(-Offset.m3174getYimpl(m803getUpDownDifferenceF1C5BW0$foundation_release())) ? 0 : -1)) == 0) || isNotGestureAction();
    }

    private final boolean isNotGestureAction() {
        return ((int) Offset.m3173getXimpl(m803getUpDownDifferenceF1C5BW0$foundation_release())) == 0 && ((int) Offset.m3174getYimpl(m803getUpDownDifferenceF1C5BW0$foundation_release())) == 0;
    }
            ...
            if (!info.getVisiblePagesInfo().isEmpty()) {
                ...
                if (index != this.indexToPrefetch) {
                    if (index >= 0 && index < getPageCount()) {
                        ...
                        this.currentPrefetchHandle = this.prefetchState.m730schedulePrefetch0kLqBqw(index, this.premeasureConstraints);
                    }
                }
            }
        }
