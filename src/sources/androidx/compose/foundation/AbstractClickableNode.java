...
abstract class AbstractClickableNode extends DelegatingNode implements PointerInputModifierNode, KeyInputModifierNode {
    ...
    public static final class InteractionData {
        ...
        private long centreOffset = Offset.INSTANCE.m3189getZeroF1C5BW0();
    ...
    public static /* synthetic */ void m179updateCommonXHw0xAI$default(AbstractClickableNode abstractClickableNode, MutableInteractionSource mutableInteractionSource, boolean z, String str, Role role, Function0 function0, int i, Object obj) {
        if (obj != null) {
    ...
    protected final void m183updateCommonXHw0xAI(MutableInteractionSource interactionSource, boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick) {
    ...
    public boolean mo180onKeyEventZmokQxo(KeyEvent event) {
        if (this.enabled && Clickable_androidKt.m262isPressZmokQxo(event)) {
            if (!this.interactionData.getCurrentKeyPressInteractions().containsKey(Key.m4111boximpl(KeyEvent_androidKt.m4422getKeyZmokQxo(event)))) {
                PressInteraction.Press press = new PressInteraction.Press(this.interactionData.getCentreOffset(), null);
                this.interactionData.getCurrentKeyPressInteractions().put(Key.m4111boximpl(KeyEvent_androidKt.m4422getKeyZmokQxo(event)), press);
        ...
        } else if (this.enabled && Clickable_androidKt.m260isClickZmokQxo(event)) {
            PressInteraction.Press pressRemove = this.interactionData.getCurrentKeyPressInteractions().remove(Key.m4111boximpl(KeyEvent_androidKt.m4422getKeyZmokQxo(event)));
            if (pressRemove != null) {
