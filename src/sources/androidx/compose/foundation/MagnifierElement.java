...
public final class MagnifierElement extends ModifierNodeElement<MagnifierNode> {
    ...
    public /* synthetic */ MagnifierElement(Function1 function1, Function1 function12, Function1 function13, float f, boolean z, long j, float f2, float f3, boolean z2, PlatformMagnifierFactory platformMagnifierFactory, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(function1, (i & 2) != 0 ? null : function12, (i & 4) != 0 ? null : function13, (i & 8) != 0 ? Float.NaN : f, (i & 16) != 0 ? false : z, (i & 32) != 0 ? DpSize.INSTANCE.m5842getUnspecifiedMYxV2XQ() : j, (i & 64) != 0 ? Dp.INSTANCE.m5755getUnspecifiedD9Ej5fM() : f2, (i & 128) != 0 ? Dp.INSTANCE.m5755getUnspecifiedD9Ej5fM() : f3, (i & 256) != 0 ? true : z2, platformMagnifierFactory, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (Intrinsics.areEqual(this.sourceCenter, magnifierElement.sourceCenter) && Intrinsics.areEqual(this.magnifierCenter, magnifierElement.magnifierCenter)) {
            return ((this.zoom > magnifierElement.zoom ? 1 : (this.zoom == magnifierElement.zoom ? 0 : -1)) == 0) && this.useTextDefault == magnifierElement.useTextDefault && DpSize.m5830equalsimpl0(this.size, magnifierElement.size) && Dp.m5740equalsimpl0(this.cornerRadius, magnifierElement.cornerRadius) && Dp.m5740equalsimpl0(this.elevation, magnifierElement.elevation) && this.clippingEnabled == magnifierElement.clippingEnabled && Intrinsics.areEqual(this.onSizeChanged, magnifierElement.onSizeChanged) && Intrinsics.areEqual(this.platformMagnifierFactory, magnifierElement.platformMagnifierFactory);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int iHashCode2 = (((((((((((((iHashCode + (function1 != null ? function1.hashCode() : 0)) * 31) + Float.hashCode(this.zoom)) * 31) + Boolean.hashCode(this.useTextDefault)) * 31) + DpSize.m5835hashCodeimpl(this.size)) * 31) + Dp.m5741hashCodeimpl(this.cornerRadius)) * 31) + Dp.m5741hashCodeimpl(this.elevation)) * 31) + Boolean.hashCode(this.clippingEnabled)) * 31;
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("size", DpSize.m5821boximpl(this.size));
        inspectorInfo.getProperties().set("cornerRadius", Dp.m5733boximpl(this.cornerRadius));
        inspectorInfo.getProperties().set("elevation", Dp.m5733boximpl(this.elevation));
