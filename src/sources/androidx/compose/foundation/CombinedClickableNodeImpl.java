...
final class CombinedClickableNodeImpl extends AbstractClickableNode implements CombinedClickableNode {
    ...
    public void mo264updatexpl5gLE(Function0<Unit> onClick, String onLongClickLabel, Function0<Unit> onLongClick, Function0<Unit> onDoubleClick, MutableInteractionSource interactionSource, boolean enabled, String onClickLabel, Role role) {
        if ((this.onLongClick == null) != (onLongClick == null)) {
            disposeInteractionSource();
        }
        this.onLongClick = onLongClick;
        m183updateCommonXHw0xAI(interactionSource, enabled, onClickLabel, role, onClick);
        getClickableSemanticsNode().m259updateUMe6uN4(enabled, onClickLabel, role, onClick, onLongClickLabel, onLongClick);
