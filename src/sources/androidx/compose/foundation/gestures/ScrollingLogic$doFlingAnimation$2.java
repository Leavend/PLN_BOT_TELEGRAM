...
final class ScrollingLogic$doFlingAnimation$2 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final Function1<Offset, Offset> function1 = new Function1<Offset, Offset>() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$outerScopeScroll$1
                ...
                public /* bridge */ /* synthetic */ Offset invoke(Offset offset) {
                    return Offset.m3162boximpl(m417invokeMKHz9U(offset.getPackedValue()));
                }

                /* renamed from: invoke-MK-Hz9U, reason: not valid java name */
                public final long m417invokeMKHz9U(long j2) {
                    ScrollingLogic scrollingLogic4 = scrollingLogic3;
                    return scrollingLogic4.m409reverseIfNeededMKHz9U(scrollingLogic4.m405dispatchScroll3eAAhYA(scrollScope, scrollingLogic4.m409reverseIfNeededMKHz9U(j2), NestedScrollSource.INSTANCE.m4453getFlingWNlRxjI()));
                }
            };
            ...
            ScrollScope scrollScope2 = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$scope$1
                ...
                public float scrollBy(float pixels) {
                    ...
                    return scrollingLogic5.m413toFloatk4lQ0M(function1.invoke(Offset.m3162boximpl(scrollingLogic5.m414toOffsettuRUvjQ(pixels))).getPackedValue());
                }
            };
            ...
            float fReverseIfNeeded = scrollingLogic.reverseIfNeeded(scrollingLogic.m412toFloatTH1AsA0(j2));
        ...
        longRef.element = scrollingLogic.m415updateQWom1Mo(j, scrollingLogic2.reverseIfNeeded(((Number) obj).floatValue()));
