...
final class ScrollableNode extends DelegatingNode implements ObserverModifierNode, CompositionLocalConsumerModifierNode, FocusPropertiesModifierNode, KeyInputModifierNode {
    ...
    public boolean mo180onKeyEventZmokQxo(KeyEvent event) {
        long jOffset;
        if (!this.enabled || ((!Key.m4114equalsimpl0(KeyEvent_androidKt.m4422getKeyZmokQxo(event), Key.INSTANCE.m4302getPageDownEK5gGoQ()) && !Key.m4114equalsimpl0(KeyEvent_androidKt.m4422getKeyZmokQxo(event), Key.INSTANCE.m4303getPageUpEK5gGoQ())) || !KeyEventType.m4415equalsimpl0(KeyEvent_androidKt.m4423getTypeZmokQxo(event), KeyEventType.INSTANCE.m4419getKeyDownCS__XNY()) || KeyEvent_androidKt.m4426isCtrlPressedZmokQxo(event))) {
            return false;
        }
        ScrollingLogic scrollingLogic = this.scrollingLogic;
        if (this.orientation == Orientation.Vertical) {
            int iM5904getHeightimpl = IntSize.m5904getHeightimpl(this.contentInViewNode.getViewportSize());
            jOffset = OffsetKt.Offset(0.0f, Key.m4114equalsimpl0(KeyEvent_androidKt.m4422getKeyZmokQxo(event), Key.INSTANCE.m4303getPageUpEK5gGoQ()) ? iM5904getHeightimpl : -iM5904getHeightimpl);
        } else {
            int iM5905getWidthimpl = IntSize.m5905getWidthimpl(this.contentInViewNode.getViewportSize());
            jOffset = OffsetKt.Offset(Key.m4114equalsimpl0(KeyEvent_androidKt.m4422getKeyZmokQxo(event), Key.INSTANCE.m4303getPageUpEK5gGoQ()) ? iM5905getWidthimpl : -iM5905getWidthimpl, 0.0f);
        }
