...
final class TransformableStateKt$animatePanBy$2 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            AnimationState animationState = new AnimationState(VectorConvertersKt.getVectorConverter(Offset.INSTANCE), Offset.m3162boximpl(this.$previous.element), null, 0L, 0L, false, 60, null);
            Offset offsetM3162boximpl = Offset.m3162boximpl(this.$offset);
            AnimationSpec<Offset> animationSpec = this.$animationSpec;
            final Ref.LongRef longRef = this.$previous;
            this.label = 1;
            if (SuspendAnimationKt.animateTo$default(animationState, offsetM3162boximpl, animationSpec, false, new Function1<AnimationScope<Offset, AnimationVector2D>, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableStateKt$animatePanBy$2.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(AnimationScope<Offset, AnimationVector2D> animationScope) {
                    TransformScope.m422transformByd4ec7I$default(transformScope, 0.0f, Offset.m3177minusMKHz9U(animationScope.getValue().getPackedValue(), longRef.element), 0.0f, 5, null);
