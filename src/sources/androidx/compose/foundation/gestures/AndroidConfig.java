...
final class AndroidConfig implements ScrollConfig {
    ...
    public long mo322calculateMouseWheelScroll8xgXZGE(Density density, PointerEvent pointerEvent, long j) {
        List<PointerInputChange> changes = pointerEvent.getChanges();
        Offset offsetM3162boximpl = Offset.m3162boximpl(Offset.INSTANCE.m3189getZeroF1C5BW0());
        int size = changes.size();
        for (int i = 0; i < size; i++) {
            offsetM3162boximpl = Offset.m3162boximpl(Offset.m3178plusMKHz9U(offsetM3162boximpl.getPackedValue(), changes.get(i).getScrollDelta()));
        }
        return Offset.m3180timestuRUvjQ(offsetM3162boximpl.getPackedValue(), -density.mo316toPx0680j_4(Dp.m5735constructorimpl(64)));
    }
}
