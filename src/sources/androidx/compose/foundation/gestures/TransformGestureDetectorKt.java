...
public final class TransformGestureDetectorKt {
    ...
    static final class AnonymousClass2 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Path cross not found for [B:60:0x0152, B:53:0x013b], limit reached: 88 */
        ...
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:16:0x00a4 -> B:18:0x00a7). Please report as a decompilation issue!!! */
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        /*
    ...
    public static final float calculateRotation(PointerEvent pointerEvent) {
        ...
        while (i4 < size2) {
            ...
            if (pointerInputChange2.getPressed() && pointerInputChange2.getPreviousPressed()) {
                ...
                long jM3177minusMKHz9U = Offset.m3177minusMKHz9U(pointerInputChange2.getPreviousPosition(), jCalculateCentroid2);
                long jM3177minusMKHz9U2 = Offset.m3177minusMKHz9U(position, jCalculateCentroid);
                float fM421anglek4lQ0M = m421anglek4lQ0M(jM3177minusMKHz9U2) - m421anglek4lQ0M(jM3177minusMKHz9U);
                float fM3171getDistanceimpl = Offset.m3171getDistanceimpl(Offset.m3178plusMKHz9U(jM3177minusMKHz9U2, jM3177minusMKHz9U)) / 2.0f;
                if (fM421anglek4lQ0M > 180.0f) {
                    fM421anglek4lQ0M -= 360.0f;
                } else if (fM421anglek4lQ0M < -180.0f) {
                    fM421anglek4lQ0M += 360.0f;
                }
                f3 += fM421anglek4lQ0M * fM3171getDistanceimpl;
                f2 += fM3171getDistanceimpl;
            }
            i4++;
            f = 0.0f;
        }
    ...
    private static final float m421anglek4lQ0M(long j) {
        if (Offset.m3173getXimpl(j) == 0.0f) {
            if (Offset.m3174getYimpl(j) == 0.0f) {
                return 0.0f;
            }
        }
        return ((-((float) Math.atan2(Offset.m3173getXimpl(j), Offset.m3174getYimpl(j)))) * 180.0f) / 3.1415927f;
    }
    ...
    public static final long calculatePan(PointerEvent pointerEvent) {
        long jCalculateCentroid = calculateCentroid(pointerEvent, true);
        if (Offset.m3170equalsimpl0(jCalculateCentroid, Offset.INSTANCE.m3188getUnspecifiedF1C5BW0())) {
            return Offset.INSTANCE.m3189getZeroF1C5BW0();
        }
        return Offset.m3177minusMKHz9U(jCalculateCentroid, calculateCentroid(pointerEvent, false));
    }
    ...
    public static final float calculateCentroidSize(PointerEvent pointerEvent, boolean z) {
        ...
        float fM3171getDistanceimpl = 0.0f;
        if (Offset.m3170equalsimpl0(jCalculateCentroid, Offset.INSTANCE.m3188getUnspecifiedF1C5BW0())) {
            return 0.0f;
        }
        List<PointerInputChange> changes = pointerEvent.getChanges();
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                fM3171getDistanceimpl += Offset.m3171getDistanceimpl(Offset.m3177minusMKHz9U(z ? pointerInputChange.getPosition() : pointerInputChange.getPreviousPosition(), jCalculateCentroid));
                i++;
            }
        }
        return fM3171getDistanceimpl / i;
    }
    ...
    public static final long calculateCentroid(PointerEvent pointerEvent, boolean z) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            PointerInputChange pointerInputChange = changes.get(i2);
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                jM3189getZeroF1C5BW0 = Offset.m3178plusMKHz9U(jM3189getZeroF1C5BW0, z ? pointerInputChange.getPosition() : pointerInputChange.getPreviousPosition());
                i++;
            }
        }
        if (i == 0) {
        ...
        return Offset.m3168divtuRUvjQ(jM3189getZeroF1C5BW0, i);
    }
}
