...
public final class ScrollingLayoutNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo90measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        CheckScrollableContainerConstraintsKt.m241checkScrollableContainerConstraintsK40F9xA(j, this.isVertical ? Orientation.Vertical : Orientation.Horizontal);
        final Placeable placeableMo4684measureBRTryo0 = measurable.mo4684measureBRTryo0(Constraints.m5682copyZbe2FdA$default(j, 0, this.isVertical ? Constraints.m5691getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, this.isVertical ? Integer.MAX_VALUE : Constraints.m5690getMaxHeightimpl(j), 5, null));
        int iCoerceAtMost = RangesKt.coerceAtMost(placeableMo4684measureBRTryo0.getWidth(), Constraints.m5691getMaxWidthimpl(j));
        int iCoerceAtMost2 = RangesKt.coerceAtMost(placeableMo4684measureBRTryo0.getHeight(), Constraints.m5690getMaxHeightimpl(j));
        final int height = placeableMo4684measureBRTryo0.getHeight() - iCoerceAtMost2;
        int width = placeableMo4684measureBRTryo0.getWidth() - iCoerceAtMost;
        if (!this.isVertical) {
            height = width;
        }
        ...
        return MeasureScope.layout$default(measureScope, iCoerceAtMost, iCoerceAtMost2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.ScrollingLayoutNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                Placeable.PlacementScope.placeRelativeWithLayer$default(placementScope, placeableMo4684measureBRTryo0, this.this$0.getIsVertical() ? 0 : i, this.this$0.getIsVertical() ? i : 0, 0.0f, null, 12, null);
            }
        }, 4, null);
    }
