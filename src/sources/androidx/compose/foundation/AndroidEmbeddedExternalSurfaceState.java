...
final class AndroidEmbeddedExternalSurfaceState extends BaseAndroidExternalSurfaceState implements TextureView.SurfaceTextureListener {
    ...
    public AndroidEmbeddedExternalSurfaceState(CoroutineScope coroutineScope) {
        ...
        this.surfaceSize = IntSize.INSTANCE.m5910getZeroYbymL2g();
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int width, int height) {
        if (!IntSize.m5903equalsimpl0(this.surfaceSize, IntSize.INSTANCE.m5910getZeroYbymL2g())) {
            width = IntSize.m5905getWidthimpl(this.surfaceSize);
            height = IntSize.m5904getHeightimpl(this.surfaceSize);
