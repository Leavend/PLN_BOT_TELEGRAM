    ...
    private static final class DefaultDebugIndicationInstance implements IndicationInstance {
        ...
        public void drawIndication(ContentDrawScope contentDrawScope) {
            ...
            if (this.isPressed.getValue().booleanValue()) {
                DrawScope.m3958drawRectnJ9OG0$default(contentDrawScope, Color.m3413copywmQWz5c$default(Color.INSTANCE.m3440getBlack0d7_KjU(), 0.3f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo3963getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
            } else if (this.isHovered.getValue().booleanValue() || this.isFocused.getValue().booleanValue()) {
                DrawScope.m3958drawRectnJ9OG0$default(contentDrawScope, Color.m3413copywmQWz5c$default(Color.INSTANCE.m3440getBlack0d7_KjU(), 0.1f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo3963getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
            }
        }
    }
