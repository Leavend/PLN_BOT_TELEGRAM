...
public final class BorderKt {
    ...
    public static final Modifier border(Modifier modifier, BorderStroke borderStroke, Shape shape) {
        return m226borderziNgDLE(modifier, borderStroke.getWidth(), borderStroke.getBrush(), shape);
    }

    /* renamed from: border-xT4_qwU$default, reason: not valid java name */
    public static /* synthetic */ Modifier m225borderxT4_qwU$default(Modifier modifier, float f, long j, Shape shape, int i, Object obj) {
        if ((i & 4) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        return m224borderxT4_qwU(modifier, f, j, shape);
    }

    /* renamed from: border-xT4_qwU, reason: not valid java name */
    public static final Modifier m224borderxT4_qwU(Modifier modifier, float f, long j, Shape shape) {
        return m226borderziNgDLE(modifier, f, new SolidColor(j, null), shape);
    }

    /* renamed from: border-ziNgDLE, reason: not valid java name */
    public static final Modifier m226borderziNgDLE(Modifier modifier, float f, Brush brush, Shape shape) {
    ...
    public static final DrawResult m227drawRectBorderNsqcLGU(CacheDrawScope cacheDrawScope, final Brush brush, long j, long j2, boolean z, float f) {
        final long jM3189getZeroF1C5BW0 = z ? Offset.INSTANCE.m3189getZeroF1C5BW0() : j;
        final long jM3080getSizeNHjbRc = z ? cacheDrawScope.m3080getSizeNHjbRc() : j2;
        ...
        return cacheDrawScope.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderKt$drawRectBorder$1
            ...
            public final void invoke2(ContentDrawScope contentDrawScope) {
                contentDrawScope.drawContent();
                DrawScope.m3957drawRectAsUm42w$default(contentDrawScope, brush, jM3189getZeroF1C5BW0, jM3080getSizeNHjbRc, 0.0f, stroke, null, 0, 104, null);
            }
        });
    }
    ...
    public static final Path createRoundRectPath(Path path, RoundRect roundRect, float f, boolean z) {
        ...
        if (!z) {
            ...
            path.mo3306opN5in7k0(path, Path, PathOperation.INSTANCE.m3705getDifferenceb3I0S0c());
        }
        return path;
    }

    private static final RoundRect createInsetRoundedRect(float f, RoundRect roundRect) {
        return new RoundRect(f, f, roundRect.getWidth() - f, roundRect.getHeight() - f, m228shrinkKibmq7A(roundRect.m3223getTopLeftCornerRadiuskKHJgLs(), f), m228shrinkKibmq7A(roundRect.m3224getTopRightCornerRadiuskKHJgLs(), f), m228shrinkKibmq7A(roundRect.m3222getBottomRightCornerRadiuskKHJgLs(), f), m228shrinkKibmq7A(roundRect.m3221getBottomLeftCornerRadiuskKHJgLs(), f), null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: shrink-Kibmq7A, reason: not valid java name */
    public static final long m228shrinkKibmq7A(long j, float f) {
        return CornerRadiusKt.CornerRadius(Math.max(0.0f, CornerRadius.m3148getXimpl(j) - f), Math.max(0.0f, CornerRadius.m3149getYimpl(j) - f));
    }
}
