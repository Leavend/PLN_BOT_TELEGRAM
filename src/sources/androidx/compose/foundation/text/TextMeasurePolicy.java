    ...
    public MeasureResult mo37measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        if (listInvoke != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                Pair pair = rect != null ? new Pair(list.get(i).mo4684measureBRTryo0(ConstraintsKt.Constraints$default(0, (int) Math.floor(rect.getWidth()), 0, (int) Math.floor(rect.getHeight()), 5, null)), IntOffset.m5854boximpl(IntOffsetKt.IntOffset(MathKt.roundToInt(rect.getLeft()), MathKt.roundToInt(rect.getTop())))) : null;
                if (pair != null) {
                    arrayList2.add(pair);
                }
            }
        ...
        return MeasureScope.layout$default(measureScope, Constraints.m5691getMaxWidthimpl(j), Constraints.m5690getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.TextMeasurePolicy$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (list2 != null) {
                    ...
                    for (int i2 = 0; i2 < size2; i2++) {
                        ...
                        Placeable.PlacementScope.m4735place70tqf50$default(placementScope, pair2.component1(), pair2.component2().getPackedValue(), 0.0f, 2, null);
                    }
                }
            }
        }, 4, null);
