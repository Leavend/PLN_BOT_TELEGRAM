        ...
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.text.HeightInLinesModifierKt$heightInLines$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier modifier2, Composer composer, int i3) {
                ...
                if (zChanged2 || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                    ...
                    FontStyle fontStyleM5267getFontStyle4Lr2A7w = textStyle3.m5267getFontStyle4Lr2A7w();
                    int iM5348unboximpl = fontStyleM5267getFontStyle4Lr2A7w != null ? fontStyleM5267getFontStyle4Lr2A7w.m5348unboximpl() : FontStyle.INSTANCE.m5352getNormal_LCdwA();
                    FontSynthesis fontSynthesisM5268getFontSynthesisZQGJjVo = textStyle3.m5268getFontSynthesisZQGJjVo();
                    objRememberedValue2 = resolver.mo5320resolveDPcqOEQ(fontFamily, fontWeight, iM5348unboximpl, fontSynthesisM5268getFontSynthesisZQGJjVo != null ? fontSynthesisM5268getFontSynthesisZQGJjVo.getValue() : FontSynthesis.INSTANCE.m5362getAllGVVA2EU());
                ...
                if (zChanged3 || objRememberedValue3 == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue3 = Integer.valueOf(IntSize.m5904getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(textStyle3, density, resolver, TextFieldDelegateKt.getEmptyTextReplacement(), 1)));
                ...
                if (zChanged4 || objRememberedValue4 == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue4 = Integer.valueOf(IntSize.m5904getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(textStyle3, density, resolver, TextFieldDelegateKt.getEmptyTextReplacement() + '\n' + TextFieldDelegateKt.getEmptyTextReplacement(), 2)));
                ...
                Modifier modifierM601heightInVpY3zN4 = SizeKt.m601heightInVpY3zN4(Modifier.INSTANCE, numValueOf != null ? density.mo313toDpu2uoSUM(numValueOf.intValue()) : Dp.INSTANCE.m5755getUnspecifiedD9Ej5fM(), numValueOf2 != null ? density.mo313toDpu2uoSUM(numValueOf2.intValue()) : Dp.INSTANCE.m5755getUnspecifiedD9Ej5fM());
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                composer.endReplaceableGroup();
                return modifierM601heightInVpY3zN4;
            }
        });
    }
}
