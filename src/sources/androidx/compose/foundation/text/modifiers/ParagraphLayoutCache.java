...
public final class ParagraphLayoutCache {
    ...
    private ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3) {
        ...
        this.maxLines = i2;
        this.minLines = i3;
        this.lastDensity = InlineDensity.INSTANCE.m959getUnspecifiedL26CHvs();
        this.layoutSize = IntSizeKt.IntSize(0, 0);
        this.prevConstraints = Constraints.INSTANCE.m5699fixedJhjzzOo(0, 0);
    ...
    public /* synthetic */ ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m5676getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, null);
    }
    ...
    public final void setDensity$foundation_release(Density density) {
        ...
        long jM951constructorimpl = density != null ? InlineDensity.m951constructorimpl(density) : InlineDensity.INSTANCE.m959getUnspecifiedL26CHvs();
        if (density2 == null) {
            this.density = density;
            this.lastDensity = jM951constructorimpl;
        } else if (density == null || !InlineDensity.m953equalsimpl0(this.lastDensity, jM951constructorimpl)) {
            this.density = density;
            this.lastDensity = jM951constructorimpl;
            markDirty();
        }
    ...
    public final void m975setLayoutSizeozmzZPI$foundation_release(long j) {
        this.layoutSize = j;
    }

    /* renamed from: layoutWithConstraints-K40F9xA, reason: not valid java name */
    public final boolean m974layoutWithConstraintsK40F9xA(long constraints, LayoutDirection layoutDirection) {
        boolean z = true;
        if (this.minLines > 1) {
            ...
            constraints = minLinesConstrainerFrom.m963coerceMinLinesOh53vG4$foundation_release(constraints, this.minLines);
        }
        boolean z2 = false;
        if (!m972newLayoutWillBeDifferentK40F9xA(constraints, layoutDirection)) {
            if (!Constraints.m5684equalsimpl0(constraints, this.prevConstraints)) {
                Paragraph paragraph = this.paragraph;
                Intrinsics.checkNotNull(paragraph);
                this.layoutSize = ConstraintsKt.m5702constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(Math.min(paragraph.getMaxIntrinsicWidth(), paragraph.getWidth())), TextDelegateKt.ceilToIntPx(paragraph.getHeight())));
                if (TextOverflow.m5669equalsimpl0(this.overflow, TextOverflow.INSTANCE.m5678getVisiblegIe3tQ8()) || (IntSize.m5905getWidthimpl(r3) >= paragraph.getWidth() && IntSize.m5904getHeightimpl(r3) >= paragraph.getHeight())) {
                    z = false;
                }
                this.didOverflow = z;
        ...
        Paragraph paragraphM971layoutTextK40F9xA = m971layoutTextK40F9xA(constraints, layoutDirection);
        this.prevConstraints = constraints;
        this.layoutSize = ConstraintsKt.m5702constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(paragraphM971layoutTextK40F9xA.getWidth()), TextDelegateKt.ceilToIntPx(paragraphM971layoutTextK40F9xA.getHeight())));
        if (!TextOverflow.m5669equalsimpl0(this.overflow, TextOverflow.INSTANCE.m5678getVisiblegIe3tQ8()) && (IntSize.m5905getWidthimpl(r9) < paragraphM971layoutTextK40F9xA.getWidth() || IntSize.m5904getHeightimpl(r9) < paragraphM971layoutTextK40F9xA.getHeight())) {
            z2 = true;
        }
        this.didOverflow = z2;
        this.paragraph = paragraphM971layoutTextK40F9xA;
        return true;
    }
    ...
    public final int intrinsicHeight(int width, LayoutDirection layoutDirection) {
        ...
        int iCeilToIntPx = TextDelegateKt.ceilToIntPx(m971layoutTextK40F9xA(ConstraintsKt.Constraints(0, width, 0, Integer.MAX_VALUE), layoutDirection).getHeight());
    ...
    public final void m976updateL6sJoHM(String text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int overflow, boolean softWrap, int maxLines, int minLines) {
        this.text = text;
        this.style = style;
    ...
    private final Paragraph m971layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ParagraphIntrinsics layoutDirection2 = setLayoutDirection(layoutDirection);
        return ParagraphKt.m5128Paragraph_EkL_Y(layoutDirection2, LayoutUtilsKt.m960finalConstraintstfFHcEY(constraints, this.softWrap, this.overflow, layoutDirection2.getMaxIntrinsicWidth()), LayoutUtilsKt.m961finalMaxLinesxdlQI24(this.softWrap, this.overflow, this.maxLines), TextOverflow.m5669equalsimpl0(this.overflow, TextOverflow.INSTANCE.m5677getEllipsisgIe3tQ8()));
    }

    /* renamed from: newLayoutWillBeDifferent-K40F9xA, reason: not valid java name */
    private final boolean m972newLayoutWillBeDifferentK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        return Constraints.m5691getMaxWidthimpl(constraints) != Constraints.m5691getMaxWidthimpl(this.prevConstraints) || ((float) Constraints.m5690getMaxHeightimpl(constraints)) < paragraph.getHeight() || paragraph.getDidExceedMaxLines();
    }
    ...
    public final TextLayoutResult slowCreateTextLayoutResultOrNull(TextStyle style) {
        ...
        long jM5682copyZbe2FdA$default = Constraints.m5682copyZbe2FdA$default(this.prevConstraints, 0, 0, 0, 0, 10, null);
        return new TextLayoutResult(new TextLayoutInput(annotatedString, style, CollectionsKt.emptyList(), this.maxLines, this.softWrap, this.overflow, density, layoutDirection, this.fontFamilyResolver, jM5682copyZbe2FdA$default, (DefaultConstructorMarker) null), new MultiParagraph(new MultiParagraphIntrinsics(annotatedString, style, (List<AnnotatedString.Range<Placeholder>>) CollectionsKt.emptyList(), density, this.fontFamilyResolver), jM5682copyZbe2FdA$default, this.maxLines, TextOverflow.m5669equalsimpl0(this.overflow, TextOverflow.INSTANCE.m5677getEllipsisgIe3tQ8()), null), this.layoutSize, null);
    }
