...
public final class SelectionControllerKt {
    ...
    public static final Modifier makeSelectionModifier(final SelectionRegistrar selectionRegistrar, final long j, final Function0<? extends LayoutCoordinates> function0) {
        TextDragObserver textDragObserver = new TextDragObserver() { // from class: androidx.compose.foundation.text.modifiers.SelectionControllerKt$makeSelectionModifier$longPressDragObserver$1
            private long lastPosition = Offset.INSTANCE.m3189getZeroF1C5BW0();
            private long dragTotalDistance = Offset.INSTANCE.m3189getZeroF1C5BW0();
            ...
            public void mo910onStartk4lQ0M(long startPoint) {
                ...
                if (layoutCoordinatesInvoke != null) {
                    ...
                    selectionRegistrar2.mo1055notifySelectionUpdateStartubNVwUQ(layoutCoordinatesInvoke, startPoint, SelectionAdjustment.INSTANCE.getWord(), true);
            ...
            public void mo909onDragk4lQ0M(long delta) {
                ...
                if (layoutCoordinatesInvoke != null) {
                    ...
                    if (layoutCoordinatesInvoke.isAttached() && SelectionRegistrarKt.hasSelection(selectionRegistrar2, j2)) {
                        long jM3178plusMKHz9U = Offset.m3178plusMKHz9U(this.dragTotalDistance, delta);
                        this.dragTotalDistance = jM3178plusMKHz9U;
                        long jM3178plusMKHz9U2 = Offset.m3178plusMKHz9U(this.lastPosition, jM3178plusMKHz9U);
                        if (selectionRegistrar2.mo1054notifySelectionUpdatenjBpvok(layoutCoordinatesInvoke, jM3178plusMKHz9U2, this.lastPosition, false, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate(), true)) {
                            this.lastPosition = jM3178plusMKHz9U2;
                            this.dragTotalDistance = Offset.INSTANCE.m3189getZeroF1C5BW0();
                        }
                    }
                }
        ...
        return SelectionGesturesKt.selectionGestureInput(Modifier.INSTANCE, new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.modifiers.SelectionControllerKt$makeSelectionModifier$mouseSelectionObserver$1
            ...
            public boolean mo982onExtendk4lQ0M(long downPosition) {
                ...
                if (selectionRegistrar2.mo1054notifySelectionUpdatenjBpvok(layoutCoordinatesInvoke, downPosition, this.lastPosition, false, SelectionAdjustment.INSTANCE.getNone(), false)) {
            ...
            public boolean mo983onExtendDragk4lQ0M(long dragPosition) {
                ...
                if (!selectionRegistrar2.mo1054notifySelectionUpdatenjBpvok(layoutCoordinatesInvoke, dragPosition, this.lastPosition, false, SelectionAdjustment.INSTANCE.getNone(), false)) {
                    return true;
                }
            ...
            public boolean mo984onStart3MmeM6k(long downPosition, SelectionAdjustment adjustment) {
                ...
                selectionRegistrar2.mo1055notifySelectionUpdateStartubNVwUQ(layoutCoordinatesInvoke, downPosition, adjustment, false);
                this.lastPosition = downPosition;
                return SelectionRegistrarKt.hasSelection(selectionRegistrar2, j2);
            }
            ...
            public boolean mo981onDrag3MmeM6k(long dragPosition, SelectionAdjustment adjustment) {
                ...
                if (!selectionRegistrar2.mo1054notifySelectionUpdatenjBpvok(layoutCoordinatesInvoke, dragPosition, this.lastPosition, false, adjustment, false)) {
                    return true;
                }
                this.lastPosition = dragPosition;
                return true;
