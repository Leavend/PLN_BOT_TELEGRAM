...
public final class InlineDensity {
    ...
    private static final long Unspecified = m949constructorimpl(Float.NaN, Float.NaN);
    private final long packedValue;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ InlineDensity m948boximpl(long j) {
    ...
    public static boolean m952equalsimpl(long j, Object obj) {
    ...
    public boolean equals(Object obj) {
        return m952equalsimpl(this.packedValue, obj);
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m951constructorimpl(Density density) {
        return m949constructorimpl(density.getDensity(), density.getFontScale());
    }
    ...
    public static String m957toStringimpl(long j) {
        return "InlineDensity(density=" + m954getDensityimpl(j) + ", fontScale=" + m955getFontScaleimpl(j) + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m959getUnspecifiedL26CHvs() {
            return InlineDensity.Unspecified;
        }
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m949constructorimpl(float f, float f2) {
        return m950constructorimpl((Float.floatToRawIntBits(f2) & InternalZipConstants.ZIP_64_SIZE_LIMIT) | (Float.floatToRawIntBits(f) << 32));
    }

    /* renamed from: getDensity-impl, reason: not valid java name */
    public static final float m954getDensityimpl(long j) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* renamed from: getFontScale-impl, reason: not valid java name */
    public static final float m955getFontScaleimpl(long j) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
