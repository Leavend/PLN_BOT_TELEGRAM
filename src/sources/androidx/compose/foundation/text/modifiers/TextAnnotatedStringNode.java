...
public final class TextAnnotatedStringNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public /* synthetic */ TextAnnotatedStringNode(AnnotatedString annotatedString, TextStyle textStyle, FontFamily.Resolver resolver, Function1 function1, int i, boolean z, int i2, int i3, List list, Function1 function12, SelectionController selectionController, ColorProducer colorProducer, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, resolver, (i4 & 8) != 0 ? null : function1, (i4 & 16) != 0 ? TextOverflow.INSTANCE.m5676getClipgIe3tQ8() : i, (i4 & 32) != 0 ? true : z, (i4 & 64) != 0 ? Integer.MAX_VALUE : i2, (i4 & 128) != 0 ? 1 : i3, (i4 & 256) != 0 ? null : list, (i4 & 512) != 0 ? null : function12, (i4 & 1024) != 0 ? null : selectionController, (i4 & 2048) != 0 ? null : colorProducer, null);
    }
    ...
    public final boolean m986updateLayoutRelatedArgsMPT68mk(TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow) {
        ...
        if (TextOverflow.m5669equalsimpl0(this.overflow, overflow)) {
            return z;
        }
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged, boolean callbacksChanged) {
        if (getIsAttached()) {
            ...
            if (textChanged || layoutChanged || callbacksChanged) {
                getLayoutCache().m970updateZNqEYIc(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders);
    ...
    public final boolean setSubstitution(AnnotatedString updatedText) {
        ...
        if (textSubstitution != null) {
            ...
            if (layoutCache != null) {
                layoutCache.m970updateZNqEYIc(updatedText, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders);
                unit = Unit.INSTANCE;
            } else {
                unit = null;
            }
                ...
                */
                public final java.lang.Boolean invoke(java.util.List<androidx.compose.ui.text.TextLayoutResult> r38) {
                    ...
                    L31:
                        ...
                        r36 = 0
                        androidx.compose.ui.text.TextStyle r5 = androidx.compose.ui.text.TextStyle.m5255mergedA7vx0o$default(r5, r6, r8, r10, r11, r12, r13, r14, r15, r17, r18, r19, r20, r22, r23, r24, r25, r26, r27, r29, r30, r31, r32, r33, r34, r35, r36)
                        androidx.compose.ui.text.TextLayoutInput r3 = r2.getLayoutInput()
                        ...
                        r6 = 2
                        r7 = 0
                        androidx.compose.ui.text.TextLayoutResult r1 = androidx.compose.ui.text.TextLayoutResult.m5205copyO0kMr_c$default(r2, r3, r4, r6, r7)
                        if (r1 == 0) goto Lb8
                        r2 = r38
                        r2.add(r1)
                        goto Lb9
    ...
    public final MeasureResult m985measureNonExtension3p2s80s(MeasureScope measureScope, Measurable measurable, long constraints) {
    ...
    public MeasureResult mo90measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        boolean zM969layoutWithConstraintsK40F9xA = layoutCache.m969layoutWithConstraintsK40F9xA(j, measureScope.getLayoutDirection());
        ...
        if (zM969layoutWithConstraintsK40F9xA) {
        ...
        final Placeable placeableMo4684measureBRTryo0 = measurable.mo4684measureBRTryo0(LayoutUtilsKt.fixedCoerceHeightAndWidthForBits(Constraints.INSTANCE, IntSize.m5905getWidthimpl(textLayoutResult.getSize()), IntSize.m5904getHeightimpl(textLayoutResult.getSize())));
        int iM5905getWidthimpl = IntSize.m5905getWidthimpl(textLayoutResult.getSize());
        int iM5904getHeightimpl = IntSize.m5904getHeightimpl(textLayoutResult.getSize());
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return measureScope.layout(iM5905getWidthimpl, iM5904getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextAnnotatedStringNode$measure$1
            {
                super(1);
            }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        if (getIsAttached()) {
            ...
            boolean z = true;
            boolean z2 = textLayoutResult.getHasVisualOverflow() && !TextOverflow.m5669equalsimpl0(this.overflow, TextOverflow.INSTANCE.m5678getVisiblegIe3tQ8());
            if (z2) {
                Rect rectM3213Recttz77jQw = RectKt.m3213Recttz77jQw(Offset.INSTANCE.m3189getZeroF1C5BW0(), SizeKt.Size(IntSize.m5905getWidthimpl(textLayoutResult.getSize()), IntSize.m5904getHeightimpl(textLayoutResult.getSize())));
                canvas.save();
                Canvas.m3387clipRectmtrdDE$default(canvas, rectM3213Recttz77jQw, 0, 2, null);
            }
            try {
                ...
                if (brush != null) {
                    multiParagraph.m5116painthn5TExg(canvas, brush, (64 & 4) != 0 ? Float.NaN : this.style.getAlpha(), (64 & 8) != 0 ? null : shadow2, (64 & 16) != 0 ? null : textDecoration2, (64 & 32) != 0 ? null : drawStyle2, (64 & 64) != 0 ? DrawScope.INSTANCE.m3964getDefaultBlendMode0nO6VwU() : 0);
                } else {
                    ColorProducer colorProducer = this.overrideColor;
                    long jM3495invoke0d7_KjU = colorProducer != null ? colorProducer.m3495invoke0d7_KjU() : Color.INSTANCE.m3450getUnspecified0d7_KjU();
                    if (!(jM3495invoke0d7_KjU != Color.INSTANCE.m3450getUnspecified0d7_KjU())) {
                        if (this.style.m5265getColor0d7_KjU() != Color.INSTANCE.m3450getUnspecified0d7_KjU()) {
                            jM3495invoke0d7_KjU = this.style.m5265getColor0d7_KjU();
                        } else {
                            jM3495invoke0d7_KjU = Color.INSTANCE.m3440getBlack0d7_KjU();
                        }
                    }
                    multiParagraph.m5114paintLG529CI(canvas, (32 & 2) != 0 ? Color.INSTANCE.m3450getUnspecified0d7_KjU() : jM3495invoke0d7_KjU, (32 & 4) != 0 ? null : shadow2, (32 & 8) != 0 ? null : textDecoration2, (32 & 16) == 0 ? drawStyle2 : null, (32 & 32) != 0 ? DrawScope.INSTANCE.m3964getDefaultBlendMode0nO6VwU() : 0);
                }
