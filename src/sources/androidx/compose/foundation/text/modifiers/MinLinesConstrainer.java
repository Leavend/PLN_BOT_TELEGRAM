...
public final class MinLinesConstrainer {
    ...
    public final long m963coerceMinLinesOh53vG4$foundation_release(long inConstraints, int minLines) {
        ...
        if (Float.isNaN(height) || Float.isNaN(height2)) {
            height = ParagraphKt.m5126ParagraphUdtVg6A(MinLinesConstrainerKt.EmptyTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (64 & 32) != 0 ? CollectionsKt.emptyList() : null, (64 & 64) != 0 ? CollectionsKt.emptyList() : null, (64 & 128) != 0 ? Integer.MAX_VALUE : 1, (64 & 256) != 0 ? false : false).getHeight();
            height2 = ParagraphKt.m5126ParagraphUdtVg6A(MinLinesConstrainerKt.TwoLineTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (64 & 32) != 0 ? CollectionsKt.emptyList() : null, (64 & 64) != 0 ? CollectionsKt.emptyList() : null, (64 & 128) != 0 ? Integer.MAX_VALUE : 2, (64 & 256) != 0 ? false : false).getHeight() - height;
            this.oneLineHeightCache = height;
            this.lineHeightCache = height2;
        }
        if (minLines != 1) {
            iM5692getMinHeightimpl = RangesKt.coerceAtMost(RangesKt.coerceAtLeast(MathKt.roundToInt(height + (height2 * (minLines - 1))), 0), Constraints.m5690getMaxHeightimpl(inConstraints));
        } else {
            iM5692getMinHeightimpl = Constraints.m5692getMinHeightimpl(inConstraints);
        }
        return ConstraintsKt.Constraints(Constraints.m5693getMinWidthimpl(inConstraints), Constraints.m5691getMaxWidthimpl(inConstraints), iM5692getMinHeightimpl, Constraints.m5690getMaxHeightimpl(inConstraints));
    }
}
