...
public final class SelectableInfo {
    ...
    public String toString() {
        return "SelectionInfo(id=" + this.selectableId + ", range=(" + this.rawStartHandleOffset + Soundex.SILENT_MARKER + getStartRunDirection() + ',' + this.rawEndHandleOffset + Soundex.SILENT_MARKER + getEndRunDirection() + "), prevOffset=" + this.rawPreviousHandleOffset + ')';
    }
}
