...
public final class SelectionManager_androidKt {
    ...
    public static final boolean m1047isCopyKeyEventZmokQxo(KeyEvent keyEvent) {
        return KeyMapping_androidKt.getPlatformDefaultKeyMapping().mo864mapZmokQxo(keyEvent) == KeyCommand.COPY;
    }
        ...
        public final Modifier invoke(Modifier modifier, Composer composer, int i) {
            ...
            Function0<Offset> function0 = new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt.selectionMagnifier.1.1
                ...
                public /* bridge */ /* synthetic */ Offset invoke() {
                    return Offset.m3162boximpl(m1048invokeF1C5BW0());
                }

                /* renamed from: invoke-F1C5BW0, reason: not valid java name */
                public final long m1048invokeF1C5BW0() {
                    return SelectionManagerKt.m1044calculateSelectionMagnifierCenterAndroidO0kMr_c(selectionManager, AnonymousClass1.invoke$lambda$1(mutableState));
                }
            };
                    ...
                    public final Modifier invoke2(final Function0<Offset> function02) {
                        ...
                        Function1<Density, Offset> function1 = new Function1<Density, Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$2$1.1
                            ...
                            public /* bridge */ /* synthetic */ Offset invoke(Density density2) {
                                return Offset.m3162boximpl(m1049invoketuRUvjQ(density2));
                            }

                            /* renamed from: invoke-tuRUvjQ, reason: not valid java name */
                            public final long m1049invoketuRUvjQ(Density density2) {
                                return function02.invoke().getPackedValue();
                            }
                        };
                        final Density density2 = density;
                        final MutableState<IntSize> mutableState2 = mutableState;
                        return Magnifier_androidKt.m283magnifierjPUL71Q$default(companion, function1, null, new Function1<DpSize, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$2$1.2
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            }
                            ...
                            public /* bridge */ /* synthetic */ Unit invoke(DpSize dpSize) {
                                m1050invokeEaSLcWc(dpSize.getPackedValue());
                                return Unit.INSTANCE;
                            }

                            /* renamed from: invoke-EaSLcWc, reason: not valid java name */
                            public final void m1050invokeEaSLcWc(long j) {
                                MutableState<IntSize> mutableState3 = mutableState2;
                                Density density3 = density2;
                                SelectionManager_androidKt.AnonymousClass1.invoke$lambda$2(mutableState3, IntSizeKt.IntSize(density3.mo310roundToPx0680j_4(DpSize.m5833getWidthD9Ej5fM(j)), density3.mo310roundToPx0680j_4(DpSize.m5831getHeightD9Ej5fM(j))));
                            }
