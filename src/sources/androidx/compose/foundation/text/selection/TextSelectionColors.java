...
public final class TextSelectionColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3415equalsimpl0(this.handleColor, textSelectionColors.handleColor) && Color.m3415equalsimpl0(this.backgroundColor, textSelectionColors.backgroundColor);
    }

    public int hashCode() {
        return (Color.m3421hashCodeimpl(this.handleColor) * 31) + Color.m3421hashCodeimpl(this.backgroundColor);
    }

    public String toString() {
        return "SelectionColors(selectionHandleColor=" + ((Object) Color.m3422toStringimpl(this.handleColor)) + ", selectionBackgroundColor=" + ((Object) Color.m3422toStringimpl(this.backgroundColor)) + ')';
    }
}
