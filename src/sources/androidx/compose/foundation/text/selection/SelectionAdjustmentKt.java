...
public final class SelectionAdjustmentKt {
    ...
    public static final Selection.AnchorInfo updateSelectionBoundary(final SelectionLayout selectionLayout, final SelectableInfo selectableInfo, Selection.AnchorInfo anchorInfo) {
        ...
        long jM5209getWordBoundaryjx7JFs = selectableInfo.getTextLayoutResult().m5209getWordBoundaryjx7JFs(offset);
        if (!isExpanding(selectableInfo, rawStartHandleOffset, selectionLayout.getIsStartHandle())) {
            return selectableInfo.anchorForOffset(rawStartHandleOffset);
        }
        if (offset == TextRange.m5235getStartimpl(jM5209getWordBoundaryjx7JFs) || offset == TextRange.m5230getEndimpl(jM5209getWordBoundaryjx7JFs)) {
            return updateSelectionBoundary$lambda$1(lazy2);
        }
        return selectableInfo.anchorForOffset(rawStartHandleOffset);
    }
    ...
    public static final Selection.AnchorInfo snapToWordBoundary(SelectableInfo selectableInfo, int i, int i2, int i3, boolean z, boolean z2) {
        int lineStart;
        int lineEnd$default;
        long jM5209getWordBoundaryjx7JFs = selectableInfo.getTextLayoutResult().m5209getWordBoundaryjx7JFs(i2);
        if (selectableInfo.getTextLayoutResult().getLineForOffset(TextRange.m5235getStartimpl(jM5209getWordBoundaryjx7JFs)) == i) {
            lineStart = TextRange.m5235getStartimpl(jM5209getWordBoundaryjx7JFs);
        ...
        if (selectableInfo.getTextLayoutResult().getLineForOffset(TextRange.m5230getEndimpl(jM5209getWordBoundaryjx7JFs)) == i) {
            lineEnd$default = TextRange.m5230getEndimpl(jM5209getWordBoundaryjx7JFs);
        } else if (i >= selectableInfo.getTextLayoutResult().getLineCount()) {
    ...
    private static final Selection.AnchorInfo anchorOnBoundary(SelectableInfo selectableInfo, boolean z, boolean z2, int i, BoundaryFunction boundaryFunction) {
        ...
        long jMo991getBoundaryfzxv0v0 = boundaryFunction.mo991getBoundaryfzxv0v0(selectableInfo, rawStartHandleOffset);
        return selectableInfo.anchorForOffset(z ^ z2 ? TextRange.m5235getStartimpl(jMo991getBoundaryfzxv0v0) : TextRange.m5230getEndimpl(jMo991getBoundaryfzxv0v0));
    }
