...
public final class TextFieldPreparedSelection extends BaseTextPreparedSelection<TextFieldPreparedSelection> {
    ...
    public final TextFieldValue getValue() {
        return TextFieldValue.m5469copy3r_uNRQ$default(this.currentValue, getAnnotatedString(), getSelection(), (TextRange) null, 4, (Object) null);
    }
    ...
    public final List<EditCommand> deleteIfSelectedOr(Function1<? super TextFieldPreparedSelection, ? extends EditCommand> or) {
        ...
        return CollectionsKt.listOf((Object[]) new EditCommand[]{new CommitTextCommand("", 0), new SetSelectionCommand(TextRange.m5233getMinimpl(getSelection()), TextRange.m5233getMinimpl(getSelection()))});
    }
    ...
    */
    private final int jumpByPagesOffset(androidx.compose.foundation.text.TextLayoutResultProxy r6, int r7) {
        ...
        L1b:
            ...
            int r1 = androidx.compose.ui.text.TextRange.m5230getEndimpl(r3)
            ...
            float r1 = r0.getLeft()
            float r0 = r0.getTop()
            long r2 = r2.m3206getSizeNHjbRc()
            float r2 = androidx.compose.ui.geometry.Size.m3239getHeightimpl(r2)
            float r7 = (float) r7
            float r2 = r2 * r7
            float r0 = r0 + r2
            ...
            int r6 = r6.m5207getOffsetForPositionk4lQ0M(r0)
