...
public final class SelectionHandlesKt {
    ...
    public static final long m1008getAdjustedCoordinatesk4lQ0M(long j) {
        return OffsetKt.Offset(Offset.m3173getXimpl(j), Offset.m3174getYimpl(j) - 1.0f);
    }

    static {
        float f = 25;
        HandleWidth = Dp.m5735constructorimpl(f);
        HandleHeight = Dp.m5735constructorimpl(f);
    }
}
