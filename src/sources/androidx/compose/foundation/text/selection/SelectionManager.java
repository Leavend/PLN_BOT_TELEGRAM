...
public final class SelectionManager {
    ...
    private final MutableState dragBeginPosition = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3162boximpl(Offset.INSTANCE.m3189getZeroF1C5BW0()), null, 2, null);

    /* renamed from: dragTotalDistance$delegate, reason: from kotlin metadata */
    private final MutableState dragTotalDistance = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m3162boximpl(Offset.INSTANCE.m3189getZeroF1C5BW0()), null, 2, null);
    ...
    public SelectionManager(SelectionRegistrarImpl selectionRegistrarImpl) {
        ...
        selectionRegistrarImpl.setOnSelectionUpdateStartCallback$foundation_release(new Function4<Boolean, LayoutCoordinates, Offset, SelectionAdjustment, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.2
            ...
            public /* bridge */ /* synthetic */ Unit invoke(Boolean bool, LayoutCoordinates layoutCoordinates, Offset offset, SelectionAdjustment selectionAdjustment) {
                m1040invokeRg1IO4c(bool.booleanValue(), layoutCoordinates, offset.getPackedValue(), selectionAdjustment);
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-Rg1IO4c, reason: not valid java name */
            public final void m1040invokeRg1IO4c(boolean z, LayoutCoordinates layoutCoordinates, long j, SelectionAdjustment selectionAdjustment) {
                long jMo4691getSizeYbymL2g = layoutCoordinates.mo4691getSizeYbymL2g();
                Rect rect = new Rect(0.0f, 0.0f, IntSize.m5905getWidthimpl(jMo4691getSizeYbymL2g), IntSize.m5904getHeightimpl(jMo4691getSizeYbymL2g));
                if (!SelectionManagerKt.m1045containsInclusiveUv8p0NA(rect, j)) {
                    j = TextLayoutStateKt.m1151coerceIn3MmeM6k(j, rect);
                }
                long jM1024convertToContainerCoordinatesR5De75A = SelectionManager.this.m1024convertToContainerCoordinatesR5De75A(layoutCoordinates, j);
                if (OffsetKt.m3192isSpecifiedk4lQ0M(jM1024convertToContainerCoordinatesR5De75A)) {
                    SelectionManager.this.setInTouchMode(z);
                    SelectionManager.this.m1031startSelection9KIMszo(jM1024convertToContainerCoordinatesR5De75A, false, selectionAdjustment);
        ...
        selectionRegistrarImpl.setOnSelectionUpdateCallback$foundation_release(new Function6<Boolean, LayoutCoordinates, Offset, Offset, Boolean, SelectionAdjustment, Boolean>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.4
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(Boolean bool, LayoutCoordinates layoutCoordinates, Offset offset, Offset offset2, Boolean bool2, SelectionAdjustment selectionAdjustment) {
                return m1041invokepGV3PM0(bool.booleanValue(), layoutCoordinates, offset.getPackedValue(), offset2.getPackedValue(), bool2.booleanValue(), selectionAdjustment);
            }

            /* renamed from: invoke-pGV3PM0, reason: not valid java name */
            public final Boolean m1041invokepGV3PM0(boolean z, LayoutCoordinates layoutCoordinates, long j, long j2, boolean z2, SelectionAdjustment selectionAdjustment) {
                long jM1024convertToContainerCoordinatesR5De75A = SelectionManager.this.m1024convertToContainerCoordinatesR5De75A(layoutCoordinates, j);
                long jM1024convertToContainerCoordinatesR5De75A2 = SelectionManager.this.m1024convertToContainerCoordinatesR5De75A(layoutCoordinates, j2);
                SelectionManager.this.setInTouchMode(z);
                return Boolean.valueOf(SelectionManager.this.m1039updateSelectionqNKwrvQ$foundation_release(Offset.m3162boximpl(jM1024convertToContainerCoordinatesR5De75A), jM1024convertToContainerCoordinatesR5De75A2, z2, selectionAdjustment));
            }
        });
        selectionRegistrarImpl.setOnSelectionUpdateEndCallback$foundation_release(new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.5
            ...
            public final void invoke2() {
                ...
                SelectionManager.this.m1026setCurrentDragPosition_kEHs6E(null);
            }
        });
        ...
        selectionRegistrarImpl.setAfterSelectableUnsubscribe$foundation_release(new Function1<Long, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.7
            ...
            public final void invoke(long j) {
                ...
                if ((selection == null || (start = selection.getStart()) == null || j != start.getSelectableId()) ? false : true) {
                    SelectionManager.this.m1030setStartHandlePosition_kEHs6E(null);
                }
                ...
                if ((selection2 == null || (end = selection2.getEnd()) == null || j != end.getSelectableId()) ? false : true) {
                    SelectionManager.this.m1029setEndHandlePosition_kEHs6E(null);
                }
                if (SelectionManager.this.selectionRegistrar.getSubselections().containsKey(Long.valueOf(j))) {
                    SelectionManager.this.updateSelectionToolbar();
                }
    ...
    public final Modifier getModifier() {
        return KeyInputModifierKt.onKeyEvent(SelectionGesturesKt.updateSelectionTouchMode(FocusableKt.focusable$default(FocusChangedModifierKt.onFocusChanged(FocusRequesterModifierKt.focusRequester(OnGloballyPositionedModifierKt.onGloballyPositioned(onClearSelectionRequested(Modifier.INSTANCE, new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager$modifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m1042invokeZmokQxo(keyEvent.m4411unboximpl());
            }

            /* renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m1042invokeZmokQxo(android.view.KeyEvent keyEvent) {
                boolean z;
                if (SelectionManager_androidKt.m1047isCopyKeyEventZmokQxo(keyEvent)) {
    ...
    public final void setContainerLayoutCoordinates(LayoutCoordinates layoutCoordinates) {
        ...
        Offset offsetM3162boximpl = layoutCoordinates != null ? Offset.m3162boximpl(LayoutCoordinatesKt.positionInWindow(layoutCoordinates)) : null;
        if (Intrinsics.areEqual(this.previousPosition, offsetM3162boximpl)) {
            return;
        }
        this.previousPosition = offsetM3162boximpl;
        updateHandleOffsets();
        updateSelectionToolbar();
    }
    ...
    public final void m1027setDragBeginPositionk4lQ0M(long j) {
        this.dragBeginPosition.setValue(Offset.m3162boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getDragBeginPosition-F1C5BW0$foundation_release, reason: not valid java name */
    public final long m1034getDragBeginPositionF1C5BW0$foundation_release() {
    ...
    public final void m1028setDragTotalDistancek4lQ0M(long j) {
        this.dragTotalDistance.setValue(Offset.m3162boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getDragTotalDistance-F1C5BW0$foundation_release, reason: not valid java name */
    public final long m1035getDragTotalDistanceF1C5BW0$foundation_release() {
        return ((Offset) this.dragTotalDistance.getValue()).getPackedValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setStartHandlePosition-_kEHs6E, reason: not valid java name */
    public final void m1030setStartHandlePosition_kEHs6E(Offset offset) {
        this.startHandlePosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getStartHandlePosition-_m7T9-E, reason: not valid java name */
    public final Offset m1037getStartHandlePosition_m7T9E() {
        return (Offset) this.startHandlePosition.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setEndHandlePosition-_kEHs6E, reason: not valid java name */
    public final void m1029setEndHandlePosition_kEHs6E(Offset offset) {
        this.endHandlePosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getEndHandlePosition-_m7T9-E, reason: not valid java name */
    public final Offset m1036getEndHandlePosition_m7T9E() {
    ...
    public final void m1026setCurrentDragPosition_kEHs6E(Offset offset) {
        this.currentDragPosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getCurrentDragPosition-_m7T9-E, reason: not valid java name */
    public final Offset m1033getCurrentDragPosition_m7T9E() {
    ...
    */
    public final void updateHandleOffsets() {
        ...
        L43:
            ...
            r9 = 1
            if (r5 == 0) goto L77
            long r10 = r3.mo993getHandlePositiondBAh8RU(r0, r9)
            boolean r3 = androidx.compose.ui.geometry.OffsetKt.m3194isUnspecifiedk4lQ0M(r10)
            if (r3 == 0) goto L56
            goto L77
        L56:
            long r10 = r1.mo4692localPositionOfR5De75A(r5, r10)
            androidx.compose.ui.geometry.Offset r3 = androidx.compose.ui.geometry.Offset.m3162boximpl(r10)
            ...
            if (r5 == r12) goto L73
            boolean r5 = androidx.compose.foundation.text.selection.SelectionManagerKt.m1045containsInclusiveUv8p0NA(r7, r10)
            if (r5 == 0) goto L71
            goto L73
        L71:
            r5 = r8
        ...
        L77:
            r3 = r2
        L78:
            r13.m1030setStartHandlePosition_kEHs6E(r3)
            if (r6 == 0) goto La6
            long r3 = r4.mo993getHandlePositiondBAh8RU(r0, r8)
            boolean r0 = androidx.compose.ui.geometry.OffsetKt.m3194isUnspecifiedk4lQ0M(r3)
            if (r0 == 0) goto L88
            goto La6
        L88:
            long r0 = r1.mo4692localPositionOfR5De75A(r6, r3)
            androidx.compose.ui.geometry.Offset r0 = androidx.compose.ui.geometry.Offset.m3162boximpl(r0)
            long r3 = r0.getPackedValue()
            androidx.compose.foundation.text.Handle r1 = r13.getDraggingHandle()
            androidx.compose.foundation.text.Handle r5 = androidx.compose.foundation.text.Handle.SelectionEnd
            if (r1 == r5) goto La2
            boolean r1 = androidx.compose.foundation.text.selection.SelectionManagerKt.m1045containsInclusiveUv8p0NA(r7, r3)
            if (r1 == 0) goto La3
        La2:
            r8 = r9
        La3:
            ...
            r2 = r0
        La6:
            r13.m1029setEndHandlePosition_kEHs6E(r2)
            return
        Laa:
            r13.m1030setStartHandlePosition_kEHs6E(r2)
            r13.m1029setEndHandlePosition_kEHs6E(r2)
            return
        */
    ...
    public final void updateSelectionToolbar() {
        ...
        if (getHasFocus() && (textToolbar = this.textToolbar) != null) {
            if (this.showToolbar && isInTouchMode() && isNonEmptySelection$foundation_release()) {
                ...
                TextToolbar.showMenu$default(textToolbar, contentRect, new C04481(this), null, null, null, 28, null);
                return;
            }
    ...
    /* synthetic */ class C04481 extends FunctionReferenceImpl implements Function0<Unit> {
        C04481(Object obj) {
    ...
    private final Rect getContentRect() {
        ...
        return Rect.copy$default(rectIntersect.m3210translatek4lQ0M(LayoutCoordinatesKt.positionInRoot(layoutCoordinates)), 0.0f, 0.0f, 0.0f, rectIntersect.getBottom() + (SelectionHandlesKt.getHandleHeight() * 4), 7, null);
    }
    ...
    public final TextDragObserver handleDragObserver(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.SelectionManager.handleDragObserver.1
            ...
            public void mo908onDownk4lQ0M(long point) {
                LayoutCoordinates layoutCoordinates;
                Offset offsetM1037getStartHandlePosition_m7T9E = isStartHandle ? this.m1037getStartHandlePosition_m7T9E() : this.m1036getEndHandlePosition_m7T9E();
                if (offsetM1037getStartHandlePosition_m7T9E != null) {
                    offsetM1037getStartHandlePosition_m7T9E.getPackedValue();
                    ...
                    long jMo993getHandlePositiondBAh8RU = anchorSelectable$foundation_release.mo993getHandlePositiondBAh8RU(selection, isStartHandle);
                    if (OffsetKt.m3194isUnspecifiedk4lQ0M(jMo993getHandlePositiondBAh8RU)) {
                        return;
                    }
                    long jM1008getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m1008getAdjustedCoordinatesk4lQ0M(jMo993getHandlePositiondBAh8RU);
                    SelectionManager selectionManager = this;
                    selectionManager.m1026setCurrentDragPosition_kEHs6E(Offset.m3162boximpl(selectionManager.requireContainerCoordinates$foundation_release().mo4692localPositionOfR5De75A(layoutCoordinates, jM1008getAdjustedCoordinatesk4lQ0M)));
            ...
            public void mo910onStartk4lQ0M(long startPoint) {
                ...
                long jMo993getHandlePositiondBAh8RU = selectable2.mo993getHandlePositiondBAh8RU(selection, isStartHandle);
                if (OffsetKt.m3194isUnspecifiedk4lQ0M(jMo993getHandlePositiondBAh8RU)) {
                    return;
                }
                long jM1008getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m1008getAdjustedCoordinatesk4lQ0M(jMo993getHandlePositiondBAh8RU);
                SelectionManager selectionManager = this;
                selectionManager.m1027setDragBeginPositionk4lQ0M(selectionManager.requireContainerCoordinates$foundation_release().mo4692localPositionOfR5De75A(layoutCoordinates, jM1008getAdjustedCoordinatesk4lQ0M));
                this.m1028setDragTotalDistancek4lQ0M(Offset.INSTANCE.m3189getZeroF1C5BW0());
            }
            ...
            public void mo909onDragk4lQ0M(long delta) {
                ...
                SelectionManager selectionManager = this;
                selectionManager.m1028setDragTotalDistancek4lQ0M(Offset.m3178plusMKHz9U(selectionManager.m1035getDragTotalDistanceF1C5BW0$foundation_release(), delta));
                long jM3178plusMKHz9U = Offset.m3178plusMKHz9U(this.m1034getDragBeginPositionF1C5BW0$foundation_release(), this.m1035getDragTotalDistanceF1C5BW0$foundation_release());
                if (this.m1039updateSelectionqNKwrvQ$foundation_release(Offset.m3162boximpl(jM3178plusMKHz9U), this.m1034getDragBeginPositionF1C5BW0$foundation_release(), isStartHandle, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate())) {
                    this.m1027setDragBeginPositionk4lQ0M(jM3178plusMKHz9U);
                    this.m1028setDragTotalDistancek4lQ0M(Offset.INSTANCE.m3189getZeroF1C5BW0());
                }
            }
            ...
            private final void done() {
                ...
                this.m1026setCurrentDragPosition_kEHs6E(null);
            }
    ...
    static final class C04452 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C04452(Function1<? super Offset, Unit> function1, Continuation<? super C04452> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04452 c04452 = new C04452(this.$onTap, continuation);
            c04452.L$0 = obj;
            return c04452;
        }
        ...
        public final Object invoke(AwaitPointerEventScope awaitPointerEventScope, Continuation<? super Unit> continuation) {
            return ((C04452) create(awaitPointerEventScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (pointerInputChange != null) {
                this.$onTap.invoke(Offset.m3162boximpl(pointerInputChange.getPosition()));
            }
            return Unit.INSTANCE;
        }
    }
    ...
    public final Object detectNonConsumingTap(PointerInputScope pointerInputScope, Function1<? super Offset, Unit> function1, Continuation<? super Unit> continuation) {
        Object objAwaitEachGesture = ForEachGestureKt.awaitEachGesture(pointerInputScope, new C04452(function1, null), continuation);
    ...
    static final class C04471 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ Function0<Unit> $block;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C04471(Function0<Unit> function0, Continuation<? super C04471> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C04471 c04471 = SelectionManager.this.new C04471(this.$block, continuation);
            c04471.L$0 = obj;
            return c04471;
        }
    ...
    private final Modifier onClearSelectionRequested(Modifier modifier, Function0<Unit> function0) {
        return getHasFocus() ? SuspendingPointerInputFilterKt.pointerInput(modifier, Unit.INSTANCE, new C04471(function0, null)) : modifier;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: convertToContainerCoordinates-R5De75A, reason: not valid java name */
    public final long m1024convertToContainerCoordinatesR5De75A(LayoutCoordinates layoutCoordinates, long offset) {
        LayoutCoordinates layoutCoordinates2 = this.containerLayoutCoordinates;
        if (layoutCoordinates2 == null || !layoutCoordinates2.isAttached()) {
            return Offset.INSTANCE.m3188getUnspecifiedF1C5BW0();
        }
        return requireContainerCoordinates$foundation_release().mo4692localPositionOfR5De75A(layoutCoordinates, offset);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: startSelection-9KIMszo, reason: not valid java name */
    public final void m1031startSelection9KIMszo(long position, boolean isStartHandle, SelectionAdjustment adjustment) {
        this.previousSelectionLayout = null;
        m1038updateSelectionjyLRC_s$foundation_release(position, Offset.INSTANCE.m3188getUnspecifiedF1C5BW0(), isStartHandle, adjustment);
    }

    /* renamed from: updateSelection-qNKwrvQ$foundation_release, reason: not valid java name */
    public final boolean m1039updateSelectionqNKwrvQ$foundation_release(Offset newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        if (newPosition == null) {
            return false;
        }
        return m1038updateSelectionjyLRC_s$foundation_release(newPosition.getPackedValue(), previousPosition, isStartHandle, adjustment);
    }

    /* renamed from: updateSelection-jyLRC_s$foundation_release, reason: not valid java name */
    public final boolean m1038updateSelectionjyLRC_s$foundation_release(long position, long previousHandlePosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
        m1026setCurrentDragPosition_kEHs6E(Offset.m3162boximpl(position));
        SelectionLayout selectionLayoutM1025getSelectionLayoutWko1d7g = m1025getSelectionLayoutWko1d7g(position, previousHandlePosition, isStartHandle);
        if (!selectionLayoutM1025getSelectionLayoutWko1d7g.shouldRecomputeSelection(this.previousSelectionLayout)) {
            return false;
        }
        Selection selectionAdjust = adjustment.adjust(selectionLayoutM1025getSelectionLayoutWko1d7g);
        if (!Intrinsics.areEqual(selectionAdjust, getSelection())) {
            selectionChanged(selectionLayoutM1025getSelectionLayoutWko1d7g, selectionAdjust);
        }
        this.previousSelectionLayout = selectionLayoutM1025getSelectionLayoutWko1d7g;
        return true;
    }

    /* renamed from: getSelectionLayout-Wko1d7g, reason: not valid java name */
    private final SelectionLayout m1025getSelectionLayoutWko1d7g(long position, long previousHandlePosition, boolean isStartHandle) {
    ...
    public final void m1032contextMenuOpenAdjustmentk4lQ0M(long position) {
        Selection selection = getSelection();
        if (selection != null ? TextRange.m5229getCollapsedimpl(selection.m999toTextRanged9O1mEE()) : true) {
            m1031startSelection9KIMszo(position, true, SelectionAdjustment.INSTANCE.getWord());
        }
    }
}
