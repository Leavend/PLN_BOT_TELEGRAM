...
public final class MultiWidgetSelectionDelegateKt {
    ...
    public static final void m995appendSelectableInfoParwq6A(SelectionLayoutBuilder selectionLayoutBuilder, TextLayoutResult textLayoutResult, long j, long j2, long j3) {
        ...
        Rect rect = new Rect(0.0f, 0.0f, IntSize.m5905getWidthimpl(textLayoutResult.getSize()), IntSize.m5904getHeightimpl(textLayoutResult.getSize()));
        Direction directionM997getXDirection3MmeM6k = m997getXDirection3MmeM6k(j, rect);
        Direction directionM998getYDirection3MmeM6k = m998getYDirection3MmeM6k(j, rect);
        if (selectionLayoutBuilder.getIsStartHandle()) {
            Selection previousSelection = selectionLayoutBuilder.getPreviousSelection();
            directionAppendSelectableInfo_Parwq6A$otherDirection = appendSelectableInfo_Parwq6A$otherDirection(directionM997getXDirection3MmeM6k, directionM998getYDirection3MmeM6k, selectionLayoutBuilder, j3, previousSelection != null ? previousSelection.getEnd() : null);
            direction3 = directionAppendSelectableInfo_Parwq6A$otherDirection;
            direction4 = direction3;
            direction = directionM997getXDirection3MmeM6k;
            direction2 = directionM998getYDirection3MmeM6k;
        } else {
            Selection previousSelection2 = selectionLayoutBuilder.getPreviousSelection();
            directionAppendSelectableInfo_Parwq6A$otherDirection = appendSelectableInfo_Parwq6A$otherDirection(directionM997getXDirection3MmeM6k, directionM998getYDirection3MmeM6k, selectionLayoutBuilder, j3, previousSelection2 != null ? previousSelection2.getStart() : null);
            direction = directionAppendSelectableInfo_Parwq6A$otherDirection;
            direction2 = direction;
            direction3 = directionM997getXDirection3MmeM6k;
            direction4 = directionM998getYDirection3MmeM6k;
        }
        if (isSelected(SelectionLayoutKt.resolve2dDirection(directionM997getXDirection3MmeM6k, directionM998getYDirection3MmeM6k), directionAppendSelectableInfo_Parwq6A$otherDirection)) {
            int length = textLayoutResult.getLayoutInput().getText().length();
            if (selectionLayoutBuilder.getIsStartHandle()) {
                int iM996getOffsetForPosition3MmeM6k = m996getOffsetForPosition3MmeM6k(j, textLayoutResult);
                Selection previousSelection3 = selectionLayoutBuilder.getPreviousSelection();
                previousAdjustedOffset2 = iM996getOffsetForPosition3MmeM6k;
                previousAdjustedOffset = (previousSelection3 == null || (end = previousSelection3.getEnd()) == null) ? iM996getOffsetForPosition3MmeM6k : getPreviousAdjustedOffset(end, selectionLayoutBuilder.getSelectableIdOrderingComparator(), j3, length);
            } else {
                int iM996getOffsetForPosition3MmeM6k2 = m996getOffsetForPosition3MmeM6k(j, textLayoutResult);
                Selection previousSelection4 = selectionLayoutBuilder.getPreviousSelection();
                previousAdjustedOffset = iM996getOffsetForPosition3MmeM6k2;
                previousAdjustedOffset2 = (previousSelection4 == null || (start = previousSelection4.getStart()) == null) ? iM996getOffsetForPosition3MmeM6k2 : getPreviousAdjustedOffset(start, selectionLayoutBuilder.getSelectableIdOrderingComparator(), j3, length);
            }
            selectionLayoutBuilder.appendInfo(j3, previousAdjustedOffset2, direction, direction2, previousAdjustedOffset, direction3, direction4, OffsetKt.m3194isUnspecifiedk4lQ0M(j2) ? -1 : m996getOffsetForPosition3MmeM6k(j2, textLayoutResult), textLayoutResult);
        }
    }
    ...
    private static final Direction m997getXDirection3MmeM6k(long j, Rect rect) {
        return Offset.m3173getXimpl(j) < rect.getLeft() ? Direction.BEFORE : Offset.m3173getXimpl(j) > rect.getRight() ? Direction.AFTER : Direction.ON;
    }

    /* renamed from: getYDirection-3MmeM6k, reason: not valid java name */
    private static final Direction m998getYDirection3MmeM6k(long j, Rect rect) {
        return Offset.m3174getYimpl(j) < rect.getTop() ? Direction.BEFORE : Offset.m3174getYimpl(j) > rect.getBottom() ? Direction.AFTER : Direction.ON;
    }
    ...
    private static final int m996getOffsetForPosition3MmeM6k(long j, TextLayoutResult textLayoutResult) {
        if (Offset.m3174getYimpl(j) <= 0.0f) {
            return 0;
        }
        return Offset.m3174getYimpl(j) >= textLayoutResult.getMultiParagraph().getHeight() ? textLayoutResult.getLayoutInput().getText().length() : textLayoutResult.m5207getOffsetForPositionk4lQ0M(j);
    }
}
