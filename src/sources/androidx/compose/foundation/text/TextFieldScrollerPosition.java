...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation orientation, float f) {
        ...
        this.previousSelection = TextRange.INSTANCE.m5240getZerod9O1mEE();
    ...
    public final void m931setPreviousSelection5zctL8(long j) {
    ...
    */
    ...
    public final int m929getOffsetToFollow5zctL8(long selection) {
        return TextRange.m5235getStartimpl(selection) != TextRange.m5235getStartimpl(this.previousSelection) ? TextRange.m5235getStartimpl(selection) : TextRange.m5230getEndimpl(selection) != TextRange.m5230getEndimpl(this.previousSelection) ? TextRange.m5230getEndimpl(selection) : TextRange.m5233getMinimpl(selection);
    }
