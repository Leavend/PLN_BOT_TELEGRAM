...
public final class Clickable_androidKt {
    ...
    public static final boolean m262isPressZmokQxo(KeyEvent keyEvent) {
        return KeyEventType.m4415equalsimpl0(KeyEvent_androidKt.m4423getTypeZmokQxo(keyEvent), KeyEventType.INSTANCE.m4419getKeyDownCS__XNY()) && m261isEnterZmokQxo(keyEvent);
    }

    /* renamed from: isClick-ZmokQxo, reason: not valid java name */
    public static final boolean m260isClickZmokQxo(KeyEvent keyEvent) {
        return KeyEventType.m4415equalsimpl0(KeyEvent_androidKt.m4423getTypeZmokQxo(keyEvent), KeyEventType.INSTANCE.m4420getKeyUpCS__XNY()) && m261isEnterZmokQxo(keyEvent);
    }

    /* renamed from: isEnter-ZmokQxo, reason: not valid java name */
    private static final boolean m261isEnterZmokQxo(KeyEvent keyEvent) {
        int iM4429getNativeKeyCodeYVgTNJs = Key_androidKt.m4429getNativeKeyCodeYVgTNJs(KeyEvent_androidKt.m4422getKeyZmokQxo(keyEvent));
        return iM4429getNativeKeyCodeYVgTNJs == 23 || iM4429getNativeKeyCodeYVgTNJs == 66 || iM4429getNativeKeyCodeYVgTNJs == 160;
    }
}
