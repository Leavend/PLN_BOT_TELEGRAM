...
public abstract class RectListNode extends Modifier.Node implements GlobalPositionAwareModifierNode, CompositionLocalConsumerModifierNode {
    ...
    private final Rect calcBounds(LayoutCoordinates layoutCoordinates, androidx.compose.ui.geometry.Rect rect) {
        ...
        long jMo4692localPositionOfR5De75A = layoutCoordinatesFindRootCoordinates.mo4692localPositionOfR5De75A(layoutCoordinates, rect.m3208getTopLeftF1C5BW0());
        long jMo4692localPositionOfR5De75A2 = layoutCoordinatesFindRootCoordinates.mo4692localPositionOfR5De75A(layoutCoordinates, rect.m3209getTopRightF1C5BW0());
        long jMo4692localPositionOfR5De75A3 = layoutCoordinatesFindRootCoordinates.mo4692localPositionOfR5De75A(layoutCoordinates, rect.m3201getBottomLeftF1C5BW0());
        long jMo4692localPositionOfR5De75A4 = layoutCoordinatesFindRootCoordinates.mo4692localPositionOfR5De75A(layoutCoordinates, rect.m3202getBottomRightF1C5BW0());
        return new Rect(MathKt.roundToInt(ComparisonsKt.minOf(Offset.m3173getXimpl(jMo4692localPositionOfR5De75A), Offset.m3173getXimpl(jMo4692localPositionOfR5De75A2), Offset.m3173getXimpl(jMo4692localPositionOfR5De75A3), Offset.m3173getXimpl(jMo4692localPositionOfR5De75A4))), MathKt.roundToInt(ComparisonsKt.minOf(Offset.m3174getYimpl(jMo4692localPositionOfR5De75A), Offset.m3174getYimpl(jMo4692localPositionOfR5De75A2), Offset.m3174getYimpl(jMo4692localPositionOfR5De75A3), Offset.m3174getYimpl(jMo4692localPositionOfR5De75A4))), MathKt.roundToInt(ComparisonsKt.maxOf(Offset.m3173getXimpl(jMo4692localPositionOfR5De75A), Offset.m3173getXimpl(jMo4692localPositionOfR5De75A2), Offset.m3173getXimpl(jMo4692localPositionOfR5De75A3), Offset.m3173getXimpl(jMo4692localPositionOfR5De75A4))), MathKt.roundToInt(ComparisonsKt.maxOf(Offset.m3174getYimpl(jMo4692localPositionOfR5De75A), Offset.m3174getYimpl(jMo4692localPositionOfR5De75A2), Offset.m3174getYimpl(jMo4692localPositionOfR5De75A3), Offset.m3174getYimpl(jMo4692localPositionOfR5De75A4))));
    }
}
