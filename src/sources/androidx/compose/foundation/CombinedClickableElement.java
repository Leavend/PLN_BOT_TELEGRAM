...
final class CombinedClickableElement extends ModifierNodeElement<CombinedClickableNodeImpl> {
    ...
    public void update(CombinedClickableNodeImpl node) {
        node.mo264updatexpl5gLE(this.onClick, this.onLongClickLabel, this.onLongClick, this.onDoubleClick, this.interactionSource, this.enabled, this.onClickLabel, this.role);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        int iM5060hashCodeimpl = (((iHashCode2 + (role != null ? Role.m5060hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode()) * 31;
        String str2 = this.onLongClickLabel;
        int iHashCode3 = (iM5060hashCodeimpl + (str2 != null ? str2.hashCode() : 0)) * 31;
