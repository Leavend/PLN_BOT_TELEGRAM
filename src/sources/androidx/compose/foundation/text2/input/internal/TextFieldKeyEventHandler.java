...
public abstract class TextFieldKeyEventHandler {
    ...
    public boolean mo1107onPreKeyEventMyFupTE(KeyEvent event, TransformedTextFieldState textFieldState, TextFieldSelectionState textFieldSelectionState, FocusManager focusManager, SoftwareKeyboardController keyboardController) {
        if (TextRange.m5229getCollapsedimpl(textFieldState.getText().getSelectionInChars()) || !KeyEventHelpers_androidKt.m863cancelsTextSelectionZmokQxo(event)) {
            return false;
        }
    ...
    public boolean m1135onKeyEvent6ptp14s(KeyEvent event, TransformedTextFieldState textFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, boolean editable, boolean singleLine, Function0<Unit> onSubmit) {
        Float visibleTextLayoutHeight;
        TextRange textRangeM5223boximpl;
        Integer numM862consumeZmokQxo;
        if (!KeyEventType.m4415equalsimpl0(KeyEvent_androidKt.m4423getTypeZmokQxo(event), KeyEventType.INSTANCE.m4419getKeyDownCS__XNY())) {
            return false;
        }
        if (TextFieldKeyInput_androidKt.m926isTypedEventZmokQxo(event) && (numM862consumeZmokQxo = this.deadKeyCombiner.m862consumeZmokQxo(event)) != null) {
            String string = StringHelpers_jvmKt.appendCodePointX(new StringBuilder(2), numM862consumeZmokQxo.intValue()).toString();
            if (!editable) {
                return false;
            }
            ...
            if (textFieldState2.getMainBuffer().getChangeTracker().getChangeCount() != 0 || !TextRange.m5228equalsimpl0(text.getSelectionInChars(), textFieldState2.getMainBuffer().m1110getSelectiond9O1mEE()) || !Intrinsics.areEqual(text.getCompositionInChars(), textFieldState2.getMainBuffer().m1109getCompositionMzsxiRA())) {
                textFieldState2.commitEditAsUser(text, inputTransformation, true, textFieldEditUndoBehavior);
            }
            this.preparedSelectionState.resetCachedX();
            return true;
        }
        KeyCommand keyCommandMo864mapZmokQxo = this.keyMapping.mo864mapZmokQxo(event);
        if (keyCommandMo864mapZmokQxo == null || (keyCommandMo864mapZmokQxo.getEditsText() && !editable)) {
            return false;
        }
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[keyCommandMo864mapZmokQxo.ordinal()]) {
            case 1:
            ...
            case 19:
                ...
                break;
            case 20:
                if (!TextRange.m5229getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                    TransformedTextFieldState.m1156replaceTextSbBc2M$default(textFieldPreparedSelection.state, "", textFieldPreparedSelection.getSelection(), null, 4, null);
                } else {
                    Integer numValueOf = Integer.valueOf(textFieldPreparedSelection.getPrecedingCharacterIndex());
                    if (!(numValueOf.intValue() != -1)) {
                        numValueOf = null;
                    }
                    textRangeM5223boximpl = numValueOf != null ? TextRange.m5223boximpl(TextRangeKt.TextRange(numValueOf.intValue(), TextRange.m5230getEndimpl(textFieldPreparedSelection.getSelection()))) : null;
                    if (textRangeM5223boximpl != null) {
                        TransformedTextFieldState.m1156replaceTextSbBc2M$default(textFieldPreparedSelection.state, "", textRangeM5223boximpl.getPackedValue(), null, 4, null);
                    }
                }
                z = true;
                break;
            case 21:
                if (!TextRange.m5229getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                    ...
                    textRangeM5223boximpl = numValueOf2 != null ? TextRange.m5223boximpl(TextRangeKt.TextRange(TextRange.m5235getStartimpl(textFieldPreparedSelection.getSelection()), numValueOf2.intValue())) : null;
                    if (textRangeM5223boximpl != null) {
                        TransformedTextFieldState.m1156replaceTextSbBc2M$default(textFieldPreparedSelection.state, "", textRangeM5223boximpl.getPackedValue(), null, 4, null);
                    }
                }
            ...
            case 22:
                if (!TextRange.m5229getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                    ...
                    TransformedTextFieldState.m1156replaceTextSbBc2M$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(textFieldPreparedSelection.getPreviousWordOffset(), TextRange.m5230getEndimpl(textFieldPreparedSelection.getSelection())), null, 4, null);
                }
                z = true;
                break;
            case 23:
                if (!TextRange.m5229getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                    ...
                    TransformedTextFieldState.m1156replaceTextSbBc2M$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(TextRange.m5235getStartimpl(textFieldPreparedSelection.getSelection()), textFieldPreparedSelection.getNextWordOffset()), null, 4, null);
                }
                z = true;
                break;
            case 24:
                if (!TextRange.m5229getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                    ...
                    TransformedTextFieldState.m1156replaceTextSbBc2M$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(textFieldPreparedSelection.getLineStartByOffset(), TextRange.m5230getEndimpl(textFieldPreparedSelection.getSelection())), null, 4, null);
                }
                z = true;
                break;
            case 25:
                if (!TextRange.m5229getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                    ...
                    TransformedTextFieldState.m1156replaceTextSbBc2M$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(TextRange.m5235getStartimpl(textFieldPreparedSelection.getSelection()), textFieldPreparedSelection.getLineEndByOffset()), null, 4, null);
                }
                z = true;
                break;
            case 26:
                if (!singleLine) {
                    ...
                    if (textFieldState3.getMainBuffer().getChangeTracker().getChangeCount() != 0 || !TextRange.m5228equalsimpl0(text2.getSelectionInChars(), textFieldState3.getMainBuffer().m1110getSelectiond9O1mEE()) || !Intrinsics.areEqual(text2.getCompositionInChars(), textFieldState3.getMainBuffer().m1109getCompositionMzsxiRA())) {
            ...
            case 27:
                if (!singleLine) {
                    ...
                    if (textFieldState4.getMainBuffer().getChangeTracker().getChangeCount() != 0 || !TextRange.m5228equalsimpl0(text3.getSelectionInChars(), textFieldState4.getMainBuffer().m1110getSelectiond9O1mEE()) || !Intrinsics.areEqual(text3.getCompositionInChars(), textFieldState4.getMainBuffer().m1109getCompositionMzsxiRA())) {
        ...
        if (!TextRange.m5228equalsimpl0(textFieldPreparedSelection.getSelection(), textFieldPreparedSelection.getInitialValue().getSelectionInChars())) {
            textFieldState.m1161selectCharsIn5zctL8(textFieldPreparedSelection.getSelection());
        }
        return z;
    }
    ...
    private final void preparedSelectionContext(TransformedTextFieldState state, TextLayoutState textLayoutState, Function1<? super TextFieldPreparedSelection, Unit> block) {
        ...
        state.m1161selectCharsIn5zctL8(textFieldPreparedSelection.getSelection());
    }
    ...
    */
    private final java.lang.Float getVisibleTextLayoutHeight(androidx.compose.foundation.text2.input.internal.TextLayoutState r5) {
        ...
        L29:
            if (r5 == 0) goto L37
            long r0 = r5.m3206getSizeNHjbRc()
            float r5 = androidx.compose.ui.geometry.Size.m3239getHeightimpl(r0)
