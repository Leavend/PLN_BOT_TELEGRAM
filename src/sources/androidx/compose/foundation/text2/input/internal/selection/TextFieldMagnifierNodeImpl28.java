...
public final class TextFieldMagnifierNodeImpl28 extends TextFieldMagnifierNode implements CompositionLocalConsumerModifierNode {
    ...
    private final MutableState magnifierSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m5897boximpl(IntSize.INSTANCE.m5910getZeroYbymL2g()), null, 2, null);
    private final MagnifierNode magnifierNode = (MagnifierNode) delegate(new MagnifierNode(new Function1<Density, Offset>() { // from class: androidx.compose.foundation.text2.input.internal.selection.TextFieldMagnifierNodeImpl28$magnifierNode$1
        ...
        public /* bridge */ /* synthetic */ Offset invoke(Density density) {
            return Offset.m3162boximpl(m1177invoketuRUvjQ(density));
        }

        /* renamed from: invoke-tuRUvjQ, reason: not valid java name */
        public final long m1177invoketuRUvjQ(Density density) {
        ...
        public /* bridge */ /* synthetic */ Unit invoke(DpSize dpSize) {
            m1178invokeEaSLcWc(dpSize.getPackedValue());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-EaSLcWc, reason: not valid java name */
        public final void m1178invokeEaSLcWc(long j) {
            ...
            textFieldMagnifierNodeImpl28.m1176setMagnifierSizeozmzZPI(IntSizeKt.IntSize(density.mo310roundToPx0680j_4(DpSize.m5833getWidthD9Ej5fM(j)), density.mo310roundToPx0680j_4(DpSize.m5831getHeightD9Ej5fM(j))));
        }
    ...
    public TextFieldMagnifierNodeImpl28(TransformedTextFieldState transformedTextFieldState, TextFieldSelectionState textFieldSelectionState, TextLayoutState textLayoutState, boolean z) {
        ...
        this.isFocused = z;
        this.animatable = new Animatable<>(Offset.m3162boximpl(TextFieldMagnifierKt.m1172calculateSelectionMagnifierCenterAndroidhUlJWOE(this.textFieldState, this.textFieldSelectionState, this.textLayoutState, m1175getMagnifierSizeYbymL2g())), SelectionMagnifierKt.getUnspecifiedSafeOffsetVectorConverter(), Offset.m3162boximpl(SelectionMagnifierKt.getOffsetDisplacementThreshold()), null, 8, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getMagnifierSize-YbymL2g, reason: not valid java name */
    public final long m1175getMagnifierSizeYbymL2g() {
    ...
    public final void m1176setMagnifierSizeozmzZPI(long j) {
        this.magnifierSize.setValue(IntSize.m5897boximpl(j));
    }
    ...
    /* renamed from: androidx.compose.foundation.text2.input.internal.selection.TextFieldMagnifierNodeImpl28$restartAnimationJob$1, reason: invalid class name */
            ...
            if (i == 0) {
                ...
                Flow flowSnapshotFlow = SnapshotStateKt.snapshotFlow(new Function0<Offset>() { // from class: androidx.compose.foundation.text2.input.internal.selection.TextFieldMagnifierNodeImpl28.restartAnimationJob.1.1
                    ...
                    public /* bridge */ /* synthetic */ Offset invoke() {
                        return Offset.m3162boximpl(m1179invokeF1C5BW0());
                    }

                    /* renamed from: invoke-F1C5BW0, reason: not valid java name */
                    public final long m1179invokeF1C5BW0() {
                        return TextFieldMagnifierKt.m1172calculateSelectionMagnifierCenterAndroidhUlJWOE(textFieldMagnifierNodeImpl28.textFieldState, textFieldMagnifierNodeImpl28.textFieldSelectionState, textFieldMagnifierNodeImpl28.textLayoutState, textFieldMagnifierNodeImpl28.m1175getMagnifierSizeYbymL2g());
                    }
                });
                ...
                if (flowSnapshotFlow.collect(new FlowCollector() { // from class: androidx.compose.foundation.text2.input.internal.selection.TextFieldMagnifierNodeImpl28.restartAnimationJob.1.2
                    ...
                    public /* bridge */ /* synthetic */ Object emit(Object obj2, Continuation continuation) {
                        return m1180emit3MmeM6k(((Offset) obj2).getPackedValue(), continuation);
                    }

                    /* renamed from: emit-3MmeM6k, reason: not valid java name */
                    public final Object m1180emit3MmeM6k(long j, Continuation<? super Unit> continuation) {
                        if (OffsetKt.m3192isSpecifiedk4lQ0M(((Offset) textFieldMagnifierNodeImpl282.animatable.getValue()).getPackedValue()) && OffsetKt.m3192isSpecifiedk4lQ0M(j)) {
                            if (!(Offset.m3174getYimpl(((Offset) textFieldMagnifierNodeImpl282.animatable.getValue()).getPackedValue()) == Offset.m3174getYimpl(j))) {
                                BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new C00741(textFieldMagnifierNodeImpl282, j, null), 3, null);
                                return Unit.INSTANCE;
                            }
                        }
                        Object objSnapTo = textFieldMagnifierNodeImpl282.animatable.snapTo(Offset.m3162boximpl(j), continuation);
                    ...
                    /* renamed from: androidx.compose.foundation.text2.input.internal.selection.TextFieldMagnifierNodeImpl28$restartAnimationJob$1$2$1, reason: invalid class name and collision with other inner class name */
                    static final class C00741 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                        ...
                        C00741(TextFieldMagnifierNodeImpl28 textFieldMagnifierNodeImpl28, long j, Continuation<? super C00741> continuation) {
                            super(2, continuation);
                        ...
                        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                            return new C00741(this.this$0, this.$targetValue, continuation);
                        }
                        ...
                        public final Object invokeSuspend(Object obj) {
                            ...
                            if (i == 0) {
                                ResultKt.throwOnFailure(obj);
                                this.label = 1;
                                if (Animatable.animateTo$default(this.this$0.animatable, Offset.m3162boximpl(this.$targetValue), SelectionMagnifierKt.getMagnifierSpringSpec(), null, null, this, 12, null) == coroutine_suspended) {
