...
public final class OffsetMappingCalculator {
    ...
    private int[] ops = OpArray.m1117constructorimpl(10);
    private int opsSize;
    ...
    public final void recordEditOperation(int sourceStart, int sourceEnd, int newLength) {
        ...
        if (iMax >= 2 || iMax != newLength) {
            ...
            if (i > OpArray.m1124getSizeimpl(this.ops)) {
                this.ops = OpArray.m1119copyOfS4kM8k(this.ops, Math.max(i * 2, OpArray.m1124getSizeimpl(this.ops) * 2));
            }
            OpArray.m1126setimpl(this.ops, this.opsSize, iMin, iMax, newLength);
            this.opsSize = i;
        }
    }
    ...
    private final long m1112mapfzxv0v0(int offset, boolean fromSource) {
        ...
        if (i2 < 0) {
            ...
            while (-1 < i3) {
                ...
                int i6 = iArr[i4 + 1];
                int i7 = iArr[i4 + 2];
                long jM1113mapStepC6uMEY = m1113mapStepC6uMEY(iMin, i5, i6, i7, fromSource);
                long jM1113mapStepC6uMEY2 = m1113mapStepC6uMEY(offset, i5, i6, i7, fromSource);
                i3--;
                iMin = Math.min(TextRange.m5235getStartimpl(jM1113mapStepC6uMEY), TextRange.m5235getStartimpl(jM1113mapStepC6uMEY2));
                offset = Math.max(TextRange.m5230getEndimpl(jM1113mapStepC6uMEY), TextRange.m5230getEndimpl(jM1113mapStepC6uMEY2));
            }
            i = offset;
            offset = iMin;
        } else {
            ...
            while (i8 < i2) {
                ...
                int i11 = iArr[i9 + 1];
                int i12 = iArr[i9 + 2];
                long jM1113mapStepC6uMEY3 = m1113mapStepC6uMEY(iMin2, i10, i11, i12, fromSource);
                long jM1113mapStepC6uMEY4 = m1113mapStepC6uMEY(offset, i10, i11, i12, fromSource);
                i8++;
                iMin2 = Math.min(TextRange.m5235getStartimpl(jM1113mapStepC6uMEY3), TextRange.m5235getStartimpl(jM1113mapStepC6uMEY4));
                offset = Math.max(TextRange.m5230getEndimpl(jM1113mapStepC6uMEY3), TextRange.m5230getEndimpl(jM1113mapStepC6uMEY4));
            }
            i = offset;
            offset = iMin2;
        }
    ...
    private final long m1113mapStepC6uMEY(int offset, int opOffset, int untransformedLen, int transformedLen, boolean fromSource) {
