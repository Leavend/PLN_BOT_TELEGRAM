...
public final /* data */ class TextFieldHandleState {
    ...
    private static final TextFieldHandleState Hidden = new TextFieldHandleState(false, Offset.INSTANCE.m3188getUnspecifiedF1C5BW0(), ResolvedTextDirection.Ltr, false, null);
    ...
    public static /* synthetic */ TextFieldHandleState m1168copyubNVwUQ$default(TextFieldHandleState textFieldHandleState, boolean z, long j, ResolvedTextDirection resolvedTextDirection, boolean z2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textFieldHandleState.m1170copyubNVwUQ(z, j2, resolvedTextDirection2, z2);
    }
    ...
    public final TextFieldHandleState m1170copyubNVwUQ(boolean visible, long position, ResolvedTextDirection direction, boolean handlesCrossed) {
    ...
    public boolean equals(Object other) {
        ...
        return this.visible == textFieldHandleState.visible && Offset.m3170equalsimpl0(this.position, textFieldHandleState.position) && this.direction == textFieldHandleState.direction && this.handlesCrossed == textFieldHandleState.handlesCrossed;
    }

    public int hashCode() {
        return (((((Boolean.hashCode(this.visible) * 31) + Offset.m3175hashCodeimpl(this.position)) * 31) + this.direction.hashCode()) * 31) + Boolean.hashCode(this.handlesCrossed);
    }

    public String toString() {
        return "TextFieldHandleState(visible=" + this.visible + ", position=" + ((Object) Offset.m3181toStringimpl(this.position)) + ", direction=" + this.direction + ", handlesCrossed=" + this.handlesCrossed + ')';
    }
    ...
    public final long m1171getPositionF1C5BW0() {
        return this.position;
    }
