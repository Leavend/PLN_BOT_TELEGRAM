...
public final class TextFieldTextLayoutModifierNode extends Modifier.Node implements LayoutModifierNode, GlobalPositionAwareModifierNode, CompositionLocalConsumerModifierNode {
    ...
    public MeasureResult mo90measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        TextLayoutResult textLayoutResultM1149layoutWithNewMeasureInputshBUhpc = this.textLayoutState.m1149layoutWithNewMeasureInputshBUhpc(measureScope, measureScope.getLayoutDirection(), (FontFamily.Resolver) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalFontFamilyResolver()), j);
        final Placeable placeableMo4684measureBRTryo0 = measurable.mo4684measureBRTryo0(Constraints.INSTANCE.m5699fixedJhjzzOo(IntSize.m5905getWidthimpl(textLayoutResultM1149layoutWithNewMeasureInputshBUhpc.getSize()), IntSize.m5904getHeightimpl(textLayoutResultM1149layoutWithNewMeasureInputshBUhpc.getSize())));
        TextLayoutState textLayoutState = this.textLayoutState;
        if (this.singleLine) {
            fM5735constructorimpl = measureScope.mo313toDpu2uoSUM(TextDelegateKt.ceilToIntPx(textLayoutResultM1149layoutWithNewMeasureInputshBUhpc.getLineBottom(0)));
        } else {
            fM5735constructorimpl = Dp.m5735constructorimpl(0);
        }
        textLayoutState.m1150setMinHeightForSingleLineField0680j_4(fM5735constructorimpl);
        return measureScope.layout(IntSize.m5905getWidthimpl(textLayoutResultM1149layoutWithNewMeasureInputshBUhpc.getSize()), IntSize.m5904getHeightimpl(textLayoutResultM1149layoutWithNewMeasureInputshBUhpc.getSize()), MapsKt.mapOf(TuplesKt.to(AlignmentLineKt.getFirstBaseline(), Integer.valueOf(MathKt.roundToInt(textLayoutResultM1149layoutWithNewMeasureInputshBUhpc.getFirstBaseline()))), TuplesKt.to(AlignmentLineKt.getLastBaseline(), Integer.valueOf(MathKt.roundToInt(textLayoutResultM1149layoutWithNewMeasureInputshBUhpc.getLastBaseline())))), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text2.input.internal.TextFieldTextLayoutModifierNode$measure$1
            {
                super(1);
            }
