...
public final class TextFieldLayoutStateCache implements State<TextLayoutResult>, StateObject {
    ...
    public final TextLayoutResult m1138layoutWithNewMeasureInputshBUhpc(Density density, LayoutDirection layoutDirection, FontFamily.Resolver fontFamilyResolver, long constraints) {
    ...
    private final TextLayoutResult getOrComputeLayout(NonMeasureInputs nonMeasureInputs, MeasureInputs measureInputs) {
        ...
        if (layoutResult != null) {
            CharSequence visualText = cacheRecord.getVisualText();
            if ((visualText != null && StringsKt.contentEquals(visualText, text)) && cacheRecord.getSingleLine() == nonMeasureInputs.getSingleLine() && cacheRecord.getSoftWrap() == nonMeasureInputs.getSoftWrap() && cacheRecord.getLayoutDirection() == measureInputs.getLayoutDirection()) {
                if (cacheRecord.getDensityValue() == measureInputs.getDensity().getDensity()) {
                    if ((cacheRecord.getFontScale() == measureInputs.getDensity().getFontScale()) && Constraints.m5684equalsimpl0(cacheRecord.getConstraints(), measureInputs.getConstraints()) && Intrinsics.areEqual(cacheRecord.getFontFamilyResolver(), measureInputs.getFontFamilyResolver())) {
        ...
        if (!Intrinsics.areEqual(textLayoutResultComputeLayout, layoutResult)) {
            ...
            if (!current.getReadOnly()) {
                ...
                synchronized (SnapshotKt.getLock()) {
                    ...
                    cacheRecord3.m1140setConstraintsBRTryo0(measureInputs.getConstraints());
    ...
    private static final class CacheRecord extends StateRecord {
        ...
        public final void m1140setConstraintsBRTryo0(long j) {
            this.constraints = j;
        }
    ...
    static final class MeasureInputs {
            ...
            public boolean equivalent(TextFieldLayoutStateCache.MeasureInputs a, TextFieldLayoutStateCache.MeasureInputs b) {
                if (a == null || b == null) {
                    ...
                    if (a.getDensityValue() == b.getDensityValue()) {
                        if ((a.getFontScale() == b.getFontScale()) && a.getLayoutDirection() == b.getLayoutDirection() && Intrinsics.areEqual(a.getFontFamilyResolver(), b.getFontFamilyResolver()) && Constraints.m5684equalsimpl0(a.getConstraints(), b.getConstraints())) {
                            return true;
                        }
                    }
                }
        ...
        public String toString() {
            return "MeasureInputs(density=" + this.density + ", densityValue=" + this.densityValue + ", fontScale=" + this.fontScale + ", layoutDirection=" + this.layoutDirection + ", fontFamilyResolver=" + this.fontFamilyResolver + ", constraints=" + ((Object) Constraints.m5696toStringimpl(this.constraints)) + ')';
        }
