...
public final class TextFieldPreparedSelection {
    ...
    public final void deleteIfSelectedOr(Function0<TextRange> block) {
        if (!TextRange.m5229getCollapsedimpl(getSelection())) {
            TransformedTextFieldState.m1156replaceTextSbBc2M$default(this.state, "", getSelection(), null, 4, null);
            return;
        }
        TextRange textRangeInvoke = block.invoke();
        if (textRangeInvoke != null) {
            TransformedTextFieldState.m1156replaceTextSbBc2M$default(this.state, "", textRangeInvoke.getPackedValue(), null, 4, null);
        }
    }

    private final int jumpByPagesOffset(int pagesAmount) {
        Rect rectTranslate = this.textLayoutResult.getCursorRect(TextRange.m5230getEndimpl(this.initialValue.getSelectionInChars())).translate(0.0f, this.visibleTextLayoutHeight * pagesAmount);
        ...
        if (Math.abs(rectTranslate.getTop() - lineBottom) > Math.abs(rectTranslate.getBottom() - lineBottom)) {
            return this.textLayoutResult.m5207getOffsetForPositionk4lQ0M(rectTranslate.m3208getTopLeftF1C5BW0());
        }
        return this.textLayoutResult.m5207getOffsetForPositionk4lQ0M(rectTranslate.m3201getBottomLeftF1C5BW0());
    }
    ...
    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.text, TextRange.m5230getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.text, TextRange.m5230getEndimpl(this.selection));
    }
    ...
    private final boolean isLtr() {
        return this.textLayoutResult.getParagraphDirection(TextRange.m5230getEndimpl(this.selection)) == ResolvedTextDirection.Ltr;
    }
    ...
    static /* synthetic */ int getNextWordOffsetForLayout$default(TextFieldPreparedSelection textFieldPreparedSelection, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m5230getEndimpl(textFieldPreparedSelection.selection);
        }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i < this.initialValue.length()) {
            long jM5209getWordBoundaryjx7JFs = textLayoutResult.m5209getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m5230getEndimpl(jM5209getWordBoundaryjx7JFs) > i) {
                return TextRange.m5230getEndimpl(jM5209getWordBoundaryjx7JFs);
            }
            i++;
        }
    ...
    private final int getPrevWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i > 0) {
            long jM5209getWordBoundaryjx7JFs = textLayoutResult.m5209getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m5235getStartimpl(jM5209getWordBoundaryjx7JFs) < i) {
                return TextRange.m5235getStartimpl(jM5209getWordBoundaryjx7JFs);
            }
            i--;
        }
        return 0;
    ...
    static /* synthetic */ int getLineStartByOffsetForLayout$default(TextFieldPreparedSelection textFieldPreparedSelection, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m5233getMinimpl(textFieldPreparedSelection.selection);
        }
    ...
    static /* synthetic */ int getLineEndByOffsetForLayout$default(TextFieldPreparedSelection textFieldPreparedSelection, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m5232getMaximpl(textFieldPreparedSelection.selection);
        }
    ...
    private final int jumpByLinesOffset(TextLayoutResult textLayoutResult, int i) {
        int iM5230getEndimpl = TextRange.m5230getEndimpl(this.selection);
        if (Float.isNaN(this.textPreparedSelectionState.getCachedX())) {
            this.textPreparedSelectionState.setCachedX(textLayoutResult.getCursorRect(iM5230getEndimpl).getLeft());
        }
        int lineForOffset = textLayoutResult.getLineForOffset(iM5230getEndimpl) + i;
        if (lineForOffset < 0) {
            return 0;
        }
        ...
        return textLayoutResult.m5207getOffsetForPositionk4lQ0M(OffsetKt.Offset(cachedX, lineBottom));
    }
    ...
    public final TextFieldPreparedSelection deselect() {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            setCursor(TextRange.m5230getEndimpl(this.selection));
        }
        return this;
    }
    ...
    public final TextFieldPreparedSelection collapseLeftOr(Function1<? super TextFieldPreparedSelection, Unit> or) {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            if (TextRange.m5229getCollapsedimpl(this.selection)) {
                or.invoke(this);
            } else if (isLtr()) {
                setCursor(TextRange.m5233getMinimpl(this.selection));
            } else {
                setCursor(TextRange.m5232getMaximpl(this.selection));
            }
        }
        return this;
    }
    ...
    public final TextFieldPreparedSelection moveCursorPrevByParagraph() {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            int iFindParagraphStart = StringHelpersKt.findParagraphStart(this.text, TextRange.m5233getMinimpl(this.selection));
            if (iFindParagraphStart == TextRange.m5233getMinimpl(this.selection) && iFindParagraphStart != 0) {
    ...
    public final TextFieldPreparedSelection moveCursorNextByParagraph() {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            int iFindParagraphEnd = StringHelpersKt.findParagraphEnd(this.text, TextRange.m5232getMaximpl(this.selection));
            if (iFindParagraphEnd == TextRange.m5232getMaximpl(this.selection) && iFindParagraphEnd != this.text.length()) {
    ...
    public final TextFieldPreparedSelection selectMovement() {
        if (this.text.length() > 0) {
            this.selection = TextRangeKt.TextRange(TextRange.m5235getStartimpl(this.initialValue.getSelectionInChars()), TextRange.m5230getEndimpl(this.selection));
        }
        return this;
    }
}
