...
public final class BackgroundKt {
    ...
    public static /* synthetic */ Modifier m212backgroundbw27NRU$default(Modifier modifier, long j, Shape shape, int i, Object obj) {
        if ((i & 2) != 0) {
    ...
    public static final Modifier m211backgroundbw27NRU(Modifier modifier, final long j, final Shape shape) {
        return modifier.then(new BackgroundElement(j, null, 1.0f, shape, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.BackgroundKt$background-bw27NRU$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                inspectorInfo.setName("background");
                inspectorInfo.setValue(Color.m3404boximpl(j));
                inspectorInfo.getProperties().set(TypedValues.Custom.S_COLOR, Color.m3404boximpl(j));
                inspectorInfo.getProperties().set("shape", shape);
            }
