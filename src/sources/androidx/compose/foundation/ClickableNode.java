...
final class ClickableNode extends AbstractClickableNode {
    ...
    public final void m256updateXHw0xAI(MutableInteractionSource interactionSource, boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick) {
        m183updateCommonXHw0xAI(interactionSource, enabled, onClickLabel, role, onClick);
        getClickableSemanticsNode().m259updateUMe6uN4(enabled, onClickLabel, role, onClick, null, null);
