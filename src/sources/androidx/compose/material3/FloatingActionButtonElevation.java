...
public class FloatingActionButtonElevation {
    ...
    public boolean equals(Object other) {
        ...
        if (Dp.m5740equalsimpl0(this.defaultElevation, floatingActionButtonElevation.defaultElevation) && Dp.m5740equalsimpl0(this.pressedElevation, floatingActionButtonElevation.pressedElevation) && Dp.m5740equalsimpl0(this.focusedElevation, floatingActionButtonElevation.focusedElevation)) {
            return Dp.m5740equalsimpl0(this.hoveredElevation, floatingActionButtonElevation.hoveredElevation);
        }
        return false;
    }

    public int hashCode() {
        return (((((Dp.m5741hashCodeimpl(this.defaultElevation) * 31) + Dp.m5741hashCodeimpl(this.pressedElevation)) * 31) + Dp.m5741hashCodeimpl(this.focusedElevation)) * 31) + Dp.m5741hashCodeimpl(this.hoveredElevation);
    }
}
