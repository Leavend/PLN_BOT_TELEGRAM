...
public final class SliderTokens {
    ...
    private static final float DisabledHandleElevation = ElevationTokens.INSTANCE.m2478getLevel0D9Ej5fM();
    ...
    private static final float HandleElevation = ElevationTokens.INSTANCE.m2479getLevel1D9Ej5fM();
    ...
    private static final float LabelContainerElevation = ElevationTokens.INSTANCE.m2478getLevel0D9Ej5fM();
    private static final float LabelContainerHeight = Dp.m5735constructorimpl((float) 28.0d);
    ...
    private static final float StateLayerSize = Dp.m5735constructorimpl((float) 40.0d);
    private static final float TrackElevation = ElevationTokens.INSTANCE.m2478getLevel0D9Ej5fM();
    private static final ColorSchemeKeyTokens OverlapHandleOutlineColor = ColorSchemeKeyTokens.OnPrimary;
    private static final float OverlapHandleOutlineWidth = Dp.m5735constructorimpl((float) 1.0d);
    ...
    private static final float TickMarksContainerSize = Dp.m5735constructorimpl((float) 2.0d);
    ...
    static {
        float f = (float) 4.0d;
        ActiveTrackHeight = Dp.m5735constructorimpl(f);
        float f2 = (float) 20.0d;
        HandleHeight = Dp.m5735constructorimpl(f2);
        HandleWidth = Dp.m5735constructorimpl(f2);
        InactiveTrackHeight = Dp.m5735constructorimpl(f);
    }
    ...
    public final float m2791getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m2792getDisabledHandleElevationD9Ej5fM() {
    ...
    public final float m2793getHandleElevationD9Ej5fM() {
        return HandleElevation;
    }

    /* renamed from: getHandleHeight-D9Ej5fM, reason: not valid java name */
    public final float m2794getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m2795getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m2796getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m2797getLabelContainerElevationD9Ej5fM() {
        return LabelContainerElevation;
    }

    /* renamed from: getLabelContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2798getLabelContainerHeightD9Ej5fM() {
    ...
    public final float m2800getStateLayerSizeD9Ej5fM() {
        return StateLayerSize;
    }

    /* renamed from: getTrackElevation-D9Ej5fM, reason: not valid java name */
    public final float m2802getTrackElevationD9Ej5fM() {
    ...
    public final float m2799getOverlapHandleOutlineWidthD9Ej5fM() {
    ...
    public final float m2801getTickMarksContainerSizeD9Ej5fM() {
