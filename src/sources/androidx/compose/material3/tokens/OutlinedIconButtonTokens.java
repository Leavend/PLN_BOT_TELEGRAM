...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m5735constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m5735constructorimpl((float) 24.0d);
    ...
    public final float m2665getContainerSizeD9Ej5fM() {
    ...
    public final float m2666getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m2667getUnselectedOutlineWidthD9Ej5fM() {
