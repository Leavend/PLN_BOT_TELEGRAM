...
public final class ShapeTokens {
    ...
    static {
        float f = (float) 28.0d;
        CornerExtraLarge = RoundedCornerShapeKt.m836RoundedCornerShape0680j_4(Dp.m5735constructorimpl(f));
        ...
        CornerExtraLargeTop = RoundedCornerShapeKt.m837RoundedCornerShapea9UjIt4(fM5735constructorimpl, fM5735constructorimpl2, Dp.m5735constructorimpl(f2), Dp.m5735constructorimpl(f2));
        float f3 = (float) 4.0d;
        CornerExtraSmall = RoundedCornerShapeKt.m836RoundedCornerShape0680j_4(Dp.m5735constructorimpl(f3));
        CornerExtraSmallTop = RoundedCornerShapeKt.m837RoundedCornerShapea9UjIt4(Dp.m5735constructorimpl(f3), Dp.m5735constructorimpl(f3), Dp.m5735constructorimpl(f2), Dp.m5735constructorimpl(f2));
        CornerFull = RoundedCornerShapeKt.getCircleShape();
        float f4 = (float) 16.0d;
        CornerLarge = RoundedCornerShapeKt.m836RoundedCornerShape0680j_4(Dp.m5735constructorimpl(f4));
        CornerLargeEnd = RoundedCornerShapeKt.m837RoundedCornerShapea9UjIt4(Dp.m5735constructorimpl(f2), Dp.m5735constructorimpl(f4), Dp.m5735constructorimpl(f4), Dp.m5735constructorimpl(f2));
        CornerLargeTop = RoundedCornerShapeKt.m837RoundedCornerShapea9UjIt4(Dp.m5735constructorimpl(f4), Dp.m5735constructorimpl(f4), Dp.m5735constructorimpl(f2), Dp.m5735constructorimpl(f2));
        CornerMedium = RoundedCornerShapeKt.m836RoundedCornerShape0680j_4(Dp.m5735constructorimpl((float) 12.0d));
        CornerNone = RectangleShapeKt.getRectangleShape();
        CornerSmall = RoundedCornerShapeKt.m836RoundedCornerShape0680j_4(Dp.m5735constructorimpl((float) 8.0d));
    }
}
