...
public final class CircularProgressIndicatorTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m5735constructorimpl((float) 4.0d);
    ...
    private static final float Size = Dp.m5735constructorimpl((float) 48.0d);
    ...
    public final float m2341getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m2342getSizeD9Ej5fM() {
        return Size;
    }
}
