...
public final class BadgeTokens {
    ...
    private static final float LargeSize = Dp.m5735constructorimpl((float) 16.0d);
    private static final ShapeKeyTokens Shape = ShapeKeyTokens.CornerFull;
    private static final float Size = Dp.m5735constructorimpl((float) 6.0d);
    ...
    public final float m2317getLargeSizeD9Ej5fM() {
        return LargeSize;
    }
