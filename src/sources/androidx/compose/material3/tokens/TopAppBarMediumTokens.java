...
public final class TopAppBarMediumTokens {
    ...
    private static final float ContainerHeight = Dp.m5735constructorimpl((float) 112.0d);
    ...
    public final float m2858getContainerHeightD9Ej5fM() {
    ...
    public final float m2859getLeadingIconSizeD9Ej5fM() {
