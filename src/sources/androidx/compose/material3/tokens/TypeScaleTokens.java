...
public final class TypeScaleTokens {
    ...
    static {
        ...
        TextUnitKt.m5939checkArithmeticR2X_6o(sp);
        DisplayLargeTracking = TextUnitKt.pack(TextUnit.m5924getRawTypeimpl(sp), -TextUnit.m5926getValueimpl(sp));
        ...
        DisplayMediumTracking = TextUnitKt.getSp(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
        ...
        DisplaySmallTracking = TextUnitKt.getSp(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
        ...
        HeadlineLargeTracking = TextUnitKt.getSp(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
        ...
        HeadlineMediumTracking = TextUnitKt.getSp(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
        ...
        HeadlineSmallTracking = TextUnitKt.getSp(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
        ...
        TitleLargeTracking = TextUnitKt.getSp(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
