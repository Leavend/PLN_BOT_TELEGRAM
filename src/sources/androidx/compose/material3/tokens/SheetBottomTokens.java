...
public final class SheetBottomTokens {
    ...
    private static final float DockedDragHandleHeight = Dp.m5735constructorimpl((float) 4.0d);
    private static final float DockedDragHandleWidth = Dp.m5735constructorimpl((float) 32.0d);
    private static final ShapeKeyTokens DockedMinimizedContainerShape = ShapeKeyTokens.CornerNone;
    private static final float DockedModalContainerElevation = ElevationTokens.INSTANCE.m2479getLevel1D9Ej5fM();
    private static final float DockedStandardContainerElevation = ElevationTokens.INSTANCE.m2479getLevel1D9Ej5fM();
    ...
    public final float m2787getDockedDragHandleHeightD9Ej5fM() {
        return DockedDragHandleHeight;
    }

    /* renamed from: getDockedDragHandleWidth-D9Ej5fM, reason: not valid java name */
    public final float m2788getDockedDragHandleWidthD9Ej5fM() {
    ...
    public final float m2789getDockedModalContainerElevationD9Ej5fM() {
        return DockedModalContainerElevation;
    }

    /* renamed from: getDockedStandardContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m2790getDockedStandardContainerElevationD9Ej5fM() {
