...
public final class MenuTokens {
    ...
    private static final float ListItemContainerHeight = Dp.m5735constructorimpl((float) 48.0d);
    ...
    static {
        float f = (float) 24.0d;
        ListItemLeadingIconSize = Dp.m5735constructorimpl(f);
        ListItemTrailingIconSize = Dp.m5735constructorimpl(f);
    }
    ...
    public final float m2623getListItemContainerHeightD9Ej5fM() {
    ...
    public final float m2624getListItemLeadingIconSizeD9Ej5fM() {
    ...
    public final float m2625getListItemTrailingIconSizeD9Ej5fM() {
