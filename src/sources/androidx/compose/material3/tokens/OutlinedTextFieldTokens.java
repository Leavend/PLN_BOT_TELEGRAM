...
public final class OutlinedTextFieldTokens {
    ...
    private static final float FocusOutlineWidth = Dp.m5735constructorimpl((float) 2.0d);
    ...
    static {
        float f = (float) 1.0d;
        DisabledOutlineWidth = Dp.m5735constructorimpl(f);
        HoverOutlineWidth = Dp.m5735constructorimpl(f);
        float f2 = (float) 24.0d;
        LeadingIconSize = Dp.m5735constructorimpl(f2);
        OutlineWidth = Dp.m5735constructorimpl(f);
        TrailingIconSize = Dp.m5735constructorimpl(f2);
    }
    ...
    public final float m2672getDisabledOutlineWidthD9Ej5fM() {
    ...
    public final float m2673getFocusOutlineWidthD9Ej5fM() {
    ...
    public final float m2674getHoverOutlineWidthD9Ej5fM() {
    ...
    public final float m2675getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m2676getOutlineWidthD9Ej5fM() {
        return OutlineWidth;
    }
    ...
    public final float m2677getTrailingIconSizeD9Ej5fM() {
