...
public final class ChipColors {
    ...
    public final long m1335labelColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m1336leadingIconContentColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m1337trailingIconContentColorvNxB06k$material3_release(boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3415equalsimpl0(this.containerColor, chipColors.containerColor) && Color.m3415equalsimpl0(this.labelColor, chipColors.labelColor) && Color.m3415equalsimpl0(this.leadingIconContentColor, chipColors.leadingIconContentColor) && Color.m3415equalsimpl0(this.trailingIconContentColor, chipColors.trailingIconContentColor) && Color.m3415equalsimpl0(this.disabledContainerColor, chipColors.disabledContainerColor) && Color.m3415equalsimpl0(this.disabledLabelColor, chipColors.disabledLabelColor) && Color.m3415equalsimpl0(this.disabledLeadingIconContentColor, chipColors.disabledLeadingIconContentColor) && Color.m3415equalsimpl0(this.disabledTrailingIconContentColor, chipColors.disabledTrailingIconContentColor);
    }

    public int hashCode() {
        return (((((((((((((Color.m3421hashCodeimpl(this.containerColor) * 31) + Color.m3421hashCodeimpl(this.labelColor)) * 31) + Color.m3421hashCodeimpl(this.leadingIconContentColor)) * 31) + Color.m3421hashCodeimpl(this.trailingIconContentColor)) * 31) + Color.m3421hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m3421hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m3421hashCodeimpl(this.disabledLeadingIconContentColor)) * 31) + Color.m3421hashCodeimpl(this.disabledTrailingIconContentColor);
    }

    /* renamed from: copy-FD3wquc, reason: not valid java name */
    public final ChipColors m1326copyFD3wquc(long containerColor, long labelColor, long leadingIconContentColor, long trailingIconContentColor, long disabledContainerColor, long disabledLabelColor, long disabledLeadingIconContentColor, long disabledTrailingIconContentColor) {
        return new ChipColors((containerColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (containerColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? containerColor : this.containerColor, (labelColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (labelColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? labelColor : this.labelColor, (leadingIconContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (leadingIconContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? leadingIconContentColor : this.leadingIconContentColor, (trailingIconContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (trailingIconContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? trailingIconContentColor : this.trailingIconContentColor, (disabledContainerColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (disabledContainerColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledContainerColor : this.disabledContainerColor, (disabledLabelColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (disabledLabelColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledLabelColor : this.disabledLabelColor, (disabledLeadingIconContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (disabledLeadingIconContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledLeadingIconContentColor : this.disabledLeadingIconContentColor, disabledTrailingIconContentColor != Color.INSTANCE.m3450getUnspecified0d7_KjU() ? disabledTrailingIconContentColor : this.disabledTrailingIconContentColor, null);
    }
}
