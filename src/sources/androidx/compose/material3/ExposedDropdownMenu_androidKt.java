...
public final class ExposedDropdownMenu_androidKt {
    private static final float ExposedDropdownMenuItemHorizontalPadding = Dp.m5735constructorimpl(16);
    ...
    */
    ...
    public static final void SoftKeyboardListener(final View view, final Density density, final Function0<Unit> function0, Composer composer, final int i) {
        ...
        if ((i2 & 147) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            EffectsKt.DisposableEffect(view, density, (Function1) objRememberedValue, composerStartRestartGroup, (i2 & 14) | (i2 & 112));
            if (ComposerKt.isTraceInProgress()) {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (ForEachGestureKt.awaitEachGesture((PointerInputScope) this.L$0, new C01031(this.$onExpandedChange, null), this) == coroutine_suspended) {
    ...
    public static final Modifier expandable(Modifier modifier, final boolean z, final Function0<Unit> function0, final String str, final String str2) {
        return SemanticsModifierKt.semantics$default(SuspendingPointerInputFilterKt.pointerInput(modifier, function0, new AnonymousClass1(function0, null)), false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.ExposedDropdownMenu_androidKt.expandable.2
            ...
            public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                ...
                SemanticsPropertiesKt.m5079setRolekuIjeqM(semanticsPropertyReceiver, Role.INSTANCE.m5065getDropdownListo7Vup1c());
    ...
    public static final Rect getAnchorBounds(LayoutCoordinates layoutCoordinates) {
        return layoutCoordinates == null ? Rect.INSTANCE.getZero() : RectKt.m3213Recttz77jQw(LayoutCoordinatesKt.positionInWindow(layoutCoordinates), IntSizeKt.m5915toSizeozmzZPI(layoutCoordinates.mo4691getSizeYbymL2g()));
    }
}
