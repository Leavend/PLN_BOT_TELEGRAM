...
public final class SliderDefaults {
    ...
    public final SliderColors m1874colorsq0g_0yA(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, Composer composer, int i, int i2, int i3) {
    ...
    public final SliderColors getDefaultSliderColors$material3_release(ColorScheme colorScheme) {
        ...
        SliderColors sliderColors = new SliderColors(ColorSchemeKt.fromToken(colorScheme, SliderTokens.INSTANCE.getHandleColor()), ColorSchemeKt.fromToken(colorScheme, SliderTokens.INSTANCE.getActiveTrackColor()), Color.m3413copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, SliderTokens.INSTANCE.getTickMarksActiveContainerColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.fromToken(colorScheme, SliderTokens.INSTANCE.getInactiveTrackColor()), Color.m3413copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, SliderTokens.INSTANCE.getTickMarksInactiveContainerColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), ColorKt.m3459compositeOverOWjLjI(Color.m3413copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, SliderTokens.INSTANCE.getDisabledHandleColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), colorScheme.getSurface()), Color.m3413copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, SliderTokens.INSTANCE.getDisabledActiveTrackColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), Color.m3413copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, SliderTokens.INSTANCE.getTickMarksDisabledContainerColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), Color.m3413copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, SliderTokens.INSTANCE.getDisabledInactiveTrackColor()), 0.12f, 0.0f, 0.0f, 0.0f, 14, null), Color.m3413copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, SliderTokens.INSTANCE.getTickMarksDisabledContainerColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    */
    public final void m1873Thumb9LiSoMs(final androidx.compose.foundation.interaction.MutableInteractionSource r30, androidx.compose.ui.Modifier r31, androidx.compose.material3.SliderColors r32, boolean r33, long r34, androidx.compose.runtime.Composer r36, final int r37, final int r38) {
        /*
            Method dump skipped, instructions count: 533
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.SliderDefaults.m1873Thumb9LiSoMs(androidx.compose.foundation.interaction.MutableInteractionSource, androidx.compose.ui.Modifier, androidx.compose.material3.SliderColors, boolean, long, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    */
    ...
    public final void m1872drawTrackLUBghH0(DrawScope drawScope, float[] fArr, float f, float f2, long j, long j2, long j3, long j4) {
        boolean z = drawScope.getLayoutDirection() == LayoutDirection.Rtl;
        long jOffset = OffsetKt.Offset(0.0f, Offset.m3174getYimpl(drawScope.mo3962getCenterF1C5BW0()));
        long jOffset2 = OffsetKt.Offset(Size.m3242getWidthimpl(drawScope.mo3963getSizeNHjbRc()), Offset.m3174getYimpl(drawScope.mo3962getCenterF1C5BW0()));
        long j5 = z ? jOffset2 : jOffset;
        long j6 = z ? jOffset : jOffset2;
        float f3 = drawScope.mo316toPx0680j_4(SliderKt.TickSize);
        float f4 = drawScope.mo316toPx0680j_4(SliderKt.getTrackHeight());
        long j7 = j6;
        long j8 = j5;
        DrawScope.m3950drawLineNGM6Ib0$default(drawScope, j, j5, j6, f4, StrokeCap.INSTANCE.m3767getRoundKaPHkGw(), null, 0.0f, null, 0, 480, null);
        DrawScope.m3950drawLineNGM6Ib0$default(drawScope, j2, OffsetKt.Offset(Offset.m3173getXimpl(j8) + ((Offset.m3173getXimpl(j7) - Offset.m3173getXimpl(j8)) * f), Offset.m3174getYimpl(drawScope.mo3962getCenterF1C5BW0())), OffsetKt.Offset(Offset.m3173getXimpl(j8) + ((Offset.m3173getXimpl(j7) - Offset.m3173getXimpl(j8)) * f2), Offset.m3174getYimpl(drawScope.mo3962getCenterF1C5BW0())), f4, StrokeCap.INSTANCE.m3767getRoundKaPHkGw(), null, 0.0f, null, 0, 480, null);
        ...
        while (i < length) {
            ...
            long j9 = j7;
            long j10 = j8;
            DrawScope.m3945drawCircleVaOC9Bg$default(drawScope, (f5 > f2 ? 1 : (f5 == f2 ? 0 : -1)) > 0 || (f5 > f ? 1 : (f5 == f ? 0 : -1)) < 0 ? j3 : j4, f3 / 2.0f, OffsetKt.Offset(Offset.m3173getXimpl(OffsetKt.m3196lerpWko1d7g(j10, j9, f5)), Offset.m3174getYimpl(drawScope.mo3962getCenterF1C5BW0())), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
            i++;
            j7 = j9;
            j8 = j10;
        }
