...
public final class SearchBarColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3415equalsimpl0(this.containerColor, searchBarColors.containerColor) && Color.m3415equalsimpl0(this.dividerColor, searchBarColors.dividerColor) && Intrinsics.areEqual(this.inputFieldColors, searchBarColors.inputFieldColors);
    }

    public int hashCode() {
        return (((Color.m3421hashCodeimpl(this.containerColor) * 31) + Color.m3421hashCodeimpl(this.dividerColor)) * 31) + this.inputFieldColors.hashCode();
    }
}
