...
public final class ColorScheme {
    ...
    public final /* synthetic */ ColorScheme m1358copyG1PFcw(long primary, long onPrimary, long primaryContainer, long onPrimaryContainer, long inversePrimary, long secondary, long onSecondary, long secondaryContainer, long onSecondaryContainer, long tertiary, long onTertiary, long tertiaryContainer, long onTertiaryContainer, long background, long onBackground, long surface, long onSurface, long surfaceVariant, long onSurfaceVariant, long surfaceTint, long inverseSurface, long inverseOnSurface, long error, long onError, long errorContainer, long onErrorContainer, long outline, long outlineVariant, long scrim) {
        return m1355copyCXl9yA$default(this, primary, onPrimary, primaryContainer, onPrimaryContainer, inversePrimary, secondary, onSecondary, secondaryContainer, onSecondaryContainer, tertiary, onTertiary, tertiaryContainer, onTertiaryContainer, background, onBackground, surface, onSurface, surfaceVariant, onSurfaceVariant, surfaceTint, inverseSurface, inverseOnSurface, error, onError, errorContainer, onErrorContainer, outline, outlineVariant, scrim, 0L, 0L, 0L, 0L, 0L, 0L, 0L, -536870912, 15, null);
    }

    public String toString() {
        StringBuilder sb = new StringBuilder("ColorScheme(primary=");
        sb.append((Object) Color.m3422toStringimpl(this.primary)).append("onPrimary=").append((Object) Color.m3422toStringimpl(this.onPrimary)).append("primaryContainer=").append((Object) Color.m3422toStringimpl(this.primaryContainer)).append("onPrimaryContainer=").append((Object) Color.m3422toStringimpl(this.onPrimaryContainer)).append("inversePrimary=").append((Object) Color.m3422toStringimpl(this.inversePrimary)).append("secondary=").append((Object) Color.m3422toStringimpl(this.secondary)).append("onSecondary=").append((Object) Color.m3422toStringimpl(this.onSecondary)).append("secondaryContainer=").append((Object) Color.m3422toStringimpl(this.secondaryContainer)).append("onSecondaryContainer=").append((Object) Color.m3422toStringimpl(this.onSecondaryContainer)).append("tertiary=").append((Object) Color.m3422toStringimpl(this.tertiary)).append("onTertiary=").append((Object) Color.m3422toStringimpl(this.onTertiary)).append("tertiaryContainer=");
        sb.append((Object) Color.m3422toStringimpl(this.tertiaryContainer)).append("onTertiaryContainer=").append((Object) Color.m3422toStringimpl(this.onTertiaryContainer)).append("background=").append((Object) Color.m3422toStringimpl(this.background)).append("onBackground=").append((Object) Color.m3422toStringimpl(this.onBackground)).append("surface=").append((Object) Color.m3422toStringimpl(this.surface)).append("onSurface=").append((Object) Color.m3422toStringimpl(this.onSurface)).append("surfaceVariant=").append((Object) Color.m3422toStringimpl(this.surfaceVariant)).append("onSurfaceVariant=").append((Object) Color.m3422toStringimpl(this.onSurfaceVariant)).append("surfaceTint=").append((Object) Color.m3422toStringimpl(this.surfaceTint)).append("inverseSurface=").append((Object) Color.m3422toStringimpl(this.inverseSurface)).append("inverseOnSurface=").append((Object) Color.m3422toStringimpl(this.inverseOnSurface)).append("error=").append((Object) Color.m3422toStringimpl(this.error));
        sb.append("onError=").append((Object) Color.m3422toStringimpl(this.onError)).append("errorContainer=").append((Object) Color.m3422toStringimpl(this.errorContainer)).append("onErrorContainer=").append((Object) Color.m3422toStringimpl(this.onErrorContainer)).append("outline=").append((Object) Color.m3422toStringimpl(this.outline)).append("outlineVariant=").append((Object) Color.m3422toStringimpl(this.outlineVariant)).append("scrim=").append((Object) Color.m3422toStringimpl(this.scrim)).append("surfaceBright=").append((Object) Color.m3422toStringimpl(this.surfaceBright)).append("surfaceDim=").append((Object) Color.m3422toStringimpl(this.surfaceDim)).append("surfaceContainer=").append((Object) Color.m3422toStringimpl(this.surfaceContainer)).append("surfaceContainerHigh=").append((Object) Color.m3422toStringimpl(this.surfaceContainerHigh)).append("surfaceContainerHighest=").append((Object) Color.m3422toStringimpl(this.surfaceContainerHighest)).append("surfaceContainerLow=");
        sb.append((Object) Color.m3422toStringimpl(this.surfaceContainerLow)).append("surfaceContainerLowest=").append((Object) Color.m3422toStringimpl(this.surfaceContainerLowest)).append(')');
        return sb.toString();
    }
