...
public final class MenuDefaults {
    ...
    private static final PaddingValues DropdownMenuItemContentPadding = PaddingKt.m559PaddingValuesYgX7TsA(MenuKt.DropdownMenuItemHorizontalPadding, Dp.m5735constructorimpl(0));
    ...
    public final MenuItemColors m1664itemColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        MenuItemColors menuItemColorsM1666copytNS2XkQ = getDefaultMenuItemColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1666copytNS2XkQ(jM3450getUnspecified0d7_KjU, jM3450getUnspecified0d7_KjU2, jM3450getUnspecified0d7_KjU3, jM3450getUnspecified0d7_KjU4, jM3450getUnspecified0d7_KjU5, jM3450getUnspecified0d7_KjU6);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return menuItemColorsM1666copytNS2XkQ;
    }
    ...
    public final MenuItemColors getDefaultMenuItemColors$material3_release(ColorScheme colorScheme) {
        ...
        MenuItemColors menuItemColors = new MenuItemColors(ColorSchemeKt.fromToken(colorScheme, MenuTokens.INSTANCE.getListItemLabelTextColor()), ColorSchemeKt.fromToken(colorScheme, MenuTokens.INSTANCE.getListItemLeadingIconColor()), ColorSchemeKt.fromToken(colorScheme, MenuTokens.INSTANCE.getListItemTrailingIconColor()), Color.m3413copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, MenuTokens.INSTANCE.getListItemDisabledLabelTextColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), Color.m3413copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, MenuTokens.INSTANCE.getListItemDisabledLeadingIconColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), Color.m3413copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, MenuTokens.INSTANCE.getListItemDisabledTrailingIconColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
