...
public final class AlertDialogKt {
    ...
    private static final float DialogMinWidth = Dp.m5735constructorimpl(280);
    private static final float DialogMaxWidth = Dp.m5735constructorimpl(560);
    ...
    */
    public static final void m1225AlertDialogContent4hvqGtA(final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r33, androidx.compose.ui.Modifier r34, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r35, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r36, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r37, final androidx.compose.ui.graphics.Shape r38, final long r39, final float r41, final long r42, final long r44, final long r46, final long r48, androidx.compose.runtime.Composer r50, final int r51, final int r52, final int r53) {
        /*
            Method dump skipped, instructions count: 564
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.AlertDialogKt.m1225AlertDialogContent4hvqGtA(kotlin.jvm.functions.Function2, androidx.compose.ui.Modifier, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, androidx.compose.ui.graphics.Shape, long, float, long, long, long, long, androidx.compose.runtime.Composer, int, int, int):void");
    }

    /* renamed from: AlertDialogFlowRow-ixp7dh8, reason: not valid java name */
    public static final void m1226AlertDialogFlowRowixp7dh8(final float f, final float f2, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        int i2;
                ...
                measurePolicyRememberedValue = new MeasurePolicy() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$1$1
                    ...
                    public final MeasureResult mo37measure3p2s80s(final MeasureScope measureScope, List<? extends Measurable> list, long j) {
                        ...
                        while (i3 < size) {
                            ...
                            Placeable placeableMo4684measureBRTryo0 = list.get(i3).mo4684measureBRTryo0(j);
                            int i4 = i3;
                            float f5 = f4;
                            int i5 = size;
                            float f6 = f3;
                            Ref.IntRef intRef8 = intRef6;
                            if (measure_3p2s80s$canAddToCurrentSequence(arrayList6, intRef5, measureScope, f3, j, placeableMo4684measureBRTryo0)) {
                                intRef = intRef5;
                            ...
                            if (!arrayList2.isEmpty()) {
                                intRef2 = intRef;
                                intRef2.element += measureScope.mo310roundToPx0680j_4(f6);
                            } else {
                                intRef2 = intRef;
                            }
                            arrayList2.add(placeableMo4684measureBRTryo0);
                            intRef2.element += placeableMo4684measureBRTryo0.getWidth();
                            intRef8.element = Math.max(intRef8.element, placeableMo4684measureBRTryo0.getHeight());
                            i3 = i4 + 1;
                            intRef5 = intRef2;
                        ...
                        final int iMax = Math.max(intRef9.element, Constraints.m5693getMinWidthimpl(j));
                        int iMax2 = Math.max(intRef4.element, Constraints.m5692getMinHeightimpl(j));
                        final float f7 = f;
                        return MeasureScope.layout$default(measureScope, iMax, iMax2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$1$1.2
                            ...
                            public final void invoke2(Placeable.PlacementScope placementScope) {
                                ...
                                for (int i7 = 0; i7 < size2; i7++) {
                                    ...
                                    int i8 = 0;
                                    while (i8 < size3) {
                                        iArr[i8] = list4.get(i8).getWidth() + (i8 < CollectionsKt.getLastIndex(list4) ? measureScope2.mo310roundToPx0680j_4(f8) : 0);
                                        i8++;
                                    }
                    ...
                    private static final boolean measure_3p2s80s$canAddToCurrentSequence(List<Placeable> list, Ref.IntRef intRef, MeasureScope measureScope, float f3, long j, Placeable placeable) {
                        return list.isEmpty() || (intRef.element + measureScope.mo310roundToPx0680j_4(f3)) + placeable.getWidth() <= Constraints.m5691getMaxWidthimpl(j);
                    }
                    ...
                    private static final void measure_3p2s80s$startNewSequence(List<List<Placeable>> list, Ref.IntRef intRef, MeasureScope measureScope, float f3, List<Placeable> list2, List<Integer> list3, Ref.IntRef intRef2, List<Integer> list4, Ref.IntRef intRef3, Ref.IntRef intRef4) {
                        if (!list.isEmpty()) {
                            intRef.element += measureScope.mo310roundToPx0680j_4(f3);
                        }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$2
                ...
                public final void invoke(Composer composer2, int i5) {
                    AlertDialogKt.m1226AlertDialogFlowRowixp7dh8(f, f2, function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
    ...
    static {
        float f = 24;
        DialogPadding = PaddingKt.m558PaddingValues0680j_4(Dp.m5735constructorimpl(f));
        float f2 = 16;
        IconPadding = PaddingKt.m562PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m5735constructorimpl(f2), 7, null);
        TitlePadding = PaddingKt.m562PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m5735constructorimpl(f2), 7, null);
        TextPadding = PaddingKt.m562PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m5735constructorimpl(f), 7, null);
    }
}
