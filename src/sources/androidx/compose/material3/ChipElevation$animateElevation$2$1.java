        ...
        if (i == 0) {
            ...
            if (!Dp.m5740equalsimpl0(this.$animatable.getTargetValue().m5749unboximpl(), this.$target)) {
                if (this.$enabled) {
                    ...
                    this.label = 2;
                    if (ElevationKt.m1544animateElevationrAjV9yQ(this.$animatable, this.$target, interactionAnimateElevation$lambda$2, this.$interaction, this) == coroutine_suspended) {
