...
public final class TextFieldDefaultsKt {
    ...
    public static final State<BorderStroke> m2119animateBorderStrokeAsStateNuRrP5Q(boolean z, boolean z2, InteractionSource interactionSource, TextFieldColors textFieldColors, float f, float f2, Composer composer, int i) {
        ...
        if (z) {
            ...
            stateRememberUpdatedState = AnimateAsStateKt.m116animateDpAsStateAjpBEmI(f3, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, null, composer, 48, 12);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-1927721380);
            ComposerKt.sourceInformation(composer, "2393@128899L46");
            stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Dp.m5733boximpl(f2), composer, (i >> 15) & 14);
            composer.endReplaceableGroup();
        }
        State<BorderStroke> stateRememberUpdatedState2 = SnapshotStateKt.rememberUpdatedState(new BorderStroke(stateRememberUpdatedState.getValue().m5749unboximpl(), new SolidColor(stateIndicatorColor$material3_release.getValue().m3424unboximpl(), null), null), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
