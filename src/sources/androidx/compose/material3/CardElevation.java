...
public final class CardElevation {
    ...
    public final float m1298tonalElevationu2uoSUM$material3_release(boolean enabled) {
    ...
    public final State<Dp> shadowElevation$material3_release(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (interactionSource == null) {
            ...
            if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m5733boximpl(this.defaultElevation), null, 2, null);
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (objRememberedValue3 == Composer.INSTANCE.getEmpty()) {
            objRememberedValue3 = new Animatable(Dp.m5733boximpl(f2), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
            composer.updateRememberedValue(objRememberedValue3);
        }
        Animatable animatable = (Animatable) objRememberedValue3;
        composer.endReplaceableGroup();
        Dp dpM5733boximpl = Dp.m5733boximpl(f2);
        ...
        composer.endReplaceableGroup();
        EffectsKt.LaunchedEffect(dpM5733boximpl, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) objRememberedValue4, composer, 0);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5740equalsimpl0(this.defaultElevation, cardElevation.defaultElevation) && Dp.m5740equalsimpl0(this.pressedElevation, cardElevation.pressedElevation) && Dp.m5740equalsimpl0(this.focusedElevation, cardElevation.focusedElevation) && Dp.m5740equalsimpl0(this.hoveredElevation, cardElevation.hoveredElevation) && Dp.m5740equalsimpl0(this.disabledElevation, cardElevation.disabledElevation);
    }

    public int hashCode() {
        return (((((((Dp.m5741hashCodeimpl(this.defaultElevation) * 31) + Dp.m5741hashCodeimpl(this.pressedElevation)) * 31) + Dp.m5741hashCodeimpl(this.focusedElevation)) * 31) + Dp.m5741hashCodeimpl(this.hoveredElevation)) * 31) + Dp.m5741hashCodeimpl(this.disabledElevation);
    }
}
