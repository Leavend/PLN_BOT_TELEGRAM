...
final class FloatingActionButtonElevationAnimatable {
    ...
    static final class C05541 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    private FloatingActionButtonElevationAnimatable(float f, float f2, float f3, float f4) {
        ...
        this.animatable = new Animatable<>(Dp.m5733boximpl(this.defaultElevation), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
    }

    /* renamed from: calculateTarget-u2uoSUM, reason: not valid java name */
    private final float m1577calculateTargetu2uoSUM(Interaction interaction) {
    ...
    public final Object m1578updateElevationlDy3nrA(float f, float f2, float f3, float f4, Continuation<? super Unit> continuation) throws Throwable {
        this.defaultElevation = f;
        this.pressedElevation = f2;
        this.hoveredElevation = f3;
        this.focusedElevation = f4;
    ...
    */
    public final java.lang.Object snapElevation(kotlin.coroutines.Continuation<? super kotlin.Unit> r5) throws java.lang.Throwable {
        /*
            r4 = this;
            boolean r0 = r5 instanceof androidx.compose.material3.FloatingActionButtonElevationAnimatable.C05541
            if (r0 == 0) goto L14
            r0 = r5
            androidx.compose.material3.FloatingActionButtonElevationAnimatable$snapElevation$1 r0 = (androidx.compose.material3.FloatingActionButtonElevationAnimatable.C05541) r0
            int r1 = r0.label
        ...
        L39:
            ...
            float r5 = r4.m1577calculateTargetu2uoSUM(r5)
            ...
            float r2 = r2.m5749unboximpl()
            boolean r2 = androidx.compose.ui.unit.Dp.m5740equalsimpl0(r2, r5)
            if (r2 != 0) goto L72
            ...
            androidx.compose.ui.unit.Dp r5 = androidx.compose.ui.unit.Dp.m5733boximpl(r5)     // Catch: java.lang.Throwable -> L6b
    ...
    */
    public final java.lang.Object animateElevation(androidx.compose.foundation.interaction.Interaction r6, kotlin.coroutines.Continuation<? super kotlin.Unit> r7) throws java.lang.Throwable {
        ...
        L3d:
            ...
            float r7 = r5.m1577calculateTargetu2uoSUM(r6)
            ...
            float r2 = r2.m5749unboximpl()     // Catch: java.lang.Throwable -> L6f
            boolean r2 = androidx.compose.ui.unit.Dp.m5740equalsimpl0(r2, r7)     // Catch: java.lang.Throwable -> L6f
            if (r2 != 0) goto L69
            androidx.compose.animation.core.Animatable<androidx.compose.ui.unit.Dp, androidx.compose.animation.core.AnimationVector1D> r2 = r5.animatable     // Catch: java.lang.Throwable -> L6f
            ...
            java.lang.Object r7 = androidx.compose.material3.ElevationKt.m1544animateElevationrAjV9yQ(r2, r7, r4, r6, r0)     // Catch: java.lang.Throwable -> L6f
            if (r7 != r1) goto L69
            return r1
        L69:
            r0 = r5
