...
final class OutlinedTextFieldMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo37measure3p2s80s(final MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        int i = measureScope.mo310roundToPx0680j_4(this.paddingValues.getBottom());
        ...
        Placeable placeableMo4684measureBRTryo0 = measurable8 != null ? measurable8.mo4684measureBRTryo0(jM5682copyZbe2FdA$default) : null;
        int iWidthOrZero = TextFieldImplKt.widthOrZero(placeableMo4684measureBRTryo0) + 0;
        int iMax = Math.max(0, TextFieldImplKt.heightOrZero(placeableMo4684measureBRTryo0));
        int size2 = list.size();
        int i3 = 0;
        while (true) {
            if (i3 >= size2) {
        ...
        Placeable placeableMo4684measureBRTryo02 = measurable9 != null ? measurable9.mo4684measureBRTryo0(ConstraintsKt.m5708offsetNN6EwU$default(jM5682copyZbe2FdA$default, -iWidthOrZero, 0, 2, null)) : null;
        int iWidthOrZero2 = iWidthOrZero + TextFieldImplKt.widthOrZero(placeableMo4684measureBRTryo02);
        int iMax2 = Math.max(iMax, TextFieldImplKt.heightOrZero(placeableMo4684measureBRTryo02));
        int size3 = list.size();
        int i4 = 0;
        while (true) {
            if (i4 >= size3) {
        ...
        final Placeable placeableMo4684measureBRTryo03 = measurable10 != null ? measurable10.mo4684measureBRTryo0(ConstraintsKt.m5708offsetNN6EwU$default(jM5682copyZbe2FdA$default, -iWidthOrZero2, 0, 2, null)) : null;
        int iWidthOrZero3 = iWidthOrZero2 + TextFieldImplKt.widthOrZero(placeableMo4684measureBRTryo03);
        int iMax3 = Math.max(iMax2, TextFieldImplKt.heightOrZero(placeableMo4684measureBRTryo03));
        int size4 = list.size();
        int i5 = 0;
        while (true) {
            if (i5 >= size4) {
        ...
        Placeable placeableMo4684measureBRTryo04 = measurable11 != null ? measurable11.mo4684measureBRTryo0(ConstraintsKt.m5708offsetNN6EwU$default(jM5682copyZbe2FdA$default, -iWidthOrZero3, 0, 2, null)) : null;
        int iWidthOrZero4 = iWidthOrZero3 + TextFieldImplKt.widthOrZero(placeableMo4684measureBRTryo04);
        int iMax4 = Math.max(iMax3, TextFieldImplKt.heightOrZero(placeableMo4684measureBRTryo04));
        int i6 = measureScope.mo310roundToPx0680j_4(this.paddingValues.mo516calculateLeftPaddingu2uoSUM(measureScope.getLayoutDirection())) + measureScope.mo310roundToPx0680j_4(this.paddingValues.mo517calculateRightPaddingu2uoSUM(measureScope.getLayoutDirection()));
        int i7 = -iWidthOrZero4;
        int i8 = -i;
        long jM5707offsetNN6EwU = ConstraintsKt.m5707offsetNN6EwU(jM5682copyZbe2FdA$default, MathHelpersKt.lerp(i7 - i6, -i6, this.animationProgress), i8);
        int size5 = list.size();
        int i9 = 0;
        while (true) {
            if (i9 >= size5) {
        ...
        Placeable placeableMo4684measureBRTryo05 = measurable13 != null ? measurable13.mo4684measureBRTryo0(jM5707offsetNN6EwU) : null;
        if (placeableMo4684measureBRTryo05 != null) {
            this.onLabelMeasured.invoke(Size.m3230boximpl(SizeKt.Size(placeableMo4684measureBRTryo05.getWidth(), placeableMo4684measureBRTryo05.getHeight())));
        }
        int size6 = list.size();
        int i11 = 0;
        while (true) {
        ...
        int iMinIntrinsicHeight = measurable14 != null ? measurable14.minIntrinsicHeight(Constraints.m5693getMinWidthimpl(j)) : 0;
        int iMax5 = Math.max(TextFieldImplKt.heightOrZero(placeableMo4684measureBRTryo05) / 2, measureScope.mo310roundToPx0680j_4(this.paddingValues.getTop()));
        long jM5682copyZbe2FdA$default2 = Constraints.m5682copyZbe2FdA$default(ConstraintsKt.m5707offsetNN6EwU(j, i7, (i8 - iMax5) - iMinIntrinsicHeight), 0, 0, 0, 0, 11, null);
        int size7 = list.size();
        int i13 = 0;
        while (i13 < size7) {
            int i14 = size7;
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable15), TextFieldImplKt.TextFieldId)) {
                final Placeable placeableMo4684measureBRTryo06 = measurable15.mo4684measureBRTryo0(jM5682copyZbe2FdA$default2);
                long jM5682copyZbe2FdA$default3 = Constraints.m5682copyZbe2FdA$default(jM5682copyZbe2FdA$default2, 0, 0, 0, 0, 14, null);
                int size8 = list.size();
                int i16 = 0;
                while (true) {
                    if (i16 >= size8) {
                ...
                Placeable placeableMo4684measureBRTryo07 = measurable16 != null ? measurable16.mo4684measureBRTryo0(jM5682copyZbe2FdA$default3) : null;
                int iMax6 = Math.max(iMax4, Math.max(TextFieldImplKt.heightOrZero(placeableMo4684measureBRTryo06), TextFieldImplKt.heightOrZero(placeableMo4684measureBRTryo07)) + iMax5 + i);
                final int iM1741calculateWidthDHJA7U0 = OutlinedTextFieldKt.m1741calculateWidthDHJA7U0(TextFieldImplKt.widthOrZero(placeableMo4684measureBRTryo0), TextFieldImplKt.widthOrZero(placeableMo4684measureBRTryo02), TextFieldImplKt.widthOrZero(placeableMo4684measureBRTryo03), TextFieldImplKt.widthOrZero(placeableMo4684measureBRTryo04), placeableMo4684measureBRTryo06.getWidth(), TextFieldImplKt.widthOrZero(placeableMo4684measureBRTryo05), TextFieldImplKt.widthOrZero(placeableMo4684measureBRTryo07), this.animationProgress, j, measureScope.getDensity(), this.paddingValues);
                Placeable placeableMo4684measureBRTryo08 = measurable14 != null ? measurable14.mo4684measureBRTryo0(Constraints.m5682copyZbe2FdA$default(ConstraintsKt.m5708offsetNN6EwU$default(jM5682copyZbe2FdA$default, 0, -iMax6, 1, null), 0, iM1741calculateWidthDHJA7U0, 0, 0, 9, null)) : null;
                int iHeightOrZero = TextFieldImplKt.heightOrZero(placeableMo4684measureBRTryo08);
                final int iM1740calculateHeightmKXJcVc = OutlinedTextFieldKt.m1740calculateHeightmKXJcVc(TextFieldImplKt.heightOrZero(placeableMo4684measureBRTryo0), TextFieldImplKt.heightOrZero(placeableMo4684measureBRTryo02), TextFieldImplKt.heightOrZero(placeableMo4684measureBRTryo03), TextFieldImplKt.heightOrZero(placeableMo4684measureBRTryo04), placeableMo4684measureBRTryo06.getHeight(), TextFieldImplKt.heightOrZero(placeableMo4684measureBRTryo05), TextFieldImplKt.heightOrZero(placeableMo4684measureBRTryo07), TextFieldImplKt.heightOrZero(placeableMo4684measureBRTryo08), this.animationProgress, j, measureScope.getDensity(), this.paddingValues);
                int i18 = iM1740calculateHeightmKXJcVc - iHeightOrZero;
                int size9 = list.size();
                for (int i19 = 0; i19 < size9; i19++) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable17), TextFieldImplKt.ContainerId)) {
                        final Placeable placeableMo4684measureBRTryo09 = measurable17.mo4684measureBRTryo0(ConstraintsKt.Constraints(iM1741calculateWidthDHJA7U0 != Integer.MAX_VALUE ? iM1741calculateWidthDHJA7U0 : 0, iM1741calculateWidthDHJA7U0, i18 != Integer.MAX_VALUE ? i18 : 0, i18));
                        final Placeable placeable = placeableMo4684measureBRTryo0;
                        final Placeable placeable2 = placeableMo4684measureBRTryo02;
                        final Placeable placeable3 = placeableMo4684measureBRTryo04;
                        final Placeable placeable4 = placeableMo4684measureBRTryo05;
                        final Placeable placeable5 = placeableMo4684measureBRTryo07;
                        final Placeable placeable6 = placeableMo4684measureBRTryo08;
                        return MeasureScope.layout$default(measureScope, iM1741calculateWidthDHJA7U0, iM1740calculateHeightmKXJcVc, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.OutlinedTextFieldMeasurePolicy$measure$2
                            ...
                            public final void invoke2(Placeable.PlacementScope placementScope) {
                                OutlinedTextFieldKt.place(placementScope, iM1740calculateHeightmKXJcVc, iM1741calculateWidthDHJA7U0, placeable, placeable2, placeableMo4684measureBRTryo03, placeable3, placeableMo4684measureBRTryo06, placeable4, placeable5, placeableMo4684measureBRTryo09, placeable6, this.animationProgress, this.singleLine, measureScope.getDensity(), measureScope.getLayoutDirection(), this.paddingValues);
                            }
                        }, 4, null);
                    }
                }
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        for (int i8 = 0; i8 < size6; i8++) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(intrinsicMeasurable13), TextFieldImplKt.TextFieldId)) {
                ...
                return OutlinedTextFieldKt.m1740calculateHeightmKXJcVc(iIntValue, iIntValue2, iIntValue3, i2, iIntValue6, iIntValue4, iIntValue7, intrinsicMeasurable16 != null ? function2.invoke(intrinsicMeasurable16, Integer.valueOf(i)).intValue() : 0, this.animationProgress, TextFieldImplKt.getZeroConstraints(), intrinsicMeasureScope.getDensity(), this.paddingValues);
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
