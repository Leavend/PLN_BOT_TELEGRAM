...
public final class DatePickerKt {
    ...
    private static final float RecommendedSizeForAccessibility = Dp.m5735constructorimpl(48);
    private static final float MonthYearHeight = Dp.m5735constructorimpl(56);
    ...
    */
    ...
    public static final DatePickerState m1490rememberDatePickerStateEU0dCGE(Long l, Long l2, IntRange intRange, int i, SelectableDates selectableDates, Composer composer, int i2, int i3) {
        ...
        final int iM1526getPickerjFl4v0 = (i3 & 8) != 0 ? DisplayMode.INSTANCE.m1526getPickerjFl4v0() : i;
        ...
        if (zChangedInstance || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = (Function0) new Function0<DatePickerStateImpl>() { // from class: androidx.compose.material3.DatePickerKt$rememberDatePickerState$1$1
                ...
                public final DatePickerStateImpl invoke() {
                    return new DatePickerStateImpl(l3, l4, yearRange, iM1526getPickerjFl4v0, allDates, localeDefaultLocale, null);
                }
            };
            composer.updateRememberedValue(objRememberedValue);
        }
        composer.endReplaceableGroup();
        DatePickerStateImpl datePickerStateImpl = (DatePickerStateImpl) RememberSaveableKt.m3031rememberSaveable(objArr, (Saver) Saver, (String) null, (Function0) objRememberedValue, composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static /* synthetic */ DatePickerState m1486DatePickerStatesHin3Bw$default(Locale locale, Long l, Long l2, IntRange intRange, int i, SelectableDates selectableDates, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            l = null;
        }
        Long l3 = (i2 & 4) != 0 ? l : l2;
        ...
        if ((i2 & 16) != 0) {
            i = DisplayMode.INSTANCE.m1526getPickerjFl4v0();
        }
        int i3 = i;
        if ((i2 & 32) != 0) {
            selectableDates = DatePickerDefaults.INSTANCE.getAllDates();
        }
        return m1485DatePickerStatesHin3Bw(locale, l, l3, intRange2, i3, selectableDates);
    }

    /* renamed from: DatePickerState-sHin3Bw, reason: not valid java name */
    public static final DatePickerState m1485DatePickerStatesHin3Bw(Locale locale, Long l, Long l2, IntRange intRange, int i, SelectableDates selectableDates) {
    ...
    public static final void m1483DateEntryContainerau3_HiA(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final DatePickerColors datePickerColors, final TextStyle textStyle, final float f, final Function2<? super Composer, ? super Integer, Unit> function24, Composer composer, final int i) {
        ...
        if ((4793491 & i2) != 4793490 || !composerStartRestartGroup.getSkipping()) {
            ...
            Modifier modifierSemantics$default = SemanticsModifierKt.semantics$default(SizeKt.m618sizeInqDBjuR0$default(modifier, DatePickerModalTokens.INSTANCE.m2446getContainerWidthD9Ej5fM(), 0.0f, 0.0f, 0.0f, 14, null), false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DateEntryContainer$1
                ...
                public final void invoke(Composer composer2, int i3) {
                    ...
                    if ((i3 & 3) != 2 || !composer2.getSkipping()) {
                            ...
                            TextKt.ProvideTextStyle(textStyle2, ComposableLambdaKt.composableLambda(composer2, -962031352, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DateEntryContainer$2$1$1$1$1
                                ...
                                public final void invoke(Composer composer3, int i4) {
                                    ...
                                    if ((i4 & 3) != 2 || !composer3.getSkipping()) {
                                        ...
                                        Updater.m2951setimpl(composerM2944constructorimpl4, measurePolicyRememberBoxMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                        ...
                        if (function27 != null || function25 != null || function26 != null) {
                            DividerKt.m1529HorizontalDivider9IZ8Weo(null, 0.0f, datePickerColors2.getDividerColor(), composer2, 0, 3);
                        }
                        composer2.endReplaceableGroup();
                        ComposerKt.sourceInformationMarkerEnd(composer2);
                        ComposerKt.sourceInformationMarkerEnd(composer2);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DateEntryContainer$3
                ...
                public final void invoke(Composer composer2, int i3) {
                    DatePickerKt.m1483DateEntryContainerau3_HiA(modifier, function2, function22, function23, datePickerColors, textStyle, f, function24, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
    ...
    public static final void m1487DisplayModeToggleButtontER2X8s(final Modifier modifier, final int i, final Function1<? super DisplayMode, Unit> function1, Composer composer, final int i2) {
        int i3;
        boolean z;
        ...
        if ((i3 & 147) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            if (!DisplayMode.m1521equalsimpl0(i, DisplayMode.INSTANCE.m1526getPickerjFl4v0())) {
                ...
                if (z || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue = (Function0) new Function0<Unit>() { // from class: androidx.compose.material3.DatePickerKt$DisplayModeToggleButton$2$1
                        ...
                        public final void invoke2() {
                            function1.invoke(DisplayMode.m1518boximpl(DisplayMode.INSTANCE.m1526getPickerjFl4v0()));
                        }
                    };
                    composerStartRestartGroup.updateRememberedValue(objRememberedValue);
                }
                composerStartRestartGroup.endReplaceableGroup();
                IconButtonKt.IconButton((Function0) objRememberedValue, modifier, false, null, null, ComposableSingletons$DatePickerKt.INSTANCE.m1422getLambda2$material3_release(), composerStartRestartGroup, ((i3 << 3) & 112) | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 28);
                composerStartRestartGroup.endReplaceableGroup();
            } else {
                ...
                if (z || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue2 = (Function0) new Function0<Unit>() { // from class: androidx.compose.material3.DatePickerKt$DisplayModeToggleButton$1$1
                        ...
                        /* renamed from: invoke, reason: avoid collision after fix types in other method */
                        public final void invoke2() {
                            function1.invoke(DisplayMode.m1518boximpl(DisplayMode.INSTANCE.m1525getInputjFl4v0()));
                        }
                    };
                    composerStartRestartGroup.updateRememberedValue(objRememberedValue2);
                }
                composerStartRestartGroup.endReplaceableGroup();
                IconButtonKt.IconButton((Function0) objRememberedValue2, modifier, false, null, null, ComposableSingletons$DatePickerKt.INSTANCE.m1421getLambda1$material3_release(), composerStartRestartGroup, ((i3 << 3) & 112) | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 28);
                composerStartRestartGroup.endReplaceableGroup();
            }
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DisplayModeToggleButton$3
                ...
                public final void invoke(Composer composer2, int i4) {
                    DatePickerKt.m1487DisplayModeToggleButtontER2X8s(modifier, i, function1, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
                }
            });
        }
    }
    ...
    public static final void m1488SwitchableDateEntryContentd7iavvg(final Long l, final long j, final int i, final Function1<? super Long, Unit> function1, final Function1<? super Long, Unit> function12, final CalendarModel calendarModel, final IntRange intRange, final DatePickerFormatter datePickerFormatter, final SelectableDates selectableDates, final DatePickerColors datePickerColors, Composer composer, final int i2) {
        ...
        if ((306783379 & i4) != 306783378 || !composerStartRestartGroup.getSkipping()) {
            ...
            ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
            final int i5 = -((Density) objConsume).mo310roundToPx0680j_4(Dp.m5735constructorimpl(48));
            DisplayMode displayModeM1518boximpl = DisplayMode.m1518boximpl(i);
            ...
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = (Function1) new Function1<AnimatedContentTransitionScope<DisplayMode>, ContentTransform>() { // from class: androidx.compose.material3.DatePickerKt$SwitchableDateEntryContent$2$1
                    ...
                    public final ContentTransform invoke(AnimatedContentTransitionScope<DisplayMode> animatedContentTransitionScope) {
                        ...
                        if (DisplayMode.m1521equalsimpl0(animatedContentTransitionScope.getTargetState().getValue(), DisplayMode.INSTANCE.m1525getInputjFl4v0())) {
                        ...
                        return animatedContentTransitionScope.using(contentTransform, AnimatedContentKt.SizeTransform(true, new Function2<IntSize, IntSize, FiniteAnimationSpec<IntSize>>() { // from class: androidx.compose.material3.DatePickerKt$SwitchableDateEntryContent$2$1.5
                            ...
                            public /* bridge */ /* synthetic */ FiniteAnimationSpec<IntSize> invoke(IntSize intSize, IntSize intSize2) {
                                return m1492invokeTemP2vQ(intSize.getPackedValue(), intSize2.getPackedValue());
                            }

                            /* renamed from: invoke-TemP2vQ, reason: not valid java name */
                            public final FiniteAnimationSpec<IntSize> m1492invokeTemP2vQ(long j2, long j3) {
            ...
            composerStartRestartGroup.endReplaceableGroup();
            AnimatedContentKt.AnimatedContent(displayModeM1518boximpl, modifierSemantics$default, (Function1) objRememberedValue, null, "DatePickerDisplayModeAnimation", null, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -459778869, true, new Function4<AnimatedContentScope, DisplayMode, Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$SwitchableDateEntryContent$3
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(4);
                ...
                public /* bridge */ /* synthetic */ Unit invoke(AnimatedContentScope animatedContentScope, DisplayMode displayMode, Composer composer2, Integer num) {
                    m1493invokefYndouo(animatedContentScope, displayMode.getValue(), composer2, num.intValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-fYndouo, reason: not valid java name */
                public final void m1493invokefYndouo(AnimatedContentScope animatedContentScope, int i6, Composer composer2, int i7) {
                    ...
                    if (DisplayMode.m1521equalsimpl0(i6, DisplayMode.INSTANCE.m1526getPickerjFl4v0())) {
                        ...
                        composer2.endReplaceableGroup();
                    } else if (DisplayMode.m1521equalsimpl0(i6, DisplayMode.INSTANCE.m1525getInputjFl4v0())) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$SwitchableDateEntryContent$4
                ...
                public final void invoke(Composer composer2, int i6) {
                    DatePickerKt.m1488SwitchableDateEntryContentd7iavvg(l, j, i, function1, function12, calendarModel, intRange, datePickerFormatter, selectableDates, datePickerColors, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
                }
            });
        }
    }
    ...
    */
    ...
    public static final void m1484DatePickerHeaderpc5RIQQ(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final long j, final long j2, final float f, final Function2<? super Composer, ? super Integer, Unit> function22, Composer composer, final int i) {
        int i2;
        Modifier.Companion companionM599defaultMinSizeVpY3zN4$default;
        ...
        if ((74899 & i2) != 74898 || !composerStartRestartGroup.getSkipping()) {
            ...
            if (function2 != null) {
                companionM599defaultMinSizeVpY3zN4$default = SizeKt.m599defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, 0.0f, f, 1, null);
            } else {
                companionM599defaultMinSizeVpY3zN4$default = Modifier.INSTANCE;
            }
            Modifier modifierThen = SizeKt.fillMaxWidth$default(modifier, 0.0f, 1, null).then(companionM599defaultMinSizeVpY3zN4$default);
            ...
            if (function2 != null) {
                ProvideContentColorTextStyleKt.m1769ProvideContentColorTextStyle3JVO9M(j, TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography(composerStartRestartGroup, 6), DatePickerModalTokens.INSTANCE.getHeaderSupportingTextFont()), ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1936268514, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePickerHeader$1$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    /* JADX WARN: Multi-variable type inference failed */
                    {
                        super(2);
            ...
            composerStartRestartGroup.endReplaceableGroup();
            CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m3404boximpl(j2)), function22, composerStartRestartGroup, ((i2 >> 12) & 112) | ProvidedValue.$stable | 0);
            ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
            composerStartRestartGroup.endReplaceableGroup();
            composerStartRestartGroup.endNode();
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePickerHeader$2
                ...
                public final void invoke(Composer composer2, int i3) {
                    DatePickerKt.m1484DatePickerHeaderpc5RIQQ(modifier, function2, j, j2, f, function22, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
                                    ...
                                    LazyListScope.items$default(lazyListScope, iNumberOfMonthsInRange, null, null, ComposableLambdaKt.composableLambdaInstance(1137566309, true, new Function4<LazyItemScope, Integer, Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$HorizontalMonthsList$1$2$1.1
                                        ...
                                        public final void invoke(LazyItemScope lazyItemScope, int i5, Composer composer4, int i6) {
                                            ...
                                            if ((i7 & 147) != 146 || !composer4.getSkipping()) {
                                                ...
                                                Composer composerM2944constructorimpl = Updater.m2944constructorimpl(composer4);
                                                ...
                                                function3ModifierMaterializerOf.invoke(SkippableUpdater.m2935boximpl(SkippableUpdater.m2936constructorimpl(composer4)), composer4, 0);
    ...
    public static final void WeekDays(final DatePickerColors datePickerColors, final CalendarModel calendarModel, Composer composer, final int i) {
        ...
        if ((i2 & 19) != 18 || !composerStartRestartGroup.getSkipping()) {
            ...
            Modifier modifierFillMaxWidth$default = SizeKt.fillMaxWidth$default(SizeKt.m599defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, 0.0f, RecommendedSizeForAccessibility, 1, null), 0.0f, 1, null);
            ...
            while (i8 < size2) {
                ...
                Modifier modifierM616sizeVpY3zN4 = SizeKt.m616sizeVpY3zN4(modifierClearAndSetSemantics, f, f);
                ...
                Function0<ComposeUiNode> constructor2 = ComposeUiNode.INSTANCE.getConstructor();
                Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3ModifierMaterializerOf2 = LayoutKt.modifierMaterializerOf(modifierM616sizeVpY3zN4);
                if (!(composerStartRestartGroup.getApplier() instanceof Applier)) {
                    ComposablesKt.invalidApplier();
                }
                composerStartRestartGroup.startReusableNode();
                ...
                TextKt.m2130Text4IGK_g((String) pair.getSecond(), SizeKt.wrapContentSize$default(Modifier.INSTANCE, null, false, 3, null), datePickerColors.getWeekdayContentColor(), 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, TextAlign.m5620boximpl(TextAlign.INSTANCE.m5627getCentere0LSkKk()), 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, textStyleFromToken, composer3, 48, 0, 65016);
                ComposerKt.sourceInformationMarkerEnd(composer3);
                ComposerKt.sourceInformationMarkerEnd(composer3);
                composer3.endReplaceableGroup();
                composer3.endNode();
    ...
    */
    ...
    private static final String dayContentDescription(boolean z, boolean z2, boolean z3, boolean z4, boolean z5, Composer composer, int i) {
        ...
        if (z) {
            if (z3) {
                ...
                sb.append(Strings_androidKt.m1972getStringNWtq28(Strings.m1903constructorimpl(R.string.m3c_date_range_picker_start_headline), composer, 0));
                composer.endReplaceableGroup();
            } else if (z4) {
                composer.startReplaceableGroup(-852184821);
                ComposerKt.sourceInformation(composer, "1909@83519L54");
                Strings.Companion companion2 = Strings.INSTANCE;
                sb.append(Strings_androidKt.m1972getStringNWtq28(Strings.m1903constructorimpl(R.string.m3c_date_range_picker_end_headline), composer, 0));
                composer.endReplaceableGroup();
            } else if (z5) {
                composer.startReplaceableGroup(-852184683);
                ComposerKt.sourceInformation(composer, "1913@83657L53");
                Strings.Companion companion3 = Strings.INSTANCE;
                sb.append(Strings_androidKt.m1972getStringNWtq28(Strings.m1903constructorimpl(R.string.m3c_date_range_picker_day_in_range), composer, 0));
                composer.endReplaceableGroup();
            } else {
        ...
        if (z2) {
            ...
            sb.append(Strings_androidKt.m1972getStringNWtq28(Strings.m1903constructorimpl(R.string.m3c_date_picker_today_description), composer, 0));
        }
    ...
    public static final void Day(final Modifier modifier, final boolean z, final Function0<Unit> function0, final boolean z2, final boolean z3, final boolean z4, final boolean z5, final String str, final DatePickerColors datePickerColors, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        ...
        if ((306783379 & i3) != 306783378 || !composerStartRestartGroup.getSkipping()) {
            ...
            if (z6 || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$Day$1$1
                    ...
                    public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                        ...
                        SemanticsPropertiesKt.m5079setRolekuIjeqM(semanticsPropertyReceiver, Role.INSTANCE.m5063getButtono7Vup1c());
                    }
                };
                composerStartRestartGroup.updateRememberedValue(objRememberedValue);
            }
            ...
            int i8 = i4 & 7168;
            composer2 = composerStartRestartGroup;
            SurfaceKt.m1983Surfaced85dljk(z, function0, modifierSemantics, z3, ShapesKt.getValue(DatePickerModalTokens.INSTANCE.getDateContainerShape(), composerStartRestartGroup, 6), datePickerColors.dayContainerColor$material3_release(z, z3, z2, composerStartRestartGroup, (i6 & 7168) | i5 | ((i3 >> 9) & 112) | (i4 & 896)).getValue().m3424unboximpl(), datePickerColors.dayContentColor$material3_release(z4, z, z5, z3, composerStartRestartGroup, (i6 & 14) | (i3 & 112) | (i7 & 896) | i8 | (i7 & 57344)).getValue().m3424unboximpl(), 0.0f, 0.0f, (!z4 || z) ? null : BorderStrokeKt.m240BorderStrokecXLIe8U(DatePickerModalTokens.INSTANCE.m2451getDateTodayContainerOutlineWidthD9Ej5fM(), datePickerColors.getTodayDateBorderColor()), (MutableInteractionSource) null, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -2031780827, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt.Day.2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                public final void invoke(Composer composer3, int i9) {
                    ...
                    if ((i9 & 3) != 2 || !composer3.getSkipping()) {
                        ...
                        Modifier modifierM608requiredSizeVpY3zN4 = SizeKt.m608requiredSizeVpY3zN4(Modifier.INSTANCE, DatePickerModalTokens.INSTANCE.m2450getDateStateLayerWidthD9Ej5fM(), DatePickerModalTokens.INSTANCE.m2449getDateStateLayerHeightD9Ej5fM());
                        Alignment center = Alignment.INSTANCE.getCenter();
                        ...
                        Function0<ComposeUiNode> constructor = ComposeUiNode.INSTANCE.getConstructor();
                        Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3ModifierMaterializerOf = LayoutKt.modifierMaterializerOf(modifierM608requiredSizeVpY3zN4);
                        if (!(composer3.getApplier() instanceof Applier)) {
                            ComposablesKt.invalidApplier();
                        }
                        composer3.startReusableNode();
            ...
            TextKt.ProvideTextStyle(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography(composerStartRestartGroup, 6), DatePickerModalTokens.INSTANCE.getSelectionYearLabelTextFont()), ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1301915789, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt.YearPicker.1
                ...
                public final void invoke(Composer composer2, int i3) {
                    ...
                    if ((i3 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        ComposerKt.sourceInformationMarkerEnd(composer2);
                        long jM1395applyTonalElevationRFCenO8 = ColorSchemeKt.m1395applyTonalElevationRFCenO8(colorScheme, containerColor, ((Dp) objConsume).m5749unboximpl(), composer2, 0);
                        ...
                        composer2.endReplaceableGroup();
                        Strings.Companion companion = Strings.INSTANCE;
                        final String strM1972getStringNWtq28 = Strings_androidKt.m1972getStringNWtq28(Strings.m1903constructorimpl(R.string.m3c_date_picker_scroll_to_earlier_years), composer2, 0);
                        Strings.Companion companion2 = Strings.INSTANCE;
                        final String strM1972getStringNWtq282 = Strings_androidKt.m1972getStringNWtq28(Strings.m1903constructorimpl(R.string.m3c_date_picker_scroll_to_later_years), composer2, 0);
                        GridCells.Fixed fixed = new GridCells.Fixed(3);
                        Modifier modifierSemantics$default = SemanticsModifierKt.semantics$default(BackgroundKt.m212backgroundbw27NRU$default(modifier, jM1395applyTonalElevationRFCenO8, null, 2, null), false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt.YearPicker.1.1
                            @Override // kotlin.jvm.functions.Function1
                            public /* bridge */ /* synthetic */ Unit invoke(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                                invoke2(semanticsPropertyReceiver);
                                return Unit.INSTANCE;
                        ...
                        Arrangement.HorizontalOrVertical horizontalOrVerticalM474spacedBy0680j_4 = Arrangement.INSTANCE.m474spacedBy0680j_4(DatePickerKt.YearsVerticalPadding);
                        Arrangement.HorizontalOrVertical horizontalOrVertical = spaceEvenly;
                        composer2.startReplaceableGroup(-969328877);
                        ComposerKt.sourceInformation(composer2, "CC(remember):DatePicker.kt#9igjgp");
                        boolean zChangedInstance = composer2.changedInstance(intRange) | composer2.changed(lazyGridStateRememberLazyGridState) | composer2.changedInstance(coroutineScope) | composer2.changed(strM1972getStringNWtq28) | composer2.changed(strM1972getStringNWtq282) | composer2.changed(year2) | composer2.changed(year) | composer2.changed(function1) | composer2.changed(selectableDates) | composer2.changed(datePickerColors);
                        final IntRange intRange2 = intRange;
                        ...
                        if (zChangedInstance || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                            ...
                            objRememberedValue2 = (Function1) new Function1<LazyGridScope, Unit>() { // from class: androidx.compose.material3.DatePickerKt$YearPicker$1$2$1
                                ...
                                public final void invoke2(LazyGridScope lazyGridScope) {
                                    ...
                                    final String str = strM1972getStringNWtq28;
                                    final String str2 = strM1972getStringNWtq282;
                                    final int i4 = year2;
                                    final int i5 = year;
                                    ...
                                    LazyGridScope.items$default(lazyGridScope, iCount, null, null, null, ComposableLambdaKt.composableLambdaInstance(1040623618, true, new Function4<LazyGridItemScope, Integer, Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$YearPicker$1$2$1.1
                                        ...
                                        public final void invoke(LazyGridItemScope lazyGridItemScope, final int i6, Composer composer3, int i7) {
                                            ...
                                            if ((i8 & 145) != 144 || !composer3.getSkipping()) {
                                                ...
                                                Modifier modifierM608requiredSizeVpY3zN4 = SizeKt.m608requiredSizeVpY3zN4(Modifier.INSTANCE, DatePickerModalTokens.INSTANCE.m2458getSelectionYearContainerWidthD9Ej5fM(), DatePickerModalTokens.INSTANCE.m2457getSelectionYearContainerHeightD9Ej5fM());
                                                ...
                                                composer3.endReplaceableGroup();
                                                Modifier modifierSemantics$default2 = SemanticsModifierKt.semantics$default(modifierM608requiredSizeVpY3zN4, false, (Function1) objRememberedValue3, 1, null);
                                                boolean z = first == i4;
                                                boolean z2 = first == i5;
                                                ...
                                                Strings.Companion companion3 = Strings.INSTANCE;
                                                String str5 = String.format(Strings_androidKt.m1972getStringNWtq28(Strings.m1903constructorimpl(R.string.m3c_date_picker_navigate_to_year_description), composer3, 0), Arrays.copyOf(new Object[]{localString$default}, 1));
                                                ...
                                                DatePickerKt.Year(modifierSemantics$default2, z, z2, function0, zIsSelectableYear, str5, datePickerColors3, ComposableLambdaKt.composableLambda(composer3, 882189459, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt.YearPicker.1.2.1.1.3
                                                    ...
                                                    public final void invoke(Composer composer4, int i9) {
                                                        ...
                                                        if ((i9 & 3) != 2 || !composer4.getSkipping()) {
                                                            ...
                                                            TextKt.m2130Text4IGK_g(localString$default, SemanticsModifierKt.clearAndSetSemantics(Modifier.INSTANCE, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt.YearPicker.1.2.1.1.3.1
                                                                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                                                                public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                                                                }
                                                            ...
                                                            }), 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, TextAlign.m5620boximpl(TextAlign.INSTANCE.m5627getCentere0LSkKk()), 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer4, 0, 0, 130556);
                                                            if (ComposerKt.isTraceInProgress()) {
                                                                ComposerKt.traceEventEnd();
                                                                return;
                                                            }
                        ...
                        composer2.endReplaceableGroup();
                        LazyGridDslKt.LazyVerticalGrid(fixed2, modifierSemantics$default, lazyGridState, null, false, horizontalOrVerticalM474spacedBy0680j_4, horizontalOrVertical, null, false, (Function1) objRememberedValue2, composer2, 1769472, 408);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
    ...
    public static final void Year(final Modifier modifier, final boolean z, final boolean z2, final Function0<Unit> function0, final boolean z3, final String str, final DatePickerColors datePickerColors, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        int i2;
        Object objM240BorderStrokecXLIe8U;
        Composer composer2;
        ...
        if ((4793491 & i2) != 4793490 || !composerStartRestartGroup.getSkipping()) {
            ...
            if (z4 || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objM240BorderStrokecXLIe8U = (!z2 || z) ? null : BorderStrokeKt.m240BorderStrokecXLIe8U(DatePickerModalTokens.INSTANCE.m2451getDateTodayContainerOutlineWidthD9Ej5fM(), datePickerColors.getTodayDateBorderColor());
                composerStartRestartGroup.updateRememberedValue(objM240BorderStrokecXLIe8U);
            } else {
                objM240BorderStrokecXLIe8U = objRememberedValue;
            }
            BorderStroke borderStroke = (BorderStroke) objM240BorderStrokecXLIe8U;
            composerStartRestartGroup.endReplaceableGroup();
            ...
            int i5 = i4 & 14;
            int i6 = i2 >> 9;
            long jM3424unboximpl = datePickerColors.yearContainerColor$material3_release(z, z3, composerStartRestartGroup, i5 | (i6 & 112) | ((i2 >> 12) & 896)).getValue().m3424unboximpl();
            int i7 = i2 >> 6;
            long jM3424unboximpl2 = datePickerColors.yearContentColor$material3_release(z2, z, z3, composerStartRestartGroup, (i7 & 14) | i3 | (i7 & 896) | (i6 & 7168)).getValue().m3424unboximpl();
            composer2 = composerStartRestartGroup;
            SurfaceKt.m1983Surfaced85dljk(z, function0, modifierSemantics, z3, value, jM3424unboximpl, jM3424unboximpl2, 0.0f, 0.0f, borderStroke, (MutableInteractionSource) null, ComposableLambdaKt.composableLambda(composer2, -1573188346, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt.Year.2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
    ...
    public static final void MonthsNavigation(final Modifier modifier, final boolean z, final boolean z2, final boolean z3, final String str, final Function0<Unit> function0, final Function0<Unit> function02, final Function0<Unit> function03, final DatePickerColors datePickerColors, Composer composer, final int i) {
        ...
        if ((38347923 & i2) != 38347922 || !composerStartRestartGroup.getSkipping()) {
            ...
            Modifier modifierM603requiredHeight3ABfNKs = SizeKt.m603requiredHeight3ABfNKs(SizeKt.fillMaxWidth$default(modifier, 0.0f, 1, null), MonthYearHeight);
            if (z3) {
            ...
            CompositionLocalMap currentCompositionLocalMap = composerStartRestartGroup.getCurrentCompositionLocalMap();
            Function0<ComposeUiNode> constructor = ComposeUiNode.INSTANCE.getConstructor();
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3ModifierMaterializerOf = LayoutKt.modifierMaterializerOf(modifierM603requiredHeight3ABfNKs);
            if (!(composerStartRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            composerStartRestartGroup.startReusableNode();
                ...
                public final void invoke(Composer composer2, int i3) {
                    ...
                    if ((i3 & 3) != 2 || !composer2.getSkipping()) {
                                ...
                                if ((i4 & 3) != 2 || !composer3.getSkipping()) {
                                    ...
                                    if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                                        objRememberedValue = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$MonthsNavigation$1$1$1$1$1
                                            ...
                                            /* renamed from: invoke, reason: avoid collision after fix types in other method */
                                            public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                                                SemanticsPropertiesKt.m5078setLiveRegionhR3wRGc(semanticsPropertyReceiver, LiveRegionMode.INSTANCE.m5055getPolite0phEisY());
                                    ...
                                    composer3.endReplaceableGroup();
                                    TextKt.m2130Text4IGK_g(str3, SemanticsModifierKt.semantics$default(companion, false, (Function1) objRememberedValue, 1, null), 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer3, 0, 0, 131068);
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
                                        return;
                                    }
                        ...
                        if (!z3) {
                            ...
                            Composer composerM2944constructorimpl2 = Updater.m2944constructorimpl(composer2);
                            Updater.m2951setimpl(composerM2944constructorimpl2, measurePolicyRowMeasurePolicy2, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                            Updater.m2951setimpl(composerM2944constructorimpl2, currentCompositionLocalMap2, ComposeUiNode.INSTANCE.getSetResolvedCompositionLocals());
                            Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash2 = ComposeUiNode.INSTANCE.getSetCompositeKeyHash();
                            if (composerM2944constructorimpl2.getInserting() || !Intrinsics.areEqual(composerM2944constructorimpl2.rememberedValue(), Integer.valueOf(currentCompositeKeyHash2))) {
                                composerM2944constructorimpl2.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash2));
                            ...
                            IconButtonKt.IconButton(function05, null, z5, null, null, ComposableSingletons$DatePickerKt.INSTANCE.m1423getLambda3$material3_release(), composer2, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 26);
                            IconButtonKt.IconButton(function06, null, z6, null, null, ComposableSingletons$DatePickerKt.INSTANCE.m1424getLambda4$material3_release(), composer2, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 26);
                            ComposerKt.sourceInformationMarkerEnd(composer2);
                            ComposerKt.sourceInformationMarkerEnd(composer2);
                            composer2.endReplaceableGroup();
                            composer2.endNode();
    ...
    */
    ...
    static {
        float f = 12;
        DatePickerHorizontalPadding = Dp.m5735constructorimpl(f);
        DatePickerModeTogglePadding = PaddingKt.m562PaddingValuesa9UjIt4$default(0.0f, 0.0f, Dp.m5735constructorimpl(f), Dp.m5735constructorimpl(f), 3, null);
        float f2 = 24;
        float f3 = 16;
        DatePickerTitlePadding = PaddingKt.m562PaddingValuesa9UjIt4$default(Dp.m5735constructorimpl(f2), Dp.m5735constructorimpl(f3), Dp.m5735constructorimpl(f), 0.0f, 8, null);
        DatePickerHeadlinePadding = PaddingKt.m562PaddingValuesa9UjIt4$default(Dp.m5735constructorimpl(f2), 0.0f, Dp.m5735constructorimpl(f), Dp.m5735constructorimpl(f), 2, null);
        YearsVerticalPadding = Dp.m5735constructorimpl(f3);
    }
}
