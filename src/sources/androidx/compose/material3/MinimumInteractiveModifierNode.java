...
public final class MinimumInteractiveModifierNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, LayoutModifierNode {
    ...
    public MeasureResult mo90measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (z) {
            width = Math.max(placeableMo4684measureBRTryo0.getWidth(), measureScope.mo310roundToPx0680j_4(DpSize.m5833getWidthD9Ej5fM(j2)));
        } else {
            width = placeableMo4684measureBRTryo0.getWidth();
        }
        final int i = width;
        if (z) {
            height = Math.max(placeableMo4684measureBRTryo0.getHeight(), measureScope.mo310roundToPx0680j_4(DpSize.m5831getHeightD9Ej5fM(j2)));
        } else {
        ...
        return MeasureScope.layout$default(measureScope, i, i2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.MinimumInteractiveModifierNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, placeableMo4684measureBRTryo0, MathKt.roundToInt((i - placeableMo4684measureBRTryo0.getWidth()) / 2.0f), MathKt.roundToInt((i2 - placeableMo4684measureBRTryo0.getHeight()) / 2.0f), 0.0f, 4, null);
            }
        }, 4, null);
    }
}
