...
public final class SwitchKt {
    ...
    */
    ...
    public static final void m2015SwitchImpl0DmnUew(final BoxScope boxScope, final boolean z, final boolean z2, final SwitchColors switchColors, final State<Float> state, final Function2<? super Composer, ? super Integer, Unit> function2, final InteractionSource interactionSource, final Shape shape, final float f, final float f2, final float f3, Composer composer, final int i, final int i2) {
        int i3;
        int i4;
        float fM5735constructorimpl;
        final float fFloatValue;
        float fM2826getTrackOutlineWidthD9Ej5fM;
        ...
        if ((i3 & 306783379) != 306783378 || (i4 & 3) != 2 || !composerStartRestartGroup.getSkipping()) {
            ...
            long jM2012trackColorWaAFU9c$material3_release = switchColors.m2012trackColorWaAFU9c$material3_release(z2, z);
            ...
            float fMo312toDpu2uoSUM = ((Density) objConsume).mo312toDpu2uoSUM(state.getValue().floatValue());
            if (SwitchImpl_0DmnUew$lambda$8(stateCollectIsPressedAsState)) {
                fM5735constructorimpl = SwitchTokens.INSTANCE.m2820getPressedHandleWidthD9Ej5fM();
            } else {
                fM5735constructorimpl = Dp.m5735constructorimpl(Dp.m5735constructorimpl(Dp.m5735constructorimpl(ThumbDiameter - f) * (Dp.m5735constructorimpl(fMo312toDpu2uoSUM - f2) / Dp.m5735constructorimpl(f3 - f2))) + f);
            }
            ...
            if (SwitchImpl_0DmnUew$lambda$8(stateCollectIsPressedAsState)) {
                ...
                if (!z) {
                    fM2826getTrackOutlineWidthD9Ej5fM = SwitchTokens.INSTANCE.m2826getTrackOutlineWidthD9Ej5fM();
                } else {
                    fM2826getTrackOutlineWidthD9Ej5fM = Dp.m5735constructorimpl(ThumbPathLength - SwitchTokens.INSTANCE.m2826getTrackOutlineWidthD9Ej5fM());
                }
                fFloatValue = density.mo316toPx0680j_4(fM2826getTrackOutlineWidthD9Ej5fM);
            } else {
            ...
            Modifier modifierM211backgroundbw27NRU = BackgroundKt.m211backgroundbw27NRU(BorderKt.m224borderxT4_qwU(SizeKt.m600height3ABfNKs(SizeKt.m619width3ABfNKs(boxScope.align(Modifier.INSTANCE, Alignment.INSTANCE.getCenter()), SwitchWidth), SwitchHeight), SwitchTokens.INSTANCE.m2826getTrackOutlineWidthD9Ej5fM(), switchColors.m1992borderColorWaAFU9c$material3_release(z2, z), value), jM2012trackColorWaAFU9c$material3_release, value);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3ModifierMaterializerOf = LayoutKt.modifierMaterializerOf(modifierM211backgroundbw27NRU);
            ...
            long jM2011thumbColorWaAFU9c$material3_release = switchColors.m2011thumbColorWaAFU9c$material3_release(z2, z);
            ...
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = (Function1) new Function1<Density, IntOffset>() { // from class: androidx.compose.material3.SwitchKt$SwitchImpl$1$1$1
                    ...
                    public /* bridge */ /* synthetic */ IntOffset invoke(Density density2) {
                        return IntOffset.m5854boximpl(m2017invokeBjo55l4(density2));
                    }

                    /* renamed from: invoke-Bjo55l4, reason: not valid java name */
                    public final long m2017invokeBjo55l4(Density density2) {
            ...
            composerStartRestartGroup.endReplaceableGroup();
            Modifier modifierM211backgroundbw27NRU2 = BackgroundKt.m211backgroundbw27NRU(SizeKt.m606requiredSize3ABfNKs(IndicationKt.indication(OffsetKt.offset(modifierAlign, (Function1) objRememberedValue), interactionSource, RippleKt.m1218rememberRipple9IZ8Weo(false, Dp.m5735constructorimpl(SwitchTokens.INSTANCE.m2824getStateLayerSizeD9Ej5fM() / 2), 0L, composerStartRestartGroup, 54, 4)), fM5735constructorimpl), jM2011thumbColorWaAFU9c$material3_release, shape);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3ModifierMaterializerOf2 = LayoutKt.modifierMaterializerOf(modifierM211backgroundbw27NRU2);
            if (!(composerStartRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            composerStartRestartGroup.startReusableNode();
            ...
            Updater.m2951setimpl(composerM2944constructorimpl2, measurePolicyRememberBoxMeasurePolicy2, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            ...
            if (function2 != null) {
                CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m3404boximpl(switchColors.m2010iconColorWaAFU9c$material3_release(z2, z))), function2, composerStartRestartGroup, 0 | ProvidedValue.$stable | ((i5 >> 12) & 112));
            }
            composerStartRestartGroup.endReplaceableGroup();
            ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SwitchKt$SwitchImpl$2
                ...
                public final void invoke(Composer composer2, int i6) {
                    SwitchKt.m2015SwitchImpl0DmnUew(boxScope, z, z2, switchColors, state, function2, interactionSource, shape, f, f2, f3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), RecomposeScopeImplKt.updateChangedFlags(i2));
                }
            });
        }
    }
    ...
    static {
        float fM2822getSelectedHandleWidthD9Ej5fM = SwitchTokens.INSTANCE.m2822getSelectedHandleWidthD9Ej5fM();
        ThumbDiameter = fM2822getSelectedHandleWidthD9Ej5fM;
        UncheckedThumbDiameter = SwitchTokens.INSTANCE.m2829getUnselectedHandleWidthD9Ej5fM();
        float fM2827getTrackWidthD9Ej5fM = SwitchTokens.INSTANCE.m2827getTrackWidthD9Ej5fM();
        SwitchWidth = fM2827getTrackWidthD9Ej5fM;
        float fM2825getTrackHeightD9Ej5fM = SwitchTokens.INSTANCE.m2825getTrackHeightD9Ej5fM();
        SwitchHeight = fM2825getTrackHeightD9Ej5fM;
        float fM5735constructorimpl = Dp.m5735constructorimpl(Dp.m5735constructorimpl(fM2825getTrackHeightD9Ej5fM - fM2822getSelectedHandleWidthD9Ej5fM) / 2);
        ThumbPadding = fM5735constructorimpl;
        ThumbPathLength = Dp.m5735constructorimpl(Dp.m5735constructorimpl(fM2827getTrackWidthD9Ej5fM - fM2822getSelectedHandleWidthD9Ej5fM) - fM5735constructorimpl);
