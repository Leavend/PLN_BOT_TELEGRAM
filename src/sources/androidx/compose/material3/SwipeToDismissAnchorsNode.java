...
final class SwipeToDismissAnchorsNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo90measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (measureScope.isLookingAhead() || !this.didLookahead) {
            final float width = placeableMo4684measureBRTryo0.getWidth();
        ...
        return MeasureScope.layout$default(measureScope, placeableMo4684measureBRTryo0.getWidth(), placeableMo4684measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.SwipeToDismissAnchorsNode$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                Placeable.PlacementScope.place$default(placementScope, placeableMo4684measureBRTryo0, MathKt.roundToInt(fRequireOffset), 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
}
