...
final class MinimumInteractiveComponentSizeModifier implements LayoutModifier {
    ...
    public MeasureResult mo63measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final int iMax = Math.max(placeableMo4684measureBRTryo0.getWidth(), measureScope.mo310roundToPx0680j_4(DpSize.m5833getWidthD9Ej5fM(this.size)));
        final int iMax2 = Math.max(placeableMo4684measureBRTryo0.getHeight(), measureScope.mo310roundToPx0680j_4(DpSize.m5831getHeightD9Ej5fM(this.size)));
        return MeasureScope.layout$default(measureScope, iMax, iMax2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.MinimumInteractiveComponentSizeModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, placeableMo4684measureBRTryo0, MathKt.roundToInt((iMax - placeableMo4684measureBRTryo0.getWidth()) / 2.0f), MathKt.roundToInt((iMax2 - placeableMo4684measureBRTryo0.getHeight()) / 2.0f), 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return DpSize.m5830equalsimpl0(this.size, minimumInteractiveComponentSizeModifier.size);
    }

    public int hashCode() {
        return DpSize.m5835hashCodeimpl(this.size);
    }
}
