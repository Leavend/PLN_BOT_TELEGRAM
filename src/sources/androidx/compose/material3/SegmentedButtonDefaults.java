...
public final class SegmentedButtonDefaults {
    ...
    private static final float BorderWidth = OutlinedSegmentedButtonTokens.INSTANCE.m2670getOutlineWidthD9Ej5fM();
    private static final float IconSize = OutlinedSegmentedButtonTokens.INSTANCE.m2669getIconSizeD9Ej5fM();
    ...
    public final SegmentedButtonColors m1827colorsXqyqHi0(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, Composer composer, int i, int i2, int i3) {
    ...
    public final float m1828getBorderWidthD9Ej5fM() {
        return BorderWidth;
    }
    ...
    public final void ActiveIcon(Composer composer, final int i) {
        ...
        if ((i2 & 3) != 2 || !composerStartRestartGroup.getSkipping()) {
            ...
            IconKt.m1602Iconww6aTOc(CheckKt.getCheck(Icons.Filled.INSTANCE), (String) null, SizeKt.m614size3ABfNKs(Modifier.INSTANCE, IconSize), 0L, composerStartRestartGroup, 48, 8);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    */
    ...
    public static /* synthetic */ BorderStroke m1825borderStrokel07J4OM$default(SegmentedButtonDefaults segmentedButtonDefaults, long j, float f, int i, Object obj) {
        if ((i & 2) != 0) {
            f = BorderWidth;
        }
        return segmentedButtonDefaults.m1826borderStrokel07J4OM(j, f);
    }

    /* renamed from: borderStroke-l07J4OM, reason: not valid java name */
    public final BorderStroke m1826borderStrokel07J4OM(long color, float width) {
        return BorderStrokeKt.m240BorderStrokecXLIe8U(width, color);
    }
}
