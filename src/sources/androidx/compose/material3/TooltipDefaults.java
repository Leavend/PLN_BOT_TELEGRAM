...
public final class TooltipDefaults {
    ...
    private static final CaretProperties caretProperties = new CaretProperties(Dp.m5735constructorimpl(8), Dp.m5735constructorimpl(16), null);
    ...
    public final RichTooltipColors m2272richTooltipColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        RichTooltipColors richTooltipColorsM1779copyjRlVdoo = getDefaultRichTooltipColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1779copyjRlVdoo(jM3450getUnspecified0d7_KjU, jM3450getUnspecified0d7_KjU2, jM3450getUnspecified0d7_KjU3, jM3450getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return richTooltipColorsM1779copyjRlVdoo;
    }
    ...
    public final PopupPositionProvider m2270rememberPlainTooltipPositionProviderkHDZbjc(float f, Composer composer, int i, int i2) {
        ...
        final int iMo310roundToPx0680j_4 = ((Density) objConsume).mo310roundToPx0680j_4(f);
        composer.startReplaceableGroup(-2013870024);
        ComposerKt.sourceInformation(composer, "CC(remember):Tooltip.kt#9igjgp");
        boolean zChanged = composer.changed(iMo310roundToPx0680j_4);
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new PopupPositionProvider() { // from class: androidx.compose.material3.TooltipDefaults$rememberPlainTooltipPositionProvider$1$1
                ...
                public long mo992calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
                    int left = anchorBounds.getLeft() + ((anchorBounds.getWidth() - IntSize.m5905getWidthimpl(popupContentSize)) / 2);
                    int top = (anchorBounds.getTop() - IntSize.m5904getHeightimpl(popupContentSize)) - iMo310roundToPx0680j_4;
                    if (top < 0) {
                        top = iMo310roundToPx0680j_4 + anchorBounds.getBottom();
                    }
    ...
    public final PopupPositionProvider m2271rememberRichTooltipPositionProviderkHDZbjc(float f, Composer composer, int i, int i2) {
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new PopupPositionProvider() { // from class: androidx.compose.material3.TooltipDefaults$rememberRichTooltipPositionProvider$1$1
                ...
                public long mo992calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
                    ...
                    if (IntSize.m5905getWidthimpl(popupContentSize) + right > IntSize.m5905getWidthimpl(windowSize) && (right = anchorBounds.getLeft() - IntSize.m5905getWidthimpl(popupContentSize)) < 0) {
                        right = anchorBounds.getLeft() + ((anchorBounds.getWidth() - IntSize.m5905getWidthimpl(popupContentSize)) / 2);
                    }
                    int top = (anchorBounds.getTop() - IntSize.m5904getHeightimpl(popupContentSize)) - iMo310roundToPx0680j_4;
                    if (top < 0) {
                        top = iMo310roundToPx0680j_4 + anchorBounds.getBottom();
