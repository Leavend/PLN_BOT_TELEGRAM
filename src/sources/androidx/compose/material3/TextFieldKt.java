    ...
    */
    ...
    public static final void TextFieldLayout(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function3<? super Modifier, ? super Composer, ? super Integer, Unit> function3, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final Function2<? super Composer, ? super Integer, Unit> function25, final Function2<? super Composer, ? super Integer, Unit> function26, final boolean z, final float f, final Function2<? super Composer, ? super Integer, Unit> function27, final Function2<? super Composer, ? super Integer, Unit> function28, final PaddingValues paddingValues, Composer composer, final int i, final int i2) {
        ...
        if ((i7 & 306783379) != 306783378 || (i8 & 147) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            Updater.m2951setimpl(composerM2944constructorimpl, textFieldMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            ...
            if (function22 != null) {
                Modifier modifierM569paddingqDBjuR0$default3 = PaddingKt.m569paddingqDBjuR0$default(SizeKt.wrapContentHeight$default(SizeKt.m602heightInVpY3zN4$default(LayoutIdKt.layoutId(Modifier.INSTANCE, TextFieldImplKt.LabelId), DpKt.m5778lerpMdfbLM(TextFieldImplKt.getMinTextLineHeight(), TextFieldImplKt.getMinFocusedLabelLineHeight(), f), 0.0f, 2, null), null, false, 3, null), fCalculateStartPadding, 0.0f, fCalculateEndPadding, 0.0f, 10, null);
                composerStartRestartGroup.startReplaceableGroup(733328855);
                ComposerKt.sourceInformation(composerStartRestartGroup, "CC(Box)P(2,1,3)71@3309L67,72@3381L130:Box.kt#2w3rfo");
                ...
                Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3ModifierMaterializerOf6 = LayoutKt.modifierMaterializerOf(modifierM569paddingqDBjuR0$default3);
            ...
            composerStartRestartGroup.endReplaceableGroup();
            Modifier modifierWrapContentHeight$default = SizeKt.wrapContentHeight$default(SizeKt.m602heightInVpY3zN4$default(Modifier.INSTANCE, TextFieldImplKt.getMinTextLineHeight(), 0.0f, 2, null), null, false, 3, null);
            if (function25 != null) {
                fCalculateStartPadding = Dp.m5735constructorimpl(0);
            }
            Modifier modifierM569paddingqDBjuR0$default4 = PaddingKt.m569paddingqDBjuR0$default(modifierWrapContentHeight$default, fCalculateStartPadding, 0.0f, function26 == null ? f2 : Dp.m5735constructorimpl(0), 0.0f, 10, null);
            ...
            if (function3 != null) {
                function3.invoke(LayoutIdKt.layoutId(Modifier.INSTANCE, TextFieldImplKt.PlaceholderId).then(modifierM569paddingqDBjuR0$default4), composerStartRestartGroup, Integer.valueOf((i7 >> 6) & 112));
            }
            composerStartRestartGroup.endReplaceableGroup();
            Modifier modifierThen3 = LayoutIdKt.layoutId(Modifier.INSTANCE, TextFieldImplKt.TextFieldId).then(modifierM569paddingqDBjuR0$default4);
            composerStartRestartGroup.startReplaceableGroup(733328855);
            ComposerKt.sourceInformation(composerStartRestartGroup, "CC(Box)P(2,1,3)71@3309L67,72@3381L130:Box.kt#2w3rfo");
    ...
    public static final int m2127calculateWidthyeHjK3Y(int i, int i2, int i3, int i4, int i5, int i6, int i7, long j) {
        int i8 = i3 + i4;
        return Math.max(i + Math.max(i5 + i8, Math.max(i7 + i8, i6)) + i2, Constraints.m5693getMinWidthimpl(j));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: calculateHeight-mKXJcVc, reason: not valid java name */
    public static final int m2126calculateHeightmKXJcVc(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, float f, long j, float f2, PaddingValues paddingValues) {
        boolean z = i2 > 0;
        float fM5735constructorimpl = Dp.m5735constructorimpl(paddingValues.getTop() + paddingValues.getBottom()) * f2;
        if (z) {
            fM5735constructorimpl = MathHelpersKt.lerp(Dp.m5735constructorimpl(TextFieldImplKt.getTextFieldPadding() * 2) * f2, fM5735constructorimpl, f);
        }
        return Math.max(Constraints.m5692getMinHeightimpl(j), Math.max(i3, Math.max(i4, MathKt.roundToInt(fM5735constructorimpl + MathHelpersKt.lerp(0, i2, f) + ComparisonsKt.maxOf(i, i7, i5, i6, MathHelpersKt.lerp(i2, 0, f))))) + i8);
    }
    ...
    public static final void placeWithoutLabel(Placeable.PlacementScope placementScope, int i, int i2, Placeable placeable, Placeable placeable2, Placeable placeable3, Placeable placeable4, Placeable placeable5, Placeable placeable6, Placeable placeable7, Placeable placeable8, boolean z, float f, PaddingValues paddingValues) {
        Placeable.PlacementScope.m4735place70tqf50$default(placementScope, placeable7, IntOffset.INSTANCE.m5873getZeronOccac(), 0.0f, 2, null);
    ...
    public static final Modifier drawIndicatorLine(Modifier modifier, final BorderStroke borderStroke) {
        ...
        return DrawModifierKt.drawWithContent(modifier, new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.material3.TextFieldKt.drawIndicatorLine.1
            ...
            public final void invoke2(ContentDrawScope contentDrawScope) {
                ...
                if (Dp.m5740equalsimpl0(width, Dp.INSTANCE.m5753getHairlineD9Ej5fM())) {
                    return;
                }
                float density = width * contentDrawScope.getDensity();
                float fM3239getHeightimpl = Size.m3239getHeightimpl(contentDrawScope.mo3963getSizeNHjbRc()) - (density / 2);
                DrawScope.m3949drawLine1RTmtNc$default(contentDrawScope, borderStroke.getBrush(), OffsetKt.Offset(0.0f, fM3239getHeightimpl), OffsetKt.Offset(Size.m3242getWidthimpl(contentDrawScope.mo3963getSizeNHjbRc()), fM3239getHeightimpl), density, 0, null, 0.0f, null, 0, 496, null);
            }
        });
    }
