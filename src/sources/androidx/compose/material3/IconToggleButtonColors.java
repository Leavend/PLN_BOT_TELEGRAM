...
public final class IconToggleButtonColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3415equalsimpl0(this.containerColor, iconToggleButtonColors.containerColor) && Color.m3415equalsimpl0(this.contentColor, iconToggleButtonColors.contentColor) && Color.m3415equalsimpl0(this.disabledContainerColor, iconToggleButtonColors.disabledContainerColor) && Color.m3415equalsimpl0(this.disabledContentColor, iconToggleButtonColors.disabledContentColor) && Color.m3415equalsimpl0(this.checkedContainerColor, iconToggleButtonColors.checkedContainerColor) && Color.m3415equalsimpl0(this.checkedContentColor, iconToggleButtonColors.checkedContentColor);
    }

    public int hashCode() {
        return (((((((((Color.m3421hashCodeimpl(this.containerColor) * 31) + Color.m3421hashCodeimpl(this.contentColor)) * 31) + Color.m3421hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m3421hashCodeimpl(this.disabledContentColor)) * 31) + Color.m3421hashCodeimpl(this.checkedContainerColor)) * 31) + Color.m3421hashCodeimpl(this.checkedContentColor);
    }
}
