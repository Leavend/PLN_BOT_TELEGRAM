...
public final class ShapesKt {
    ...
    public static final CornerBasedShape top(CornerBasedShape cornerBasedShape) {
        ...
        return CornerBasedShape.copy$default(cornerBasedShape, null, null, CornerSizeKt.m828CornerSize0680j_4(Dp.m5735constructorimpl(f)), CornerSizeKt.m828CornerSize0680j_4(Dp.m5735constructorimpl(f)), 3, null);
    }

    public static final CornerBasedShape bottom(CornerBasedShape cornerBasedShape) {
        float f = (float) FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE;
        return CornerBasedShape.copy$default(cornerBasedShape, CornerSizeKt.m828CornerSize0680j_4(Dp.m5735constructorimpl(f)), CornerSizeKt.m828CornerSize0680j_4(Dp.m5735constructorimpl(f)), null, null, 12, null);
    }

    public static final CornerBasedShape start(CornerBasedShape cornerBasedShape) {
        float f = (float) FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE;
        return CornerBasedShape.copy$default(cornerBasedShape, null, CornerSizeKt.m828CornerSize0680j_4(Dp.m5735constructorimpl(f)), CornerSizeKt.m828CornerSize0680j_4(Dp.m5735constructorimpl(f)), null, 9, null);
    }

    public static final CornerBasedShape end(CornerBasedShape cornerBasedShape) {
        float f = (float) FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE;
        return CornerBasedShape.copy$default(cornerBasedShape, CornerSizeKt.m828CornerSize0680j_4(Dp.m5735constructorimpl(f)), null, null, CornerSizeKt.m828CornerSize0680j_4(Dp.m5735constructorimpl(f)), 6, null);
    }
}
