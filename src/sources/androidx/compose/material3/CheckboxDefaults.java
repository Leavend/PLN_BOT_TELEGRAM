...
public final class CheckboxDefaults {
    ...
    public final CheckboxColors m1319colors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        CheckboxColors checkboxColorsM1306copy2qZNXz8 = getDefaultCheckboxColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1306copy2qZNXz8(jM3450getUnspecified0d7_KjU3, Color.INSTANCE.m3449getTransparent0d7_KjU(), jM3450getUnspecified0d7_KjU, Color.INSTANCE.m3449getTransparent0d7_KjU(), jM3450getUnspecified0d7_KjU4, Color.INSTANCE.m3449getTransparent0d7_KjU(), jM3450getUnspecified0d7_KjU6, jM3450getUnspecified0d7_KjU, jM3450getUnspecified0d7_KjU2, jM3450getUnspecified0d7_KjU4, jM3450getUnspecified0d7_KjU5, jM3450getUnspecified0d7_KjU6);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return checkboxColorsM1306copy2qZNXz8;
    }
