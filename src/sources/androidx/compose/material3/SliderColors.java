...
public final class SliderColors {
    ...
    public final long m1868thumbColorvNxB06k$material3_release(boolean enabled) {
        return enabled ? this.thumbColor : this.disabledThumbColor;
    }

    /* renamed from: trackColor-WaAFU9c$material3_release, reason: not valid java name */
    public final long m1870trackColorWaAFU9c$material3_release(boolean enabled, boolean active) {
    ...
    public final long m1869tickColorWaAFU9c$material3_release(boolean enabled, boolean active) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3415equalsimpl0(this.thumbColor, sliderColors.thumbColor) && Color.m3415equalsimpl0(this.activeTrackColor, sliderColors.activeTrackColor) && Color.m3415equalsimpl0(this.activeTickColor, sliderColors.activeTickColor) && Color.m3415equalsimpl0(this.inactiveTrackColor, sliderColors.inactiveTrackColor) && Color.m3415equalsimpl0(this.inactiveTickColor, sliderColors.inactiveTickColor) && Color.m3415equalsimpl0(this.disabledThumbColor, sliderColors.disabledThumbColor) && Color.m3415equalsimpl0(this.disabledActiveTrackColor, sliderColors.disabledActiveTrackColor) && Color.m3415equalsimpl0(this.disabledActiveTickColor, sliderColors.disabledActiveTickColor) && Color.m3415equalsimpl0(this.disabledInactiveTrackColor, sliderColors.disabledInactiveTrackColor) && Color.m3415equalsimpl0(this.disabledInactiveTickColor, sliderColors.disabledInactiveTickColor);
    }

    public int hashCode() {
        return (((((((((((((((((Color.m3421hashCodeimpl(this.thumbColor) * 31) + Color.m3421hashCodeimpl(this.activeTrackColor)) * 31) + Color.m3421hashCodeimpl(this.activeTickColor)) * 31) + Color.m3421hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m3421hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m3421hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m3421hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m3421hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m3421hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m3421hashCodeimpl(this.disabledInactiveTickColor);
    }

    /* renamed from: copy--K518z4, reason: not valid java name */
    public final SliderColors m1857copyK518z4(long thumbColor, long activeTrackColor, long activeTickColor, long inactiveTrackColor, long inactiveTickColor, long disabledThumbColor, long disabledActiveTrackColor, long disabledActiveTickColor, long disabledInactiveTrackColor, long disabledInactiveTickColor) {
        return new SliderColors((thumbColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (thumbColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? thumbColor : this.thumbColor, (activeTrackColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (activeTrackColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? activeTrackColor : this.activeTrackColor, (activeTickColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (activeTickColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? activeTickColor : this.activeTickColor, (inactiveTrackColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (inactiveTrackColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? inactiveTrackColor : this.inactiveTrackColor, (inactiveTickColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (inactiveTickColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? inactiveTickColor : this.inactiveTickColor, (disabledThumbColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (disabledThumbColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledThumbColor : this.disabledThumbColor, (disabledActiveTrackColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (disabledActiveTrackColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledActiveTrackColor : this.disabledActiveTrackColor, (disabledActiveTickColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (disabledActiveTickColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledActiveTickColor : this.disabledActiveTickColor, (disabledInactiveTrackColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (disabledInactiveTrackColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledInactiveTrackColor : this.disabledInactiveTrackColor, disabledInactiveTickColor != Color.INSTANCE.m3450getUnspecified0d7_KjU() ? disabledInactiveTickColor : this.disabledInactiveTickColor, null);
    }
}
