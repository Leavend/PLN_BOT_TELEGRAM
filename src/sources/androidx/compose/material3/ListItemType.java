...
final class ListItemType implements Comparable<ListItemType> {
    ...
    private static final int OneLine = m1653constructorimpl(1);
    private static final int TwoLine = m1653constructorimpl(2);
    private static final int ThreeLine = m1653constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ListItemType m1651boximpl(int i) {
    ...
    public boolean equals(Object obj) {
        return m1654equalsimpl(this.lines, obj);
    }

    public int hashCode() {
        return m1656hashCodeimpl(this.lines);
    }

    public String toString() {
        return m1657toStringimpl(this.lines);
    }
    ...
    public /* bridge */ /* synthetic */ int compareTo(ListItemType listItemType) {
        return m1658compareToyh95HIg(listItemType.getLines());
    }
