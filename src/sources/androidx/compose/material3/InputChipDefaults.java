...
public final class InputChipDefaults {
    ...
    private static final float Height = InputChipTokens.INSTANCE.m2601getContainerHeightD9Ej5fM();
    private static final float IconSize = InputChipTokens.INSTANCE.m2603getLeadingIconSizeD9Ej5fM();
    private static final float AvatarSize = InputChipTokens.INSTANCE.m2599getAvatarSizeD9Ej5fM();

    private InputChipDefaults() {
    }

    /* renamed from: getHeight-D9Ej5fM, reason: not valid java name */
    public final float m1611getHeightD9Ej5fM() {
        return Height;
    }
    ...
    public final float m1610getAvatarSizeD9Ej5fM() {
        return AvatarSize;
    }
    ...
    public final SelectableChipColors m1614inputChipColorskwJvTHA(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, Composer composer, int i, int i2, int i3) {
    ...
    public final SelectableChipElevation m1615inputChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float fM2600getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? InputChipTokens.INSTANCE.m2600getContainerElevationD9Ej5fM() : f;
        float f7 = (i2 & 2) != 0 ? fM2600getContainerElevationD9Ej5fM : f2;
        float f8 = (i2 & 4) != 0 ? fM2600getContainerElevationD9Ej5fM : f3;
        float f9 = (i2 & 8) != 0 ? fM2600getContainerElevationD9Ej5fM : f4;
        float fM2602getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? InputChipTokens.INSTANCE.m2602getDraggedContainerElevationD9Ej5fM() : f5;
        float f10 = (i2 & 32) != 0 ? fM2600getContainerElevationD9Ej5fM : f6;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1745270109, i, -1, "androidx.compose.material3.InputChipDefaults.inputChipElevation (Chip.kt:1580)");
        }
        SelectableChipElevation selectableChipElevation = new SelectableChipElevation(fM2600getContainerElevationD9Ej5fM, f7, f8, f9, fM2602getDraggedContainerElevationD9Ej5fM, f10, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final BorderStroke m1613inputChipBorder_7El2pE(boolean z, boolean z2, long j, long j2, long j3, long j4, float f, float f2, Composer composer, int i, int i2) {
        ...
        long jM3413copywmQWz5c$default = (i2 & 16) != 0 ? Color.m3413copywmQWz5c$default(ColorSchemeKt.getValue(InputChipTokens.INSTANCE.getDisabledUnselectedOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long jM3449getTransparent0d7_KjU2 = (i2 & 32) != 0 ? Color.INSTANCE.m3449getTransparent0d7_KjU() : j4;
        float fM2606getUnselectedOutlineWidthD9Ej5fM = (i2 & 64) != 0 ? InputChipTokens.INSTANCE.m2606getUnselectedOutlineWidthD9Ej5fM() : f;
        float fM2604getSelectedOutlineWidthD9Ej5fM = (i2 & 128) != 0 ? InputChipTokens.INSTANCE.m2604getSelectedOutlineWidthD9Ej5fM() : f2;
        if (ComposerKt.isTraceInProgress()) {
        ...
        if (z2) {
            fM2606getUnselectedOutlineWidthD9Ej5fM = fM2604getSelectedOutlineWidthD9Ej5fM;
        }
        BorderStroke borderStrokeM240BorderStrokecXLIe8U = BorderStrokeKt.m240BorderStrokecXLIe8U(fM2606getUnselectedOutlineWidthD9Ej5fM, value);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
