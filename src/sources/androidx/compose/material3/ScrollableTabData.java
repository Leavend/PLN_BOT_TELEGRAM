...
final class ScrollableTabData {
    ...
    private final int calculateTabOffset(TabPosition tabPosition, Density density, int i, List<TabPosition> list) {
        int iMo310roundToPx0680j_4 = density.mo310roundToPx0680j_4(((TabPosition) CollectionsKt.last((List) list)).m2025getRightD9Ej5fM()) + i;
        int maxValue = iMo310roundToPx0680j_4 - this.scrollState.getMaxValue();
        return RangesKt.coerceIn(density.mo310roundToPx0680j_4(tabPosition.getLeft()) - ((maxValue / 2) - (density.mo310roundToPx0680j_4(tabPosition.getWidth()) / 2)), 0, RangesKt.coerceAtLeast(iMo310roundToPx0680j_4 - maxValue, 0));
    }
}
