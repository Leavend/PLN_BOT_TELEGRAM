...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0004\bÁ\u0002\u0018\u00002\u00020\u0001:\u0002\u0003\u0004B\u0007\b\u0002¢\u0006\u0002\u0010\u0002¨\u0006\u0005"}, d2 = {"Landroidx/compose/material3/WindowAlignmentMarginPosition;", "", "()V", "Horizontal", "Vertical", "material3_release"}, k = 1, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class WindowAlignmentMarginPosition {
    ...
    public static final /* data */ class Horizontal implements MenuPosition.Horizontal {
        ...
        public int mo1227position95KtPRI(IntRect anchorBounds, long windowSize, int menuWidth, LayoutDirection layoutDirection) {
            if (menuWidth >= IntSize.m5905getWidthimpl(windowSize) - (this.margin * 2)) {
                return Alignment.INSTANCE.getCenterHorizontally().align(menuWidth, IntSize.m5905getWidthimpl(windowSize), layoutDirection);
            }
            return RangesKt.coerceIn(this.alignment.align(menuWidth, IntSize.m5905getWidthimpl(windowSize), layoutDirection), this.margin, (IntSize.m5905getWidthimpl(windowSize) - this.margin) - menuWidth);
        }
    }
    ...
    public static final /* data */ class Vertical implements MenuPosition.Vertical {
        ...
        public int mo1228positionJVtK1S4(IntRect anchorBounds, long windowSize, int menuHeight) {
            if (menuHeight >= IntSize.m5904getHeightimpl(windowSize) - (this.margin * 2)) {
                return Alignment.INSTANCE.getCenterVertically().align(menuHeight, IntSize.m5904getHeightimpl(windowSize));
            }
            return RangesKt.coerceIn(this.alignment.align(menuHeight, IntSize.m5904getHeightimpl(windowSize)), this.margin, (IntSize.m5904getHeightimpl(windowSize) - this.margin) - menuHeight);
        }
    }
}
