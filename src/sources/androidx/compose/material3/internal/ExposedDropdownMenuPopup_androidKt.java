...
public final class ExposedDropdownMenuPopup_androidKt {
    public static final void ExposedDropdownMenuPopup(Function0<Unit> function0, final PopupPositionProvider popupPositionProvider, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i, final int i2) {
        ...
        if ((i6 & 147) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            UUID uuid = (UUID) RememberSaveableKt.m3031rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<UUID>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopup_androidKt$ExposedDropdownMenuPopup$popupId$1
                            ...
                            if (zChangedInstance || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                                objRememberedValue2 = (Function1) new Function1<IntSize, Unit>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopup_androidKt$ExposedDropdownMenuPopup$popupLayout$1$1$1$2$1
                                    ...
                                    public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
                                        m2292invokeozmzZPI(intSize.getPackedValue());
                                        return Unit.INSTANCE;
                                    }

                                    /* renamed from: invoke-ozmzZPI, reason: not valid java name */
                                    public final void m2292invokeozmzZPI(long j) {
                                        popupLayout2.m2294setPopupContentSizefhxjrPA(IntSize.m5897boximpl(j));
            ...
            if (zChangedInstance3 || objRememberedValue4 == Composer.INSTANCE.getEmpty()) {
                objRememberedValue4 = (Function1) new Function1<LayoutCoordinates, Unit>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopup_androidKt$ExposedDropdownMenuPopup$4$1
                    ...
                    public final void invoke2(LayoutCoordinates layoutCoordinates) {
                        ...
                        popupLayout2.setParentBounds(IntRectKt.m5895IntRectVbeCjmY(IntOffsetKt.IntOffset(MathKt.roundToInt(Offset.m3173getXimpl(jPositionInWindow)), MathKt.roundToInt(Offset.m3174getYimpl(jPositionInWindow))), jMo4691getSizeYbymL2g));
                        popupLayout2.updatePosition();
                    }
                };
    ...
    public static final class AnonymousClass1 implements MeasurePolicy {
        ...
        public final MeasureResult mo37measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
            ...
            if (size == 1) {
                ...
                return MeasureScope.layout$default(measureScope, placeableMo4684measureBRTryo0.getWidth(), placeableMo4684measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopup_androidKt.SimpleStack.1.2
                    {
                        super(1);
                    }
