...
public final class PullToRefreshKt {
    ...
    private static final float StrokeWidth = Dp.m5735constructorimpl((float) 2.5d);
    private static final float ArcRadius = Dp.m5735constructorimpl((float) 5.5d);
    private static final float SpinnerSize = Dp.m5735constructorimpl(16);
    private static final float SpinnerContainerSize = Dp.m5735constructorimpl(40);
    private static final float Elevation = ElevationTokens.INSTANCE.m2480getLevel2D9Ej5fM();
    private static final float ArrowWidth = Dp.m5735constructorimpl(10);
    private static final float ArrowHeight = Dp.m5735constructorimpl(5);
    ...
    */
    public static final void m2299PullToRefreshContainerwBJOh4Y(final androidx.compose.material3.pulltorefresh.PullToRefreshState r17, androidx.compose.ui.Modifier r18, kotlin.jvm.functions.Function3<? super androidx.compose.material3.pulltorefresh.PullToRefreshState, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r19, androidx.compose.ui.graphics.Shape r20, long r21, long r23, androidx.compose.runtime.Composer r25, final int r26, final int r27) {
        /*
            Method dump skipped, instructions count: 436
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.pulltorefresh.PullToRefreshKt.m2299PullToRefreshContainerwBJOh4Y(androidx.compose.material3.pulltorefresh.PullToRefreshState, androidx.compose.ui.Modifier, kotlin.jvm.functions.Function3, androidx.compose.ui.graphics.Shape, long, long, androidx.compose.runtime.Composer, int, int):void");
    }

    /* renamed from: rememberPullToRefreshState--orJrPs, reason: not valid java name */
    public static final PullToRefreshState m2305rememberPullToRefreshStateorJrPs(float f, final Function0<Boolean> function0, Composer composer, int i, int i2) {
        ...
        if ((i2 & 1) != 0) {
            f = PullToRefreshDefaults.INSTANCE.m2297getPositionalThresholdD9Ej5fM();
        }
        if ((i2 & 2) != 0) {
        ...
        final float fMo316toPx0680j_4 = ((Density) objConsume).mo316toPx0680j_4(f);
        Object[] objArr = {Float.valueOf(fMo316toPx0680j_4), function0};
        Saver<PullToRefreshState, Boolean> Saver = PullToRefreshStateImpl.INSTANCE.Saver(fMo316toPx0680j_4, function0);
        composer.startReplaceableGroup(804873447);
        ComposerKt.sourceInformation(composer, "CC(remember):PullToRefresh.kt#9igjgp");
        boolean zChanged = ((((i & 112) ^ 48) > 32 && composer.changed(function0)) || (i & 48) == 32) | composer.changed(fMo316toPx0680j_4);
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = (Function0) new Function0<PullToRefreshState>() { // from class: androidx.compose.material3.pulltorefresh.PullToRefreshKt$rememberPullToRefreshState$2$1
                ...
                public final PullToRefreshState invoke() {
                    return new PullToRefreshStateImpl(false, fMo316toPx0680j_4, function0);
                }
            };
            composer.updateRememberedValue(objRememberedValue);
        }
        composer.endReplaceableGroup();
        PullToRefreshState pullToRefreshState = (PullToRefreshState) RememberSaveableKt.m3031rememberSaveable(objArr, (Saver) Saver, (String) null, (Function0) objRememberedValue, composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m2298CircularArrowProgressIndicatorRPmYEkk(final Function0<Float> function0, final long j, Composer composer, final int i) {
        int i2;
        Composer composer2;
        ...
        if ((i2 & 19) != 18 || !composerStartRestartGroup.getSkipping()) {
            ...
            if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
                ...
                Path.mo3307setFillTypeoQ8Xj4U(PathFillType.INSTANCE.m3696getEvenOddRgk1Os());
            ...
            composerStartRestartGroup.endReplaceableGroup();
            Modifier modifierM614size3ABfNKs = SizeKt.m614size3ABfNKs(SemanticsModifierKt.semantics(companion, true, (Function1) objRememberedValue3), SpinnerSize);
            ...
            if (zChanged || objRememberedValue4 == Composer.INSTANCE.getEmpty()) {
                ...
                objRememberedValue4 = (Function1) new Function1<DrawScope, Unit>() { // from class: androidx.compose.material3.pulltorefresh.PullToRefreshKt$CircularArrowProgressIndicator$2$1
                    ...
                    public final void invoke2(DrawScope drawScope) {
                        ...
                        long j2 = j;
                        Path path2 = path;
                        long jMo3962getCenterF1C5BW0 = drawScope.mo3962getCenterF1C5BW0();
                        DrawContext drawContext = drawScope.getDrawContext();
                        long jMo3888getSizeNHjbRc = drawContext.mo3888getSizeNHjbRc();
                        drawContext.getCanvas().save();
                        drawContext.getTransform().mo3894rotateUv8p0NA(rotation, jMo3962getCenterF1C5BW0);
                        Rect rectM3212Rect3MmeM6k = RectKt.m3212Rect3MmeM6k(androidx.compose.ui.geometry.SizeKt.m3252getCenteruvyYCjk(drawScope.mo3963getSizeNHjbRc()), drawScope.mo316toPx0680j_4(PullToRefreshKt.ArcRadius) + (drawScope.mo316toPx0680j_4(PullToRefreshKt.StrokeWidth) / 2.0f));
                        PullToRefreshKt.m2304drawCircularIndicatorKzyDr3Q(drawScope, j2, fFloatValue, ArrowValues, rectM3212Rect3MmeM6k, PullToRefreshKt.StrokeWidth);
                        PullToRefreshKt.m2303drawArrowuDrxG_w(drawScope, path2, rectM3212Rect3MmeM6k, j2, fFloatValue, ArrowValues, PullToRefreshKt.StrokeWidth);
            ...
            CanvasKt.Canvas(modifierM614size3ABfNKs, (Function1) objRememberedValue4, composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.pulltorefresh.PullToRefreshKt$CircularArrowProgressIndicator$3
                ...
                public final void invoke(Composer composer3, int i4) {
                    PullToRefreshKt.m2298CircularArrowProgressIndicatorRPmYEkk(function0, j, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
    ...
    public static final void m2304drawCircularIndicatorKzyDr3Q(DrawScope drawScope, long j, float f, ArrowValues arrowValues, Rect rect, float f2) {
        DrawScope.m3943drawArcyD3GUKo$default(drawScope, j, arrowValues.getStartAngle(), arrowValues.getEndAngle() - arrowValues.getStartAngle(), false, rect.m3208getTopLeftF1C5BW0(), rect.m3206getSizeNHjbRc(), f, new Stroke(drawScope.mo316toPx0680j_4(f2), 0.0f, StrokeCap.INSTANCE.m3766getButtKaPHkGw(), 0, null, 26, null), null, 0, 768, null);
    }
    ...
    public static final void m2303drawArrowuDrxG_w(DrawScope drawScope, Path path, Rect rect, long j, float f, ArrowValues arrowValues, float f2) {
        path.reset();
        path.moveTo(0.0f, 0.0f);
        float f3 = ArrowWidth;
        path.lineTo((drawScope.mo316toPx0680j_4(f3) * arrowValues.getScale()) / 2, drawScope.mo316toPx0680j_4(ArrowHeight) * arrowValues.getScale());
        path.lineTo(drawScope.mo316toPx0680j_4(f3) * arrowValues.getScale(), 0.0f);
        path.mo3309translatek4lQ0M(OffsetKt.Offset(((Math.min(rect.getWidth(), rect.getHeight()) / 2.0f) + Offset.m3173getXimpl(rect.m3203getCenterF1C5BW0())) - ((drawScope.mo316toPx0680j_4(f3) * arrowValues.getScale()) / 2.0f), Offset.m3174getYimpl(rect.m3203getCenterF1C5BW0()) - drawScope.mo316toPx0680j_4(f2)));
        float endAngle = arrowValues.getEndAngle() - drawScope.mo316toPx0680j_4(f2);
        long jMo3962getCenterF1C5BW0 = drawScope.mo3962getCenterF1C5BW0();
        DrawContext drawContext = drawScope.getDrawContext();
        long jMo3888getSizeNHjbRc = drawContext.mo3888getSizeNHjbRc();
        drawContext.getCanvas().save();
        drawContext.getTransform().mo3894rotateUv8p0NA(endAngle, jMo3962getCenterF1C5BW0);
        DrawScope.m3954drawPathLG529CI$default(drawScope, path, j, f, new Stroke(drawScope.mo316toPx0680j_4(f2), 0.0f, 0, 0, null, 30, null), null, 0, 48, null);
        drawContext.getCanvas().restore();
        drawContext.mo3889setSizeuvyYCjk(jMo3888getSizeNHjbRc);
    }
