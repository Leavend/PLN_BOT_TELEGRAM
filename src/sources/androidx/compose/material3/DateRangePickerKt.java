...
public final class DateRangePickerKt {
    ...
    private static final PaddingValues CalendarMonthSubheadPadding = PaddingKt.m562PaddingValuesa9UjIt4$default(Dp.m5735constructorimpl(24), Dp.m5735constructorimpl(20), 0.0f, Dp.m5735constructorimpl(8), 4, null);
    private static final float HeaderHeightOffset = Dp.m5735constructorimpl(60);
    ...
    */
    ...
    public static final DateRangePickerState m1505rememberDateRangePickerStateIlFM19s(Long l, Long l2, Long l3, IntRange intRange, int i, SelectableDates selectableDates, Composer composer, int i2, int i3) {
        ...
        final int iM1526getPickerjFl4v0 = (i3 & 16) != 0 ? DisplayMode.INSTANCE.m1526getPickerjFl4v0() : i;
        ...
        if (zChangedInstance || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = (Function0) new Function0<DateRangePickerStateImpl>() { // from class: androidx.compose.material3.DateRangePickerKt$rememberDateRangePickerState$1$1
                ...
                public final DateRangePickerStateImpl invoke() {
                    return new DateRangePickerStateImpl(l4, l5, l6, yearRange, iM1526getPickerjFl4v0, allDates, localeDefaultLocale, null);
                }
            };
            composer.updateRememberedValue(objRememberedValue);
        }
        composer.endReplaceableGroup();
        DateRangePickerStateImpl dateRangePickerStateImpl = (DateRangePickerStateImpl) RememberSaveableKt.m3031rememberSaveable(objArr, (Saver) Saver, (String) null, (Function0) objRememberedValue, composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static /* synthetic */ DateRangePickerState m1501DateRangePickerStateHVP43zI$default(Locale locale, Long l, Long l2, Long l3, IntRange intRange, int i, SelectableDates selectableDates, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            l = null;
        }
        if ((i2 & 4) != 0) {
        ...
        return m1500DateRangePickerStateHVP43zI(locale, l, l2, l3, intRange, i, selectableDates);
    }

    /* renamed from: DateRangePickerState-HVP43zI, reason: not valid java name */
    public static final DateRangePickerState m1500DateRangePickerStateHVP43zI(Locale locale, Long l, Long l2, Long l3, IntRange intRange, int i, SelectableDates selectableDates) {
    ...
    public static final void m1502SwitchableDateEntryContentRN2D1Q(final Long l, final Long l2, final long j, final int i, final Function2<? super Long, ? super Long, Unit> function2, final Function1<? super Long, Unit> function1, final CalendarModel calendarModel, final IntRange intRange, final DatePickerFormatter datePickerFormatter, final SelectableDates selectableDates, final DatePickerColors datePickerColors, Composer composer, final int i2, final int i3) {
        int i4;
        int i5;
        ...
        if ((i4 & 306783379) != 306783378 || (i5 & 3) != 2 || !composerStartRestartGroup.getSkipping()) {
            ...
            CrossfadeKt.Crossfade(DisplayMode.m1518boximpl(i), SemanticsModifierKt.semantics$default(Modifier.INSTANCE, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$SwitchableDateEntryContent$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(DisplayMode displayMode, Composer composer2, Integer num) {
                    m1507invokeQujVXRc(displayMode.getValue(), composer2, num.intValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-QujVXRc, reason: not valid java name */
                public final void m1507invokeQujVXRc(int i6, Composer composer2, int i7) {
                    int i8;
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$SwitchableDateEntryContent$3
                ...
                public final void invoke(Composer composer2, int i6) {
                    DateRangePickerKt.m1502SwitchableDateEntryContentRN2D1Q(l, l2, j, i, function2, function1, calendarModel, intRange, datePickerFormatter, selectableDates, datePickerColors, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), RecomposeScopeImplKt.updateChangedFlags(i3));
                }
            });
        }
    }
    ...
    public static final void DateRangePickerContent(final Long l, final Long l2, final long j, final Function2<? super Long, ? super Long, Unit> function2, final Function1<? super Long, Unit> function1, final CalendarModel calendarModel, final IntRange intRange, final DatePickerFormatter datePickerFormatter, final SelectableDates selectableDates, final DatePickerColors datePickerColors, Composer composer, final int i) {
        ...
        if ((i2 & 306783379) != 306783378 || !composerStartRestartGroup.getSkipping()) {
            ...
            Modifier modifierM567paddingVpY3zN4$default = PaddingKt.m567paddingVpY3zN4$default(Modifier.INSTANCE, DatePickerKt.getDatePickerHorizontalPadding(), 0.0f, 2, null);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3ModifierMaterializerOf = LayoutKt.modifierMaterializerOf(modifierM567paddingVpY3zN4$default);
            ...
            VerticalMonthsList(lazyListStateRememberLazyListState, l, l2, function2, function1, calendarModel, intRange, datePickerFormatter, selectableDates, datePickerColors, composer2, (i3 & 896) | (i3 & 112) | (i2 & 7168) | (57344 & i2) | (458752 & i2) | (3670016 & i2) | (29360128 & i2) | (234881024 & i2) | (1879048192 & i2));
            ...
            TextKt.ProvideTextStyle(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography(composerStartRestartGroup, 6), DatePickerModalTokens.INSTANCE.getDateLabelTextFont()), ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1090773432, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.VerticalMonthsList.1
                ...
                public final void invoke(Composer composer3, int i4) {
                    ...
                    if ((i4 & 3) != 2 || !composer3.getSkipping()) {
                        ...
                        String strM1972getStringNWtq28 = Strings_androidKt.m1972getStringNWtq28(Strings.m1903constructorimpl(R.string.m3c_date_range_picker_scroll_to_previous_month), composer3, 0);
                        Strings.Companion companion2 = Strings.INSTANCE;
                        String strM1972getStringNWtq282 = Strings_androidKt.m1972getStringNWtq28(Strings.m1903constructorimpl(R.string.m3c_date_range_picker_scroll_to_next_month), composer3, 0);
                        ...
                        composer3.endReplaceableGroup();
                        final List listCustomScrollActions = DateRangePickerKt.customScrollActions(lazyListState, coroutineScope, strM1972getStringNWtq28, strM1972getStringNWtq282);
                                                ...
                                                TextKt.ProvideTextStyle(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography(composer4, 6), DatePickerModalTokens.INSTANCE.getRangeSelectionMonthSubheadFont()), ComposableLambdaKt.composableLambda(composer4, 1622100276, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$VerticalMonthsList$1$2$1$1$1$1
                                                    ...
                                                    public final void invoke(Composer composer5, int i8) {
                                                        ...
                                                        if ((i8 & 3) != 2 || !composer5.getSkipping()) {
                                                            ...
                                                            Modifier modifierM247clickableXHw0xAI$default = ClickableKt.m247clickableXHw0xAI$default(PaddingKt.padding(Modifier.INSTANCE, DateRangePickerKt.getCalendarMonthSubheadPadding()), false, null, null, new Function0<Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$VerticalMonthsList$1$2$1$1$1$1.1
                                                                /* renamed from: invoke, reason: avoid collision after fix types in other method */
    ...
    public static final void m1504drawRangeBackgroundmxwnekA(ContentDrawScope contentDrawScope, SelectedRangeInfo selectedRangeInfo, long j) {
        float fM3242getWidthimpl;
        float f = contentDrawScope.mo316toPx0680j_4(DatePickerKt.getRecommendedSizeForAccessibility());
        float f2 = contentDrawScope.mo316toPx0680j_4(DatePickerKt.getRecommendedSizeForAccessibility());
        float f3 = contentDrawScope.mo316toPx0680j_4(DatePickerModalTokens.INSTANCE.m2449getDateStateLayerHeightD9Ej5fM());
        float f4 = 2;
        float f5 = (f2 - f3) / f4;
        float f6 = 7;
        float fM3242getWidthimpl2 = (Size.m3242getWidthimpl(contentDrawScope.mo3963getSizeNHjbRc()) - (f6 * f)) / f6;
        long gridStartCoordinates = selectedRangeInfo.getGridStartCoordinates();
        int iM5855component1impl = IntOffset.m5855component1impl(gridStartCoordinates);
        int iM5856component2impl = IntOffset.m5856component2impl(gridStartCoordinates);
        long gridEndCoordinates = selectedRangeInfo.getGridEndCoordinates();
        int iM5855component1impl2 = IntOffset.m5855component1impl(gridEndCoordinates);
        int iM5856component2impl2 = IntOffset.m5856component2impl(gridEndCoordinates);
        float f7 = f + fM3242getWidthimpl2;
        float f8 = fM3242getWidthimpl2 / f4;
        float fM3242getWidthimpl3 = (iM5855component1impl * f7) + (selectedRangeInfo.getFirstIsSelectionStart() ? f / f4 : 0.0f) + f8;
        float f9 = (iM5856component2impl * f2) + f5;
        float f10 = iM5855component1impl2 * f7;
        if (selectedRangeInfo.getLastIsSelectionEnd()) {
            f /= f4;
        }
        float fM3242getWidthimpl4 = f10 + f + f8;
        float f11 = (iM5856component2impl2 * f2) + f5;
        boolean z = contentDrawScope.getLayoutDirection() == LayoutDirection.Rtl;
        if (z) {
            fM3242getWidthimpl3 = Size.m3242getWidthimpl(contentDrawScope.mo3963getSizeNHjbRc()) - fM3242getWidthimpl3;
            fM3242getWidthimpl4 = Size.m3242getWidthimpl(contentDrawScope.mo3963getSizeNHjbRc()) - fM3242getWidthimpl4;
        }
        ContentDrawScope contentDrawScope2 = contentDrawScope;
        long jOffset = OffsetKt.Offset(fM3242getWidthimpl3, f9);
        if (iM5856component2impl == iM5856component2impl2) {
            fM3242getWidthimpl = fM3242getWidthimpl4 - fM3242getWidthimpl3;
        } else {
            fM3242getWidthimpl = z ? -fM3242getWidthimpl3 : Size.m3242getWidthimpl(contentDrawScope.mo3963getSizeNHjbRc()) - fM3242getWidthimpl3;
        }
        DrawScope.m3958drawRectnJ9OG0$default(contentDrawScope2, j, jOffset, SizeKt.Size(fM3242getWidthimpl, f3), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        if (iM5856component2impl != iM5856component2impl2) {
            for (int i = (iM5856component2impl2 - iM5856component2impl) - 1; i > 0; i--) {
                DrawScope.m3958drawRectnJ9OG0$default(contentDrawScope2, j, OffsetKt.Offset(0.0f, (i * f2) + f9), SizeKt.Size(Size.m3242getWidthimpl(contentDrawScope.mo3963getSizeNHjbRc()), f3), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
            }
            long jOffset2 = OffsetKt.Offset(contentDrawScope.getLayoutDirection() != LayoutDirection.Ltr ? Size.m3242getWidthimpl(contentDrawScope.mo3963getSizeNHjbRc()) : 0.0f, f11);
            if (z) {
                fM3242getWidthimpl4 -= Size.m3242getWidthimpl(contentDrawScope.mo3963getSizeNHjbRc());
            }
            DrawScope.m3958drawRectnJ9OG0$default(contentDrawScope2, j, jOffset2, SizeKt.Size(fM3242getWidthimpl4, f3), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        }
    }
    ...
    static {
        float f = 64;
        float f2 = 12;
        DateRangePickerTitlePadding = PaddingKt.m562PaddingValuesa9UjIt4$default(Dp.m5735constructorimpl(f), 0.0f, Dp.m5735constructorimpl(f2), 0.0f, 10, null);
        DateRangePickerHeadlinePadding = PaddingKt.m562PaddingValuesa9UjIt4$default(Dp.m5735constructorimpl(f), 0.0f, Dp.m5735constructorimpl(f2), Dp.m5735constructorimpl(f2), 2, null);
    }
}
