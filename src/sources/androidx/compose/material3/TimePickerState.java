...
public final class TimePickerState {
    ...
    public TimePickerState(int i, int i2, final boolean z) {
        ...
        this.selectorPos = SnapshotStateKt.derivedStateOf(SnapshotStateKt.structuralEqualityPolicy(), new Function0<DpOffset>() { // from class: androidx.compose.material3.TimePickerState$selectorPos$2
            ...
            public /* bridge */ /* synthetic */ DpOffset invoke() {
                return DpOffset.m5790boximpl(m2182invokeRKDOV3M());
            }

            /* renamed from: invoke-RKDOV3M, reason: not valid java name */
            public final long m2182invokeRKDOV3M() {
                boolean zIsInnerCircle$material3_release = this.this$0.isInnerCircle$material3_release();
                float f = 2;
                float fM5735constructorimpl = Dp.m5735constructorimpl(TimePickerTokens.INSTANCE.m2842getClockDialSelectorHandleContainerSizeD9Ej5fM() / f);
                float fM5735constructorimpl2 = Dp.m5735constructorimpl(Dp.m5735constructorimpl(((z && zIsInnerCircle$material3_release && Selection.m1850equalsimpl0(this.this$0.m2178getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1854getHourJiIwxys())) ? TimePickerKt.InnerCircleRadius : TimePickerKt.OuterCircleSizeRadius) - fM5735constructorimpl) + fM5735constructorimpl);
                return DpKt.m5756DpOffsetYgX7TsA(Dp.m5735constructorimpl(Dp.m5735constructorimpl(((float) Math.cos(this.this$0.getCurrentAngle$material3_release().getValue().floatValue())) * fM5735constructorimpl2) + Dp.m5735constructorimpl(TimePickerTokens.INSTANCE.m2840getClockDialContainerSizeD9Ej5fM() / f)), Dp.m5735constructorimpl(Dp.m5735constructorimpl(fM5735constructorimpl2 * ((float) Math.sin(this.this$0.getCurrentAngle$material3_release().getValue().floatValue()))) + Dp.m5735constructorimpl(TimePickerTokens.INSTANCE.m2840getClockDialContainerSizeD9Ej5fM() / f)));
            }
        });
        this.center = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m5854boximpl(IntOffset.INSTANCE.m5873getZeronOccac()), null, 2, null);
        this.selection = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Selection.m1847boximpl(Selection.INSTANCE.m1854getHourJiIwxys()), null, 2, null);
    ...
    public final long m2179getSelectorPosRKDOV3M$material3_release() {
    ...
    public final long m2177getCenternOccac$material3_release() {
    ...
    public final void m2180setCentergyyYBs$material3_release(long j) {
        this.center.setValue(IntOffset.m5854boximpl(j));
    }

    public final List<Integer> getValues$material3_release() {
        return Selection.m1850equalsimpl0(m2178getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1855getMinuteJiIwxys()) ? TimePickerKt.Minutes : TimePickerKt.Hours;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getSelection-JiIwxys$material3_release, reason: not valid java name */
    public final int m2178getSelectionJiIwxys$material3_release() {
        return ((Selection) this.selection.getValue()).m1853unboximpl();
    }

    /* renamed from: setSelection-iHAOin8$material3_release, reason: not valid java name */
    public final void m2181setSelectioniHAOin8$material3_release(int i) {
        this.selection.setValue(Selection.m1847boximpl(i));
    }
    ...
    public final void moveSelector$material3_release(float x, float y, float maxDist) {
        if (Selection.m1850equalsimpl0(m2178getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1854getHourJiIwxys()) && this.is24hour) {
            setInnerCircle$material3_release(TimePickerKt.dist(x, y, IntOffset.m5863getXimpl(m2177getCenternOccac$material3_release()), IntOffset.m5864getYimpl(m2177getCenternOccac$material3_release())) < maxDist);
        }
    }

    public final boolean isSelected$material3_release(int value) {
        if (Selection.m1850equalsimpl0(m2178getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1855getMinuteJiIwxys())) {
            if (value == getMinute()) {
                return true;
            }
        } else {
    ...
    */
    public final java.lang.Object animateToCurrent$material3_release(kotlin.coroutines.Continuation<? super kotlin.Unit> r12) {
        ...
        L42:
            kotlin.ResultKt.throwOnFailure(r12)
            int r12 = r11.m2178getSelectionJiIwxys$material3_release()
            androidx.compose.material3.Selection$Companion r1 = androidx.compose.material3.Selection.INSTANCE
            int r1 = r1.m1854getHourJiIwxys()
            boolean r12 = androidx.compose.material3.Selection.m1850equalsimpl0(r12, r1)
            if (r12 == 0) goto L62
