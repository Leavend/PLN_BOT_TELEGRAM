...
public final class SelectableChipElevation {
    ...
    public final float m1844tonalElevationu2uoSUM$material3_release(boolean enabled) {
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (objRememberedValue4 == Composer.INSTANCE.getEmpty()) {
            objRememberedValue4 = new Animatable(Dp.m5733boximpl(f2), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
        ...
        composer.endReplaceableGroup();
        EffectsKt.LaunchedEffect(dpM5733boximpl, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) objRememberedValue5, composer, 0);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5740equalsimpl0(this.elevation, selectableChipElevation.elevation) && Dp.m5740equalsimpl0(this.pressedElevation, selectableChipElevation.pressedElevation) && Dp.m5740equalsimpl0(this.focusedElevation, selectableChipElevation.focusedElevation) && Dp.m5740equalsimpl0(this.hoveredElevation, selectableChipElevation.hoveredElevation) && Dp.m5740equalsimpl0(this.disabledElevation, selectableChipElevation.disabledElevation);
    }

    public int hashCode() {
        return (((((((Dp.m5741hashCodeimpl(this.elevation) * 31) + Dp.m5741hashCodeimpl(this.pressedElevation)) * 31) + Dp.m5741hashCodeimpl(this.focusedElevation)) * 31) + Dp.m5741hashCodeimpl(this.hoveredElevation)) * 31) + Dp.m5741hashCodeimpl(this.disabledElevation);
    }
}
