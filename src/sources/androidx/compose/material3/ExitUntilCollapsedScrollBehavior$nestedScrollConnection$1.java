...
public final class ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public long mo404onPreScrollOzD1aCk(long available, int source) {
        if (!this.this$0.getCanScroll().invoke().booleanValue() || Offset.m3174getYimpl(available) > 0.0f) {
    ...
    public long mo403onPostScrollDzOQY0M(long consumed, long available, int source) {
        ...
        state.setContentOffset(state.getContentOffset() + Offset.m3174getYimpl(consumed));
        if (Offset.m3174getYimpl(available) < 0.0f || Offset.m3174getYimpl(consumed) < 0.0f) {
            float heightOffset = this.this$0.getState().getHeightOffset();
            this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m3174getYimpl(consumed));
            return OffsetKt.Offset(0.0f, this.this$0.getState().getHeightOffset() - heightOffset);
        }
        if ((Offset.m3174getYimpl(consumed) == 0.0f) && Offset.m3174getYimpl(available) > 0.0f) {
            this.this$0.getState().setContentOffset(0.0f);
        }
        if (Offset.m3174getYimpl(available) > 0.0f) {
    ...
    */
    public java.lang.Object mo402onPostFlingRZ2iAVY(long r10, long r12, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r14) {
        ...
        L82:
            ...
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1.mo402onPostFlingRZ2iAVY(long, long, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
