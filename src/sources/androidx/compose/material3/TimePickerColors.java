...
public final class TimePickerColors {
    ...
    public final long m2150periodSelectorContainerColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.periodSelectorSelectedContainerColor;
        }
        return this.periodSelectorUnselectedContainerColor;
    ...
    public final long m2151periodSelectorContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.periodSelectorSelectedContentColor;
        }
        return this.periodSelectorUnselectedContentColor;
    ...
    public final long m2152timeSelectorContainerColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.timeSelectorSelectedContainerColor;
        }
        return this.timeSelectorUnselectedContainerColor;
    ...
    public final long m2153timeSelectorContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.timeSelectorSelectedContentColor;
        }
        return this.timeSelectorUnselectedContentColor;
    ...
    public final long m2134clockDialContentColorvNxB06k$material3_release(boolean selected) {
        if (selected) {
            return this.clockDialSelectedContentColor;
        }
        return this.clockDialUnselectedContentColor;
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3415equalsimpl0(this.clockDialColor, timePickerColors.clockDialColor) && Color.m3415equalsimpl0(this.selectorColor, timePickerColors.selectorColor) && Color.m3415equalsimpl0(this.containerColor, timePickerColors.containerColor) && Color.m3415equalsimpl0(this.periodSelectorBorderColor, timePickerColors.periodSelectorBorderColor) && Color.m3415equalsimpl0(this.periodSelectorSelectedContainerColor, timePickerColors.periodSelectorSelectedContainerColor) && Color.m3415equalsimpl0(this.periodSelectorUnselectedContainerColor, timePickerColors.periodSelectorUnselectedContainerColor) && Color.m3415equalsimpl0(this.periodSelectorSelectedContentColor, timePickerColors.periodSelectorSelectedContentColor) && Color.m3415equalsimpl0(this.periodSelectorUnselectedContentColor, timePickerColors.periodSelectorUnselectedContentColor) && Color.m3415equalsimpl0(this.timeSelectorSelectedContainerColor, timePickerColors.timeSelectorSelectedContainerColor) && Color.m3415equalsimpl0(this.timeSelectorUnselectedContainerColor, timePickerColors.timeSelectorUnselectedContainerColor) && Color.m3415equalsimpl0(this.timeSelectorSelectedContentColor, timePickerColors.timeSelectorSelectedContentColor) && Color.m3415equalsimpl0(this.timeSelectorUnselectedContentColor, timePickerColors.timeSelectorUnselectedContentColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((Color.m3421hashCodeimpl(this.clockDialColor) * 31) + Color.m3421hashCodeimpl(this.selectorColor)) * 31) + Color.m3421hashCodeimpl(this.containerColor)) * 31) + Color.m3421hashCodeimpl(this.periodSelectorBorderColor)) * 31) + Color.m3421hashCodeimpl(this.periodSelectorSelectedContainerColor)) * 31) + Color.m3421hashCodeimpl(this.periodSelectorUnselectedContainerColor)) * 31) + Color.m3421hashCodeimpl(this.periodSelectorSelectedContentColor)) * 31) + Color.m3421hashCodeimpl(this.periodSelectorUnselectedContentColor)) * 31) + Color.m3421hashCodeimpl(this.timeSelectorSelectedContainerColor)) * 31) + Color.m3421hashCodeimpl(this.timeSelectorUnselectedContainerColor)) * 31) + Color.m3421hashCodeimpl(this.timeSelectorSelectedContentColor)) * 31) + Color.m3421hashCodeimpl(this.timeSelectorUnselectedContentColor);
    }

    /* renamed from: copy-dVHXu7A, reason: not valid java name */
    public final TimePickerColors m2135copydVHXu7A(long clockDialColor, long selectorColor, long containerColor, long periodSelectorBorderColor, long clockDialSelectedContentColor, long clockDialUnselectedContentColor, long periodSelectorSelectedContainerColor, long periodSelectorUnselectedContainerColor, long periodSelectorSelectedContentColor, long periodSelectorUnselectedContentColor, long timeSelectorSelectedContainerColor, long timeSelectorUnselectedContainerColor, long timeSelectorSelectedContentColor, long timeSelectorUnselectedContentColor) {
        return new TimePickerColors((clockDialColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (clockDialColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? clockDialColor : this.clockDialColor, (selectorColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (selectorColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? selectorColor : this.selectorColor, (containerColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (containerColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? containerColor : this.containerColor, (periodSelectorBorderColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (periodSelectorBorderColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? periodSelectorBorderColor : this.periodSelectorBorderColor, (clockDialSelectedContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (clockDialSelectedContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? clockDialSelectedContentColor : this.clockDialSelectedContentColor, (clockDialUnselectedContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (clockDialUnselectedContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? clockDialUnselectedContentColor : this.clockDialUnselectedContentColor, (periodSelectorSelectedContainerColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (periodSelectorSelectedContainerColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? periodSelectorSelectedContainerColor : this.periodSelectorSelectedContainerColor, (periodSelectorUnselectedContainerColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (periodSelectorUnselectedContainerColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? periodSelectorUnselectedContainerColor : this.periodSelectorUnselectedContainerColor, (periodSelectorSelectedContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (periodSelectorSelectedContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? periodSelectorSelectedContentColor : this.periodSelectorSelectedContentColor, (periodSelectorUnselectedContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (periodSelectorUnselectedContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? periodSelectorUnselectedContentColor : this.periodSelectorUnselectedContentColor, (timeSelectorSelectedContainerColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (timeSelectorSelectedContainerColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? timeSelectorSelectedContainerColor : this.timeSelectorSelectedContainerColor, (timeSelectorUnselectedContainerColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (timeSelectorUnselectedContainerColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? timeSelectorUnselectedContainerColor : this.timeSelectorUnselectedContainerColor, (timeSelectorSelectedContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (timeSelectorSelectedContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? timeSelectorSelectedContentColor : this.timeSelectorSelectedContentColor, timeSelectorUnselectedContentColor != Color.INSTANCE.m3450getUnspecified0d7_KjU() ? timeSelectorUnselectedContentColor : this.timeSelectorUnselectedContentColor, null);
    }
}
