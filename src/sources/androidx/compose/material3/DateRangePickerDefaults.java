...
public final class DateRangePickerDefaults {
    ...
    */
    public final void m1499DateRangePickerTitlehOD91z4(final int r30, androidx.compose.ui.Modifier r31, androidx.compose.runtime.Composer r32, final int r33, final int r34) {
        /*
            Method dump skipped, instructions count: 319
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.DateRangePickerDefaults.m1499DateRangePickerTitlehOD91z4(int, androidx.compose.ui.Modifier, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void m1498DateRangePickerHeadlinev84Udv0(final java.lang.Long r22, final java.lang.Long r23, final int r24, final androidx.compose.material3.DatePickerFormatter r25, androidx.compose.ui.Modifier r26, androidx.compose.runtime.Composer r27, final int r28, final int r29) {
        /*
            Method dump skipped, instructions count: 391
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.DateRangePickerDefaults.m1498DateRangePickerHeadlinev84Udv0(java.lang.Long, java.lang.Long, int, androidx.compose.material3.DatePickerFormatter, androidx.compose.ui.Modifier, androidx.compose.runtime.Composer, int, int):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: DateRangePickerHeadline-0YIUgSQ, reason: not valid java name */
    public final void m1496DateRangePickerHeadline0YIUgSQ(final Long l, final Long l2, final int i, final DatePickerFormatter datePickerFormatter, final Modifier modifier, final String str, final String str2, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, Composer composer, final int i2, final int i3) {
        int i4;
        Composer composer2;
        ...
        if ((306783379 & i5) != 306783378 || (i3 & 1) != 0 || !composerStartRestartGroup.getSkipping()) {
            ...
            String strM1972getStringNWtq28 = "";
            ...
            if (date == null) {
                if (DisplayMode.m1521equalsimpl0(i, DisplayMode.INSTANCE.m1526getPickerjFl4v0())) {
                    ...
                    date = Strings_androidKt.m1972getStringNWtq28(Strings.m1903constructorimpl(R.string.m3c_date_picker_no_selection_description), composer2, 0);
                    composer2.endReplaceableGroup();
                } else if (DisplayMode.m1521equalsimpl0(i, DisplayMode.INSTANCE.m1525getInputjFl4v0())) {
                    composer2.startReplaceableGroup(-1212631354);
                    ComposerKt.sourceInformation(composer2, "443@19765L46");
                    Strings.Companion companion2 = Strings.INSTANCE;
                    date = Strings_androidKt.m1972getStringNWtq28(Strings.m1903constructorimpl(R.string.m3c_date_input_no_input_description), composer2, 0);
                    composer2.endReplaceableGroup();
                } else {
            ...
            ComposerKt.sourceInformation(composer2, "");
            if (date2 != null) {
                strM1972getStringNWtq28 = date2;
            } else if (DisplayMode.m1521equalsimpl0(i, DisplayMode.INSTANCE.m1526getPickerjFl4v0())) {
                composer2.startReplaceableGroup(-1212631014);
                ComposerKt.sourceInformation(composer2, "452@20105L51");
                Strings.Companion companion3 = Strings.INSTANCE;
                strM1972getStringNWtq28 = Strings_androidKt.m1972getStringNWtq28(Strings.m1903constructorimpl(R.string.m3c_date_picker_no_selection_description), composer2, 0);
                composer2.endReplaceableGroup();
            } else if (DisplayMode.m1521equalsimpl0(i, DisplayMode.INSTANCE.m1525getInputjFl4v0())) {
                composer2.startReplaceableGroup(-1212630929);
                ComposerKt.sourceInformation(composer2, "453@20190L46");
                Strings.Companion companion4 = Strings.INSTANCE;
                strM1972getStringNWtq28 = Strings_androidKt.m1972getStringNWtq28(Strings.m1903constructorimpl(R.string.m3c_date_input_no_input_description), composer2, 0);
                composer2.endReplaceableGroup();
            } else {
            ...
            final String str4 = str2 + ": " + strM1972getStringNWtq28;
            ...
            Arrangement.HorizontalOrVertical horizontalOrVerticalM474spacedBy0680j_4 = Arrangement.INSTANCE.m474spacedBy0680j_4(Dp.m5735constructorimpl(4));
            composer2.startReplaceableGroup(693286680);
            ComposerKt.sourceInformation(composer2, "CC(Row)P(2,1,3)90@4553L58,91@4616L130:Row.kt#2w3rfo");
            MeasurePolicy measurePolicyRowMeasurePolicy = RowKt.rowMeasurePolicy(horizontalOrVerticalM474spacedBy0680j_4, centerVertically, composer2, 54);
            ...
            if (date$default != null) {
                ...
                TextKt.m2130Text4IGK_g(date$default, (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 0, 0, 131070);
                composer2.endReplaceableGroup();
            } else {
            ...
            if (date$default2 != null) {
                ...
                TextKt.m2130Text4IGK_g(date$default2, (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 0, 0, 131070);
                composer2.endReplaceableGroup();
            } else {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerDefaults$DateRangePickerHeadline$6
                ...
                public final void invoke(Composer composer3, int i6) {
                    this.$tmp7_rcvr.m1496DateRangePickerHeadline0YIUgSQ(l, l2, i, datePickerFormatter, modifier, str, str2, function2, function22, function23, composer3, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), RecomposeScopeImplKt.updateChangedFlags(i3));
                }
            });
        }
    }
