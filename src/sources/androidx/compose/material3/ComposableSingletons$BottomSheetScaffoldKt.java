...
public final class ComposableSingletons$BottomSheetScaffoldKt {
    ...
    public static Function2<Composer, Integer, Unit> f17lambda1 = ComposableLambdaKt.composableLambdaInstance(-927355320, false, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ComposableSingletons$BottomSheetScaffoldKt$lambda-1$1
        ...
        public final void invoke(Composer composer, int i) {
            ...
            BottomSheetDefaults.INSTANCE.m1251DragHandlelgZ2HuY(null, 0.0f, 0.0f, null, 0L, composer, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 31);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public final Function2<Composer, Integer, Unit> m1419getLambda1$material3_release() {
        return f17lambda1;
    }

    /* renamed from: getLambda-2$material3_release, reason: not valid java name */
    public final Function3<SnackbarHostState, Composer, Integer, Unit> m1420getLambda2$material3_release() {
        return f18lambda2;
    }
}
