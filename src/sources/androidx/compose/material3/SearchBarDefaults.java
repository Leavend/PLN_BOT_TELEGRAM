...
public final class SearchBarDefaults {
    ...
    public static /* synthetic */ void m1795getElevationD9Ej5fM$annotations() {
    }
    ...
    static {
        float fM2778getContainerElevationD9Ej5fM = SearchBarTokens.INSTANCE.m2778getContainerElevationD9Ej5fM();
        TonalElevation = fM2778getContainerElevationD9Ej5fM;
        ShadowElevation = ElevationTokens.INSTANCE.m2478getLevel0D9Ej5fM();
        Elevation = fM2778getContainerElevationD9Ej5fM;
        InputFieldHeight = SearchBarTokens.INSTANCE.m2779getContainerHeightD9Ej5fM();
    }

    /* renamed from: getTonalElevation-D9Ej5fM, reason: not valid java name */
    public final float m1800getTonalElevationD9Ej5fM() {
        return TonalElevation;
    }

    /* renamed from: getShadowElevation-D9Ej5fM, reason: not valid java name */
    public final float m1799getShadowElevationD9Ej5fM() {
    ...
    public final float m1798getInputFieldHeightD9Ej5fM() {
    ...
    public final SearchBarColors m1796colorsKlgxPg(long j, long j2, TextFieldColors textFieldColors, Composer composer, int i, int i2) {
        ...
        TextFieldColors textFieldColorsM1802inputFieldColorsITpI4ow = (i2 & 4) != 0 ? m1802inputFieldColorsITpI4ow(0L, 0L, 0L, 0L, null, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, composer, 0, (i << 3) & 57344, 16383) : textFieldColors;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1216168196, i, -1, "androidx.compose.material3.SearchBarDefaults.colors (SearchBar.android.kt:548)");
        }
        SearchBarColors searchBarColors = new SearchBarColors(value, value2, textFieldColorsM1802inputFieldColorsITpI4ow, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final TextFieldColors m1802inputFieldColorsITpI4ow(long j, long j2, long j3, long j4, TextSelectionColors textSelectionColors, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, Composer composer, int i, int i2, int i3) {
        ...
        long jM3413copywmQWz5c$default = (i3 & 4) != 0 ? Color.m3413copywmQWz5c$default(ColorSchemeKt.getValue(FilledTextFieldTokens.INSTANCE.getDisabledInputColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        ...
        long jM3413copywmQWz5c$default2 = (i3 & 128) != 0 ? Color.m3413copywmQWz5c$default(ColorSchemeKt.getValue(FilledTextFieldTokens.INSTANCE.getDisabledLeadingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j7;
        ...
        long jM3413copywmQWz5c$default3 = (i3 & 1024) != 0 ? Color.m3413copywmQWz5c$default(ColorSchemeKt.getValue(FilledTextFieldTokens.INSTANCE.getDisabledTrailingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j10;
        ...
        long jM3413copywmQWz5c$default4 = (i3 & 8192) != 0 ? Color.m3413copywmQWz5c$default(ColorSchemeKt.getValue(FilledTextFieldTokens.INSTANCE.getDisabledInputColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j13;
        if (ComposerKt.isTraceInProgress()) {
        ...
        int i4 = i2 << 18;
        TextFieldColors textFieldColorsM2100colors0hiis_0 = TextFieldDefaults.INSTANCE.m2100colors0hiis_0(value, value2, jM3413copywmQWz5c$default, 0L, 0L, 0L, 0L, 0L, value3, 0L, textSelectionColors2, 0L, 0L, 0L, 0L, value4, value5, jM3413copywmQWz5c$default2, 0L, value6, value7, jM3413copywmQWz5c$default3, 0L, 0L, 0L, 0L, 0L, value8, value9, jM3413copywmQWz5c$default4, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, composer, (i & 14) | (i & 112) | (i & 896) | ((i << 15) & 234881024), ((i >> 12) & 14) | (458752 & i) | (3670016 & i) | (i & 29360128) | ((i << 3) & 1879048192), ((i >> 27) & 14) | ((i2 << 3) & 112) | (i4 & 29360128) | (i4 & 234881024) | (i4 & 1879048192), 0, 3072, 1204058872, 4095);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final /* synthetic */ TextFieldColors m1801inputFieldColorsuKgnY(long j, long j2, long j3, TextSelectionColors textSelectionColors, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, Composer composer, int i, int i2, int i3) {
        TextSelectionColors textSelectionColors2;
        ...
        long value = (i3 & 1) != 0 ? ColorSchemeKt.getValue(SearchBarTokens.INSTANCE.getInputTextColor(), composer, 6) : j;
        long jM3413copywmQWz5c$default = (i3 & 2) != 0 ? Color.m3413copywmQWz5c$default(ColorSchemeKt.getValue(FilledTextFieldTokens.INSTANCE.getDisabledInputColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j2;
        ...
        long value4 = (i3 & 32) != 0 ? ColorSchemeKt.getValue(SearchBarTokens.INSTANCE.getLeadingIconColor(), composer, 6) : j5;
        long jM3413copywmQWz5c$default2 = (i3 & 64) != 0 ? Color.m3413copywmQWz5c$default(ColorSchemeKt.getValue(FilledTextFieldTokens.INSTANCE.getDisabledLeadingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j6;
        long value5 = (i3 & 128) != 0 ? ColorSchemeKt.getValue(SearchBarTokens.INSTANCE.getTrailingIconColor(), composer, 6) : j7;
        long value6 = (i3 & 256) != 0 ? ColorSchemeKt.getValue(SearchBarTokens.INSTANCE.getTrailingIconColor(), composer, 6) : j8;
        long jM3413copywmQWz5c$default3 = (i3 & 512) != 0 ? Color.m3413copywmQWz5c$default(ColorSchemeKt.getValue(FilledTextFieldTokens.INSTANCE.getDisabledTrailingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j9;
        long value7 = (i3 & 1024) != 0 ? ColorSchemeKt.getValue(SearchBarTokens.INSTANCE.getSupportingTextColor(), composer, 6) : j10;
        long jM3413copywmQWz5c$default4 = (i3 & 2048) != 0 ? Color.m3413copywmQWz5c$default(ColorSchemeKt.getValue(FilledTextFieldTokens.INSTANCE.getDisabledInputColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j11;
        if (ComposerKt.isTraceInProgress()) {
        ...
        int i4 = i << 3;
        int i5 = i2 << 6;
        TextFieldColors textFieldColorsM1802inputFieldColorsITpI4ow = m1802inputFieldColorsITpI4ow(value, value, jM3413copywmQWz5c$default, value2, textSelectionColors2, value3, value4, jM3413copywmQWz5c$default2, value5, value6, jM3413copywmQWz5c$default3, value7, value7, jM3413copywmQWz5c$default4, composer, (i & 14) | (i4 & 112) | (i4 & 896) | (i4 & 7168) | (i4 & 57344) | (458752 & i4) | (3670016 & i4) | (29360128 & i4) | (234881024 & i4) | (i4 & 1879048192), ((i >> 27) & 14) | ((i2 << 3) & 112) | (i5 & 896) | (i5 & 7168) | (i5 & 57344), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return textFieldColorsM1802inputFieldColorsITpI4ow;
    }
}
