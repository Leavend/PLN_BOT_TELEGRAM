...
public final class SegmentedButtonColors {
    ...
    public final long m1809borderColorWaAFU9c$material3_release(boolean enabled, boolean active) {
        if (enabled && active) {
            return this.activeBorderColor;
        }
        if (enabled && !active) {
    ...
    public final long m1811contentColorWaAFU9c$material3_release(boolean enabled, boolean checked) {
        if (enabled && checked) {
            return this.activeContentColor;
        }
        if (enabled && !checked) {
    ...
    public final long m1810containerColorWaAFU9c$material3_release(boolean enabled, boolean active) {
        if (enabled && active) {
            return this.activeContainerColor;
        }
        if (enabled && !active) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3415equalsimpl0(this.activeBorderColor, segmentedButtonColors.activeBorderColor) && Color.m3415equalsimpl0(this.activeContentColor, segmentedButtonColors.activeContentColor) && Color.m3415equalsimpl0(this.activeContainerColor, segmentedButtonColors.activeContainerColor) && Color.m3415equalsimpl0(this.inactiveBorderColor, segmentedButtonColors.inactiveBorderColor) && Color.m3415equalsimpl0(this.inactiveContentColor, segmentedButtonColors.inactiveContentColor) && Color.m3415equalsimpl0(this.inactiveContainerColor, segmentedButtonColors.inactiveContainerColor) && Color.m3415equalsimpl0(this.disabledActiveBorderColor, segmentedButtonColors.disabledActiveBorderColor) && Color.m3415equalsimpl0(this.disabledActiveContentColor, segmentedButtonColors.disabledActiveContentColor) && Color.m3415equalsimpl0(this.disabledActiveContainerColor, segmentedButtonColors.disabledActiveContainerColor) && Color.m3415equalsimpl0(this.disabledInactiveBorderColor, segmentedButtonColors.disabledInactiveBorderColor) && Color.m3415equalsimpl0(this.disabledInactiveContentColor, segmentedButtonColors.disabledInactiveContentColor) && Color.m3415equalsimpl0(this.disabledInactiveContainerColor, segmentedButtonColors.disabledInactiveContainerColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((Color.m3421hashCodeimpl(this.activeBorderColor) * 31) + Color.m3421hashCodeimpl(this.activeContentColor)) * 31) + Color.m3421hashCodeimpl(this.activeContainerColor)) * 31) + Color.m3421hashCodeimpl(this.inactiveBorderColor)) * 31) + Color.m3421hashCodeimpl(this.inactiveContentColor)) * 31) + Color.m3421hashCodeimpl(this.inactiveContainerColor)) * 31) + Color.m3421hashCodeimpl(this.disabledActiveBorderColor)) * 31) + Color.m3421hashCodeimpl(this.disabledActiveContentColor)) * 31) + Color.m3421hashCodeimpl(this.disabledActiveContainerColor)) * 31) + Color.m3421hashCodeimpl(this.disabledInactiveBorderColor)) * 31) + Color.m3421hashCodeimpl(this.disabledInactiveContentColor)) * 31) + Color.m3421hashCodeimpl(this.disabledInactiveContainerColor);
    }

    /* renamed from: copy-2qZNXz8, reason: not valid java name */
    public final SegmentedButtonColors m1812copy2qZNXz8(long activeContainerColor, long activeContentColor, long activeBorderColor, long inactiveContainerColor, long inactiveContentColor, long inactiveBorderColor, long disabledActiveContainerColor, long disabledActiveContentColor, long disabledActiveBorderColor, long disabledInactiveContainerColor, long disabledInactiveContentColor, long disabledInactiveBorderColor) {
        return new SegmentedButtonColors((activeContainerColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (activeContainerColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? activeContainerColor : this.activeContainerColor, (activeContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (activeContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? activeContentColor : this.activeContentColor, (activeBorderColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (activeBorderColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? activeBorderColor : this.activeBorderColor, (inactiveContainerColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (inactiveContainerColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? inactiveContainerColor : this.inactiveContainerColor, (inactiveContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (inactiveContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? inactiveContentColor : this.inactiveContentColor, (inactiveBorderColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (inactiveBorderColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? inactiveBorderColor : this.inactiveBorderColor, (disabledActiveContainerColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (disabledActiveContainerColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledActiveContainerColor : this.disabledActiveContainerColor, (disabledActiveContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (disabledActiveContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledActiveContentColor : this.disabledActiveContentColor, (disabledActiveBorderColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (disabledActiveBorderColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledActiveBorderColor : this.disabledActiveBorderColor, (disabledInactiveContainerColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (disabledInactiveContainerColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledInactiveContainerColor : this.disabledInactiveContainerColor, (disabledInactiveContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (disabledInactiveContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledInactiveContentColor : this.disabledInactiveContentColor, disabledInactiveBorderColor != Color.INSTANCE.m3450getUnspecified0d7_KjU() ? disabledInactiveBorderColor : this.disabledInactiveBorderColor, null);
    }
}
