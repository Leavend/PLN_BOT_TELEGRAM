...
public final class RadioButtonKt {
    ...
    private static final float RadioButtonDotSize = Dp.m5735constructorimpl(12);
    ...
    */
    ...
    static {
        float f = 2;
        RadioButtonPadding = Dp.m5735constructorimpl(f);
        RadioStrokeWidth = Dp.m5735constructorimpl(f);
    }
}
