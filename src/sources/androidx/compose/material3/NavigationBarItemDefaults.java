...
public final class NavigationBarItemDefaults {
    ...
    public final NavigationBarItemColors m1694colors69fazGs(long j, long j2, long j3, long j4, long j5, long j6, long j7, Composer composer, int i, int i2) {
        ...
        NavigationBarItemColors navigationBarItemColorsM1685copy4JmcsL4 = getDefaultNavigationBarItemColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1685copy4JmcsL4(jM3450getUnspecified0d7_KjU, jM3450getUnspecified0d7_KjU2, jM3450getUnspecified0d7_KjU3, jM3450getUnspecified0d7_KjU4, jM3450getUnspecified0d7_KjU5, jM3450getUnspecified0d7_KjU6, jM3450getUnspecified0d7_KjU7);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return navigationBarItemColorsM1685copy4JmcsL4;
    }
    ...
    public final /* synthetic */ NavigationBarItemColors m1695colorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
        ...
        NavigationBarItemColors navigationBarItemColors = new NavigationBarItemColors(value, value2, value3, value4, value5, Color.m3413copywmQWz5c$default(value4, 0.38f, 0.0f, 0.0f, 0.0f, 14, null), Color.m3413copywmQWz5c$default(value5, 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
