...
public final class ChipBorder {
    ...
    public final State<BorderStroke> borderStroke$material3_release(boolean z, Composer composer, int i) {
        ...
        State<BorderStroke> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(BorderStrokeKt.m240BorderStrokecXLIe8U(this.borderWidth, z ? this.borderColor : this.disabledBorderColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3415equalsimpl0(this.borderColor, chipBorder.borderColor) && Color.m3415equalsimpl0(this.disabledBorderColor, chipBorder.disabledBorderColor) && Dp.m5740equalsimpl0(this.borderWidth, chipBorder.borderWidth);
    }

    public int hashCode() {
        return (((Color.m3421hashCodeimpl(this.borderColor) * 31) + Color.m3421hashCodeimpl(this.disabledBorderColor)) * 31) + Dp.m5741hashCodeimpl(this.borderWidth);
    }
}
