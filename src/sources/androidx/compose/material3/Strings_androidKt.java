...
public final class Strings_androidKt {
    ...
    public static final String m1973getStringiSCLEhQ(int i, Object[] objArr, Composer composer, int i2) {
        ...
        String strM1972getStringNWtq28 = m1972getStringNWtq28(i, composer, i2 & 14);
        ProvidableCompositionLocal<Configuration> localConfiguration = AndroidCompositionLocals_androidKt.getLocalConfiguration();
        ComposerKt.sourceInformationMarkerStart(composer, 2023513938, "CC:CompositionLocal.kt#9igjgp");
        ...
        String str = String.format(locale, strM1972getStringNWtq28, Arrays.copyOf(objArrCopyOf, objArrCopyOf.length));
