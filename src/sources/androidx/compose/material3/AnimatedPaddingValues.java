...
final class AnimatedPaddingValues implements PaddingValues {
    ...
    public float getTop() {
        return Dp.m5735constructorimpl(this.topPadding.getValue().m5749unboximpl() * this.animationProgress.getValue().floatValue());
    }

    @Override // androidx.compose.foundation.layout.PaddingValues
    /* renamed from: calculateBottomPadding-D9Ej5fM */
    public float getBottom() {
        return Dp.m5735constructorimpl(SearchBar_androidKt.getSearchBarVerticalPadding() * this.animationProgress.getValue().floatValue());
    }
