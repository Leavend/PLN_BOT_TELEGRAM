...
public final class SegmentedButtonKt {
    ...
    private static final float IconSpacing = Dp.m5735constructorimpl(8);
    ...
    */
    ...
    public static final void m1831SingleChoiceSegmentedButtonRowuFdPcIQ(Modifier modifier, float f, final Function3<? super SingleChoiceSegmentedButtonRowScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i, final int i2) {
        int i3;
        ...
        if ((i3 & 147) == 146 && composerStartRestartGroup.getSkipping()) {
            ...
            if (i5 != 0) {
                f = SegmentedButtonDefaults.INSTANCE.m1828getBorderWidthD9Ej5fM();
            }
            ...
            Modifier modifierWidth = IntrinsicKt.width(SizeKt.m599defaultMinSizeVpY3zN4$default(SelectableGroupKt.selectableGroup(modifier), 0.0f, OutlinedSegmentedButtonTokens.INSTANCE.m2668getContainerHeightD9Ej5fM(), 1, null), IntrinsicSize.Min);
            ...
            MeasurePolicy measurePolicyRowMeasurePolicy = RowKt.rowMeasurePolicy(horizontalOrVerticalM474spacedBy0680j_4, centerVertically, composerStartRestartGroup, 48);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SegmentedButtonKt$SingleChoiceSegmentedButtonRow$2
                ...
                public final void invoke(Composer composer2, int i6) {
                    SegmentedButtonKt.m1831SingleChoiceSegmentedButtonRowuFdPcIQ(modifier2, f2, function3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
    }
    ...
    public static final void m1830MultiChoiceSegmentedButtonRowuFdPcIQ(Modifier modifier, float f, final Function3<? super MultiChoiceSegmentedButtonRowScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i, final int i2) {
        int i3;
        ...
        if ((i3 & 147) == 146 && composerStartRestartGroup.getSkipping()) {
            ...
            Modifier modifierWidth = IntrinsicKt.width(SizeKt.m599defaultMinSizeVpY3zN4$default(modifier, 0.0f, OutlinedSegmentedButtonTokens.INSTANCE.m2668getContainerHeightD9Ej5fM(), 1, null), IntrinsicSize.Min);
            Arrangement.HorizontalOrVertical horizontalOrVerticalM474spacedBy0680j_4 = Arrangement.INSTANCE.m474spacedBy0680j_4(Dp.m5735constructorimpl(-f));
            Alignment.Vertical centerVertically = Alignment.INSTANCE.getCenterVertically();
            composerStartRestartGroup.startReplaceableGroup(693286680);
            ComposerKt.sourceInformation(composerStartRestartGroup, "CC(Row)P(2,1,3)90@4553L58,91@4616L130:Row.kt#2w3rfo");
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SegmentedButtonKt$MultiChoiceSegmentedButtonRow$2
                ...
                public final void invoke(Composer composer2, int i6) {
                    SegmentedButtonKt.m1830MultiChoiceSegmentedButtonRowuFdPcIQ(modifier2, f2, function3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
    }
            ...
            TextKt.ProvideTextStyle(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography(composerStartRestartGroup, 6), OutlinedSegmentedButtonTokens.INSTANCE.getLabelTextFont()), ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1420592651, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SegmentedButtonKt$SegmentedButtonContent$1$1
                ...
                public final void invoke(Composer composer2, int i3) {
                    ...
                    if ((i3 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        Updater.m2951setimpl(composerM2944constructorimpl2, measurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
    ...
    private static final Modifier interactionZIndex(Modifier modifier, final boolean z, final State<Integer> state) {
        return LayoutModifierKt.layout(modifier, new Function3<MeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.material3.SegmentedButtonKt.interactionZIndex.1
            ...
            public final MeasureResult m1832invoke3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
                ...
                int width = placeableMo4684measureBRTryo0.getWidth();
                int height = placeableMo4684measureBRTryo0.getHeight();
                ...
                return MeasureScope.layout$default(measureScope, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.SegmentedButtonKt.interactionZIndex.1.1
                    ...
                    public final void invoke2(Placeable.PlacementScope placementScope) {
                        placementScope.place(placeableMo4684measureBRTryo0, 0, 0, state2.getValue().floatValue() + (z2 ? SegmentedButtonKt.CheckedZIndexFactor : 0.0f));
                    }
                }, 4, null);
            }
        });
