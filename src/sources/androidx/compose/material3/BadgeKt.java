...
public final class BadgeKt {
    ...
    private static final float BadgeWithContentHorizontalPadding = Dp.m5735constructorimpl(4);
    private static final float BadgeOffset = Dp.m5735constructorimpl(0);
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m1249BadgeeopBjH0(androidx.compose.ui.Modifier r16, long r17, long r19, kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.RowScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r21, androidx.compose.runtime.Composer r22, final int r23, final int r24) {
        /*
            Method dump skipped, instructions count: 642
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.BadgeKt.m1249BadgeeopBjH0(androidx.compose.ui.Modifier, long, long, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    static {
        float f = 6;
        BadgeWithContentHorizontalOffset = Dp.m5735constructorimpl(-Dp.m5735constructorimpl(f));
        BadgeWithContentVerticalOffset = Dp.m5735constructorimpl(f);
    }
}
