...
public final class TabIndicatorOffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo90measure3p2s80s(final MeasureScope measureScope, Measurable measurable, final long j) {
        ...
        long jM5682copyZbe2FdA$default;
        ...
        if (this.followContentSize) {
            if (this.initialWidth != null) {
                ...
                if (!Dp.m5740equalsimpl0(contentWidth, animatable.getTargetValue().m5749unboximpl())) {
                ...
                this.initialWidth = Dp.m5733boximpl(contentWidth);
            }
        }
        ...
        if (this.initialOffset != null) {
            ...
            if (!Dp.m5740equalsimpl0(left, animatable2.getTargetValue().m5749unboximpl())) {
            ...
            this.initialOffset = Dp.m5733boximpl(left);
        }
        Animatable<Dp, AnimationVector1D> animatable3 = this.offsetAnimatable;
        if (animatable3 != null) {
            left = animatable3.getValue().m5749unboximpl();
        }
        final float f = left;
        if (this.followContentSize) {
            Animatable<Dp, AnimationVector1D> animatable4 = this.widthAnimatable;
            if (animatable4 != null) {
                contentWidth = animatable4.getValue().m5749unboximpl();
            }
            jM5682copyZbe2FdA$default = Constraints.m5682copyZbe2FdA$default(j, measureScope.mo310roundToPx0680j_4(contentWidth), measureScope.mo310roundToPx0680j_4(contentWidth), 0, 0, 12, null);
            measurable2 = measurable;
        } else {
            measurable2 = measurable;
            jM5682copyZbe2FdA$default = j;
        }
        final Placeable placeableMo4684measureBRTryo0 = measurable2.mo4684measureBRTryo0(jM5682copyZbe2FdA$default);
        return MeasureScope.layout$default(measureScope, placeableMo4684measureBRTryo0.getWidth(), Constraints.m5690getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TabIndicatorOffsetNode$measure$4
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, placeableMo4684measureBRTryo0, measureScope.mo310roundToPx0680j_4(f), Constraints.m5690getMaxHeightimpl(j) - placeableMo4684measureBRTryo0.getHeight(), 0.0f, 4, null);
            }
        }, 4, null);
    }
}
