...
public final class BasicTooltip_androidKt {
    ...
    */
                        ...
                        if (zChanged || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                            objRememberedValue2 = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.BasicTooltip_androidKt$TooltipPopup$2$1$1
                                ...
                                public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                                    SemanticsPropertiesKt.m5078setLiveRegionhR3wRGc(semanticsPropertyReceiver, LiveRegionMode.INSTANCE.m5054getAssertive0phEisY());
    ...
    static final class C05171 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ BasicTooltipState $state;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05171(BasicTooltipState basicTooltipState, Continuation<? super C05171> continuation) {
            super(2, continuation);
            this.$state = basicTooltipState;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C05171 c05171 = new C05171(this.$state, continuation);
            c05171.L$0 = obj;
            return c05171;
        }
        ...
        public final Object invoke(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
            return ((C05171) create(pointerInputScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        static final class C00891 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            static final class C00901 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: Removed duplicated region for block: B:31:0x00d3 A[LOOP:0: B:30:0x00d1->B:31:0x00d3, LOOP_END] */
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                /*
                    Code decompiled incorrectly, please refer to instructions dump.
                    To view partially-correct add '--show-bad-code' argument
                */
                public final java.lang.Object invokeSuspend(java.lang.Object r17) {
                    /*
                        ...
                        To view this dump add '--comments-level debug' option
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.BasicTooltip_androidKt.C05171.C00891.C00901.invokeSuspend(java.lang.Object):java.lang.Object");
                }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    this.label = 1;
                    if (ForEachGestureKt.awaitEachGesture(this.$$this$pointerInput, new C00901(coroutineScope, this.$state, null), this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i != 1) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                this.label = 1;
                if (CoroutineScopeKt.coroutineScope(new C00891((PointerInputScope) this.L$0, this.$state, null), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
    ...
    private static final Modifier handleGestures(Modifier modifier, boolean z, BasicTooltipState basicTooltipState) {
        return z ? SuspendingPointerInputFilterKt.pointerInput(SuspendingPointerInputFilterKt.pointerInput(modifier, basicTooltipState, new C05171(basicTooltipState, null)), basicTooltipState, new C05182(basicTooltipState, null)) : modifier;
    }
    ...
    static final class C05182 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ BasicTooltipState $state;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05182(BasicTooltipState basicTooltipState, Continuation<? super C05182> continuation) {
            super(2, continuation);
            this.$state = basicTooltipState;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C05182 c05182 = new C05182(this.$state, continuation);
            c05182.L$0 = obj;
            return c05182;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
            return ((C05182) create(pointerInputScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            static final class C00921 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:12:0x003f -> B:13:0x0045). Please report as a decompilation issue!!! */
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                /*
                    Code decompiled incorrectly, please refer to instructions dump.
                    To view partially-correct add '--show-bad-code' argument
                */
                public final java.lang.Object invokeSuspend(java.lang.Object r14) {
                    ...
                    L2f:
                        ...
                        r14.L$1 = r1
                        r14.label = r2
                        java.lang.Object r4 = r3.awaitPointerEvent(r1, r4)
                        if (r4 != r0) goto L3f
                        return r0
                    L3f:
                        r12 = r0
                    ...
                    L45:
                        ...
                        int r5 = r5.m4511getEnter7fucELk()
                        boolean r5 = androidx.compose.ui.input.pointer.PointerEventType.m4507equalsimpl0(r14, r5)
                        if (r5 == 0) goto L87
                        ...
                        androidx.compose.material3.BasicTooltipState r5 = r0.$state
                        r9 = 0
                        r14.<init>(r5, r9)
                        r9 = r14
                    ...
                    L87:
                        androidx.compose.ui.input.pointer.PointerEventType$Companion r5 = androidx.compose.ui.input.pointer.PointerEventType.INSTANCE
                        int r5 = r5.m4512getExit7fucELk()
                        boolean r14 = androidx.compose.ui.input.pointer.PointerEventType.m4507equalsimpl0(r14, r5)
                        if (r14 == 0) goto L98
                        androidx.compose.material3.BasicTooltipState r14 = r0.$state
                        r14.dismiss()
                    L98:
                        r14 = r0
                        r0 = r1
                        ...
                        goto L2f
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.BasicTooltip_androidKt.C05182.AnonymousClass1.C00921.invokeSuspend(java.lang.Object):java.lang.Object");
                }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    CoroutineScope coroutineScope = (CoroutineScope) this.L$0;
                    this.label = 1;
                    if (this.$$this$pointerInput.awaitPointerEventScope(new C00921(coroutineScope, this.$state, null), this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i != 1) {
            ...
            public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                ...
                SemanticsPropertiesKt.onLongClick(semanticsPropertyReceiver, str2, new Function0<Boolean>() { // from class: androidx.compose.material3.BasicTooltip_androidKt.anchorSemantics.1.1
                    ...
                    public final Boolean invoke() {
                        BuildersKt__Builders_commonKt.launch$default(coroutineScope2, null, null, new C00881(basicTooltipState2, null), 3, null);
                        return true;
                    }
                });
            }
