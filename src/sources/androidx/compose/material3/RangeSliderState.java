...
public final class RangeSliderState {
    ...
    public final void onDrag$material3_release(boolean isStart, float offset) {
        ...
        long jM1777scaleToUserValueowVgs5E = m1777scaleToUserValueowVgs5E(getMinPx(), getMaxPx(), jSliderRange);
        if (SliderRange.m1887equalsimpl0(jM1777scaleToUserValueowVgs5E, SliderKt.SliderRange(getActiveRangeStart(), getActiveRangeEnd()))) {
            return;
        }
        Function1<? super SliderRange, Unit> function1 = this.onValueChange;
        if (function1 == null) {
            setActiveRangeStart(SliderRange.m1889getStartimpl(jM1777scaleToUserValueowVgs5E));
            setActiveRangeEnd(SliderRange.m1888getEndInclusiveimpl(jM1777scaleToUserValueowVgs5E));
        } else if (function1 != null) {
            function1.invoke(SliderRange.m1884boximpl(jM1777scaleToUserValueowVgs5E));
        }
    }
    ...
    private final long m1777scaleToUserValueowVgs5E(float minPx, float maxPx, long offset) {
        return SliderKt.m1880scaleziovWd0(minPx, maxPx, offset, this.valueRange.getStart().floatValue(), this.valueRange.getEndInclusive().floatValue());
    }
