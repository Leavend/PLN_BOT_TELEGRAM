...
public final class SheetDefaultsKt {
    private static final float DragHandleVerticalPadding = Dp.m5735constructorimpl(22);
    ...
    public static final NestedScrollConnection ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection(final SheetState sheetState, final Orientation orientation, final Function1<? super Float, Unit> function1) {
        return new NestedScrollConnection() { // from class: androidx.compose.material3.SheetDefaultsKt.ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection.1
            ...
            public long mo404onPreScrollOzD1aCk(long available, int source) {
                ...
                if (fOffsetToFloat < 0.0f && NestedScrollSource.m4447equalsimpl0(source, NestedScrollSource.INSTANCE.m4452getDragWNlRxjI())) {
            ...
            public long mo403onPostScrollDzOQY0M(long consumed, long available, int source) {
                if (NestedScrollSource.m4447equalsimpl0(source, NestedScrollSource.INSTANCE.m4452getDragWNlRxjI())) {
            ...
            private final float velocityToFloat(long j) {
                return orientation == Orientation.Horizontal ? Velocity.m5970getXimpl(j) : Velocity.m5971getYimpl(j);
            }

            private final float offsetToFloat(long j) {
                return orientation == Orientation.Horizontal ? Offset.m3173getXimpl(j) : Offset.m3174getYimpl(j);
            }
        };
    }
    ...
    public static final SheetState rememberSheetState(boolean z, Function1<? super SheetValue, Boolean> function1, SheetValue sheetValue, boolean z2, Composer composer, int i, int i2) {
        ...
        SheetState sheetState = (SheetState) RememberSaveableKt.m3031rememberSaveable(objArr, (Saver) Saver, (String) null, (Function0) objRememberedValue, composer, 0, 4);
        if (ComposerKt.isTraceInProgress()) {
