...
public final class ButtonDefaults {
    ...
    public final ButtonColors m1271buttonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long jM3450getUnspecified0d7_KjU2 = (i2 & 2) != 0 ? Color.INSTANCE.m3450getUnspecified0d7_KjU() : j2;
        long jM3450getUnspecified0d7_KjU3 = (i2 & 4) != 0 ? Color.INSTANCE.m3450getUnspecified0d7_KjU() : j3;
        long jM3450getUnspecified0d7_KjU4 = (i2 & 8) != 0 ? Color.INSTANCE.m3450getUnspecified0d7_KjU() : j4;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-339300779, i, -1, "androidx.compose.material3.ButtonDefaults.buttonColors (Button.kt:563)");
        }
        ButtonColors buttonColorsM1266copyjRlVdoo = getDefaultButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1266copyjRlVdoo(jM3450getUnspecified0d7_KjU, jM3450getUnspecified0d7_KjU2, jM3450getUnspecified0d7_KjU3, jM3450getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return buttonColorsM1266copyjRlVdoo;
    }
    ...
    public final ButtonColors m1273elevatedButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        ButtonColors buttonColorsM1266copyjRlVdoo = getDefaultElevatedButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1266copyjRlVdoo(jM3450getUnspecified0d7_KjU, jM3450getUnspecified0d7_KjU2, jM3450getUnspecified0d7_KjU3, jM3450getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ButtonColors getDefaultElevatedButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        ButtonColors buttonColors = new ButtonColors(ColorSchemeKt.fromToken(colorScheme, ElevatedButtonTokens.INSTANCE.getContainerColor()), ColorSchemeKt.fromToken(colorScheme, ElevatedButtonTokens.INSTANCE.getLabelTextColor()), Color.m3413copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, ElevatedButtonTokens.INSTANCE.getDisabledContainerColor()), 0.12f, 0.0f, 0.0f, 0.0f, 14, null), Color.m3413copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, ElevatedButtonTokens.INSTANCE.getDisabledLabelTextColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final ButtonColors m1275filledTonalButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        ButtonColors buttonColorsM1266copyjRlVdoo = getDefaultFilledTonalButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1266copyjRlVdoo(jM3450getUnspecified0d7_KjU, jM3450getUnspecified0d7_KjU2, jM3450getUnspecified0d7_KjU3, jM3450getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ButtonColors getDefaultFilledTonalButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        ButtonColors buttonColors = new ButtonColors(ColorSchemeKt.fromToken(colorScheme, FilledTonalButtonTokens.INSTANCE.getContainerColor()), ColorSchemeKt.fromToken(colorScheme, FilledTonalButtonTokens.INSTANCE.getLabelTextColor()), Color.m3413copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalButtonTokens.INSTANCE.getDisabledContainerColor()), 0.12f, 0.0f, 0.0f, 0.0f, 14, null), Color.m3413copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalButtonTokens.INSTANCE.getDisabledLabelTextColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final ButtonColors m1281outlinedButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        ButtonColors buttonColorsM1266copyjRlVdoo = getDefaultOutlinedButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1266copyjRlVdoo(jM3450getUnspecified0d7_KjU, jM3450getUnspecified0d7_KjU2, jM3450getUnspecified0d7_KjU3, jM3450getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ButtonColors getDefaultOutlinedButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        ButtonColors buttonColors = new ButtonColors(Color.INSTANCE.m3449getTransparent0d7_KjU(), ColorSchemeKt.fromToken(colorScheme, OutlinedButtonTokens.INSTANCE.getLabelTextColor()), Color.INSTANCE.m3449getTransparent0d7_KjU(), Color.m3413copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, OutlinedButtonTokens.INSTANCE.getDisabledLabelTextColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final ButtonColors m1282textButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        ButtonColors buttonColorsM1266copyjRlVdoo = getDefaultTextButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1266copyjRlVdoo(jM3450getUnspecified0d7_KjU, jM3450getUnspecified0d7_KjU2, jM3450getUnspecified0d7_KjU3, jM3450getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ButtonColors getDefaultTextButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        ButtonColors buttonColors = new ButtonColors(Color.INSTANCE.m3449getTransparent0d7_KjU(), ColorSchemeKt.fromToken(colorScheme, TextButtonTokens.INSTANCE.getLabelTextColor()), Color.INSTANCE.m3449getTransparent0d7_KjU(), Color.m3413copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, TextButtonTokens.INSTANCE.getDisabledLabelTextColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
        colorScheme.setDefaultTextButtonColorsCached$material3_release(buttonColors);
        return buttonColors;
    }

    /* renamed from: buttonElevation-R_JCAzs, reason: not valid java name */
    public final ButtonElevation m1272buttonElevationR_JCAzs(float f, float f2, float f3, float f4, float f5, Composer composer, int i, int i2) {
        ...
        float fM2548getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? FilledButtonTokens.INSTANCE.m2548getContainerElevationD9Ej5fM() : f;
        float fM2554getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? FilledButtonTokens.INSTANCE.m2554getPressedContainerElevationD9Ej5fM() : f2;
        float fM2551getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? FilledButtonTokens.INSTANCE.m2551getFocusContainerElevationD9Ej5fM() : f3;
        float fM2552getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? FilledButtonTokens.INSTANCE.m2552getHoverContainerElevationD9Ej5fM() : f4;
        float fM2550getDisabledContainerElevationD9Ej5fM = (i2 & 16) != 0 ? FilledButtonTokens.INSTANCE.m2550getDisabledContainerElevationD9Ej5fM() : f5;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1827791191, i, -1, "androidx.compose.material3.ButtonDefaults.buttonElevation (Button.kt:772)");
        }
        ButtonElevation buttonElevation = new ButtonElevation(fM2548getContainerElevationD9Ej5fM, fM2554getPressedContainerElevationD9Ej5fM, fM2551getFocusContainerElevationD9Ej5fM, fM2552getHoverContainerElevationD9Ej5fM, fM2550getDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ButtonElevation m1274elevatedButtonElevationR_JCAzs(float f, float f2, float f3, float f4, float f5, Composer composer, int i, int i2) {
        ...
        float fM2464getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? ElevatedButtonTokens.INSTANCE.m2464getContainerElevationD9Ej5fM() : f;
        float fM2470getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? ElevatedButtonTokens.INSTANCE.m2470getPressedContainerElevationD9Ej5fM() : f2;
        float fM2467getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? ElevatedButtonTokens.INSTANCE.m2467getFocusContainerElevationD9Ej5fM() : f3;
        float fM2468getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? ElevatedButtonTokens.INSTANCE.m2468getHoverContainerElevationD9Ej5fM() : f4;
        float fM2466getDisabledContainerElevationD9Ej5fM = (i2 & 16) != 0 ? ElevatedButtonTokens.INSTANCE.m2466getDisabledContainerElevationD9Ej5fM() : f5;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ButtonElevation buttonElevation = new ButtonElevation(fM2464getContainerElevationD9Ej5fM, fM2470getPressedContainerElevationD9Ej5fM, fM2467getFocusContainerElevationD9Ej5fM, fM2468getHoverContainerElevationD9Ej5fM, fM2466getDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ButtonElevation m1276filledTonalButtonElevationR_JCAzs(float f, float f2, float f3, float f4, float f5, Composer composer, int i, int i2) {
        ...
        float fM2571getContainerElevationD9Ej5fM = (i2 & 1) != 0 ? FilledTonalButtonTokens.INSTANCE.m2571getContainerElevationD9Ej5fM() : f;
        float fM2577getPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? FilledTonalButtonTokens.INSTANCE.m2577getPressedContainerElevationD9Ej5fM() : f2;
        float fM2574getFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? FilledTonalButtonTokens.INSTANCE.m2574getFocusContainerElevationD9Ej5fM() : f3;
        float fM2575getHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? FilledTonalButtonTokens.INSTANCE.m2575getHoverContainerElevationD9Ej5fM() : f4;
        float fM5735constructorimpl = (i2 & 16) != 0 ? Dp.m5735constructorimpl(0) : f5;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ButtonElevation buttonElevation = new ButtonElevation(fM2571getContainerElevationD9Ej5fM, fM2577getPressedContainerElevationD9Ej5fM, fM2574getFocusContainerElevationD9Ej5fM, fM2575getHoverContainerElevationD9Ej5fM, fM5735constructorimpl, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final BorderStroke getOutlinedButtonBorder(Composer composer, int i) {
        ...
        BorderStroke borderStrokeM240BorderStrokecXLIe8U = BorderStrokeKt.m240BorderStrokecXLIe8U(OutlinedButtonTokens.INSTANCE.m2656getOutlineWidthD9Ej5fM(), ColorSchemeKt.getValue(OutlinedButtonTokens.INSTANCE.getOutlineColor(), composer, 6));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return borderStrokeM240BorderStrokecXLIe8U;
    }

    static {
        float fM5735constructorimpl = Dp.m5735constructorimpl(24);
        ButtonHorizontalPadding = fM5735constructorimpl;
        float f = 8;
        float fM5735constructorimpl2 = Dp.m5735constructorimpl(f);
        ButtonVerticalPadding = fM5735constructorimpl2;
        PaddingValues paddingValuesM561PaddingValuesa9UjIt4 = PaddingKt.m561PaddingValuesa9UjIt4(fM5735constructorimpl, fM5735constructorimpl2, fM5735constructorimpl, fM5735constructorimpl2);
        ContentPadding = paddingValuesM561PaddingValuesa9UjIt4;
        float f2 = 16;
        float fM5735constructorimpl3 = Dp.m5735constructorimpl(f2);
        ButtonWithIconHorizontalStartPadding = fM5735constructorimpl3;
        ButtonWithIconContentPadding = PaddingKt.m561PaddingValuesa9UjIt4(fM5735constructorimpl3, fM5735constructorimpl2, fM5735constructorimpl, fM5735constructorimpl2);
        float fM5735constructorimpl4 = Dp.m5735constructorimpl(12);
        TextButtonHorizontalPadding = fM5735constructorimpl4;
        TextButtonContentPadding = PaddingKt.m561PaddingValuesa9UjIt4(fM5735constructorimpl4, paddingValuesM561PaddingValuesa9UjIt4.getTop(), fM5735constructorimpl4, paddingValuesM561PaddingValuesa9UjIt4.getBottom());
        float fM5735constructorimpl5 = Dp.m5735constructorimpl(f2);
        TextButtonWithIconHorizontalEndPadding = fM5735constructorimpl5;
        TextButtonWithIconContentPadding = PaddingKt.m561PaddingValuesa9UjIt4(fM5735constructorimpl4, paddingValuesM561PaddingValuesa9UjIt4.getTop(), fM5735constructorimpl5, paddingValuesM561PaddingValuesa9UjIt4.getBottom());
        MinWidth = Dp.m5735constructorimpl(58);
        MinHeight = Dp.m5735constructorimpl(40);
        IconSize = FilledButtonTokens.INSTANCE.m2553getIconSizeD9Ej5fM();
        IconSpacing = Dp.m5735constructorimpl(f);
    }
}
