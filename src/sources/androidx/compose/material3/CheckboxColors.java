...
public final class CheckboxColors {
    ...
    public final State<Color> checkmarkColor$material3_release(ToggleableState toggleableState, Composer composer, int i) {
        ...
        State<Color> stateM104animateColorAsStateeuL9pac = SingleValueAnimationKt.m104animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(toggleableState == ToggleableState.Off ? 100 : 50, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> boxColor$material3_release(boolean z, ToggleableState toggleableState, Composer composer, int i) {
        ...
        if (z) {
            ...
            stateRememberUpdatedState = SingleValueAnimationKt.m104animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(toggleableState == ToggleableState.Off ? 100 : 50, 0, null, 6, null), null, null, composer, 0, 12);
            composer.endReplaceableGroup();
        } else {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3415equalsimpl0(this.checkedCheckmarkColor, checkboxColors.checkedCheckmarkColor) && Color.m3415equalsimpl0(this.uncheckedCheckmarkColor, checkboxColors.uncheckedCheckmarkColor) && Color.m3415equalsimpl0(this.checkedBoxColor, checkboxColors.checkedBoxColor) && Color.m3415equalsimpl0(this.uncheckedBoxColor, checkboxColors.uncheckedBoxColor) && Color.m3415equalsimpl0(this.disabledCheckedBoxColor, checkboxColors.disabledCheckedBoxColor) && Color.m3415equalsimpl0(this.disabledUncheckedBoxColor, checkboxColors.disabledUncheckedBoxColor) && Color.m3415equalsimpl0(this.disabledIndeterminateBoxColor, checkboxColors.disabledIndeterminateBoxColor) && Color.m3415equalsimpl0(this.checkedBorderColor, checkboxColors.checkedBorderColor) && Color.m3415equalsimpl0(this.uncheckedBorderColor, checkboxColors.uncheckedBorderColor) && Color.m3415equalsimpl0(this.disabledBorderColor, checkboxColors.disabledBorderColor) && Color.m3415equalsimpl0(this.disabledUncheckedBorderColor, checkboxColors.disabledUncheckedBorderColor) && Color.m3415equalsimpl0(this.disabledIndeterminateBorderColor, checkboxColors.disabledIndeterminateBorderColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((Color.m3421hashCodeimpl(this.checkedCheckmarkColor) * 31) + Color.m3421hashCodeimpl(this.uncheckedCheckmarkColor)) * 31) + Color.m3421hashCodeimpl(this.checkedBoxColor)) * 31) + Color.m3421hashCodeimpl(this.uncheckedBoxColor)) * 31) + Color.m3421hashCodeimpl(this.disabledCheckedBoxColor)) * 31) + Color.m3421hashCodeimpl(this.disabledUncheckedBoxColor)) * 31) + Color.m3421hashCodeimpl(this.disabledIndeterminateBoxColor)) * 31) + Color.m3421hashCodeimpl(this.checkedBorderColor)) * 31) + Color.m3421hashCodeimpl(this.uncheckedBorderColor)) * 31) + Color.m3421hashCodeimpl(this.disabledBorderColor)) * 31) + Color.m3421hashCodeimpl(this.disabledUncheckedBorderColor)) * 31) + Color.m3421hashCodeimpl(this.disabledIndeterminateBorderColor);
    }

    /* renamed from: copy-2qZNXz8, reason: not valid java name */
    public final CheckboxColors m1306copy2qZNXz8(long checkedCheckmarkColor, long uncheckedCheckmarkColor, long checkedBoxColor, long uncheckedBoxColor, long disabledCheckedBoxColor, long disabledUncheckedBoxColor, long disabledIndeterminateBoxColor, long checkedBorderColor, long uncheckedBorderColor, long disabledBorderColor, long disabledUncheckedBorderColor, long disabledIndeterminateBorderColor) {
        return new CheckboxColors((checkedCheckmarkColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (checkedCheckmarkColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? checkedCheckmarkColor : this.checkedCheckmarkColor, (uncheckedCheckmarkColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (uncheckedCheckmarkColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? uncheckedCheckmarkColor : this.uncheckedCheckmarkColor, (checkedBoxColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (checkedBoxColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? checkedBoxColor : this.checkedBoxColor, (uncheckedBoxColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (uncheckedBoxColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? uncheckedBoxColor : this.uncheckedBoxColor, (disabledCheckedBoxColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (disabledCheckedBoxColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledCheckedBoxColor : this.disabledCheckedBoxColor, (disabledUncheckedBoxColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (disabledUncheckedBoxColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledUncheckedBoxColor : this.disabledUncheckedBoxColor, (disabledIndeterminateBoxColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (disabledIndeterminateBoxColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledIndeterminateBoxColor : this.disabledIndeterminateBoxColor, (checkedBorderColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (checkedBorderColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? checkedBorderColor : this.checkedBorderColor, (uncheckedBorderColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (uncheckedBorderColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? uncheckedBorderColor : this.uncheckedBorderColor, (disabledBorderColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (disabledBorderColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledBorderColor : this.disabledBorderColor, (disabledUncheckedBorderColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (disabledUncheckedBorderColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledUncheckedBorderColor : this.disabledUncheckedBorderColor, disabledIndeterminateBorderColor != Color.INSTANCE.m3450getUnspecified0d7_KjU() ? disabledIndeterminateBorderColor : this.disabledIndeterminateBorderColor, null);
    }
}
