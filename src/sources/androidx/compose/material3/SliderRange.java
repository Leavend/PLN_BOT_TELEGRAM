...
public final class SliderRange {
    ...
    public static final /* synthetic */ SliderRange m1884boximpl(long j) {
        return new SliderRange(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m1885constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1886equalsimpl(long j, Object obj) {
        return (obj instanceof SliderRange) && j == ((SliderRange) obj).m1892unboximpl();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1887equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public static int m1890hashCodeimpl(long j) {
        return Long.hashCode(j);
    }

    public boolean equals(Object obj) {
        return m1886equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m1890hashCodeimpl(this.packedValue);
    }
    ...
    public static final float m1889getStartimpl(long j) {
        if (!(j != Unspecified)) {
    ...
    public static final float m1888getEndInclusiveimpl(long j) {
        if (!(j != Unspecified)) {
            throw new IllegalStateException("SliderRange is unspecified".toString());
        }
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m1893getUnspecifiedFYbKRX4$annotations() {
        }
        ...
        public final long m1894getUnspecifiedFYbKRX4() {
            return SliderRange.Unspecified;
        }
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1891toStringimpl(long j) {
        return SliderKt.m1878isSpecifiedIf1S1O4(j) ? m1889getStartimpl(j) + ".." + m1888getEndInclusiveimpl(j) : "FloatRange.Unspecified";
    }

    public String toString() {
        return m1891toStringimpl(this.packedValue);
    }
}
