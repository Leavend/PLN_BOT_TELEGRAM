...
public final class EnterAlwaysScrollBehavior$nestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public long mo404onPreScrollOzD1aCk(long available, int source) {
        ...
        this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m3174getYimpl(available));
        if (!(heightOffset == this.this$0.getState().getHeightOffset())) {
            return Offset.m3167copydBAh8RU$default(available, 0.0f, 0.0f, 2, null);
        }
        return Offset.INSTANCE.m3189getZeroF1C5BW0();
    }
    ...
    */
    public long mo403onPostScrollDzOQY0M(long r5, long r7, int r9) {
        /*
            r4 = this;
            ...
            long r5 = r5.m3189getZeroF1C5BW0()
            return r5
        L19:
            androidx.compose.material3.EnterAlwaysScrollBehavior r9 = r4.this$0
            androidx.compose.material3.TopAppBarState r9 = r9.getState()
            float r0 = r9.getContentOffset()
            float r1 = androidx.compose.ui.geometry.Offset.m3174getYimpl(r5)
            float r0 = r0 + r1
        ...
        L5c:
            if (r9 == 0) goto L7b
        L5e:
            float r9 = androidx.compose.ui.geometry.Offset.m3174getYimpl(r5)
            int r9 = (r9 > r0 ? 1 : (r9 == r0 ? 0 : -1))
            if (r9 != 0) goto L67
            goto L68
        L67:
        ...
        L68:
            if (r1 == 0) goto L7b
            float r7 = androidx.compose.ui.geometry.Offset.m3174getYimpl(r7)
        ...
        L7b:
            ...
            float r5 = androidx.compose.ui.geometry.Offset.m3174getYimpl(r5)
            float r8 = r8 + r5
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.EnterAlwaysScrollBehavior$nestedScrollConnection$1.mo403onPostScrollDzOQY0M(long, long, int):long");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public java.lang.Object mo402onPostFlingRZ2iAVY(long r10, long r12, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r14) {
        /*
            r9 = this;
        ...
        L42:
            ...
            r4 = r12
            r6 = r0
            java.lang.Object r14 = super.mo402onPostFlingRZ2iAVY(r2, r4, r6)
            if (r14 != r7) goto L56
            return r7
        L56:
            r10 = r9
        L57:
            ...
            float r12 = androidx.compose.ui.unit.Velocity.m5971getYimpl(r12)
        ...
        L82:
            ...
            long r10 = androidx.compose.ui.unit.Velocity.m5974plusAH228Gc(r10, r12)
            androidx.compose.ui.unit.Velocity r10 = androidx.compose.ui.unit.Velocity.m5961boximpl(r10)
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.EnterAlwaysScrollBehavior$nestedScrollConnection$1.mo402onPostFlingRZ2iAVY(long, long, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
