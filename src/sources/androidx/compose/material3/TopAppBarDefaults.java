...
public final class TopAppBarDefaults {
    ...
    public final TopAppBarColors m2289topAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
        ...
        TopAppBarColors topAppBarColorsM2279copyt635Npw = getDefaultTopAppBarColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2279copyt635Npw(jM3450getUnspecified0d7_KjU, jM3450getUnspecified0d7_KjU2, jM3450getUnspecified0d7_KjU3, jM3450getUnspecified0d7_KjU4, jM3450getUnspecified0d7_KjU5);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return topAppBarColorsM2279copyt635Npw;
    }
    ...
    public final TopAppBarColors getDefaultTopAppBarColors$material3_release(ColorScheme colorScheme) {
        ...
        if (defaultTopAppBarColorsCached == null) {
            ...
            if (Color.m3415equalsimpl0(ColorSchemeKt.fromToken(colorScheme, TopAppBarSmallTokens.INSTANCE.getContainerColor()), colorScheme.getSurface())) {
                jFromToken = ColorSchemeKt.m1406surfaceColorAtElevation3ABfNKs(colorScheme, TopAppBarSmallTokens.INSTANCE.m2870getOnScrollContainerElevationD9Ej5fM());
            } else {
    ...
    public final TopAppBarColors m2288smallTopAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
        ...
        long jM1395applyTonalElevationRFCenO8 = (i2 & 2) != 0 ? ColorSchemeKt.m1395applyTonalElevationRFCenO8(MaterialTheme.INSTANCE.getColorScheme(composer, 6), value, TopAppBarSmallTokens.INSTANCE.m2870getOnScrollContainerElevationD9Ej5fM(), composer, ((i << 3) & 112) | 384) : j2;
        ...
        TopAppBarColors topAppBarColorsM2289topAppBarColorszjMxDiM = m2289topAppBarColorszjMxDiM(value, jM1395applyTonalElevationRFCenO8, value2, value3, value4, composer, (i & 14) | (i & 112) | (i & 896) | (i & 7168) | (57344 & i) | (458752 & i), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return topAppBarColorsM2289topAppBarColorszjMxDiM;
    }
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i) {
        ...
        WindowInsets windowInsetsM640onlybOOhFvg = WindowInsetsKt.m640onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.INSTANCE, composer, 6), WindowInsetsSides.m651plusgK_yJZ4(WindowInsetsSides.INSTANCE.m661getHorizontalJoeWqyM(), WindowInsetsSides.INSTANCE.m665getTopJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return windowInsetsM640onlybOOhFvg;
    }
    ...
    public final TopAppBarColors m2285centerAlignedTopAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
        ...
        TopAppBarColors topAppBarColorsM2279copyt635Npw = getDefaultCenterAlignedTopAppBarColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2279copyt635Npw(jM3450getUnspecified0d7_KjU, jM3450getUnspecified0d7_KjU2, jM3450getUnspecified0d7_KjU3, jM3450getUnspecified0d7_KjU4, jM3450getUnspecified0d7_KjU5);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final TopAppBarColors getDefaultCenterAlignedTopAppBarColors$material3_release(ColorScheme colorScheme) {
        ...
        if (defaultCenterAlignedTopAppBarColorsCached == null) {
            ...
            if (Color.m3415equalsimpl0(ColorSchemeKt.fromToken(colorScheme, TopAppBarSmallCenteredTokens.INSTANCE.getContainerColor()), colorScheme.getSurface())) {
                jFromToken = ColorSchemeKt.m1406surfaceColorAtElevation3ABfNKs(colorScheme, TopAppBarSmallTokens.INSTANCE.m2870getOnScrollContainerElevationD9Ej5fM());
            } else {
    ...
    public final TopAppBarColors m2287mediumTopAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
    ...
    public final TopAppBarColors getDefaultMediumTopAppBarColors$material3_release(ColorScheme colorScheme) {
        ...
        if (defaultMediumTopAppBarColorsCached == null) {
            ...
            if (Color.m3415equalsimpl0(ColorSchemeKt.fromToken(colorScheme, TopAppBarMediumTokens.INSTANCE.getContainerColor()), colorScheme.getSurface())) {
                jFromToken = ColorSchemeKt.m1406surfaceColorAtElevation3ABfNKs(colorScheme, TopAppBarSmallTokens.INSTANCE.m2870getOnScrollContainerElevationD9Ej5fM());
            } else {
    ...
    public final TopAppBarColors m2286largeTopAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
        ...
        TopAppBarColors topAppBarColorsM2279copyt635Npw = getDefaultLargeTopAppBarColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2279copyt635Npw(jM3450getUnspecified0d7_KjU, jM3450getUnspecified0d7_KjU2, jM3450getUnspecified0d7_KjU3, jM3450getUnspecified0d7_KjU4, jM3450getUnspecified0d7_KjU5);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final TopAppBarColors getDefaultLargeTopAppBarColors$material3_release(ColorScheme colorScheme) {
        ...
        if (defaultLargeTopAppBarColorsCached == null) {
            ...
            if (Color.m3415equalsimpl0(ColorSchemeKt.fromToken(colorScheme, TopAppBarLargeTokens.INSTANCE.getContainerColor()), colorScheme.getSurface())) {
                jFromToken = ColorSchemeKt.m1406surfaceColorAtElevation3ABfNKs(colorScheme, TopAppBarSmallTokens.INSTANCE.m2870getOnScrollContainerElevationD9Ej5fM());
            } else {
