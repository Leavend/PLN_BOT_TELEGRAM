...
public final class DateInputKt {
    ...
    public static final void DateInputContent(final Long l, final Function1<? super Long, Unit> function1, final CalendarModel calendarModel, final IntRange intRange, final DatePickerFormatter datePickerFormatter, final SelectableDates selectableDates, final DatePickerColors datePickerColors, Composer composer, final int i) {
        ...
        if ((599187 & i4) != 599186 || !composerStartRestartGroup.getSkipping()) {
            ...
            String strM1972getStringNWtq28 = Strings_androidKt.m1972getStringNWtq28(Strings.m1903constructorimpl(R.string.m3c_date_input_invalid_for_pattern), composerStartRestartGroup, 0);
            Strings.Companion companion2 = Strings.INSTANCE;
            String strM1972getStringNWtq282 = Strings_androidKt.m1972getStringNWtq28(Strings.m1903constructorimpl(R.string.m3c_date_input_invalid_year_range), composerStartRestartGroup, 0);
            Strings.Companion companion3 = Strings.INSTANCE;
            String strM1972getStringNWtq283 = Strings_androidKt.m1972getStringNWtq28(Strings.m1903constructorimpl(R.string.m3c_date_input_invalid_not_allowed), composerStartRestartGroup, 0);
            ...
            if (zChanged2 || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                ...
                i3 = i4;
                r13 = 1;
                DateInputValidator dateInputValidator = new DateInputValidator(intRange, selectableDates, dateInputFormat2, datePickerFormatter, strM1972getStringNWtq28, strM1972getStringNWtq282, strM1972getStringNWtq283, "", null, null, 768, null);
            ...
            final String strM1972getStringNWtq284 = Strings_androidKt.m1972getStringNWtq28(Strings.m1903constructorimpl(R.string.m3c_date_input_label), composer2, 0);
            ...
            int iM1624getSingleDateInputJ2x2o4M = InputIdentifier.INSTANCE.m1624getSingleDateInputJ2x2o4M();
            ...
            ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer2, -1819015125, r13, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt.DateInputContent.2
                ...
                public final void invoke(Composer composer4, int i5) {
                    ...
                    String str = strM1972getStringNWtq284;
                    Modifier.Companion companion5 = Modifier.INSTANCE;
                    composer4.startReplaceableGroup(-694340528);
                    ComposerKt.sourceInformation(composer4, "CC(remember):DateInput.kt#9igjgp");
                    boolean zChanged3 = composer4.changed(strM1972getStringNWtq284) | composer4.changed(upperCase);
                    final String str2 = strM1972getStringNWtq284;
                    ...
                    TextKt.m2130Text4IGK_g(str, SemanticsModifierKt.semantics$default(companion5, false, (Function1) objRememberedValue3, 1, null), 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer4, 0, 0, 131068);
                    if (ComposerKt.isTraceInProgress()) {
            ...
            ComposableLambda composableLambda2 = ComposableLambdaKt.composableLambda(composer2, -564233108, r13, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt.DateInputContent.3
                ...
                public final void invoke(Composer composer4, int i5) {
                    ...
                    TextKt.m2130Text4IGK_g(upperCase, SemanticsModifierKt.clearAndSetSemantics(Modifier.INSTANCE, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateInputKt.DateInputContent.3.1
                        /* renamed from: invoke, reason: avoid collision after fix types in other method */
                        public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                        }
            ...
            int i5 = i3 << 3;
            composer3 = composer2;
            m1450DateInputTextFieldtQNruF0(modifierPadding, l, function1, calendarModel, composableLambda, composableLambda2, iM1624getSingleDateInputJ2x2o4M, dateInputValidator2, dateInputFormat, locale, datePickerColors, composer2, (i5 & 112) | 1794054 | (i5 & 896) | (i5 & 7168), (i3 >> 18) & 14);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public static final void m1450DateInputTextFieldtQNruF0(final Modifier modifier, final Long l, final Function1<? super Long, Unit> function1, final CalendarModel calendarModel, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final int i, final DateInputValidator dateInputValidator, final DateInputFormat dateInputFormat, final Locale locale, final DatePickerColors datePickerColors, Composer composer, final int i2, final int i3) {
        ...
        if ((i4 & 306783379) != 306783378 || (i5 & 3) != 2 || !composerStartRestartGroup.getSkipping()) {
            ...
            int i6 = i4;
            final MutableState mutableState = (MutableState) RememberSaveableKt.m3031rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<MutableState<String>>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$errorText$1
            ...
            ComposerKt.sourceInformation(composerStartRestartGroup, "CC(remember):DateInput.kt#9igjgp");
            boolean zChanged = (i7 == 67108864) | composerStartRestartGroup.changed(mutableStateRememberSaveable) | composerStartRestartGroup.changed(mutableState) | ((i6 & 896) == 256) | composerStartRestartGroup.changedInstance(calendarModel) | ((i6 & 29360128) == 8388608) | ((i6 & 3670016) == 1048576) | composerStartRestartGroup.changedInstance(locale);
            Object objRememberedValue2 = composerStartRestartGroup.rememberedValue();
                    ...
                    public final void invoke2(TextFieldValue textFieldValue) {
                        ...
                        if (textFieldValue.getText().length() <= dateInputFormat.getPatternWithoutDelimiters().length()) {
                            ...
                            if (z) {
                                ...
                                mutableState.setValue(dateInputValidator.m1451validateXivgLIo(calendarDate, i, locale));
            ...
            if (!(!StringsKt.isBlank((CharSequence) mutableState.getValue()))) {
                fM5735constructorimpl = InputTextNonErroneousBottomPadding;
            } else {
                fM5735constructorimpl = Dp.m5735constructorimpl(0);
            }
            Modifier modifierM569paddingqDBjuR0$default = PaddingKt.m569paddingqDBjuR0$default(modifier, 0.0f, 0.0f, 0.0f, fM5735constructorimpl, 7, null);
            ...
            composerStartRestartGroup.endReplaceableGroup();
            int i8 = i6 << 6;
            OutlinedTextFieldKt.OutlinedTextField(textFieldValueDateInputTextField_tQNruF0$lambda$4, (Function1<? super TextFieldValue, Unit>) function12, SemanticsModifierKt.semantics$default(modifierM569paddingqDBjuR0$default, false, (Function1) objRememberedValue3, 1, null), false, false, (TextStyle) null, function2, function22, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.composableLambda(composerStartRestartGroup, -591991974, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$3
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                }
                ...
                public final void invoke(Composer composer2, int i9) {
                    ...
                    if (!StringsKt.isBlank(mutableState.getValue())) {
                        TextKt.m2130Text4IGK_g(mutableState.getValue(), (Modifier) null, 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer2, 0, 0, 131070);
                    }
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                }
            }), !StringsKt.isBlank((CharSequence) mutableState.getValue()), (VisualTransformation) new DateVisualTransformation(dateInputFormat), new KeyboardOptions(0, false, KeyboardType.INSTANCE.m5463getNumberPjHm6EE(), ImeAction.INSTANCE.m5413getDoneeUduSuo(), null, 17, null), (KeyboardActions) null, true, 0, 0, (MutableInteractionSource) null, (Shape) null, datePickerColors.getDateTextFieldColors(), composerStartRestartGroup, (i8 & 3670016) | (i8 & 29360128), 12779904, 0, 4001592);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateInputKt$DateInputTextField$4
                ...
                public final void invoke(Composer composer2, int i9) {
                    DateInputKt.m1450DateInputTextFieldtQNruF0(modifier, l, function1, calendarModel, function2, function22, i, dateInputValidator, dateInputFormat, locale, datePickerColors, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), RecomposeScopeImplKt.updateChangedFlags(i3));
                }
            });
        }
    }
    ...
    static {
        float f = 24;
        InputTextFieldPadding = PaddingKt.m562PaddingValuesa9UjIt4$default(Dp.m5735constructorimpl(f), Dp.m5735constructorimpl(10), Dp.m5735constructorimpl(f), 0.0f, 8, null);
    }
}
