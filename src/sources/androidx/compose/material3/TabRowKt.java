...
public final class TabRowKt {
    private static final float ScrollableTabRowMinimumTabWidth = Dp.m5735constructorimpl(90);
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m2036SecondaryTabRowpAZo6Ak(final int r21, androidx.compose.ui.Modifier r22, long r23, long r25, kotlin.jvm.functions.Function3<? super androidx.compose.material3.TabIndicatorScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r27, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r28, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r29, androidx.compose.runtime.Composer r30, final int r31, final int r32) {
        /*
            Method dump skipped, instructions count: 432
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TabRowKt.m2036SecondaryTabRowpAZo6Ak(int, androidx.compose.ui.Modifier, long, long, kotlin.jvm.functions.Function3, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    */
    ...
    public static final void m2038TabRowImplDTcfvLk(final Modifier modifier, final long j, final long j2, final Function3<? super TabIndicatorScope, ? super Composer, ? super Integer, Unit> function3, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, Composer composer, final int i) {
        ...
        if ((74899 & i2) != 74898 || !composerStartRestartGroup.getSkipping()) {
            ...
            int i3 = i2 << 3;
            SurfaceKt.m1982SurfaceT9BRK9s(SelectableGroupKt.selectableGroup(modifier), null, j, j2, 0.0f, 0.0f, null, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -65106680, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabRowKt$TabRowImpl$1
                    ...
                    if ((i4 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        if (objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                            objRememberedValue2 = (MultiContentMeasurePolicy) new MultiContentMeasurePolicy() { // from class: androidx.compose.material3.TabRowKt$TabRowImpl$1$2$1
                                ...
                                public final MeasureResult mo1650measure3p2s80s(MeasureScope measureScope, List<? extends List<? extends Measurable>> list, long j3) {
                                    MeasureScope measureScope2 = measureScope;
                                    List<? extends Measurable> list2 = list.get(0);
                                    List<? extends Measurable> list3 = list.get(1);
                                    int i5 = 2;
                                    List<? extends Measurable> list4 = list.get(2);
                                    int iM5691getMaxWidthimpl = Constraints.m5691getMaxWidthimpl(j3);
                                    int size = list2.size();
                                    final Ref.IntRef intRef = new Ref.IntRef();
                                    if (size > 0) {
                                        intRef.element = iM5691getMaxWidthimpl / size;
                                    }
                                    int iValueOf = 0;
                                    ...
                                    int i7 = 0;
                                    while (i7 < size) {
                                        arrayList.add(new TabPosition(Dp.m5735constructorimpl(measureScope2.mo313toDpu2uoSUM(intRef.element) * i7), measureScope2.mo313toDpu2uoSUM(intRef.element), ((Dp) ComparisonsKt.maxOf(Dp.m5733boximpl(Dp.m5735constructorimpl(measureScope2.mo313toDpu2uoSUM(Math.min(list2.get(i7).maxIntrinsicWidth(iIntValue), intRef.element)) - Dp.m5735constructorimpl(TabKt.getHorizontalTextPadding() * i5))), Dp.m5733boximpl(Dp.m5735constructorimpl(24)))).m5749unboximpl(), null));
                                        i7++;
                                    ...
                                    for (int i8 = 0; i8 < size3; i8++) {
                                        arrayList2.add(list2.get(i8).mo4684measureBRTryo0(Constraints.m5681copyZbe2FdA(j3, intRef.element, intRef.element, iIntValue, iIntValue)));
                                    }
                                    final ArrayList arrayList3 = arrayList2;
                                    ArrayList arrayList4 = new ArrayList(list3.size());
                                    int size4 = list3.size();
                                    for (int i9 = 0; i9 < size4; i9++) {
                                        arrayList4.add(list3.get(i9).mo4684measureBRTryo0(Constraints.m5682copyZbe2FdA$default(j3, 0, 0, 0, 0, 11, null)));
                                    }
                                    final ArrayList arrayList5 = arrayList4;
                                    ArrayList arrayList6 = new ArrayList(list4.size());
                                    int size5 = list4.size();
                                    for (int i10 = 0; i10 < size5; i10++) {
                                        arrayList6.add(list4.get(i10).mo4684measureBRTryo0(Constraints.m5682copyZbe2FdA$default(j3, intRef.element, intRef.element, 0, iIntValue, 4, null)));
                                    }
                                    final ArrayList arrayList7 = arrayList6;
                                    return MeasureScope.layout$default(measureScope, iM5691getMaxWidthimpl, iIntValue, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TabRowKt$TabRowImpl$1$2$1.2
                                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                        /* JADX WARN: Multi-variable type inference failed */
                                        {
                                            super(1);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabRowKt$TabRowImpl$2
                ...
                public final void invoke(Composer composer2, int i4) {
                    TabRowKt.m2038TabRowImplDTcfvLk(modifier, j, j2, function3, function2, function22, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
    ...
    public static final void m2039TabRowWithSubcomposeImplDTcfvLk(final Modifier modifier, final long j, final long j2, final Function3<? super List<TabPosition>, ? super Composer, ? super Integer, Unit> function3, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, Composer composer, final int i) {
        ...
        if ((74899 & i2) != 74898 || !composerStartRestartGroup.getSkipping()) {
            ...
            int i3 = i2 << 3;
            SurfaceKt.m1982SurfaceT9BRK9s(SelectableGroupKt.selectableGroup(modifier), null, j, j2, 0.0f, 0.0f, null, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1617702432, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabRowKt$TabRowWithSubcomposeImpl$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                    ...
                    if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                        objRememberedValue = (Function2) new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material3.TabRowKt$TabRowWithSubcomposeImpl$1$1$1
                            ...
                            public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeMeasureScope subcomposeMeasureScope, Constraints constraints) {
                                return m2045invoke0kLqBqw(subcomposeMeasureScope, constraints.getValue());
                            }

                            /* renamed from: invoke-0kLqBqw, reason: not valid java name */
                            public final MeasureResult m2045invoke0kLqBqw(final SubcomposeMeasureScope subcomposeMeasureScope, final long j3) {
                                ...
                                for (int i6 = 0; i6 < size3; i6++) {
                                    arrayList.add(listSubcompose.get(i6).mo4684measureBRTryo0(Constraints.m5681copyZbe2FdA(j3, intRef.element, intRef.element, iIntValue, iIntValue)));
                                }
                                final ArrayList arrayList2 = arrayList;
                                ArrayList arrayList3 = new ArrayList(size);
                                for (int i7 = 0; i7 < size; i7++) {
                                    arrayList3.add(new TabPosition(Dp.m5735constructorimpl(subcomposeMeasureScope.mo313toDpu2uoSUM(intRef.element) * i7), subcomposeMeasureScope.mo313toDpu2uoSUM(intRef.element), ((Dp) ComparisonsKt.maxOf(Dp.m5733boximpl(Dp.m5735constructorimpl(subcomposeMeasureScope.mo313toDpu2uoSUM(Math.min(listSubcompose.get(i7).maxIntrinsicWidth(iIntValue), intRef.element)) - Dp.m5735constructorimpl(TabKt.getHorizontalTextPadding() * 2))), Dp.m5733boximpl(Dp.m5735constructorimpl(24)))).m5749unboximpl(), null));
                                }
                                final ArrayList arrayList4 = arrayList3;
                                final Function2<Composer, Integer, Unit> function25 = function24;
                                final Function3<List<TabPosition>, Composer, Integer, Unit> function33 = function32;
                                return MeasureScope.layout$default(subcomposeMeasureScope, iM5691getMaxWidthimpl, iIntValue, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TabRowKt$TabRowWithSubcomposeImpl$1$1$1.1
                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                    /* JADX WARN: Multi-variable type inference failed */
                                    {
                                        super(1);
                                    ...
                                    public final void invoke2(Placeable.PlacementScope placementScope) {
                                        ...
                                        for (int i10 = 0; i10 < size5; i10++) {
                                            Placeable placeableMo4684measureBRTryo0 = listSubcompose2.get(i10).mo4684measureBRTryo0(Constraints.m5682copyZbe2FdA$default(j4, 0, 0, 0, 0, 11, null));
                                            Placeable.PlacementScope.placeRelative$default(placementScope, placeableMo4684measureBRTryo0, 0, i9 - placeableMo4684measureBRTryo0.getHeight(), 0.0f, 4, null);
                                        }
                                        ...
                                        int i11 = iM5691getMaxWidthimpl;
                                        int i12 = iIntValue;
                                        int size6 = listSubcompose3.size();
                                        for (int i13 = 0; i13 < size6; i13++) {
                                            Placeable.PlacementScope.placeRelative$default(placementScope, listSubcompose3.get(i13).mo4684measureBRTryo0(Constraints.INSTANCE.m5699fixedJhjzzOo(i11, i12)), 0, 0, 0.0f, 4, null);
                                        }
                                    }
                                }, 4, null);
                            }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabRowKt$TabRowWithSubcomposeImpl$2
                ...
                public final void invoke(Composer composer2, int i4) {
                    TabRowKt.m2039TabRowWithSubcomposeImplDTcfvLk(modifier, j, j2, function3, function2, function22, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m2035SecondaryScrollableTabRowqhFBPw4(final int r28, androidx.compose.ui.Modifier r29, androidx.compose.foundation.ScrollState r30, long r31, long r33, float r35, kotlin.jvm.functions.Function3<? super java.util.List<androidx.compose.material3.TabPosition>, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r36, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r37, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r38, androidx.compose.runtime.Composer r39, final int r40, final int r41) {
        /*
            Method dump skipped, instructions count: 608
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TabRowKt.m2035SecondaryScrollableTabRowqhFBPw4(int, androidx.compose.ui.Modifier, androidx.compose.foundation.ScrollState, long, long, float, kotlin.jvm.functions.Function3, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, androidx.compose.runtime.Composer, int, int):void");
    }
