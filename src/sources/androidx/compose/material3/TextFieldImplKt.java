...
public final class TextFieldImplKt {
    ...
    private static final float HorizontalIconPadding = Dp.m5735constructorimpl(12);
    private static final float SupportingTopPadding = Dp.m5735constructorimpl(4);
    private static final float PrefixSuffixTextPadding = Dp.m5735constructorimpl(2);
    private static final float MinTextLineHeight = Dp.m5735constructorimpl(24);
    ...
    /* JADX WARN: Removed duplicated region for block: B:234:0x02b4  */
    ...
    */
    ...
    public static final void m2120DecorationKTwxG1Y(final long j, TextStyle textStyle, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i, final int i2) {
        int i3;
        ...
        if ((i3 & 147) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1449369305, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextFieldImplKt$Decoration$contentWithColor$1
                ...
                public final void invoke(Composer composer2, int i5) {
                    ...
                    if ((i5 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m3404boximpl(j)), function2, composer2, ProvidedValue.$stable | 0);
                        if (ComposerKt.isTraceInProgress()) {
            ...
            if (textStyle != null) {
                ...
                ProvideContentColorTextStyleKt.m1769ProvideContentColorTextStyle3JVO9M(j, textStyle, function2, composerStartRestartGroup, (i3 & 14) | (i3 & 112) | (i3 & 896));
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TextFieldImplKt$Decoration$1
                ...
                public final void invoke(Composer composer2, int i5) {
                    TextFieldImplKt.m2120DecorationKTwxG1Y(j, textStyle2, function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
    }
    ...
    static {
        float f = 16;
        TextFieldPadding = Dp.m5735constructorimpl(f);
        MinFocusedLabelLineHeight = Dp.m5735constructorimpl(f);
        MinSupportingTextLineHeight = Dp.m5735constructorimpl(f);
        float f2 = 48;
        IconDefaultSizeModifier = SizeKt.m598defaultMinSizeVpY3zN4(Modifier.INSTANCE, Dp.m5735constructorimpl(f2), Dp.m5735constructorimpl(f2));
    }
