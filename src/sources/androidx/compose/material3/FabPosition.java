...
public final class FabPosition {
    ...
    private static final int Start = m1554constructorimpl(0);
    private static final int Center = m1554constructorimpl(1);
    private static final int End = m1554constructorimpl(2);
    private static final int EndOverlay = m1554constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FabPosition m1553boximpl(int i) {
    ...
    public boolean equals(Object obj) {
        return m1555equalsimpl(this.value, obj);
    }
    ...
    public static String m1558toStringimpl(int i) {
        return m1556equalsimpl0(i, Start) ? "FabPosition.Start" : m1556equalsimpl0(i, Center) ? "FabPosition.Center" : m1556equalsimpl0(i, End) ? "FabPosition.End" : "FabPosition.EndOverlay";
    }
}
