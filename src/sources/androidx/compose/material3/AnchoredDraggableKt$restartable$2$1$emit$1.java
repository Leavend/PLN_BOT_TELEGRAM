...
final class AnchoredDraggableKt$restartable$2$1$emit$1 extends ContinuationImpl {
    ...
    final /* synthetic */ AnchoredDraggableKt.C04982.AnonymousClass1<T> this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    AnchoredDraggableKt$restartable$2$1$emit$1(AnchoredDraggableKt.C04982.AnonymousClass1<? super T> anonymousClass1, Continuation<? super AnchoredDraggableKt$restartable$2$1$emit$1> continuation) {
        super(continuation);
