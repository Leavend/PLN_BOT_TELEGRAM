...
public final class SegmentedButtonContentMeasurePolicy implements MultiContentMeasurePolicy {
    ...
    public MeasureResult mo1650measure3p2s80s(final MeasureScope measureScope, List<? extends List<? extends Measurable>> list, long j) {
        Object obj;
        Object obj2;
        Object obj3;
        ...
        for (int i2 = 0; i2 < size; i2++) {
            arrayList.add(list2.get(i2).mo4684measureBRTryo0(j));
        }
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            arrayList3.add(list3.get(i4).mo4684measureBRTryo0(j));
        }
        ...
        int iMax = Math.max(measureScope.mo310roundToPx0680j_4(SegmentedButtonDefaults.INSTANCE.m1829getIconSizeD9Ej5fM()), width3) + measureScope.mo310roundToPx0680j_4(SegmentedButtonKt.IconSpacing) + (numValueOf != null ? numValueOf.intValue() : 0);
        int i6 = width3 == 0 ? (-(measureScope.mo310roundToPx0680j_4(SegmentedButtonDefaults.INSTANCE.m1829getIconSizeD9Ej5fM()) + measureScope.mo310roundToPx0680j_4(SegmentedButtonKt.IconSpacing))) / 2 : 0;
        ...
        return MeasureScope.layout$default(measureScope, iMax, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.SegmentedButtonContentMeasurePolicy$measure$2
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                int i11 = measureScope.mo310roundToPx0680j_4(SegmentedButtonDefaults.INSTANCE.m1829getIconSizeD9Ej5fM()) + measureScope.mo310roundToPx0680j_4(SegmentedButtonKt.IconSpacing);
