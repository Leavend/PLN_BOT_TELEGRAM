    ...
    */
    ...
    public static final void m1345ChipnkUnTEs(final Modifier modifier, final Function0<Unit> function0, final boolean z, final Function2<? super Composer, ? super Integer, Unit> function2, final TextStyle textStyle, final long j, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Shape shape, final ChipColors chipColors, final ChipElevation chipElevation, final BorderStroke borderStroke, final float f, final PaddingValues paddingValues, final MutableInteractionSource mutableInteractionSource, Composer composer, final int i, final int i2) {
        ...
        if ((306783379 & i6) != 306783378 || (i4 & 9363) != 9362 || !composerStartRestartGroup.getSkipping()) {
            ...
            long jM1325containerColorvNxB06k$material3_release = chipColors.m1325containerColorvNxB06k$material3_release(z);
            if (chipElevation != null) {
                fM5735constructorimpl = chipElevation.m1344tonalElevationu2uoSUM$material3_release(z);
            } else {
                fM5735constructorimpl = Dp.m5735constructorimpl(0);
            }
            float f2 = fM5735constructorimpl;
            ...
            SurfaceKt.m1985Surfaceo_FOJdg(function0, modifierSemantics$default, z, shape, jM1325containerColorvNxB06k$material3_release, 0L, f2, stateShadowElevation$material3_release != null ? stateShadowElevation$material3_release.getValue().m5749unboximpl() : Dp.m5735constructorimpl(0), borderStroke, mutableInteractionSource, ComposableLambdaKt.composableLambda(composer2, -1985962652, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ChipKt$Chip$2
                ...
                public final void invoke(Composer composer3, int i8) {
                    ...
                    if ((i8 & 3) != 2 || !composer3.getSkipping()) {
                        ...
                        ChipKt.m1346ChipContentfe0OD_I(function2, textStyle, j, function22, null, function23, chipColors.m1336leadingIconContentColorvNxB06k$material3_release(z), chipColors.m1337trailingIconContentColorvNxB06k$material3_release(z), f, paddingValues, composer3, 24576);
                        if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ChipKt$Chip$3
                ...
                public final void invoke(Composer composer3, int i8) {
                    ChipKt.m1345ChipnkUnTEs(modifier, function0, z, function2, textStyle, j, function22, function23, shape, chipColors, chipElevation, borderStroke, f, paddingValues, mutableInteractionSource, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1), RecomposeScopeImplKt.updateChangedFlags(i2));
                }
            });
        }
    }
    ...
    public static final void m1347SelectableChipu0RnIRE(final boolean z, final Modifier modifier, final Function0<Unit> function0, final boolean z2, final Function2<? super Composer, ? super Integer, Unit> function2, final TextStyle textStyle, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final Shape shape, final SelectableChipColors selectableChipColors, final SelectableChipElevation selectableChipElevation, final BorderStroke borderStroke, final float f, final PaddingValues paddingValues, final MutableInteractionSource mutableInteractionSource, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 306783379) != 306783378 || (74899 & i4) != 74898 || !composerStartRestartGroup.getSkipping()) {
            ...
            Modifier modifierSemantics$default = SemanticsModifierKt.semantics$default(modifier, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.ChipKt$SelectableChip$1
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                    SemanticsPropertiesKt.m5079setRolekuIjeqM(semanticsPropertyReceiver, Role.INSTANCE.m5064getCheckboxo7Vup1c());
                }
            }, 1, null);
            int i5 = (i3 >> 9) & 14;
            long jM3424unboximpl = selectableChipColors.containerColor$material3_release(z2, z, composerStartRestartGroup, ((i3 << 3) & 112) | i5 | ((i4 << 6) & 896)).getValue().m3424unboximpl();
            if (selectableChipElevation != null) {
                fM5735constructorimpl = selectableChipElevation.m1844tonalElevationu2uoSUM$material3_release(z2);
            } else {
                fM5735constructorimpl = Dp.m5735constructorimpl(0);
            }
            float f2 = fM5735constructorimpl;
            ...
            int i7 = i4;
            composer2 = composerStartRestartGroup;
            SurfaceKt.m1983Surfaced85dljk(z, function0, modifierSemantics$default, z2, shape, jM3424unboximpl, 0L, f2, stateShadowElevation$material3_release != null ? stateShadowElevation$material3_release.getValue().m5749unboximpl() : Dp.m5735constructorimpl(0), borderStroke, mutableInteractionSource, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -577614814, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ChipKt$SelectableChip$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                public final void invoke(Composer composer3, int i8) {
                    ...
                    if ((i8 & 3) != 2 || !composer3.getSkipping()) {
                        ...
                        ChipKt.m1346ChipContentfe0OD_I(function2, textStyle, selectableChipColors.m1835labelColorWaAFU9c$material3_release(z2, z), function22, function23, function24, selectableChipColors.m1836leadingIconContentColorWaAFU9c$material3_release(z2, z), selectableChipColors.m1837trailingIconContentColorWaAFU9c$material3_release(z2, z), f, paddingValues, composer3, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ChipKt$SelectableChip$3
                ...
                public final void invoke(Composer composer3, int i8) {
                    ChipKt.m1347SelectableChipu0RnIRE(z, modifier, function0, z2, function2, textStyle, function22, function23, function24, shape, selectableChipColors, selectableChipElevation, borderStroke, f, paddingValues, mutableInteractionSource, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1), RecomposeScopeImplKt.updateChangedFlags(i2));
                }
            });
        }
    }
    ...
    public static final void m1346ChipContentfe0OD_I(final Function2<? super Composer, ? super Integer, Unit> function2, final TextStyle textStyle, final long j, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final long j2, final long j3, final float f, final PaddingValues paddingValues, Composer composer, final int i) {
        ...
        if ((i3 & 306783379) != 306783378 || !composerStartRestartGroup.getSkipping()) {
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m3404boximpl(j)), TextKt.getLocalTextStyle().provides(textStyle)}, ComposableLambdaKt.composableLambda(composerStartRestartGroup, 1748799148, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ChipKt$ChipContent$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(2);
                ...
                public final void invoke(Composer composer2, int i4) {
                    ...
                    if ((i4 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        Modifier modifierPadding = PaddingKt.padding(SizeKt.m599defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, 0.0f, f, 1, null), paddingValues);
                        AnonymousClass1 anonymousClass1 = new MeasurePolicy() { // from class: androidx.compose.material3.ChipKt$ChipContent$1.1
                            ...
                            public final MeasureResult mo37measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j5) {
                                ...
                                final Placeable placeableMo4684measureBRTryo0 = measurable3 != null ? measurable3.mo4684measureBRTryo0(Constraints.m5682copyZbe2FdA$default(j5, 0, 0, 0, 0, 10, null)) : null;
                                final int iWidthOrZero = TextFieldImplKt.widthOrZero(placeableMo4684measureBRTryo0);
                                final int iHeightOrZero = TextFieldImplKt.heightOrZero(placeableMo4684measureBRTryo0);
                                int size2 = list.size();
                                int i6 = 0;
                                while (true) {
                                    if (i6 >= size2) {
                                ...
                                final Placeable placeableMo4684measureBRTryo02 = measurable4 != null ? measurable4.mo4684measureBRTryo0(Constraints.m5682copyZbe2FdA$default(j5, 0, 0, 0, 0, 10, null)) : null;
                                int iWidthOrZero2 = TextFieldImplKt.widthOrZero(placeableMo4684measureBRTryo02);
                                final int iHeightOrZero2 = TextFieldImplKt.heightOrZero(placeableMo4684measureBRTryo02);
                                int size3 = list.size();
                                for (int i7 = 0; i7 < size3; i7++) {
                                    ...
                                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable5), Constants.ScionAnalytics.PARAM_LABEL)) {
                                        final Placeable placeableMo4684measureBRTryo03 = measurable5.mo4684measureBRTryo0(ConstraintsKt.m5708offsetNN6EwU$default(j5, -(iWidthOrZero + iWidthOrZero2), 0, 2, null));
                                        int width = placeableMo4684measureBRTryo03.getWidth() + iWidthOrZero + iWidthOrZero2;
                                        final int iMax = Math.max(iHeightOrZero, Math.max(placeableMo4684measureBRTryo03.getHeight(), iHeightOrZero2));
                                        return MeasureScope.layout$default(measureScope, width, iMax, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.ChipKt.ChipContent.1.1.1
                                            ...
                                            public final void invoke2(Placeable.PlacementScope placementScope) {
                                                ...
                                                Placeable.PlacementScope.placeRelative$default(placementScope, placeableMo4684measureBRTryo03, iWidthOrZero, 0, 0.0f, 4, null);
                                                Placeable placeable2 = placeableMo4684measureBRTryo02;
                                                if (placeable2 != null) {
                                                    Placeable.PlacementScope.placeRelative$default(placementScope, placeable2, placeableMo4684measureBRTryo03.getWidth() + iWidthOrZero, Alignment.INSTANCE.getCenterVertically().align(iHeightOrZero2, iMax), 0.0f, 4, null);
                                                }
                                            }
                                        }, 4, null);
                                    }
                        ...
                        Updater.m2951setimpl(composerM2944constructorimpl, anonymousClass1, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                        ...
                        if (function25 == null && function26 == null) {
                            ...
                            if (function25 != null) {
                                ...
                                CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m3404boximpl(j5)), function26, composer2, ProvidedValue.$stable | 0);
                                composer2.endReplaceableGroup();
                            } else {
                        ...
                        composer2.endReplaceableGroup();
                        Modifier modifierM566paddingVpY3zN4 = PaddingKt.m566paddingVpY3zN4(LayoutIdKt.layoutId(Modifier.INSTANCE, Constants.ScionAnalytics.PARAM_LABEL), ChipKt.HorizontalElementsPadding, Dp.m5735constructorimpl(0));
                        ...
                        Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> function3ModifierMaterializerOf3 = LayoutKt.modifierMaterializerOf(modifierM566paddingVpY3zN4);
                        if (!(composer2.getApplier() instanceof Applier)) {
                            ComposablesKt.invalidApplier();
                        }
                        composer2.startReusableNode();
                        ...
                        if (function27 != null) {
                            ...
                            Composer composerM2944constructorimpl4 = Updater.m2944constructorimpl(composer2);
                            Updater.m2951setimpl(composerM2944constructorimpl4, measurePolicyRememberBoxMeasurePolicy2, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                            ...
                            function3ModifierMaterializerOf4.invoke(SkippableUpdater.m2935boximpl(SkippableUpdater.m2936constructorimpl(composer2)), composer2, 0);
                            composer2.startReplaceableGroup(2058660585);
                            ComposerKt.sourceInformationMarkerStart(composer2, -1253629263, "C73@3426L9:Box.kt#2w3rfo");
                            BoxScopeInstance boxScopeInstance2 = BoxScopeInstance.INSTANCE;
                            ComposerKt.sourceInformationMarkerStart(composer2, 1725998433, "C1988@97800L188:Chip.kt#uh7d8r");
                            CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m3404boximpl(j4)), function27, composer2, ProvidedValue.$stable | 0);
                            ComposerKt.sourceInformationMarkerEnd(composer2);
                            ComposerKt.sourceInformationMarkerEnd(composer2);
                            composer2.endReplaceableGroup();
                            composer2.endNode();
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ChipKt$ChipContent$2
                ...
                public final void invoke(Composer composer2, int i4) {
                    ChipKt.m1346ChipContentfe0OD_I(function2, textStyle, j, function22, function23, function24, j2, j3, f, paddingValues, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
    ...
    public static final ChipColors getDefaultSuggestionChipColors(ColorScheme colorScheme) {
        ...
        ChipColors chipColors = new ChipColors(Color.INSTANCE.m3449getTransparent0d7_KjU(), ColorSchemeKt.fromToken(colorScheme, SuggestionChipTokens.INSTANCE.getLabelTextColor()), ColorSchemeKt.fromToken(colorScheme, SuggestionChipTokens.INSTANCE.getLeadingIconColor()), Color.INSTANCE.m3450getUnspecified0d7_KjU(), Color.INSTANCE.m3449getTransparent0d7_KjU(), Color.m3413copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, SuggestionChipTokens.INSTANCE.getDisabledLabelTextColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), Color.m3413copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, SuggestionChipTokens.INSTANCE.getDisabledLeadingIconColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), Color.INSTANCE.m3450getUnspecified0d7_KjU(), null);
    ...
    private static final PaddingValues inputChipPadding(boolean z, boolean z2, boolean z3) {
        return PaddingKt.m562PaddingValuesa9UjIt4$default(Dp.m5735constructorimpl((z || !z2) ? 4 : 8), 0.0f, Dp.m5735constructorimpl(z3 ? 8 : 4), 0.0f, 10, null);
    }

    static {
        float fM5735constructorimpl = Dp.m5735constructorimpl(8);
        HorizontalElementsPadding = fM5735constructorimpl;
        AssistChipPadding = PaddingKt.m560PaddingValuesYgX7TsA$default(fM5735constructorimpl, 0.0f, 2, null);
        FilterChipPadding = PaddingKt.m560PaddingValuesYgX7TsA$default(fM5735constructorimpl, 0.0f, 2, null);
        SuggestionChipPadding = PaddingKt.m560PaddingValuesYgX7TsA$default(fM5735constructorimpl, 0.0f, 2, null);
    }
}
