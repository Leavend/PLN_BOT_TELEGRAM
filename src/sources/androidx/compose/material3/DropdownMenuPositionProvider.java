...
public final /* data */ class DropdownMenuPositionProvider implements PopupPositionProvider {
    ...
    public static /* synthetic */ DropdownMenuPositionProvider m1539copyuVxBXkw$default(DropdownMenuPositionProvider dropdownMenuPositionProvider, long j, Density density, int i, Function2 function2, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return dropdownMenuPositionProvider.m1541copyuVxBXkw(j2, density2, i3, function2);
    }
    ...
    public final DropdownMenuPositionProvider m1541copyuVxBXkw(long contentOffset, Density density, int verticalMargin, Function2<? super IntRect, ? super IntRect, Unit> onPositionCalculated) {
    ...
    public boolean equals(Object other) {
        ...
        return DpOffset.m5795equalsimpl0(this.contentOffset, dropdownMenuPositionProvider.contentOffset) && Intrinsics.areEqual(this.density, dropdownMenuPositionProvider.density) && this.verticalMargin == dropdownMenuPositionProvider.verticalMargin && Intrinsics.areEqual(this.onPositionCalculated, dropdownMenuPositionProvider.onPositionCalculated);
    }

    public int hashCode() {
        return (((((DpOffset.m5800hashCodeimpl(this.contentOffset) * 31) + this.density.hashCode()) * 31) + Integer.hashCode(this.verticalMargin)) * 31) + this.onPositionCalculated.hashCode();
    }

    public String toString() {
        return "DropdownMenuPositionProvider(contentOffset=" + ((Object) DpOffset.m5803toStringimpl(this.contentOffset)) + ", density=" + this.density + ", verticalMargin=" + this.verticalMargin + ", onPositionCalculated=" + this.onPositionCalculated + ')';
    }
    ...
    private DropdownMenuPositionProvider(long j, Density density, int i, Function2<? super IntRect, ? super IntRect, Unit> function2) {
        ...
        int iMo310roundToPx0680j_4 = density.mo310roundToPx0680j_4(DpOffset.m5796getXD9Ej5fM(j));
        this.startToAnchorStart = MenuPosition.INSTANCE.startToAnchorStart(iMo310roundToPx0680j_4);
        this.endToAnchorEnd = MenuPosition.INSTANCE.endToAnchorEnd(iMo310roundToPx0680j_4);
        ...
        int iMo310roundToPx0680j_42 = density.mo310roundToPx0680j_4(DpOffset.m5798getYD9Ej5fM(j));
        this.topToAnchorBottom = MenuPosition.INSTANCE.topToAnchorBottom(iMo310roundToPx0680j_42);
        this.bottomToAnchorTop = MenuPosition.INSTANCE.bottomToAnchorTop(iMo310roundToPx0680j_42);
        this.centerToAnchorTop = MenuPosition.INSTANCE.centerToAnchorTop(iMo310roundToPx0680j_42);
    ...
    public /* synthetic */ DropdownMenuPositionProvider(long j, Density density, int i, AnonymousClass2 anonymousClass2, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, density, (i2 & 4) != 0 ? density.mo310roundToPx0680j_4(MenuKt.getMenuVerticalMargin()) : i, (i2 & 8) != 0 ? new Function2<IntRect, IntRect, Unit>() { // from class: androidx.compose.material3.DropdownMenuPositionProvider.2
    ...
    public long mo992calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        if (IntOffset.m5863getXimpl(anchorBounds.m5886getCenternOccac()) < IntSize.m5905getWidthimpl(windowSize) / 2) {
        ...
        for (int i = 0; i < size; i++) {
            arrayList.add(Integer.valueOf(((MenuPosition.Horizontal) listListOf.get(i)).mo1227position95KtPRI(anchorBounds, windowSize, IntSize.m5905getWidthimpl(popupContentSize), layoutDirection)));
        }
        ...
        while (true) {
            ...
            if (iIntValue >= 0 && iIntValue + IntSize.m5905getWidthimpl(popupContentSize) <= IntSize.m5905getWidthimpl(windowSize)) {
                break;
            }
            i2++;
        }
        ...
        if (IntOffset.m5864getYimpl(anchorBounds.m5886getCenternOccac()) < IntSize.m5904getHeightimpl(windowSize) / 2) {
        ...
        for (int i3 = 0; i3 < size3; i3++) {
            arrayList3.add(Integer.valueOf(((MenuPosition.Vertical) listListOf2.get(i3)).mo1228positionJVtK1S4(anchorBounds, windowSize, IntSize.m5904getHeightimpl(popupContentSize))));
        }
        ...
        while (true) {
            ...
            if (iIntValue3 >= this.verticalMargin && iIntValue3 + IntSize.m5904getHeightimpl(popupContentSize) <= IntSize.m5904getHeightimpl(windowSize) - this.verticalMargin) {
                obj = obj3;
                break;
            }
            i4++;
        ...
        this.onPositionCalculated.invoke(anchorBounds, IntRectKt.m5895IntRectVbeCjmY(jIntOffset, popupContentSize));
        return jIntOffset;
    }
}
