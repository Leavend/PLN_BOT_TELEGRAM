...
public final /* data */ class CaretProperties {
    ...
    public static /* synthetic */ CaretProperties m1299copyYgX7TsA$default(CaretProperties caretProperties, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return caretProperties.m1302copyYgX7TsA(f, f2);
    }
    ...
    public final CaretProperties m1302copyYgX7TsA(float caretHeight, float caretWidth) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5740equalsimpl0(this.caretHeight, caretProperties.caretHeight) && Dp.m5740equalsimpl0(this.caretWidth, caretProperties.caretWidth);
    }

    public int hashCode() {
        return (Dp.m5741hashCodeimpl(this.caretHeight) * 31) + Dp.m5741hashCodeimpl(this.caretWidth);
    }

    public String toString() {
        return "CaretProperties(caretHeight=" + ((Object) Dp.m5746toStringimpl(this.caretHeight)) + ", caretWidth=" + ((Object) Dp.m5746toStringimpl(this.caretWidth)) + ')';
    }
    ...
    public final float m1303getCaretHeightD9Ej5fM() {
        return this.caretHeight;
    }

    /* renamed from: getCaretWidth-D9Ej5fM, reason: not valid java name */
    public final float m1304getCaretWidthD9Ej5fM() {
        return this.caretWidth;
    }
}
