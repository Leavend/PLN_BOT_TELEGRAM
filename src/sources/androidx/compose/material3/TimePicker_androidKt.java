...
public final class TimePicker_androidKt {
    ...
    public static final int getDefaultTimePickerLayoutType(Composer composer, int i) {
        ...
        if (configuration.screenHeightDp < configuration.screenWidthDp) {
            iM2176getVerticalQJTpgSE = TimePickerLayoutType.INSTANCE.m2175getHorizontalQJTpgSE();
        } else {
            iM2176getVerticalQJTpgSE = TimePickerLayoutType.INSTANCE.m2176getVerticalQJTpgSE();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return iM2176getVerticalQJTpgSE;
    }
}
