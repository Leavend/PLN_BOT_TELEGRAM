...
public final class CheckboxKt {
    ...
    private static final float CheckboxSize = Dp.m5735constructorimpl(20);
    ...
    */
    ...
    public static final void m1322drawBox1wkBAMs(DrawScope drawScope, long j, long j2, float f, float f2) {
        float f3 = f2 / 2.0f;
        ...
        if (Color.m3415equalsimpl0(j, j2)) {
            DrawScope.m3960drawRoundRectuAw5IA$default(drawScope, j, 0L, SizeKt.Size(fM3242getWidthimpl, fM3242getWidthimpl), CornerRadiusKt.CornerRadius$default(f, 0.0f, 2, null), Fill.INSTANCE, 0.0f, null, 0, HttpStatusCodesKt.HTTP_IM_USED, null);
            return;
        }
        float f4 = fM3242getWidthimpl - (2 * f2);
        DrawScope.m3960drawRoundRectuAw5IA$default(drawScope, j, OffsetKt.Offset(f2, f2), SizeKt.Size(f4, f4), CornerRadiusKt.CornerRadius$default(Math.max(0.0f, f - f2), 0.0f, 2, null), Fill.INSTANCE, 0.0f, null, 0, 224, null);
        float f5 = fM3242getWidthimpl - f2;
        DrawScope.m3960drawRoundRectuAw5IA$default(drawScope, j2, OffsetKt.Offset(f3, f3), SizeKt.Size(f5, f5), CornerRadiusKt.CornerRadius$default(f - f3, 0.0f, 2, null), stroke, 0.0f, null, 0, 224, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: drawCheck-3IgeMak, reason: not valid java name */
    public static final void m1323drawCheck3IgeMak(DrawScope drawScope, long j, float f, float f2, float f3, CheckDrawingCache checkDrawingCache) {
        Stroke stroke = new Stroke(f3, 0.0f, StrokeCap.INSTANCE.m3768getSquareKaPHkGw(), 0, null, 26, null);
        float fM3242getWidthimpl = Size.m3242getWidthimpl(drawScope.mo3963getSizeNHjbRc());
        ...
        checkDrawingCache.getCheckPath().moveTo(0.2f * fM3242getWidthimpl, fLerp3 * fM3242getWidthimpl);
        checkDrawingCache.getCheckPath().lineTo(fLerp * fM3242getWidthimpl, fLerp2 * fM3242getWidthimpl);
        checkDrawingCache.getCheckPath().lineTo(0.8f * fM3242getWidthimpl, fM3242getWidthimpl * fLerp4);
        ...
        DrawScope.m3954drawPathLG529CI$default(drawScope, checkDrawingCache.getPathToDraw(), j, 0.0f, stroke, null, 0, 52, null);
    }

    static {
        float f = 2;
        CheckboxDefaultPadding = Dp.m5735constructorimpl(f);
        StrokeWidth = Dp.m5735constructorimpl(f);
        RadiusSize = Dp.m5735constructorimpl(f);
    }
}
