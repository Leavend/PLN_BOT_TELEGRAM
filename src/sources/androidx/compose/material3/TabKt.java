...
public final class TabKt {
    ...
    private static final float SmallTabHeight = PrimaryNavigationTabTokens.INSTANCE.m2771getContainerHeightD9Ej5fM();
    private static final float LargeTabHeight = Dp.m5735constructorimpl(72);
    private static final float HorizontalTextPadding = Dp.m5735constructorimpl(16);
    private static final float SingleLineTextBaselineWithIcon = Dp.m5735constructorimpl(14);
    private static final float DoubleLineTextBaselineWithIcon = Dp.m5735constructorimpl(6);
    private static final long IconDistanceFromBaseline = TextUnitKt.getSp(20);
    private static final float TextDistanceFromLeadingIcon = Dp.m5735constructorimpl(8);
    ...
    */
    public static final void m2020TabwqdebIU(final boolean r29, final kotlin.jvm.functions.Function0<kotlin.Unit> r30, androidx.compose.ui.Modifier r31, boolean r32, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r33, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r34, long r35, long r37, androidx.compose.foundation.interaction.MutableInteractionSource r39, androidx.compose.runtime.Composer r40, final int r41, final int r42) {
        /*
            Method dump skipped, instructions count: 611
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TabKt.m2020TabwqdebIU(boolean, kotlin.jvm.functions.Function0, androidx.compose.ui.Modifier, boolean, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, long, long, androidx.compose.foundation.interaction.MutableInteractionSource, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m2018LeadingIconTabwqdebIU(final boolean r23, final kotlin.jvm.functions.Function0<kotlin.Unit> r24, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r25, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r26, androidx.compose.ui.Modifier r27, boolean r28, long r29, long r31, androidx.compose.foundation.interaction.MutableInteractionSource r33, androidx.compose.runtime.Composer r34, final int r35, final int r36) {
        /*
            Method dump skipped, instructions count: 607
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TabKt.m2018LeadingIconTabwqdebIU(boolean, kotlin.jvm.functions.Function0, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, androidx.compose.ui.Modifier, boolean, long, long, androidx.compose.foundation.interaction.MutableInteractionSource, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m2019TabbogVsAg(final boolean r27, final kotlin.jvm.functions.Function0<kotlin.Unit> r28, androidx.compose.ui.Modifier r29, boolean r30, long r31, long r33, androidx.compose.foundation.interaction.MutableInteractionSource r35, final kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.ColumnScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r36, androidx.compose.runtime.Composer r37, final int r38, final int r39) {
        /*
            Method dump skipped, instructions count: 556
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TabKt.m2019TabbogVsAg(boolean, kotlin.jvm.functions.Function0, androidx.compose.ui.Modifier, boolean, long, long, androidx.compose.foundation.interaction.MutableInteractionSource, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: TabTransition-Klgx-Pg, reason: not valid java name */
    public static final void m2021TabTransitionKlgxPg(final long j, final long j2, final boolean z, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        int i2;
        ...
        if ((i2 & 1171) != 1170 || !composerStartRestartGroup.getSkipping()) {
            ...
            ColorSpace colorSpaceM3418getColorSpaceimpl = Color.m3418getColorSpaceimpl(j3);
            composerStartRestartGroup.startReplaceableGroup(1157296644);
            ComposerKt.sourceInformation(composerStartRestartGroup, "CC(remember)P(1):Composables.kt#9igjgp");
            boolean zChanged = composerStartRestartGroup.changed(colorSpaceM3418getColorSpaceimpl);
            Object objRememberedValue = composerStartRestartGroup.rememberedValue();
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = (TwoWayConverter) ColorVectorConverterKt.getVectorConverter(Color.INSTANCE).invoke(colorSpaceM3418getColorSpaceimpl);
            ...
            composerStartRestartGroup.endReplaceableGroup();
            Color colorM3404boximpl = Color.m3404boximpl(j4);
            ...
            composerStartRestartGroup.endReplaceableGroup();
            State stateCreateTransitionAnimation = TransitionKt.createTransitionAnimation(transitionUpdateTransition, colorM3404boximpl, Color.m3404boximpl(j5), tabKt$TabTransition$color$2.invoke((TabKt$TabTransition$color$2) transitionUpdateTransition.getSegment(), (Transition.Segment) composerStartRestartGroup, (Composer) 0), twoWayConverter, "ColorAnimation", composerStartRestartGroup, 32768);
            composerStartRestartGroup.endReplaceableGroup();
            composerStartRestartGroup.endReplaceableGroup();
            CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m3404boximpl(TabTransition_Klgx_Pg$lambda$5(stateCreateTransitionAnimation))), function2, composerStartRestartGroup, (i3 & 112) | 0 | ProvidedValue.$stable);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$TabTransition$1
                ...
                public final void invoke(Composer composer2, int i4) {
                    TabKt.m2021TabTransitionKlgxPg(j, j2, z, function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
        ...
        if ((i2 & 19) != 18 || !composerStartRestartGroup.getSkipping()) {
            ...
            if (z || measurePolicyRememberedValue == Composer.INSTANCE.getEmpty()) {
                measurePolicyRememberedValue = new MeasurePolicy() { // from class: androidx.compose.material3.TabKt$TabBaselineLayout$2$1
                    ...
                    public final MeasureResult mo37measure3p2s80s(final MeasureScope measureScope, List<? extends Measurable> list, long j) {
                        final Placeable placeableMo4684measureBRTryo0;
                        final Placeable placeableMo4684measureBRTryo02;
                        if (function2 != null) {
                            int size = list.size();
                            for (int i4 = 0; i4 < size; i4++) {
                                Measurable measurable = list.get(i4);
                                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), TextBundle.TEXT_ENTRY)) {
                                    placeableMo4684measureBRTryo0 = measurable.mo4684measureBRTryo0(Constraints.m5682copyZbe2FdA$default(j, 0, 0, 0, 0, 11, null));
                                }
                            }
                        ...
                        if (function22 != null) {
                            ...
                            for (int i5 = 0; i5 < size2; i5++) {
                                ...
                                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), "icon")) {
                                    placeableMo4684measureBRTryo02 = measurable2.mo4684measureBRTryo0(j);
                                }
                            }
                            throw new NoSuchElementException("Collection contains no element matching the predicate.");
                        }
                        placeableMo4684measureBRTryo02 = null;
                        final int iMax = Math.max(placeableMo4684measureBRTryo0 != null ? placeableMo4684measureBRTryo0.getWidth() : 0, placeableMo4684measureBRTryo02 != null ? placeableMo4684measureBRTryo02.getWidth() : 0);
                        final int iMax2 = Math.max(measureScope.mo310roundToPx0680j_4((placeableMo4684measureBRTryo0 == null || placeableMo4684measureBRTryo02 == null) ? TabKt.SmallTabHeight : TabKt.LargeTabHeight), (placeableMo4684measureBRTryo02 != null ? placeableMo4684measureBRTryo02.getHeight() : 0) + (placeableMo4684measureBRTryo0 != null ? placeableMo4684measureBRTryo0.getHeight() : 0) + measureScope.mo309roundToPxR2X_6o(TabKt.IconDistanceFromBaseline));
                        final Integer numValueOf = placeableMo4684measureBRTryo0 != null ? Integer.valueOf(placeableMo4684measureBRTryo0.get(AlignmentLineKt.getFirstBaseline())) : null;
                        final Integer numValueOf2 = placeableMo4684measureBRTryo0 != null ? Integer.valueOf(placeableMo4684measureBRTryo0.get(AlignmentLineKt.getLastBaseline())) : null;
                        return MeasureScope.layout$default(measureScope, iMax, iMax2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TabKt$TabBaselineLayout$2$1.1
                            ...
                            public final void invoke2(Placeable.PlacementScope placementScope) {
                                Placeable placeable;
                                Placeable placeable2 = placeableMo4684measureBRTryo0;
                                if (placeable2 == null || (placeable = placeableMo4684measureBRTryo02) == null) {
                                    if (placeable2 != null) {
                                        TabKt.placeTextOrIcon(placementScope, placeable2, iMax2);
                                        return;
                                    }
                                    Placeable placeable3 = placeableMo4684measureBRTryo02;
                                    if (placeable3 != null) {
            ...
            if (function2 != null) {
                Modifier modifierM567paddingVpY3zN4$default = PaddingKt.m567paddingVpY3zN4$default(LayoutIdKt.layoutId(Modifier.INSTANCE, TextBundle.TEXT_ENTRY), HorizontalTextPadding, 0.0f, 2, null);
    ...
    public static final void placeTextAndIcon(Placeable.PlacementScope placementScope, Density density, Placeable placeable, Placeable placeable2, int i, int i2, int i3, int i4) {
        ...
        int iMo310roundToPx0680j_4 = density.mo310roundToPx0680j_4(f) + density.mo310roundToPx0680j_4(PrimaryNavigationTabTokens.INSTANCE.m2769getActiveIndicatorHeightD9Ej5fM());
        int height = (placeable2.getHeight() + density.mo309roundToPxR2X_6o(IconDistanceFromBaseline)) - i3;
        int i5 = (i2 - i4) - iMo310roundToPx0680j_4;
