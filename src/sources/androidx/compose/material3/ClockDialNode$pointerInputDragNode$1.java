        ...
        if (i == 0) {
            ...
            Function0<Unit> function0 = new Function0<Unit>() { // from class: androidx.compose.material3.ClockDialNode$pointerInputDragNode$1.1
                ...
                static final class C00951 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 0) {
                            ResultKt.throwOnFailure(obj);
                            if (!Selection.m1850equalsimpl0(this.this$0.state.m2178getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1854getHourJiIwxys()) || !this.this$0.autoSwitchToMinute) {
                                if (Selection.m1850equalsimpl0(this.this$0.state.m2178getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1855getMinuteJiIwxys())) {
                                    this.label = 2;
                                ...
                                this.this$0.state.m2181setSelectioniHAOin8$material3_release(Selection.INSTANCE.m1855getMinuteJiIwxys());
                                this.label = 1;
            ...
            if (DragGestureDetectorKt.detectDragGestures$default(pointerInputScope, null, function0, null, new Function2<PointerInputChange, Offset, Unit>() { // from class: androidx.compose.material3.ClockDialNode$pointerInputDragNode$1.2
                ...
                public /* bridge */ /* synthetic */ Unit invoke(PointerInputChange pointerInputChange, Offset offset) {
                    m1351invokeUv8p0NA(pointerInputChange, offset.getPackedValue());
                    return Unit.INSTANCE;
                }
                ...
                static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 0) {
                            ResultKt.throwOnFailure(obj);
                            this.this$0.offsetX += Offset.m3173getXimpl(this.$dragAmount);
                            this.this$0.offsetY += Offset.m3174getYimpl(this.$dragAmount);
                            this.label = 1;
                            if (TimePickerState.update$material3_release$default(this.this$0.state, TimePickerKt.atan(this.this$0.offsetY - IntOffset.m5864getYimpl(this.this$0.state.m2177getCenternOccac$material3_release()), this.this$0.offsetX - IntOffset.m5863getXimpl(this.this$0.state.m2177getCenternOccac$material3_release())), false, this, 2, null) == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                        } else {
                            if (i != 1) {
                ...
                public final void m1351invokeUv8p0NA(PointerInputChange pointerInputChange, long j) {
