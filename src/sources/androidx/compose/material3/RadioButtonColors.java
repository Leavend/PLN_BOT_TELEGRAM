...
public final class RadioButtonColors {
    ...
    public final State<Color> radioColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        if (z) {
            ...
            stateRememberUpdatedState = SingleValueAnimationKt.m104animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 48, 12);
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3415equalsimpl0(this.selectedColor, radioButtonColors.selectedColor) && Color.m3415equalsimpl0(this.unselectedColor, radioButtonColors.unselectedColor) && Color.m3415equalsimpl0(this.disabledSelectedColor, radioButtonColors.disabledSelectedColor) && Color.m3415equalsimpl0(this.disabledUnselectedColor, radioButtonColors.disabledUnselectedColor);
    }

    public int hashCode() {
        return (((((Color.m3421hashCodeimpl(this.selectedColor) * 31) + Color.m3421hashCodeimpl(this.unselectedColor)) * 31) + Color.m3421hashCodeimpl(this.disabledSelectedColor)) * 31) + Color.m3421hashCodeimpl(this.disabledUnselectedColor);
    }

    /* renamed from: copy-jRlVdoo, reason: not valid java name */
    public final RadioButtonColors m1771copyjRlVdoo(long selectedColor, long unselectedColor, long disabledSelectedColor, long disabledUnselectedColor) {
        return new RadioButtonColors((selectedColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (selectedColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? selectedColor : this.selectedColor, (unselectedColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (unselectedColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? unselectedColor : this.unselectedColor, (disabledSelectedColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (disabledSelectedColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledSelectedColor : this.disabledSelectedColor, disabledUnselectedColor != Color.INSTANCE.m3450getUnspecified0d7_KjU() ? disabledUnselectedColor : this.disabledUnselectedColor, null);
    }
}
