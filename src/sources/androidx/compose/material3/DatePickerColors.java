...
public final class DatePickerColors {
    ...
    public final State<Color> dayContentColor$material3_release(boolean z, boolean z2, boolean z3, boolean z4, Composer composer, int i) {
        long j;
        State<Color> stateM104animateColorAsStateeuL9pac;
        ...
        if (z3) {
            ...
            stateM104animateColorAsStateeuL9pac = SnapshotStateKt.rememberUpdatedState(Color.m3404boximpl(j2), composer, 0);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(379022258);
            ComposerKt.sourceInformation(composer, "905@42421L134");
            stateM104animateColorAsStateeuL9pac = SingleValueAnimationKt.m104animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
            composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> dayContainerColor$material3_release(boolean z, boolean z2, boolean z3, Composer composer, int i) {
        long jM3449getTransparent0d7_KjU;
        ...
        if (z) {
            jM3449getTransparent0d7_KjU = z2 ? this.selectedDayContainerColor : this.disabledSelectedDayContainerColor;
        } else {
            jM3449getTransparent0d7_KjU = Color.INSTANCE.m3449getTransparent0d7_KjU();
        }
        long j = jM3449getTransparent0d7_KjU;
        if (z3) {
            composer.startReplaceableGroup(1577421952);
            ComposerKt.sourceInformation(composer, "931@43245L134");
            stateRememberUpdatedState = SingleValueAnimationKt.m104animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(1577422116);
            ComposerKt.sourceInformation(composer, "936@43409L28");
            stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3404boximpl(j), composer, 0);
            composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> yearContentColor$material3_release(boolean z, boolean z2, boolean z3, Composer composer, int i) {
        ...
        State<Color> stateM104animateColorAsStateeuL9pac = SingleValueAnimationKt.m104animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> yearContainerColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        if (z) {
            jM3449getTransparent0d7_KjU = z2 ? this.selectedYearContainerColor : this.disabledSelectedYearContainerColor;
        } else {
            jM3449getTransparent0d7_KjU = Color.INSTANCE.m3449getTransparent0d7_KjU();
        }
        State<Color> stateM104animateColorAsStateeuL9pac = SingleValueAnimationKt.m104animateColorAsStateeuL9pac(jM3449getTransparent0d7_KjU, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        return Color.m3415equalsimpl0(this.containerColor, datePickerColors.containerColor) && Color.m3415equalsimpl0(this.titleContentColor, datePickerColors.titleContentColor) && Color.m3415equalsimpl0(this.headlineContentColor, datePickerColors.headlineContentColor) && Color.m3415equalsimpl0(this.weekdayContentColor, datePickerColors.weekdayContentColor) && Color.m3415equalsimpl0(this.subheadContentColor, datePickerColors.subheadContentColor) && Color.m3415equalsimpl0(this.yearContentColor, datePickerColors.yearContentColor) && Color.m3415equalsimpl0(this.disabledYearContentColor, datePickerColors.disabledYearContentColor) && Color.m3415equalsimpl0(this.currentYearContentColor, datePickerColors.currentYearContentColor) && Color.m3415equalsimpl0(this.selectedYearContentColor, datePickerColors.selectedYearContentColor) && Color.m3415equalsimpl0(this.disabledSelectedYearContentColor, datePickerColors.disabledSelectedYearContentColor) && Color.m3415equalsimpl0(this.selectedYearContainerColor, datePickerColors.selectedYearContainerColor) && Color.m3415equalsimpl0(this.disabledSelectedYearContainerColor, datePickerColors.disabledSelectedYearContainerColor) && Color.m3415equalsimpl0(this.dayContentColor, datePickerColors.dayContentColor) && Color.m3415equalsimpl0(this.disabledDayContentColor, datePickerColors.disabledDayContentColor) && Color.m3415equalsimpl0(this.selectedDayContentColor, datePickerColors.selectedDayContentColor) && Color.m3415equalsimpl0(this.disabledSelectedDayContentColor, datePickerColors.disabledSelectedDayContentColor) && Color.m3415equalsimpl0(this.selectedDayContainerColor, datePickerColors.selectedDayContainerColor) && Color.m3415equalsimpl0(this.disabledSelectedDayContainerColor, datePickerColors.disabledSelectedDayContainerColor) && Color.m3415equalsimpl0(this.todayContentColor, datePickerColors.todayContentColor) && Color.m3415equalsimpl0(this.todayDateBorderColor, datePickerColors.todayDateBorderColor) && Color.m3415equalsimpl0(this.dayInSelectionRangeContainerColor, datePickerColors.dayInSelectionRangeContainerColor) && Color.m3415equalsimpl0(this.dayInSelectionRangeContentColor, datePickerColors.dayInSelectionRangeContentColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((((((((Color.m3421hashCodeimpl(this.containerColor) * 31) + Color.m3421hashCodeimpl(this.titleContentColor)) * 31) + Color.m3421hashCodeimpl(this.headlineContentColor)) * 31) + Color.m3421hashCodeimpl(this.weekdayContentColor)) * 31) + Color.m3421hashCodeimpl(this.subheadContentColor)) * 31) + Color.m3421hashCodeimpl(this.yearContentColor)) * 31) + Color.m3421hashCodeimpl(this.disabledYearContentColor)) * 31) + Color.m3421hashCodeimpl(this.currentYearContentColor)) * 31) + Color.m3421hashCodeimpl(this.selectedYearContentColor)) * 31) + Color.m3421hashCodeimpl(this.disabledSelectedYearContentColor)) * 31) + Color.m3421hashCodeimpl(this.selectedYearContainerColor)) * 31) + Color.m3421hashCodeimpl(this.disabledSelectedYearContainerColor)) * 31) + Color.m3421hashCodeimpl(this.dayContentColor)) * 31) + Color.m3421hashCodeimpl(this.disabledDayContentColor)) * 31) + Color.m3421hashCodeimpl(this.selectedDayContentColor)) * 31) + Color.m3421hashCodeimpl(this.disabledSelectedDayContentColor)) * 31) + Color.m3421hashCodeimpl(this.selectedDayContainerColor)) * 31) + Color.m3421hashCodeimpl(this.disabledSelectedDayContainerColor)) * 31) + Color.m3421hashCodeimpl(this.todayContentColor)) * 31) + Color.m3421hashCodeimpl(this.todayDateBorderColor)) * 31) + Color.m3421hashCodeimpl(this.dayInSelectionRangeContainerColor)) * 31) + Color.m3421hashCodeimpl(this.dayInSelectionRangeContentColor);
    }

    /* renamed from: copy-tNwlRmA, reason: not valid java name */
    public final DatePickerColors m1453copytNwlRmA(long containerColor, long titleContentColor, long headlineContentColor, long weekdayContentColor, long subheadContentColor, long navigationContentColor, long yearContentColor, long disabledYearContentColor, long currentYearContentColor, long selectedYearContentColor, long disabledSelectedYearContentColor, long selectedYearContainerColor, long disabledSelectedYearContainerColor, long dayContentColor, long disabledDayContentColor, long selectedDayContentColor, long disabledSelectedDayContentColor, long selectedDayContainerColor, long disabledSelectedDayContainerColor, long todayContentColor, long todayDateBorderColor, long dayInSelectionRangeContainerColor, long dayInSelectionRangeContentColor, long dividerColor, TextFieldColors dateTextFieldColors) {
        return new DatePickerColors((containerColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (containerColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? containerColor : this.containerColor, (titleContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (titleContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? titleContentColor : this.titleContentColor, (headlineContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (headlineContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? headlineContentColor : this.headlineContentColor, (weekdayContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (weekdayContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? weekdayContentColor : this.weekdayContentColor, (subheadContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (subheadContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? subheadContentColor : this.subheadContentColor, (navigationContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (navigationContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? navigationContentColor : this.navigationContentColor, (yearContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (yearContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? yearContentColor : this.yearContentColor, (disabledYearContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (disabledYearContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledYearContentColor : this.disabledYearContentColor, (currentYearContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (currentYearContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? currentYearContentColor : this.currentYearContentColor, (selectedYearContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (selectedYearContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? selectedYearContentColor : this.selectedYearContentColor, (disabledSelectedYearContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (disabledSelectedYearContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledSelectedYearContentColor : this.disabledSelectedYearContentColor, (selectedYearContainerColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (selectedYearContainerColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? selectedYearContainerColor : this.selectedYearContainerColor, (disabledSelectedYearContainerColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (disabledSelectedYearContainerColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledSelectedYearContainerColor : this.disabledSelectedYearContainerColor, (dayContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (dayContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? dayContentColor : this.dayContentColor, (disabledDayContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (disabledDayContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledDayContentColor : this.disabledDayContentColor, (selectedDayContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (selectedDayContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? selectedDayContentColor : this.selectedDayContentColor, (disabledSelectedDayContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (disabledSelectedDayContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledSelectedDayContentColor : this.disabledSelectedDayContentColor, (selectedDayContainerColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (selectedDayContainerColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? selectedDayContainerColor : this.selectedDayContainerColor, (disabledSelectedDayContainerColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (disabledSelectedDayContainerColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? disabledSelectedDayContainerColor : this.disabledSelectedDayContainerColor, (todayContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (todayContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? todayContentColor : this.todayContentColor, (todayDateBorderColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (todayDateBorderColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? todayDateBorderColor : this.todayDateBorderColor, (dayInSelectionRangeContainerColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (dayInSelectionRangeContainerColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? dayInSelectionRangeContainerColor : this.dayInSelectionRangeContainerColor, (dayInSelectionRangeContentColor > Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 1 : (dayInSelectionRangeContentColor == Color.INSTANCE.m3450getUnspecified0d7_KjU() ? 0 : -1)) != 0 ? dayInSelectionRangeContentColor : this.dayInSelectionRangeContentColor, dividerColor != Color.INSTANCE.m3450getUnspecified0d7_KjU() ? dividerColor : this.dividerColor, takeOrElse$material3_release(dateTextFieldColors, new Function0<TextFieldColors>() { // from class: androidx.compose.material3.DatePickerColors$copy$25
            {
                super(0);
            }
