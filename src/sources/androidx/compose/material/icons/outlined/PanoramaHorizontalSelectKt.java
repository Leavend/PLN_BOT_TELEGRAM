...
public final class PanoramaHorizontalSelectKt {
    ...
    public static final ImageVector getPanoramaHorizontalSelect(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.PanoramaHorizontalSelect", Dp.m5735constructorimpl(24.0f), Dp.m5735constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
