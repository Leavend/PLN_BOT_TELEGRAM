...
public final class QrCodeKt {
    ...
    public static final ImageVector getQrCode(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.QrCode", Dp.m5735constructorimpl(24.0f), Dp.m5735constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m4047addPathoIyEayM$default(builder, pathBuilder14.getNodes(), defaultFillType14, "", solidColor14, 1.0f, null, 1.0f, 1.0f, iM3766getButtKaPHkGw14, iM3776getBevelLxFBmk814, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
