...
public final class SportsBasketballKt {
    ...
    public static final ImageVector getSportsBasketball(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SportsBasketball", Dp.m5735constructorimpl(24.0f), Dp.m5735constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        pathBuilder9.close();
        ImageVector imageVectorBuild = ImageVector.Builder.m4047addPathoIyEayM$default(builder, pathBuilder9.getNodes(), defaultFillType9, "", solidColor9, 1.0f, null, 1.0f, 1.0f, iM3766getButtKaPHkGw9, iM3776getBevelLxFBmk89, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
