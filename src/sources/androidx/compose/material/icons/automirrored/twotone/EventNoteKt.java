...
public final class EventNoteKt {
    ...
    public static final ImageVector getEventNote(Icons.AutoMirrored.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.TwoTone.EventNote", Dp.m5735constructorimpl(24.0f), Dp.m5735constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
