...
public final class RippleKt {
    ...
    public static final Indication m1218rememberRipple9IZ8Weo(boolean z, float f, long j, Composer composer, int i, int i2) {
        ...
        State stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m3404boximpl(j), composer, (i >> 6) & 14);
        Boolean boolValueOf = Boolean.valueOf(z);
        Dp dpM5733boximpl = Dp.m5733boximpl(f);
        composer.startReplaceableGroup(511388516);
        ComposerKt.sourceInformation(composer, "CC(remember)P(1,2):Composables.kt#9igjgp");
        boolean zChanged = composer.changed(boolValueOf) | composer.changed(dpM5733boximpl);
