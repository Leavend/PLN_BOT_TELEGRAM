...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m1223setColorDxMtmZc(long color, float alpha) {
        long jM1222calculateRippleColor5vOe2sY = m1222calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (color2 == null ? false : Color.m3415equalsimpl0(color2.m3424unboximpl(), jM1222calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m3404boximpl(jM1222calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m3468toArgb8_81llA(jM1222calculateRippleColor5vOe2sY)));
    }
    ...
    private final long m1222calculateRippleColor5vOe2sY(long color, float alpha) {
        if (Build.VERSION.SDK_INT < 28) {
            alpha *= 2;
        }
        return Color.m3413copywmQWz5c$default(color, RangesKt.coerceAtMost(alpha, 1.0f), 0.0f, 0.0f, 0.0f, 14, null);
    }
