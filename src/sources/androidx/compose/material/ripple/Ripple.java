...
public abstract class Ripple implements Indication {
    ...
    public final IndicationInstance rememberUpdatedInstance(InteractionSource interactionSource, Composer composer, int i) {
        long jMo1210defaultColorWaAFU9c;
        ...
        if (this.color.getValue().m3424unboximpl() != Color.INSTANCE.m3450getUnspecified0d7_KjU()) {
            jMo1210defaultColorWaAFU9c = this.color.getValue().m3424unboximpl();
        } else {
            jMo1210defaultColorWaAFU9c = rippleTheme.mo1210defaultColorWaAFU9c(composer, 0);
        }
        composer.endReplaceableGroup();
        RippleIndicationInstance rippleIndicationInstanceMo1208rememberUpdatedRippleInstance942rkJo = mo1208rememberUpdatedRippleInstance942rkJo(interactionSource, this.bounded, this.radius, SnapshotStateKt.rememberUpdatedState(Color.m3404boximpl(jMo1210defaultColorWaAFU9c), composer, 0), SnapshotStateKt.rememberUpdatedState(rippleTheme.rippleAlpha(composer, 0), composer, 0), composer, (i & 14) | ((i << 12) & 458752));
        EffectsKt.LaunchedEffect(rippleIndicationInstanceMo1208rememberUpdatedRippleInstance942rkJo, interactionSource, new AnonymousClass1(interactionSource, rippleIndicationInstanceMo1208rememberUpdatedRippleInstance942rkJo, null), composer, ((i << 3) & 112) | 520);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return rippleIndicationInstanceMo1208rememberUpdatedRippleInstance942rkJo;
    }
    ...
    public boolean equals(Object other) {
        ...
        return this.bounded == ripple.bounded && Dp.m5740equalsimpl0(this.radius, ripple.radius) && Intrinsics.areEqual(this.color, ripple.color);
    }

    public int hashCode() {
        return (((Boolean.hashCode(this.bounded) * 31) + Dp.m5741hashCodeimpl(this.radius)) * 31) + this.color.hashCode();
    }
}
