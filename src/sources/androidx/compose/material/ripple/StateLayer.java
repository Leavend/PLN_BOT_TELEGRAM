...
final class StateLayer {
    ...
    public final void m1221drawStateLayerH2RKhps(DrawScope drawScope, float f, long j) {
        float fM1212getRippleEndRadiuscSwnlzA;
        if (Float.isNaN(f)) {
            fM1212getRippleEndRadiuscSwnlzA = RippleAnimationKt.m1212getRippleEndRadiuscSwnlzA(drawScope, this.bounded, drawScope.mo3963getSizeNHjbRc());
        } else {
            fM1212getRippleEndRadiuscSwnlzA = drawScope.mo316toPx0680j_4(f);
        }
        float f2 = fM1212getRippleEndRadiuscSwnlzA;
        float fFloatValue = this.animatedAlpha.getValue().floatValue();
        if (fFloatValue > 0.0f) {
            long jM3413copywmQWz5c$default = Color.m3413copywmQWz5c$default(j, fFloatValue, 0.0f, 0.0f, 0.0f, 14, null);
            if (!this.bounded) {
                DrawScope.m3945drawCircleVaOC9Bg$default(drawScope, jM3413copywmQWz5c$default, f2, 0L, 0.0f, null, null, 0, 124, null);
                return;
            }
