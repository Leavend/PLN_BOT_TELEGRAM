...
public final class RippleAnimationKt {
    private static final float BoundedRippleExtraRadius = Dp.m5735constructorimpl(10);
    ...
    public static final float m1213getRippleStartRadiusuvyYCjk(long j) {
        return Math.max(Size.m3242getWidthimpl(j), Size.m3239getHeightimpl(j)) * 0.3f;
    }

    /* renamed from: getRippleEndRadius-cSwnlzA, reason: not valid java name */
    public static final float m1212getRippleEndRadiuscSwnlzA(Density density, boolean z, long j) {
        float fM3171getDistanceimpl = Offset.m3171getDistanceimpl(OffsetKt.Offset(Size.m3242getWidthimpl(j), Size.m3239getHeightimpl(j))) / 2.0f;
        return z ? fM3171getDistanceimpl + density.mo316toPx0680j_4(BoundedRippleExtraRadius) : fM3171getDistanceimpl;
    }
}
