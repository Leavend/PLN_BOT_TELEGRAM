...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1210defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long jM1220defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m1220defaultRippleColor5vOe2sY(Color.INSTANCE.m3440getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return jM1220defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha rippleAlphaM1219defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m1219defaultRippleAlphaDxMtmZc(Color.INSTANCE.m3440getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return rippleAlphaM1219defaultRippleAlphaDxMtmZc;
    }
}
