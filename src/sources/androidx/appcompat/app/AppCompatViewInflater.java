...
public class AppCompatViewInflater {
    ...
    private static class DeclaredOnClickListener implements View.OnClickListener {
        ...
        private void resolveMethod(Context context) {
            ...
            throw new IllegalStateException("Could not find method " + this.mMethodName + "(View) in a parent or ancestor Context for android:onClick attribute defined on view " + this.mHostView.getClass() + (id2 == -1 ? "" : " with id '" + this.mHostView.getContext().getResources().getResourceEntryName(id2) + "'"));
        }
    }
}
