    ...
    private final void resizeStorage(int newCapacity) {
        ...
        while (i3 < i2) {
            if (((jArr3[i3 >> 3] >> ((i3 & 7) << 3)) & 255) < 128) {
                ...
                int i9 = i8 >> 3;
                int i10 = (i8 & 7) << 3;
                jArr6[i9] = (j2 << i10) | (jArr6[i9] & (~(255 << i10)));
