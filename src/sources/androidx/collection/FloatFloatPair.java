...
public final class FloatFloatPair {
    ...
    public static String m18toStringimpl(long j) {
        return "(" + Float.intBitsToFloat((int) (j >> 32)) + ", " + Float.intBitsToFloat((int) (j & InternalZipConstants.ZIP_64_SIZE_LIMIT)) + ')';
    }
    ...
    public static long m11constructorimpl(float f, float f2) {
        return m12constructorimpl((Float.floatToRawIntBits(f2) & InternalZipConstants.ZIP_64_SIZE_LIMIT) | (Float.floatToRawIntBits(f) << 32));
    }

    /* renamed from: getFirst-impl, reason: not valid java name */
    public static final float m15getFirstimpl(long j) {
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* renamed from: getSecond-impl, reason: not valid java name */
    public static final float m16getSecondimpl(long j) {
        return Float.intBitsToFloat((int) (j & InternalZipConstants.ZIP_64_SIZE_LIMIT));
    }

    /* renamed from: component1-impl, reason: not valid java name */
    public static final float m9component1impl(long j) {
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* renamed from: component2-impl, reason: not valid java name */
    public static final float m10component2impl(long j) {
        return Float.intBitsToFloat((int) (j & InternalZipConstants.ZIP_64_SIZE_LIMIT));
    }
}
