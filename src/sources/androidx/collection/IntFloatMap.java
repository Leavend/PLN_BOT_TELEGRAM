...
public abstract class IntFloatMap {
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final boolean all(kotlin.jvm.functions.Function2<? super java.lang.Integer, ? super java.lang.Float, java.lang.Boolean> r19) {
        /*
            r18 = this;
            r0 = r18
            r1 = r19
        ...
        L69:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.collection.IntFloatMap.all(kotlin.jvm.functions.Function2):boolean");
    }
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i4 = 0; i4 < i3; i4++) {
                        if ((255 & j) < 128) {
                            int i5 = (i2 << 3) + i4;
                            iHashCode += Float.hashCode(fArr[i5]) ^ Integer.hashCode(iArr[i5]);
                        }
                        j >>= 8;
                    }
                    if (i3 != 8) {
