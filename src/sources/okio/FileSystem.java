...
public abstract class FileSystem {
    ...
    public final <T> T m8583read(Path file, Function1<? super BufferedSource, ? extends T> readerAction) throws Throwable {
        T tInvoke;
        Intrinsics.checkNotNullParameter(file, "file");
    ...
    public static /* synthetic */ Object m8582write$default(FileSystem fileSystem, Path file, boolean z, Function1 writerAction, int i, Object obj) throws Throwable {
        Object objInvoke;
        if (obj == null) {
            if ((i & 2) != 0) {
                z = false;
    ...
    public final <T> T m8584write(Path file, boolean mustCreate, Function1<? super BufferedSink, ? extends T> writerAction) throws Throwable {
        T tInvoke;
        Intrinsics.checkNotNullParameter(file, "file");
        Intrinsics.checkNotNullParameter(writerAction, "writerAction");
