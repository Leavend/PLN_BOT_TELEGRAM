...
public final class _PathKt {
    private static final ByteString SLASH = ByteString.INSTANCE.encodeUtf8(InternalZipConstants.ZIP_FILE_SEPARATOR);
    ...
    public static final ByteString toSlash(String str) {
        if (Intrinsics.areEqual(str, InternalZipConstants.ZIP_FILE_SEPARATOR)) {
            return SLASH;
        }
